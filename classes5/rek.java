...
public class rek
  implements Runnable
{
  public rek(DatingTopListActivity paramDatingTopListActivity)
  {
  ...
  public void run()
  {
    ...
    if (DatingTopListActivity.d(this.a))
    {
      ...
      if (!DatingTopListActivity.b(this.a).hasMore) {
        break label137;
      }
    ...
    for (;;)
    {
      this.a.b("0X8005276");
      return;
      DatingTopListActivity.a(this.a).setSelection(DatingTopListActivity.b(this.a).visiblePos);
      break;
      label137:
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\rek.class
