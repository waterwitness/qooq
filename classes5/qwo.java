  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    if ((this.a.a.jdField_a_of_type_ComTencentMobileqqBusinessCardDataCardOCRInfo != null) && (this.a.a.jdField_a_of_type_ComTencentMobileqqBusinessCardDataCardOCRInfo.jdField_a_of_type_Int != 0))
    {
      ...
      this.a.a.e();
      BusinessCardUtils.a(this.a.a.app.a(), this.a.a.jdField_a_of_type_ComTencentMobileqqBusinessCardDataCardOCRInfo.jdField_a_of_type_Int, -1, false, 0L);
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (int j = 1;; j = 0)
      {
        ...
        for (;;)
        {
          BusinessCardUtils.a(this.a.a.app.a(), 0, i, true, l - this.a.a.jdField_a_of_type_Long);
          this.a.a.e();
          this.a.a.g();
          Intent localIntent;
          if (this.a.a.e)
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\qwo.class
