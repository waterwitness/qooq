...
class uqq
{
  ...
  uqq(uqo paramuqo)
  {
    ...
    this.jdField_a_of_type_ArrayOfLong = new long[3];
    this.jdField_b_of_type_ArrayOfLong = new long[3];
  }
  ...
  {
    if ((paramBoolean) && (this.jdField_d_of_type_Int < 3))
    {
      this.jdField_a_of_type_ArrayOfLong[this.jdField_d_of_type_Int] = (System.currentTimeMillis() - this.jdField_a_of_type_ArrayOfLong[this.jdField_d_of_type_Int]);
      this.jdField_d_of_type_Int += 1;
      if (this.jdField_d_of_type_Int == 3)
      {
        this.jdField_a_of_type_Uqo.a.a("hw_video_time_used_msg", "videoEncodeTime:cnt20=" + this.jdField_a_of_type_ArrayOfLong[0] + " cnt1=" + this.jdField_a_of_type_ArrayOfLong[1] + " cnt2" + this.jdField_a_of_type_ArrayOfLong[2]);
        ...
        this.jdField_a_of_type_Uqo.a.a("hw_video_time_used_msg", "videoEncodeTime:timeout=" + this.jdField_a_of_type_ArrayOfLong[0]);
      }
    }
    do
    {
      ...
      {
        return;
      } while (this.jdField_e_of_type_Int >= 3);
      this.jdField_b_of_type_ArrayOfLong[this.jdField_e_of_type_Int] = (System.currentTimeMillis() - this.jdField_b_of_type_ArrayOfLong[this.jdField_e_of_type_Int]);
      this.jdField_e_of_type_Int += 1;
    } while (this.jdField_e_of_type_Int != 3);
    this.jdField_a_of_type_Uqo.a.a("hw_video_time_used_msg", "audioEncodeTime:cnt20=" + this.jdField_b_of_type_ArrayOfLong[0] + " cnt1=" + this.jdField_b_of_type_ArrayOfLong[1] + " cnt2" + this.jdField_b_of_type_ArrayOfLong[2]);
    ...
    this.jdField_a_of_type_Uqo.a.a("hw_video_time_used_msg", "audioEncodeTime:timeout=" + this.jdField_b_of_type_ArrayOfLong[0]);
  }
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("vStop=").append(this.jdField_e_of_type_Long).append(" ");
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\uqq.class
