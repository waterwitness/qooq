  ...
  implements Cloneable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.strPkgName, ((GetResourceRespInfoV2)paramObject).strPkgName)) || (!JceUtil.equals(this.uiNewVer, ((GetResourceRespInfoV2)paramObject).uiNewVer)) || (!JceUtil.equals(this.sResSubType, ((GetResourceRespInfoV2)paramObject).sResSubType)) || (!JceUtil.equals(this.sLanType, ((GetResourceRespInfoV2)paramObject).sLanType)) || (!JceUtil.equals(this.sPriority, ((GetResourceRespInfoV2)paramObject).sPriority)) || (!JceUtil.equals(this.strResName, ((GetResourceRespInfoV2)paramObject).strResName)) || (!JceUtil.equals(this.strResDesc, ((GetResourceRespInfoV2)paramObject).strResDesc)) || (!JceUtil.equals(this.strResURL_big, ((GetResourceRespInfoV2)paramObject).strResURL_big)) || (!JceUtil.equals(this.strResURL_small, ((GetResourceRespInfoV2)paramObject).strResURL_small)) || (!JceUtil.equals(this.strResConf, ((GetResourceRespInfoV2)paramObject).strResConf)) || (!JceUtil.equals(this.cDefaultState, ((GetResourceRespInfoV2)paramObject).cDefaultState)) || (!JceUtil.equals(this.cCanChangeState, ((GetResourceRespInfoV2)paramObject).cCanChangeState)) || (!JceUtil.equals(this.uiResId, ((GetResourceRespInfoV2)paramObject).uiResId)) || (!JceUtil.equals(this.cStatus, ((GetResourceRespInfoV2)paramObject).cStatus)) || (!JceUtil.equals(this.cPush, ((GetResourceRespInfoV2)paramObject).cPush)) || (!JceUtil.equals(this.iPluginType, ((GetResourceRespInfoV2)paramObject).iPluginType)) || (!JceUtil.equals(this.strNewPluginDesc, ((GetResourceRespInfoV2)paramObject).strNewPluginDesc)) || (!JceUtil.equals(this.strNewPluginURL, ((GetResourceRespInfoV2)paramObject).strNewPluginURL)));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\protocol\KQQConfig\GetResourceRespInfoV2.class
