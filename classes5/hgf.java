...
public class hgf
  extends BaseAdapter
{
  public hgf(TroopCardPopClassfic paramTroopCardPopClassfic)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      localView = LayoutInflater.from(this.a.getContext()).inflate(2130903642, paramViewGroup, false);
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)localView.findViewById(2131299545));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131299544));
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\hgf.class
