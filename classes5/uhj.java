  ...
  extends AsyncTask
{
  ...
  public uhj(BitmapDecoder paramBitmapDecoder, String paramString1, String paramString2, String paramString3)
  {
  ...
  {
    if (paramBitmap != null) {
      BaseApplicationImpl.a.put(BitmapDecoder.a(this.jdField_a_of_type_ComTencentMobileqqRichstatusBitmapDecoder) + this.jdField_a_of_type_JavaLangString, paramBitmap, (byte)0);
    }
  ...
  protected void a(Bitmap... paramVarArgs)
  {
    ...
    BaseApplicationImpl.a.put(BitmapDecoder.a(this.jdField_a_of_type_ComTencentMobileqqRichstatusBitmapDecoder) + this.b, paramVarArgs, (byte)0);
    if (BitmapDecoder.a(this.jdField_a_of_type_ComTencentMobileqqRichstatusBitmapDecoder) != null) {
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\uhj.class
