  ...
  implements Runnable
{
  ...
  public upr(BaseShortVideoOprerator paramBaseShortVideoOprerator, ShortVideoForwardInfo paramShortVideoForwardInfo)
  {
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      Object localObject;
      int i;
      if (localShortVideoForwardInfo.o == 3)
      {
      ...
      while (localObject != null)
      {
        ...
        localTransferRequest.i = (localShortVideoForwardInfo.h + "QQ_&_MoblieQQ_&_QQ" + localShortVideoForwardInfo.i + "QQ_&_MoblieQQ_&_QQ" + localShortVideoForwardInfo.n + "QQ_&_MoblieQQ_&_QQ" + localShortVideoForwardInfo.g);
        ...
        return;
        if (localShortVideoForwardInfo.o == 4)
        {
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\upr.class
