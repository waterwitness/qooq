...
{
  public hqp(PublicAccountManager paramPublicAccountManager, NewIntent paramNewIntent, QQAppInterface paramQQAppInterface, String paramString, Context paramContext, BusinessObserver paramBusinessObserver)
  {
      ...
      try
      {
        ...
        try
        {
          ...
          if (localGetPublicAccountMenuResponse.uin.has())
          {
            ...
            ThreadManager.b(new hqq(this, localGetPublicAccountMenuResponse, paramInt, paramBoolean, paramBundle));
            return;
          }
          long l = 0L;
          continue;
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\hqp.class
