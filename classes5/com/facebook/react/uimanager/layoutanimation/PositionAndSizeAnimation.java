  ...
  implements HandleLayout
{
  ...
  public PositionAndSizeAnimation(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    this.mStartX = paramView.getX();
    this.mStartY = paramView.getY();
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\facebook\react\uimanager\layoutanimation\PositionAndSizeAnimation.class
