...
public final class ScreencastDispatcher
{
    ...
    implements Runnable
  {
    ...
    private void updateScreenBitmap()
    {
      ...
      try
      {
        if (ScreencastDispatcher.this.mBitmap == null)
        {
          ...
          int k = (int)(i * f);
          int m = (int)(j * f);
          ScreencastDispatcher.this.mBitmap = Bitmap.createBitmap(k, m, Bitmap.Config.RGB_565);
    ...
    {
      updateScreenBitmap();
      ScreencastDispatcher.this.mBackgroundHandler.post(ScreencastDispatcher.EventDispatchRunnable.access$1(ScreencastDispatcher.this.mEventDispatchRunnable, this));
    }
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\facebook\stetho\inspector\screencast\ScreencastDispatcher.class
