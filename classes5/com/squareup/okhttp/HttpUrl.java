...
public final class HttpUrl
{
  ...
  private static int delimiterOffset(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    for (;;)
    {
      ...
      do
      {
        return i;
        i = paramInt1;
      } while (paramString2.indexOf(paramString1.charAt(paramInt1)) != -1);
      paramInt1 += 1;
    }
  }
  ...
  public static final class Builder
  {
    ...
    private static InetAddress decodeIpv6(String paramString, int paramInt1, int paramInt2)
    {
      ...
      label328:
      System.arraycopy(arrayOfByte, k, arrayOfByte, arrayOfByte.length - (paramInt1 - k), paramInt1 - k);
      Arrays.fill(arrayOfByte, k, arrayOfByte.length - paramInt1 + k, (byte)0);
      try
      {
        label360:
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\squareup\okhttp\HttpUrl.class
