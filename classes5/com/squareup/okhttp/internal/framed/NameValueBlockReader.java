...
class NameValueBlockReader
{
  ...
  private final InflaterSource inflaterSource = new InflaterSource(new ForwardingSource(paramBufferedSource)new Inflater
  {
      ...
      throws IOException
    {
      ...
      paramAnonymousBuffer.compressedLimit = ((int)(paramAnonymousBuffer.compressedLimit - paramAnonymousLong));
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\squareup\okhttp\internal\framed\NameValueBlockReader.class
