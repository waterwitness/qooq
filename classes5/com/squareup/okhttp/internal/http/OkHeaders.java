...
public final class OkHeaders
{
  ...
  public static boolean varyMatches(Response paramResponse, Headers paramHeaders, Request paramRequest)
  {
    ...
    } while (Util.equal(paramHeaders.values(str), paramRequest.headers(str)));
    return false;
  }
}


/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\squareup\okhttp\internal\http\OkHeaders.class
