...
public final class HttpEngine
{
    ...
    throws RouteException
  {
    ...
    for (;;)
    {
      Connection localConnection2 = localConnectionPool.get(this.address);
      ...
      do
      {
        do
        {
          try
          {
            localConnection1 = new Connection(localConnectionPool, this.routeSelector.next());
        ...
        } while (this.networkRequest.method().equals("GET"));
        localConnection1 = localConnection2;
      } while (Internal.instance.isReadable(localConnection2));
  ...
  public HttpEngine recover(IOException paramIOException, Sink paramSink)
  {
    ...
    for (int i = 0; ((this.routeSelector == null) && (this.connection == null)) || ((this.routeSelector != null) && (!this.routeSelector.hasNext())) || (!isRecoverable(paramIOException)) || (i == 0); i = 1) {
      return null;
    }
    ...
    implements Interceptor.Chain
  {
      ...
      throws IOException
    {
      ...
      else
      {
        ...
        HttpEngine.this.networkRequest = paramRequest;
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\squareup\okhttp\internal\http\HttpEngine.class
