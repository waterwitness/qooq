...
public final class Connection
{
    ...
    throws RouteException
  {
    ...
    try
    {
      ...
      for (paramList = localAddress.getSocketFactory().createSocket();; paramList = new Socket(localProxy))
      {
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\squareup\okhttp\Connection.class
