...
public final class SmartDeviceReport
{
  ...
  private static String c = "smartdevice::smartdevicereport";
  public int a;
  public long a;
  public String b = "";
  ...
  public static void a(AppRuntime paramAppRuntime, String paramString1, String paramString2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString3, String paramString4)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(c, 2, "smartdevice datareport, actionname:" + paramString1 + ", fromType:" + paramInt1 + ", actionResult = " + paramInt2 + ", ext2:" + paramInt3 + ", ext3:" + paramInt4 + ", ext4:" + paramString3 + ", ext5:" + paramString4);
    }
  ...
  public void a(AppRuntime paramAppRuntime, String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    QQAppInterface localQQAppInterface = null;
    if ((paramAppRuntime instanceof QQAppInterface)) {
      localQQAppInterface = (QQAppInterface)paramAppRuntime;
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(c, 2, "smartdevice datareport2, actionname:" + paramString1 + ",result:" + paramInt1 + ", pid:" + paramInt2 + ",sn:" + paramAppRuntime);
      }
      ReportController.b(localQQAppInterface, "CliOper", "", "0", "SmartDevice", paramString1, paramInt1, 0, Long.toString(paramInt2), "", paramAppRuntime, "");
      return;
    }
  }
  ...
  public void b(AppRuntime paramAppRuntime, String paramString, int paramInt)
  {
    ...
    if (this.b == null) {}
    for (paramAppRuntime = "";; paramAppRuntime = this.b)
    {
      if (QLog.isColorLevel()) {
        QLog.d(c, 2, "smartdevice datareport, actionname:" + paramString + ",result:" + paramInt + ", pid:" + Long.toString(this.jdField_a_of_type_Int) + ",sn:" + paramAppRuntime + ",seq:" + Long.toString(l));
      }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\device\utils\SmartDeviceReport.class
