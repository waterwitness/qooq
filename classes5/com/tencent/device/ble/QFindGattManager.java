...
public class QFindGattManager
{
  ...
  private static final String jdField_a_of_type_JavaLangString = "DeviceBLE2";
  private static final int jdField_b_of_type_Int = 100;
  private static final String jdField_b_of_type_JavaLangString = "__BLE_RETRY_CONNECT__";
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new jwb(this);
  private Context jdField_a_of_type_AndroidContentContext = BaseApplicationImpl.getContext();
  private ServiceConnection jdField_a_of_type_AndroidContentServiceConnection = new jwa(this);
  ...
  {
    this.jdField_a_of_type_MqqOsMqqHandler = new jvz(this, Looper.getMainLooper());
  ...
  public PeerInfo b(String paramString)
  {
    if ((this.jdField_a_of_type_ComTencentDeviceQfindPeerInfo != null) && (this.jdField_a_of_type_ComTencentDeviceQfindPeerInfo.a().equals(paramString))) {
      return this.jdField_a_of_type_ComTencentDeviceQfindPeerInfo;
    }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\device\ble\QFindGattManager.class
