  ...
  extends DeviceFileObserver
{
  ...
  private void a(long paramLong1, String paramString, int paramInt, long paramLong2)
  {
    ...
    {
      paramString = new kap(this, paramString, paramInt, paramLong2);
  ...
  private void a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct)
  {
    ...
    {
      Object localObject = (kao)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((kao)localObject).a();
      localObject = ((kao)localObject).a();
  ...
  public long a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct)
  {
    ...
    if ((paramMessageForDeviceSingleStruct == null) || (TextUtils.isEmpty(paramMessageForDeviceSingleStruct.strMediaKey)))
    {
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "mr is null or strMediaKey is empty in downloadMediaFile!");
      }
      l1 = 0L;
      return l1;
    }
    if (!NetworkUtil.e(BaseApplication.getContext()))
    {
      ...
      {
        return 0L;
        new Handler(paramMessageForDeviceSingleStruct).post(new kan(this));
      }
    }
  ...
  public long a(MessageForDeviceSingleStruct paramMessageForDeviceSingleStruct, View paramView, MessageForDeviceSingleStruct.DeviceSingleStructItemCallback paramDeviceSingleStructItemCallback)
  {
    ...
    {
      kao localkao = (kao)localIterator.next();
      if (localkao.a() == paramView) {
        localkao.b = new WeakReference(paramDeviceSingleStructItemCallback);
      }
    }
    for (int i = 1;; i = 0)
    {
      if (i == 0) {
        this.jdField_a_of_type_JavaUtilArrayList.add(new kao(this, paramView, paramDeviceSingleStructItemCallback));
      }
  ...
  {
    paramLong = (kap)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramLong);
    if (paramLong == null) {
      return null;
    }
  ...
  public String a(DataPoint paramDataPoint)
  {
    ...
    try
    {
      ...
      localObject = ((SmartDeviceProxyMgr)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(51)).a(paramDataPoint.mDin);
      if (localObject != null)
      {
        j = ((DeviceInfo)localObject).productId;
        SmartDeviceReport.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDataPoint.mDin, "Usr_AIO_ReceiveMsg", i, 0, j);
        if ((localObject != null) && (((DeviceInfo)localObject).isAdmin == 1) && (!TextUtils.isEmpty(localMessageForDeviceSingleStruct.faceRect))) {
          SmartDeviceReport.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramDataPoint.mDin, "FR_StrangerComming", 0, 0, 0);
        }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\device\msg\data\DevSingleStructMsgProcessor.class
