  ...
  extends DeviceFileObserver
{
  ...
  public MessageForDeviceFile a(String paramString, MessageForDeviceFile paramMessageForDeviceFile)
  {
    ...
    localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131371972);
    if (paramString.compareTo(DeviceMsgHandle.d) == 0)
    {
      localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131371973);
      label361:
      ((SVIPHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(localMessageForDeviceFile);
    ...
    for (;;)
    {
      ...
      localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131371974);
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    for (int j = 0;; j = 1)
    {
      ...
      if ((paramSession.actionInfo.strServiceName.compareTo(DeviceMsgHandle.c) == 0) && (paramSession.bSend) && (paramBoolean))
      {
        ...
        ((SmartDeviceProxyMgr)localObject1).a(Long.parseLong(localMessageForDeviceFile.frienduin), str, String.valueOf(((Session)localObject2).uSessionID), paramSession.strFileNameSrc, paramSession.emFileType, localMessageForDeviceFile.copies, localMessageForDeviceFile.duplexMode);
        localObject1 = (MessageForDeviceFile)MessageRecordFactory.a(61036);
        ((MessageForDeviceFile)localObject1).strServiceName = DeviceMsgHandle.c;
        ((MessageForDeviceFile)localObject1).msgtype = 61036;
        ...
        ((MessageForDeviceFile)localObject1).selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        ...
        ((MessageForDeviceFile)localObject1).msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131371974);
        ...
        ThreadManager.c().postDelayed(new kas(this, (MessageForDeviceFile)localObject1), 900000L);
      }
  ...
  public void a(MessageRecord paramMessageRecord, Boolean paramBoolean)
  {
    ...
    for (paramMessageRecord.msgStatus = 0;; paramMessageRecord.msgStatus = 1)
    {
      ...
      b(paramMessageRecord);
      paramMessageRecord = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(Conversation.class);
      if (paramMessageRecord == null) {
        break;
      }
  ...
  public void a(String paramString, long paramLong, boolean paramBoolean)
  {
    ...
    for (int i = localDeviceInfo.productId;; i = 0)
    {
      ...
      if (paramBoolean)
      {
        ...
        label76:
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131369800);
        if (paramString.compareTo(DeviceMsgHandle.d) != 0) {
          break label252;
        }
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131369796);
      }
      for (;;)
      {
        if (QLog.isDevelopLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 4, "onServiceSessionComplete:" + paramLong);
        }
        localMessageForDeviceFile.serial();
        ...
        paramString = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(Conversation.class);
        if (paramString == null) {
          break;
        }
  ...
  {
    MessageForStructing localMessageForStructing = MessageRecordFactory.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), paramString, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), 9501, 100L, paramAbsStructMsg);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localMessageForStructing, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a());
  ...
  public void a(String paramString1, String paramString2, List paramList, int paramInt1, int paramInt2)
  {
    ArrayList localArrayList = new ArrayList();
    ...
    if (paramList.hasNext())
    {
      ...
      MessageForDeviceFile localMessageForDeviceFile = (MessageForDeviceFile)MessageRecordFactory.a(61036);
      ...
      {
        localMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131371974);
        localMessageForDeviceFile.copies = paramInt1;
        localMessageForDeviceFile.duplexMode = paramInt2;
      }
      ((SVIPHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13)).a(localMessageForDeviceFile);
  ...
  public void a(String paramString, List paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      localMessageForDeviceFile.time = MessageCache.a();
      localMessageForDeviceFile.progress = 0.0F;
      localMessageForDeviceFile.msg = (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131367355) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131371973));
      localMessageForDeviceFile.nFileMsgType = 2;
      ...
      localMessageForDeviceFile.serial();
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(localMessageForDeviceFile, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a());
  ...
  {
    return this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Long.valueOf(paramMessageForDeviceFile.uSessionID));
  }
  
  public boolean a(String paramString1, String paramString2, List paramList)
  {
    a(paramString1, paramString2, paramList, 1, 1);
    return true;
  }
  ...
  public boolean a(String paramString, List paramList)
  {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        else
        {
          ...
          {
            localObject = ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(50)).a(((FileInfo)localObject).d(), localMessageForDeviceFile.strServiceName, null, Long.parseLong(paramString));
            if (localObject != null)
            {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      for (;;)
      {
        ...
        localMessageForDeviceFile.fileSize = FileManagerUtil.a(((FileInfo)localObject).d());
        localMessageForDeviceFile.issend = 1;
        localMessageForDeviceFile.isread = true;
        localMessageForDeviceFile.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        localMessageForDeviceFile.senderuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
  ...
  public boolean b(MessageForDeviceFile paramMessageForDeviceFile)
  {
    if ((paramMessageForDeviceFile == null) || (paramMessageForDeviceFile.strServiceName == null)) {
      return false;
    }
    paramMessageForDeviceFile.nFileStatus = 4;
    paramMessageForDeviceFile.progress = 0.0F;
    if (paramMessageForDeviceFile.strServiceName.compareTo(DeviceMsgHandle.d) == 0) {}
    for (paramMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131369796);; paramMessageForDeviceFile.msg = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131369800))
    {
      ...
      ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(50)).a(0, paramMessageForDeviceFile.uSessionID, false);
      return true;
    }
  }
  
  public boolean c(MessageForDeviceFile paramMessageForDeviceFile)
  {
    paramMessageForDeviceFile.nFileStatus = 4;
    paramMessageForDeviceFile.progress = 0.0F;
    if (paramMessageForDeviceFile.strServiceName != null) {
      if (paramMessageForDeviceFile.strServiceName.compareTo(DeviceMsgHandle.d) != 0) {
        break label136;
      }
    }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\device\msg\data\DeviceComnFileMsgProcessor.class
