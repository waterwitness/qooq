  ...
  extends DeviceFileObserver
{
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = DeviceGroupChatMsgProcessor.class.getSimpleName();
  }
  ...
  private MessageRecord a(long paramLong1, long paramLong2, JSONObject paramJSONObject)
  {
    ...
    localMessageForDevPtt.selfuin = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
    ...
    localMessageForDevPtt.msg = (ContactUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForDevPtt.senderuin, true) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131369798));
  ...
  private MessageRecord b(long paramLong1, long paramLong2, JSONObject paramJSONObject)
  {
    ...
    localMessageForDeviceFile.msg = (ContactUtils.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localMessageForDeviceFile.senderuin, true) + ": " + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getString(2131371973));
  ...
  public void a(DataPoint paramDataPoint)
  {
    try
    {
      ...
      if ((!TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a())) && (String.valueOf(l1).equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a()))) {
        return;
      }
  ...
  public boolean a(MessageRecord paramMessageRecord)
  {
    ...
    {
      MessageForDeviceFile localMessageForDeviceFile = (MessageForDeviceFile)paramMessageRecord;
      if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(Long.valueOf(localMessageForDeviceFile.uSessionID))) {
        this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(Long.valueOf(localMessageForDeviceFile.uSessionID));
      }
      localMessageForDeviceFile.nFileStatus = 6;
      ...
      ((DeviceFileHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(50)).a(0, localMessageForDeviceFile.uSessionID, false);
      return true;
    }
    return false;
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\device\msg\data\DeviceGroupChatMsgProcessor.class
