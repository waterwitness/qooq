  ...
  implements DeviceAVFileMsgObserver.DevMsgViewCallback
{
      ...
      if (paramMessageForPtt.fileSize != -1L) {
        ...
        else
        {
          ...
          if (paramMessageForPtt != null)
          {
            ...
            else if ((paramMessageForPtt.url.startsWith(AppConstants.bh)) && (FileUtils.a(paramMessageForPtt.url)))
            {
              i = 2003;
            }
            else if ((paramMessageForPtt.url.startsWith("/data/data")) && (FileUtils.a(paramMessageForPtt.url)))
            {
              i = 2003;
            }
  ...
  protected void a(View paramView)
  {
    ...
    if (localMessageForPtt.isSendFromLocal())
    {
      ...
      paramView.a(new kag(this, localMessageForPtt, paramView));
      paramView.show();
      return;
    }
    ...
    localActionSheet.a(new kah(this, paramView, localMessageForPtt, localActionSheet));
  ...
  public void a(PttItemBuilder.Holder paramHolder, MessageForPtt paramMessageForPtt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(new kai(this, paramMessageForPtt));
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\device\msg\activities\DevicePttItemBuilder.class
