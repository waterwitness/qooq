...
{
  private static final String a = "DevLittleVideoOperator";
  ...
  public MessageRecord a(ShortVideoUploadInfo paramShortVideoUploadInfo)
  {
    ...
    localMessageForDevLittleVideo.msg = "我：[视频]";
  ...
  public ShortVideoUploadInfo a(Object paramObject, ShortVideoReq paramShortVideoReq)
  {
    ...
    for (;;)
    {
      ...
      localShortVideoUploadInfo.jdField_g_of_type_Int = paramShortVideoReq.f;
  ...
  public void a(ShortVideoUploadInfo paramShortVideoUploadInfo)
  {
    ...
    ThreadManager.b().post(new jxc(this, paramShortVideoUploadInfo));
  }
  
  public boolean a(String paramString)
  {
    SmartDeviceProxyMgr localSmartDeviceProxyMgr = (SmartDeviceProxyMgr)this.a.a(51);
    ...
    return (!StringUtil.b(paramString)) && (Double.valueOf(paramString).doubleValue() >= 1.3D);
  }
}


/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\device\file\DevLittleVideoOperator.class
