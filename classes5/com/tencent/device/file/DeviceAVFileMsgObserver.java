  ...
  extends DeviceFileObserver
{
  ...
  public static final String b = "smartdevice_ptt_channeltype";
  ...
  private final TransProcessorHandler jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new jxf(this, Looper.getMainLooper());
  ...
  private void a(long paramLong1, String paramString, long paramLong2, int paramInt)
  {
    ...
    {
      paramString = new jxh(this, paramString, paramLong2, paramInt, "", 0L);
  ...
  {
    jxh localjxh = (jxh)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramSession.uSessionID));
    if (localjxh == null) {
      return;
    }
    Object localObject1;
    ...
    {
      this.jdField_a_of_type_ComTencentDeviceFileDevVideoMsgProcessor.a(paramSession, localjxh.jdField_a_of_type_JavaLangString, localjxh.jdField_a_of_type_Long, localjxh.jdField_a_of_type_Int, paramBoolean);
      localObject1 = BaseApplicationImpl.a().a();
      if ((localObject1 instanceof QQAppInterface))
      {
        localObject1 = (QQAppInterface)localObject1;
        localObject2 = ((SmartDeviceProxyMgr)((QQAppInterface)localObject1).a(51)).a(Long.parseLong(localjxh.jdField_a_of_type_JavaLangString));
    ...
    for (int i = ((DeviceInfo)localObject2).productId;; i = 0)
    {
      ...
      for (long l = ((DeviceInfo)localObject2).din;; l = 0L)
      {
        ...
        for (i = 1003;; i = 1005)
        {
          ...
          ((DeviceAVFileMsgObserver.DevMsgViewData)localObject2).jdField_a_of_type_Long = localjxh.jdField_a_of_type_Long;
          ...
          this.jdField_a_of_type_ComTencentDeviceFileDevAudioMsgProcessor.a(paramSession, localjxh.jdField_a_of_type_JavaLangString, localjxh.jdField_a_of_type_Long, localjxh.jdField_a_of_type_Int, paramBoolean);
          break;
          j = 1;
          break label152;
  ...
  private void c(Session paramSession)
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "recievemsg msg.uniseq:" + localMessageForDevShortVideo.uniseq + " ===> filesize:" + localMessageForDevShortVideo.videoFileSize + " fileStatus:" + ShortVideoUtils.b(localMessageForDevShortVideo.videoFileStatus));
      }
    }
  }
  ...
  public String a(DataPoint paramDataPoint)
  {
    try
    {
      ...
      String str1 = ((JSONObject)localObject1).optString("file_key", "");
      String str2 = ((JSONObject)localObject1).optString("file_url", "");
      String str3 = ((JSONObject)localObject1).optString("file_mini", "");
      ...
      if ((localObject2 instanceof QQAppInterface))
      {
        ...
        MessageForDevPtt localMessageForDevPtt = (MessageForDevPtt)MessageRecordFactory.a(61035);
        ...
        for (;;)
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_a_of_type_JavaLangString, 2, "voiceLength onReceiveAudioMsg " + localMessageForDevPtt.voiceLength);
          }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      paramBundle = (jxh)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(i));
  ...
  public void a(Message paramMessage)
  {
    ...
    {
      Object localObject = (jxg)this.jdField_a_of_type_JavaUtilArrayList.get(i);
      View localView = ((jxg)localObject).a();
      localObject = ((jxg)localObject).a();
  ...
  public void a(View paramView, DeviceAVFileMsgObserver.DevMsgViewCallback paramDevMsgViewCallback)
  {
    ...
    {
      jxg localjxg = (jxg)localIterator.next();
      if (localjxg.a() == paramView)
      {
        localjxg.b = new WeakReference(paramDevMsgViewCallback);
        return;
      }
    }
    this.jdField_a_of_type_JavaUtilArrayList.add(new jxg(this, paramView, paramDevMsgViewCallback));
  }
  ...
  public void a(MessageForDevPtt paramMessageForDevPtt)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        {
          paramMessageForDevPtt = new jxh(this, paramMessageForDevPtt.frienduin, paramMessageForDevPtt.uniseq, paramMessageForDevPtt.istroop, "", 0L);
  ...
  public void a(Session paramSession, float paramFloat)
  {
    ...
    if (localjxh != null)
    {
      ...
      this.jdField_a_of_type_ComTencentDeviceFileDevVideoMsgProcessor.a(paramSession, localjxh.jdField_a_of_type_JavaLangString, localjxh.jdField_a_of_type_Long, localjxh.jdField_a_of_type_Int, paramFloat);
    ...
    for (localDevMsgViewData.jdField_a_of_type_Int = 1002;; localDevMsgViewData.jdField_a_of_type_Int = 2002)
    {
      ...
      localDevMsgViewData.jdField_a_of_type_Long = localjxh.jdField_a_of_type_Long;
      ...
      this.jdField_a_of_type_ComTencentDeviceFileDevAudioMsgProcessor.a(paramSession, localjxh.jdField_a_of_type_JavaLangString, localjxh.jdField_a_of_type_Long, localjxh.jdField_a_of_type_Int, paramFloat);
      break;
    }
  }
  ...
  public void a(Session paramSession, boolean paramBoolean)
  {
    ...
    if (paramSession == null) {
      QLog.e(jdField_a_of_type_JavaLangString, 1, "onServiceSessionComplete, session == null !!!!!");
    }
    jxh localjxh;
    do
    {
      ...
      localjxh = (jxh)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramSession.uSessionID));
    } while (localjxh == null);
    label132:
    Object localObject1;
    Object localObject2;
    ...
    for (int i = 2003;; i = 2005)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler.sendMessageDelayed((Message)localObject1, 0L);
      this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.remove(String.valueOf(paramSession.uSessionID));
      this.jdField_a_of_type_JavaUtilSet.remove(Long.valueOf(localjxh.jdField_a_of_type_Long));
      if (!paramBoolean) {
        break label433;
      }
      this.b.remove(Long.valueOf(localjxh.jdField_a_of_type_Long));
      return;
      ...
      localObject1 = (QQAppInterface)localObject1;
      localObject2 = ((QQAppInterface)localObject1).a().a(localjxh.jdField_a_of_type_JavaLangString, localjxh.jdField_a_of_type_Int, localjxh.jdField_a_of_type_Long);
      if (localObject2 == null) {
        break;
      }
    ...
    label433:
    this.b.put(Long.valueOf(localjxh.jdField_a_of_type_Long), Long.valueOf(MessageCache.a()));
  }
  ...
  public void a(String paramString1, String paramString2, long paramLong1, long paramLong2, int paramInt1, int paramInt2)
  {
    ...
    {
      localObject1 = (QQAppInterface)localObject1;
      Object localObject2 = (SmartDeviceProxyMgr)((QQAppInterface)localObject1).a(51);
      ...
      paramString2 = new jxh(this, String.valueOf(paramLong1), paramLong2, paramInt1, paramString2, ((Session)localObject1).uFileSizeSrc);
    ...
    while (!paramString1.equalsIgnoreCase(DeviceMsgHandle.f))
    {
      ...
      {
        return;
        localObject1 = ((DeviceFileHandler)((QQAppInterface)localObject1).a(50)).a(paramString2, paramString1, null, paramLong1);
  ...
  public boolean a(long paramLong)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (((jxh)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).jdField_a_of_type_Long == paramLong) {
        return true;
      }
    }
    return false;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localjxh = (jxh)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(String.valueOf(paramBundle.uSessionID));
    } while (localjxh == null);
    paramBundle.strFilePathSrc = localjxh.jdField_b_of_type_JavaLangString;
    paramBundle.uFileSizeSrc = localjxh.jdField_b_of_type_Long;
    Object localObject1 = this.jdField_a_of_type_ComTencentDeviceFileDevAudioMsgProcessor;
    Object localObject2 = localjxh.jdField_a_of_type_JavaLangString;
    long l = localjxh.jdField_a_of_type_Long;
    int j = localjxh.jdField_a_of_type_Int;
    if (i == 0)
    {
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\device\file\DeviceAVFileMsgObserver.class
