  ...
  implements DeviceAVFileMsgObserver.DevMsgProcessor
{
  ...
  public long a(String paramString, long paramLong)
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      SmartDeviceProxyMgr localSmartDeviceProxyMgr = (SmartDeviceProxyMgr)((QQAppInterface)localObject).a(51);
      if ((localSmartDeviceProxyMgr != null) && (localSmartDeviceProxyMgr.b(paramLong))) {
        return localSmartDeviceProxyMgr.a(paramLong, paramString, 0);
      }
      paramString = ((DeviceFileHandler)((QQAppInterface)localObject).a(50)).a(paramString, DeviceMsgHandle.f, null, paramLong);
      if (paramString != null) {
  ...
  public void a(Session paramSession)
  {
    ...
    {
      localObject = (QQAppInterface)localObject;
      localMessageForDevPtt = (MessageForDevPtt)MessageRecordFactory.a(61035);
      byte[] arrayOfByte = new byte[3];
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\device\file\DevAudioMsgProcessor.class
