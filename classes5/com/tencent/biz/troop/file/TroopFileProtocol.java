...
{
  public static final String A = "itemKey";
  public static final String B = "uin_filter";
  public static final String C = "sessionId";
  public static final int a = -1;
  public static final String a = "OidbSvc.0x6d6_0";
  public static final int b = -2;
  public static final String b = "OidbSvc.0x6d6_1";
  public static final int c = 0;
  public static final String c = "OidbSvc.0x6d6_2";
  public static final int d = 1;
  public static final String d = "OidbSvc.0x6d6_3";
  public static final int e = 2;
  public static final String e = "OidbSvc.0x6d6_5";
  public static final int f = 3;
  public static final String f = "OidbSvc.0x6d7_0";
  public static final int g = 48;
  public static final String g = "OidbSvc.0x6d7_1";
  public static final int h = 102;
  public static final String h = "OidbSvc.0x6d7_2";
  public static final int i = 104;
  public static final String i = "OidbSvc.0x6d7_3";
  public static final String j = "OidbSvc.0x6d8_0";
  public static final String k = "OidbSvc.0x6d8_1";
  public static final String l = "OidbSvc.0x6d8_4";
  public static final String m = "OidbSvc.0x6d9_0";
  public static final String n = "OidbSvc.0x6d9_2";
  public static final String o = "OidbSvc.0x6d9_4";
  public static final String p = "TroopFileProtocol";
  public static final String q = "troopUin";
  public static final String r = "reqFor";
  public static final String s = "reqFrom";
  public static final String t = "isFirstPage";
  public static final String u = "parentFileId";
  public static final String v = "folderId";
  public static final String w = "fileId";
  public static final String x = "folderName";
  public static final String y = "thumbNail";
  public static final String z = "isPreview";
  
  public TroopFileProtocol()
  {
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong1, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, String paramString, int paramInt6, long paramLong2, int paramInt7, ByteStringMicro paramByteStringMicro, TroopFileProtocol.GetFileListObserver paramGetFileListObserver)
  {
    ...
    for (;;)
    {
      ...
      ProtoUtils.a(paramQQAppInterface, paramGetFileListObserver, paramString.toByteArray(), "OidbSvc.0x6d8_1", 1752, 1, paramByteStringMicro);
      return;
      bool = false;
      break;
      label310:
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString, TroopFileProtocol.GetOneFileInfoObserver paramGetOneFileInfoObserver)
  {
    ...
    ProtoUtils.a(paramQQAppInterface, paramGetOneFileInfoObserver, paramString.toByteArray(), "OidbSvc.0x6d8_0", 1752, 0);
  }
  
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString1, String paramString2, TroopFileProtocol.DeleteFileObserver paramDeleteFileObserver)
  {
    if ((paramLong == 0L) || (TextUtils.isEmpty(paramString1))) {
      return;
    }
    Object localObject = new oidb_0x6d6.DeleteFileReqBody();
    ((oidb_0x6d6.DeleteFileReqBody)localObject).uint32_bus_id.set(paramInt);
    ...
    ProtoUtils.a(paramQQAppInterface, paramDeleteFileObserver, paramString2.toByteArray(), "OidbSvc.0x6d6_3", 1750, 3, (Bundle)localObject);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, int paramInt, String paramString1, String paramString2, String paramString3, TroopFileProtocol.MoveFileObserver paramMoveFileObserver)
  {
    ...
    ProtoUtils.a(paramQQAppInterface, paramMoveFileObserver, paramString1.toByteArray(), "OidbSvc.0x6d6_5", 1750, 5);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileInfo paramTroopFileInfo, TroopFileProtocol.ReqTransFileObserver paramReqTransFileObserver)
  {
    ...
    ProtoUtils.a(paramQQAppInterface, paramReqTransFileObserver, paramTroopFileInfo.toByteArray(), "OidbSvc.0x6d9_0", 1753, 0, localBundle);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, int paramInt, boolean paramBoolean, TroopFileProtocol.ReqDownloadFileObserver paramReqDownloadFileObserver)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      ProtoUtils.a(paramQQAppInterface, paramReqDownloadFileObserver, paramItem.toByteArray(), "OidbSvc.0x6d6_2", 1750, 2, (Bundle)localObject);
      return;
    }
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, TroopFileProtocol.ReqFeedsObserver paramReqFeedsObserver)
  {
    ...
    try
    {
      ...
      ProtoUtils.a(paramQQAppInterface, paramReqFeedsObserver, paramItem.toByteArray(), "OidbSvc.0x6d9_4", 1753, 4, (Bundle)localObject1);
      return;
    }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, TroopFileProtocol.ReqResendFileObserver paramReqResendFileObserver)
  {
    ...
    ((Bundle)localObject).putString("itemKey", paramItem.Id.toString());
    ((Bundle)localObject).putLong("troopUin", paramLong);
    ProtoUtils.a(paramQQAppInterface, paramReqResendFileObserver, localReqBody.toByteArray(), "OidbSvc.0x6d6_1", 1750, 1, (Bundle)localObject);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, TroopFileTransferManager.Item paramItem, TroopFileProtocol.ReqUploadFileObserver paramReqUploadFileObserver)
  {
    ...
    for (int i1 = 5;; i1 = 4)
    {
      ...
      ((Bundle)localObject1).putString("itemKey", paramItem.Id.toString());
      ((Bundle)localObject1).putLong("troopUin", paramLong);
      ProtoUtils.a(paramQQAppInterface, paramReqUploadFileObserver, ((oidb_0x6d6.ReqBody)localObject2).toByteArray(), "OidbSvc.0x6d6_0", 1750, 0, (Bundle)localObject1);
      return;
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, int paramInt, TroopFileProtocol.GetFilePreviewObserver paramGetFilePreviewObserver)
  {
    ...
    ProtoUtils.a(paramQQAppInterface, paramGetFilePreviewObserver, paramString.toByteArray(), "OidbSvc.0x6d8_4", 1752, 4);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString, TroopFileProtocol.DeleteFolderObserver paramDeleteFolderObserver)
  {
    ...
    ProtoUtils.a(paramQQAppInterface, paramDeleteFolderObserver, paramString.toByteArray(), "OidbSvc.0x6d7_1", 1751, 1);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, TroopFileProtocol.CreateFolderObserver paramCreateFolderObserver)
  {
    ...
    ProtoUtils.a(paramQQAppInterface, paramCreateFolderObserver, paramString1.toByteArray(), "OidbSvc.0x6d7_0", 1751, 0);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, TroopFileProtocol.RenameFolderObserver paramRenameFolderObserver)
  {
    ...
    ProtoUtils.a(paramQQAppInterface, paramRenameFolderObserver, localReqBody.toByteArray(), "OidbSvc.0x6d7_2", 1751, 2, (Bundle)localObject);
  }
  ...
  {
    paramString1 = new HttpWebCgiAsyncTask2("http://" + paramString1 + ":" + paramString2 + "/ftn_compress_list/rkey=" + paramString3 + "&filetype=" + paramInt + "&path=" + paramString4 + "&", "GET", new jei(new ArrayList(), paramString4, paramFileManagerEntity, paramInt, paramQQAppInterface, paramOnGetZipFileList), 1000, null);
    ...
    paramString3.put("CONTEXT", paramQQAppInterface.a().getApplicationContext());
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\biz\troop\file\TroopFileProtocol.class
