  ...
  implements View.OnClickListener
{
  ...
  private void a(int paramInt)
  {
    ...
    hgb localhgb = new hgb(this);
    this.jdField_a_of_type_JavaUtilTimer.schedule(localhgb, paramInt, paramInt);
  }
    ...
    if (paramBoolean)
    {
      ...
      if (i < this.jdField_a_of_type_TencentImTroop_search_popclassifcPopclassifc$BannerCard.rpt_banner_items.size())
      {
        ...
        if (i == 0)
        {
          ...
          localImageView.setImageResource(2130837548);
        }
        for (;;)
        {
  ...
  private void g()
  {
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131299526));
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager = ((ViewPager)findViewById(2131299525));
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setAdapter(new TroopCardBanner.CPagerAdapter(this));
    this.jdField_a_of_type_AndroidSupportV4ViewViewPager.setOnPageChangeListener(new hga(this));
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\biz\addContactTroopView\TroopCardBanner.class
