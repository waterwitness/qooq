  ...
  extends BaseTroopCardView
{
  ...
  public TroopCardXingquBuluo(ContactBaseView.IAddContactContext paramIAddContactContext)
  {
    super(paramIAddContactContext);
    boolean bool = NotVerifyClass.DO_VERIFY_CLASS;
    this.jdField_a_of_type_AndroidWidgetBaseAdapter = new hgl(this);
  }
  ...
  private void h()
  {
    this.jdField_a_of_type_ComTencentBizWidgetsGridViewForScrollView.setOnItemClickListener(new hgj(this));
  }
  ...
  private void j()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setOnClickListener(new hgk(this));
  }
  ...
  public void a(searchtab.Card paramCard)
  {
    if (paramCard != null)
    {
      ...
      this.jdField_a_of_type_JavaUtilList = paramCard.rpt_item3.get();
      this.b.setText(this.jdField_a_of_type_TencentImTroop_search_searchtabSearchtab$Card.title_bar.str_desc.get());
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\biz\addContactTroopView\TroopCardXingquBuluo.class
