...
public class AddContactTroopHandler
{
  ...
  private userinfo.UserInfo a(SosoInterface.SosoLbsInfo paramSosoLbsInfo)
  {
    ...
    try
    {
      ...
      localUserInfo.bytes_client_version.set(ByteStringMicro.copyFromUtf8("6.5.5"));
  ...
  private void a(userinfo.UserInfo paramUserInfo, AddContactTroopHandler.IGetPopClassAndSearchCB paramIGetPopClassAndSearchCB)
  {
    ...
    a("SearchAsmTab.GetPopClassific", localReqBody.toByteArray(), new hfy(this, paramIGetPopClassAndSearchCB));
  }
  ...
  private void b(userinfo.UserInfo paramUserInfo, AddContactTroopHandler.IGetPopClassAndSearchCB paramIGetPopClassAndSearchCB)
  {
    ...
    a("SearchAsmTab.GetAsmInfo", localReqBody.toByteArray(), new hfz(this, paramIGetPopClassAndSearchCB));
  }
  ...
  {
    SosoInterface.a(new hfx(this, 0, true, false, 60000L, false, false, "AddContactTroopHandler", paramIGetPopClassAndSearchCB1, paramIGetPopClassAndSearchCB2));
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\biz\addContactTroopView\AddContactTroopHandler.class
