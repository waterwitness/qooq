...
public class AnonymousChatHelper
{
  ...
  public static final String a = "http://pub.idqqimg.com/pc/group/anony/portrait/img/";
  public static final int b;
  public static final String b = "http://qqweb.qq.com/m/business/anonymoustalk/index.html?_wv=5123&_bid=227";
  ...
  public static AnonymousChatHelper.AnonymousExtInfo a(MessageRecord paramMessageRecord)
  {
    ...
    try
    {
      ...
      if (((JSONObject)localObject).has("expire_time")) {
        paramMessageRecord.c = ((JSONObject)localObject).getInt("expire_time");
      }
  ...
  public static String a(int paramInt1, String paramString1, String paramString2, int paramInt2, int paramInt3)
  {
  ...
  public static boolean a(Context paramContext, QQAppInterface paramQQAppInterface)
  {
    ...
    if (paramContext.getBoolean("first_enter_anonymous" + paramQQAppInterface.a(), true))
    {
      paramContext.edit().putBoolean("first_enter_anonymous" + paramQQAppInterface.a(), false).commit();
      return true;
    }
    return false;
  }
  ...
  public String a(String paramString1, String paramString2)
  {
    ...
    return this.jdField_a_of_type_ComTencentBizAnonymousAnonymousChatHelper$AnonymousReport.c;
  }
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    paramMessageRecord.saveExtInfoToExtStr("anonymous", a(2, localAnonymousInfo.jdField_b_of_type_JavaLangString, localAnonymousInfo.jdField_a_of_type_JavaLangString, localAnonymousInfo.jdField_a_of_type_Int, localAnonymousInfo.jdField_b_of_type_Int));
  }
  
  public void a(String paramString1, long paramLong, int paramInt1, String paramString2, int paramInt2, String paramString3)
  {
  ...
  public void a(String paramString1, String paramString2, MessageRecord paramMessageRecord)
  {
    ...
    this.jdField_a_of_type_ComTencentBizAnonymousAnonymousChatHelper$AnonymousReport.c = paramMessageRecord;
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\biz\anonymous\AnonymousChatHelper.class
