  ...
  extends BaseAdapter
{
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentBizPoiMapActivity.p = localPOI.jdField_a_of_type_JavaLangString;
      this.jdField_a_of_type_ComTencentBizPoiMapActivity.q = localPOI.jdField_b_of_type_JavaLangString;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131299856));
      ...
      paramViewGroup.jdField_c_of_type_AndroidViewView = paramView.findViewById(2131299862);
      paramViewGroup.jdField_d_of_type_AndroidViewView = paramView.findViewById(2131299863);
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131299854);
      paramViewGroup.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131299858));
      paramViewGroup.jdField_c_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131299859));
      paramViewGroup.jdField_d_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131299860));
    ...
    for (paramViewGroup = str + this.jdField_a_of_type_ComTencentBizPoiMapActivity.getString(2131364976);; paramViewGroup = str + this.jdField_a_of_type_ComTencentBizPoiMapActivity.getString(2131364977))
    {
      ...
      Object localObject = this.jdField_a_of_type_ComTencentBizPoiMapActivity.getResources().getDrawable(2130839495);
      int i = this.jdField_a_of_type_ComTencentBizPoiMapActivity.getResources().getDimensionPixelSize(2131493268);
      int j = this.jdField_a_of_type_ComTencentBizPoiMapActivity.getResources().getDimensionPixelSize(2131493269);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\biz\PoiMapActivity$PoiItemAdapter.class
