  ...
  extends QQCustomDialog
{
  ...
  {
    InputDialog localInputDialog = new InputDialog(paramContext, 2131558973);
    localInputDialog.setContentView(2130903241);
    ...
    paramString1.setBackgroundResource(2130840097);
  ...
  public InputDialog a(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.lBtn.setOnClickListener(new jix(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
  ...
  public InputDialog b(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.rBtn.setOnClickListener(new jiy(this, paramOnClickListener));
    setSeperatorState();
    return this;
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\biz\widgets\InputDialog.class
