...
public class PluginJumpManager
{
  ...
  {
    Object localObject1 = new File(HtmlOffline.a("1007") + "1007" + "/urlplugin.cfg");
  ...
  public boolean openView(Activity paramActivity, String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean)
  {
    ...
    PluginManagerHelper.getPluginInterface(paramActivity.getApplicationContext(), new jff(this, (PluginJumpManager.BidInfo)localObject2, paramActivity, paramString3, paramString1, paramString4, l, (PluginJumpManager.UrlMappingInfo)localObject1, paramString2));
    return true;
  }
  ...
  public void updateConfig(AppRuntime paramAppRuntime)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      ...
      HtmlOffline.b("1007", paramAppRuntime, true, new jfd(this));
      return;
    }
  }
}
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\biz\troopplugin\PluginJumpManager.class
