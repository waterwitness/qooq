  ...
  implements QQRecorder.OnQQRecorderListener
{
  ...
  private VoicePlayer.VoicePlayerListener jdField_a_of_type_ComTencentMobileqqUtilsVoicePlayer$VoicePlayerListener = new ifc(this);
  ...
  private void j()
  {
    SpannableString localSpannableString = new SpannableString(this.jdField_a_of_type_AndroidAppActivity.getString(2131367639));
    DialogUtil.a(this.jdField_a_of_type_AndroidAppActivity, "权限提示", localSpannableString, 0, 2131369401, null, null, new iff(this)).show();
  }
  ...
  public int a()
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin$PluginRuntime.a() != null) {
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin$PluginRuntime.a().a(PublicAccountH5AbilityPlugin.t, new String[] { localJSONObject.toString() });
      }
  ...
  {
    if (a(AppConstants.bj + this.jdField_b_of_type_JavaLangString + "/" + "c2bPTT/"))
    {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin$PluginRuntime.a() != null) {
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin$PluginRuntime.a().a(PublicAccountH5AbilityPlugin.t, new String[] { paramString.toString() });
      }
      ReportController.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D29", "0X8005D29", 0, -1, "1", "", "", "");
      return;
    }
    ...
    for (;;)
    {
      try
      {
        if (jdField_a_of_type_Double == this.jdField_b_of_type_Int)
        {
          ...
          paramString.put("localId", f());
          if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin$PluginRuntime.a() != null) {
            this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin$PluginRuntime.a().a(PublicAccountH5AbilityPlugin.x, new String[] { paramString.toString() });
          }
        ...
        {
          paramString.put("retCode", 0);
          paramString.put("msg", "localId 为" + f());
          paramString.put("localId", f());
          ReportController.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D2A", "0X8005D2A", 0, 0, "1", "", "", "");
          if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin$PluginRuntime.a() == null) {
            break;
          }
          this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin$PluginRuntime.a().a(PublicAccountH5AbilityPlugin.u, new String[] { paramString.toString() });
          return;
        }
      }
  ...
  public void a(String paramString1, QQRecorder.RecorderParam paramRecorderParam, String paramString2)
  {
    ...
    try
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin$PluginRuntime.a() != null) {
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin$PluginRuntime.a().a(PublicAccountH5AbilityPlugin.t, new String[] { paramString1.toString() });
      }
      ReportController.b(null, "P_CliOper", "Pb_account_lifeservice", "", "0X8005D29", "0X8005D29", 0, -1, "1", "", "", "");
      return;
    }
  ...
  {
    return AppConstants.bj + this.jdField_b_of_type_JavaLangString + "/" + "c2bPTT/" + paramString + ".amr";
  }
  ...
  public void b()
  {
    ...
    f = AppConstants.bj + this.jdField_b_of_type_JavaLangString + "/" + "c2bPTT/" + FileMsg.a() + ".amr";
  ...
  {
    this.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new ife(this));
  }
  ...
  public void e()
  {
    ...
    {
      localJSONObject.put("retCode", 0);
      localJSONObject.put("msg", "录音(" + f() + ")播放结束");
      localJSONObject.put("localId", f());
      if (this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin$PluginRuntime.a() != null) {
        this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin$PluginRuntime.a().a(PublicAccountH5AbilityPlugin.w, new String[] { localJSONObject.toString() });
      }
      return;
    }
    catch (JSONException localJSONException)
  ...
  public String f()
  {
    ...
    localObject1 = "";
    if (((String)localObject2).length() >= 21) {
  ...
  public void i()
  {
    this.jdField_a_of_type_AndroidAppActivity.runOnUiThread(new ifd(this));
  }
}


/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\biz\pubaccount\util\PublicAccountH5AbilityForPtt.class
