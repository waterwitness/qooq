...
{
  public static final String a = "PAH5Manager";
  ...
  HashMap jdField_c_of_type_JavaUtilHashMap;
  private String f;
  
  public PAH5Manager(TroopMemberApiService paramTroopMemberApiService, QQAppInterface paramQQAppInterface)
  {
    boolean bool = NotVerifyClass.DO_VERIFY_CLASS;
    this.jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new iet(this);
  ...
  public PAH5Manager(QQAppInterface paramQQAppInterface)
  {
    this.jdField_a_of_type_ComTencentMobileqqTransfileTransProcessorHandler = new iet(this);
    this.jdField_a_of_type_JavaUtilHashMap = new HashMap();
    this.jdField_b_of_type_JavaUtilHashMap = new HashMap();
  ...
  public void a(Bundle paramBundle)
  {
    ...
    this.f = paramBundle.getString("pic_puin");
  ...
  public void a(NetResp paramNetResp)
  {
    Object localObject;
    Bundle localBundle;
    if ((paramNetResp != null) && ((paramNetResp.a instanceof HttpNetReq)))
    {
      localObject = (HttpNetReq)paramNetResp.a;
      if ((paramNetResp.jdField_e_of_type_Int == 0) || (paramNetResp.jdField_e_of_type_Int == 1))
      {
        ...
        if (localBundle != null)
        {
          if ((((HttpNetReq)localObject).jdField_a_of_type_JavaLangString == null) || (paramNetResp.jdField_e_of_type_Int != 0)) {
            break label278;
          }
          ...
          localObject = ((HttpNetReq)localObject).jdField_b_of_type_JavaLangString;
  ...
  public void b(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localHttpNetReq.jdField_b_of_type_JavaLangString = (AppConstants.bj + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount() + "/" + "c2bPIC/" + (String)localObject1 + ".png");
      Object localObject2 = new File(AppConstants.bj + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount() + "/" + "c2bPIC/");
      ArrayList localArrayList = new ArrayList();
  ...
  public void d(Bundle paramBundle)
  {
    ...
    ((TransferRequest)localObject).h = (AppConstants.bj + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount() + "/" + "c2bPTT/" + str + ".amr");
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\biz\pubaccount\util\PAH5Manager.class
