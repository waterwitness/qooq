...
import tencent.im.oidb.cmd0x472.Oidb_0x472.ReqBody;
import tencent.im.oidb.cmd0x472.Oidb_0x472.ReqChannelPara;
  ...
  extends BusinessHandler
{
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = SubscriptHandler.class.getSimpleName();
  }
  ...
  public static ReadInJoyArticle a(Oidb_0x472.ArticleSummary paramArticleSummary, int paramInt)
  {
    ...
    do
    {
      do
      {
        return (ReadInJoyArticle)localObject;
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (boolean bool1 = true;; bool1 = false)
    {
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "handleGetRecommendList onReceive :" + bool1);
      }
      if (bool1) {
        break;
      }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        QLog.i(jdField_a_of_type_JavaLangString, 2, "result: " + i);
      }
      ...
      if ((((oidb_cmd0x439.RspBody)localObject1).rpt_msg_subscribe_info.has()) && (((oidb_cmd0x439.RspBody)localObject1).rpt_msg_subscribe_info.get() != null))
      {
        ...
        paramFromServiceMsg = new ArrayList(((List)paramObject).size());
        paramObject = ((List)paramObject).iterator();
        if (((Iterator)paramObject).hasNext())
        {
          Object localObject2 = (oidb_cmd0x439.SubscribeInfo)((Iterator)paramObject).next();
          ...
          if (QLog.isColorLevel()) {
            QLog.i(jdField_a_of_type_JavaLangString, 2, "handleGetRecommendList create SubscriptRecommendAccountInfo id: " + ((SubscriptRecommendAccountInfo)localObject1).jdField_a_of_type_Long + " | name: " + ((SubscriptRecommendAccountInfo)localObject1).jdField_a_of_type_JavaLangString + " | article: " + ((SubscriptRecommendAccountInfo)localObject1).jdField_a_of_type_ComTencentBizPubaccountSubscriptReadInJoyArticle.mTitle);
          }
          ...
          QLog.e(jdField_a_of_type_JavaLangString, 2, "handleGetRecommendList onReceive fail: ", paramToServiceMsg);
          return;
        }
      ...
      for (;;)
      {
        ...
        {
          super.a(1, bool1, paramToServiceMsg);
          return;
        }
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.e(jdField_a_of_type_JavaLangString, 2, "handleGetRecommendList onReceive fail, list is null");
        return;
        paramToServiceMsg = paramFromServiceMsg;
      }
      label747:
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      ...
      paramFromServiceMsg = null;
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "handleGetReadinjoyRecommentList onReceive :" + bool1);
      }
      if (bool1) {
        bool2 = bool1;
      }
      ...
      for (;;)
      {
        try
        {
          ...
          if (i == 0)
          {
            ...
            {
              bool2 = bool1;
              QLog.e(jdField_a_of_type_JavaLangString, 2, "result: " + i);
            }
            if (!bool1) {
              continue;
            }
            ...
            bool2 = bool1;
            ((Oidb_0x472.RspBody)paramObject).mergeFrom(paramToServiceMsg);
            bool2 = bool1;
            boolean bool3 = ((Oidb_0x472.RspBody)paramObject).rspChannelArticle.has();
            if (!bool3) {
              continue;
            }
            bool1 = false;
        ...
        try
        {
          paramToServiceMsg = (Oidb_0x472.RspChannelArticle)((Oidb_0x472.RspBody)paramObject).rspChannelArticle.get();
          ...
          paramToServiceMsg = new ArrayList(((List)paramObject).size());
          try
          {
    ...
    for (;;)
    {
      ...
      super.a(2, bool1, paramToServiceMsg);
      return;
      bool1 = false;
      break;
      bool1 = false;
  ...
  public void a(String paramString)
  {
    ...
    if (QLog.isDevelopLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 4, "getRecommendListAsync() start uinStr: " + paramString);
    }
    ...
    for (;;)
    {
      ...
      super.b(super.a("OidbSvc.1081", 1081, 0, paramString.toByteArray()));
      return;
      i = 2;
      continue;
      i = 3;
  ...
  public void b(String paramString)
  {
    ...
    paramString = new Oidb_0x472.ReqBody();
    paramString.uint64_uin.set(l);
    Oidb_0x472.ReqChannelPara localReqChannelPara = new Oidb_0x472.ReqChannelPara();
    localReqChannelPara.uint64_channel_id.set(0L);
    localReqChannelPara.uint32_req_channel_list.set(1);
    paramString.reqChannelPara.set(localReqChannelPara);
    super.b(super.a("OidbSvc.0x472", 1138, 1, paramString.toByteArray()));
  }
}


/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\biz\pubaccount\subscript\SubscriptHandler.class
