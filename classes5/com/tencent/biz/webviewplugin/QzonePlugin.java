  ...
  extends WebViewPlugin
{
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    new Handler().post(new jhv(this, paramArrayOfByte));
    this.c = this.d;
  }
    ...
    if ((paramLong == 8589934601L) && (this.b != null) && (!"".equals(this.b)))
    {
      ...
      if ("com.tencent.mobileqq.opencenter.vipInfo".equals(this.b))
      {
        ...
        if ((paramMap != null) && ((paramMap instanceof WebUiUtils.QQBrowserBaseActivityInterface))) {
          paramString.putExtra("key_pay_action_result", ((WebUiUtils.QQBrowserBaseActivityInterface)paramMap).c());
        }
      }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\biz\webviewplugin\QzonePlugin.class
