...
public class ThridAppShareHelper
{
  ...
  public void a(Context paramContext, String paramString1, String paramString2, SessionInfo paramSessionInfo)
  {
    ...
    {
      if (!DataProviderApi.b(paramContext, localThirdAppInfo.d, paramString1, "android.intent.action.VIEW", "com.tencent.mobileqq", "com.tencent.mobileqq.activity.JumpActivity"))
      {
  ...
  {
    if (11 != paramIntent.getIntExtra("forward_type", Integer.MAX_VALUE))
    {
    ...
    catch (JSONException localJSONException2)
    {
      for (;;)
      {
        try
        {
          ...
          localThirdAppInfo.d = ((JSONObject)localObject2).optString("defaultScheme_a");
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\biz\thridappshare\ThridAppShareHelper.class
