  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup.setBackgroundResource(2130839274);
      paramViewGroup.setClickable(true);
      paramViewGroup.setOnClickListener(this.jdField_a_of_type_ComTencentBizLebasearchSearchActivity.a);
    ...
    for (;;)
    {
      ...
      break;
      label150:
      Object localObject = this.jdField_a_of_type_ComTencentBizLebasearchSearchActivity.getString(2131364995, new Object[] { str });
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\biz\lebasearch\SearchActivity$SearchAsociatedWordAdapter.class
