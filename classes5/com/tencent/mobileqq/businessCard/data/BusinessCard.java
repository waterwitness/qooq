  ...
  implements Parcelable
{
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("BusinessCard{").append("cardId=" + this.cardId).append(", cardName=" + this.cardName).append(", company=" + this.company).append(", bindUin=" + this.bindUin).append(", bindMobile = " + this.bindMobile).append("\n picUrl=" + this.picUrl).append("\n ocrInfo=" + this.OCRInfo).append("\n qqNum=" + this.qqNum).append("\n uinInfo=" + this.uinInfos).append("\n mobilesNum=" + this.mobilesNum).append("\n mobileInfo=" + this.mobileInfos).append("\n desc=" + this.descs).append(", cardType=" + this.cardType).append(", lastUpdateTime=" + this.lastUpdateTime).append('}');
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\businessCard\data\BusinessCard.class
