...
{
  public static final float a = 0.87F;
  ...
  void a(BusinessCardChildViewTransform paramBusinessCardChildViewTransform, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_Boolean) && (paramBusinessCardChildViewTransform.a > 0.87F))
    {
  ...
  public void a(Object paramObject, String paramString1, String paramString2, String paramString3, String paramString4, boolean paramBoolean)
  {
    ...
    label246:
    label262:
    for (this.jdField_a_of_type_JavaLangString = localResources.getString(2131371247, new Object[] { paramObject, paramString1, paramString2, paramString3 });; this.jdField_a_of_type_JavaLangString = paramString1)
    {
  ...
  public void a(String paramString)
  {
    ...
    {
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840561);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.w("BusinessCardChildView", 2, "bindCardPictureWithUrl:mTaskProgress=" + this.jdField_b_of_type_Float + "pic=" + paramString);
    }
    try
    {
      ...
      ((URLDrawable.URLDrawableOptions)localObject).mFailedDrawable = super.getResources().getDrawable(2130840561);
      ((URLDrawable.URLDrawableOptions)localObject).mLoadingDrawable = super.getResources().getDrawable(2130840561);
  ...
  void a(qxd paramqxd)
  {
    this.jdField_a_of_type_Qxd = paramqxd;
  }
  ...
  void b()
  {
    ...
    if (this.jdField_a_of_type_Qxd != null) {
      this.jdField_a_of_type_Qxd.a(this, false);
    }
    super.invalidate();
  }
  ...
  {
    if (this.jdField_a_of_type_Qxd != null) {
      this.jdField_a_of_type_Qxd.a(this, a());
    }
  }
  ...
  protected void onFinishInflate()
  {
    ...
    this.jdField_a_of_type_AndroidViewView = findViewById(2131301334);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131301336));
    this.jdField_b_of_type_AndroidViewView = findViewById(2131301337);
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131301339));
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131301340));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131301341));
    this.d = ((TextView)findViewById(2131301338));
    this.e = ((TextView)findViewById(2131301335));
    View localView = findViewById(2131300639);
  ...
  public void setFocusedTask(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Qxd != null) {
      this.jdField_a_of_type_Qxd.a(this, true);
    }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\businessCard\views\BusinessCardChildView.class
