...
public class BusinessCardView
  extends FrameLayout
  implements BusinessCardViewScroller.DeckViewScrollerCallbacks, ViewPool.ViewPoolConsumer, qxd
{
  ...
  private Runnable jdField_a_of_type_JavaLangRunnable = new qxe(this);
  ...
  public BusinessCardView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.c = false;
    this.jdField_b_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131493571);
  }
  ...
  {
    return (BusinessCardChildView)this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130904089, this, false);
  }
  ...
  public void a(int paramInt)
  {
    ...
    float f = this.jdField_a_of_type_ComTencentMobileqqBusinessCardViewsBusinessCardViewLayoutAlgorithm.a(this.jdField_a_of_type_ComTencentMobileqqBusinessCardViewsBusinessCardView$Callback.a().get(paramInt));
  ...
  public void a(int paramInt1, int paramInt2, Rect paramRect, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    a(false, paramBoolean1, paramBoolean2);
  }
  ...
  void a(int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    do
    {
      ...
      while (paramBoolean1)
      {
        ...
        return;
        localObject1 = new qxf(this, paramBoolean2);
      }
  ...
  public void onInitializeAccessibilityEvent(AccessibilityEvent paramAccessibilityEvent)
  {
    ...
    paramAccessibilityEvent.setMaxScrollY(this.jdField_a_of_type_ComTencentMobileqqBusinessCardViewsBusinessCardViewScroller.a(this.jdField_a_of_type_ComTencentMobileqqBusinessCardViewsBusinessCardViewLayoutAlgorithm.c));
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    a(j, paramInt2, new Rect(this.jdField_a_of_type_AndroidGraphicsRect), false, false);
    if (this.jdField_b_of_type_Boolean)
    {
      b();
      a(false);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\businessCard\views\BusinessCardView.class
