...
public class RedLbsInfoUtil
{
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = RedLbsInfoUtil.class.getSimpleName();
  }
  ...
  public LbsCellInfo a()
  {
    ...
    for (;;)
    {
      ...
      {
        QLog.e(jdField_a_of_type_JavaLangString, 1, "getCellInfo exception : e = " + localException.getMessage());
        return null;
      }
      int j = -1;
      int k = -1;
  ...
  public LbsWLanInfo a()
  {
    ...
    {
      QLog.e(jdField_a_of_type_JavaLangString, 1, "getWLanInfo exception : e = " + localException.getMessage());
    }
  ...
  public List a()
  {
    ...
    {
      QLog.e(jdField_a_of_type_JavaLangString, 1, "getWifiScanResult exception : e = " + localException.getMessage());
    }
    return null;
  }
  ...
  public List b()
  {
    for (;;)
    {
      ...
      {
        QLog.e(jdField_a_of_type_JavaLangString, 1, "getNearbyCellInfo exception : e = " + localException.getMessage());
        return null;
      }
      label216:
      int i = 0;
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\redtouch\RedLbsInfoUtil.class
