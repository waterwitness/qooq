...
public class NearbyMineHelper
{
  ...
  public static final String a = "NewNearbyMyTab";
  public static final HashMap a;
  public static final String[] a;
  public static final int b = 3;
  public static final String b = "NewNearbyMyTab.nbr";
  ...
  public static int a(Context paramContext, TextView paramTextView, ViewGroup paramViewGroup)
  {
    Rect localRect = new Rect();
    TextPaint localTextPaint = paramTextView.getPaint();
    paramTextView = paramTextView.getText().toString();
    localTextPaint.getTextBounds(paramTextView, 0, paramTextView.length(), localRect);
    int i = ScreenUtil.jdField_a_of_type_Int / paramViewGroup.getChildCount() / 2;
    return DisplayUtil.b(paramContext, localRect.width() / 2 + i - 5.0F);
  }
  
  public static int a(Context paramContext, BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    paramContext = paramAppInfo.red_display_info.red_type_info.get();
    int j = -1;
    int i = j;
    if (paramContext != null)
    {
      ...
      if (paramContext.size() >= 2) {
        i = ((BusinessInfoCheckUpdate.RedTypeInfo)paramContext.get(1)).red_type.get();
      }
    }
    if (i == 0) {
      return 11;
  ...
  public static int a(AppInterface paramAppInterface, int paramInt)
  {
    ...
    case 100511: 
      label86:
      paramAppInterface = (DatingManager)paramAppInterface.getManager(212);
      if (paramAppInterface == null) {}
      break;
    }
    for (int j = paramAppInterface.a().a(false);; j = 0)
    {
      i = j;
      if (!QLog.isColorLevel()) {
        break;
      }
      NearbyUtils.a(2, "NearbyMineHelper", "getUnCountByPathIDNearby", new Object[] { "dating", Integer.valueOf(j) });
      i = j;
      break;
      FreshNewsManager localFreshNewsManager = (FreshNewsManager)paramAppInterface.getManager(211);
      if (FreshNewsManager.a(paramAppInterface)) {}
      for (j = localFreshNewsManager.a(false);; j = 0)
      {
        i = j;
        if (!QLog.isColorLevel()) {
          break;
        }
        NearbyUtils.a(2, "NearbyMineHelper", "getUnCountByPathIDNearby", new Object[] { "freshnews", Integer.valueOf(j) });
        i = j;
        break;
        paramAppInterface = (DatingManager)paramAppInterface.getManager(212);
        if ((paramAppInterface != null) && (paramAppInterface.a().a(false) > 0)) {}
        for (j = 1;; j = 0)
        {
          i = j;
          if (!QLog.isColorLevel()) {
          ...
          NearbyUtils.a(2, "NearbyMineHelper", "getUnCountByPathIDNearby", new Object[] { "ranking", Integer.valueOf(j) });
          i = j;
          break;
          i = 0;
          break label86;
  ...
  public static NearbyMyTabCard a(AppInterface paramAppInterface)
  {
    ...
    for (;;)
    {
      ...
      {
        paramAppInterface = FileUtils.a(paramAppInterface.a() + "NewNearbyMyTab.nbr", arrayOfClass);
  ...
  public static BusinessInfoCheckUpdate.AppInfo a(QQAppInterface paramQQAppInterface)
  {
    if (QLog.isColorLevel()) {
    ...
    if (FreshNewsManager.a(paramQQAppInterface)) {}
    for (int j = a(paramQQAppInterface, 100519) + 0;; j = 0)
    {
      int i = j;
      if (((Boolean)NearbySPUtil.a(paramQQAppInterface.getAccount(), "nearby_event_file", 4, "config_show_date", Boolean.valueOf(false))).booleanValue()) {
        i = j + a(paramQQAppInterface, 100511);
      }
      j = i;
      ...
      if (j > 0) {
        return localRedTouchManager.a(100510, String.valueOf(100510), j);
      }
  ...
  public static BusinessInfoCheckUpdate.AppInfo a(QQAppInterface paramQQAppInterface, Object[] paramArrayOfObject)
  {
    ...
    for (paramQQAppInterface = ((BusinessInfoCheckUpdate.AppInfo)localObject2).type.get() + "";; paramQQAppInterface = "-1")
    {
      ...
      return (BusinessInfoCheckUpdate.AppInfo)localObject2;
      if (i != 0)
      {
  ...
  public static void a(AppInterface paramAppInterface, NearbyMyTabCard paramNearbyMyTabCard)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      FileUtils.a(paramAppInterface.a() + "NewNearbyMyTab.nbr", new Object[] { paramNearbyMyTabCard });
      return;
    }
  }
  ...
  public static void a(NearbyAppInterface paramNearbyAppInterface, Context paramContext, StrangerInfo paramStrangerInfo)
  {
    ...
    localAllInOne.h = paramStrangerInfo.nickName;
    ...
    localAllInOne.g = 37;
    if ((paramStrangerInfo.uin > 0L) && (((NearbyProcManager)paramNearbyAppInterface.getManager(213)).b(String.valueOf(paramStrangerInfo.uin))))
    {
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\nearpeople\mytab\NearbyMineHelper.class
