  ...
  implements ISearchEngine
{
  ...
  public static final String a = "NetSearchEngine";
  public static final boolean a = true;
  public static double b = 0.0D;
  public static final int b = 2;
  public static final String b = "SEARCH_REQUEST_EXTRA_SEARCH_TYPE";
  public static final int c = 4;
  public static final String c = "SEARCH_REQUEST_EXTRA_PAGE";
  public static final int d = 8;
  public static final String d = "SEARCH_REQUEST_EXTRA_RESULT_COUNT";
  ...
  private umw jdField_a_of_type_Umw;
  private int g;
  ...
  public NetSearchEngine(QQAppInterface paramQQAppInterface, ThreadPoolExecutor paramThreadPoolExecutor, int paramInt)
  {
    ...
    SosoInterface.a(new umu(this, 0, true, false, 60000L, false, false, "SearchContacts"));
  ...
  public List a(SearchRequest paramSearchRequest)
  {
    ...
    this.jdField_a_of_type_Umw = new umw(this, paramSearchRequest.jdField_a_of_type_JavaLangString, arrayOfInt, j, new umv(this, (List)localObject));
    this.jdField_a_of_type_JavaUtilConcurrentFuture = this.jdField_a_of_type_JavaUtilConcurrentThreadPoolExecutor.submit(this.jdField_a_of_type_Umw);
    try
    {
      this.jdField_a_of_type_Umw.a.await();
  ...
  public void a(SearchRequest paramSearchRequest, ISearchListener paramISearchListener)
  {
    ...
    this.jdField_a_of_type_Umw = new umw(this, paramSearchRequest.jdField_a_of_type_JavaLangString, (int[])localObject, j, paramISearchListener);
    this.jdField_a_of_type_JavaUtilConcurrentFuture = this.jdField_a_of_type_JavaUtilConcurrentThreadPoolExecutor.submit(this.jdField_a_of_type_Umw);
  }
  ...
  public void b()
  {
    ...
    if (this.jdField_a_of_type_Umw != null) {
      this.jdField_a_of_type_Umw.a();
    }
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\search\searchengine\NetSearchEngine.class
