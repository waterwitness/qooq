...
{
  private static final String jdField_a_of_type_JavaLangString = "FTSMessageSearchEngine";
  ...
  private GlobalSearchObserver jdField_a_of_type_ComTencentMobileqqAppGlobalSearchObserver = new ull(this);
  private RecentUserProxy jdField_a_of_type_ComTencentMobileqqAppProxyRecentUserProxy;
  private Object jdField_a_of_type_JavaLangObject = new Object();
  private Comparator jdField_a_of_type_JavaUtilComparator = new ulj(this);
  ...
  private ArrayList a(ArrayList paramArrayList)
  {
    ...
    Collections.sort(paramArrayList, new ulk(this));
  ...
  private List a(String paramString1, String paramString2, String paramString3, boolean paramBoolean1, ArrayList paramArrayList, boolean paramBoolean2)
  {
    ...
    Collections.sort(paramArrayList, new ulh(this));
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        if (a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, String.valueOf(((FTSMessage)((FTSMessageSearchEngine.FTSSearchResultItem)localObject4).jdField_a_of_type_JavaUtilList.get(0)).uin), ((FTSMessage)((FTSMessageSearchEngine.FTSSearchResultItem)localObject4).jdField_a_of_type_JavaUtilList.get(0)).istroop))
        {
          ...
          for (paramArrayList = paramString2;; paramArrayList = paramString1)
          {
            ...
            if ((!paramBoolean1) || (((List)localObject2).size() < 4)) {
              break;
            }
  ...
  public static boolean a()
  {
    for (;;)
    {
      ...
      {
        if (jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.size() > 0)
        {
          bool = true;
          return bool;
        }
  ...
  public List a(SearchRequest paramSearchRequest)
  {
    ...
    if (SQLiteFTSUtils.f(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface) == 1) {
      return b(paramSearchRequest, true);
    }
    return a(paramSearchRequest, true);
  }
        ...
        if (??? != null)
        {
          ...
          if (n == 0)
          {
            ...
            if (bool)
            {
              ...
              jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(str, new SoftReference(???));
            }
          }
        }
        for (;;)
          ...
          for (int i1 = ???.size();; i1 = 0)
          {
            ...
            do
            {
              synchronized (jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap)
              {
                ...
                synchronized (jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap)
                {
                  if (!jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.keySet().contains(str)) {
                    jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
                  }
                }
              }
              localArrayList = (ArrayList)((SoftReference)jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(str)).get();
  ...
  public List a(String paramString, boolean paramBoolean)
  {
    ...
    if (??? != null)
    {
      localObject2 = ((StringBuilder)???).toString().trim();
    ...
    for (int k = 1;; k = 2)
    {
      ...
      l4 = System.nanoTime();
      l1 = System.nanoTime();
      localArrayList = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a((String)localObject2, FTSMessage.class, paramBoolean, false);
    ...
    do
    {
      synchronized (jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap)
      {
        ...
        synchronized (jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap)
        {
          if (!jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.keySet().contains(paramString)) {
            jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.clear();
          }
        }
      }
      localArrayList = (ArrayList)((SoftReference)jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString)).get();
    } while (localArrayList == null);
    int m = localArrayList.size();
    long l1 = System.nanoTime();
    paramString = a(paramString, (String)localObject2, null, paramBoolean, localArrayList, true);
    l1 = (System.nanoTime() - l1) / 1000000L;
    long l2 = 0L + l1;
    ...
    return paramString;
    label628:
    long l5 = (System.nanoTime() - l1) / 1000000L;
    long l6;
    if (localArrayList == null)
    {
      ...
      l2 = System.nanoTime();
      ??? = a(paramString, (String)localObject2, null, paramBoolean, localArrayList, false);
      ...
      if (paramBoolean)
      {
        ...
        jdField_b_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramString, new SoftReference(localArrayList));
      }
      paramString = (String)???;
    }
    for (;;)
    {
      ...
      {
        n = paramString.size();
        ((HashMap)???).put("queryConversationSize", Integer.toString(n));
        if (localArrayList == null) {
          break label1180;
        }
        n = localArrayList.size();
        ((HashMap)???).put("resultSize", Integer.toString(n));
        if (localObject2 == null) {
          break label1186;
        }
        n = ((String)localObject2).length();
        ((HashMap)???).put("keyLength", Integer.toString(n));
        StatisticCollector.a(BaseApplication.getContext()).a(null, "SearchMessageStatistic_FTS", true, (l7 - l4) / 1000000L, 0L, (HashMap)???, null);
        l8 = System.nanoTime();
        if (QLog.isColorLevel()) {
          if (localArrayList == null) {
            break label1192;
      ...
      {
        QLog.d("FTSMessageSearchEngine", 2, String.format("fts search,size:%d, refresh time: %dms, query time: %dms, convert time: %dms, report time: %dms", new Object[] { Integer.valueOf(n), Long.valueOf((l4 - l3) / 1000000L), Long.valueOf((l6 - l4) / 1000000L), Long.valueOf((l7 - l6) / 1000000L), Long.valueOf((l8 - l7) / 1000000L) }));
        localObject2 = new HashMap();
        ((HashMap)localObject2).put("keyNum", String.valueOf(i));
        ((HashMap)localObject2).put("firstKeyLen", String.valueOf(j));
        ((HashMap)localObject2).put("searchPage", String.valueOf(k));
        ((HashMap)localObject2).put("useCache", String.valueOf(0));
        ((HashMap)localObject2).put("searchCost", String.valueOf(l1));
        ((HashMap)localObject2).put("singleSearchResultNum", String.valueOf(m));
        ((HashMap)localObject2).put("singleSearchCost", String.valueOf(l5));
        ((HashMap)localObject2).put("groupSortCost", String.valueOf(l2));
        StatisticCollector.a(BaseApplication.getContext()).a(null, "actFtsSearchEvent", true, l1, 0L, (HashMap)???, null);
        return paramString;
  ...
  public void a(SearchRequest paramSearchRequest, ISearchListener paramISearchListener)
  {
    com.tencent.mobileqq.utils.fts.SQLiteFTSUtils.FtsItemClickEvent.e = System.nanoTime();
    com.tencent.mobileqq.utils.fts.SQLiteFTSUtils.FtsItemClickEvent.f = 0L;
    ThreadManager.a(new ule(this, paramSearchRequest, paramISearchListener), 8, null, true);
  }
  ...
  public List b(SearchRequest arg1, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          i = j;
          if (!TextUtils.equals(this.jdField_b_of_type_JavaLangString, str)) {
            i = 1;
          }
        }
        if (i != 0)
        {
          localObject4 = this.e.get(this.jdField_b_of_type_JavaLangString);
    ...
    for (;;)
    {
      ...
      if ((localObject4 != null) && (!((ArrayList)localObject4).isEmpty()))
      {
        ...
        if (i5 < ((ArrayList)localObject4).size())
        {
          ...
          int i6 = m;
          if (TextUtils.equals(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), (CharSequence)localObject5)) {
            i6 = 1;
          }
          i = k;
          if (!TextUtils.equals((CharSequence)localObject5, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.f()))
          {
            i = k;
  ...
  {
    ThreadManager.a(new ulf(this, paramSearchRequest, paramISearchListener), 8, null, true);
  }
  
  public void f()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(this.jdField_a_of_type_ComTencentMobileqqAppGlobalSearchObserver);
  }
  
  public void g()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.b(this.jdField_a_of_type_ComTencentMobileqqAppGlobalSearchObserver);
  }
}


/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\search\ftsmsg\FTSMessageSearchEngine.class
