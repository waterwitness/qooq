...
public class KMAlgorithm
{
  ...
  public static int[] a(long[][] paramArrayOfLong, int paramInt1, int paramInt2)
  {
    ...
    Arrays.fill(arrayOfLong1, Long.MIN_VALUE);
    ...
    if (i < paramInt1)
    {
      ...
      Arrays.fill(arrayOfLong3, Long.MAX_VALUE);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\search\util\KMAlgorithm.class
