  ...
  extends EditText
{
  ...
  private TextWatcher jdField_a_of_type_AndroidTextTextWatcher = new uis(this);
  ...
  protected void onSelectionChanged(int paramInt1, int paramInt2)
  {
    ...
    if ((paramInt1 != paramInt2) && (((ClickableImageSpan[])a().getSpans(Math.min(paramInt1, paramInt2), Math.max(paramInt1, paramInt2), ClickableImageSpan.class)).length != 0))
    {
      ...
      this.jdField_a_of_type_Int = ((uit)localObject).jdField_a_of_type_Int;
      this.b = ((uit)localObject).b;
      i = 1;
    }
    for (;;)
    {
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\richstatus\RichStatusEditText.class
