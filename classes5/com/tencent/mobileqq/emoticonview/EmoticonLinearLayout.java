  ...
  extends LinearLayout
{
  ...
  EmoticonLinearLayout.DataObserver jdField_a_of_type_ComTencentMobileqqEmoticonviewEmoticonLinearLayout$DataObserver = new rjr(this);
  ...
  public EmoticonLinearLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_JavaLangRunnable = new rjs(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    this.jdField_b_of_type_Int = super.getResources().getColor(2131427547);
    setOrientation(1);
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    {
      return true;
      if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_Rjt != null)) {
        removeCallbacks(this.jdField_a_of_type_Rjt);
      }
      ...
      if (this.jdField_a_of_type_AndroidViewView != null)
      {
        if (this.jdField_a_of_type_Rjt == null) {
          this.jdField_a_of_type_Rjt = new rjt(this);
        }
        this.jdField_a_of_type_Rjt.a();
        postDelayed(this.jdField_a_of_type_Rjt, ViewConfiguration.getLongPressTimeout());
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\emoticonview\EmoticonLinearLayout.class
