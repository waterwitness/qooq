      ...
      for (int j = 0; paramView.hasNext(); j = i)
      {
        ...
        if (paramObject != null)
        {
          ...
          if ((paramObject instanceof EmoticonPanelViewBinder))
          {
            ...
            int k = ((EmoticonPanelViewBinder)paramObject).a();
            j += k;
            i = j;
            if (paramInt + 1 <= j)
            {
              ...
              ((EmoticonPanelViewBinder)paramObject).a(i);
              return;
            }
          }
        }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\emoticonview\EmoticonPagerAdapter.class
