...
{
  public static final String g = "ForwardOption.ForwardStructingMsgOption";
  AbsShareMsg a;
  ...
  protected void a()
  {
    ...
    if ((this.jdField_a_of_type_AndroidContentIntent.getBooleanExtra("k_smartdevice", true)) && (super.m())) {
  ...
  protected boolean a(QQCustomDialog paramQQCustomDialog)
  {
    ...
    {
      bool = a(this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg);
  ...
  protected boolean c()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgBrief != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgBrief.equals(this.jdField_a_of_type_AndroidAppActivity.getString(2131363761)))) {
      ReportController.b(null, "CliOper", "", "", "0X8005403", "0X8005403", 0, 0, "", "", "", "");
    }
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg != null) && (this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID == 32))
    {
  ...
  protected int d()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForImageShare))
    {
      ...
      if ((localObject1 == null) || (!QfavBuilder.b(((StructMsgItemImage)localObject1).o).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null))) {}
    }
    else
    {
      for (i = 0;; i = 0)
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg.mMsgServiceID != 32) || (TextUtils.isEmpty((CharSequence)localObject1)) || (TextUtils.isEmpty((CharSequence)localObject2)) || (TextUtils.isEmpty((CharSequence)localObject3)) || (!QfavBuilder.a(Float.valueOf((String)localObject1).floatValue(), Float.valueOf((String)localObject2).floatValue(), (String)localObject4, (String)localObject3, null).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(this.jdField_a_of_type_AndroidAppActivity, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getAccount(), -1, null))) {
          break label538;
        }
      }
  ...
  protected void k()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg instanceof StructMsgForGeneralShare))
    {
      StructMsgForGeneralShare localStructMsgForGeneralShare = (StructMsgForGeneralShare)this.jdField_a_of_type_ComTencentMobileqqStructmsgAbsShareMsg;
      Iterator localIterator = localStructMsgForGeneralShare.iterator();
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if ((localObject2 instanceof StructMsgItemVideo))
            {
              ...
              if (((StructMsgItemVideo)localObject2).a()) {
                VideoReporter.a("0X80065FF", localStructMsgForGeneralShare.uinType, VideoReporter.a(((StructMsgItemVideo)localObject2).n, localStructMsgForGeneralShare.mSourceName), ((StructMsgItemVideo)localObject2).cY, "");
              }
            }
          }
        }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\forward\ForwardStructingMsgOption.class
