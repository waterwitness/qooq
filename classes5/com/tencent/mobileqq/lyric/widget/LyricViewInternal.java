  ...
  extends View
{
  ...
  private static final String c = "ModuleLyricViewInternal";
  protected float a;
  ...
  public LyricViewInternal(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new tab(this, Looper.getMainLooper());
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    paramAttributeSet = (WindowManager)this.jdField_a_of_type_AndroidContentContext.getSystemService("window");
    if (Build.VERSION.SDK_INT < 13) {}
    Object localObject;
    for (this.o = paramAttributeSet.getDefaultDisplay().getWidth();; this.o = ((Point)localObject).x)
    {
      ...
      this.jdField_a_of_type_JavaLangString = paramContext.getString(2131372409);
      this.jdField_b_of_type_JavaLangString = paramContext.getString(2131372410);
  ...
  private void c(Lyric paramLyric1, Lyric paramLyric2)
  {
    if (paramLyric1 != null) {}
    for (;;)
    {
  ...
  {
    this.y = ((paramInt - this.jdField_g_of_type_Int - this.jdField_f_of_type_Int) / (this.jdField_c_of_type_Int + this.jdField_d_of_type_Int) + 1);
    if (this.y < 0) {
      this.y = 2;
    }
  }
        ...
        catch (StringIndexOutOfBoundsException localStringIndexOutOfBoundsException)
        {
          try
          {
            if (paramInt2 == localSentenceUI.jdField_a_of_type_JavaUtilArrayList.size() - 1)
            {
              ...
              paramInt2 = this.jdField_f_of_type_Int + i4 + i1;
              break label783;
  ...
  protected void a(Sentence paramSentence, Canvas paramCanvas, int paramInt1, int paramInt2, Paint paramPaint)
  {
    ...
    {
      ((SentenceUI)paramSentence.get(paramInt2)).a(paramCanvas, paramInt1, i1 + this.jdField_d_of_type_Int, paramPaint, false);
      i1 += i3 + i4;
      paramInt2 += 1;
    }
  }
  ...
  protected void a(Sentence paramSentence, Canvas paramCanvas, int paramInt1, int paramInt2, Paint paramPaint1, Paint paramPaint2)
  {
    ...
    while (paramInt2 < paramSentence.size())
    {
      ((SentenceUI)paramSentence.get(paramInt2)).a(paramCanvas, paramInt1, i1 + this.jdField_d_of_type_Int, paramPaint1, paramPaint2);
      i1 += i3 + i4;
      paramInt2 += 1;
    }
  }
  ...
  protected void a(Sentence paramSentence, Canvas paramCanvas, int paramInt1, int paramInt2, boolean paramBoolean)
  {
    ...
    for (paramSentence = this.jdField_b_of_type_AndroidGraphicsPaint;; paramSentence = this.jdField_a_of_type_AndroidGraphicsPaint)
    {
      ...
      {
        ((SentenceUI)localArrayList.get(paramInt2)).a(paramCanvas, paramInt1, i1 + this.jdField_d_of_type_Int, paramSentence, paramBoolean);
        i1 += i3 + i4;
        paramInt2 += 1;
      }
    }
  ...
  public void a(LyricViewAttribute paramLyricViewAttribute)
  {
    this.jdField_a_of_type_ComTencentMobileqqLyricDataLyric = new Lyric(2, 0, null);
    this.jdField_b_of_type_ComTencentMobileqqLyricDataLyric = new Lyric(2, 0, null);
    this.jdField_e_of_type_Int = paramLyricViewAttribute.jdField_j_of_type_Int;
    this.jdField_c_of_type_Int = paramLyricViewAttribute.jdField_d_of_type_Int;
    this.jdField_d_of_type_Int = paramLyricViewAttribute.i;
    ...
    this.jdField_f_of_type_Int = paramLyricViewAttribute.jdField_h_of_type_Int;
    ...
    this.jdField_h_of_type_Boolean = paramLyricViewAttribute.jdField_a_of_type_Boolean;
    boolean bool = paramLyricViewAttribute.jdField_b_of_type_Boolean;
    this.jdField_j_of_type_Boolean = true;
    this.y = 3;
    this.z = 2;
    this.jdField_h_of_type_Int = paramLyricViewAttribute.l;
    ...
    this.jdField_f_of_type_AndroidGraphicsPaint.setTextSize(this.jdField_b_of_type_Int);
    ...
    this.jdField_g_of_type_AndroidGraphicsPaint.setTextSize(this.jdField_b_of_type_Int);
    ...
    this.jdField_h_of_type_AndroidGraphicsPaint.setTextSize(this.jdField_b_of_type_Int);
    ...
    this.jdField_i_of_type_AndroidGraphicsPaint.setTextSize(this.jdField_b_of_type_Int);
    ...
    this.jdField_g_of_type_Int = this.jdField_d_of_type_Int;
  }
  ...
  {
    if (this.l == -1) {
      this.l = ((int)(43.0F * this.jdField_a_of_type_Float));
    }
    return this.l;
  }
  ...
  public void b(Lyric paramLyric1, Lyric paramLyric2)
  {
    for (;;)
    {
      try
  ...
  public Lyric c()
  {
    return this.jdField_b_of_type_ComTencentMobileqqLyricDataLyric;
  }
  ...
  {
    int i1 = (getMeasuredHeight() >> 1) - this.jdField_c_of_type_Int;
    switch (this.k)
    {
    default: 
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (this.k == 70)
    {
      ...
      this.m = (paramInt2 * (i4 + i5));
      setMeasuredDimension(i2, this.m + i3);
      return;
    }
  ...
  public void setSegment(int paramInt1, int paramInt2)
  {
    ...
    this.p = paramInt1;
    this.q = paramInt2;
    this.r = this.jdField_a_of_type_ComTencentMobileqqLyricDataLyric.b(paramInt1);
    this.s = this.jdField_a_of_type_ComTencentMobileqqLyricDataLyric.e(paramInt2);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\lyric\widget\LyricViewInternal.class
