...
public class Logger
{
  ...
  public static void a(Object paramObject, String paramString1, String paramString2)
  {
    if ((paramObject instanceof PicBaseInfo))
    {
      ...
      RichMediaUtil.c(((PicBaseInfo)paramObject).b, true, 1, ((PicBaseInfo)paramObject).a, paramString1, paramString2);
      return;
    }
    if ((paramObject instanceof MessageForPic))
    {
      paramObject = (MessageForPic)paramObject;
      RichMediaUtil.c(((MessageForPic)paramObject).istroop, true, 1, ((MessageForPic)paramObject).localUUID, paramString1, paramString2);
      return;
    }
  ...
  public static void b(Object paramObject, String paramString1, String paramString2)
  {
    ...
    {
      paramObject = (PicBaseInfo)paramObject;
      RichMediaUtil.b(((PicBaseInfo)paramObject).b, true, 1, ((PicBaseInfo)paramObject).a, paramString1, paramString2, null);
      return;
    }
    if ((paramObject instanceof MessageForPic))
    {
      paramObject = (MessageForPic)paramObject;
      RichMediaUtil.b(((MessageForPic)paramObject).istroop, true, 1, ((MessageForPic)paramObject).localUUID, paramString1, paramString2, null);
      return;
    }
    StringBuilder localStringBuilder = new StringBuilder();
    localStringBuilder.append("step:").append(paramString1);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\pic\Logger.class
