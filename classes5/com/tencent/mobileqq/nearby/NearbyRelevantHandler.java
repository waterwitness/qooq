  ...
  extends BusinessHandler
{
  ...
  private static final int b = 42049;
  public static final String b = "freshnews_notify_switch";
  protected Set a;
  
  static
  {
    boolean bool = NotVerifyClass.DO_VERIFY_CLASS;
    jdField_a_of_type_JavaLangString = NearbyRelevantHandler.class.getSimpleName();
  }
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.getResultCode() == 1000))
    {
      ...
      if ((paramToServiceMsg != null) && (paramToServiceMsg.uint32_result.has()))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.i(jdField_a_of_type_JavaLangString, 2, "handle_oidb_0x480_9 ret=" + i);
        }
        if ((i == 0) && (paramToServiceMsg.bytes_bodybuffer.has()) && (paramToServiceMsg.bytes_bodybuffer.get() != null))
        {
          ...
          if (4 <= n)
          {
            ...
            {
              if (QLog.isColorLevel()) {
                QLog.w(jdField_a_of_type_JavaLangString, 2, "handle_oidb_0x480_9 uin error");
              }
              return;
            }
          }
    ...
    for (;;)
    {
      ...
      for (boolean bool2 = bool3;; bool2 = false)
      {
        ...
        QLog.d(jdField_a_of_type_JavaLangString, 2, "handle_oidb_0x480_9, isSuccess:" + bool1);
        return;
  ...
  {
    NearbyCmdHelper.e(this, 7, paramToServiceMsg, paramFromServiceMsg, paramObject);
  }
  ...
  private void e(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (int k = j;; k = 0)
    {
      ...
      NearbyProcessMonitor.b(this.b.a(), k);
      return;
      i = 0;
      break;
      j = 0;
  ...
  private void f(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg.isSuccess()) && (paramObject != null))
    {
      bool1 = true;
      if (QLog.isColorLevel()) {
        QLog.i(jdField_a_of_type_JavaLangString, 2, "handleSetNotifyOnLikeSwitch success=" + bool1);
      }
    ...
    for (;;)
    {
        ...
        if (paramObject != null)
        {
          ...
          if (((oidb_sso.OIDBSSOPkg)paramObject).uint32_result.get() == 0)
          {
            ...
            if (QLog.isColorLevel())
            {
              bool4 = bool1;
              bool3 = bool1;
              QLog.i(jdField_a_of_type_JavaLangString, 2, "handleSetNotifyOnLikeSwitch result=" + bool1);
            }
            bool5 = bool1;
            if (!bool1) {
              break label670;
            ...
            bool4 = bool1;
            bool3 = bool1;
            l = Utils.a(ByteBuffer.wrap(((oidb_sso.OIDBSSOPkg)paramObject).bytes_bodybuffer.get().toByteArray()).getInt());
            bool4 = bool1;
            bool3 = bool1;
            if (!this.b.a().equals(String.valueOf(l))) {
              continue;
            }
            bool4 = bool1;
            bool3 = bool1;
      ...
      catch (Exception paramFromServiceMsg)
      {
        ...
        {
          bool3 = bool1;
          QLog.i(jdField_a_of_type_JavaLangString, 2, "handleSetNotifyOnLikeSwitch ex", paramFromServiceMsg);
        }
        if (QLog.isColorLevel())
        {
          QLog.i(jdField_a_of_type_JavaLangString, 2, "handleSetNotifyOnLikeSwitch result=" + false + ";allow=" + paramToServiceMsg.extraData.getBoolean("switch"));
          bool3 = false;
          bool4 = bool2;
          continue;
        }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.i(jdField_a_of_type_JavaLangString, 2, "handleSetNotifyOnLikeSwitch result=" + bool3 + ";allow=" + paramToServiceMsg.extraData.getBoolean("switch"));
        }
      }
      try
      {
        ...
        if (QLog.isColorLevel())
        {
          QLog.i(jdField_a_of_type_JavaLangString, 2, "handleSetNotifyOnLikeSwitch result=" + bool2 + ";allow=" + paramToServiceMsg.extraData.getBoolean("switch"));
          bool3 = bool2;
          bool4 = bool1;
        }
      }
      ...
      a(13, bool3, new Boolean[] { Boolean.valueOf(bool4) });
      return;
      bool1 = false;
      break;
      bool1 = false;
      ...
      if (QLog.isColorLevel())
      {
        bool4 = bool1;
        bool3 = bool1;
        QLog.i(jdField_a_of_type_JavaLangString, 2, "handleSetNotifyOnLikeSwitch cur:" + this.b.a() + " dwUin:" + l);
      }
      bool1 = bool2;
      bool2 = false;
      continue;
  ...
  private void g(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.getResultCode() == 1000))
    {
      ...
      if ((paramToServiceMsg != null) && (paramToServiceMsg.uint32_result.has()))
      {
        i = paramToServiceMsg.uint32_result.get();
        if (QLog.isColorLevel()) {
          QLog.i(jdField_a_of_type_JavaLangString, 2, "handleGetNotifyOnLikeSwitch ret=" + i);
        }
        if ((i == 0) && (paramToServiceMsg.bytes_bodybuffer.has()) && (paramToServiceMsg.bytes_bodybuffer.get() != null))
        {
          paramToServiceMsg = paramToServiceMsg.bytes_bodybuffer.get().toByteArray();
          ...
          if (4 <= n)
          {
            ...
            {
              if (QLog.isColorLevel()) {
                QLog.i(jdField_a_of_type_JavaLangString, 2, "handleGetNotifyOnLikeSwitch uin error");
              }
              return;
            }
          }
    ...
    for (;;)
    {
      ...
      for (boolean bool2 = bool3;; bool2 = false)
      {
        a(14, bool1, new Boolean[] { Boolean.valueOf(bool2) });
        if (!QLog.isColorLevel()) {
          break;
        }
        QLog.i(jdField_a_of_type_JavaLangString, 2, "handleGetNotifyOnLikeSwitch, isSuccess:" + bool1 + ",sessionSwitch=" + i);
        return;
        i = (byte)PkgTools.a(paramToServiceMsg, i1);
        bool1 = true;
        break label295;
  ...
  private void h(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.getResultCode() == 1000))
    {
      ...
      try
      {
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg.uint32_result.has()))
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.i(jdField_a_of_type_JavaLangString, 2, "handle_oidb_0x4ff_41933 ret=" + i);
          }
    ...
    for (;;)
    {
      boolean bool2 = paramToServiceMsg.extraData.getBoolean("freshnews_notify_switch", true);
      if (bool1) {
        this.b.a().b(bool2);
      }
      a(11, bool1, Boolean.valueOf(bool2));
      return;
      bool1 = false;
    }
  }
  ...
  public void a(boolean paramBoolean)
  {
    short s = 0;
    if (QLog.isColorLevel()) {
      QLog.i(jdField_a_of_type_JavaLangString, 2, "setNotifyOnLikeSwitch OPEN=" + paramBoolean);
    }
    for (;;)
    {
      try
  ...
  public void b(boolean paramBoolean)
  {
    ...
    for (short s = 0;; s = 1)
    {
      ((ByteBuffer)localObject).putInt(Utils.a(l)).put((byte)0).putShort((short)1).putShort((short)41993).putShort((short)2).putShort(s);
      localObject = a("OidbSvc.0x4ff_41993", 1279, 9, ((ByteBuffer)localObject).array());
      ((ToServiceMsg)localObject).extraData.putBoolean("freshnews_notify_switch", paramBoolean);
      b((ToServiceMsg)localObject);
      return;
    }
  }
  ...
  public void c()
  {
    ...
    {
      while (!QLog.isColorLevel()) {}
      QLog.i(jdField_a_of_type_JavaLangString, 2, "getNotifyOnLikeSwitch error", localException);
    }
  }
}


/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\nearby\NearbyRelevantHandler.class
