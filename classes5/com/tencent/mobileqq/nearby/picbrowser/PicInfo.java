  ...
  implements Parcelable
{
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("photoId:").append(this.jdField_a_of_type_Int).append(",localPath:").append(this.c).append(" ,thumbUrl:").append(this.b).append(" ,bigPicUrl:").append(this.jdField_a_of_type_JavaLangString).append(" ,videoUrl:").append(this.d).append(" ,videoLocalPath:").append(this.e).append(" ,videoId:").append(this.f);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\nearby\picbrowser\PicInfo.class
