...
public class InterestTag
{
  ...
  public static InterestTag a(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        do
        {
          return (InterestTag)localObject;
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((((InterestTag)paramObject).jdField_a_of_type_Int != this.jdField_a_of_type_Int) || (((InterestTag)paramObject).jdField_a_of_type_JavaUtilArrayList.size() != this.jdField_a_of_type_JavaUtilArrayList.size()));
    ...
    for (;;)
    {
      ...
      if (!Utils.a(this.jdField_a_of_type_JavaUtilArrayList.get(i), ((InterestTag)paramObject).jdField_a_of_type_JavaUtilArrayList.get(i))) {
        break;
      }
      i += 1;
    }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\nearby\interestTag\InterestTag.class
