  ...
  extends MSFServlet
{
  ...
  public static final String b = "param_cmd";
  public static final String c = "param_subcmd";
  public static final String d = "param_req_json_string";
  public static final String e = "param_callback_key";
  public static final String f = "param_callback_id";
  public static final String g = "HttpConn.0x6ff_501";
  private static final String h;
  
  static
  {
    boolean bool = NotVerifyClass.DO_VERIFY_CLASS;
    h = NearbyAlumniServlet.class.getSimpleName();
  }
  ...
  private void a(Intent paramIntent, int paramInt, byte[] paramArrayOfByte1, byte[] arg4)
  {
    if (QLog.isColorLevel()) {
      QLog.i(h, 2, "respGetNearbyAlumni, errorCode = " + paramInt);
    }
    ...
    if (paramInt == 0) {
      ...
      catch (Exception paramArrayOfByte1)
      {
        ...
        if (QLog.isColorLevel())
        {
          QLog.i(h, 2, "respGetNearbyAlumni | Exception:" + paramArrayOfByte1.getMessage());
          i = paramInt;
          paramIntent = (Intent)localObject1;
        }
      }
    ...
    for (;;)
    {
      synchronized (jdField_a_of_type_JavaLangObject)
      {
        ...
        if (NearbyUtils.b()) {
          NearbyUtils.a(h, new Object[] { "respGetNearbyAlumni", Integer.valueOf(i), paramArrayOfByte1 });
        }
        if ((paramArrayOfByte1 instanceof Callback))
        {
          ((Callback)paramArrayOfByte1).invoke(new Object[] { Integer.valueOf(i), paramIntent });
          return;
          label316:
          ...
          if (QLog.isColorLevel()) {
            QLog.i(h, 2, "respGetNearbyAlumni | headLen=" + i + " | bodyLen=" + j);
          }
          if (i > 0)
          {
            ...
            if (QLog.isDevelopLevel())
            {
              ...
              QLog.i(h, 4, "HttpConnHead=" + paramArrayOfByte1.toString());
              paramInt = i;
            }
          }
          if ((j <= 0) || (paramInt != 0)) {
  ...
  private void a(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    catch (InvalidProtocolBufferMicroException paramFromServiceMsg)
    {
      for (;;)
      {
        ...
        if (QLog.isColorLevel())
        {
          QLog.i(h, 2, paramFromServiceMsg.getMessage());
          continue;
          localObject2 = null;
          continue;
          localObject1 = null;
  ...
  public static void a(AppInterface paramAppInterface, int paramInt1, int paramInt2, String paramString1, Object paramObject, String paramString2)
  {
    ...
    synchronized (jdField_a_of_type_JavaLangObject)
    {
      ...
      ((NewIntent)paramObject).putExtra("param_cmd", paramInt1);
      ((NewIntent)paramObject).putExtra("param_subcmd", paramInt2);
      ((NewIntent)paramObject).putExtra("param_uin", Long.parseLong(paramAppInterface.a()));
      ((NewIntent)paramObject).putExtra("param_req_json_string", paramString1);
      ((NewIntent)paramObject).putExtra("param_callback_key", str);
      ((NewIntent)paramObject).putExtra("param_callback_id", paramString2);
      paramAppInterface.startServlet((NewIntent)paramObject);
      return;
    }
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i(h, 2, "request get ip list");
    }
  ...
  protected void a(Intent paramIntent, Packet paramPacket, boolean paramBoolean)
  {
    ...
    if (NearbyUtils.b()) {
      NearbyUtils.a(h, new Object[] { "reqBigData", Integer.valueOf(i), Long.valueOf(l) });
    }
      ...
      do
      {
        ...
        for (;;)
        {
          ...
          catch (Exception localException)
          {
            ...
            {
              if (QLog.isColorLevel()) {
                QLog.i(h, 2, localException.getMessage());
              }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\nearby\NearbyAlumniServlet.class
