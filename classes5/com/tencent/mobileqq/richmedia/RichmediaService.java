  ...
  implements Handler.Callback, RichmediaIPCConstants
{
  ...
  static final String jdField_a_of_type_JavaLangString = "RichmediaService";
  Messenger jdField_a_of_type_AndroidOsMessenger;
  public volatile ICallBack a;
  ugb jdField_a_of_type_Ugb;
  public Messenger b;
  ...
  static void a(int paramInt, Bundle paramBundle)
  {
    ...
    {
      localWeakReferenceHandler.post(new uga(paramInt, paramBundle));
      return;
    }
  ...
  {
    super.onCreate();
    this.jdField_a_of_type_Ugb = new ugb(ThreadManager.b(), this);
    this.jdField_a_of_type_AndroidOsMessenger = new Messenger(this.jdField_a_of_type_Ugb);
    jdField_a_of_type_ComTencentMobileqqRichmediaRichmediaService = this;
    jdField_a_of_type_ComTencentUtilWeakReferenceHandler = new WeakReferenceHandler(ThreadManager.b(), this);
    if (QLog.isColorLevel()) {
  ...
  {
    super.onDestroy();
    this.jdField_a_of_type_Ugb = null;
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\richmedia\RichmediaService.class
