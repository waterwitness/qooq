  ...
  extends BaseProtocolCoder
{
  ...
  private boolean a(ToServiceMsg paramToServiceMsg, ArrayList paramArrayList, UniPacket paramUniPacket)
  {
    ...
    for (byte b1 = 1;; b1 = 0)
    {
      paramUniPacket.put("req", new ProfUsrQryReq(0, "", paramArrayList, 1, 1, (byte)0, i1, i2, (byte)1, b1, (byte)1));
      return true;
      i1 = 0;
      break;
      i2 = 0;
  ...
  private boolean z(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    paramUniPacket.setFuncName("GroupMngReq");
    paramUniPacket.put("GroupMngReq", localGroupMngReq);
    QLog.d("Q.troopInviteMember", 4, "inviteGroup: groupCode=" + str + ", uinListSize=" + localArrayList.size());
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\service\profile\ProfileService.class
