...
public class MessagePBDecoderConfig
{
  ...
  protected static final int y = 25;
  ...
  protected static ArrayList a(List paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      else if ((localElem.lola_msg.has()) && (BitAppAbilityUtils.a()))
      {
        localArrayList.add("lolaMsg");
      }
  ...
  {
    return (paramArrayList.contains("lifeOnline")) || (paramArrayList.contains("nearByMsg")) || (paramArrayList.contains("generalFlags")) || (paramArrayList.contains("crmElemFlags"));
  }
}


/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\service\message\MessagePBDecoderConfig.class
