  ...
  extends BaseProtocolCoder
{
  ...
  private boolean d(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    localCheckSinglePkgSigReq.pkgName = BaseApplicationImpl.a.getPackageName();
    String str = paramToServiceMsg.extraData.getString("ac");
    paramToServiceMsg = str;
    if (str == null) {
      paramToServiceMsg = "";
    }
    localCheckSinglePkgSigReq.pkgSig = paramToServiceMsg;
    localCheckSinglePkgSigReq.versionCode = ApkUtils.a(BaseApplicationImpl.a);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\service\config\ConfigService.class
