...
public class TroopSender
{
  ...
  private boolean i(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i(jdField_a_of_type_JavaLangString, 2, "handlerBatchGetGroupInfoReq：" + l + ",isMember=" + bool1 + ",isGetTroopCreditInfo=" + bool2);
    }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\service\troop\TroopSender.class
