  ...
  extends BaseProtocolCoder
{
  ...
  {
    paramFromServiceMsg = QZoneGetPhotoWallRequest.a(paramFromServiceMsg.getWupBuffer());
    if (QLog.isColorLevel()) {
  ...
  {
    paramFromServiceMsg = QZoneDelPhotoWallRequest.a(paramFromServiceMsg.getWupBuffer());
    if (QLog.isColorLevel()) {
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\service\qzone\QZoneService.class
