  ...
  extends BaseProtocolCoder
{
  ...
  private SvcRequestRegisterNew a(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    if (((0x4 & l) == 4L) || ((0x80 & l) == 128L))
    {
      ...
      {
        localSvcRequestRegisterNew.ulRequestOptional &= 0xFFFFFFFFFFFFFFFB;
        localSvcRequestRegisterNew.ulRequestOptional &= 0xFFFFFFFFFFFFFF7F;
      }
    }
    ...
    for (;;)
    {
      ...
      {
        localSvcRequestRegisterNew.ulRequestOptional &= 0xFFFFFFFFFFFFFFF7;
        localSvcRequestRegisterNew.ulRequestOptional &= 0xFFFFFFFFFFFFFEFF;
      }
    }
  }
  ...
  private SvcReqRegister a()
  {
    ...
    switch (uou.a[localStatus.ordinal()])
    {
    default: 
  ...
  private SvcRequestRegisterNew b(ToServiceMsg paramToServiceMsg, UniPacket paramUniPacket)
  {
    ...
    long l2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b();
    if (l2 > 0L) {
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\service\RegisterProxySvcPack\RegisterProxySvcPackService.class
