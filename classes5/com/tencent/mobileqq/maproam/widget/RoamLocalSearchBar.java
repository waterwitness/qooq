  ...
  implements View.OnClickListener
{
  ...
  protected void a()
  {
    ...
    LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130904556, this, true);
    ...
    this.c = findViewById(2131297827);
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)findViewById(2131303173));
    setBackgroundAlpha(0.0F);
  }
  
  public void a(RoamSearchDialog.OnRoamResultObserver paramOnRoamResultObserver, RoamSearchDialog.OnSearchResultItemClick paramOnSearchResultItemClick)
  {
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog = new RoamSearchDialog(this.jdField_a_of_type_AndroidContentContext);
    ...
    this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.setOnDismissListener(new tcq(this));
    this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.show();
    startAnimation(AnimationUtils.loadAnimation(this.jdField_a_of_type_AndroidContentContext, 2130968621));
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\maproam\widget\RoamLocalSearchBar.class
