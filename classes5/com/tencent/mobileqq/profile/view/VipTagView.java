  ...
  implements DragAndDropDetector.Draggable
{
  ...
  private static final int[] jdField_a_of_type_ArrayOfInt = { 2131493375, 2131493376, 2131493377, 2131493378, 2131493379 };
  ...
  {
    setBackgroundResource(2130841842);
  ...
  private void b()
  {
    setClickable(true);
    Resources localResources = getResources();
    setTextSize(0, localResources.getDimensionPixelSize(2131493380));
    int i = localResources.getDimensionPixelSize(2131493381);
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsValueAnimation = new ValueAnimation(Float.valueOf(0.0F), Float.valueOf(1.0F), new txq(this));
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsValueAnimation.setAnimationListener(new txr(this));
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\profile\view\VipTagView.class
