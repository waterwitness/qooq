  ...
  implements DragAndDropDetector.DropTarget
{
  ...
  private void e()
  {
    e = getResources().getDimensionPixelSize(2131493384);
    setBackgroundResource(2130841841);
    ...
    if ((localDrawable instanceof LayerDrawable))
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[2] = this.jdField_a_of_type_AndroidGraphicsDrawableLayerDrawable.findDrawableByLayerId(2131305397);
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[1] = this.jdField_a_of_type_AndroidGraphicsDrawableLayerDrawable.findDrawableByLayerId(2131305398);
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[0] = this.jdField_a_of_type_AndroidGraphicsDrawableLayerDrawable.findDrawableByLayerId(2131305399);
      return;
    }
    ...
    if (a())
    {
      if (this.jdField_a_of_type_AndroidViewAnimationAnimationSet == null)
      {
        ...
        while (i < 3)
        {
          ...
          ((Rect)localObject2).left = (this.jdField_a_of_type_ArrayOfAndroidGraphicsRect[i].left - e);
          ((Rect)localObject2).top = (this.jdField_a_of_type_ArrayOfAndroidGraphicsRect[i].top - e);
          ((Rect)localObject2).right = (this.jdField_a_of_type_ArrayOfAndroidGraphicsRect[i].right + e);
          ((Rect)localObject2).bottom = (this.jdField_a_of_type_ArrayOfAndroidGraphicsRect[i].bottom + e);
          localObject2 = new ValueAnimation(this.jdField_a_of_type_ArrayOfAndroidGraphicsRect[i], localObject2, new tvu(this, (Drawable)localObject1));
          ...
          localObject1 = new ValueAnimation(Integer.valueOf(0), Integer.valueOf(255), new tvv(this, (Drawable)localObject1));
          ...
          if (2 == i) {
            ((ValueAnimation)localObject2).setAnimationListener(new tvw(this));
          }
  ...
  public void a(BreatheEffectView.BreatheListener paramBreatheListener)
  {
    ...
    if (a())
    {
      ...
      while (i < 3)
      {
        ...
        ((ValueAnimation)localObject).a(new tvx(this, localDrawable));
      ...
      if (paramBreatheListener != null) {
        localAnimationSet.setAnimationListener(new tvy(this, paramBreatheListener));
      }
  ...
  public void b(BreatheEffectView.BreatheListener paramBreatheListener)
  {
    if (a())
    {
      ...
      while (i < 3)
      {
        ...
        int j = localRect.centerX();
        int k = localRect.centerY();
        localObject = new ValueAnimation(localRect, new Rect(j, k, j, k), new tvz(this, (Drawable)localObject));
        ((ValueAnimation)localObject).setDuration(400L);
  ...
  public void c()
  {
    if (a())
    {
      ...
      while (i < 3)
      {
        ...
        ((Rect)localObject2).left -= e;
        ((Rect)localObject2).top -= e;
        ((Rect)localObject2).right += e;
        ((Rect)localObject2).bottom += e;
        localObject2 = new ValueAnimation(localObject2, localObject3, new twa(this, (Drawable)localObject1));
        ((ValueAnimation)localObject2).setDuration(800L);
        ((ValueAnimation)localObject2).setInterpolator(new AccelerateInterpolator(0.24F));
        localObject1 = new ValueAnimation(Integer.valueOf(204), Integer.valueOf(0), new twb(this, (Drawable)localObject1));
        ...
        ((Animation)localObject3).setAnimationListener(new twc(this));
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\profile\view\BreatheEffectView.class
