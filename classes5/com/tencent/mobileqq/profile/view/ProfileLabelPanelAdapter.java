  ...
  implements View.OnClickListener
{
  ...
  protected void a(View paramView, int paramInt)
  {
    ...
    this.jdField_a_of_type_Twu = ((twu)this.jdField_a_of_type_AndroidUtilSparseArray.get(paramInt));
    if (this.jdField_a_of_type_Twu == null)
    {
      this.jdField_a_of_type_Twu = new twu(this, null);
      this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, this.jdField_a_of_type_Twu);
    }
    paramView = (GridView)paramView;
    this.jdField_a_of_type_Twu.a(((ProfileLabelTypeInfo)this.jdField_a_of_type_JavaUtilList.get(paramInt)).labels);
    paramView.setAdapter(this.jdField_a_of_type_Twu);
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\profile\view\ProfileLabelPanelAdapter.class
