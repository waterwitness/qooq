    ...
    if (localProfileHeaderView != null) {
      for (;;)
      {
        try
        {
          ...
          SharedPreferences localSharedPreferences = localQQAppInterface.a().getSharedPreferences("ProfileCardTips" + localQQAppInterface.a(), 0);
          ...
          localObject2 = ((FriendsManager)localQQAppInterface.getManager(50)).a(localQQAppInterface.a());
          if (localObject2 != null)
          {
            ...
            localQQAppInterface.runOnUiThread(new tws(this, localProfileHeaderView));
            continue;
          }
          l1 = 0L;
        }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\profile\view\ProfileHeaderView$UpdateProfileSetCardTask.class
