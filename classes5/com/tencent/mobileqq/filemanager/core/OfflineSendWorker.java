  ...
  implements FileUploader.IFileUploaderSink, IFileHttpBase
{
  ...
  public OfflineSendWorker(QQAppInterface paramQQAppInterface, FileManagerEntity paramFileManagerEntity)
  {
    ...
    this.jdField_a_of_type_JavaLangString = "OfflineFileUploader<FileAssistant>";
    this.jdField_a_of_type_Int = -1;
    this.jdField_b_of_type_JavaLangString = "actFileUp";
    this.jdField_c_of_type_JavaLangString = "actFileUpDetail";
    this.jdField_b_of_type_Boolean = true;
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppFileTransferObserver = new rxn(this);
  ...
  {
    ThreadManager.a().post(new rxm(this, paramString, paramLong, paramArrayOfByte3, paramArrayOfByte4, paramArrayOfByte2, paramArrayOfByte1));
  }
  ...
  private void j()
  {
    ...
    do
    {
      ...
      try
      {
        byte[] arrayOfByte1 = FileManagerUtil.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getFilePath()).getBytes("utf-8");
  ...
  public void a(Object paramObject)
  {
    ...
    for (;;)
    {
      ((FileManagerEntity)paramObject).status = i;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.uniseq, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerUin, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.peerType, 15, null, 5, null);
      return;
      i = 16;
  ...
  public void g()
  {
    ...
    ThreadManager.a(new Thread(new rxl(this)), 5, null, true);
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\filemanager\core\OfflineSendWorker.class
