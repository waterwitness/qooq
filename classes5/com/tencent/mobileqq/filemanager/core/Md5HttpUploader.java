  ...
  implements IHttpCommunicatorListener, rxj
{
  ...
  public void a(HttpMsg paramHttpMsg1, HttpMsg paramHttpMsg2)
  {
    ...
    for (long l = Long.parseLong(paramHttpMsg2.a("User-ReturnCode"));; l = 0L)
    {
      ...
      if (paramHttpMsg1 == null)
      {
        this.jdField_a_of_type_Rxi.a(9001, "httpServer not has range");
        return;
      }
      l = Long.parseLong(paramHttpMsg1);
      this.jdField_a_of_type_Rxi.a(l, paramHttpMsg2.al);
      return;
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\filemanager\core\Md5HttpUploader.class
