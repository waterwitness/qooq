...
public class FtnUploader
  implements IHttpCommunicatorListener, rxj
{
  ...
  private void a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      if (localDataInputStream.readInt() != 0) {
        this.jdField_a_of_type_Rxi.a(9001, "httpServer retCode!=0");
      }
    }
    catch (IOException localIOException)
    {
      for (;;)
      {
        ...
        this.jdField_a_of_type_Rxi.a(9001, "httpServer flag!=0 flag!=1");
        try
        {
    ...
    if (i == 0)
    {
      ...
      l2 = i;
      this.jdField_a_of_type_Rxi.a(l1 << 32 | l2, null);
    }
    for (;;)
    {
      try
  ...
  public void a(HttpMsg paramHttpMsg1, HttpMsg paramHttpMsg2)
  {
    ...
    for (long l = Long.parseLong(paramHttpMsg2.a("User-ReturnCode"));; l = 0L)
    {
      if (0L != l)
      {
        this.jdField_a_of_type_Rxi.a(paramHttpMsg2.h, paramHttpMsg2.d(), paramHttpMsg2.al);
        return;
      }
      a(paramHttpMsg2.a());
      return;
  ...
  public void a(String paramString)
  {
    ...
    this.jdField_a_of_type_Rxi.a(paramString);
  }
  
  public void a(rxi paramrxi)
  {
    this.jdField_a_of_type_Rxi = paramrxi;
  }
  ...
  public boolean a(String paramString, long paramLong, byte[] paramArrayOfByte)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsHttputilsHttpMsg.ai = String.valueOf(this.jdField_a_of_type_Long);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqUtilsHttputilsHttpMsg);
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\filemanager\core\FtnUploader.class
