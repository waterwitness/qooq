  ...
  extends BaseProxy
{
  ...
  private boolean a(int paramInt)
  {
    ...
    for (long l = Long.MAX_VALUE;; l = ((UniformDownloadBPTransEntity)this.jdField_a_of_type_JavaUtilList.get(this.jdField_a_of_type_JavaUtilList.size() - 1)).getId())
    {
  ...
  public void a(UniformDownloadBPTransEntity paramUniformDownloadBPTransEntity)
  {
    ...
    new Handler(localLooper).post(new sjn(this, paramUniformDownloadBPTransEntity));
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\filemanager\util\UniformDownloadBPTransProxy.class
