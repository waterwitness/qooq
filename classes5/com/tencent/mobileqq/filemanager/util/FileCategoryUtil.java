...
public class FileCategoryUtil
{
  ...
  public static Map a(Context paramContext, String paramString, int paramInt)
  {
    ...
    //   5: aconst_null
    //   6: iload_2
    //   7: invokestatic 37	com/tencent/mobileqq/filemanager/util/FileCategoryUtil:b	(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;I)Landroid/database/Cursor;
    //   10: astore_0
    //   11: aload_0
    //   12: astore_1
    //   13: aload_0
    //   14: iconst_0
    //   15: invokestatic 329	com/tencent/mobileqq/filemanager/util/FileCategoryUtil:a	(Landroid/database/Cursor;I)Ljava/util/Map;
    //   18: astore_3
    //   19: aload_3
    //   20: astore_1
    //   21: aload_0
    ...
    //   39: astore_1
    //   40: aload_3
    //   41: invokevirtual 49	java/lang/Exception:printStackTrace	()V
    //   44: aload 4
    //   46: astore_1
    //   47: aload_0
    //   48: ifnull -15 -> 33
  ...
  public static void a(FileManagerEntity paramFileManagerEntity)
  {
    ...
    ThreadManager.a(new siy(paramFileManagerEntity), 8, null, false);
  }
  ...
  public static Drawable b(Context paramContext, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramContext.getValue(localApplicationInfo.icon, paramString, true);
        str = paramString.string.toString();
      }
      catch (PackageManager.NameNotFoundException paramContext)
      {
        ...
        {
          String str;
          for (paramContext = Drawable.createFromResourceStream(paramContext, paramString, paramContext.getAssets().openNonAssetFd(paramString.assetCookie, str).createInputStream(), null);; paramContext = (Context)localObject)
          {
  ...
  public static Map b(Context paramContext, String paramString, int paramInt)
  {
    ...
    //   5: aconst_null
    //   6: iload_2
    //   7: invokestatic 533	com/tencent/mobileqq/filemanager/util/FileCategoryUtil:a	(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;I)Landroid/database/Cursor;
    //   10: astore_0
    //   11: aload_0
    //   12: astore_1
    //   13: aload_0
  ...
  public static Map c(Context paramContext, String paramString, int paramInt)
  {
    ...
    //   5: aconst_null
    //   6: iload_2
    //   7: invokestatic 480	com/tencent/mobileqq/filemanager/util/FileCategoryUtil:c	(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;I)Landroid/database/Cursor;
    //   10: astore_0
    //   11: aload_0
    //   12: astore_1
    //   13: aload_0
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\filemanager\util\FileCategoryUtil.class
