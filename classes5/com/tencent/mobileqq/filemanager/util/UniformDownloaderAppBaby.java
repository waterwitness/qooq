  ...
  implements UniformDownloader.IUniformDownloader
{
  ...
  private int i()
  {
    int i = UniformDownloaderAppBabySdk.a().a(this.jdField_c_of_type_Long, this.jdField_c_of_type_JavaLangString, this.b, new sjq(this));
    if (i == 0) {
      a(true);
    }
    return i;
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\filemanager\util\UniformDownloaderAppBaby.class
