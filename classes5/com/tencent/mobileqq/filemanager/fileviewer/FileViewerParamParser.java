...
public class FileViewerParamParser
{
  ...
  public static int a(QQAppInterface paramQQAppInterface, ArrayList paramArrayList1, FileManagerEntity paramFileManagerEntity, ArrayList paramArrayList2)
  {
    ...
    while (paramArrayList1.hasNext())
    {
      ...
      {
        int k = localFileManagerEntity.getCloudType();
  ...
  private boolean b()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((this.b == null) || (this.b.trim().length() == 0) || (this.b.equals(localFileManagerEntity.peerUin)))
      {
        int j = localFileManagerEntity.getCloudType();
        if (FileUtil.b(localFileManagerEntity.getFilePath())) {
          j = 3;
        }
        if (localFileManagerEntity.nSessionId == this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId) {
  ...
  private boolean d()
  {
    ...
    {
      FileManagerEntity localFileManagerEntity = (FileManagerEntity)((Iterator)localObject).next();
      if ((5 == localFileManagerEntity.getCloudType()) && (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nOlSenderProgress == localFileManagerEntity.nOlSenderProgress) && ((this.b == null) || (this.b.trim().length() == 0) || (this.b.equals(localFileManagerEntity.peerUin))))
      {
        if (localFileManagerEntity.nSessionId == this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nSessionId) {
          this.e = i;
        }
  ...
  private boolean e()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((5 == localFileManagerEntity.getCloudType()) && (this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nOlSenderProgress == localFileManagerEntity.nOlSenderProgress) && ((this.b == null) || (this.b.trim().length() == 0) || (this.b.equals(localFileManagerEntity.peerUin))))
      {
        ...
        while (b(localFileManagerEntity.nFileType, localFileManagerEntity.getCloudType()))
        {
          i += 1;
          this.jdField_a_of_type_JavaUtilList.add(FileViewerAdapterBase.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, localFileManagerEntity));
          break;
  ...
  public boolean a(Intent paramIntent)
  {
    ...
    boolean bool1 = a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.nFileType, this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.getCloudType());
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\filemanager\fileviewer\FileViewerParamParser.class
