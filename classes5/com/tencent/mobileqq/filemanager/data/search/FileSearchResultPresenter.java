  ...
  public void b(ISearchResultModel paramISearchResultModel, ISearchResultView paramISearchResultView)
  {
    ...
    if (FileManagerUtil.a((String)localObject1) == 0)
    {
      ...
      for (localObject1 = ((FileManagerEntity)localObject2).strThumbPath;; localObject1 = ((FileManagerEntity)localObject2).strFilePath)
      {
        ...
        if (paramISearchResultModel == null) {
          localImageView.setImageDrawable(localImageView.getContext().getResources().getDrawable(2130840362));
        }
      ...
      if (((FileManagerEntity)localObject2).getCloudType() == 1) {
        if (((FileManagerEntity)localObject2).peerType == 3000) {
          localObject1 = ((QQAppInterface)localObject1).a().a((FileManagerEntity)localObject2, 3);
        }
      }
    }
    for (;;)
    {
      ...
      {
        localImageView.setImageDrawable(BaseApplicationImpl.getContext().getResources().getDrawable(2130840362));
        return;
        localObject1 = ((QQAppInterface)localObject1).a().a(((FileManagerEntity)localObject2).Uuid, 3, ((FileManagerEntity)localObject2).bSend, localObject2);
        continue;
        if (((FileManagerEntity)localObject2).getCloudType() == 2) {
          localObject1 = ((QQAppInterface)localObject1).a().a(((FileManagerEntity)localObject2).WeiYunFileId, ((FileManagerEntity)localObject2).fileName, 3, localObject2);
        }
      }
      else
      {
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\filemanager\data\search\FileSearchResultPresenter.class
