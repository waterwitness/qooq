...
public class EmosmUtils
{
  ...
  public static String a(int paramInt, String paramString)
  {
    ...
    localStringBuilder.append(EmoticonUtils.j.replace("[epId]", paramString));
    switch (paramInt)
    {
    }
    for (;;)
  ...
  public static String a(Context paramContext, QQMessageFacade.Message paramMessage)
  {
    ...
    return paramContext.getString(2131370467);
  }
  ...
  public static String a(String paramString1, String paramString2, int paramInt)
  {
    ...
    if (1 == paramInt) {
      paramString1.append("http://i.gtimg.cn/club/item/parcel/item/" + paramString2.substring(0, 2) + "/" + paramString2 + "/pngframe.zip");
    }
    for (;;)
    {
      return a("VIP_emosm", paramString1.toString());
  ...
  public static boolean a(Context paramContext)
  {
    ...
    if (!bool) {
      QQToast.a(BaseApplicationImpl.getContext(), 2131367256, 0).a();
    }
    return bool;
  }
  ...
  public static byte[] a(String paramString)
  {
    ...
    //   8: invokevirtual 155	java/io/File:exists	()Z
    //   11: ifeq +63 -> 74
    ...
    //   21: dup
    //   22: aload_0
    //   23: invokespecial 152	java/io/File:<init>	(Ljava/lang/String;)V
    //   26: invokespecial 325	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   29: astore_1
    //   30: aload_1
    //   31: astore_0
    //   32: aload_1
    //   33: invokevirtual 329	java/io/FileInputStream:available	()I
    ...
    //   41: aload_1
    //   42: aload_2
    //   43: invokevirtual 333	java/io/FileInputStream:read	([B)I
    //   46: pop
    //   47: aload_1
    //   48: ifnull +7 -> 55
    //   51: aload_1
    //   52: invokevirtual 336	java/io/FileInputStream:close	()V
    //   55: aload_2
    //   56: areturn
    //   57: astore_2
    //   58: aconst_null
    ...
    //   61: astore_0
    //   62: aload_2
    //   63: invokevirtual 337	java/io/FileNotFoundException:printStackTrace	()V
    //   66: aload_1
    //   67: ifnull +7 -> 74
    //   70: aload_1
    //   71: invokevirtual 336	java/io/FileInputStream:close	()V
    //   74: aconst_null
    //   75: areturn
    //   76: astore_2
    //   77: aconst_null
    ...
    //   80: astore_0
    //   81: aload_2
    //   82: invokevirtual 338	java/io/IOException:printStackTrace	()V
    //   85: aload_1
    //   86: ifnull -12 -> 74
    //   89: aload_1
    //   90: invokevirtual 336	java/io/FileInputStream:close	()V
    //   93: goto -19 -> 74
    //   96: astore_0
    //   97: goto -23 -> 74
    //   100: astore_1
    ...
    //   104: ifnull +7 -> 111
    //   107: aload_0
    //   108: invokevirtual 336	java/io/FileInputStream:close	()V
    //   111: aload_1
    //   112: athrow
    //   113: astore_0
    //   114: aload_2
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\com\tencent\mobileqq\emosm\EmosmUtils.class
