...
public final class usm
  implements Runnable
{
  public usm(PtvFilterSoLoad.FilterVideoSoCallback paramFilterVideoSoCallback)
  {
  ...
  {
    if (this.a != null) {
      this.a.a((PtvFilterSoLoad.b().f + PtvFilterSoLoad.a().f) / 2);
    }
  }
}


/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\usm.class
