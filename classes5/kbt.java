...
{
  public kbt(BluetoothLeService paramBluetoothLeService)
  {
  ...
  public void onServicesDiscovered(BluetoothGatt paramBluetoothGatt, int paramInt)
  {
    ...
    {
      return;
      localGattInfo.jdField_a_of_type_AndroidBluetoothBluetoothGattService = localGattInfo.jdField_a_of_type_AndroidBluetoothBluetoothGatt.getService(UUID.fromString(BluetoothLeService.o));
      if (localGattInfo.jdField_a_of_type_AndroidBluetoothBluetoothGattService != null)
      {
        localGattInfo.jdField_a_of_type_AndroidBluetoothBluetoothGattCharacteristic = localGattInfo.jdField_a_of_type_AndroidBluetoothBluetoothGattService.getCharacteristic(UUID.fromString(BluetoothLeService.s));
        if (localGattInfo.jdField_a_of_type_AndroidBluetoothBluetoothGattCharacteristic == null) {
          localGattInfo.jdField_a_of_type_AndroidBluetoothBluetoothGattCharacteristic = localGattInfo.jdField_a_of_type_AndroidBluetoothBluetoothGattService.getCharacteristic(UUID.fromString(BluetoothLeService.p));
        }
        localGattInfo.jdField_b_of_type_AndroidBluetoothBluetoothGattCharacteristic = localGattInfo.jdField_a_of_type_AndroidBluetoothBluetoothGattService.getCharacteristic(UUID.fromString(BluetoothLeService.t));
        if (localGattInfo.jdField_b_of_type_AndroidBluetoothBluetoothGattCharacteristic == null) {
          localGattInfo.jdField_b_of_type_AndroidBluetoothBluetoothGattCharacteristic = localGattInfo.jdField_a_of_type_AndroidBluetoothBluetoothGattService.getCharacteristic(UUID.fromString(BluetoothLeService.q));
        }
        localGattInfo.c = localGattInfo.jdField_a_of_type_AndroidBluetoothBluetoothGattService.getCharacteristic(UUID.fromString(BluetoothLeService.u));
        if (localGattInfo.c == null) {
          localGattInfo.c = localGattInfo.jdField_a_of_type_AndroidBluetoothBluetoothGattService.getCharacteristic(UUID.fromString(BluetoothLeService.r));
        }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\kbt.class
