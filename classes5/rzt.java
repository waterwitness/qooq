...
public class rzt
  implements Runnable
{
  public rzt(UniformDownloadMgr paramUniformDownloadMgr, String paramString, Bundle paramBundle)
  {
  ...
  public void run()
  {
    ...
    sae localsae = UniformDownloadMgr.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreUniformDownloadMgr, this.jdField_a_of_type_JavaLangString);
    if ((localsae != null) && (this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreUniformDownloadMgr.a != null))
    {
      if (localsae.a != 1) {
        break label175;
      }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\rzt.class
