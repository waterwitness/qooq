  ...
  extends Handler
{
  ...
  public ugb(Looper paramLooper, RichmediaService paramRichmediaService)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (int i = localBundle.getInt("msg_sub_cmd");; i = 0)
    {
      ...
      case 100: 
        ...
        paramMessage.c = localBundle.getInt("video_slice_width");
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\ugb.class
