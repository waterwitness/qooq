...
{
  public jdn(TroopNewGuidePopWindow paramTroopNewGuidePopWindow)
  {
  ...
  {
    if ((this.a.jdField_a_of_type_ComTencentMobileqqTroopDataTroopFeedsDataManager$TroopNotifyAd != null) && (this.a.jdField_c_of_type_Boolean))
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentImageURLImageView.getLocalVisibleRect(localRect))
      {
        ...
        ReportController.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Grp_bulletin", "", "bulletin_popUp", "exp_ad", 0, 0, this.a.jdField_c_of_type_JavaLangString, String.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqTroopDataTroopFeedsDataManager$TroopNotify.a), "8020205751015455", "");
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\jdn.class
