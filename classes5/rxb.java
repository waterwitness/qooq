...
{
  public rxb(FileManagerRSWorker paramFileManagerRSWorker)
  {
  ...
  public void onCanceled(IWyTaskManager.Task paramTask, Object paramObject)
  {
    if (QLog.isColorLevel()) {
      QLog.i("FileManagerRSWorker<FileAssistant>", 2, "WeiYun download is canceled[" + String.valueOf(this.a.c) + "],set trafficData size[" + String.valueOf(this.a.jdField_a_of_type_Long) + "]");
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("FileManagerRSWorker<FileAssistant>", 2, "WeiYun download is onFailed[" + String.valueOf(this.a.c) + "],set trafficData size[" + String.valueOf(this.a.jdField_a_of_type_Long) + "]");
    }
    if (NetworkUtil.b(BaseApplication.getContext()) == 1)
    {
      paramTask = new String[3];
  ...
  public void onProgressChange(IWyTaskManager.Task paramTask, Object paramObject, long paramLong1, long paramLong2)
  {
    ...
    this.a.f = paramLong2;
    if (QLog.isColorLevel()) {
      QLog.i("FileManagerRSWorker<FileAssistant>", 2, "Id[" + String.valueOf(this.a.c) + "]" + "WeiYun download is onProgressChange mtransferedSize[" + String.valueOf(this.a.jdField_a_of_type_Long) + "/" + String.valueOf(this.a.d) + "]");
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("FileManagerRSWorker<FileAssistant>", 2, "WeiYun download is onStarted[" + String.valueOf(this.a.c) + "]");
    }
    this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.a.b, this.a.c, this.a.e, this.a.jdField_a_of_type_Int, 16, null, 0, null);
  }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.i("FileManagerRSWorker<FileAssistant>", 2, "WeiYun download is onSucceed[" + String.valueOf(this.a.c) + "],set trafficData size[" + String.valueOf(this.a.jdField_a_of_type_Long) + "]");
    }
    paramTask = (IWyTaskManager.DownloadTask)this.a.jdField_a_of_type_ComWeiyunSdkIWyTaskManager$Task;
    this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.setFilePath(paramTask.getFilePath());
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\rxb.class
