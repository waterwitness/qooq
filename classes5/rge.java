...
{
  public rge(NearbyTransitActivity paramNearbyTransitActivity)
  {
  ...
  public void a(boolean paramBoolean, HotChatInfo paramHotChatInfo, Common.WifiPOIInfo paramWifiPOIInfo, int paramInt, String paramString)
  {
    ...
    while ((NearbyTransitActivity.b(this.a) == 1) && (paramWifiPOIInfo.what == 3) && (paramHotChatInfo.mFissionRoomNum > 0))
    {
      ...
      paramString.what = 5;
      paramString.obj = String.format(this.a.getResources().getString(2131371472), new Object[] { Integer.valueOf(paramHotChatInfo.mFissionRoomNum) });
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\rge.class
