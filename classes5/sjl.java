...
{
  public sjl(QQAppInterface paramQQAppInterface, int paramInt)
  {
  ...
  public long a(String paramString1, int paramInt1, String paramString2, int paramInt2, String paramString3, String paramString4, String paramString5, long paramLong, int paramInt3)
  {
    ...
    for (localDataLineMsgRecord.nOpType = 29;; localDataLineMsgRecord.nOpType = 31)
    {
      ...
      paramString2 = (SVIPHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(13);
      localDataLineMsgRecord.vipBubbleDiyTextId = paramString2.g();
      localDataLineMsgRecord.vipBubbleID = SVIPHandler.a(paramString2.e(), localDataLineMsgRecord.vipBubbleDiyTextId);
  ...
  public void a(boolean paramBoolean, long paramLong, int paramInt, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    do
    {
      do
      {
        ...
        paramString2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramInt).b(paramLong);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\sjl.class
