...
public class tqh
{
  ...
  public tqh(AbsListView paramAbsListView)
  {
  ...
  {
    ListAdapter localListAdapter2 = (ListAdapter)this.jdField_a_of_type_ComTencentWidgetAbsListView.a();
  ...
  ListAdapter a(ItemManager paramItemManager, ListAdapter paramListAdapter)
  {
    ...
    if (paramItemManager != null)
    {
      ...
      if (paramListAdapter != null) {
        localObject = new tqa(paramItemManager, (BaseAdapter)paramListAdapter);
      }
    }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\tqh.class
