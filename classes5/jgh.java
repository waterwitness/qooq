  ...
  extends CustomWebChromeClient
{
  ...
  public jgh(AbsBaseWebViewActivity paramAbsBaseWebViewActivity)
  {
  ...
  private void a(View paramView, int paramInt, IX5WebChromeClient.CustomViewCallback paramCustomViewCallback)
  {
    ...
    if (!this.jdField_a_of_type_ComTencentBizWebviewbaseAbsBaseWebViewActivity.jdField_a_of_type_ComTencentMobileqqWebviewSwiftComponentSwiftBrowserUIStyleHandler$SwiftBrowserUIStyle.w) {
    ...
    this.jdField_a_of_type_ComTencentBizWebviewbaseAbsBaseWebViewActivity.k = true;
  ...
  public View getVideoLoadingProgressView()
  {
    if (this.jdField_b_of_type_AndroidViewView == null) {
      this.jdField_b_of_type_AndroidViewView = LayoutInflater.from(this.jdField_a_of_type_ComTencentBizWebviewbaseAbsBaseWebViewActivity).inflate(2130905093, null);
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("WebViewBase", 2, "onGeolocationPermissionsShowPrompt:" + paramString);
    }
    ...
    if (paramString != null)
    {
      ...
      {
        str = paramString;
        if (AbsBaseWebViewActivity.a(this.jdField_a_of_type_ComTencentBizWebviewbaseAbsBaseWebViewActivity) != null)
        {
          str = paramString;
          if (AbsBaseWebViewActivity.a(this.jdField_a_of_type_ComTencentBizWebviewbaseAbsBaseWebViewActivity).getX5WebViewExtension() != null) {
  ...
  public void onHideCustomView()
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_ComTencentBizWebviewbaseAbsBaseWebViewActivity.k = false;
      return;
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("WebViewBase", 2, "onProgressChanged:" + paramInt);
    }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\jgh.class
