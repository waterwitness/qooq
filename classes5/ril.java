...
class ril
  implements Runnable
{
  ril(rhz paramrhz, QQAppInterface paramQQAppInterface, long paramLong, int paramInt, Bundle paramBundle, MessengerService paramMessengerService)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      for (;;)
      {
        ...
        catch (JSONException localJSONException)
        {
          ...
          Object localObject1 = new ApolloMainInfo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.f());
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\ril.class
