...
{
  public rnq(FilePreviewActivity paramFilePreviewActivity)
  {
  ...
  public void loadFinish(int paramInt1, int paramInt2, String paramString)
  {
    ...
    if (paramInt2 == 0)
    {
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqFilemanagerWidgetFileWebView.a();
    }
    for (;;)
    {
  ...
  public void loadFinish(int paramInt1, boolean paramBoolean, int paramInt2, String paramString)
  {
    ...
    {
      bool1 = true;
      this.a.runOnUiThread(new rns(this, paramInt1, bool1, paramInt2, paramString));
      paramString = this.a;
      if (paramBoolean) {
        break label67;
      }
  ...
  public void openFile(String paramString1, String paramString2, long paramLong, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        if (!TextUtils.isEmpty(this.a.g)) {
          localBundle.putString("COOKIE", "FTN5K=" + this.a.g);
        }
        ((Bundle)localObject3).putBundle("_user_data", localBundle);
        DialogUtil.a(this.a, 233, this.a.getString(2131368409), "是否下载文件:\n" + paramString1 + "(" + FileUtil.a(paramLong) + ")", new rnt(this, paramString2, (UniformDownloadMgr)localObject2, (Bundle)localObject3), new rnu(this)).show();
        return;
    ...
    FileManagerReporter.a(this.a.app.a(), paramString1);
  ...
  {
    this.a.runOnUiThread(new rnr(this, paramInt1, paramInt2));
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\rnq.class
