...
{
  public kag(DevicePttItemBuilder paramDevicePttItemBuilder, MessageForPtt paramMessageForPtt, ActionSheet paramActionSheet)
  {
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    if (paramView != null)
    {
      ...
      if ((!NetworkUtil.e(BaseApplication.getContext())) && ((paramView instanceof MessageForDevPtt)))
      {
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\kag.class
