  ...
  implements Cloneable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.sUin, ((UniPayResponse)paramObject).sUin)) || (!JceUtil.equals(this.iShowOpen, ((UniPayResponse)paramObject).iShowOpen)) || (!JceUtil.equals(this.iUniPayType, ((UniPayResponse)paramObject).iUniPayType)) || (!JceUtil.equals(this.sProductID, ((UniPayResponse)paramObject).sProductID)) || (!JceUtil.equals(this.mapResponse, ((UniPayResponse)paramObject).mapResponse)));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\PayMQQ\UniPayResponse.class
