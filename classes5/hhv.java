...
{
  public hhv(Context paramContext, QQAppInterface paramQQAppInterface, QQProgressDialog paramQQProgressDialog, EqqDetail paramEqqDetail, SessionInfo paramSessionInfo, String paramString)
  {
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      {
        CrmUtils.a(this.jdField_a_of_type_AndroidContentContext, 2131364487);
      ...
      if (paramInt == 58)
      {
        CrmUtils.a(this.jdField_a_of_type_AndroidContentContext, 2131364494);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\hhv.class
