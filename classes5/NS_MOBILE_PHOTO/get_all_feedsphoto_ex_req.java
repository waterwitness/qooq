  ...
  extends JceStruct
{
  ...
  public get_all_feedsphoto_ex_req(long paramLong, int paramInt1, int paramInt2, String paramString, int paramInt3, int paramInt4, int paramInt5, Map paramMap)
  {
    this.uin = paramLong;
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\NS_MOBILE_PHOTO\get_all_feedsphoto_ex_req.class
