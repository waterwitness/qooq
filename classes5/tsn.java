      ...
      if (i < this.a.a.jdField_a_of_type_JavaUtilArrayList.size())
      {
        ...
        if (((PicResult)localObject2).d == -2)
        {
          ...
          if (str != null)
          {
            ...
            ((TransferRequest)localObject2).jdField_a_of_type_ComTencentMobileqqPicUpCallBack = new tso(this, i, str);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\tsn.class
