...
public class sli
  implements Runnable
{
  public sli(ForwardQFavBatchOption paramForwardQFavBatchOption, Bundle paramBundle, String paramString1, String paramString2, String paramString3, int paramInt1, int paramInt2, String paramString4, Intent paramIntent)
  {
  ...
  public void run()
  {
    ...
    case 6: 
    case 8: 
      this.jdField_a_of_type_AndroidOsBundle.putString("struct_share_key_source_icon", BaseApplicationImpl.getContext().getString(2131365952));
      this.jdField_a_of_type_AndroidOsBundle.putString("app_name", BaseApplicationImpl.getContext().getString(2131365938));
    ...
    case 2: 
      ...
      ForwardSendPicUtil.a(this.jdField_a_of_type_ComTencentMobileqqForwardForwardQFavBatchOption.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, (String)localObject1, this.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_Int, this.c, false, this.jdField_a_of_type_ComTencentMobileqqForwardForwardQFavBatchOption.jdField_a_of_type_AndroidAppActivity);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\sli.class
