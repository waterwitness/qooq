...
public class jhj
  extends Handler
{
  public jhj(OfflinePlugin paramOfflinePlugin, Looper paramLooper)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    do
    {
          ...
          do
          {
            ...
            for (;;)
            {
              ...
              try
              {
                ...
                ((JSONObject)localObject2).put("data", Util.b((String)localObject1));
                this.a.callJs(this.a.f, new String[] { ((JSONObject)localObject2).toString() });
              }
              catch (Exception localException1)
              {
                try
                {
                  ...
                  this.a.callJs(this.a.f, new String[] { localJSONObject1.toString() });
                }
              ...
              else if (paramMessage.arg1 == 3)
              {
                try
                {
                  ...
                  OfflinePlugin.a(this.a, localJSONObject2);
                }
      ...
      paramMessage = localException2.getResources().getDrawable(2130838301);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\jhj.class
