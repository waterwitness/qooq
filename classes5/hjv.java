...
{
  public hjv(SharedPreferences paramSharedPreferences, Handler paramHandler)
  {
      ...
      if (paramBundle != null)
      {
        ...
        try
        {
          ...
          if (paramInt != 0)
          {
            ...
            QLog.d("SearchProtocol", 2, "retcode:" + paramInt);
            return;
          }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\hjv.class
