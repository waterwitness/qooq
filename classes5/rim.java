...
class rim
  implements Runnable
{
  rim(rhz paramrhz, QQAppInterface paramQQAppInterface, String paramString, Bundle paramBundle, MessengerService paramMessengerService)
  {
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      {
        ((ApolloDaoManager)localObject2).e(localArrayList);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\rim.class
