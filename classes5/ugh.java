  ...
  extends DataAdapter
{
  ...
  public ugh(int paramInt, String paramString)
  {
    boolean bool = NotVerifyClass.DO_VERIFY_CLASS;
    this.jdField_a_of_type_JavaLangString = "receiver";
  }
  ...
  public HashMap a(String paramString)
  {
    ...
    if (this.jdField_b_of_type_Int <= 0)
    {
      ...
      {
        QLog.i(DataCollector.a_, 4, "View count is 0!");
        localObject1 = localObject2;
      }
    }
    do
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\ugh.class
