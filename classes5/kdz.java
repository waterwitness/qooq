...
{
  public kdz(LightAppUtil paramLightAppUtil)
  {
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      if (paramInt < paramBundle.length())
      {
        ...
        localLightAppSettingInfo.jdField_f_of_type_Int = ((JSONObject)localObject1).optInt("pid");
        localLightAppSettingInfo.jdField_d_of_type_Int = ((JSONObject)localObject1).optInt("template_type");
        localLightAppSettingInfo.jdField_e_of_type_Int = ((JSONObject)localObject1).optInt("has_own_app");
        localLightAppSettingInfo.jdField_d_of_type_JavaLangString = ((JSONObject)localObject1).optString("h5_url");
        localLightAppSettingInfo.c = ((JSONObject)localObject1).optString("public_url");
        localLightAppSettingInfo.jdField_a_of_type_JavaLangString = ((JSONObject)localObject1).optString("own_appid");
        localLightAppSettingInfo.jdField_g_of_type_Int = ((JSONObject)localObject1).optInt("device_type");
        localLightAppSettingInfo.b = ((JSONObject)localObject1).optString("own_pkgname");
        localLightAppSettingInfo.jdField_e_of_type_JavaLangString = ((JSONObject)localObject1).optString("openid");
        localLightAppSettingInfo.jdField_f_of_type_JavaLangString = ((JSONObject)localObject1).optString("openkey");
        localLightAppSettingInfo.jdField_g_of_type_JavaLangString = ((JSONObject)localObject1).optString("appname");
        localLightAppSettingInfo.jdField_h_of_type_Int = ((JSONObject)localObject1).optInt("bindtype", 1);
        ...
        localLightAppSettingInfo.jdField_h_of_type_JavaLangString = ((JSONObject)localObject1).optString("comment");
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\kdz.class
