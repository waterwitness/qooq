...
class rik
  implements Runnable
{
  rik(rhz paramrhz, QQAppInterface paramQQAppInterface, int paramInt1, String paramString, int paramInt2, Bundle paramBundle, MessengerService paramMessengerService)
  {
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      {
        localObject2 = new ApolloMainInfo(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.f());
        ((ApolloInfo)localObject2).a = ((ApolloDaoManager)localObject1).a(this.jdField_a_of_type_Int);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\rik.class
