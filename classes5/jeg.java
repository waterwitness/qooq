  ...
  implements AbsListView.OnScrollListener
{
  ...
  private jeg(MoveFileActivity paramMoveFileActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramViewGroup = this.jdField_a_of_type_ComTencentBizTroopFileMoveFileActivity.getLayoutInflater().inflate(2130903900, MoveFileActivity.a(this.jdField_a_of_type_ComTencentBizTroopFileMoveFileActivity), false);
      paramView = new jeh(null);
      paramView.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramViewGroup.findViewById(2131300596));
      paramView.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramViewGroup.findViewById(2131300595));
      paramView.b = ((TextView)paramViewGroup.findViewById(2131300597));
      paramViewGroup.setTag(paramView);
    }
    paramView = (jeh)paramViewGroup.getTag();
    ...
    if (localTroopFileInfo != null)
    {
      ...
      paramView.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840096);
    }
    while (paramInt == MoveFileActivity.a(this.jdField_a_of_type_ComTencentBizTroopFileMoveFileActivity))
    {
      ...
      paramView.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840098);
    }
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\jeg.class
