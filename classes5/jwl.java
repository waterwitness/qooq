...
public class jwl
  implements Runnable
{
  public jwl(SmartDeviceProxyMgr paramSmartDeviceProxyMgr, ConfigurationService.Config paramConfig)
  {
  ...
  public void run()
  {
    ...
    while (!QLog.isColorLevel())
    {
      ...
      ((SharedPreferences.Editor)localObject3).putString("qfind_assist" + this.jdField_a_of_type_ComTencentDeviceDevicemgrSmartDeviceProxyMgr.b.a(), String.valueOf(((QFindConfig)localObject2).b));
      ((SharedPreferences.Editor)localObject3).commit();
      FileUtils.a(BaseApplicationImpl.a().getFilesDir() + "/qfindconfig", (String)localObject1);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\jwl.class
