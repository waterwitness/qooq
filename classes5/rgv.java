...
{
  public rgv(FavroamingManager paramFavroamingManager)
  {
  ...
  public void a(EmoticonPackage paramEmoticonPackage, int paramInt)
  {
    ...
    EmojiListenerManager.a().b(FavroamingManager.access$000(this.a));
    Object localObject = (FavroamingDBManager)this.a.mApp.getManager(148);
    ...
    do
    {
      ...
      if (i < localList.size())
      {
        ...
        {
          localFavroamingManager.onFileDone(localCustomEmotionData, bool);
          i += 1;
          break;
        }
      }
      localObject = (FavEmoRoamingHandler)this.a.mApp.a(72);
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\rgv.class
