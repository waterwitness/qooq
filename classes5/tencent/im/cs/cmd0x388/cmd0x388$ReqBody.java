  ...
  extends MessageMicro
{
  ...
  public final PBRepeatMessageField rpt_msg_del_img_req = PBField.initRepeatMessage(cmd0x388.DelImgReq.class);
  ...
  public final PBRepeatMessageField rpt_msg_query_img_req = PBField.initRepeatMessage(cmd0x388.QueryImgReq.class);
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 16, 26, 34, 42, 50, 56, 66, 74, 8010 }, new String[] { "uint32_net_type", "uint32_subcmd", "rpt_msg_tryup_img_req", "rpt_msg_getimg_url_req", "rpt_msg_tryup_ptt_req", "rpt_msg_getptt_url_req", "uint32_command_id", "rpt_msg_del_img_req", "rpt_msg_query_img_req", "bytes_extension" }, new Object[] { Integer.valueOf(0), Integer.valueOf(0), null, null, null, null, Integer.valueOf(0), null, null, localByteStringMicro }, ReqBody.class);
  }
}


/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\tencent\im\cs\cmd0x388\cmd0x388$ReqBody.class
