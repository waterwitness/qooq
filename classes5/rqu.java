...
{
  public rqu(QfileBaseCloudFileTabView paramQfileBaseCloudFileTabView)
  {
  ...
  public void onClick(View paramView)
  {
    ...
    paramView = QfileBaseCloudFileTabView.d(this.a).a().c(localWeiYunFileInfo.a);
    if (paramView != null) {
      if (((QfileCloudFileBaseExpandableListAdapter.CloudItemHolder)localObject).c == 1)
      {
        ...
        if (FileManagerUtil.a()) {
          FMDialogUtil.a(this.a.getContext(), 2131362855, 2131362851, new rqv(this, paramView));
        }
      }
    }
    for (;;)
    {
      ...
      if (((QfileCloudFileBaseExpandableListAdapter.CloudItemHolder)localObject).c == 3)
      {
        ...
        if (FileManagerUtil.a()) {
          FMDialogUtil.a(this.a.getContext(), 2131362855, 2131362851, new rqw(this, paramView));
        } else {
      ...
      else if (((QfileCloudFileBaseExpandableListAdapter.CloudItemHolder)localObject).c == 2)
      {
        ...
        if (FileManagerUtil.a())
        {
          FMDialogUtil.a(this.a.getContext(), 2131362855, 2131362851, new rqx(this, localWeiYunFileInfo));
        }
        else
        {
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\rqu.class
