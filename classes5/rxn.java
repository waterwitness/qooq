...
{
  public rxn(OfflineSendWorker paramOfflineSendWorker)
  {
  ...
  protected void a(boolean paramBoolean, FileTransferHandler.FileUploadInfo paramFileUploadInfo, MessageObserver.StatictisInfo paramStatictisInfo, List paramList)
  {
    ...
    do
    {
      ...
      if (paramList == null)
      {
        ...
        if (FMConfig.b)
        {
          paramStatictisInfo.clear();
          paramStatictisInfo.add(0, "14.17.29.27:" + paramFileUploadInfo.jdField_a_of_type_Short);
        }
        ...
        OfflineSendWorker.a(this.a, FileUploader.a(OfflineSendWorker.a(this.a), OfflineSendWorker.a(this.a).nSessionId, OfflineSendWorker.a(this.a).peerType, 0, OfflineSendWorker.a(this.a).getFilePath(), paramStatictisInfo, paramList));
      }
      for (;;)
      {
        if (OfflineSendWorker.a(this.a) == null) {
        ...
        if (2 == paramFileUploadInfo.jdField_d_of_type_Int)
        {
          ...
          OfflineSendWorker.a(this.a, FileUploader.a(OfflineSendWorker.a(this.a), OfflineSendWorker.a(this.a).nSessionId, OfflineSendWorker.a(this.a).peerType, 0, OfflineSendWorker.a(this.a).getFilePath(), paramList, OfflineSendWorker.a(this.a).strFileSHA, paramStatictisInfo, "/ftn_handler"));
        }
        else
        {
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\rxn.class
