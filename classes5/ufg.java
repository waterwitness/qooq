...
public class ufg
  implements Runnable
{
  public ufg(RedTouchWebviewHandler paramRedTouchWebviewHandler, String paramString, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((JSONObject)localObject9).has("serial"))
        {
          ...
          localObject7 = localObject2;
          localObject8 = localObject1;
          localAppInfo = RedTouchWebviewHandler.access$000(this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouchWebviewHandler, (String)localObject2);
      ...
      try
      {
        ...
        if ((this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouchWebviewHandler.mRuntime == null) || (this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouchWebviewHandler.mRuntime.a() == null)) {
          break label1756;
        }
        localObject1 = new RedTouchManager(this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouchWebviewHandler.mRuntime.a());
        if (localObject1 == null) {
          break label1756;
        }
        localObject1 = ((RedTouchManager)localObject1).a();
        if ((TextUtils.isEmpty((CharSequence)localObject7)) || (!((String)localObject7).equals(localObject1))) {
          break label1756;
        }
        i = 1;
      }
      ...
      {
        localObject1 = this.jdField_a_of_type_ComTencentMobileqqRedtouchRedTouchWebviewHandler.mRuntime.a();
        if (localObject1 != null) {
          ((Activity)localObject1).runOnUiThread(new ufh(this, (String)localObject4, localJSONObject1, (BusinessInfoCheckUpdate.AppInfo)localObject6, k, i, localArrayList, (String)localObject7, (String)localObject8));
        }
      }
      return;
      localObject1 = "";
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\ufg.class
