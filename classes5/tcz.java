  ...
  extends BaseAdapter
{
  ...
  public tcz(RoamSearchDialog paramRoamSearchDialog)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    case 0: 
      ...
      {
        paramView = View.inflate(this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.jdField_a_of_type_AndroidContentContext, 2130904557, null);
        paramViewGroup = new tcy(null);
        paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297123));
        paramViewGroup.b = ((TextView)paramView.findViewById(2131303176));
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (tcy)paramView.getTag();
      }
    }
    if ((paramView == null) || (!(paramView instanceof LinearLayout)))
    {
      paramView = View.inflate(this.jdField_a_of_type_ComTencentMobileqqMaproamWidgetRoamSearchDialog.jdField_a_of_type_AndroidContentContext, 2130903408, null);
      paramViewGroup = new tcy(null);
      paramView.setTag(paramViewGroup);
      paramViewGroup.c = ((TextView)paramView.findViewById(2131298457));
      paramViewGroup.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)paramView.findViewById(2131297005));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131298469));
      if ((paramView != null) && ((paramView instanceof LinearLayout))) {
...
/* Location:              E:\apk\QQ_91\classes5-dex2jar.jar!\tcz.class
