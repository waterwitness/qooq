  ...
  extends AbstractImageAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      ...
      {
        int i = localURLDrawable.getProgress();
        localURLImageView.setURLDrawableDownListener(new jlc(this, paramInt, paramViewGroup));
        a(paramInt, i / 100);
        return localURLImageView;
      }
      paramView = localURLImageView;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\common\galleryactivity\UrlGalleryAdapter.class
