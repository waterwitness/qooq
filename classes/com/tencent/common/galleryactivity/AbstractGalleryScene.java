  ...
  implements AnimationLister, AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener, AdapterView.OnItemSelectedListener, Gallery.OnItemRotateListener, Gallery.OnScollListener
{
  ...
  public AbstractGalleryScene(Activity paramActivity, AbstractImageListModel paramAbstractImageListModel)
  {
    ...
    this.jdField_a_of_type_ComTencentCommonGalleryactivityAnimationLister = new jkq(this);
    this.f = false;
  ...
  protected RelativeLayout a()
  {
    return (RelativeLayout)LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2130904285, null);
  }
  ...
  public void a(ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      b((ViewGroup)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131296895));
      this.jdField_a_of_type_ComTencentWidgetGallery = ((Gallery)this.jdField_a_of_type_AndroidAppActivity.findViewById(2131298351));
      this.jdField_b_of_type_AndroidViewView = this.jdField_a_of_type_AndroidAppActivity.findViewById(2131296820);
      ...
      this.jdField_a_of_type_ComTencentWidgetGallery.setSpacing(this.jdField_a_of_type_AndroidAppActivity.getResources().getDimensionPixelSize(2131492970));
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localAlphaAnimation.setAnimationListener(new jkr(this));
  ...
  public void b(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    localAnimationSet.setAnimationListener(new jks(this));
    this.jdField_b_of_type_AndroidViewView.startAnimation(localAlphaAnimation);
  ...
  public void j()
  {
    if ((this.jdField_a_of_type_AndroidAppActivity instanceof AIOGalleryActivity))
    {
      ...
      {
        ((AIOGalleryActivity)this.jdField_a_of_type_AndroidAppActivity).a.a(-16777216);
        ((AIOGalleryActivity)this.jdField_a_of_type_AndroidAppActivity).a.b(-16777216);
      }
    }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\common\galleryactivity\AbstractGalleryScene.class
