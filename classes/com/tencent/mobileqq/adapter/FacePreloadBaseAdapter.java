  ...
  implements FaceDecoder.DecodeTaskCompletionListener, AbsListView.OnScrollListener
{
  ...
  public Bitmap a(int paramInt, String paramString)
  {
    ...
    try
    {
      paramString = BitmapFactory.decodeResource(BaseApplicationImpl.a().getResources(), 2130841857);
      return paramString;
    }
    ...
    while (i < j)
    {
      ...
      if ((localObject != null) && ((localObject instanceof FacePreloadBaseAdapter.ViewHolder)))
      {
        ...
        if ((localObject != null) && (((FacePreloadBaseAdapter.ViewHolder)localObject).b != null) && (((FacePreloadBaseAdapter.ViewHolder)localObject).b.length() > 0)) {
          ((FacePreloadBaseAdapter.ViewHolder)localObject).d.setImageBitmap(a(((FacePreloadBaseAdapter.ViewHolder)localObject).c, ((FacePreloadBaseAdapter.ViewHolder)localObject).b));
        }
      }
      i += 1;
      continue;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\adapter\FacePreloadBaseAdapter.class
