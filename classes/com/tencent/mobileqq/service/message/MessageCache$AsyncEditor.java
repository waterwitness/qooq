    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (Build.VERSION.SDK_INT < 9) {
        try
        {
          ...
          QLog.d(MessageCache.c(), 2, "AsyncEditor commit fail!");
          return;
        }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\service\message\MessageCache$AsyncEditor.class
