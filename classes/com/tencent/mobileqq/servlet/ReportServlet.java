  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (("App_GetDataCount".equals(localObject1)) && (paramFromServiceMsg.isSuccess()))
    {
      ...
      if ((localObject2 != null) && (localObject2.length == 4) && (localObject2[0].equals("param_XGC2CPicDownloadFlow"))) {
        notifyObserver(paramIntent, 3, paramFromServiceMsg.isSuccess(), (Bundle)localObject1, PreDownloadStrategyBeta.class);
      }
    }
    boolean bool;
    do
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\servlet\ReportServlet.class
