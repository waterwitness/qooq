  ...
  extends Entity
{
  ...
  {
    return (this.istroop == 0) || (this.istroop == 1) || (this.istroop == 3000) || (this.istroop == 1001) || (this.istroop == 1010) || (this.istroop == 1020);
  }
  ...
  public void removeExtInfoToExtStr(String paramString)
  {
    try
    {
      ...
      {
        this.extStr = null;
        this.extLong = ((int)(this.extLong & 0xFFFFFFFFFFFFFFFE));
        return;
      }
    }
    catch (Exception paramString)
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\data\MessageRecord.class
