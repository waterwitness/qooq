  ...
  implements Cloneable
{
  ...
  public static int MULTI_FLAGS_MASK_SHIELD = 0;
  ...
  {
    return (this.status == 10) || (this.status == 11) || ((this.status == 20) && (this.sqqOnLineState == 1)) || (this.status == 30) || (this.status == 31);
  }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\data\Friends.class
