  ...
  extends BaseMessageProcessor
{
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    catch (Exception paramObject)
    {
      for (;;)
      {
        int i;
        if (QLog.isColorLevel()) {
          QLog.e("Q.msg.BaseMessageProcessor", 2, "<---handleSendTransMessageResp::invalid.", (Throwable)paramObject);
        }
        paramObject = null;
        continue;
        if (((msg_svc.PbSendMsgResp)paramObject).result.get() != 0)
        {
          i = ((msg_svc.PbSendMsgResp)paramObject).result.get();
          continue;
          label297:
          if (i == 255) {}
          for (int j = 1;; j = 0)
          {
            if (j != 0)
            {
              ...
              if (((MessageHandler)paramObject).a(paramFromServiceMsg, "server")) {
                break;
              }
            }
            if ((i != 0) && (i != 241)) {
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, MessageFactoryReceiver.OffLineFileInfo paramOffLineFileInfo)
  {
    ...
    localStatictisInfo.c = paramFromServiceMsg.getResultCode();
    localStatictisInfo.jdField_d_of_type_Int = i;
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    catch (Exception paramObject)
    {
      for (;;)
      {
        int i;
        if (QLog.isColorLevel()) {
          QLog.e("Q.msg.BaseMessageProcessor", 2, "<---handleSendTransMessageExResp::invalid.", (Throwable)paramObject);
        }
        paramObject = null;
        continue;
        if (((msg_svc.PbSendMsgResp)paramObject).result.get() != 0)
        {
          ...
          for (int j = 1;; j = 0)
          {
            ...
            if ((((msg_svc.PbSendMsgResp)paramObject).send_time.has()) && (l1 != 0L))
            {
              l2 = ((msg_svc.PbSendMsgResp)paramObject).send_time.get() & 0xFFFFFFFF;
          ...
          if (((msg_svc.PbSendMsgResp)paramObject).send_time.has()) {
            a(str2 + String.valueOf(((msg_svc.PbSendMsgResp)paramObject).send_time.get()));
          }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, MessageFactoryReceiver.OffLineFileInfo paramOffLineFileInfo)
  {
    ...
    for (;;)
    {
      ...
      long l2 = paramOffLineFileInfo.jdField_d_of_type_Long;
      ...
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.BaseMessageProcessor", 2, "<<---handleGetOffLineFileResp serverPath: " + (String)localObject + " strFileName: " + str1 + " time: " + paramOffLineFileInfo.jdField_d_of_type_Long + " seq: " + paramOffLineFileInfo.jdField_a_of_type_Short);
      }
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.BaseMessageProcessor", 2, "friendUin:" + str2 + "  struct.senderUin: " + paramOffLineFileInfo.jdField_b_of_type_Long + " struct.time: " + paramOffLineFileInfo.jdField_d_of_type_Long + " struct.seq: " + paramOffLineFileInfo.jdField_a_of_type_Short);
      }
      int i;
  ...
  public boolean a(String paramString, int paramInt1, byte[] paramArrayOfByte1, int paramInt2, int paramInt3, byte[] paramArrayOfByte2, FMTransC2CMsgInfo paramFMTransC2CMsgInfo)
  {
    ...
    a(true, true, true, l, new qlv(this, paramString, paramFMTransC2CMsgInfo, paramInt1, paramArrayOfByte2, paramArrayOfByte1, paramInt2, paramInt3));
    return true;
  }
  ...
  public boolean a(String paramString, int paramInt, byte[] paramArrayOfByte, FMTransC2CMsgInfo paramFMTransC2CMsgInfo)
  {
    ...
    long l = i;
    paramFMTransC2CMsgInfo.queueSeq = l;
    a(true, true, true, l, new qlw(this, paramString, paramFMTransC2CMsgInfo, paramInt, paramArrayOfByte));
    return true;
  }
  ...
  public boolean a(String paramString, long paramLong, int paramInt, byte[] paramArrayOfByte)
  {
    ...
    MobileQQService.c = i + 1;
    long l = i;
    a(true, true, true, l, new qlx(this, paramString, paramLong, Math.abs(new Random().nextInt()), l, paramInt, paramArrayOfByte));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\app\message\OfflineFileMessageProcessor.class
