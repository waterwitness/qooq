  ...
  extends BaseMessageProcessor
{
  ...
  private void a(MessageRecord paramMessageRecord, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    ToServiceMsg localToServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a("PbMessageSvc.PbDelOneRoamMsg");
    ...
    for (;;)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.c(localToServiceMsg);
      return;
      if (i2 == 1)
      {
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (i2 == 2901)
    {
      ...
      if (l2 > 0L)
      {
        paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a("MessageSvc.PbMultiMsgSend");
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.c(paramFromServiceMsg);
        return;
      }
    }
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.b(8019, false, new Object[] { Integer.valueOf(i2), Long.valueOf(0L) });
  }
  ...
  private void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      if ((paramToServiceMsg == null) || (!paramToServiceMsg.result.has()))
      {
        ...
        bool1 = true;
        this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.b(8019, bool1, new Object[] { Integer.valueOf(i1), Long.valueOf(l1) });
        if (QLog.isColorLevel()) {
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.b(8018, false, new Object[] { Integer.valueOf(0) });
    if (QLog.isColorLevel()) {
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (i1 == 1)
    {
      ...
      if (i2 == 2901)
      {
        ...
        if (l4 > 0L)
        {
          paramFromServiceMsg = this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a("PbMessageSvc.PbMsgWithDraw");
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (i1 == 2)
    {
      ...
      try
      {
        ...
        if (((msg_svc.PbMsgWithDrawResp)paramObject).c2c_with_draw.has())
        {
          paramObject = ((msg_svc.PbMsgWithDrawResp)paramObject).c2c_with_draw.get();
          i1 = i4;
          if (paramObject == null) {
            break label486;
          }
          ...
          for (;;)
          {
            ...
            localObject1 = (msg_svc.PbC2CMsgWithDrawResp)((Iterator)paramObject).next();
    ...
    {
      i1 = i4;
      if (((msg_svc.PbMsgWithDrawResp)paramObject).group_with_draw.has())
      {
        paramObject = ((msg_svc.PbMsgWithDrawResp)paramObject).group_with_draw.get();
        i1 = i4;
        if (paramObject != null)
        {
          i1 = i4;
          if (!((List)paramObject).isEmpty())
          {
            ...
            for (;;)
            {
              ...
              localObject1 = (msg_svc.PbGroupMsgWithDrawResp)((Iterator)paramObject).next();
        ...
        if (i1 == 1)
        {
          ...
          for (;;)
          {
            try
            {
              ...
              if ((paramObject == null) || (((List)paramObject).isEmpty()) || (((msg_svc.PbC2CMsgWithDrawResp)((List)paramObject).get(0)).uint32_sub_cmd.get() != 1)) {
                break label875;
              }
              ...
              i1 = ((msg_svc.PbC2CMsgWithDrawResp)paramObject).result.get();
              if ((i1 >= 0) && (i1 <= 1000))
              {
              ...
              paramToServiceMsg = ((msg_svc.PbC2CMsgWithDrawResp)paramObject).errmsg.get();
            }
            catch (Exception paramToServiceMsg)
            {
              if (QLog.isColorLevel()) {
              ...
              a(((RevokeMsgInfo)((ArrayList)localObject1).get(0)).jdField_a_of_type_JavaLangString, i4, i, t);
              return;
            }
            a(((RevokeMsgInfo)((ArrayList)localObject1).get(0)).jdField_a_of_type_JavaLangString, i4, i, i1);
          }
          label875:
    ...
    if (((msg_svc.PbGroupMsgWithDrawResp)localObject3).failed_msg_list.has())
    {
      ...
      if ((localList != null) && (!localList.isEmpty()))
      {
        ...
        while (localIterator.hasNext())
        {
          ...
          i3 = ((msg_svc.PbGroupMsgWithDrawResp.MessageResult)paramObject).uint32_result.get();
          int i6 = ((msg_svc.PbGroupMsgWithDrawResp.MessageResult)paramObject).uint32_msg_seq.get();
          paramFromServiceMsg = "";
          try
          {
            paramObject = ((msg_svc.PbGroupMsgWithDrawResp.MessageResult)paramObject).bytes_err_msg.get().toStringUtf8();
    ...
    for (i1 = i3;; i1 = 0)
    {
      ...
      a(((RevokeMsgInfo)((ArrayList)localObject1).get(0)).jdField_a_of_type_JavaLangString, i4, i, i2);
      break;
    }
  }
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    catch (Exception paramObject)
    {
      do
      {
        ...
        } while ((paramObject == null) || (!((msg_svc.PbDelRoamMsgResp)paramObject).result.has()));
        i1 = ((msg_svc.PbDelRoamMsgResp)paramObject).result.get();
        if (QLog.isColorLevel()) {
  ...
  public ToServiceMsg a(List paramList, int paramInt)
  {
    ...
    if ((paramInt == 1) && (!((MessageRecord)localObject1).isSend()))
    {
      QLog.e("revokeMsg", 1, "buildRevokeOrDeleteMultiMsgReq error, msg not send");
      a(((MessageRecord)localObject1).frienduin, ((MessageRecord)localObject1).istroop, l, u);
      return null;
    }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        default: 
          ...
          paramList = this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a("PbMessageSvc.PbMsgWithDraw");
        ...
        case 1000: 
        case 1004: 
          localObject3 = new msg_svc.PbC2CMsgWithDrawReq();
          ((msg_svc.PbC2CMsgWithDrawReq)localObject3).uint32_sub_cmd.set(paramInt);
          localObject5 = paramList.iterator();
          if (((Iterator)localObject5).hasNext())
          {
            localObject6 = (MessageRecord)((Iterator)localObject5).next();
            i3 = (short)(int)((MessageRecord)localObject6).shmsgseq;
            int i4 = MessageUtils.b(((MessageRecord)localObject6).msgUid);
            localObject7 = new msg_svc.PbC2CMsgWithDrawReq.MsgInfo();
            if ((paramInt == 1) && (i2 == 0)) {}
            for (localObject2 = ((MessageRecord)localObject6).senderuin;; localObject2 = ((MessageRecord)localObject6).selfuin)
            {
              ((msg_svc.PbC2CMsgWithDrawReq.MsgInfo)localObject7).uint64_from_uin.set(Long.valueOf((String)localObject2).longValue());
              ((msg_svc.PbC2CMsgWithDrawReq.MsgInfo)localObject7).uint64_to_uin.set(Long.valueOf(((MessageRecord)localObject6).frienduin).longValue());
              ((msg_svc.PbC2CMsgWithDrawReq.MsgInfo)localObject7).uint32_msg_seq.set(i3 & 0xFFFF);
              ((msg_svc.PbC2CMsgWithDrawReq.MsgInfo)localObject7).uint64_msg_uid.set(((MessageRecord)localObject6).msgUid);
              ((msg_svc.PbC2CMsgWithDrawReq.MsgInfo)localObject7).uint64_msg_time.set(((MessageRecord)localObject6).time);
              ((msg_svc.PbC2CMsgWithDrawReq.MsgInfo)localObject7).uint32_msg_random.set(i4);
              if (((MessageRecord)localObject6).isLongMsg())
              {
                ((msg_svc.PbC2CMsgWithDrawReq.MsgInfo)localObject7).uint32_div_seq.set(((MessageRecord)localObject6).longMsgId);
                ((msg_svc.PbC2CMsgWithDrawReq.MsgInfo)localObject7).uint32_pkg_num.set(((MessageRecord)localObject6).longMsgCount);
                ((msg_svc.PbC2CMsgWithDrawReq.MsgInfo)localObject7).uint32_pkg_index.set(((MessageRecord)localObject6).longMsgIndex);
              }
              if (((MessageRecord)localObject6).msgtype == 63531)
              {
                localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(((MessageRecord)localObject6).uniseq, ((MessageRecord)localObject6).frienduin, ((MessageRecord)localObject6).istroop);
                if ((localObject2 != null) && (!TextUtils.isEmpty(((FileManagerEntity)localObject2).Uuid))) {
                  ((ArrayList)localObject4).add(((FileManagerEntity)localObject2).Uuid);
                }
                ((msg_svc.PbC2CMsgWithDrawReq.MsgInfo)localObject7).uint32_msg_type.set(1);
              }
              ((msg_svc.PbC2CMsgWithDrawReq)localObject3).msg_info.add((MessageMicro)localObject7);
              localArrayList.add(new RevokeMsgInfo((MessageRecord)localObject6));
              if (!QLog.isColorLevel()) {
                break;
              }
              QLog.d("revokeMsg", 2, String.format((String)localObject1 + ",istroop %s, frienduin %s, shmsgseq %s, time %s, random %s, uid %s", new Object[] { Integer.valueOf(((MessageRecord)localObject6).istroop), ((MessageRecord)localObject6).frienduin, Long.valueOf(((MessageRecord)localObject6).shmsgseq), Long.valueOf(((MessageRecord)localObject6).time), Integer.valueOf(i4), Long.valueOf(((MessageRecord)localObject6).msgUid) }));
              break;
            }
          }
          if (bool) {
            ((msg_svc.PbC2CMsgWithDrawReq)localObject3).uint32_long_message_flag.set(1);
          }
          for (;;)
          {
            ...
            if (((ArrayList)localObject4).size() > 0) {
              ((msgrevoke_userdef.UinTypeUserDef)localObject1).str_file_uuid.addAll((Collection)localObject4);
            }
            if ((i1 == 1) || (i1 == 2)) {
            ...
            ((msg_svc.PbC2CMsgWithDrawReq)localObject3).bytes_reserved.set(ByteStringMicro.copyFrom(((msgrevoke_userdef.UinTypeUserDef)localObject1).toByteArray()));
            paramList = null;
            localObject1 = localObject3;
            break;
            ((msg_svc.PbC2CMsgWithDrawReq)localObject3).uint32_long_message_flag.set(0);
          }
        case 1: 
        case 3000: 
          ...
          while (((Iterator)localObject3).hasNext())
          {
            ...
            i1 = (int)((MessageRecord)localObject5).shmsgseq;
            i3 = MessageUtils.b(((MessageRecord)localObject5).msgUid);
            ...
            {
              localObject7 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(((MessageRecord)localObject5).uniseq, ((MessageRecord)localObject5).frienduin, ((MessageRecord)localObject5).istroop);
              if ((localObject7 != null) && (!TextUtils.isEmpty(((FileManagerEntity)localObject7).Uuid))) {
                ((ArrayList)localObject4).add(((FileManagerEntity)localObject7).Uuid);
              }
              ((msg_svc.PbGroupMsgWithDrawReq.MessageInfo)localObject6).uint32_msg_type.set(1);
            }
            ((msg_svc.PbGroupMsgWithDrawReq)localObject2).msg_list.add((MessageMicro)localObject6);
            localArrayList.add(new RevokeMsgInfo((MessageRecord)localObject5));
            if (QLog.isColorLevel()) {
              QLog.d("revokeMsg", 2, String.format((String)localObject1 + ",istroop %s, frienduin %s, shmsgseq %s", new Object[] { Integer.valueOf(((MessageRecord)localObject5).istroop), ((MessageRecord)localObject5).frienduin, Long.valueOf(((MessageRecord)localObject5).shmsgseq) }));
            }
          }
          ((msg_svc.PbGroupMsgWithDrawReq)localObject2).uint32_sub_cmd.set(paramInt);
          if (i2 == 1)
          {
            ((msg_svc.PbGroupMsgWithDrawReq)localObject2).uint32_group_type.set(0);
            label1143:
            ((msg_svc.PbGroupMsgWithDrawReq)localObject2).uint64_group_code.set(Long.valueOf(((MessageRecord)paramList.get(0)).frienduin).longValue());
            localObject1 = new msgrevoke_userdef.MsgInfoUserDef();
            if (((ArrayList)localObject4).size() > 0) {
              ((msgrevoke_userdef.MsgInfoUserDef)localObject1).str_file_uuid.addAll((Collection)localObject4);
            }
            if (paramInt != 1) {
              break label1371;
            }
          ...
          for (;;)
          {
            ((msg_svc.PbGroupMsgWithDrawReq)localObject2).bytes_userdef.set(ByteStringMicro.copyFrom(((msgrevoke_userdef.MsgInfoUserDef)localObject1).toByteArray()));
            ...
            ((msg_svc.PbGroupMsgWithDrawReq)localObject2).uint32_group_type.set(1);
            break label1143;
            label1256:
            ...
            while (paramList.hasNext())
            {
              ...
              ((msgrevoke_userdef.MsgInfoUserDef.MsgInfoDef)localObject4).uint32_msg_seq.set(i1 & 0xFFFFFFFF);
              ((msgrevoke_userdef.MsgInfoUserDef.MsgInfoDef)localObject4).long_msg_id.set(((MessageRecord)localObject3).longMsgId);
              ((msgrevoke_userdef.MsgInfoUserDef.MsgInfoDef)localObject4).long_msg_num.set(((MessageRecord)localObject3).longMsgCount);
              ((msgrevoke_userdef.MsgInfoUserDef.MsgInfoDef)localObject4).long_msg_index.set(((MessageRecord)localObject3).longMsgIndex);
              ((msgrevoke_userdef.MsgInfoUserDef)localObject1).long_msg_info.add((MessageMicro)localObject4);
            }
            continue;
            label1371:
            if (paramInt == 2)
  ...
  public void a(MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      break;
      if ((!MsgProxyUtils.a(paramMessageRecord)) && (MsgProxyUtils.f(paramMessageRecord.msgtype)))
      {
        ...
        for (;;)
        {
          ...
          while (i2 < 12)
          {
            localSendMessageHandler.a(new qmw(this, localMessageRecord, l1));
            i2 += 1;
          }
          i2 = 0;
          if (i2 < 6)
  ...
  {
    paramArrayList = MessageHandlerUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramMessageRecord, paramArrayList, paramHongbaoParams);
    if (paramArrayList == null)
    {
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.UncommonMessageProcessor", 2, "sendBlessMsg error, msgReq is null!");
      }
      this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.b(8019, false, new Object[] { Integer.valueOf(0), Long.valueOf(0L) });
      return;
    }
    a(false, true, true, 0L, new qmu(this, paramMessageRecord, paramArrayList));
  }
  ...
  public void a(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.b(8016, false, null);
  ...
  public void a(String paramString, ArrayList paramArrayList)
  {
    ...
    localmsg.uin.set(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getLongAccountUin());
    localmsg.time.set(l1);
    localmsg.number.set(1);
    localmsg.text.set(ByteStringMicro.copyFrom(paramString.getBytes()));
    localmsg.touin_count.set(paramArrayList.size());
    paramString = paramArrayList.iterator();
    while (paramString.hasNext())
    {
      paramArrayList = (String)paramString.next();
      localmsg.touin_list.add(Long.valueOf(paramArrayList));
    }
    paramString = this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.a("SecSvcBlessingHelper.blessing_helper");
    paramString.extraData.putLong("bless_sendreq_time", l1);
    paramString.putWupBuffer(localmsg.toByteArray());
    paramString.setTimeout(15000L);
    paramString.setEnableFastResend(true);
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.b(paramString);
  }
  ...
  public void a(List paramList)
  {
    ...
    while (i1 < 12)
    {
      localSendMessageHandler.a(new qmv(this, paramList));
      i1 += 1;
    }
    i1 = 0;
    label86:
  ...
  {
    if ((paramBoolean) && (!this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().f())) {
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqAppMessageHandler.b(8016, true, new Object[] { paramList, Boolean.valueOf(paramBoolean) });
  }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\app\message\UncommonMessageProcessor.class
