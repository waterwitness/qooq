  ...
  implements IMessageManager
{
  ...
  private void a(DataLineMsgRecord paramDataLineMsgRecord, EntityManager paramEntityManager)
  {
    ...
    QQMessageFacade.Message localMessage = this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a(String.valueOf(this.b), this.jdField_a_of_type_Int);
    localMessage.selfuin = String.valueOf(this.b);
    localMessage.senderuin = String.valueOf(this.b);
    localMessage.msgtype = paramDataLineMsgRecord.msgtype;
    if (localMessage.msgtype == 63527) {
      localMessage.msgtype = 63531;
    }
    ...
    localMessage.frienduin = String.valueOf(this.b);
  ...
  public int a()
  {
    ...
    localObject = this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a(String.valueOf(this.b), this.jdField_a_of_type_Int);
  ...
  public int a(long paramLong)
  {
    ...
    new Handler(localLooper).post(new qlm(this, localDataLineMsgSet));
    return 0;
  }
  ...
  public int a(DataLineMsgSet paramDataLineMsgSet)
  {
    ...
    if (Thread.currentThread() == ((Looper)localObject).getThread())
    {
      ...
      if (i > 0)
      {
        paramDataLineMsgSet = MsgProxyUtils.a(String.valueOf(this.b), this.jdField_a_of_type_Int);
        ...
        if (l > 0L)
        {
          ...
          {
            paramDataLineMsgSet = (DataLineMsgSet)localObject;
            if (((DataLineMsgRecord)localObject).msgtype == 60536)
            {
              paramDataLineMsgSet = (DataLineMsgSet)localObject;
              if (l > 1L) {
          ...
          if (paramDataLineMsgSet != null)
          {
            ...
            this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a.put(MsgProxyUtils.a(String.valueOf(this.b), this.jdField_a_of_type_Int), localObject);
          }
        }
        paramDataLineMsgSet = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createEntityManager();
        localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().a(String.valueOf(this.b), this.jdField_a_of_type_Int);
    ...
    new Handler((Looper)localObject).post(new qln(this, paramDataLineMsgSet));
    return 0;
  }
  ...
  public long a(DataLineMsgRecord paramDataLineMsgRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (Thread.currentThread() == ((Looper)localObject2).getThread())
      {
        ...
        try
        {
          ...
          RecentUser localRecentUser = ((RecentUserProxy)localObject2).a(String.valueOf(this.b), this.jdField_a_of_type_Int);
    ...
    new Handler((Looper)localObject2).post(new qll(this, paramDataLineMsgRecord, (WaitEvent)localObject1));
  ...
  public void b()
  {
    ...
    try
    {
      ...
      RecentUser localRecentUser = localRecentUserProxy.a(String.valueOf(this.b), this.jdField_a_of_type_Int);
      localRecentUser.type = this.jdField_a_of_type_Int;
      localRecentUser.lastmsgtime = MessageCache.a();
      localRecentUserProxy.a(localRecentUser);
      ((EntityManager)localObject1).a();
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a(String.valueOf(this.b), this.jdField_a_of_type_Int);
  ...
  public void e()
  {
    ...
    do
    {
      return;
      if (QLog.isColorLevel()) {
        QLog.d("Q.msg.DatalineMessageManager", 2, "setDataLineMsgReaded,unread=" + this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a().a(this.b, this.jdField_a_of_type_Int));
      }
    } while (this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a().a(this.b, this.jdField_a_of_type_Int) <= 0);
    a().e();
    this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a().a(this.b, this.jdField_a_of_type_Int, true);
    this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a(this.jdField_a_of_type_ComTencentMobileqqAppMessageQQMessageFacade.a(this.b, this.jdField_a_of_type_Int));
  }
}


/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\app\message\DatalineMessageManager.class
