  ...
  extends FullCache
{
  ...
  public Calendar a(String paramString, Calendar paramCalendar, List paramList)
  {
    ...
    for (;;)
    {
      ...
      if (m >= 0)
      {
        paramList = (RoamDate)((Map.Entry)localList.get(m)).getValue();
        if (m != i) {
          break label268;
        }
        k = i1 - 2;
  ...
  public List a()
  {
    ...
    Collections.sort(localArrayList, new qin(this));
  ...
  public boolean a(String paramString, Calendar paramCalendar, List paramList)
  {
    boolean bool2 = false;
    boolean bool1 = bool2;
    int j;
  ...
  public Calendar b(String paramString, Calendar paramCalendar, List paramList)
  {
    Object localObject2 = null;
    Object localObject1 = null;
    List localList = paramList;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\app\asyncdb\cache\RoamDateCache.class
