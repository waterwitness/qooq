  ...
  extends FTSIndexOperator
{
  ...
  public ArrayList a(String paramString, Class paramClass, boolean paramBoolean)
  {
    ...
    while (!QLog.isColorLevel())
    {
      ...
      paramString = FTSArgsFactory.a(paramString, (String[])((ArrayList)localObject).toArray(new String[((ArrayList)localObject).size()]), paramClass, paramBoolean);
  ...
  public void a(MsgQueueItem paramMsgQueueItem, EntityManager paramEntityManager)
  {
    ...
    while (paramMsgQueueItem.hasNext())
    {
      ...
      if ((((MessageRecord)localObject1).isSupportFTS()) && (((MessageRecord)localObject1).isValid) && (((MessageRecord)localObject1).msgtype != 63530))
      {
        ...
        if ((localObject1 != null) && (SQLiteFTSUtils.b(paramMsgQueueItem.jdField_a_of_type_AndroidContentContentValues)))
        {
          ...
          while (((Iterator)localObject1).hasNext())
          {
            ...
            if ((((MessageRecord)localObject2).isSupportFTS()) && (((MessageRecord)localObject2).isValid) && (((MessageRecord)localObject2).msgtype != 63530))
            {
  ...
  {
    if (((paramEntity instanceof MessageRecord)) && (((MessageRecord)paramEntity).isSupportFTS()) && (((MessageRecord)paramEntity).isValid) && (((MessageRecord)paramEntity).msgtype != 63530))
    {
  ...
  public void a(FTSEntity paramFTSEntity, boolean paramBoolean)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a())) {
      if (paramFTSEntity == null) {
        if (QLog.isColorLevel()) {
          QLog.w("Q.fts.FTSMsgOperator", 2, "insert: entity == null");
        }
      }
    }
    while (!QLog.isColorLevel())
    {
      do
      {
        ...
        QLog.w("Q.fts.FTSMsgOperator", 2, "insert: entity no valid");
        return;
        paramFTSEntity.insertOpt();
        if (paramBoolean)
        {
          paramFTSEntity.preWrite();
          this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a(paramFTSEntity);
          return;
        }
        this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramFTSEntity);
        if (this.d)
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.fts.FTSMsgOperator", 2, "insert after destroy");
          }
          d();
          return;
        }
      ...
      if (QLog.isColorLevel()) {
        QLog.d("Q.fts.FTSMsgOperator", 2, "insert workerthread notify");
      }
      d();
      return;
    }
  ...
  public void b(MsgQueueItem paramMsgQueueItem, EntityManager paramEntityManager)
  {
    ...
    else
    {
      while (paramMsgQueueItem.hasNext())
      {
        ...
        if ((((MessageRecord)localObject).isSupportFTS()) && (((MessageRecord)localObject).isValid) && (((MessageRecord)localObject).msgtype != 63530))
        {
          ...
          ((FTSMessage)localObject).mOId = Long.MIN_VALUE;
        }
      }
    }
    try
    {
      ...
      ((FTSMessage)localObject).istroop = paramMsgQueueItem.h;
      ((FTSMessage)localObject).deleteOpt();
      paramEntityManager.b(FTSMessageCodec.a((FTSMessage)localObject));
      return;
    }
  ...
  public void b(FTSEntity paramFTSEntity, boolean paramBoolean)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a())) {
      if (paramFTSEntity == null) {
        if (QLog.isColorLevel()) {
          QLog.w("Q.fts.FTSMsgOperator", 2, "delete: entity == null");
        }
      }
    }
    while (!QLog.isColorLevel())
    {
      do
      {
        ...
        QLog.w("Q.fts.FTSMsgOperator", 2, "delete: entity no valid");
        return;
        paramFTSEntity.deleteOpt();
        if (paramBoolean)
        {
          paramFTSEntity.preWrite();
          this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a(paramFTSEntity);
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.fts.FTSMsgOperator", 2, "delete after destroy");
          }
          d();
          return;
        }
      ...
      if (QLog.isColorLevel()) {
        QLog.d("Q.fts.FTSMsgOperator", 2, "delete workerthread notify");
      }
      d();
      return;
    }
  ...
  public void c(FTSEntity paramFTSEntity, boolean paramBoolean)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase != null) && (this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.a())) {
      if (paramFTSEntity == null) {
        if (QLog.isColorLevel()) {
          QLog.w("Q.fts.FTSMsgOperator", 2, "update: entity == null");
        }
      }
    }
    while (!QLog.isColorLevel())
    {
      do
      {
        ...
        QLog.w("Q.fts.FTSMsgOperator", 2, "update: entity no valid");
        return;
        paramFTSEntity.upgradeOpt();
        if (paramBoolean)
        {
          paramFTSEntity.preWrite();
          this.jdField_a_of_type_ComTencentMobileqqPersistenceFtsFTSDatatbase.b(paramFTSEntity);
          return;
        }
        this.jdField_a_of_type_JavaUtilConcurrentCopyOnWriteArrayList.add(paramFTSEntity);
        if (this.d)
        {
          if (QLog.isColorLevel()) {
            QLog.d("Q.fts.FTSMsgOperator", 2, "update after destroy");
          }
          d();
          return;
        }
      ...
      if (QLog.isColorLevel()) {
        QLog.d("Q.fts.FTSMsgOperator", 2, "update workerthread notify");
      }
      d();
      return;
    }
  ...
  {
    int j = 0;
    if ((!FTSDBManager.a) && (SQLiteFTSUtils.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface))) {
      if (QLog.isColorLevel()) {
        QLog.e("Q.fts.FTSMsgOperator", 2, "transToDatabase ENABLE = " + FTSDBManager.a + ", FTSUpgradeFlag = " + SQLiteFTSUtils.d(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface));
      }
    }
    label217:
    label296:
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\app\proxy\fts\FTSMsgOperator.class
