  ...
  extends BaseProxy
{
  ...
  public long a(MpfileTaskRecord paramMpfileTaskRecord)
  {
    ...
    new Handler(localLooper).post(new qnl(this, paramMpfileTaskRecord, localWaitEvent));
    localWaitEvent.a(-1L);
    return 0L;
  }
  ...
  public void a(Entity paramEntity, ProxyListener paramProxyListener)
  {
    ...
    new Handler(localLooper).post(new qni(this, paramEntity, paramProxyListener, localWaitEvent));
    localWaitEvent.a(-1L);
  }
  ...
  public void a(String paramString1, ContentValues paramContentValues, String paramString2, String[] paramArrayOfString, ProxyListener paramProxyListener)
  {
    ...
    new Handler(localLooper).post(new qnj(this, paramString1, paramContentValues, paramString2, paramArrayOfString, paramProxyListener));
  }
  ...
  public void a(String paramString1, String paramString2, String[] paramArrayOfString, ProxyListener paramProxyListener)
  {
    ...
    new Handler(localLooper).post(new qnk(this, paramString1, paramString2, paramArrayOfString, paramProxyListener));
  }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\app\proxy\MpfileTaskProxy.class
