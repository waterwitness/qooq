  ...
  extends BusinessHandler
{
  ...
  {
    paramObject = this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(ChatHistoryForC2C.class);
    Object localObject;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg.uint32_result.has()))
        {
          ...
          if ((i == 0) && (j == 0) && (m == 0) && (n == 0))
          {
            ...
            ((MqqHandler)paramObject).sendMessageDelayed(((MqqHandler)paramObject).obtainMessage(16), 0L);
          }
        }
        else
        {
      ...
      catch (InvalidProtocolBufferMicroException paramToServiceMsg)
      {
        ...
        ((MqqHandler)paramObject).sendMessageDelayed(((MqqHandler)paramObject).obtainMessage(15), 0L);
        return;
      }
      int i4 = (i - m) * 12 + (j - n) + 1;
      ...
      for (;;)
      {
        ...
        while ((i2 < m) || ((i2 == m) && (k < n)))
        {
          ...
          paramToServiceMsg.l();
          paramToServiceMsg.c();
          ((MqqHandler)paramObject).sendMessageDelayed(((MqqHandler)paramObject).obtainMessage(17), 0L);
          return;
          i2 = 12;
          i3 = k - 1;
          k = i2;
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (i = j;; i = -1)
    {
      paramToServiceMsg = this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(AuthDevForRoamMsgActivity.class);
      if (paramToServiceMsg != null)
      {
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      paramToServiceMsg = this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(ChatHistoryForC2C.class);
      if (paramToServiceMsg != null) {
  ...
  public MessageObserver a(int paramInt)
  {
    ...
    {
      qoj localqoj = new qoj(this, paramInt);
      this.jdField_a_of_type_AndroidUtilSparseArray.put(paramInt, localqoj);
    }
  ...
  public void a(String paramString, Calendar paramCalendar, boolean paramBoolean, int paramInt)
  {
    ...
    {
      return;
      paramString = this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(ChatHistoryForC2C.class);
  ...
  public void a(String paramString, Calendar paramCalendar, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    SharedPreferences localSharedPreferences = this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a().getSharedPreferences("vip_message_roam_passwordmd5_and_signature_file", 0);
    long l1;
    if (localMessageRoamManager.b() == 0)
    {
      l1 = localSharedPreferences.getLong("vip_message_roam_last_request_timestamp" + this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(), 0L);
    ...
    do
    {
      ...
      this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramString, l1, 0L, l2, (short)0, 0L, 1, localMessageRoamManager.b(), localMessageRoamManager.b(), paramBoolean1, paramInt, paramBoolean2);
    } while (localMessageRoamManager.b() != 0);
    paramString = localSharedPreferences.edit();
    paramString.putLong("vip_message_roam_last_request_timestamp" + this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(), System.currentTimeMillis());
    paramString.commit();
  }
  ...
  {
    this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a().a(paramShort, paramByte);
  }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\app\utils\MessageRoamHandler.class
