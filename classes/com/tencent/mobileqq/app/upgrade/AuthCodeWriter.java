  ...
  implements ApkWriteCodeListener
{
  ...
  {
    int i = -20;
    if (paramString1.equals(BaseApplicationImpl.a.getPackageName()))
    {
      ...
      for (;;)
      {
        ...
        if (QLog.isDevelopLevel()) {
          QLog.d("UpgradeController", 4, "writeCodeToApk:" + this.jdField_a_of_type_JavaLangString + ", forFile:" + paramString2 + " result: " + paramInt, paramString1);
        }
        return paramInt;
  ...
  {
    if (BaseApplicationImpl.a.getPackageName().equals(paramString))
    {
      if (QLog.isDevelopLevel()) {
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\app\upgrade\AuthCodeWriter.class
