...
public class d
{
  ...
  private void a(FromServiceMsg paramFromServiceMsg, f paramf)
  {
    ...
    do
    {
      ...
      com.tencent.mobileqq.msf.core.b.a.a(com.tencent.mobileqq.msf.core.b.a.i, paramFromServiceMsg);
      if (com.tencent.mobileqq.msf.core.b.b.b(paramf.c))
      {
        QLog.i("MSF.C.SsoListManager", 1, "handleLogPush, repeated push ignored");
        com.tencent.mobileqq.msf.core.b.a.a(com.tencent.mobileqq.msf.core.b.a.i, paramFromServiceMsg, com.tencent.mobileqq.msf.core.b.a.c, true, new Object[0]);
        return;
      }
      locala.f = paramf.c;
      this.C.offer(locala);
    } while (this.D != null);
    this.D = new e(this, "LogUploadThread", paramFromServiceMsg);
    this.D.start();
  }
  ...
  public static String c()
  {
    ...
    //   0: ldc 2
    //   2: monitorenter
    //   3: invokestatic 415	com/tencent/qphone/base/util/BaseApplication:getContext	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   6: ldc_w 567
    //   9: invokevirtual 421	com/tencent/qphone/base/util/BaseApplication:getSystemService	(Ljava/lang/String;)Ljava/lang/Object;
    //   12: checkcast 569	android/net/wifi/WifiManager
    //   15: invokevirtual 573	android/net/wifi/WifiManager:getConnectionInfo	()Landroid/net/wifi/WifiInfo;
    //   18: astore_0
    //   19: aload_0
    //   20: invokevirtual 578	android/net/wifi/WifiInfo:getSSID	()Ljava/lang/String;
    //   23: astore_1
    //   24: aload_1
    //   25: ifnonnull +10 -> 35
    //   28: aconst_null
    ...
    //   34: areturn
    //   35: aload_0
    //   36: invokevirtual 578	android/net/wifi/WifiInfo:getSSID	()Ljava/lang/String;
    //   39: ldc_w 580
    //   42: ldc_w 409
    //   45: invokevirtual 584	java/lang/String:replaceAll	(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    //   48: astore_0
    //   49: aload_0
    //   50: ldc_w 586
    //   53: invokevirtual 247	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   56: istore_2
    //   57: iload_2
    //   58: ifeq -28 -> 30
    //   61: aconst_null
  ...
  public void a(ArrayList paramArrayList1, ArrayList paramArrayList2, boolean paramBoolean1, boolean paramBoolean2)
  {
    for (;;)
    {
      ...
      try
      {
        if ((!this.j.sender.a.p().equals("")) || (BaseConstants.isUseDebugSso))
        {
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\msf\core\a\d.class
