...
public class a
{
  ...
  public static CopyOnWriteArrayList au()
  {
  ...
  public static CopyOnWriteArrayList av()
  {
  ...
  public static HashSet bc()
  {
    try
    {
          ...
          if ((localObject != null) && (localObject.length > 0))
          {
            ...
            while (i1 < localObject.length)
            {
              if (!TextUtils.isEmpty(localObject[i1])) {
                com.tencent.mobileqq.msf.core.auth.i.c.add(localObject[i1]);
              }
              i1 += 1;
            }
          }
      ...
      return com.tencent.mobileqq.msf.core.auth.i.c;
    }
    catch (Exception localException)
    {
      if (QLog.isColorLevel()) {
  ...
  private void bp()
  {
    ...
    catch (Exception localException6)
    {
      ...
      catch (Exception localException6)
      {
        try
        {
          String str1 = (String)q.get("msf_simpleGetReportSwitch");
          if (!str1.equals("0")) {
            break label624;
          }
          bool1 = bool2;
        ...
        catch (Exception localException6)
        {
          try
          {
            com.tencent.mobileqq.msf.core.c.i.b(Long.parseLong(ae()));
          }
          catch (Exception localException6)
          {
            try
            {
              for (;;)
              {
                com.tencent.mobileqq.msf.core.c.i.a(Long.parseLong(W()));
                return;
                boolean bool1 = true;
                continue;
                ...
                if (QLog.isColorLevel())
                {
                  ...
                  if (QLog.isColorLevel())
                  {
                    ...
                    if (QLog.isColorLevel())
                    {
                      ...
                      if (QLog.isColorLevel()) {
                        QLog.d("MSF.C.ConfigManager", 2, "set3GBigLow error " + localException6);
                      }
                    }
                  }
                }
            ...
            catch (Exception localException7)
            {
              ...
              QLog.d("MSF.C.ConfigManager", 2, "setWifiBigLow error " + localException7);
            }
          }
        }
      }
  ...
  private void br()
  {
    try
    {
      ...
      {
        this.z.sender.f = Integer.parseInt(arrayOfString[0]);
        this.z.sender.g = Integer.parseInt(arrayOfString[1]);
        this.z.sender.k = Integer.parseInt(arrayOfString[2]);
        this.z.sender.i = Integer.parseInt(arrayOfString[3]);
      }
      return;
    }
    catch (Exception localException1)
    ...
    throws Exception
  {
    ...
    paramString.setAppId(this.z.sender.f());
  ...
  public void a(com.tencent.msf.service.protocol.e.f paramf, FromServiceMsg paramFromServiceMsg, ToServiceMsg paramToServiceMsg)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        try
        {
          MsfSdkUtils.writeServerConfig("com.tencent.mobileqq", 0, str1, this.z.sender.e());
        }
    ...
    for (;;)
    {
      try
      {
        MsfSdkUtils.writeServerConfig("com.tencent.mobileqq", 2, paramToServiceMsg, this.z.sender.e());
      }
    ...
    for (;;)
    {
      ...
      try
      {
        for (;;)
        {
          MsfSdkUtils.writeServerConfig("com.tencent.mobileqq", 1, paramToServiceMsg, this.z.sender.e());
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\msf\core\a\a.class
