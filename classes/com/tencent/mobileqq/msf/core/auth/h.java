        ...
        case 9: 
          ...
          if (i < localRespondCustomSig.SigList.size())
          {
            ...
            if (((CustomSigContent)localObject1).ulSigType == 13L)
            {
              ...
              {
                localObject4 = this.b.m(localk.d);
                localObject1 = localObject2;
            ...
            for (;;)
            {
              ...
              else
              {
                ...
                else
                {
                  ...
                  g.a((byte[])localObject2, 0, (byte[])localObject1, 4);
                  g.a((byte[])localObject3, 0, (byte[])localObject1, 4, 16);
                  g.a(arrayOfByte, 0, (byte[])localObject1, 20, 2);
                  ...
                  else
                  {
                    ...
                    g.a(arrayOfByte, 0, (byte[])localObject1, 22, j);
    ...
    for (Object localObject1 = ((i)localObject1).b;; localObject1 = "password error")
    {
      ...
      for (localObject1 = ((i)localObject1).b;; localObject1 = "loginFailed.")
      {
        if ((localk.b == 14) || (localk.b == 0)) {
          this.b.l(paramFromServiceMsg.getUin());
        }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\msf\core\auth\h.class
