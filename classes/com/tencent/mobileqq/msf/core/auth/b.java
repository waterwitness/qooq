...
public class b
{
  ...
  {
    paramString = i.e.GetLocalTicket(paramString, 16L, paramInt);
    if (paramString != null)
    {
  ...
  {
    Iterator localIterator = i.e.GetAllLoginInfo().iterator();
    while (localIterator.hasNext())
    {
      ...
      try
      {
        ...
        if (i.e.IsNeedLoginWithPasswd(str, 16L).booleanValue()) {
          continue;
        }
        localObject = i.e.GetLocalSig(str, 16L);
      ...
      if (QLog.isColorLevel())
      {
        ...
        g.a(arrayOfByte2, 0, arrayOfByte1, arrayOfByte1.length);
        ...
        if (l1 > l2)
        {
          ...
          if (i.e.GetBasicUserInfo(str, (WloginSimpleInfo)localObject).booleanValue())
          {
  ...
  private void d(a parama)
  {
    ...
    {
      a(parama);
      CodecWarpper.setAccountKey(parama.d(), parama.e(), parama.f(), parama.g(), parama.h(), parama.i(), parama.j(), parama.k(), parama.l(), null);
      w.a(parama.d(), false);
  ...
  public int b(ToServiceMsg paramToServiceMsg, boolean paramBoolean)
  {
    ...
    f localf = new f();
    localf.a = m(paramToServiceMsg.getUin()).g();
  ...
  void b(a parama)
  {
    ...
    CodecWarpper.setAccountKey(str, new byte[0], arrayOfByte1, arrayOfByte2, arrayOfByte3, arrayOfByte4, arrayOfByte5, arrayOfByte6, new byte[0], null);
  ...
  public String j(String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if ((str.equalsIgnoreCase(paramString)) && (k(str))) {
  ...
  public void l(String paramString)
  {
    ...
    //   6: aload_1
    //   7: invokevirtual 422	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   10: ifeq +22 -> 32
    //   13: aload_0
    //   14: ldc 54
    //   16: ldc_w 760
    //   19: invokevirtual 762	com/tencent/mobileqq/msf/core/auth/b:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   22: aload_0
    //   23: getfield 64	com/tencent/mobileqq/msf/core/auth/b:a	Lcom/tencent/mobileqq/msf/core/MsfCore;
    //   26: ldc_w 760
    //   29: invokevirtual 765	com/tencent/mobileqq/msf/core/MsfCore:stopPCActivePolling	(Ljava/lang/String;)V
    //   32: aload_0
    //   33: aload_1
    //   34: invokevirtual 552	com/tencent/mobileqq/msf/core/auth/b:m	(Ljava/lang/String;)Lcom/tencent/mobileqq/msf/core/auth/a;
    //   37: astore_2
    //   38: aload_1
    //   39: iconst_0
    //   40: invokestatic 378	com/tencent/mobileqq/msf/core/w:a	(Ljava/lang/String;Z)V
    //   43: aload_2
    //   44: ifnull +20 -> 64
    //   47: aload_2
    //   48: iconst_0
    //   49: invokevirtual 292	com/tencent/mobileqq/msf/core/auth/a:a	(Z)V
    //   52: aload_0
    //   53: aload_1
    //   54: invokevirtual 554	com/tencent/mobileqq/msf/core/auth/b:n	(Ljava/lang/String;)V
    //   57: aload_1
    //   58: invokestatic 768	com/tencent/qphone/base/util/CodecWarpper:nateiveRemoveAccountKey	(Ljava/lang/String;)V
    //   61: aload_0
    //   62: monitorexit
    //   63: return
    //   64: aload_1
    //   65: invokestatic 771	com/tencent/qphone/base/util/CodecWarpper:removeAccountKey	(Ljava/lang/String;)V
    //   68: goto -7 -> 61
    //   71: astore_1
    //   72: aload_0
    //   73: monitorexit
  ...
  {
    Object localObject = m(paramString);
    if (localObject == null) {
      return;
    }
    ...
    CodecWarpper.setAccountKey(str, new byte[0], arrayOfByte1, arrayOfByte2, arrayOfByte3, arrayOfByte4, arrayOfByte5, (byte[])localObject, new byte[0], null);
    w.a(paramString, false);
  }
}


/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\msf\core\auth\b.class
