  ...
  implements e
{
  ...
  public c(Context paramContext)
  {
    ...
    d = false;
    c.sendEmptyMessageDelayed(154, com.tencent.mobileqq.msf.core.a.a.aL());
    y = 0;
  }
  ...
  public void a()
  {
    ...
    try
    {
      ...
      if (b.e)
      {
        ...
        localStringBuilder.append("net_").append(NetConnInfoCenterImpl.isWifiOrMobileConn()).append(":");
        l1 = n - m;
        QLog.d("HwSocketAdaptor", 1, "connection last:" + l1);
        if ((600000L <= l1) || (240000L >= l1) || (!NetConnInfoCenterImpl.isWifiOrMobileConn())) {
          break label283;
        }
        QLog.d("HwSocketAdaptor", 1, "heartbeatUnexpectCount:" + r);
        r += 1;
        if (r >= com.tencent.mobileqq.msf.core.a.a.aJ())
        {
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    long l2;
    if ((f.containsKey(Integer.valueOf(paramInt))) && (NetConnInfoCenterImpl.isMobileConn()))
    {
    ...
    if ((!paramBoolean) && (g.contains(Integer.valueOf(paramInt))) && (NetConnInfoCenterImpl.isMobileConn()))
    {
      l2 = ((Long)g.get(Integer.valueOf(paramInt))).longValue();
      g.put(Integer.valueOf(paramInt), Long.valueOf(l1 - l2));
    }
    if (paramBoolean) {
      if ((e.inquireNetworkQuality() != 0) && (NetConnInfoCenterImpl.isWifiOrMobileConn())) {}
    }
    while (!h)
    {
      do
      {
        ...
        i += 1;
      } while (i <= com.tencent.mobileqq.msf.core.a.a.aG());
      t = true;
      a.j();
      i = 0;
      return;
  ...
  public void a(Socket paramSocket)
  {
    ...
    catch (Throwable paramSocket)
    {
      ...
      j += 1;
      d = false;
      if (j > com.tencent.mobileqq.msf.core.a.a.aH())
      {
        a.j();
        j = 0;
        k += 1;
  ...
  public void a(byte[] paramArrayOfByte, Socket paramSocket, int paramInt)
  {
    ...
    catch (Throwable paramArrayOfByte)
    {
      do
      {
        ...
        j += 1;
        d = false;
      } while (j <= com.tencent.mobileqq.msf.core.a.a.aH());
      a.j();
      j = 0;
      k += 1;
    }
    ...
    implements Handler.Callback
  {
    ...
    public boolean handleMessage(Message paramMessage)
    {
      ...
      } while (c.e() > com.tencent.mobileqq.msf.core.a.a.aK());
      c.c.sendEmptyMessageDelayed(154, com.tencent.mobileqq.msf.core.a.a.aL());
      return false;
    }
  }
}
