  ...
  implements e
{
  ...
  public void a()
  {
    try
    {
      ...
      if (l > 600000L)
      {
        ...
        localStringBuilder.append("net_").append(NetConnInfoCenterImpl.isWifiOrMobileConn());
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    try
    {
      ...
      long l2;
      if ((d.containsKey(Integer.valueOf(paramInt))) && (NetConnInfoCenterImpl.isMobileConn()))
      {
      ...
      if ((!paramBoolean) && (e.containsKey(Integer.valueOf(paramInt))) && (NetConnInfoCenterImpl.isMobileConn()))
      {
