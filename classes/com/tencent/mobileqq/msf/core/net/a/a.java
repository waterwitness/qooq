...
public class a
{
  ...
  public static void e()
  {
    try
    {
      ...
      if ((h == 2) && (NetConnInfoCenterImpl.isMobileConn()) && ((!i) || (n)) && (!b.e) && (m.compareAndSet(false, true)))
      {
        p = 0;
        j = 0;
        if (!l.sendEmptyMessageDelayed(18, com.tencent.mobileqq.msf.core.a.a.aI())) {
  ...
  public static void h()
  {
    try
    {
      ...
      if (h == 2)
      {
        localObject1 = g.sender.G.b().a(513);
        ...
        localObject2 = g.sender.G.b().a(516);
        if (localObject1 != null)
        {
        ...
        localObject1 = g.sender.G.b().a(514);
        if (localObject1 != null)
        {
          localObject2 = new HashMap();
  ...
  public static boolean l()
  {
    try
    {
      ...
      {
        m.set(false);
        QLog.d(a, 1, "maincount: " + j + ", fore: " + i + ", mobile: " + NetConnInfoCenterImpl.isMobileConn() + ", screenoff: " + n);
        if (((j <= 0) && (!i)) || ((!n) || (!NetConnInfoCenterImpl.isMobileConn())))
        {
          QLog.d(a, 1, "condition check failed");
          return false;
        }
        if (!g.sender.G.b().a(156).equals("false")) {
          break label189;
        }
  ...
  public void a()
  {
    QLog.d(a, 1, "main process enter background inMode:" + h + ", mobile:" + NetConnInfoCenterImpl.isMobileConn() + " ,inproxy:" + b.e + ", enterprocess:" + m);
    try
    {
      if ((h == 2) && (NetConnInfoCenterImpl.isMobileConn()))
      {
        i = false;
        j += 1;
  ...
  public void c()
  {
    QLog.d(a, 1, "receive screen off msg inMode:" + h + ", mobile:" + NetConnInfoCenterImpl.isMobileConn() + " ,inproxy:" + b.e + ", enterprocess:" + m);
    try
    {
      if ((h == 2) && (NetConnInfoCenterImpl.isMobileConn()) && (!b.e) && (m.compareAndSet(false, true)))
      {
        n = true;
        if (!l.sendEmptyMessageDelayed(18, com.tencent.mobileqq.msf.core.a.a.aI())) {
          QLog.d(a, 1, "failed to add msg testHeartbeat");
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              for (;;)
              {
                ...
                try
                {
                  if (a.o() == 2)
                  {
                    QLog.d(a.a, 1, "test heartbeat count:" + a.p() + ", fore:" + a.q() + ", mobile:" + NetConnInfoCenterImpl.isMobileConn());
                    if (((a.p() != 0) || (a.q())) && ((!a.r()) || (!NetConnInfoCenterImpl.isMobileConn()))) {
                      break label240;
                    }
            ...
            a.s().sendEmptyMessageDelayed(18, com.tencent.mobileqq.msf.core.a.a.aI());
            return false;
          } while (a.o() != 2);
          if (b.b())
          {
            ...
            a.b(a.u() + 1);
            if (a.u() <= com.tencent.mobileqq.msf.core.a.a.aN())
            {
