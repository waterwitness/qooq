  ...
  extends n
{
  ...
  private void a(String paramString, long paramLong, boolean paramBoolean)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        if ((((m)localObject).a.equals(paramString)) || (System.currentTimeMillis() - ((m)localObject).b <= 86400000L)) {
          break;
        }
        this.s.remove(str);
      }
  ...
  public void a(String paramString)
  {
    ...
    m localm = (m)this.s.get(paramString);
    ...
    if (l1 - localm.b >= 7200000L)
    {
      c(paramString);
      return;
    }
    b(paramString, 7200000L - (l1 - localm.b));
  }
  ...
  public void a(String paramString, long paramLong)
  {
    ...
    if (localm != null)
    {
      a(paramString, paramLong, localm.c);
      return;
    }
  ...
  public void a(String paramString, boolean paramBoolean)
  {
    m localm = (m)this.s.get(paramString);
    if (localm != null) {
      a(paramString, localm.b, paramBoolean);
    }
  }
