  ...
  extends o
{
  ...
  private void a(FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (!b(null, paramFromServiceMsg)) {
      if (paramFromServiceMsg.getMsfCommand() == MsfCommand.pushSetConfig)
      {
        ...
        com.tencent.mobileqq.msf.core.NetConnInfoCenter.sAppTimeoutConfig = ((Integer)paramFromServiceMsg.getAttribute("_attr_app_timeout")).intValue();
  ...
  boolean b()
  {
    try
    {
      ...
      localIntent.putExtra("to_SenderProcessName", this.a.processName);
      localIntent.setComponent(localComponentName);
      bool = BaseApplication.getContext().bindService(localIntent, this.o, 1);
    ...
    catch (Exception localException1)
    {
      try
      {
        QLog.d("MSF.D.Proxy", 1, "threadID:" + Thread.currentThread().getId() + ", threadName: " + Thread.currentThread().getName() + " bind " + this.a.msfServiceName + " service finished " + bool);
        return bool;
      }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\msf\sdk\g.class
