    ...
    for (;;)
    {
      ...
      if (MonitorSocketImplFactory.isNetworkTypeMobile(j) == true)
      {
        ...
        if ((this.monitorSocketImpl.g != null) && (this.monitorSocketImpl.g.equals(b.h)))
        {
          ...
          if ((this.monitorSocketImpl.d.toLowerCase().contains("tmassistant")) || (this.monitorSocketImpl.d.contains("apkupdate")))
          {
            this.monitorSocketImpl.g = "yingyongbao";
            ((a)localObject2).h = this.monitorSocketImpl.g;
            continue;
          }
          if (this.monitorSocketImpl.d.contains("smtt"))
          {
            this.monitorSocketImpl.g = "Web";
            ((a)localObject2).h = this.monitorSocketImpl.g;
            continue;
          }
          if ((this.monitorSocketImpl.d.contains("biz")) || (this.monitorSocketImpl.d.contains("troop")))
          {
          ...
          else
          {
            ...
            {
              paramInt1 += 8;
              ((a)localObject1).h = this.monitorSocketImpl.d.substring(paramInt1, this.monitorSocketImpl.d.indexOf(".", paramInt1));
            }
            for (;;)
            {
              paramArrayOfByte = (byte[])localObject1;
              ...
              if (this.monitorSocketImpl.d.indexOf("_") > 0) {
                ((a)localObject1).h = this.monitorSocketImpl.d.substring(0, this.monitorSocketImpl.d.indexOf("_"));
              } else {
                ((a)localObject1).h = "unknown";
              }
            }
          }
          paramArrayOfByte = null;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\msf\sdk\utils\MonitorSocketOutputStream.class
