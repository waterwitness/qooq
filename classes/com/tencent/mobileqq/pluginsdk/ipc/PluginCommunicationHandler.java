      ...
      implements Runnable
    {
      ...
      public void run()
      {
        do
        {
          ...
          if (!((RemoteCommand)localObject2).isSynchronized()) {
            break;
          }
        ...
        return;
        ((RemoteCommand)localObject2).invoke(this.d, this.e);
      }
    }
  }
}
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\pluginsdk\ipc\PluginCommunicationHandler.class
