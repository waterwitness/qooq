  ...
  extends BroadcastReceiver
{
  ...
  private IPluginBroadcastReceiver a(Context paramContext, Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      paramIntent = paramIntent.getStringExtra("pluginsdk_pluginpath");
            ...
            if (paramIntent == null)
            {
              ...
              catch (Throwable localThrowable)
              {
                for (;;)
                {
                  ...
                  try
                  {
                    paramContext.IInit(str1, (String)localObject1, this, (ClassLoader)localObject2, paramIntent, this.a);
                    paramIntent = paramContext;
                    return paramIntent;
                  }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\pluginsdk\PluginProxyBroadcastReceiver.class
