...
public class ConfigParser
{
  ...
  private static void a(rag paramrag, byte[] paramArrayOfByte)
  {
    int i1 = PkgTools.a(paramArrayOfByte, 0);
    paramrag.jdField_a_of_type_JavaLangString = PkgTools.a(paramArrayOfByte, 2, i1);
    i1 += 2;
    paramrag.jdField_a_of_type_Byte = paramArrayOfByte[i1];
    i1 += 1;
    paramrag.jdField_b_of_type_Byte = paramArrayOfByte[i1];
    int i2 = i1 + 1;
    i1 = PkgTools.a(paramArrayOfByte, i2);
    i2 += 2;
    paramrag.jdField_b_of_type_JavaLangString = PkgTools.a(paramArrayOfByte, i2, i1);
  }
  
  private static void a(rah paramrah) {}
  
  private static void a(rah paramrah, String paramString)
  {
    int i3 = 2;
    int i4 = 0;
    int i5 = PkgTools.a(paramrah.jdField_a_of_type_ArrayOfByte, 0);
    int i1 = i4;
    int i2 = i3;
    if (QLog.isColorLevel())
    {
    ...
    while (i1 < i5)
    {
      i3 = PkgTools.a(paramrah.jdField_a_of_type_ArrayOfByte, i2);
      i4 = i2 + 2;
      i2 = PkgTools.a(paramrah.jdField_a_of_type_ArrayOfByte, i4);
      i4 += 2;
      byte[] arrayOfByte = new byte[i2];
      PkgTools.b(paramrah.jdField_a_of_type_ArrayOfByte, i4, arrayOfByte, i2);
      i2 = i4 + i2;
  ...
  private static void a(byte[] paramArrayOfByte, rah paramrah)
  {
    ...
    for (;;)
    {
      ...
      {
        paramrah.b = PkgTools.a(paramArrayOfByte, 1);
        paramrah.jdField_a_of_type_Short = PkgTools.a(paramArrayOfByte, 3);
        paramrah.jdField_a_of_type_Long = (PkgTools.a(paramArrayOfByte, 5) * 1000L);
        paramrah.jdField_a_of_type_Byte = paramArrayOfByte[9];
        int i1 = paramArrayOfByte.length - 10 - 1;
        if (paramrah.jdField_a_of_type_Byte == 0)
        {
          paramrah.jdField_a_of_type_ArrayOfByte = new byte[i1];
          PkgTools.b(paramArrayOfByte, 10, paramrah.jdField_a_of_type_ArrayOfByte, i1);
        }
        while (paramArrayOfByte.length != i1 + 10 + 1)
        {
          return;
          paramrah.jdField_a_of_type_JavaLangString = PkgTools.a(paramArrayOfByte, 10, i1);
        }
      }
    }
  }
  ...
  public static boolean a(byte[] paramArrayOfByte, rah paramrah, String paramString)
  {
    ...
    do
    {
      ...
      {
        return false;
        a(paramArrayOfByte, paramrah);
      } while (paramrah.b != 768);
      if (paramrah.jdField_a_of_type_Byte != 0)
      {
        a(paramrah);
        return false;
      }
    } while ((paramrah.jdField_a_of_type_ArrayOfByte == null) || (paramrah.jdField_a_of_type_ArrayOfByte.length == 0));
    a(paramrah, paramString);
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\config\ConfigParser.class
