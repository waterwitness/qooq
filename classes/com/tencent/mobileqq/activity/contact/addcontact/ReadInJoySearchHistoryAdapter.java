  ...
  implements View.OnClickListener
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        return paramView;
        paramViewGroup = (ohv)paramView.getTag();
      }
      localView = paramView;
  ...
  {
    if ((paramView.getTag() instanceof ohv))
    {
      paramView = (ohv)paramView.getTag();
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityContactAddcontactReadInJoySearchHistoryAdapter$OnItemClickObserver.d();
  }
}


/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\contact\addcontact\ReadInJoySearchHistoryAdapter.class
