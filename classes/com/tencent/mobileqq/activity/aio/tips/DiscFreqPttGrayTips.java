  ...
  implements GrayTipsTask
{
  ...
  public MessageRecord a(Object... paramVarArgs)
  {
    ...
    paramVarArgs.init(str, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str, this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131367285), l, 64519, 3000, l);
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    do
    {
      do
      {
        ...
        for (;;)
        {
          try
          {
            ...
            if (!NetworkUtil.i(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication()))
            {
              if (!QLog.isColorLevel()) {
                break;
              }
          ...
          return;
          if (((ChatMessage)localList.get(paramInt)).msgtype != 64493) {
            break label1257;
          }
          bool = true;
        }
        ...
        paramVarArgs = "voice_disc_ptt_freq_tip_msg_insert_time" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
      ...
      return;
      localObject2 = localSharedPreferences.getString("start_group_audio_time" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), null);
    ...
    for (;;)
    {
      if (j >= 0)
      {
        ...
        {
          i = paramInt;
          if (((ChatMessage)localObject3).msgtype == 63534)
          {
            i = paramInt;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\tips\DiscFreqPttGrayTips.class
