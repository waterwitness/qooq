  ...
  implements TipsBarTask
{
  ...
  {
    paramVarArgs = LayoutInflater.from(this.jdField_a_of_type_AndroidAppActivity).inflate(2130904079, null);
    ((TextView)paramVarArgs.findViewById(2131301295)).setText(2131367285);
    ((ImageView)paramVarArgs.findViewById(2131301293)).setImageResource(2130843019);
    paramVarArgs.findViewById(2131301294).setOnClickListener(new oej(this));
    return paramVarArgs;
  }
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        Object localObject2 = "voice_disc_chat_freq_bar_show_count" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
        ...
        localObject2 = ((SharedPreferences)localObject1).getString("voice_disc_chat_freq_bar_show_time" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), null);
        if (QLog.isColorLevel())
        {
          String str = paramInt + "-" + i + "-" + j;
          QLog.d(jdField_a_of_type_JavaLangString, 2, "currDate is:" + str + ",curr hour is:" + this.jdField_a_of_type_AndroidTextFormatTime.hour + ",discPttFreqTipMsgInsertTime is:" + (String)localObject2);
        }
        ...
        localObject1 = ((SharedPreferences)localObject1).getString("start_group_audio_time" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), null);
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\tips\DiscActiveTipsBar.class
