  ...
  implements GrayTipsTask, Runnable
{
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if (((MessageRecord)localObject2).time >= l - 86400L)
      {
        ...
        if (((MessageRecord)localObject2).time <= l)
        {
          ...
          {
            j = k;
            if (((MessageRecord)localObject2).msgtype == 64536)
            {
              j = k;
          ...
          if (((MessageRecord)localObject2).msgtype == 63534)
          {
            if (((MessageRecord)localObject2).isSend())
            {
              i2 = i;
          ...
          else
          {
            i2 = i;
            i1 = j;
            if (((MessageRecord)localObject2).msgtype == 63527)
            {
              i2 = i;
              i1 = j;
              if ((localObject2 instanceof MessageForVideo))
              {
                ...
                if (((MessageForVideo)localObject2).text != null)
                {
                  i2 = i;
                  i1 = j;
                  if (((MessageForVideo)localObject2).text.contains(BaseApplicationImpl.a().getResources().getString(2131363323)))
                  {
  ...
  public MessageRecord a(Object... paramVarArgs)
  {
    ...
    paramVarArgs.init(str, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str, "", l, 60531, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, l);
  ...
  public void run()
  {
    ...
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int);
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\tips\VipSpecialCareGrayTips.class
