  ...
  implements GrayTipsTask
{
  ...
  public MessageRecord a(Object... paramVarArgs)
  {
    ...
    paramVarArgs.init(str, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str, "", l, 64522, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, l);
  ...
  public void a(int paramInt, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        {
          localObject2 = ((FriendsManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(50)).c(this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString);
              ...
              else
              {
                ...
                if (paramInt >= 0)
                {
                  ...
                  if (((ChatMessage)localObject2).time >= l2)
                  {
                    ...
                    label1340:
                    if (!MsgProxyUtils.p(((ChatMessage)localObject2).msgtype)) {
                      break;
                    }
                    bool1 = true;
                    break;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\tips\FriendFreqGrayTips.class
