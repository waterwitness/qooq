  ...
  implements GrayTipsTask, Runnable
{
  ...
  public MessageRecord a(Object... paramVarArgs)
  {
    ...
    paramVarArgs.init(str, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, str, "", l, 64493, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, l);
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      Object localObject2 = "key_sougou_input_gray_tips_count_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a();
      ...
      if (!TextUtils.isEmpty(str2))
      {
        ...
        if ((((ChatMessage)localObject2).msgtype == 64522) || (((ChatMessage)localObject2).msgtype == 64519) || (((ChatMessage)localObject2).msgtype == 64520) || (((ChatMessage)localObject2).msgtype == 64495) || (((ChatMessage)localObject2).msgtype == 64493) || ((((ChatMessage)localObject2).msgtype == 64523) && (((ChatMessage)localObject2).istroop == 0)))
        {
          bool = true;
          continue;
        }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\tips\SougouInputGrayTips.class
