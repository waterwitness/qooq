  ...
  implements Handler.Callback
{
  ...
  public static final String a = "Q.aio.AIOPreLoadEngine";
  ...
  private void a(Activity paramActivity)
  {
    ...
    {
      if ((jdField_a_of_type_Int == 1) || (QQAppInterface.c)) {
        if (QLog.isColorLevel()) {
          QLog.e("Q.aio.AIOPreLoadEngine", 2, "sPreloadedAIOType:" + jdField_a_of_type_Int + "|AIO_HAD_OPEN:" + QQAppInterface.c);
        }
      }
      do
      {
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\AIOPreLoadEngine.class
