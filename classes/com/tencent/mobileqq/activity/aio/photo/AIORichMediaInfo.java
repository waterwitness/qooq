  ...
  public Drawable c()
  {
    for (;;)
    {
      try
      {
        ...
        if ((localObject1 == null) || (BaseApplicationImpl.a.get(this.a.a(2)) == null)) {
          continue;
        }
      ...
      catch (Throwable localThrowable)
      {
        ...
        localURLDrawableOptions.mLoadingDrawable = URLDrawableHelper.e;
        localURLDrawableOptions.mFailedDrawable = URLDrawableHelper.e;
        if ((localObject2 == null) || (BaseApplicationImpl.a.get(this.a.a(18)) == null)) {
          continue;
        }
        ...
        continue;
        if ((localObject3 == null) || (BaseApplicationImpl.a.get(this.a.a(20)) == null)) {
          continue;
        }
        ...
        localObject2 = URLDrawable.getDrawable(this.a.a(1), localURLDrawableOptions);
        continue;
        localObject2 = null;
        continue;
      }
      ...
      if ((localObject3 != null) && (BaseApplicationImpl.a.get(this.a.a(4)) != null))
      {
        if (URLDrawableHelper.a(((File)localObject3).getAbsolutePath()) != 0) {
          break label531;
        }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\photo\AIORichMediaInfo.class
