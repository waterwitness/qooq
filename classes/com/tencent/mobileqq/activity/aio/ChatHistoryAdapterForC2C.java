  ...
  extends ChatAdapter1
{
  ...
  public ChatHistoryAdapterForC2C(QQAppInterface paramQQAppInterface, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner, BaseChatPie paramBaseChatPie)
  {
    ...
    this.jdField_a_of_type_Ncu = new ncu(this, null);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    paramView = localChatItemBuilder.a(paramInt, this.jdField_a_of_type_JavaUtilList.size(), localChatMessage, paramView, paramViewGroup, this.jdField_a_of_type_Ncu);
    if (paramView != null) {
      paramView.setTag(2131296315, localChatMessage);
    }
    if ((localChatMessage.msgtype == 63527) || (localChatMessage.msgtype == 63520)) {
    ...
    for (;;)
    {
      ...
      return paramView;
      if (localChatMessage.msgtype == 63497)
      {
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\ChatHistoryAdapterForC2C.class
