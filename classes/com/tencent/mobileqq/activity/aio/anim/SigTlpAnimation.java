  ...
  extends XBubbleAnimation
{
    ...
    if (b())
    {
      ...
      if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_AndroidViewView != null))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "paramButton.width=" + localLayoutParams2.width + ",paramButton.height=" + localLayoutParams2.height);
        }
  ...
  protected boolean a()
  {
    if (this.jdField_b_of_type_AndroidViewView != null)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "rect.left=" + this.jdField_a_of_type_AndroidGraphicsRect.left + ",rect.top=" + this.jdField_a_of_type_AndroidGraphicsRect.top);
      }
      if ((this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_AndroidViewView != null))
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 2, "rectAio.left=" + jdField_b_of_type_AndroidGraphicsRect.left + ",rectAio.top=" + jdField_b_of_type_AndroidGraphicsRect.top);
        }
      }
    }
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_Boolean) {
        this.jdField_a_of_type_AndroidOsHandler.post(new nfc(this));
      }
    }
  }
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    ThreadManager.a().post(new nfd(this, str1, str2));
    return true;
  }
  ...
  public boolean b()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      this.e = AIOUtils.a(Long.valueOf(this.d).longValue(), this.jdField_a_of_type_ComTencentWidgetListView.a());
      localObject = AIOUtils.a(AIOUtils.a(this.jdField_a_of_type_ComTencentWidgetListView, this.e));
      ...
      while (this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRichStatItemBuilder$Holder == null)
      {
        ...
        return false;
        if (QLog.isColorLevel()) {
          QLog.e(jdField_a_of_type_JavaLangString, 2, "list view item's tag can not cast to Holder, object:" + localObject + ",mPosition:" + this.e);
        }
      }
      if ((this.jdField_b_of_type_AndroidViewView == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRichStatItemBuilder$Holder.jdField_a_of_type_AndroidWidgetImageView == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRichStatItemBuilder$Holder.jdField_a_of_type_AndroidViewViewGroup == null)) {
        break label729;
      }
      int n = this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRichStatItemBuilder$Holder.jdField_a_of_type_AndroidWidgetImageView.getLeft() + this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRichStatItemBuilder$Holder.jdField_a_of_type_AndroidViewViewGroup.getLeft();
      int i1 = a(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRichStatItemBuilder$Holder.jdField_a_of_type_AndroidWidgetImageView, true) - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY();
      if (QLog.isColorLevel()) {
        QLog.e(jdField_a_of_type_JavaLangString, 2, "getParentTop(mHolder.signCardBg, true):" + a(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRichStatItemBuilder$Holder.jdField_a_of_type_AndroidWidgetImageView, true) + ",istview.getScrollY():" + this.jdField_a_of_type_ComTencentWidgetListView.getScrollY());
      }
      int i2 = this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRichStatItemBuilder$Holder.jdField_a_of_type_AndroidWidgetImageView.getRight() - this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRichStatItemBuilder$Holder.jdField_a_of_type_AndroidWidgetImageView.getLeft();
      int i3 = this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRichStatItemBuilder$Holder.jdField_a_of_type_AndroidWidgetImageView.getBottom() - this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRichStatItemBuilder$Holder.jdField_a_of_type_AndroidWidgetImageView.getTop();
      i = i3;
      j = i2;
      k = i1;
      m = n;
      if (this.jdField_a_of_type_AndroidViewView != null)
      {
        jdField_b_of_type_AndroidGraphicsRect.top = a(this.jdField_a_of_type_ComTencentMobileqqActivityAioItemRichStatItemBuilder$Holder.c, true);
        m = n;
        k = i1;
        j = i2;
        i = i3;
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_AndroidViewView == null)
      {
        ...
        this.e = SignatureManager.a(this.d, this.jdField_a_of_type_ComTencentWidgetListView.a());
        localObject = AIOUtils.a(AIOUtils.a(this.jdField_a_of_type_ComTencentWidgetListView, this.e));
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\anim\SigTlpAnimation.class
