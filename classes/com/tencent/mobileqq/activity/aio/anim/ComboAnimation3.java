  ...
  extends AIOAnimationConatiner.AIOAnimator
{
  ...
  public ComboAnimation3(int paramInt, AIOAnimationConatiner paramAIOAnimationConatiner, ListView paramListView)
  {
    ...
    this.jdField_a_of_type_Float = 0.041666668F;
  }
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    if (i > 0)
    {
      ...
      this.jdField_a_of_type_ArrayOfAndroidGraphicsDrawableDrawable[3] = this.jdField_a_of_type_ComTencentWidgetListView.getResources().getDrawable(2130837543);
      ...
      this.jdField_a_of_type_AndroidViewView = new nex(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      this.jdField_b_of_type_AndroidViewView = new nex(this, this.jdField_a_of_type_ComTencentWidgetListView.getContext());
      ...
      if (a(this.jdField_a_of_type_Long))
      {
        ...
        ((AnimatorSet)localObject3).addListener(new nes(this));
    ...
    for (;;)
    {
      ...
      paramVarArgs.setAnimationListener(new neu(this));
      paramVarArgs = new new(this);
      paramVarArgs.setDuration(1000L);
      paramVarArgs.setFillAfter(true);
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\anim\ComboAnimation3.class
