  ...
  extends AIOAnimationConatiner.AIOAnimator
{
  ...
  static
  {
    ...
    jdField_a_of_type_Float = BaseApplicationImpl.a().getResources().getDisplayMetrics().density;
  ...
  private BaseChatItemLayout a(long paramLong)
  {
    ...
    {
      i1 = 0;
      while (i1 < this.jdField_a_of_type_ComTencentWidgetListView.getChildCount())
      {
        localObject1 = this.jdField_a_of_type_ComTencentWidgetListView.getChildAt(i1);
        if ((localObject1 instanceof BaseChatItemLayout))
        {
          localObject2 = (BaseBubbleBuilder.ViewHolder)AIOUtils.a((View)localObject1);
          if ((((BaseBubbleBuilder.ViewHolder)localObject2).jdField_a_of_type_Int != 0) && (((BaseBubbleBuilder.ViewHolder)localObject2).jdField_a_of_type_AndroidViewView.getTop() + ((View)localObject1).getTop() + BaseChatItemLayout.k > 0)) {
    ...
    int i4 = this.jdField_a_of_type_ComTencentWidgetListView.m();
    int i5 = this.jdField_a_of_type_ComTencentWidgetListView.n();
    int i3 = this.jdField_a_of_type_ComTencentWidgetListView.s();
    int i6 = this.jdField_a_of_type_ComTencentWidgetListView.t();
    Object localObject1 = this.jdField_a_of_type_ComTencentWidgetListView.a();
    ...
    for (;;)
    {
      ...
      {
        localObject2 = this.jdField_a_of_type_ComTencentWidgetListView.getChildAt(i2 - i3);
  ...
  int a(int paramInt, BaseBubbleBuilder.ViewHolder paramViewHolder)
  {
    ...
    {
      i1 = paramViewHolder.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.n + BaseChatItemLayout.s;
      i2 = paramViewHolder.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.m - BaseChatItemLayout.r;
      if (paramInt > i1) {
        break label129;
      }
    ...
    {
      return i3;
      i1 = paramViewHolder.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.m + BaseChatItemLayout.r;
      i2 = paramViewHolder.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.n - BaseChatItemLayout.n;
      break;
    ...
    case 3: 
      ...
      if (this.jdField_b_of_type_Int == 1)
      {
        ...
        if (localBaseChatItemLayout != null)
        {
          ...
          if (localViewHolder != null)
          {
            ...
            this.k = (localBaseChatItemLayout.getTop() + i1 + BaseChatItemLayout.k - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY());
        ...
        for (;;)
        {
          ...
          this.l = (this.jdField_a_of_type_ComTencentWidgetListView.getWidth() / 2 + (int)(Math.random() * 160.0D * jdField_a_of_type_Float - 80.0D));
          this.m = this.o;
          this.jdField_d_of_type_Long = 0L;
          this.jdField_a_of_type_Long = 0L;
      ...
      if (localBaseChatItemLayout != null)
      {
        ...
        if (localViewHolder != null)
        {
          ...
          this.k = (localViewHolder.jdField_a_of_type_AndroidViewView.getTop() + localBaseChatItemLayout.getTop() + BaseChatItemLayout.k - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - this.m);
  ...
  public boolean a(boolean paramBoolean)
  {
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      while ((this.jdField_a_of_type_ComTencentMobileqqActivityAioAnimAIOAnimationConatiner == null) || (this.jdField_a_of_type_AndroidViewView == null))
      {
        ...
        return false;
        i1 = AIOUtils.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.a());
        if (i1 < this.jdField_a_of_type_ComTencentWidgetListView.s())
        {
          this.o = -1;
        }
        else if (i1 > this.jdField_a_of_type_ComTencentWidgetListView.t())
        {
          if (this.jdField_d_of_type_Long > 0L)
          {
            c();
        ...
        {
          BaseBubbleBuilder.ViewHolder localViewHolder = (BaseBubbleBuilder.ViewHolder)AIOUtils.a(AIOUtils.a(this.jdField_a_of_type_ComTencentWidgetListView, i1));
          if (localViewHolder != null)
          {
            i1 = localViewHolder.jdField_a_of_type_AndroidViewView.getTop();
            i1 = localViewHolder.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + i1 + BaseChatItemLayout.k - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.m + this.k);
            if (i1 != 0)
            {
              this.m += i1;
              this.o += i1;
          ...
          else
          {
            ...
            return false;
            i1 = AIOUtils.a(this.jdField_b_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.a());
            int i2 = AIOUtils.a(this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentWidgetListView.a());
            if ((i1 >= this.jdField_a_of_type_ComTencentWidgetListView.s()) && (i1 <= this.jdField_a_of_type_ComTencentWidgetListView.t()))
            {
              localViewHolder = (BaseBubbleBuilder.ViewHolder)AIOUtils.a(AIOUtils.a(this.jdField_a_of_type_ComTencentWidgetListView, i1));
              if (localViewHolder != null)
              {
                i1 = localViewHolder.jdField_a_of_type_AndroidViewView.getTop();
                i1 = localViewHolder.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + i1 + BaseChatItemLayout.k - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.m + this.k);
            ...
            else if ((i2 >= this.jdField_a_of_type_ComTencentWidgetListView.s()) && (i2 <= this.jdField_a_of_type_ComTencentWidgetListView.t()))
            {
              localViewHolder = (BaseBubbleBuilder.ViewHolder)AIOUtils.a(AIOUtils.a(this.jdField_a_of_type_ComTencentWidgetListView, i2));
              if (localViewHolder != null)
              {
                i1 = localViewHolder.jdField_a_of_type_AndroidViewView.getTop();
                i1 = localViewHolder.jdField_a_of_type_ComTencentMobileqqActivityAioBaseChatItemLayout.getTop() + i1 + BaseChatItemLayout.k - this.jdField_a_of_type_ComTencentWidgetListView.getScrollY() - (this.m + this.k);
            ...
            else if (i1 < this.jdField_a_of_type_ComTencentWidgetListView.s())
            {
              this.o = -1;
            }
            else if (i2 > this.jdField_a_of_type_ComTencentWidgetListView.t())
            {
              this.jdField_b_of_type_Int = 5;
              this.jdField_a_of_type_Long = 0L;
              this.jdField_b_of_type_Long = 0L;
  ...
  protected boolean a(Object... paramVarArgs)
  {
    ...
    for (paramVarArgs = paramVarArgs[1];; paramVarArgs = Integer.valueOf(0))
    {
      ...
      long l1 = AnimationUtils.currentAnimationTimeMillis();
      this.jdField_c_of_type_Long = (i1 + l1);
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\anim\FloorJumper.class
