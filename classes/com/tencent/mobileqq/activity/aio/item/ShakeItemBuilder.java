  ...
  extends BaseBubbleBuilder
{
  ...
  public ShakeItemBuilder(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo, AIOAnimationConatiner paramAIOAnimationConatiner)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new non(this);
  }
  ...
  protected View a(ChatMessage paramChatMessage, BaseBubbleBuilder.ViewHolder paramViewHolder, View paramView, BaseChatItemLayout paramBaseChatItemLayout, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    if (paramView == null)
    {
      ...
      ((TextView)localObject).setTextColor(paramBaseChatItemLayout.getResources().getColorStateList(2131428272));
      ((TextView)localObject).setMaxWidth(BaseChatItemLayout.i);
      ((TextView)localObject).setId(2131297486);
    ...
    localHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840538);
    if (paramChatMessage.isSend())
    {
      k = BaseChatItemLayout.s;
      j = BaseChatItemLayout.r;
      i = BaseChatItemLayout.s;
      localHolder.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130840539);
    }
    ...
    localHolder.jdField_a_of_type_AndroidWidgetTextView.setText(paramBaseChatItemLayout.getResources().getString(2131367601));
  ...
  protected void a(View paramView)
  {
    ...
    if (paramView.isSendFromLocal()) {
      DialogUtil.a(this.jdField_a_of_type_AndroidContentContext, 230, str1, str2, new noo(this, paramView), new nop(this)).show();
    }
  }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\item\ShakeItemBuilder.class
