  ...
  extends AbstractChatItemBuilder
{
  ...
  public PASingleItemBuilder(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new nmt(this);
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, long paramLong)
  {
    ...
    paramString1.putExtra("assignBackText", paramContext.getResources().getString(2131367975));
  ...
  protected View a(MessageRecord paramMessageRecord, AbstractChatItemBuilder.ViewHolder paramViewHolder, View paramView, LinearLayout paramLinearLayout, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    if (paramView == null) {
      paramLinearLayout = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130903175, null);
    }
    Object localObject4 = (MessageForPubAccount)paramMessageRecord;
    paramViewHolder = (nmu)paramViewHolder;
    paramView = paramLinearLayout.findViewById(2131297490);
    Object localObject5 = (TextView)paramLinearLayout.findViewById(2131297489);
    Object localObject2 = (TextView)paramLinearLayout.findViewById(2131297491);
    Object localObject3 = (TextView)paramLinearLayout.findViewById(2131297492);
    Object localObject1 = (ImageView)paramLinearLayout.findViewById(2131297493);
    Object localObject7 = (TextView)paramLinearLayout.findViewById(2131297494);
    Object localObject8 = (TextView)paramLinearLayout.findViewById(2131297495);
    TextView localTextView1 = (TextView)paramLinearLayout.findViewById(2131297496);
    TextView localTextView2 = (TextView)paramLinearLayout.findViewById(2131297497);
    TextView localTextView3 = (TextView)paramLinearLayout.findViewById(2131297498);
    Object localObject6 = (TextView)paramLinearLayout.findViewById(2131297500);
    ...
    if (((PAMessage)localObject7).grayTips != null)
    {
      ...
      localObject4 = Util.d(((PAMessage.Item)localObject5).title);
      ((TextView)localObject2).setText((CharSequence)localObject4);
      if (((PAMessage.Item)localObject5).mVideoFlag == 1)
      {
        localObject6 = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130839510);
    ...
    for (;;)
    {
      try
      {
        ...
        paramMessageRecord.addHeader("my_uin", this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a());
        ...
        if (paramMessageRecord != null)
        {
          ...
          if (j < localArrayList.size())
          {
            ...
            if (i > j)
            {
              ...
              break;
              label819:
              ((TextView)localObject6).setText(2131370322);
              break label394;
              label830:
      ...
      {
        ((ImageView)localObject1).setImageResource(2130837568);
        continue;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\item\PASingleItemBuilder.class
