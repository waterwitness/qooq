  ...
  extends AbstractChatItemBuilder
{
  ...
  public PAMultiItemBuilder(QQAppInterface paramQQAppInterface, BaseAdapter paramBaseAdapter, Context paramContext, SessionInfo paramSessionInfo)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new nmr(this);
  }
  ...
  protected View a(MessageRecord paramMessageRecord, AbstractChatItemBuilder.ViewHolder paramViewHolder, View paramView, LinearLayout paramLinearLayout, OnLongClickAndTouchListener paramOnLongClickAndTouchListener)
  {
    ...
    if (localPAMessage.grayTips != null)
    {
      ...
      paramViewHolder.setBackgroundResource(2130840531);
    ...
    {
      localObject1 = new nms(this);
      PAMessage.Item localItem = (PAMessage.Item)localArrayList.get(i);
      ((nms)localObject1).jdField_b_of_type_Int = 5;
      ((nms)localObject1).jdField_c_of_type_JavaLangString = localItem.url;
      ((nms)localObject1).jdField_c_of_type_Int = localPAMessage.type;
      ((nms)localObject1).jdField_b_of_type_JavaLangString = localItem.actionUrl;
      ((nms)localObject1).jdField_a_of_type_JavaLangString = localItem.nativeJumpString;
      ((nms)localObject1).jdField_a_of_type_Long = paramLinearLayout.uniseq;
      ((nms)localObject1).d = i;
      Object localObject2;
      int j;
      if (i == 0)
      {
        paramViewHolder = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130903174, null);
        localObject2 = (TextView)paramViewHolder.findViewById(2131297487);
        localImageView = (ImageView)paramViewHolder.findViewById(2131297488);
        String str = Util.d(localItem.title);
      ...
      for (;;)
      {
        ...
        {
          label830:
          localImageView.setImageResource(2130837568);
          continue;
        }
        localViewGroup.addView(paramViewHolder);
        ...
        if (i == localArrayList.size() - 1)
        {
          ...
          paramViewHolder.setBackgroundResource(2130838772);
          localViewGroup.addView(paramViewHolder);
          paramViewHolder = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130903172, null);
          break label362;
        }
        paramViewHolder = new ImageView(this.jdField_a_of_type_AndroidContentContext);
        paramViewHolder.setLayoutParams(new ViewGroup.LayoutParams(-1, k));
        paramViewHolder.setBackgroundResource(2130838772);
        localViewGroup.addView(paramViewHolder);
        paramViewHolder = LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130903173, null);
        break label362;
        j = 2130839510;
        break label428;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\item\PAMultiItemBuilder.class
