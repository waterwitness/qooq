...
public class ChangeVoiceListAdapter
  extends BaseAdapter
{
  static final String jdField_a_of_type_JavaLangString = "ChangeVoiceListAdapter";
  public int a;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      while (i < this.jdField_a_of_type_Int)
      {
        ...
        ((LinearLayout)localObject1).addView(LayoutInflater.from(this.jdField_a_of_type_AndroidContentContext).inflate(2130904070, null), (ViewGroup.LayoutParams)localObject2);
        i += 1;
    ...
    for (;;)
    {
      ...
      ((ChangeVoiceView)localObject2).e = this.b;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\audiopanel\ChangeVoiceListAdapter.class
