  ...
  implements View.OnTouchListener, AudioPanelCallback, QQRecorder.OnQQRecorderListener
{
  ...
  static final String jdField_a_of_type_JavaLangString = "PressToChangeVoicePanel";
  static final int jdField_b_of_type_Int = 1002;
  ...
  public PressToChangeVoicePanel(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new ngf(this, Looper.getMainLooper());
  }
  ...
  public static void a(QQAppInterface paramQQAppInterface, boolean paramBoolean, String paramString)
  {
    if (paramBoolean)
    {
      if (jdField_b_of_type_JavaLangString == null) {
        jdField_b_of_type_JavaLangString = TraeHelper.a(BaseApplicationImpl.a);
      }
      if (QLog.isColorLevel()) {
        QLog.d("AIOAudioPanel", 2, "checkVcSo sync:" + jdField_b_of_type_JavaLangString);
      }
    }
    if (jdField_b_of_type_JavaLangString == null) {
      ThreadManager.a(new ngh(paramBoolean, paramQQAppInterface, paramString), 5, null, false);
    }
  }
  ...
  private boolean a(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      if (j == 2)
      {
        ...
        if ((Math.abs(m - (d3 + d1)) > d1) || (Math.abs(k - (d4 + d2)) > d2)) {
  ...
  public int a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    PttPreSendManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).a(paramString, paramRecorderParam, jdField_b_of_type_JavaLangString);
  ...
  public void a(QQAppInterface paramQQAppInterface, BaseChatPie paramBaseChatPie, ViewGroup paramViewGroup1, AudioPanel paramAudioPanel, ViewGroup paramViewGroup2, ViewGroup paramViewGroup3, ViewGroup paramViewGroup4, AudioPanelAdapter paramAudioPanelAdapter)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131301271));
    ...
    if (AppSetting.j)
    {
      ...
      this.jdField_a_of_type_AndroidWidgetImageView.setContentDescription(getContext().getString(2131362109));
    }
  }
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam, double paramDouble)
  {
    ...
    if (this.jdField_a_of_type_Double < 800.0D)
    {
      ...
      ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005A17", "0X8005A17", 1, 0, String.valueOf((int)this.jdField_a_of_type_Double), "", "", "6.5.5");
    ...
    do
    {
      ...
      j = this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.d();
      if (QLog.isColorLevel()) {
  ...
  public void a(String paramString1, QQRecorder.RecorderParam paramRecorderParam, String paramString2)
  {
    ...
    ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005A17", "0X8005A17", 2, 0, "", "", "", "6.5.5");
    PttPreSendManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).c();
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    while ((j == 2) || ((j != 1) && (j != 3)) || (!this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.h())) {
      return true;
    }
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.e(2);
    return true;
  ...
  public void b(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1006);
    ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005A17", "0X8005A17", 4, 0, "", "", "", "6.5.5");
    PttPreSendManager.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface).c();
  }
  ...
  public void c(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a(paramString, true, false, paramRecorderParam);
    this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessage(1006);
    ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8005A17", "0X8005A17", 3, 0, "", "", "", "6.5.5");
  }
  ...
  public void f()
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      localObject = (ListenChangeVoicePanel)LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a()).inflate(2130904071, null);
  ...
  public void g()
  {
    ...
    try
    {
      ...
      int k = this.jdField_b_of_type_AndroidViewViewGroup.getChildCount();
      int j = 0;
      for (;;)
      {
        if (j >= k) {
        ...
        localObject = this.jdField_b_of_type_AndroidViewViewGroup.getChildAt(j);
  ...
  public void h()
  {
    ...
    localScaleAnimation.setInterpolator(new LinearInterpolator());
    localAnimationSet.addAnimation(localScaleAnimation);
    localAnimationSet.setAnimationListener(new ngj(this));
  ...
  {
    if (AppSetting.j) {
      this.jdField_a_of_type_AndroidWidgetImageView.postDelayed(new ngk(this), 500L);
    }
  }
  ...
  public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
  {
    ...
    {
      QQToast.a(BaseApplication.getContext(), 2131371968, 0).b(this.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie.a().getTitleBarHeight());
      return false;
    }
    int j = paramMotionEvent.getAction();
    if (QLog.isColorLevel()) {
      QLog.d("AIOAudioPanel", 2, "PressToChangeVoice.onTouch() is called,action is:" + j);
    }
    if (paramView.getId() == 2131301271) {
      if (j == 0)
      {
        paramView = new ngi(this);
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\activity\aio\audiopanel\PressToChangeVoicePanel.class
