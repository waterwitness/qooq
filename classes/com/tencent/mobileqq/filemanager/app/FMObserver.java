  ...
  implements Observer
{
  ...
  private void a(Object paramObject)
  {
    ...
    case 3: 
      for (;;)
      {
        ...
        for (paramObject = null;; paramObject = (String)paramObject[6])
        {
          ...
          a(false, l1, l2, (String)localObject1, i, j, (String)paramObject);
          return;
        }
        ...
        for (paramObject = null;; paramObject = (String)paramObject[6])
        {
          a();
          QLog.i("FMObserver<FileAssistant>", 1, "OnFileTransferEnd uniseq[" + String.valueOf(l1) + "],nSessionId[" + String.valueOf(l2) + "],errCode[" + String.valueOf(j) + "],errMsg[" + String.valueOf(paramObject) + "], peerType[" + String.valueOf(i) + "]");
          c(j, (String)paramObject);
          return;
        }
        bool = ((Boolean)paramObject[1]).booleanValue();
        Object localObject5 = (Object[])paramObject[2];
        i = ((Integer)localObject5[0]).intValue();
        localObject2 = (String)localObject5[1];
        localObject3 = (String)localObject5[2];
        localObject4 = (String)localObject5[3];
        str = (String)localObject5[4];
        j = ((Integer)localObject5[5]).intValue();
        localObject1 = null;
        paramObject = localObject1;
        if (localObject5.length > 6)
        {
          paramObject = localObject1;
          if (localObject5[6] != null) {
            paramObject = (String)localObject5[6];
          }
        }
        ...
        b(bool, i, (String)localObject2, (String)localObject3, (String)localObject4, str, j, (String)paramObject);
        return;
        bool = ((Boolean)paramObject[1]).booleanValue();
        ...
        QLog.i("FMObserver<FileAssistant>", 1, "OnDiscFilePreview retCode[" + String.valueOf(i) + "],retMsg[" + (String)localObject2 + "], " + "downloadKey[" + (String)localObject3 + "], downloadIp[" + (String)localObject4 + "], downloadDomain[" + str + "], port[" + String.valueOf(j) + "]");
        a(bool, i, (String)localObject2, (String)localObject3, (String)localObject4, str, j, (String)paramObject);
        return;
        bool = ((Boolean)paramObject[1]).booleanValue();
        ...
        localObject5 = (String)arrayOfObject[5];
        ...
        QLog.i("FMObserver<FileAssistant>", 1, "OnWeiYunFilePreview retCode[" + String.valueOf(i) + "],retMsg[" + (String)localObject2 + "], " + "downloadKey[" + (String)localObject3 + "], downloadIp[" + str + "], downloadDomain[" + (String)localObject5 + "], port[" + String.valueOf(j) + "]");
        a(bool, i, (String)localObject2, (String)localObject3, (String)localObject4, str, (String)localObject5, j, (String)paramObject);
        return;
        if (((Boolean)paramObject[1]).booleanValue())
        {
          ...
          for (;;)
          {
            a((List)paramObject);
            return;
            QLog.i("FMObserver<FileAssistant>", 1, "OnWeiYunClassificationTypeSuccess, WeiYunClassificationType size[" + String.valueOf(((List)paramObject).size()) + "]");
          }
        }
        paramObject = (Object[])paramObject[2];
        ...
        if (((Boolean)paramObject[1]).booleanValue())
        {
          ...
          localObject2 = new StringBuilder().append("OnWeiYunOneClassificationInfoSuccess, categoryId[").append((String)paramObject).append("]").append(", isEnd[").append(String.valueOf(bool)).append("]").append(", count[").append(String.valueOf(j)).append("]").append(", timestamp[").append(String.valueOf(l1)).append("]").append(", List<WeiYunFileInfo> size[");
          if (localObject1 != null) {}
          for (i = ((List)localObject1).size();; i = 0)
          {
            QLog.i("FMObserver<FileAssistant>", 1, String.valueOf(i) + "]" + ", index[" + String.valueOf(k) + "]" + "");
            a((String)paramObject, bool, j, l1, (List)localObject1, k);
            return;
          }
        }
        ...
        a(i, (String)paramObject, (String)localObject1);
        return;
        if (((Boolean)paramObject[1]).booleanValue())
        {
          paramObject = (Object[])paramObject[2];
          ...
          if (paramObject != null) {}
          for (i = ((List)paramObject).size();; i = 0)
          {
            QLog.i("FMObserver<FileAssistant>", 1, String.valueOf(i) + "]" + "");
            a(Boolean.valueOf(bool), (List)paramObject);
            return;
          }
        }
        paramObject = (Object[])paramObject[2];
        ...
        a(Integer.valueOf(i), (String)paramObject);
        return;
        if (((Boolean)paramObject[1]).booleanValue())
        {
        ...
        if (((Boolean)paramObject[1]).booleanValue())
        {
          ...
          ((ThumbnailInfo)paramObject).jdField_a_of_type_JavaLangObject = ((IWyFileSystem.Thumbnail)localObject1).context;
          ((ThumbnailInfo)paramObject).jdField_a_of_type_JavaLangString = ((IWyFileSystem.Thumbnail)localObject1).fileId;
          ((ThumbnailInfo)paramObject).jdField_b_of_type_JavaLangString = ((IWyFileSystem.Thumbnail)localObject1).filePath;
          ((ThumbnailInfo)paramObject).jdField_a_of_type_Int = ((IWyFileSystem.Thumbnail)localObject1).type.ordinal();
          QLog.i("FMObserver<FileAssistant>", 1, "OnThumbDownLoadSuccess,fileId[" + ((ThumbnailInfo)paramObject).jdField_a_of_type_JavaLangString + "],filePath[" + ((ThumbnailInfo)paramObject).jdField_b_of_type_JavaLangString + "]");
          if ((((ThumbnailInfo)paramObject).jdField_a_of_type_JavaLangObject != null) && (((IWyFileSystem.Thumbnail)localObject1).filePath != null) && (((IWyFileSystem.Thumbnail)localObject1).filePath.length() > 0))
          {
            if (!(((ThumbnailInfo)paramObject).jdField_a_of_type_JavaLangObject instanceof WeiYunFileInfo)) {
              break label3274;
            }
          ...
          for (;;)
          {
            a((ThumbnailInfo)paramObject);
            return;
            if ((((ThumbnailInfo)paramObject).jdField_a_of_type_JavaLangObject instanceof OfflineFileInfo)) {
              ((OfflineFileInfo)((IWyFileSystem.Thumbnail)localObject1).context).c = ((IWyFileSystem.Thumbnail)localObject1).filePath;
            } else if ((((ThumbnailInfo)paramObject).jdField_a_of_type_JavaLangObject instanceof FileManagerEntity)) {
        ...
        paramObject = new ThumbnailInfo();
        ((ThumbnailInfo)paramObject).jdField_b_of_type_JavaLangString = null;
        ((ThumbnailInfo)paramObject).jdField_a_of_type_JavaLangString = ((String)localObject2);
        ((ThumbnailInfo)paramObject).jdField_a_of_type_JavaLangObject = localObject1[1];
        localObject1 = new Handler();
        QLog.i("FMObserver<FileAssistant>", 1, "OnThumbDownLoadSuccess(faild),fileId[" + ((ThumbnailInfo)paramObject).jdField_a_of_type_JavaLangString + "],delay 1000ms");
        ((Handler)localObject1).postDelayed(new rvq(this, (ThumbnailInfo)paramObject), 1000L);
        return;
        if (((Boolean)paramObject[1]).booleanValue())
        {
          paramObject = (String)paramObject[2];
          QLog.i("FMObserver<FileAssistant>", 1, "OnGetWeiYunPriviewUrlSuccess,strUrlString[" + (String)paramObject + "]");
        ...
        b(Integer.valueOf(i), (String)paramObject);
        return;
        try
        {
          bool = ((Boolean)paramObject[1]).booleanValue();
    ...
    case 190: 
      ...
      if (!bool)
      {
        a(((Long)paramObject).longValue(), ((Integer)localObject2).intValue(), (String)localObject3);
        return;
      }
      localObject2 = (String)localObject1[3];
      localObject3 = (Integer)localObject1[4];
      localObject1 = (Long)localObject1[5];
      a(((Long)paramObject).longValue(), (String)localObject2, ((Integer)localObject3).intValue(), ((Long)localObject1).longValue());
      return;
    case 20: 
      bool = ((Boolean)paramObject[1]).booleanValue();
      ...
      if (!bool)
      {
        ...
        a((String)localObject2, (String)localObject3, (Integer)paramObject, (String)localObject1, ((Boolean)localObject4).booleanValue());
        return;
      }
    ...
    case 45: 
      ...
      if (!bool)
      {
        ...
        a(((Integer)paramObject).intValue(), (String)localObject1);
        return;
      }
    ...
    for (i = ((Integer)localObject1[1]).intValue();; i = 0)
    {
      if (bool)
      {
        ...
        ((ThumbnailInfo)localObject1).jdField_a_of_type_JavaLangString = ((FileManagerEntity)paramObject).Uuid;
        ((ThumbnailInfo)localObject1).jdField_b_of_type_Int = i;
        if (i == 7) {
          ((ThumbnailInfo)localObject1).jdField_b_of_type_JavaLangString = ((FileManagerEntity)paramObject).strLargeThumPath;
        }
        for (;;)
        {
          ((ThumbnailInfo)localObject1).jdField_a_of_type_Long = ((FileManagerEntity)paramObject).nSessionId;
          a((ThumbnailInfo)localObject1);
          return;
          if (i == 5) {
            ((ThumbnailInfo)localObject1).jdField_b_of_type_JavaLangString = ((FileManagerEntity)paramObject).strMiddleThumPath;
          } else {
            ((ThumbnailInfo)localObject1).jdField_b_of_type_JavaLangString = ((FileManagerEntity)paramObject).strThumbPath;
          }
        }
      }
      localObject1 = new ThumbnailInfo();
  ...
  public void update(Observable paramObservable, Object paramObject)
  {
    ...
    {
      new Handler(paramObservable).post(new rvp(this, paramObject));
      return;
    }
    a(paramObject);
  }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\filemanager\app\FMObserver.class
