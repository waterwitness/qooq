...
public class OnlineFileSessionCenter
{
  ...
  public OnlineFileSessionCenter(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppFMObserver = new rxr(this);
    ...
    try
    {
      ThreadManager.b(new rxp(this, paramQQAppInterface));
      return;
    }
  ...
  public void a(String paramString, long paramLong)
  {
    ...
    do
    {
      ...
      a(paramString, paramLong, new rxu(this, 10));
      return;
  ...
  public void a(String paramString, long paramLong, int paramInt)
  {
    ...
    do
    {
      ...
      a(paramString, paramLong, new rxu(this, paramInt));
      return;
  ...
  public void a(String paramString1, long paramLong, int paramInt, String paramString2)
  {
    ...
    do
    {
      ...
      localObject = new rxu(this, 12);
      ((rxu)localObject).jdField_b_of_type_Int = paramInt;
      ((rxu)localObject).jdField_a_of_type_JavaLangString = paramString2;
      a(paramString1, paramLong, (rxu)localObject);
      return;
  ...
  public void a(String paramString1, long paramLong1, int paramInt, String paramString2, long paramLong2)
  {
    ...
    do
    {
      ...
      localObject = new rxu(this, 11);
      ((rxu)localObject).jdField_b_of_type_Int = paramInt;
      ((rxu)localObject).jdField_a_of_type_JavaLangString = paramString2;
      ((rxu)localObject).jdField_b_of_type_Long = paramLong2;
      a(paramString1, paramLong1, (rxu)localObject);
      return;
  ...
  void a(String paramString, long paramLong, rxu paramrxu)
  {
    if ((paramString == null) || (paramLong <= 0L) || (paramrxu == null)) {
      return;
    }
    QLog.i("OnlineFileSessionCenter<FileAssistant>", 1, "OLfilesession[" + paramLong + "]  cacheHandleBeforeRequest handleType:" + paramrxu.jdField_a_of_type_Int + " info_1:" + paramrxu.jdField_b_of_type_Int + " info_2:" + paramrxu.jdField_a_of_type_JavaLangString + " info_3:" + paramrxu.jdField_b_of_type_Long);
    LinkedHashMap localLinkedHashMap = (LinkedHashMap)this.b.get(paramString);
    if (localLinkedHashMap == null)
    {
      localLinkedHashMap = new LinkedHashMap();
      localLinkedHashMap.put(Long.valueOf(paramLong), paramrxu);
  ...
  boolean a(String paramString, long paramLong)
  {
    ...
    if (localLinkedHashMap != null)
    {
      localObject = (rxu)localLinkedHashMap.get(Long.valueOf(paramLong));
      if (localObject != null)
      {
        QLog.i("OnlineFileSessionCenter<FileAssistant>", 1, "OLfilesession[" + paramLong + "]  isBeHandledBeforeRequest handleType:" + ((rxu)localObject).jdField_a_of_type_Int + " info_1:" + ((rxu)localObject).jdField_b_of_type_Int + " info_2:" + ((rxu)localObject).jdField_a_of_type_JavaLangString + " info_3:" + ((rxu)localObject).jdField_b_of_type_Long);
        switch (((rxu)localObject).jdField_a_of_type_Int)
        {
        case 6: 
        case 7: 
        case 8: 
      ...
      for (;;)
      {
        ...
        if ((localLinkedHashMap != null) && (localLinkedHashMap.size() > 0))
        {
          ...
          for (;;)
          {
            ...
            rxu localrxu = (rxu)localEntry.getValue();
            long l = ((Long)localEntry.getKey()).longValue();
            if (localrxu != null)
            {
              if (paramLong - localrxu.jdField_a_of_type_Long < 7200L) {
                continue;
              }
              QLog.i("OnlineFileSessionCenter<FileAssistant>", 1, "OLfilesession[" + l + "]  isBeHandledBeforeRequest and clear it.handleType:" + localrxu.jdField_a_of_type_Int + " info_1:" + localrxu.jdField_b_of_type_Int + " info_2:" + localrxu.jdField_a_of_type_JavaLangString + " info_3:" + localrxu.jdField_b_of_type_Long);
              ((Iterator)localObject).remove();
              continue;
              a(paramString, paramLong, ((rxu)localObject).jdField_a_of_type_Int);
              bool1 = true;
              break;
              a(paramString, paramLong);
              bool1 = true;
              break;
              a(paramString, paramLong, ((rxu)localObject).jdField_b_of_type_Int, ((rxu)localObject).jdField_a_of_type_JavaLangString, ((rxu)localObject).jdField_b_of_type_Long);
              bool1 = true;
              break;
              a(paramString, paramLong, ((rxu)localObject).jdField_b_of_type_Int, ((rxu)localObject).jdField_a_of_type_JavaLangString);
              bool1 = true;
              break;
            }
            ((Iterator)localObject).remove();
  ...
  void b()
  {
    if (this.jdField_a_of_type_AndroidOsHandler == null) {
      this.jdField_a_of_type_AndroidOsHandler = new rxt(this, Looper.getMainLooper());
    }
    if (this.jdField_a_of_type_Rxv == null)
    {
      this.jdField_a_of_type_Rxv = new rxv(this, null);
      this.jdField_a_of_type_Rxv.a();
  ...
  public void b(int paramInt)
  {
    ...
    {
      new Handler(localLooper).post(new rxs(this, paramInt));
      return;
    }
    a(paramInt);
  }
  ...
  void c()
  {
    if (this.jdField_a_of_type_Rxv != null)
    {
      this.jdField_a_of_type_Rxv.b();
      this.jdField_a_of_type_Rxv = null;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\mobileqq\filemanager\core\OnlineFileSessionCenter.class
