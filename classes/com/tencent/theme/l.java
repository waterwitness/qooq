...
public class l
{
    ...
    throws IOException
  {
    ...
    l locall = new l();
    locall.a = c.c(paramByteBuffer, m);
    if (i != 0) {
      locall.c = c.c(paramByteBuffer, i);
    }
    ...
    locall.f = localByteBuffer;
    locall.b = new String[m];
    ...
    if (k != 0)
    {
      ...
      locall.d = c.c(paramByteBuffer, i / 4);
    }
    return locall;
  }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\theme\l.class
