  ...
  implements Parcelable
{
  ...
  private void readFromParcel(Parcel paramParcel)
  {
    ...
    //   0: aload_0
    //   1: aload_1
    //   2: invokevirtual 112	android/os/Parcel:readInt	()I
    //   5: putfield 114	com/tencent/qphone/base/remote/ToServiceMsg:appId	I
    //   8: aload_0
    //   9: aload_1
    //   10: invokevirtual 112	android/os/Parcel:readInt	()I
    //   13: putfield 61	com/tencent/qphone/base/remote/ToServiceMsg:appSeq	I
    //   16: aload_0
    //   17: aload_1
    //   18: invokevirtual 118	android/os/Parcel:readString	()Ljava/lang/String;
    //   21: putfield 96	com/tencent/qphone/base/remote/ToServiceMsg:serviceName	Ljava/lang/String;
    //   24: aload_0
    //   25: aload_1
    //   26: invokevirtual 118	android/os/Parcel:readString	()Ljava/lang/String;
    //   29: putfield 98	com/tencent/qphone/base/remote/ToServiceMsg:uin	Ljava/lang/String;
    //   32: aload_0
    //   33: aload_1
    //   34: invokevirtual 122	android/os/Parcel:readByte	()B
    //   37: putfield 88	com/tencent/qphone/base/remote/ToServiceMsg:uinType	B
    //   40: aload_0
    //   41: aload_1
    //   42: invokevirtual 118	android/os/Parcel:readString	()Ljava/lang/String;
    //   45: putfield 100	com/tencent/qphone/base/remote/ToServiceMsg:serviceCmd	Ljava/lang/String;
    //   48: aload_0
    //   49: aload_1
    //   50: invokevirtual 126	android/os/Parcel:readLong	()J
    ...
    //   60: invokevirtual 129	android/os/Bundle:clear	()V
    //   63: aload_0
    //   64: getfield 77	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   67: aload_1
    //   68: invokestatic 135	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   71: invokevirtual 139	java/lang/Thread:getContextClassLoader	()Ljava/lang/ClassLoader;
    //   74: invokevirtual 143	android/os/Parcel:readBundle	(Ljava/lang/ClassLoader;)Landroid/os/Bundle;
    //   77: invokevirtual 147	android/os/Bundle:putAll	(Landroid/os/Bundle;)V
    //   80: aload_0
    //   81: aload_1
    //   82: invokevirtual 151	android/os/Parcel:readStrongBinder	()Landroid/os/IBinder;
    //   85: invokestatic 157	com/tencent/qphone/base/remote/IBaseActionListener$Stub:asInterface	(Landroid/os/IBinder;)Lcom/tencent/qphone/base/remote/IBaseActionListener;
    //   88: putfield 159	com/tencent/qphone/base/remote/ToServiceMsg:actionListener	Lcom/tencent/qphone/base/remote/IBaseActionListener;
    //   91: aload_0
    //   92: aload_0
    //   93: getfield 77	com/tencent/qphone/base/remote/ToServiceMsg:extraData	Landroid/os/Bundle;
    //   96: ldc 14
    //   98: invokevirtual 163	android/os/Bundle:getByte	(Ljava/lang/String;)B
    ...
    //   111: aload_0
    //   112: aload_1
    //   113: invokevirtual 167	android/os/Parcel:readSerializable	()Ljava/io/Serializable;
    ...
    //   122: aload_0
    //   123: aload_1
    //   124: invokevirtual 126	android/os/Parcel:readLong	()J
    //   127: putfield 57	com/tencent/qphone/base/remote/ToServiceMsg:sendTimeout	J
    //   130: aload_1
    //   131: invokevirtual 122	android/os/Parcel:readByte	()B
    //   134: ifne +80 -> 214
    //   137: iconst_0
    //   138: istore_2
    //   139: aload_0
    ...
    //   144: aload_0
    //   145: aload_1
    //   146: invokevirtual 112	android/os/Parcel:readInt	()I
    ...
    //   159: invokevirtual 171	android/os/Parcel:readByteArray	([B)V
    //   162: aload_0
    //   163: aload_1
    //   164: invokevirtual 112	android/os/Parcel:readInt	()I
    ...
    //   174: invokevirtual 172	java/util/HashMap:clear	()V
    //   177: aload_1
    //   178: aload_0
    //   179: getfield 72	com/tencent/qphone/base/remote/ToServiceMsg:attributes	Ljava/util/HashMap;
    //   182: ldc 2
    //   184: invokevirtual 177	java/lang/Class:getClassLoader	()Ljava/lang/ClassLoader;
    //   187: invokevirtual 181	android/os/Parcel:readMap	(Ljava/util/Map;Ljava/lang/ClassLoader;)V
    //   190: aload_1
    //   191: invokevirtual 112	android/os/Parcel:readInt	()I
    //   194: iconst_1
    ...
    //   200: aload_0
    //   201: iload_2
    //   202: putfield 183	com/tencent/qphone/base/remote/ToServiceMsg:quickSendEnable	Z
    //   205: aload_0
    //   206: aload_1
    //   207: invokevirtual 112	android/os/Parcel:readInt	()I
  ...
  public void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    //   2: aload_1
    //   3: aload_0
    //   4: getfield 114	com/tencent/qphone/base/remote/ToServiceMsg:appId	I
    ...
    //   18: aload_1
    //   19: aload_0
    //   20: getfield 96	com/tencent/qphone/base/remote/ToServiceMsg:serviceName	Ljava/lang/String;
    //   23: invokevirtual 339	android/os/Parcel:writeString	(Ljava/lang/String;)V
    //   26: aload_1
    //   27: aload_0
    //   28: getfield 98	com/tencent/qphone/base/remote/ToServiceMsg:uin	Ljava/lang/String;
    ...
    //   42: aload_1
    //   43: aload_0
    //   44: getfield 100	com/tencent/qphone/base/remote/ToServiceMsg:serviceCmd	Ljava/lang/String;
    ...
    //   66: aload_1
    //   67: aload_0
    //   68: getfield 159	com/tencent/qphone/base/remote/ToServiceMsg:actionListener	Lcom/tencent/qphone/base/remote/IBaseActionListener;
    ...
    //   144: aload_0
    //   145: getfield 183	com/tencent/qphone/base/remote/ToServiceMsg:quickSendEnable	Z
    //   148: ifeq +22 -> 170
    //   151: aload_1
    //   152: iload_2
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\qphone\base\remote\ToServiceMsg.class
