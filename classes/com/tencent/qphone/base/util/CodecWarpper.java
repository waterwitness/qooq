...
public abstract class CodecWarpper
{
  ...
  public static void checkSOVersion()
  {
    try
    {
      ...
      QLog.d(tag, 1, "set so version to " + checkedSOVersion);
      return;
    }
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if ((i == 8) || (i == 9))
          {
            ...
            QLog.d(tag, 1, "set so version to " + checkedSOVersion + " with error ", localUnsatisfiedLinkError);
            return;
          }
        }
        ...
        {
          checkedSOVersion = 591;
          QLog.d(tag, 1, "set so version to 591 with deep error ", localUnsatisfiedLinkError);
          return;
        }
        if ((i == 10) || (i == 11)) {
    ...
    {
      QLog.d(tag, 1, "set so version failed ", localThrowable1);
    }
  }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\qphone\base\util\CodecWarpper.class
