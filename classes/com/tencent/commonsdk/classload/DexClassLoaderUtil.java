...
public class DexClassLoaderUtil
{
  ...
  /* Error */
  public static dalvik.system.DexClassLoader createDexClassLoader(String paramString1, String paramString2, String paramString3, ClassLoader paramClassLoader)
  {
    // Byte code:
    ...
    //   0	700	3	paramClassLoader	ClassLoader
    //   231	465	4	localObject1	Object
    //   213	480	5	localObject2	Object
    //   208	94	6	str1	String
    //   365	10	6	localException1	Exception
    //   455	213	6	str2	String
    //   688	1	6	localException2	Exception
    //   205	273	7	localFile1	File
    //   202	166	8	arrayOfFile	File[]
    //   199	35	9	localObject3	Object
    //   28	632	10	localHandler	Handler
    //   85	530	11	str3	String
    //   182	488	12	localFile2	File
    //   123	478	13	localFile3	File
    //   112	389	14	str4	String
    //   36	518	15	i	int
    //   44	486	16	j	int
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\commonsdk\classload\DexClassLoaderUtil.class
