...
public class FastScroller
{
  ...
  private final Runnable jdField_a_of_type_JavaLangRunnable = new xtc(this);
  ...
  private void a(Context paramContext)
  {
    ...
    b();
    this.r = paramContext.getResources().getDimensionPixelSize(2131492892);
  ...
  private void a(Context paramContext, Drawable paramDrawable)
  {
    ...
    if ((paramDrawable instanceof NinePatchDrawable)) {
      this.jdField_b_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131492893);
    }
    for (this.jdField_a_of_type_Int = paramContext.getResources().getDimensionPixelSize(2131492894);; this.jdField_a_of_type_Int = paramDrawable.getIntrinsicHeight())
    {
  ...
  {
    int i8 = this.jdField_a_of_type_ComTencentWidgetAbsListView.d_();
  ...
  boolean a(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      {
        if (!this.jdField_a_of_type_ComTencentWidgetAbsListView.s())
        {
          f();
          return true;
        }
    ...
    do
    {
      ...
      if ((this.jdField_b_of_type_Boolean) && (Math.abs(paramMotionEvent.getY() - this.jdField_a_of_type_Float) > this.y))
      {
        ...
        if (this.jdField_a_of_type_ComTencentWidgetAbsListView != null)
        {
          ...
          this.jdField_a_of_type_ComTencentWidgetAbsListView.b(1);
          i();
          d();
        }
      }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\widget\FastScroller.class
