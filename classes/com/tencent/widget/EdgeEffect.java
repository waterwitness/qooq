...
public class EdgeEffect
{
  ...
  public EdgeEffect(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getDrawable(2130838726);
    this.b = paramContext.getDrawable(2130838727);
  ...
  private void c()
  {
    ...
    case 4: 
      if (this.u != 0.0F) {}
      for (f1 = 1.0F / (this.u * this.u);; f1 = Float.MAX_VALUE)
      {
        float f3 = this.p;
  ...
  public void a(int paramInt)
  {
    ...
    this.u = Math.min(0.025F + paramInt / 100 * paramInt * 1.5E-4F, 1.75F);
    this.s = Math.max(this.jdField_r_of_type_Float, Math.min(paramInt * 16 * 1.0E-5F, 0.8F));
  }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\widget\EdgeEffect.class
