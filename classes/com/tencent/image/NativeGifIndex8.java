  ...
  extends AbstractGifImage
{
  ...
  private static void loadLibrary()
  {
    ...
    try
    {
      ...
      if (localObject != null) {
        ((SharedPreferences)localObject).edit().putBoolean("gif_so_is_update", false).commit();
      }
      if (QLog.isColorLevel()) {
  ...
  protected void getNextFrame()
  {
    ...
    //   50	6	1	localSharedPreferences	SharedPreferences
    //   79	11	1	localOutOfMemoryError1	OutOfMemoryError
    //   99	4	1	localObject	Object
    //   104	11	1	localIllegalArgumentException	IllegalArgumentException
    //   189	24	1	localOutOfMemoryError2	OutOfMemoryError
    //   228	24	1	localThrowable	Throwable
    //   150	2	2	i	int
    //   5	2	3	bool	boolean
    // Exception table:
    //   from	to	target	type
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\image\NativeGifIndex8.class
