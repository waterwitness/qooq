  ...
  implements Drawable.Callback, Runnable, URLState.Callback
{
  ...
  public static URLDrawable getDrawable(URL paramURL, URLDrawableOptions paramURLDrawableOptions)
  {
    ...
    do
    {
      for (;;)
      {
        try
        {
          ...
          {
            ((ApngDrawable)paramURL.mCurrDrawable).mUseAnimation = localURLDrawableOptions.mUseApngImage;
            continue;
          }
          if (!(paramURL.mCurrDrawable instanceof VideoDrawable)) {
            break;
          }
        }
        finally {}
        if ((localURLDrawableOptions.mExtraInfo != null) && ((localURLDrawableOptions.mExtraInfo instanceof VideoDrawable.VideoDrawableParams))) {
          ((VideoDrawable)paramURL.mCurrDrawable).mPlayVideoFrame = ((VideoDrawable.VideoDrawableParams)localURLDrawableOptions.mExtraInfo).mPlayVideoFrame;
        }
      }
    } while ((!(paramURL.mCurrDrawable instanceof QQLiveDrawable)) || (localURLDrawableOptions.mExtraInfo == null) || (!(localURLDrawableOptions.mExtraInfo instanceof QQLiveDrawable.QQLiveDrawableParams)));
    paramURLDrawableOptions = (QQLiveDrawable)paramURL.mCurrDrawable;
    Object localObject = (QQLiveDrawable.QQLiveDrawableParams)localURLDrawableOptions.mExtraInfo;
    paramURLDrawableOptions.setParams((QQLiveDrawable.QQLiveDrawableParams)localObject);
    if (((QQLiveDrawable.QQLiveDrawableParams)localObject).mPlayPause) {
      paramURLDrawableOptions.pause();
    }
    for (;;)
    {
      paramURLDrawableOptions.setOnStateListener(((QQLiveDrawable.QQLiveDrawableParams)localObject).mListener);
      break;
      if (((QQLiveDrawable.QQLiveDrawableParams)localObject).mStartPosi > 0) {
        paramURLDrawableOptions.resumeFromPosi(((QQLiveDrawable.QQLiveDrawableParams)localObject).mStartPosi);
      } else {
        paramURLDrawableOptions.resume();
      }
    }
    label310:
    paramURL.mUseGifAnimation = localURLDrawableOptions.mPlayGifImage;
    paramURL.mUseApngImage = localURLDrawableOptions.mUseApngImage;
    paramURL.mUseSharpPImage = localURLDrawableOptions.mUseSharpPImage;
    ...
    ((DownloadParams)localObject).reportFlag = localURLDrawableOptions.mReportFlag;
  ...
  public static void pause()
  {
    if (QLog.isColorLevel()) {
      QLog.d("URLDrawable_", 2, "pause load image " + new RuntimeException("getStack").getStackTrace()[1].toString());
    }
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("URLDrawable_", 2, "resume load image " + new RuntimeException("getStack").getStackTrace()[1].toString());
    }
    synchronized (sPauseLock)
    {
      sPause = false;
  ...
  public void setTargetDensity(int paramInt)
  {
    ...
    } while (!(this.mCurrDrawable instanceof VideoDrawable));
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\tencent\image\URLDrawable.class
