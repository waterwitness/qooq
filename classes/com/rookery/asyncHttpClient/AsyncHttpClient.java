...
public class AsyncHttpClient
{
      ...
      try
      {
        ...
        for (;;)
        {
          try
          {
            ...
            ((SSLSocketFactory)localObject2).setHostnameVerifier(new gbu(this));
            ...
            this.jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient.addRequestInterceptor(new gbv(this));
            this.jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient.addResponseInterceptor(new gbw(this));
            this.jdField_a_of_type_OrgApacheHttpImplClientDefaultHttpClient.setHttpRequestRetryHandler(new gca(3));
  ...
  protected void a(DefaultHttpClient paramDefaultHttpClient, HttpContext paramHttpContext, HttpUriRequest paramHttpUriRequest, String paramString, AsyncHttpResponseHandler paramAsyncHttpResponseHandler, Context paramContext)
  {
    ...
    paramHttpUriRequest = this.jdField_a_of_type_JavaUtilConcurrentThreadPoolExecutor.submit(new gby(paramDefaultHttpClient, paramHttpContext, paramHttpUriRequest, paramAsyncHttpResponseHandler));
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\rookery\asyncHttpClient\AsyncHttpClient.class
