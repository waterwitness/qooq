...
public final class BitMatrix
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((this.jdField_a_of_type_Int != ((BitMatrix)paramObject).jdField_a_of_type_Int) || (this.b != ((BitMatrix)paramObject).b) || (this.c != ((BitMatrix)paramObject).c) || (this.jdField_a_of_type_ArrayOfInt.length != ((BitMatrix)paramObject).jdField_a_of_type_ArrayOfInt.length));
    int i = 0;
    for (;;)
    {
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\com\google\zxing\common\BitMatrix.class
