...
public class xue
{
  ...
  private void b()
  {
    long l1 = this.jdField_a_of_type_Long + this.jdField_e_of_type_Int;
    int i1 = (int)(this.jdField_e_of_type_Int / this.jdField_f_of_type_Int * 100.0F);
    float f1 = 0.0F;
    if (i1 < 100)
    {
      f1 = i1 / 100.0F;
  ...
  {
    this.jdField_e_of_type_Int = ((int)(AnimationUtils.currentAnimationTimeMillis() - this.jdField_a_of_type_Long) + paramInt);
    this.jdField_a_of_type_Boolean = false;
  }
  ...
  public void b(int paramInt1, int paramInt2, int paramInt3)
  {
    if (this.i == 0) {
      if (paramInt1 == paramInt2) {
        a(paramInt2, paramInt3, this.d, OverScroller.jdField_b_of_type_Int);
      }
    }
    while (this.i != 4)
    {
  ...
  public boolean b()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_Int = ((int)Math.round(d1) + i1);
      return true;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\xue.class
