  ...
  extends View
{
  ...
  public qfz(ScreenShot paramScreenShot, Context paramContext)
  {
    super(paramContext);
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppScreenShot.jdField_a_of_type_AndroidGraphicsBitmap != null)
    {
      ...
      invalidate();
      this.jdField_a_of_type_AndroidGraphicsPaint.setColor(48689);
    ...
    do
    {
      try
      {
        ...
        this.jdField_a_of_type_AndroidGraphicsPaint.setColor(Integer.MIN_VALUE);
        ...
        {
          Toast.makeText(this.jdField_a_of_type_ComTencentMobileqqAppScreenShot.jdField_a_of_type_AndroidContentContext.getApplicationContext(), 2131368162, 1).show();
          return;
          i = getWidth();
          j = getHeight();
      ...
      if (this.jdField_a_of_type_AndroidGraphicsRect.isEmpty())
      {
        ...
        this.jdField_b_of_type_AndroidGraphicsPaint.setShadowLayer(2.0F, 0.0F, 2.0F * f1, Integer.MIN_VALUE);
        paramCanvas.drawText(this.jdField_a_of_type_ComTencentMobileqqAppScreenShot.jdField_a_of_type_AndroidContentContext.getString(2131368160), getWidth() / 2, m + 26.0F * f1, this.jdField_b_of_type_AndroidGraphicsPaint);
      }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\qfz.class
