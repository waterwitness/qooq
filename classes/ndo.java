...
{
  public ndo(MediaPlayerManager paramMediaPlayerManager)
  {
    ...
    for (;;)
    {
      ...
      if ((f4 >= MediaPlayerManager.a(this.a)) || (f5 >= MediaPlayerManager.a(this.a)) || (f6 >= MediaPlayerManager.a(this.a)))
      {
        if ((!this.a.jdField_a_of_type_Boolean) && (QLog.isColorLevel())) {
          QLog.d(MediaPlayerManager.a(), 2, "ProximityEventListener$onSensorChanged moving | x=" + f1 + " | y = " + f2 + " | z = " + f3 + " | ax = " + f4 + " | ay = " + f5 + " | az = " + f6 + " | value=" + MediaPlayerManager.a(this.a));
        }
      ...
      {
        if ((this.a.jdField_a_of_type_Boolean) && (QLog.isColorLevel())) {
          QLog.d(MediaPlayerManager.a(), 2, "ProximityEventListener$onSensorChanged stop moving | x=" + f1 + " | y = " + f2 + " | z = " + f3 + " | ax = " + f4 + " | ay = " + f5 + " | az = " + f6 + " | value=" + MediaPlayerManager.a(this.a));
        }
