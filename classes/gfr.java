...
{
  public gfr(AvAddFriendService paramAvAddFriendService)
  {
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      {
        new ArrayList();
        localObject = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().b(AppConstants.av, 0);
        if (QLog.isColorLevel()) {
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\gfr.class
