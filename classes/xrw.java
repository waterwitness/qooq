  ...
  implements Runnable
{
  ...
  public xrw(AbsListView paramAbsListView)
  {
  ...
  {
    boolean bool = true;
    int k = this.jdField_a_of_type_ComTencentWidgetAbsListView.au;
    int m = this.jdField_a_of_type_ComTencentWidgetAbsListView.getChildCount();
    k = this.jdField_a_of_type_ComTencentWidgetAbsListView.aG - (k + m - 1) - 1;
    if (k == 0)
    {
    ...
    this.jdField_b_of_type_Int = 0;
    this.d = (this.jdField_a_of_type_ComTencentWidgetAbsListView.aG - 1);
    if (k == 1) {}
    for (;;)
    {
  ...
  public void b()
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetAbsListView.m = false;
  }
  
  public void run()
  {
    int k = 0;
    AdapterView.d("AbsListView.MoveToBottomScroller.run");
    for (;;)
    {
      int m;
      try
      {
        ...
        case 0: 
          ...
          int n = this.jdField_a_of_type_ComTencentWidgetAbsListView.au;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\xrw.class
