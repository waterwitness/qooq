...
{
  public sap(WeiYunLogicCenter paramWeiYunLogicCenter, FileManagerEntity paramFileManagerEntity, int paramInt)
  {
  ...
  public void a(IWyFileSystem.CommonFtnFile paramCommonFtnFile)
  {
    ...
    if ((!FileUtils.b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.strThumbPath)) && (FileManagerUtil.a(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity.fileName) == 2))
    {
      String str = this.jdField_a_of_type_ComTencentMobileqqFilemanagerCoreWeiYunLogicCenter.a.a().b(this.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity, 2);
      if (str != null) {
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\sap.class
