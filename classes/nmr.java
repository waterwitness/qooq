...
{
  public nmr(PAMultiItemBuilder paramPAMultiItemBuilder)
  {
  ...
  {
    nms localnms = (nms)paramView.getTag();
    ...
    if ((localnms == null) || (!(localChatMessage instanceof MessageForPubAccount))) {
      if (QLog.isColorLevel()) {
        QLog.d(ChatItemBuilder.a, 2, "PAMultiItemBuilder onClickListener holder = " + localnms + ", msg = " + localChatMessage);
      }
    }
    Object localObject1;
    do
    ...
    return;
    Object localObject2 = (PAMessage.Item)((MessageForPubAccount)localObject1).mPAMessage.items.get(localnms.d);
    if ((this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface instanceof QQAppInterface)) {
      ReportController.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, "mp_msg_msgpic_click", "aio_morpic_click", localnms.d + 1, 0, "", "", Long.toString(((MessageForPubAccount)localObject1).mPAMessage.mMsgId), "");
    }
    ...
    if (TextUtils.isEmpty(((PAMessage.Item)localObject2).a_actionData))
    {
      ...
      PASingleItemBuilder.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.a.jdField_a_of_type_AndroidContentContext, localnms.a, localnms.b, localnms.c, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.d, l1);
      label547:
    ...
    for (;;)
    {
      ...
      ((EcshopReportHandler)localObject2).a(false, localChatMessage, localnms.d + 1, paramView);
      return;
