...
{
  public rwm(DiscPicThumbDownloader paramDiscPicThumbDownloader)
  {
  ...
  protected void a(boolean paramBoolean, long paramLong1, String paramString1, ByteStringMicro paramByteStringMicro, String paramString2, short paramShort, String paramString3, List paramList, int paramInt, String paramString4, long paramLong2)
  {
    ...
    if ((paramString2 == null) || (paramByteStringMicro == null))
    {
    ...
    {
    default: 
      new StringBuilder().append("http://").append(paramString2).append(":").append(String.valueOf(paramShort)).append(paramString3).toString();
      QLog.e("DiscPicThumbDownloader<FileAssistant>", 2, "[downloadThumb]  ID[" + paramLong2 + "] unknow thumbSize!!!info:" + paramList.toString());
      this.a.a.a().a(false, 51, new Object[] { paramList.jdField_a_of_type_ComTencentMobileqqFilemanagerDataFileManagerEntity, Integer.valueOf(paramList.jdField_a_of_type_Int) });
      this.a.a(paramLong2);
      this.a.a(paramLong2, false, paramString2, paramShort, paramString3, null);
      return;
    case 0: 
    ...
    for (;;)
    {
      ...
      this.a.a(paramLong2, true, paramString2, paramShort, paramString1, null);
      return;
  ...
  protected void a(boolean paramBoolean, long paramLong1, String paramString1, String paramString2, String paramString3, int paramInt1, String paramString4, String paramString5, int paramInt2, long paramLong2)
  {
    ...
    if (!paramBoolean)
    {
      ...
      for (;;)
      {
        ...
        this.a.a(paramLong2, false, null, 0, null, null);
        return;
        if ((paramLong1 == -25081L) || (paramLong1 == -6101L))
        {
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\rwm.class
