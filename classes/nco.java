  ...
  implements Runnable
{
  ...
  public nco(QQAppInterface paramQQAppInterface, Context paramContext, BaseChatItemLayout paramBaseChatItemLayout, String paramString1, String paramString2, int paramInt, View.OnLongClickListener paramOnLongClickListener)
  {
  ...
  public void run()
  {
    ...
    for (;;)
    {
      ...
      {
        str1 = ContactUtils.f(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_JavaLangString, this.b);
        localObject = str1;
        if (str1 != null)
        {
          localObject = str1;
      ...
      try
      {
        ...
        ((Activity)this.jdField_a_of_type_AndroidContentContext).runOnUiThread(new ncp(this, (String)localObject));
        return;
