...
{
  public oju(RecommendTroopView paramRecommendTroopView, int paramInt, boolean paramBoolean1, boolean paramBoolean2, long paramLong, boolean paramBoolean3, boolean paramBoolean4, String paramString)
  {
  ...
  public void a(int paramInt, SosoInterface.SosoLbsInfo paramSosoLbsInfo)
  {
    ...
    {
      this.a.c = Double.valueOf(paramSosoLbsInfo.a.a * 1000000.0D).intValue();
      this.a.d = Double.valueOf(paramSosoLbsInfo.a.b * 1000000.0D).intValue();
      paramSosoLbsInfo = new userinfo.UserInfo();
      localObject1 = new userinfo.GPS();
      if (this.a.c != 0)
      {
        ((userinfo.GPS)localObject1).uint32_lat.set(this.a.c);
        ((userinfo.GPS)localObject1).uint32_lon.set(this.a.d);
    ...
    try
    {
      ...
      paramSosoLbsInfo.setObserver(new ojv(this));
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\oju.class
