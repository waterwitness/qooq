...
{
  public lba(ContactSyncJumpActivity paramContactSyncJumpActivity)
  {
  ...
  protected void a(boolean paramBoolean, long paramLong, String paramString, GetOnlineInfoResp paramGetOnlineInfoResp)
  {
    ...
    do
    {
      ...
      for (paramLong = paramGetOnlineInfoResp.uAbiFlag;; paramLong = -10000L)
      {
        ...
        paramString = (TextView)this.a.jdField_a_of_type_AndroidAppDialog.findViewById(2131301461);
        paramString.setText(2131371193);
      ...
      {
        if ((paramGetOnlineInfoResp.errorCode == 60001) || (paramGetOnlineInfoResp.errorCode == 60001))
        {
          paramString = String.format(this.a.getResources().getString(2131371188), new Object[] { ContactSyncJumpActivity.d(this.a) });
    ...
    label760:
    for (paramString = this.a.getResources().getString(2131371193);; paramString = (String)localObject)
    {
      localObject = (TextView)this.a.jdField_a_of_type_AndroidAppDialog.findViewById(2131301461);
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\lba.class
