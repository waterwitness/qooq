...
public class obz
  implements Runnable
{
  public obz(PublicAccountChatPie paramPublicAccountChatPie)
  {
  ...
  public void run()
  {
    ...
    if (localObject == null)
    {
      bool = this.a.w();
      this.a.v();
      if ((bool) && (TextUtils.isEmpty(this.a.ax)) && (localPublicAccountDataManager != null))
      {
        ...
        if ((localObject != null) && (!TextUtils.isEmpty(((AccountDetail)localObject).summary))) {
          this.a.ax = ((AccountDetail)localObject).summary;
        }
      }
    }
    for (;;)
    {
      ...
      {
        ReportController.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8004EFB", "0X8004EFB", 0, 0, "", "", "", "");
        this.a.K = true;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\obz.class
