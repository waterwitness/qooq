  ...
  implements Runnable
{
  ...
  public pzt(QQAppInterface paramQQAppInterface, Context paramContext, int paramInt)
  {
  ...
  public void run()
  {
    for (;;)
    {
      ...
      try
      {
        boolean bool = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.k;
        if (bool) {
          return;
        }
      ...
      Object localObject3 = ((SharedPreferences)localObject2).edit();
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\pzt.class
