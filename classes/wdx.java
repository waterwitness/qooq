  ...
  extends Handler
{
  ...
  public wdx(HttpCommunicator paramHttpCommunicator, Looper paramLooper)
  {
    super(paramLooper);
  ...
  public void a()
  {
    try
    {
      ...
      {
        this.jdField_a_of_type_ComTencentMobileqqUtilsHttputilsHttpCommunicator.a(this.jdField_a_of_type_ComTencentMobileqqUtilsHttputilsHttpMsg, "requeustInterupt", "msgId:" + this.jdField_a_of_type_ComTencentMobileqqUtilsHttputilsHttpMsg.ai + " thread id:" + this.jdField_a_of_type_Int);
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\wdx.class
