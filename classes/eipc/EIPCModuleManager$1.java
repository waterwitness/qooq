    ...
    throws RemoteException
  {
    ...
    for (;;)
    {
      synchronized (this.g.k)
      {
        ...
        {
          EIPCModuleManager.a().post(new EIPCModuleManager.1.1(this, localEIPCModule1, paramString2, paramBundle, 1000000 * paramInt2 + paramInt1));
          return null;
        }
      }
      if (QLog.isColorLevel()) {
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\eipc\EIPCModuleManager$1.class
