...
abstract class EIPCModuleManager
{
  ...
  public void removeCallback(EIPCResultCallback paramEIPCResultCallback)
  {
    if (paramEIPCResultCallback != null)
    {
      int m = this.mCallbackMap.indexOfValue(paramEIPCResultCallback);
      if (m != -1) {
        this.mCallbackMap.remove(this.mCallbackMap.keyAt(m));
      }
    }
  }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\eipc\EIPCModuleManager.class
