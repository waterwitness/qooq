...
public class t
{
  ...
  public static c ah = null;
  protected static String ai = "";
  static report_t1 aj = new report_t1();
  public static long ak = 0L;
  public static TreeMap<Long, async_context> al = new TreeMap();
  ...
  public static async_context b(long paramLong)
  {
    for (;;)
    {
      synchronized (an)
      {
        async_context localasync_context2 = (async_context)al.get(Long.valueOf(paramLong));
        if (localasync_context2 == null)
        {
          for (;;)
          {
            ...
            try
            {
              al.put(Long.valueOf(paramLong), localasync_context1);
  ...
  public static void c(long paramLong)
  {
    synchronized (an)
    {
      try
      {
        al.remove(Long.valueOf(paramLong));
        return;
      }
  ...
  public static String l()
  {
    ...
    try
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        {
          ai = localRunningAppProcessInfo.processName;
          localObject = ai;
  ...
  public int a(long paramLong1, long paramLong2, long paramLong3, long paramLong4, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2)
  {
    try
    {
      int i1 = ah.a(paramLong1, paramLong2, paramLong3, paramLong4, paramArrayOfByte1, paramArrayOfByte2);
      return i1;
    }
    finally
    {
  ...
  public int a(long paramLong1, long paramLong2, byte[] paramArrayOfByte)
  {
    try
    {
      int i1 = ah.a(paramLong1, paramLong2, paramArrayOfByte);
      return i1;
    }
    finally
    {
  ...
  public WloginSigInfo a(long paramLong1, long paramLong2)
  {
    try
    {
      ...
      WloginSigInfo localWloginSigInfo = ah.c(paramLong1, paramLong2);
  ...
  public void a(String paramString, Long paramLong)
  {
    try
    {
      ah.a(paramString, paramLong, true);
      return;
    }
    finally
    {
  ...
  public void a(String paramString, Long paramLong, boolean paramBoolean)
  {
    try
    {
      ah.a(paramString, paramLong, paramBoolean);
      return;
    }
    finally
    {
  ...
  public int b(long paramLong1, long paramLong2)
  {
    try
    {
      int i1 = ah.a(paramLong1, paramLong2);
      return i1;
    }
    finally
    {
  ...
  public long b(String paramString)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: getstatic 190	oicq/wlogin_sdk/request/t:ah	Loicq/wlogin_sdk/request/c;
    //   5: aload_1
    //   6: iconst_1
    //   7: invokevirtual 593	oicq/wlogin_sdk/request/c:a	(Ljava/lang/String;Z)Loicq/wlogin_sdk/request/UinInfo;
    //   10: astore_1
    //   11: aload_1
    //   12: ifnull +15 -> 27
    //   15: aload_1
    //   16: getfield 599	oicq/wlogin_sdk/request/UinInfo:_uin	Ljava/lang/Long;
    //   19: invokevirtual 602	java/lang/Long:longValue	()J
    //   22: lstore_2
    //   23: aload_0
    //   24: monitorexit
    //   25: lload_2
  ...
  public UinInfo c(String paramString)
  {
    try
    {
      paramString = ah.a(paramString, false);
      return paramString;
    }
    finally
    {
  ...
  public WloginSimpleInfo d(long paramLong)
  {
    try
    {
      WloginSimpleInfo localWloginSimpleInfo = ah.b(paramLong);
  ...
  public void d(long paramLong1, long paramLong2)
  {
    try
    {
      ah.a(Long.valueOf(paramLong1), Long.valueOf(paramLong2));
      return;
    }
    finally
    {
  ...
  public String e(long paramLong)
  {
    try
    {
      String str = ah.a(Long.valueOf(paramLong));
      return str;
    }
    finally
    {
  ...
  public void h()
  {
    ...
    try
    {
      util.LOGD("close_connect", this.af.toString());
      this.af.close();
      this.af = null;
      return;
    }
  ...
  public void i()
  {
    ...
    try
    {
      util.LOGD("close_transport_connect", this.ag.toString());
      this.ag.close();
      this.ag = null;
      return;
    }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\oicq\wlogin_sdk\request\t.class
