  ...
  extends oicq_request
{
  ...
  public int a(long paramLong1, long paramLong2, long paramLong3, int paramInt1, int paramInt2, byte[] paramArrayOfByte1, int paramInt3, int paramInt4, long[] paramArrayOfLong, byte[] paramArrayOfByte2, WUserSigInfo paramWUserSigInfo)
  {
    ...
    for (;;)
    {
      a(this.h, this.t, this.i, paramLong1, this.l, this.m, j, this.o, a(paramLong1, paramLong2, paramLong3, j, paramInt2, paramArrayOfByte1, paramInt3, paramInt4, paramArrayOfLong, t.Y, paramArrayOfByte2, paramWUserSigInfo._domains));
  ...
  public byte[] a(long paramLong1, long paramLong2, long paramLong3, int paramInt1, int paramInt2, byte[] paramArrayOfByte1, int paramInt3, int paramInt4, long[] paramArrayOfLong, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, List<String> paramList)
  {
    ...
    localObject12 = ((av)localObject12).b(this.x.i);
    ...
    localObject18 = ((bj)localObject18).a(1472635589L, "6.3.1.1668");
    byte[] arrayOfByte = new byte[0];
    if ((paramArrayOfByte2 != null) && (paramArrayOfByte2.length > 0)) {
      paramArrayOfByte1 = ((j)localObject22).a(paramArrayOfByte2);
    }
    for (paramInt1 = 11;; paramInt1 = 10)
    {
      ...
      for (;;)
      {
        ...
        {
          paramArrayOfByte2 = ((bg)localObject20).a(this.x.p);
          paramInt1 += 1;
        }
        for (;;)
        {
              ...
              for (;;)
              {
                ...
                for (;;)
                {
                  ...
                  for (;;)
                  {
                    ...
                    localObject21 = t.A;
                    localObject22 = t.D;
                    localObject9 = localan.a((byte[])localObject16, ((ab)localObject9).a((byte[])localObject19, (byte[])localObject20, paramInt2, (byte[])localObject21, new byte[0], (byte[])localObject22), localaf.a(t.R, t.S, t.T, t.W, t.G, t.y, t.N), localbe.a(t.G), this.x.b);
                    ...
                    {
                      paramArrayOfByte3 = localq.a(this.x.g.getBytes());
                      paramInt1 += 1;
                    }
                    for (;;)
                    {
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\oicq\wlogin_sdk\request\m.class
