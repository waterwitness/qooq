...
public class h
{
  ...
  byte[] a(int paramInt)
  {
    Object localObject1 = ByteBuffer.allocate("6.3.1.1668".length() + 24 + 2 + 2 + 1 + 4);
    ...
    ((ByteBuffer)localObject1).putShort((short)"6.3.1.1668".length());
    ((ByteBuffer)localObject1).put("6.3.1.1668".getBytes());
    ...
    for (int i = 1;; i = 0)
    {
      ...
      ByteBuffer localByteBuffer = ByteBuffer.allocate(((ByteBuffer)localObject1).capacity() + 4 + 4 + (co.j.length + 4) + 8 + localObject2.length);
  ...
  int b(int paramInt)
  {
    ...
    //   7: aload_0
    //   8: iload_1
    //   9: invokevirtual 245	oicq/wlogin_sdk/request/h:a	(I)[B
    //   12: astore 4
    //   14: aload_3
    //   15: astore_2
    ...
    //   25: aload_3
    //   26: astore_2
    //   27: invokestatic 251	java/lang/Math:random	()D
    //   30: ldc2_w 252
    //   33: dmul
    //   34: invokestatic 257	java/lang/Math:round	(D)J
    //   37: l2i
    //   38: istore_1
    //   39: aload_3
    //   40: astore_2
    ...
    //   116: invokespecial 273	java/net/URL:<init>	(Ljava/lang/String;)V
    //   119: invokevirtual 277	java/net/URL:openConnection	()Ljava/net/URLConnection;
    //   122: checkcast 279	java/net/HttpURLConnection
    //   125: astore_3
    //   126: aload_3
    //   127: ldc_w 281
    //   130: invokevirtual 284	java/net/HttpURLConnection:setRequestMethod	(Ljava/lang/String;)V
    //   133: aload_3
    //   134: ldc_w 286
    ...
    //   158: invokevirtual 289	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   161: aload_3
    //   162: ldc_w 291
    //   165: ldc_w 293
    //   168: invokevirtual 289	java/net/HttpURLConnection:setRequestProperty	(Ljava/lang/String;Ljava/lang/String;)V
    //   171: aload_3
    //   172: getstatic 296	oicq/wlogin_sdk/b/co:i	I
    //   175: invokevirtual 299	java/net/HttpURLConnection:setConnectTimeout	(I)V
    //   178: aload_3
    //   179: getstatic 296	oicq/wlogin_sdk/b/co:i	I
    //   182: invokevirtual 302	java/net/HttpURLConnection:setReadTimeout	(I)V
    //   185: aload_3
    //   186: iconst_1
    //   187: invokevirtual 306	java/net/HttpURLConnection:setDoOutput	(Z)V
    //   190: aload_3
    //   191: iconst_1
    //   192: invokevirtual 309	java/net/HttpURLConnection:setDoInput	(Z)V
    //   195: aload_3
    //   196: aload_0
    //   197: getfield 18	oicq/wlogin_sdk/request/h:a	Loicq/wlogin_sdk/request/t;
    //   200: getfield 312	oicq/wlogin_sdk/request/t:l	I
    //   203: i2l
    //   204: invokestatic 317	oicq/wlogin_sdk/request/i:a	(Ljava/net/HttpURLConnection;J)Z
    //   207: ifne +46 -> 253
    //   210: ldc_w 319
    ...
    //   225: aload_0
    //   226: getfield 18	oicq/wlogin_sdk/request/h:a	Loicq/wlogin_sdk/request/t;
    ...
    //   242: ifnull +7 -> 249
    //   245: aload_3
    //   246: invokevirtual 322	java/net/HttpURLConnection:disconnect	()V
    //   249: sipush 64536
    //   252: ireturn
    //   253: aload_3
    //   254: invokevirtual 326	java/net/HttpURLConnection:getOutputStream	()Ljava/io/OutputStream;
    //   257: astore_2
    //   258: aload_2
    //   259: aload 4
    //   261: invokevirtual 331	java/io/OutputStream:write	([B)V
    //   264: aload_2
    //   265: invokevirtual 334	java/io/OutputStream:close	()V
    //   268: aload_3
    //   269: invokevirtual 337	java/net/HttpURLConnection:getResponseCode	()I
    //   272: istore_1
    ...
    //   305: aload_0
    //   306: getfield 18	oicq/wlogin_sdk/request/h:a	Loicq/wlogin_sdk/request/t;
    ...
    //   329: ifnull +7 -> 336
    //   332: aload_3
    //   333: invokevirtual 322	java/net/HttpURLConnection:disconnect	()V
    //   336: sipush 64536
    //   339: ireturn
    //   340: ldc_w 341
    ...
    //   355: aload_0
    //   356: getfield 18	oicq/wlogin_sdk/request/h:a	Loicq/wlogin_sdk/request/t;
    ...
    //   371: aload_3
    //   372: invokevirtual 345	java/net/HttpURLConnection:getInputStream	()Ljava/io/InputStream;
    //   375: astore_2
    //   376: new 347	java/io/ByteArrayOutputStream
    //   379: dup
    //   380: invokespecial 348	java/io/ByteArrayOutputStream:<init>	()V
    //   383: astore 4
    //   385: sipush 1024
    //   388: newarray <illegal type>
    //   390: astore 5
    //   392: aload_2
    //   393: aload 5
    //   395: invokevirtual 353	java/io/InputStream:read	([B)I
    //   398: istore_1
    //   399: iload_1
    //   400: iconst_m1
    ...
    //   408: iconst_0
    //   409: iload_1
    //   410: invokevirtual 356	java/io/ByteArrayOutputStream:write	([BII)V
    //   413: goto -21 -> 392
    //   416: astore 4
    //   418: aload_3
    //   419: astore_2
    ...
    //   426: ifnull +7 -> 433
    //   429: aload_3
    //   430: invokevirtual 322	java/net/HttpURLConnection:disconnect	()V
    //   433: sipush 64536
    //   436: ireturn
    //   437: aload_0
    //   438: aload 4
    //   440: invokevirtual 359	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   443: invokevirtual 361	oicq/wlogin_sdk/request/h:a	([B)I
    //   446: sipush 64536
    //   449: if_icmpeq +26 -> 475
    //   452: iconst_1
    //   453: istore_1
    //   454: aload 4
    //   456: invokevirtual 362	java/io/ByteArrayOutputStream:close	()V
    //   459: iload_1
    //   460: ifne +20 -> 480
    //   463: aload_3
    //   464: ifnull +7 -> 471
    //   467: aload_3
    //   468: invokevirtual 322	java/net/HttpURLConnection:disconnect	()V
    //   471: sipush 64536
    //   474: ireturn
    //   475: iconst_0
    //   476: istore_1
    ...
    //   481: ifnull +7 -> 488
    //   484: aload_3
    //   485: invokevirtual 322	java/net/HttpURLConnection:disconnect	()V
    //   488: sipush 257
    //   491: ireturn
    //   492: astore 4
    //   494: aload_2
    ...
    //   500: ifnull +7 -> 507
    //   503: aload_3
    //   504: invokevirtual 322	java/net/HttpURLConnection:disconnect	()V
    //   507: aload_2
    //   508: athrow
    //   509: astore_2
    //   510: goto -11 -> 499
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\oicq\wlogin_sdk\request\h.class
