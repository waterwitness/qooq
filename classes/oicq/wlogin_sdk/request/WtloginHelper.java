  ...
  extends WtloginListener
{
  ...
  private int mMiscBitmap = 1572732;
  ...
  private int CheckPictureAndGetSt(String paramString, byte[] paramArrayOfByte, WUserSigInfo paramWUserSigInfo, byte[][] paramArrayOfByte1, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      label343:
      t.aj.commit_t2(localt.f, localt.g, util.format_ret_code(paramInt), paramInt);
      if (paramInt != 0) {
        break label1354;
      }
  ...
  {
    oicq.wlogin_sdk.a.h.w = false;
    oicq.wlogin_sdk.a.h.x = 0L;
  ...
  private byte[] GetA1ByAccount(String paramString, long paramLong)
  {
    ...
    while ((localObject == null) || (((WloginSigInfo)localObject)._en_A1 == null) || (((WloginSigInfo)localObject)._en_A1.length <= 0))
    {
  ...
  private int GetA1WithA1(String paramString, long paramLong1, long paramLong2, int paramInt1, byte[] paramArrayOfByte1, long paramLong3, long paramLong4, long paramLong5, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, WUserSigInfo paramWUserSigInfo, WFastLoginInfo paramWFastLoginInfo, int paramInt2)
  {
    ...
    t.aj.add_t2(new report_t2("login", new String(t.A), System.currentTimeMillis(), paramLong4, paramLong5, null));
    long l1;
    if (!util.check_uin_account(paramString).booleanValue())
    {
      long l2 = localt.b(paramString);
    ...
    for (;;)
    {
      t.aj.commit_t2(localt.f, localt.g, util.format_ret_code(paramInt1), paramInt1);
      if (paramInt1 == 0) {
  ...
  private int GetFastLoginInfo(byte[] paramArrayOfByte, async_context paramasync_context)
  {
    ...
    paramasync_context._tmp_pwd = oicq_request.b(localh.b(), localn.b());
  ...
  private byte[] GetNoPicSigByAccount(String paramString, long paramLong)
  {
    ...
    while ((localObject == null) || (((WloginSigInfo)localObject)._noPicSig == null) || (((WloginSigInfo)localObject)._noPicSig.length <= 0))
    {
  ...
  private int GetStWithPasswd(String paramString1, long paramLong1, int paramInt1, long paramLong2, long[] paramArrayOfLong, boolean paramBoolean1, String paramString2, WUserSigInfo paramWUserSigInfo, byte[][] paramArrayOfByte, boolean paramBoolean2, int paramInt2)
  {
    ...
    long l2;
    long l1;
    if ((paramBoolean2) && (!oicq.wlogin_sdk.a.h.w))
    {
      if (paramWUserSigInfo._seqence == 0L) {
        paramWUserSigInfo._seqence = this.mAysncSeq;
      }
      ...
      util.LOGI("start GetStWithPasswd:user:" + paramString1 + " dwAppid:" + paramLong1 + " dwMainSigMap:" + Integer.toHexString(j) + " dwSubAppid:" + paramLong2 + " Seq:" + localt.h + " ...", paramString1);
      ...
      t.aj.add_t2(new report_t2("login", new String(t.A), System.currentTimeMillis(), paramLong1, paramLong2, paramArrayOfLong));
    ...
    for (;;)
    {
      ...
      t.b();
      localt.h();
      util.LOGI("end GetStWithPasswd:user:" + paramString1 + " dwAppid:" + paramLong1 + " dwMainSigMap:" + Integer.toHexString(j) + " dwSubAppid:" + paramLong2 + " Seq:" + localt.h + " ret=" + paramInt1, "" + localt.f);
      return paramInt1;
      localt = this.mG.a(0L);
      paramWUserSigInfo._seqence = localt.h;
    ...
    for (;;)
    {
      ...
      if (oicq.wlogin_sdk.a.h.x != 0L)
      {
        localasync_context._msalt = oicq.wlogin_sdk.a.h.x;
        oicq.wlogin_sdk.a.h.x = 0L;
      }
      localt.f = l1;
      paramWUserSigInfo.uin = ("" + l1);
  ...
  private int GetStWithoutPasswd(String paramString, long paramLong1, long paramLong2, long paramLong3, int paramInt1, long paramLong4, long[] paramArrayOfLong, WUserSigInfo paramWUserSigInfo, byte[][] paramArrayOfByte1, byte[][] paramArrayOfByte2, int paramInt2, WtTicketPromise paramWtTicketPromise)
  {
    ...
    util.LOGI("start GetStWithoutPasswd:user:" + paramString + " dwSrcAppid:" + paramLong1 + " dwDstAppid:" + paramLong2 + " dwDstAppPri:" + paramLong3 + " dwMainSigMap:" + Integer.toHexString(i) + " dwSubDstAppid:" + paramLong4 + " Seq:" + paramWtTicketPromise.h, paramString);
    paramInt1 = util.get_saved_network_type(this.mContext);
    t.B = util.get_network_type(this.mContext);
    if (paramInt1 != t.B)
    {
    ...
    if ((paramWUserSigInfo._reserveData != null) && (paramWUserSigInfo._reserveData.length > 3))
    {
      ...
      t.aj.add_t2(new report_t2("exchg", new String(t.A), System.currentTimeMillis(), paramLong2, paramLong4, paramArrayOfLong));
      if (util.check_uin_account(paramString).booleanValue()) {
        break label779;
      }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        t.aj.commit_t2(paramWtTicketPromise.f, paramWtTicketPromise.g, util.format_ret_code(paramInt1), paramInt1);
        if (paramInt1 == 0) {
          if ((paramArrayOfLong._sig != null) && (paramArrayOfLong._sig.length != 0)) {
        ...
        for (;;)
        {
          ...
          util.LOGI("end GetStWithoutPasswd:user:" + paramString + " dwSrcAppid:" + paramLong1 + " dwDstAppid:" + paramLong2 + " dwDstAppPri:" + paramLong3 + " dwMainSigMap:" + Integer.toHexString(i) + " dwSubDstAppid:" + paramLong4 + " Seq:" + paramWtTicketPromise.h + " ret=" + paramInt1, "" + paramWtTicketPromise.f);
          return paramInt1;
  ...
  public static Ticket GetUserSigInfoTicket(WUserSigInfo paramWUserSigInfo, int paramInt)
  {
    ...
    util.LOGI("GetUserSigInfoTicket ticket type:" + Integer.toHexString(paramInt), "");
    if (paramWUserSigInfo._tickets != null)
    {
      int i = 0;
      while (i < paramWUserSigInfo._tickets.size())
      {
        ...
        {
          util.LOGI("GetUserSigInfoTicket type:" + Integer.toHexString(paramInt) + " sig:" + util.buf_len(localTicket._sig) + " key:" + util.buf_len(localTicket._sig_key) + " create time:" + localTicket._create_time + " expire time:" + localTicket._expire_time, "");
          return localTicket;
        }
        i += 1;
      }
  ...
  private void OnRequestRegister(String paramString, long paramLong1, long paramLong2, TransReqContext paramTransReqContext, WUserSigInfo paramWUserSigInfo, int paramInt)
  {
    ...
    do
    {
      ...
      default: 
        ...
        this.mListener.OnRegError(paramWUserSigInfo, 64526, str.getBytes());
        return;
      case 10: 
        ...
        if (localh.d == 2)
        {
          this.mListener.OnRegCheckUploadMsg(paramWUserSigInfo, new String(localh.p));
          return;
        }
        if (localh.d == 3)
        {
          this.mListener.OnRegCheckValidUrl(paramWUserSigInfo, localh.q);
          return;
        }
        if ((localh.d == 6) || (localh.d == 44))
        {
          this.mListener.OnRegCheckWebSig(paramWUserSigInfo, new String(localh.q), new String(localh.f));
          localh.q = new byte[0];
          return;
        }
      ...
      case 3: 
        ...
        {
          this.mListener.OnRegQueryClientSentMsgStatus(paramWUserSigInfo, localh.d, localh.r, localh.s, new String(localh.f));
          return;
        }
        if (localh.d == 3)
        {
      ...
      case 4: 
        ...
        if (localh.d == 0)
        {
          this.mListener.OnRegRequestServerResendMsg(paramWUserSigInfo, localh.d, localh.r, localh.s);
          return;
        }
        if (localh.d == 3)
        {
      ...
      case 6: 
        ...
        for (localh.b = localh.b.substring(paramInt + 1);; localh.b = ("00" + paramString + localh.b.substring(paramInt + 1)))
        {
          ...
          {
            this.mG.d(localh.b);
            this.mG.a(localh.b, Long.valueOf(localh.t));
          }
          util.LOGI("reg userAccount: " + localh.b, localh.t + "");
          if (oicq.wlogin_sdk.a.h.y.length() <= 0) {
            break;
          }
          this.mListener.OnRegGetSMSVerifyLoginAccount(paramWUserSigInfo, localh.d, localh.t, localh.u, localh.v, localh.f);
          return;
        }
        this.mListener.OnRegGetAccount(paramWUserSigInfo, localh.d, localh.t, localh.u, localh.v, localh.f);
        return;
      }
  ...
  private int RequestInit()
  {
    try
    {
      ...
      int j = ShareKeyInit();
      AsyncGenRSAKey();
      util.LOGI("WtloginHelper init ok, ret:" + j + " android version:" + new String(t.H) + " saved_network_type:" + i + " network_type:" + t.B + " release time:" + util.get_release_time() + " svn verion:" + 1668L + " at " + t.l(), "");
      return j;
    }
    finally {}
  }
  ...
  private int ShareKeyInitBC()
  {
    ...
    {
      util.LOGW("create key pair and shared key failed ExceptionInInitializerError, " + localExceptionInInitializerError.getStackTrace(), "");
      t.aj.attr_api(2368735);
      return -6;
    }
  ...
  public int CheckDevLockSms(String paramString1, long paramLong1, long paramLong2, String paramString2, byte[] paramArrayOfByte, WUserSigInfo paramWUserSigInfo)
  {
    ...
    byte[] arrayOfByte2 = "6.3.1.1668".getBytes();
  ...
  public int CheckDevLockStatus(String paramString, long paramLong1, long paramLong2, WUserSigInfo paramWUserSigInfo)
  {
    ...
    localTransReqContext._body = locala.a(l, paramLong1, paramLong2, ((WloginSigInfo)localObject)._TGT, t.y, t.C, "6.3.1.1668".getBytes(), t.I, t.H);
    if ((localTransReqContext._body == null) || (localTransReqContext._body.length == 0)) {
      return 64519;
    }
  ...
  public Boolean ClearUserLoginData(String paramString, long paramLong)
  {
    ...
    //   47: ifgt +8 -> 55
    //   50: iconst_1
    //   51: invokestatic 1908	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   54: areturn
    //   55: aload_0
    //   56: monitorenter
    //   57: aload_1
    ...
    //   97: lload 5
    //   99: lload_2
    //   100: invokevirtual 1910	oicq/wlogin_sdk/request/t:d	(JJ)V
    //   103: aload_0
    //   104: monitorexit
    //   105: iconst_0
    //   106: newarray <illegal type>
    //   108: putstatic 816	oicq/wlogin_sdk/sharemem/WloginSigInfo:_QRPUSHSig	[B
    //   111: iconst_0
    //   112: newarray <illegal type>
    //   114: putstatic 807	oicq/wlogin_sdk/sharemem/WloginSigInfo:_LHSig	[B
    //   117: iconst_1
    //   118: invokestatic 1908	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   121: areturn
    //   122: aload_0
    //   123: getfield 52	oicq/wlogin_sdk/request/WtloginHelper:mG	Loicq/wlogin_sdk/request/t;
    //   126: aload_1
    //   127: invokevirtual 1271	oicq/wlogin_sdk/request/t:d	(Ljava/lang/String;)V
    //   130: iconst_1
    //   131: istore 4
    //   133: goto -46 -> 87
    //   136: aload_1
  ...
  public int CloseCode(String paramString, long paramLong, byte[] paramArrayOfByte, int paramInt, List<byte[]> paramList, WUserSigInfo paramWUserSigInfo)
  {
    ...
    localTransReqContext._body = locala.a(l, paramLong, 1L, paramArrayOfByte, ((WloginSigInfo)localObject)._userStSig, t.y, paramInt, paramList, ((WloginSigInfo)localObject)._en_A1, ((WloginSigInfo)localObject)._noPicSig, this.mMiscBitmap, 0L);
  ...
  public int CloseDevLock(String paramString, long paramLong1, long paramLong2, WUserSigInfo paramWUserSigInfo)
  {
    ...
    localTransReqContext._body = localb.a(l, paramLong1, paramLong2, localWloginSigInfo._TGT, t.y, t.C, "6.3.1.1668".getBytes(), "android".getBytes(), ((String)localObject).getBytes());
    if ((localTransReqContext._body == null) || (localTransReqContext._body.length == 0)) {
      return 64519;
    }
  ...
  {
    util.LOGI("GetLocalTicket appid=" + paramLong + " account " + paramString);
    if (paramString == null)
    {
      util.LOGI("userAccount null", "");
      return null;
  ...
  public int GetStViaSMSVerifyLogin(String paramString, long paramLong1, long paramLong2, int paramInt, WUserSigInfo paramWUserSigInfo)
  {
    ...
    if (oicq.wlogin_sdk.a.h.w) {}
    for (String str = oicq.wlogin_sdk.a.h.y;; str = "") {
  ...
  public Ticket GetTicket(String paramString, long paramLong, int paramInt, WtTicketPromise paramWtTicketPromise, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        util.LOGI("GetTicket sigType:" + Integer.toHexString(paramInt) + " expires in " + (localTicket._expire_time - l) / 60L / 60L + "h", "");
        localObject1 = localTicket;
  ...
  public int RegGetSMSVerifyLoginAccount(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, WUserSigInfo paramWUserSigInfo)
  {
    ...
    for (localh.j = ((byte[])paramArrayOfByte1.clone());; localh.j = new byte[0])
    {
      oicq.wlogin_sdk.a.h.w = true;
      oicq.wlogin_sdk.a.h.y = util.get_mpasswd();
      localTransReqContext.set_register_req();
      localTransReqContext.set_subcmd(localb.a());
      localTransReqContext._body = localb.a(localh.e, paramArrayOfByte1, oicq.wlogin_sdk.a.h.y.getBytes(), paramArrayOfByte3, 1, localh.b.getBytes(), paramArrayOfByte2, true, GetGuid(), localh.h, t.C, t.x);
      return RequestTransport(0, 1, null, 0L, localh.i, localTransReqContext, paramWUserSigInfo);
    }
  }
  ...
  public int VerifyCode(String paramString, long paramLong, boolean paramBoolean, byte[] paramArrayOfByte, int[] paramArrayOfInt, int paramInt, WUserSigInfo paramWUserSigInfo)
  {
    ...
    ((TransReqContext)localObject3)._body = ((oicq.wlogin_sdk.code2d.e)localObject2).a(l, paramLong, paramBoolean, paramArrayOfByte, paramArrayOfInt, localWloginSigInfo._userStSig, t.y, t.C, paramInt, (byte[])localObject1);
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\oicq\wlogin_sdk\request\WtloginHelper.class
