  ...
  implements Runnable
{
  ...
  private int sendRPCData(byte[] arg1, int paramInt)
  {
    ...
    try
    {
      ...
      int i = Integer.valueOf(localClass1.getMethod("sendRPCData", new Class[] { Long.TYPE, String.class, String.class, byte[].class, Integer.TYPE }).invoke(TicketMgr, new Object[] { Long.valueOf(l), this.uin, this.serviceCmd, ???.clone(), Integer.valueOf(paramInt) }).toString()).intValue();
      paramInt = i;
      if (i == 0) {
        paramInt = 99;
      }
  ...
  public int SendData(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        int i = Integer.valueOf(((Class)localObject).getMethod("sendData", new Class[] { WUserSigInfo.class, String.class, String.class, byte[].class, Integer.TYPE, Boolean.TYPE, WtloginMsfListener.class }).invoke(localObject, new Object[] { this.userSigInfo, this.uin, this.serviceCmd, paramArrayOfByte.clone(), Integer.valueOf(paramInt), Boolean.valueOf(this.flag), this }).toString()).intValue();
        paramInt = i;
        if (i > 0)
        {
          this.semp.acquire();
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\oicq\wlogin_sdk\request\WtloginMsfListener.class
