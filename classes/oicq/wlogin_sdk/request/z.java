  ...
  extends oicq_request
{
  ...
  public int a(long paramLong1, TransReqContext paramTransReqContext, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, long paramLong2, long paramLong3, WUserSigInfo paramWUserSigInfo)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        k = 0;
        j = 0;
        localObject = paramTransReqContext._body;
        ...
        if ((TransReqContext.EncryptMethod.EM_ST == paramTransReqContext.encryptMethod) && (paramTransReqContext.wtSessionTicket != null) && (paramTransReqContext.wtSessionTicket.length > 0))
        {
          boolean bool;
          if (paramArrayOfByte1 != null)
          {
            bool = true;
            a(paramLong1, a((byte[])localObject, bool, paramArrayOfByte1, paramLong2, paramLong3, paramTransReqContext));
        ...
        else
        {
          if (TransReqContext.EncryptMethod.EM_ST == paramTransReqContext.encryptMethod) {
            t.aj.attr_api(2413503);
          }
          localObject = a((byte[])localObject, paramArrayOfByte1, paramLong2, paramLong3, 0);
          a(this.h, this.t, this.i, paramLong1, this.l, this.m, m, this.o, (byte[])localObject);
          paramTransReqContext.encryptMethod = TransReqContext.EncryptMethod.EM_ECDH;
          continue;
        }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (arrayOfByte2 == null)
        {
          ...
          a(this.h, this.t, this.i, paramLong1, this.l, this.m, i, this.o, paramArrayOfByte3);
  ...
  public int a(long paramLong1, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, long paramLong2, WUserSigInfo paramWUserSigInfo)
  {
    for (;;)
    {
      try
      {
        ...
        long l1 = System.currentTimeMillis() / 1000L;
        long l2 = t.aa;
        t.aj.commit(Build.VERSION.RELEASE, new String(t.E), "", util.buf_to_string(util.get_ksid(t.r)), new String(t.C), new String(t.O), new String(t.G), new String(t.F), util.get_release_time(), "6.3.1.1668");
        try
        {
          paramArrayOfByte1 = t.aj.toJasonObj().toString().getBytes();
          if (paramArrayOfByte1 != null)
          {
        ...
        a(this.h, this.t, this.i, paramLong1, this.l, this.m, i, this.o, paramArrayOfByte1);
        i = a(String.valueOf(paramLong1), true, paramWUserSigInfo);
        if (i != 0)
        {
          if (i == 0) {
          ...
          report_t.write_tofile(t.aj, t.r);
          continue;
        }
        i = b();
      }
  ...
  public int a(TransReqContext paramTransReqContext)
  {
    ...
    this.f = (j - this.e - 2);
    if (paramTransReqContext.encryptMethod == TransReqContext.EncryptMethod.EM_ECDH) {
      if (this.x.m == 0)
      {
        j = a(this.g, this.e + 1, this.f, this.x.o);
        i = j;
        if (j < 0)
        {
          util.LOGI("use ecdh decrypt_body failed");
          j = a(this.g, this.e + 1, this.f, this.x.c);
          i = j;
          if (j < 0)
          {
    ...
    for (;;)
    {
      ...
      if (j < 0)
      {
        ...
        i = j;
        continue;
        if (paramTransReqContext.encryptMethod == TransReqContext.EncryptMethod.EM_ST)
        {
          j = a(this.g, this.e + 1, this.f, paramTransReqContext.wtSessionTicketKey);
          i = j;
          if (j < 0)
          {
  ...
  public int a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, TransReqContext paramTransReqContext)
  {
    ...
    {
      this.x.m = 2;
      this.x.p = paramTransReqContext.b();
  ...
  public byte[] a(byte[] paramArrayOfByte1, boolean paramBoolean, byte[] paramArrayOfByte2, long paramLong1, long paramLong2, TransReqContext paramTransReqContext)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      if (this.x.p != null)
      {
        ...
        {
          arrayOfByte2 = new bg().a(this.x.p);
      ...
      this.E = (arrayOfByte1.length + 13 + 1 + paramArrayOfByte2.length);
      arrayOfByte2 = new byte[paramArrayOfByte1.length + this.E];
      ...
      return a(arrayOfByte2, paramTransReqContext);
    }
  }
  ...
  public byte[] a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, long paramLong1, long paramLong2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      this.E = (paramArrayOfByte2.length + 13 + 1 + arrayOfByte1.length);
      arrayOfByte2 = new byte[paramArrayOfByte1.length + this.E];
  ...
  {
    if (this.x.ag != null) {
      util.LOGD("_transport_sk", "_transport_sk" + this.x.ag.toString());
    }
    for (;;)
    {
      return this.x.ag;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\oicq\wlogin_sdk\request\z.class
