  ...
  extends oicq_request
{
  ...
  public int a(long paramLong1, int paramInt1, long paramLong2, int paramInt2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt3, int paramInt4, long[] paramArrayOfLong, int paramInt5, long paramLong3, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, byte[] paramArrayOfByte4, long paramLong4, WUserSigInfo paramWUserSigInfo)
  {
    ...
    for (;;)
    {
      a(this.h, this.t, this.i, paramLong2, this.l, this.m, i, this.o, a(paramLong1, i, paramLong2, paramInt2, paramArrayOfByte1, paramArrayOfByte2, paramArrayOfByte3, paramInt3, paramInt4, paramArrayOfLong, paramInt5, paramLong3, i, paramInt7, paramInt8, paramInt9, paramInt10, paramArrayOfByte4, paramLong4, t.C, paramWUserSigInfo._domains));
  ...
  public byte[] a(long paramLong1, int paramInt1, long paramLong2, int paramInt2, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt3, int paramInt4, long[] paramArrayOfLong, int paramInt5, long paramLong3, int paramInt6, int paramInt7, int paramInt8, int paramInt9, int paramInt10, byte[] paramArrayOfByte4, long paramLong4, byte[] paramArrayOfByte5, List<String> paramList)
  {
    ...
    Object localObject7 = new a(1302);
    Object localObject10 = this.x.a(paramLong2, paramLong4);
    ...
    localObject15 = ((av)localObject15).b(this.x.i);
    ...
    localObject19 = ((bj)localObject19).a(1472635589L, "6.3.1.1668");
    if ((paramArrayOfByte4 != null) && (paramArrayOfByte4.length > 0)) {
      paramArrayOfByte1 = ((j)localObject26).a(paramArrayOfByte4);
    }
    for (paramInt1 = 13;; paramInt1 = 12)
    {
      ...
      for (;;)
      {
        ...
        {
          paramArrayOfLong = ((bg)localObject24).a(this.x.p);
          paramInt1 += 1;
        }
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            for (;;)
            {
              ...
              for (;;)
              {
                ...
                {
                  localObject3 = ((ch)localObject3).a(k.F, k.G, "qq".getBytes(), k.H);
                  paramInt1 += 1;
                }
                for (;;)
                {
                  ...
                  for (;;)
                  {
                    ...
                    localObject25 = t.A;
                    localObject26 = t.D;
                    localObject21 = localan.a((byte[])localObject22, ((ab)localObject21).a((byte[])localObject23, (byte[])localObject24, paramInt2, (byte[])localObject25, new byte[0], (byte[])localObject26), localaf.a(t.R, t.S, t.T, t.W, t.G, t.y, t.N), localbe.a(t.G), t.b(this.x.h)._tgtgt_key);
                    localObject20 = ((al)localObject20).a(paramArrayOfByte5);
                    paramInt1 = paramInt1 + 1 + 1;
                    if ((this.x.g != null) && (!util.check_uin_account(this.x.g).booleanValue()))
                    {
                      paramArrayOfByte5 = localq.a(this.x.g.getBytes());
                      paramInt1 += 1;
                    }
                    for (;;)
                    {
                      ...
                      for (;;)
                      {
                        ...
                        for (;;)
                        {
                          ...
                          for (;;)
                          {
                            localObject10 = new byte[4];
                            util.int32_to_buf((byte[])localObject10, 0, t.ad);
                            ((a)localObject7).a((byte[])localObject10, 4);
                            ...
                            return a((byte[])localObject10, this.u, paramInt1 + 1);
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\oicq\wlogin_sdk\request\y.class
