  ...
  extends b
{
  ...
  public int a(byte[] paramArrayOfByte, long paramLong, Context paramContext)
  {
    ...
    if (c.s)
    {
      ...
      localObject4[0] = oicq_request.b((byte[])localObject1, (byte[])localObject2);
  ...
  public byte[] a(long paramLong1, long paramLong2, long paramLong3, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, int paramInt, List<byte[]> paramList, byte[] paramArrayOfByte4, byte[] paramArrayOfByte5, long paramLong4, long paramLong5)
  {
    ...
    {
      paramArrayOfByte3 = new oicq.wlogin_sdk.b.a();
      paramArrayOfByte3.a(104);
      paramArrayOfByte3.b(t.y, t.y.length);
      paramArrayOfByte3.d();
      ((List)tmp25_23).add(paramArrayOfByte3.a());
      paramInt = 0;
      ...
      int j = ((List)tmp25_23).size();
      paramInt = paramArrayOfByte1.length + 16 + 2 + paramArrayOfByte2.length + 1 + 2;
      int i = 0;
      if (i < j)
      {
        if (((List)tmp25_23).get(i) == null) {
          break label629;
        }
        paramInt = ((byte[])((List)tmp25_23).get(i)).length + paramInt;
      }
      label626:
      label629:
      for (;;)
      {
        ...
        if (i < j)
        {
          paramArrayOfByte1 = (byte[])((List)tmp25_23).get(i);
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\oicq\wlogin_sdk\code2d\a.class
