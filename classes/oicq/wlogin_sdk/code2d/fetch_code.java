  ...
  public byte[] get_request(long paramLong1, long paramLong2, long paramLong3, byte[] paramArrayOfByte1, QRCodeCustom paramQRCodeCustom, long paramLong4, long paramLong5, byte[] paramArrayOfByte2)
  {
    ...
    if (j < n)
    {
      ...
      for (;;)
      {
        ...
        {
          locala.b((byte[])localObject1, tmp12_10);
          locala.d();
        ...
        if (paramArrayOfByte2 != null)
        {
          ...
          if (paramArrayOfByte2.length > 0)
          {
            ...
            continue;
            tmp12_10 = t.I.length + 3 + 2 + t.H.length + 2 + 2 + t.A.length + 2 + 0 + 2 + t.D.length;
            localObject1 = new byte[tmp12_10];
    ...
    tmp12_10 = fill_staff(paramQRCodeCustom, paramArrayOfByte1, 15);
    k = localArrayList.size();
    util.int16_to_buf(paramQRCodeCustom, tmp12_10, k);
    j = tmp12_10 + 2;
    tmp12_10 = 0;
    while (tmp12_10 < k)
    {
      paramArrayOfByte1 = (byte[])localArrayList.get(tmp12_10);
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\oicq\wlogin_sdk\code2d\fetch_code.class
