...
public class nga
  extends Handler
{
  public nga(ListenChangeVoicePanel paramListenChangeVoicePanel, Looper paramLooper)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message arg1)
  {
    ...
    case 102: 
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelChangeVoiceView.a();
      return;
    case 106: 
      VoiceChangeManager.a(ListenChangeVoicePanel.a(this.a).a(), ListenChangeVoicePanel.a(this.a), PressToChangeVoicePanel.b, this.a);
      ...
      if (!PttPreSendManager.a(ListenChangeVoicePanel.a(this.a)).a(this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie, ListenChangeVoicePanel.a(this.a)))
      {
        if (QLog.isColorLevel()) {
          QLog.d(PttPreSendManager.a, 2, "presend not hit, do origin logic");
        }
      ...
      for (int i = 1;; i = 0)
      {
        ???.a(str, 4, k, localRecorderParam, i, false);
