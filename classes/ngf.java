...
public class ngf
  extends Handler
{
  public ngf(PressToChangeVoicePanel paramPressToChangeVoicePanel, Looper paramLooper)
  {
    super(paramLooper);
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    else
    {
      ...
      Object localObject2 = (ListenChangeVoicePanel)this.a.f.findViewById(2131299550);
      ...
      if ((this.a.jdField_a_of_type_ComTencentMobileqqActivityBaseChatPie instanceof PublicAccountChatPie)) {
        ReportController.b(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "P_CliOper", "Pb_account_lifeservice", "", "0X8005850", "0X8005850", 0, 0, "", "", Double.toString(this.a.jdField_a_of_type_Double), "");
      }
      paramMessage = (ViewGroup)((ListenChangeVoicePanel)localObject2).findViewById(2131301261);
      if (VersionUtils.e())
      {
        ...
        localAnimatorSet.addListener(new ngg(this, paramMessage));
