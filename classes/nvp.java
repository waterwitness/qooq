  ...
  extends nvt
{
  ...
  public nvp(PhotoListPanel.SwipeUpAndDragListener paramSwipeUpAndDragListener, Context paramContext, ViewGroup paramViewGroup)
  {
  ...
  boolean b(MotionEvent paramMotionEvent)
  {
    ...
    ((ArrayList)localObject).add(this.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$SwipeUpAndDragListener.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel.jdField_a_of_type_ComTencentMobileqqActivityAioPhotoPhotoListPanel$MyAdapter.a(this.jdField_b_of_type_Int).a);
    ...
    for (;;)
    {
      paramMotionEvent.setAnimationListener(new nvq(this, f2));
      break;
