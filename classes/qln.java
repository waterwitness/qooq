...
public class qln
  implements Runnable
{
  public qln(DatalineMessageManager paramDatalineMessageManager, DataLineMsgSet paramDataLineMsgSet)
  {
  ...
  public void run()
  {
    ...
    {
      localObject1 = MsgProxyUtils.a(String.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppMessageDatalineMessageManager.b), this.jdField_a_of_type_ComTencentMobileqqAppMessageDatalineMessageManager.jdField_a_of_type_Int);
    ...
    for (;;)
    {
      ...
      if (l > 0L)
      {
        ...
        {
          localObject1 = localObject2;
          if (((DataLineMsgRecord)localObject2).msgtype == 60536)
          {
            localObject1 = localObject2;
            if (l > 1L) {
      ...
      localObject2 = ((RecentUserProxy)localObject2).a(String.valueOf(this.jdField_a_of_type_ComTencentMobileqqAppMessageDatalineMessageManager.b), this.jdField_a_of_type_ComTencentMobileqqAppMessageDatalineMessageManager.jdField_a_of_type_Int);
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\qln.class
