  ...
  implements ygd
{
  ...
  public static void a(Activity paramActivity, String paramString1, boolean paramBoolean1, String paramString2, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      try
      {
        paramString2 = paramActivity.getString(2131365918);
        if (!paramBoolean2) {
          continue;
        }
        paramString1 = paramActivity.getString(2131365920);
        DialogUtil.a(paramActivity, 230, paramString2, paramString1, 2131367262, 2131365921, new yge(), null).setMessageCount(null).show();
      ...
      localQQToast.b(paramActivity.getResources().getDimensionPixelSize(2131492908) - (int)(5.0F * paramActivity.getResources().getDisplayMetrics().density));
      return;
      paramString1 = paramActivity.getString(2131365919);
      continue;
      localQQToast.a(QQToast.a(1));
      if (paramString2 == null) {
        localQQToast.b(2131365903);
      } else {
  ...
  public static void a(Context paramContext, OnPluginInstallListener paramOnPluginInstallListener)
  {
    ...
    try
    {
      new ygi((Context)localObject, paramOnPluginInstallListener).start();
      return;
    }
  ...
  public static boolean a(boolean paramBoolean)
  {
    ...
    ??? = new ygf();
    Object localObject2 = new Thread((Runnable)???);
    if (paramBoolean) {}
    synchronized (jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean)
    {
      PluginManagerHelper.getPluginInterface(BaseApplicationImpl.a(), new ygg((Thread)localObject2));
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\cooperation\qqfav\QfavHelper.class
