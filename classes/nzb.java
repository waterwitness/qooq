...
class nzb
  implements Runnable
{
  nzb(nza paramnza, MultiForwardChatPie paramMultiForwardChatPie, CharSequence paramCharSequence)
  {
  ...
  public void run()
  {
    ...
    MultiForwardChatPie.a(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildMultiForwardChatPie).setVisibility(0);
    this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildMultiForwardChatPie.jdField_b_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityAioRebuildMultiForwardChatPie.an);
