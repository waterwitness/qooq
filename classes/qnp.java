...
public class qnp
  implements Runnable
{
  public qnp(FTSTroopOperator paramFTSTroopOperator)
  {
  ...
  public void run()
  {
    ...
    this.a.b();
    Object localObject1 = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().createEntityManager();
    ...
    FTSTroopOperator.a(this.a).d();
    localObject1 = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getSharedPreferences(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), 0);
    ...
    if (i == 0)
    {
      ...
      if (FTSTroopOperator.a(this.a) == null) {
        FTSTroopOperator.a(this.a, new qnq(this));
      }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\qnp.class
