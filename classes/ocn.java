...
{
  public ocn(TroopChatPie paramTroopChatPie)
  {
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      j = this.a.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.s();
      k = this.a.jdField_a_of_type_ComTencentMobileqqBubbleChatXListView.t();
    ...
    while (paramBundle != null)
    {
      ...
      if ((i != 0) || (localObject1 == null))
      {
        ...
        this.a.a(131076);
        QQToast.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getBaseContext(), "展开话题失败", 0).b(this.a.a());
        return;
      }
      ...
      while (paramBundle != null)
      {
        ...
        this.a.a(131076);
        TroopChatPie.b(this.a).postDelayed(new oco(this), 100L);
        return;
        ...
        paramBundle = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c((String)localObject1, this.a.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.a, l);
        if (!(paramBundle instanceof MessageForTroopTopic)) {
          break;
        }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\ocn.class
