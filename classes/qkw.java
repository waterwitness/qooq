...
public class qkw
  implements Runnable
{
  public qkw(BaseMessageManagerForTroopAndDisc paramBaseMessageManagerForTroopAndDisc, QQMessageFacade.RefreshMessageContext paramRefreshMessageContext, String paramString, int paramInt, long paramLong, boolean paramBoolean)
  {
  ...
  public void run()
  {
    ...
    for (int i = (int)localChatMessage.shmsgseq;; i = 0)
    {
      ...
      for (boolean bool = true; (j == i) || (i <= this.jdField_a_of_type_Long); bool = false)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppMessageBaseMessageManagerForTroopAndDisc.a.a.post(new qkx(this));
        return;
      }
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\qkw.class
