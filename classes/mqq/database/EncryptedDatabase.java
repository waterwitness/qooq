...
public class EncryptedDatabase
{
  ...
  private ArrayList<String> getTableInfo(String paramString)
  {
    ...
    try
    {
      Cursor localCursor = this.mHelper.getReadableDatabase().rawQueryWithFactory(null, "select sql from sqlite_master where type=? and name=?", new String[] { "table", paramString }, "sqlite_master");
      if (localCursor != null)
      {
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\mqq\database\EncryptedDatabase.class
