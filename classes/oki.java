...
{
  public oki(TroopActivity paramTroopActivity, ActionSheet paramActionSheet)
  {
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    case 0: 
      for (;;)
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityContactTroopTroopActivity.app.a().c(AppConstants.aC, 9000, -i);
        ...
        paramView.b(AppConstants.aC, 9000);
        ...
        MqqHandler localMqqHandler = this.jdField_a_of_type_ComTencentMobileqqActivityContactTroopTroopActivity.app.a(NotificationView.class);
    ...
    i = paramInt;
    paramView = this.jdField_a_of_type_ComTencentMobileqqActivityContactTroopTroopActivity.app.a().b(AppConstants.aw, 0);
    if ((paramView == null) || (paramView.size() == 0)) {
      l = 0L;
    }
    ...
    paramView.a(AppConstants.aC, 9000, l);
  }
}


/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\oki.class
