...
{
  public nqm(TextItemBuilder paramTextItemBuilder, boolean paramBoolean)
  {
  ...
  public void a(View paramView)
  {
    ...
    float f1 = ((AnimationTextView)localObject).a - TextItemBuilder.l;
    float f2 = ((AnimationTextView)localObject).b;
    float f3 = TextItemBuilder.j;
    if (this.jdField_a_of_type_Boolean) {
      f1 = ((AnimationTextView)localObject).a - TextItemBuilder.m;
    }
