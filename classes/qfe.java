...
{
  public qfe(QQMapActivityProxy paramQQMapActivityProxy)
  {
          ...
          do
          {
            do
            {
              do
              {
                ...
                QQMapActivityProxy.a(this.a).b(QQMapActivityProxy.a(this.a));
                return;
                if (!paramContext.equals("com.tencent.mobileqq.getStreetViewUrl")) {
                  break;
                }
              } while (QQMapActivityProxy.a(this.a) == null);
              ((LBSHandler)QQMapActivityProxy.a(this.a).a(3)).a((int)(paramIntent.getDoubleExtra("latitude", 0.0D) * 1000000.0D), (int)(paramIntent.getDoubleExtra("longitude", 0.0D) * 1000000.0D));
              return;
...
/* Location:              E:\apk\QQ_91\classes-dex2jar.jar!\qfe.class
