  ...
  implements Parcelable
{
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = "LBSInfo";
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((this.h.equals(((LBSInfo)paramObject).h)) && (this.f.equals(((LBSInfo)paramObject).f)) && (this.i.equals(((LBSInfo)paramObject).i)) && (this.g.equals(((LBSInfo)paramObject).g)) && (this.jdField_c_of_type_JavaLangString.equals(((LBSInfo)paramObject).jdField_c_of_type_JavaLangString)) && (this.jdField_b_of_type_JavaLangString.equals(((LBSInfo)paramObject).jdField_b_of_type_JavaLangString)) && (this.e.equals(((LBSInfo)paramObject).e)) && (this.d.equals(((LBSInfo)paramObject).d)) && (this.jdField_a_of_type_Double == ((LBSInfo)paramObject).jdField_a_of_type_Double) && (this.jdField_b_of_type_Double == ((LBSInfo)paramObject).jdField_b_of_type_Double) && (this.jdField_c_of_type_Double == ((LBSInfo)paramObject).jdField_c_of_type_Double));
    return false;
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\av\service\LBSInfo.class
