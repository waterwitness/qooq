...
public class ShareUtils
{
  ...
  {
    paramAppInterface = new AbsShareMsg.Builder(StructMsgForGeneralShare.class).c(1).a("推荐公会：" + paramString2).e(paramString4).a();
  ...
  public static void a(AppInterface paramAppInterface, Context paramContext, String paramString1, String paramString2)
  {
    if ((paramString2 != null) && (paramString2.length() > 0))
    {
      ...
      for (;;)
      {
        QQToast.a(paramContext, 2, "已复制语音房间链接地址", 0).b(paramContext.getResources().getDimensionPixelSize(2131492908));
        return;
    ...
    QQToast.a(paramContext, 2, "复制语音房间链接失败", 0).b(paramContext.getResources().getDimensionPixelSize(2131492908));
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\av\utils\ShareUtils.class
