...
public class BitmapTools
{
  ...
  {
    Bitmap localBitmap = Bitmap.createBitmap(120, 60, Bitmap.Config.ARGB_8888);
    Canvas localCanvas = new Canvas(localBitmap);
    Path localPath = new Path();
    Paint localPaint = new Paint();
    RectF localRectF = new RectF(0.0F, 0.0F, 50.0F, 50.0F);
    Path.Direction localDirection = Path.Direction.CW;
    localPath.addRoundRect(localRectF, new float[] { 12.0F, 12.0F, 12.0F, 12.0F, 12.0F, 12.0F, 12.0F, 12.0F }, localDirection);
  ...
  public static BitmapDrawable a(int paramInt, float paramFloat)
  {
    int i = (int)(50.0F * paramFloat);
    int j = (int)(25.0F * paramFloat);
    ...
    paramFloat = (int)(60.0F * paramFloat);
    localPaint.setAntiAlias(true);
    localCanvas.drawARGB(0, 0, 0, 0);
    localPaint.setColor(paramInt);
    localCanvas.drawRoundRect(localRectF, paramFloat, paramFloat, localPaint);
    localPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.SRC_IN));
    new Matrix().setRectToRect(new RectF(localRect1), new RectF(localRect2), Matrix.ScaleToFit.FILL);
  ...
  public static Drawable a(Context paramContext, int paramInt, float paramFloat)
  {
    int i = UITools.a(paramContext);
    ...
    for (;;)
    {
      try
      {
        ...
        ((ColorMatrix)localObject).set(new float[] { 1.0F, 0.0F, 0.0F, 0.0F, paramFloat, 0.0F, 1.0F, 0.0F, 0.0F, paramFloat, 0.0F, 0.0F, 1.0F, 0.0F, paramFloat, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F });
        paramContext.setColorFilter(new ColorMatrixColorFilter((ColorMatrix)localObject));
        return paramContext;
      }
      catch (Exception paramContext)
      {
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\av\utils\BitmapTools.class
