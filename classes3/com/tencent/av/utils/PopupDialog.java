  ...
  extends BaseActivity
{
  ...
  public static void a()
  {
    ...
    jdField_a_of_type_Hbl.jdField_a_of_type_Boolean = false;
    hbl localhbl = jdField_a_of_type_Hbl;
    if (hbl.jdField_a_of_type_ComTencentAvUtilsPopupDialog != null)
    {
      localhbl = jdField_a_of_type_Hbl;
      hbl.jdField_a_of_type_ComTencentAvUtilsPopupDialog.finish();
      localhbl = jdField_a_of_type_Hbl;
      hbl.jdField_a_of_type_ComTencentAvUtilsPopupDialog = null;
    }
  }
  ...
  public static void a(Context paramContext)
  {
    ...
    Object localObject = jdField_a_of_type_Hbl;
    if (hbl.jdField_a_of_type_ComTencentAvUtilsPopupDialog != null) {
      return;
    }
    ...
    jdField_a_of_type_Hbl.jdField_a_of_type_Boolean = true;
  ...
  {
    a();
    Intent localIntent = new Intent(paramContext, PopupDialogQQSide.class);
    ...
    jdField_a_of_type_Hbl.jdField_a_of_type_Boolean = true;
    jdField_a_of_type_Hbl.jdField_a_of_type_Int = paramInt1;
    jdField_a_of_type_Hbl.jdField_a_of_type_JavaLangString = paramString1;
    jdField_a_of_type_Hbl.jdField_b_of_type_JavaLangString = paramString2;
    jdField_a_of_type_Hbl.jdField_b_of_type_Int = paramInt2;
    jdField_a_of_type_Hbl.c = paramInt3;
    jdField_a_of_type_Hbl.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener = paramOnClickListener2;
    jdField_a_of_type_Hbl.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener = paramOnClickListener1;
  ...
  public static void a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    if (hbl.jdField_a_of_type_ComTencentAvUtilsPopupDialog != null)
    {
      paramContext = jdField_a_of_type_Hbl;
      hbl.jdField_a_of_type_ComTencentAvUtilsPopupDialog.a(paramString1, paramString2);
      return;
    }
    localObject = new Intent(paramContext, PopupDialog.class);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d("PopupDialog", 2, "WL_DEBUG sendIsResumeBroadcast isResume = " + paramBoolean);
    }
  ...
  {
    return jdField_a_of_type_Hbl.jdField_a_of_type_Boolean;
  }
  ...
  void c()
  {
    ...
    do
    {
      ...
      localObject1 = jdField_a_of_type_Hbl.jdField_a_of_type_JavaLangString;
      localObject2 = jdField_a_of_type_Hbl.jdField_b_of_type_JavaLangString;
    ...
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.show();
    return;
    int k = jdField_a_of_type_Hbl.jdField_a_of_type_Int;
    String str1 = jdField_a_of_type_Hbl.jdField_a_of_type_JavaLangString;
    String str2 = jdField_a_of_type_Hbl.jdField_b_of_type_JavaLangString;
    int i = jdField_a_of_type_Hbl.jdField_b_of_type_Int;
    int j = jdField_a_of_type_Hbl.c;
    if (this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog != null)
    {
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.dismiss();
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = null;
    }
    localObject1 = new hbj(this);
    Object localObject2 = new hbk(this);
    if ((i == 0) || (jdField_a_of_type_Hbl.jdField_a_of_type_AndroidContentDialogInterface$OnClickListener == null))
    {
      localObject1 = null;
      i = 2131363160;
    }
    if ((j == 0) || (jdField_a_of_type_Hbl.jdField_b_of_type_AndroidContentDialogInterface$OnClickListener == null))
    {
      localObject2 = null;
      j = 2131363160;
    }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    paramBundle = jdField_a_of_type_Hbl;
    if (hbl.jdField_a_of_type_ComTencentAvUtilsPopupDialog != null)
    {
      paramBundle = jdField_a_of_type_Hbl;
      if (hbl.jdField_a_of_type_ComTencentAvUtilsPopupDialog != this)
      {
        paramBundle = jdField_a_of_type_Hbl;
        hbl.jdField_a_of_type_ComTencentAvUtilsPopupDialog.finish();
      }
    ...
    paramBundle = jdField_a_of_type_Hbl;
    hbl.jdField_a_of_type_ComTencentAvUtilsPopupDialog = this;
  }
  ...
  protected void onNewIntent(Intent paramIntent)
  {
    ...
    paramIntent = jdField_a_of_type_Hbl;
    if (hbl.jdField_a_of_type_ComTencentAvUtilsPopupDialog != null)
    {
      paramIntent = jdField_a_of_type_Hbl;
      if (hbl.jdField_a_of_type_ComTencentAvUtilsPopupDialog != this)
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\av\utils\PopupDialog.class
