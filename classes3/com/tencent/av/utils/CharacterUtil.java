...
{
  static final int jdField_a_of_type_Int = 18;
  static final long jdField_a_of_type_Long = -1L;
  static final String jdField_a_of_type_JavaLangString = "CharacterUtil";
  static final int jdField_b_of_type_Int = 5;
  static final long jdField_b_of_type_Long;
  static final String jdField_b_of_type_JavaLangString = "-9223372036854775808";
  ...
  {
    long l = paramLong & 0x7FFFFFFFFFFFFFFF;
    if (paramLong == l) {
  ...
  public static String a(String paramString, int paramInt1, int paramInt2)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      {
        j = i;
        if (c(paramString.charAt(paramInt2))) {
          j = i - 1;
        }
        paramInt2 += 1;
      }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\av\utils\CharacterUtil.class
