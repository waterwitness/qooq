  ...
  extends BaseGestureDetector
{
  ...
  protected void a(int paramInt, MotionEvent paramMotionEvent)
  {
    ...
    this.jdField_a_of_type_Boolean = this.jdField_a_of_type_ComTencentAvOpenglGesturedetectorsMoveGestureDetector$OnMoveGestureListener.a(this);
  }
  ...
  protected void b(int paramInt, MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      ...
      return;
      a(paramMotionEvent);
    } while ((this.jdField_a_of_type_Float / this.jdField_b_of_type_Float <= 0.67F) || (!this.jdField_a_of_type_ComTencentAvOpenglGesturedetectorsMoveGestureDetector$OnMoveGestureListener.b(this)) || (this.jdField_a_of_type_AndroidViewMotionEvent == null));
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\av\opengl\gesturedetectors\MoveGestureDetector.class
