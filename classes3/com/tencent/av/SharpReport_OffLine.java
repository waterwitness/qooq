...
public class SharpReport_OffLine
{
  ...
  private static SharpReport_OffLine jdField_a_of_type_ComTencentAvSharpReport_OffLine;
  ...
  private SharpReport_OffLine.ReportHeader jdField_a_of_type_ComTencentAvSharpReport_OffLine$ReportHeader = new SharpReport_OffLine.ReportHeader(this);
  ...
  private byte[] jdField_a_of_type_ArrayOfByte = new byte['Ā'];
  private int d;
  ...
  private int a()
  {
    ...
    } while (!((String)localObject).equalsIgnoreCase(PkgTools.h));
    return 8;
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\av\SharpReport_OffLine.class
