  ...
  extends BaseActivity
{
  ...
  public PSTNC2CActivity()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler$Callback = new gxi(this);
    ...
    this.jdField_a_of_type_ComTencentMobileqqQcallPstnObserver = new gxq(this);
    this.jdField_a_of_type_AndroidTelephonyPhoneStateListener = new gxv(this);
    this.jdField_a_of_type_JavaLangRunnable = new gxj(this);
  }
  ...
  private void d()
  {
    ...
    for (;;)
    {
      localObject1 = new Intent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), PstnSmallScreenService.class);
      ((Intent)localObject1).putExtra("pstn_session_info", this.jdField_a_of_type_ComTencentAvAppPstnSessionInfo);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().stopService((Intent)localObject1);
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().startService((Intent)localObject1);
      return;
  ...
  public void BtnOnClick(View paramView)
  {
    ...
    DialogUtil.a(this, 230, paramView, (String)localObject1, getString(2131363161), (String)localObject2, new gxo(this), new gxp(this)).show();
  }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    ThreadManager.a(new gxk(this), 5, null, false);
    b();
    a(getIntent());
    return true;
  }
  ...
  protected void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    DialogUtil.a(this, 230, paramIntent, str, getString(2131363161), (String)localObject, new gxm(this), new gxn(this)).show();
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\av\ui\PSTNC2CActivity.class
