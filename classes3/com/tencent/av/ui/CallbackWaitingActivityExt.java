  ...
  extends BaseActivity
{
  ...
  public static final String b = "ActivityStartFrom";
  public static final String c = "ActivityStartFromBall";
  ...
  private static String k = "CallbackWaitingActivity";
  private static final String l = "com.tencent.lightalk.callbackwaiting.STOPMULTIAUDIO";
  int jdField_a_of_type_Int = 1001;
  public BroadcastReceiver a;
  public Intent a;
  AudioManager jdField_a_of_type_AndroidMediaAudioManager;
  protected Handler.Callback a;
  private Handler jdField_a_of_type_AndroidOsHandler = new gql(this, Looper.getMainLooper());
  PhoneStateListener jdField_a_of_type_AndroidTelephonyPhoneStateListener = new gqy(this);
  ...
  PstnObserver jdField_a_of_type_ComTencentMobileqqQcallPstnObserver = new gqs(this);
  public Runnable a;
  public MqqHandler a;
  public int b;
  BroadcastReceiver jdField_b_of_type_AndroidContentBroadcastReceiver = new gqz(this);
  public Button b;
  ...
  public CallbackWaitingActivityExt()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler$Callback = new gqq(this);
    this.jdField_c_of_type_AndroidWidgetTextView = null;
    this.jdField_a_of_type_AndroidWidgetButton = null;
    this.jdField_b_of_type_AndroidWidgetButton = null;
    this.jdField_a_of_type_JavaLangRunnable = new gqr(this);
  ...
  private void a(Button paramButton, int paramInt1, int paramInt2, int paramInt3)
  {
    if (paramButton == null)
    {
      if (QLog.isColorLevel()) {
        QLog.d(k, 2, "changButtonStyle button is null");
      }
      return;
    }
  ...
  private void b(Intent paramIntent)
  {
    ...
    {
      this.e = paramIntent.getStringExtra("toPhone");
      this.f = paramIntent.getStringExtra("fromPhone");
    }
    this.jdField_d_of_type_JavaLangString = paramIntent.getStringExtra("callbackId");
    this.g = paramIntent.getStringExtra("toUin");
    this.h = paramIntent.getStringExtra("fromUin");
  ...
  private void d()
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(k, 2, "PstnSession is null. Getting data from AVCenter");
      }
      ...
      m = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().jdField_b_of_type_Int;
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidContentIntent = new Intent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), PstnSmallScreenService.class);
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().startService(this.jdField_a_of_type_AndroidContentIntent);
      return;
  ...
  private void e()
  {
    ...
    {
      super.setContentView(2130903600);
      this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131298946));
      LayoutInflater.from(this).inflate(2130903601, this.jdField_a_of_type_AndroidWidgetRelativeLayout);
    }
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131299056));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131299058));
    int m = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().jdField_b_of_type_Int;
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131299119));
    if ((m == -1) || (m == 0))
    {
      a(this.jdField_a_of_type_AndroidWidgetButton, 2130839056, 2131427785, 2131427785);
      this.jdField_a_of_type_AndroidWidgetButton.setClickable(false);
      this.jdField_b_of_type_AndroidWidgetButton = ((Button)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131299019));
      this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131299090));
      if (m != 2) {
        break label295;
      }
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131364009);
      a(this.jdField_b_of_type_AndroidWidgetButton, false, 2130839044);
    ...
    for (;;)
    {
      ...
      {
        RelativeLayout localRelativeLayout = (RelativeLayout)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131299462);
        if (localRelativeLayout != null)
        {
          RelativeLayout.LayoutParams localLayoutParams = (RelativeLayout.LayoutParams)localRelativeLayout.getLayoutParams();
          localLayoutParams.topMargin = getResources().getDimensionPixelSize(2131493874);
          localRelativeLayout.setLayoutParams(localLayoutParams);
        }
      }
      return;
      a(this.jdField_a_of_type_AndroidWidgetButton, false, 2130839056);
      this.jdField_a_of_type_AndroidWidgetButton.setClickable(true);
      break;
      label295:
      this.jdField_c_of_type_AndroidWidgetTextView.setText(2131364002);
      a(this.jdField_b_of_type_AndroidWidgetButton, 2130839044, 2131427785, 2131427785);
  ...
  private void f()
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(k, 2, "user close! 0");
      }
      if (this.jdField_a_of_type_Int == 1001)
      {
        if (QLog.isColorLevel()) {
          QLog.d(k, 2, "user close! 1");
        }
        finish();
        c();
        return;
  ...
  public void BtnOnClick(View paramView)
  {
    ...
    if (PstnUtils.a(this.app, 2))
    {
      ...
      for (;;)
      {
        ...
        ((Intent)localObject2).putExtra("param_title", getString(2131372453));
    ...
    DialogUtil.a(this, 230, paramView, (String)localObject1, getString(2131363161), (String)localObject2, new gra(this), new grb(this)).show();
  }
  
  public void a()
  {
    if (QLog.isColorLevel()) {
      QLog.d(k, 2, "refreshUI");
    }
    if (this.jdField_a_of_type_AndroidWidgetRelativeLayout == null) {
      return;
    }
    ...
    if (this.jdField_b_of_type_AndroidWidgetTextView == null) {
      this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetRelativeLayout.findViewById(2131299365));
    }
    int m;
    if (this.jdField_a_of_type_ComTencentAvAppPstnSessionInfo == null)
    {
      ...
      m = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().jdField_a_of_type_Int;
    }
    for (String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().jdField_b_of_type_JavaLangString;; str = this.jdField_a_of_type_ComTencentAvAppPstnSessionInfo.jdField_b_of_type_JavaLangString)
    {
      ...
      default: 
        ...
        this.jdField_b_of_type_AndroidWidgetTextView.setText(ContactUtils.d((String)localObject2));
        return;
        ...
        m = this.jdField_a_of_type_ComTencentAvAppPstnSessionInfo.jdField_a_of_type_Int;
      }
    }
  ...
  public void a(Button paramButton, boolean paramBoolean, int paramInt)
  {
    if (paramBoolean)
    {
      a(paramButton, paramInt, 2131428165, 2131428166);
      return;
    }
    a(paramButton, paramInt, 2131428157, 2131428158);
  }
  ...
  protected void a(PstnSessionInfo paramPstnSessionInfo)
  {
    if ((paramPstnSessionInfo != null) && (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().c = paramPstnSessionInfo.c;
  ...
  protected void b()
  {
    ...
    {
      localObject1 = getString(2131372503);
      localObject2 = getString(2131372504);
      localObject3 = getString(2131372505);
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(k, 2, "sendCloseBroadCast");
    }
    Intent localIntent = new Intent();
    localIntent.setPackage(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getPackageName());
    localIntent.setAction("tencent.av.v2q.CancelCallBack");
    localIntent.putExtra("fromPhone", this.f);
    localIntent.putExtra("toPhone", this.e);
    localIntent.putExtra("fromUin", this.h);
    localIntent.putExtra("uinType", this.jdField_b_of_type_Int);
    localIntent.putExtra("toUin", this.g);
    localIntent.putExtra("callBackId", this.jdField_d_of_type_JavaLangString);
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    for (;;)
    {
      ...
      ThreadManager.a(new gqp(this), 5, null, false);
      a(getIntent());
      if (this.jdField_a_of_type_ComTencentAvAppPstnSessionInfo != null)
      {
        paramBundle = getString(2131372455) + a(this.jdField_a_of_type_ComTencentAvAppPstnSessionInfo.jdField_b_of_type_JavaLangString, this.jdField_a_of_type_ComTencentAvAppPstnSessionInfo.jdField_d_of_type_JavaLangString);
      ...
      return true;
      super.setContentView(2130903523);
      this.jdField_a_of_type_ComTencentAvUiBaseCallbackUI = new BaseCallbackUI(this, 1001);
      this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131298958));
    }
  }
  ...
  protected void doOnResume()
  {
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().jdField_b_of_type_Int == -1)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(this.jdField_a_of_type_ComTencentAvAppPstnSessionInfo.jdField_a_of_type_JavaLangString, 5);
  ...
  protected void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    DialogUtil.a(this, 230, paramIntent, str, getString(2131363161), (String)localObject, new gqn(this), new gqo(this)).show();
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\av\ui\CallbackWaitingActivityExt.class
