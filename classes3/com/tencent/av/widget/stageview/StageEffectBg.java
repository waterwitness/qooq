...
public class StageEffectBg
  extends View
{
  private static final int jdField_a_of_type_Int = 1358954495;
  static final double[] jdField_a_of_type_ArrayOfDouble = { 0.0D, 5.585053606381854D, 0.6981317007977318D, 4.1887902047863905D, 2.0943951023931953D, 3.4033920413889427D, 2.8797932657906435D, 3.141592653589793D };
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramBoolean)
    {
      ...
      float f4;
      for (f1 = (paramInt2 - f3 * 444.0F) / 2.0F + 96.77058F * f3;; f1 = f4)
      {
        this.jdField_a_of_type_AndroidGraphicsMatrix.reset();
        this.jdField_a_of_type_AndroidGraphicsCamera.save();
        this.jdField_a_of_type_AndroidGraphicsCamera.rotateX(72.2F);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\av\widget\stageview\StageEffectBg.class
