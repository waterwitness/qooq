...
public class VideoPngDecoder
{
  ...
  public int getNextPngFrame(String paramString)
  {
    int i = getNextArgbFrame(this.mHandler, this.colorbuffer);
    try
    {
      this.bitmap = Bitmap.createBitmap(this.colorbuffer, this.width, this.height, Bitmap.Config.ARGB_8888);
      paramString = new FileOutputStream(paramString);
      this.bitmap.compress(Bitmap.CompressFormat.PNG, 90, paramString);
      this.bitmap.recycle();
      return i;
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\common\VideoPngDecoder.class
