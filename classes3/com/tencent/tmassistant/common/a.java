...
public class a
{
  public static JceStruct a(byte paramByte, List<byte[]> paramList, String paramString1, int paramInt, String paramString2)
  {
  ...
  public static JceStruct a(byte[] paramArrayOfByte, Class<? extends JceStruct> paramClass)
  {
  ...
  public static ReqHead a(JceStruct paramJceStruct)
  {
    ...
    localReqHead.assistantVersionCode = f.a().m();
    return localReqHead;
  }
      ...
      try
      {
        ...
        if (localResponse.head.ret == 0)
        {
          ...
          if ((localResponse.head.encryptWithPack & 0x1) == 1) {
            localResponse.body = r.b(localResponse.body);
          }
  ...
  public static byte[] a(Request paramRequest)
  {
    ...
    {
      paramRequest.body = r.a(paramRequest.body);
  ...
  /* Error */
  public static byte[] a(List<byte[]> paramList)
  {
    // Byte code:
    //   0: new 234	java/io/ByteArrayOutputStream
    //   3: dup
    //   4: invokespecial 235	java/io/ByteArrayOutputStream:<init>	()V
    //   7: astore_1
    //   8: new 237	java/io/DataOutputStream
    //   11: dup
    //   12: aload_1
    //   13: invokespecial 240	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   16: astore 4
    //   18: aload 4
    //   20: astore_3
    //   21: aload_1
    ...
    //   67: aload 5
    //   69: arraylength
    //   70: invokevirtual 260	java/io/DataOutputStream:writeInt	(I)V
    //   73: aload 4
    //   75: astore_3
    //   76: aload_1
    //   77: astore_2
    //   78: aload 4
    //   80: aload 5
    //   82: invokevirtual 263	java/io/DataOutputStream:write	([B)V
    //   85: goto -55 -> 30
    //   88: astore_2
    //   89: aload 4
    //   91: astore_0
    ...
    //   98: astore_2
    //   99: aload 4
    //   101: invokevirtual 63	java/lang/Exception:printStackTrace	()V
    //   104: aload_1
    //   105: ifnull +7 -> 112
    //   108: aload_1
    //   109: invokevirtual 266	java/io/ByteArrayOutputStream:close	()V
    //   112: aload_0
    //   113: ifnull +7 -> 120
    //   116: aload_0
    //   117: invokevirtual 267	java/io/DataOutputStream:close	()V
    //   120: aconst_null
    //   121: astore_1
    //   122: aload_1
    //   123: areturn
    ...
    //   128: astore_2
    //   129: aload_1
    //   130: invokevirtual 270	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   133: astore_0
    //   134: aload_1
    //   135: ifnull +7 -> 142
    //   138: aload_1
    //   139: invokevirtual 266	java/io/ByteArrayOutputStream:close	()V
    //   142: aload_0
    //   143: astore_1
    //   144: aload 4
    //   146: ifnull -24 -> 122
    //   149: aload 4
    //   151: invokevirtual 267	java/io/DataOutputStream:close	()V
    //   154: aload_0
    //   155: areturn
    //   156: astore_1
    //   157: aload_1
    //   158: invokevirtual 271	java/io/IOException:printStackTrace	()V
    //   161: aload_0
    //   162: areturn
    //   163: astore_1
    //   164: aload_1
    //   165: invokevirtual 271	java/io/IOException:printStackTrace	()V
    //   168: goto -26 -> 142
    //   171: astore_1
    //   172: aload_1
    ...
    //   179: astore_0
    //   180: aload_0
    //   181: invokevirtual 271	java/io/IOException:printStackTrace	()V
    //   184: goto -64 -> 120
    //   187: astore_0
    //   188: aconst_null
    //   189: astore_3
    ...
    //   193: ifnull +7 -> 200
    //   196: aload_1
    //   197: invokevirtual 266	java/io/ByteArrayOutputStream:close	()V
    //   200: aload_3
    //   201: ifnull +7 -> 208
    //   204: aload_3
    //   205: invokevirtual 267	java/io/DataOutputStream:close	()V
    //   208: aload_0
    //   209: athrow
    //   210: astore_1
    //   211: aload_1
    //   212: invokevirtual 271	java/io/IOException:printStackTrace	()V
    //   215: goto -15 -> 200
    //   218: astore_1
    //   219: aload_1
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\tmassistant\common\a.class
