  ...
  extends SQLiteOpenHelper
{
  ...
  {
    m.c("sqliteHelper", "tables count:" + b().length);
    ...
    while (i < j)
    {
      ...
      try
      {
        ...
        m.c("sqliteHelper", "sql=" + (String)localObject);
      }
  ...
  public void onOpen(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    m.c("sqliteHelper", " dbversion:" + i + " newVersion:" + a());
    if (i == 0) {
      return;
    }
    if (i < a())
      ...
      for (;;)
      {
        if (i < k)
        {
          ...
          try
          {
            ...
            m.c("sqliteHelper", " upgrade:" + localObject);
            if (localObject != null)
            {
              int j = 0;
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\tmassistant\common\a\d.class
