  ...
  implements IWXAPI
{
  ...
  {
    paramContext = paramContext.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/createChatroom"), null, null, new String[] { this.appId, paramBundle.getString("_wxapi_create_chatroom_group_id"), paramBundle.getString("_wxapi_create_chatroom_chatroom_name"), paramBundle.getString("_wxapi_create_chatroom_chatroom_nickname"), paramBundle.getString("_wxapi_create_chatroom_ext_msg") }, null);
  ...
  {
    paramContext = paramContext.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/joinChatroom"), null, null, new String[] { this.appId, paramBundle.getString("_wxapi_join_chatroom_group_id"), paramBundle.getString("_wxapi_join_chatroom_chatroom_nickname"), paramBundle.getString("_wxapi_join_chatroom_ext_msg") }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
  ...
  {
    paramContext = paramContext.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/openWebview"), null, null, new String[] { this.appId, paramBundle.getString("_wxapi_jump_to_webview_url") }, null);
    if (paramContext != null) {
      paramContext.close();
    }
    return true;
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mm\sdk\openapi\WXApiImplV10.class
