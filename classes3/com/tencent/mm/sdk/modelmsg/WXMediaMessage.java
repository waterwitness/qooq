  ...
  public static class Builder
  {
    ...
    public static WXMediaMessage fromBundle(Bundle paramBundle)
    {
      ...
      catch (Exception paramBundle)
      {
        ...
        b.a("MicroMsg.SDK.WXMediaMessage", "get media object from bundle failed: unknown ident " + str + ", ex = " + paramBundle.getMessage());
      }
      return localWXMediaMessage;
    }
    ...
    private static String pathNewToOld(String paramString)
    {
      ...
      {
        b.a("MicroMsg.SDK.WXMediaMessage", "pathNewToOld fail, newPath is null");
        return paramString;
      }
    ...
    private static String pathOldToNew(String paramString)
    {
      if ((paramString == null) || (paramString.length() == 0))
      {
        b.a("MicroMsg.SDK.WXMediaMessage", "pathOldToNew fail, oldPath is null");
        return paramString;
      }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mm\sdk\modelmsg\WXMediaMessage.class
