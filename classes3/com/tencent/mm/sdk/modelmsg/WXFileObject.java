  ...
  implements WXMediaMessage.IMediaObject
{
  ...
  public boolean checkArgs()
  {
    ...
    {
      b.a("MicroMsg.SDK.WXFileObject", "checkArgs fail, both arguments is null");
      return false;
    }
    if ((this.fileData != null) && (this.fileData.length > this.contentLengthLimit))
    {
      b.a("MicroMsg.SDK.WXFileObject", "checkArgs fail, fileData is too large");
      return false;
    }
    if ((this.filePath != null) && (getFileSize(this.filePath) > this.contentLengthLimit))
    {
      b.a("MicroMsg.SDK.WXFileObject", "checkArgs fail, fileSize is too large");
      return false;
    }
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mm\sdk\modelmsg\WXFileObject.class
