...
class X5CoreWizard
{
    ...
    throws Throwable
  {
    try
    {
      Object localObject = this.mDexLoader.getClassLoader().loadClass("com.tencent.tbs.tbsshell.WebCoreProxy").getMethod("canUseX5", null);
      ((Method)localObject).setAccessible(true);
      localObject = ((Method)localObject).invoke(null, null);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\smtt\sdk\X5CoreWizard.class
