      ...
      public void onCallBackAction(Integer paramAnonymousInteger, Object paramAnonymousObject1, Object paramAnonymousObject2)
      {
        ...
        for (;;)
        {
          ...
          if (!MttLoader.isBrowserInstalledEx(TbsReaderView.this.mContext))
          {
            ...
            ((Bundle)paramAnonymousObject1).putString("tip", (String)localObject1);
            ((Bundle)paramAnonymousObject1).putString("statistics", "AHNG812");
            ((Bundle)paramAnonymousObject1).putInt("channel_id", 10834);
          ...
          else
          {
            ...
            if (!MttLoader.isBrowserInstalledEx(TbsReaderView.this.mContext))
            {
              ...
              paramAnonymousObject1 = new Bundle();
              ((Bundle)paramAnonymousObject1).putString("tip", (String)localObject1);
              ((Bundle)paramAnonymousObject1).putString("statistics", "AHNG808");
              ((Bundle)paramAnonymousObject1).putInt("channel_id", 10833);
            ...
            else
            {
              ...
              if (!MttLoader.isBrowserInstalledEx(TbsReaderView.this.mContext))
              {
                ...
                paramAnonymousObject1 = new Bundle();
                ((Bundle)paramAnonymousObject1).putString("tip", (String)localObject1);
                ((Bundle)paramAnonymousObject1).putString("statistics", "AHNG816");
                ((Bundle)paramAnonymousObject1).putInt("channel_id", 10835);
              ...
              else
              {
                ...
                if (!MttLoader.isBrowserInstalledEx(TbsReaderView.this.mContext))
                {
                  ...
                  paramAnonymousObject1 = new Bundle();
                  ((Bundle)paramAnonymousObject1).putString("tip", (String)localObject1);
                  ((Bundle)paramAnonymousObject1).putString("statistics", "AHNG828");
                  ((Bundle)paramAnonymousObject1).putInt("channel_id", 10965);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\smtt\sdk\TbsReaderView.class
