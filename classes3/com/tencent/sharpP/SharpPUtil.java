...
public final class SharpPUtil
{
  ...
  public static boolean isSharpPFile(java.io.File paramFile)
  {
    ...
    //   18: aload_0
    //   19: aload_3
    //   20: invokevirtual 70	java/io/FileInputStream:read	([B)I
    //   23: pop
    //   24: aload_0
    //   25: ifnull +183 -> 208
    //   28: aload_0
    //   29: invokevirtual 73	java/io/FileInputStream:close	()V
    //   32: new 75	java/lang/String
    //   35: dup
    //   36: aload_3
    //   37: invokespecial 78	java/lang/String:<init>	([B)V
    //   40: astore_0
    //   41: ldc 11
    //   43: new 30	java/lang/StringBuilder
    //   46: dup
    //   47: ldc 80
    //   49: invokespecial 35	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   52: aload_0
    ...
    //   59: invokestatic 49	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   62: pop
    //   63: aload_0
    //   64: ldc 8
    //   66: invokevirtual 87	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   69: ireturn
    //   70: astore_1
    //   71: aload_2
    //   72: astore_0
    ...
    //   76: astore_1
    //   77: ldc 11
    //   79: new 30	java/lang/StringBuilder
    //   82: dup
    //   83: ldc 89
    //   85: invokespecial 35	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   88: aload_2
    //   89: invokevirtual 92	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   98: invokestatic 49	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   101: pop
    //   102: aload_0
    //   103: ifnull -71 -> 32
    //   106: aload_0
    //   107: invokevirtual 73	java/io/FileInputStream:close	()V
    //   110: goto -78 -> 32
    //   113: astore_0
    //   114: ldc 11
    //   116: new 30	java/lang/StringBuilder
    //   119: dup
    //   120: ldc 94
    //   122: invokespecial 35	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   125: aload_0
    //   126: invokevirtual 92	java/io/IOException:getMessage	()Ljava/lang/String;
    ...
    //   135: invokestatic 49	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   138: pop
    //   139: goto -107 -> 32
    //   142: astore_0
    //   143: aload_1
    //   144: ifnull +7 -> 151
    //   147: aload_1
    //   148: invokevirtual 73	java/io/FileInputStream:close	()V
    //   151: aload_0
    //   152: athrow
    //   153: astore_1
    //   154: ldc 11
    ...
    //   159: dup
    //   160: ldc 94
    //   162: invokespecial 35	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   165: aload_1
    //   166: invokevirtual 92	java/io/IOException:getMessage	()Ljava/lang/String;
    //   169: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   172: invokevirtual 43	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   175: invokestatic 49	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   178: pop
    //   179: goto -28 -> 151
    //   182: astore_0
    //   183: ldc 11
    //   185: new 30	java/lang/StringBuilder
    //   188: dup
    //   189: ldc 94
    //   191: invokespecial 35	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   194: aload_0
    //   195: invokevirtual 92	java/io/IOException:getMessage	()Ljava/lang/String;
    //   198: invokevirtual 83	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   201: invokevirtual 43	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   204: invokestatic 49	android/util/Log:d	(Ljava/lang/String;Ljava/lang/String;)I
    //   207: pop
    //   208: goto -176 -> 32
    //   211: astore_2
    //   212: aload_0
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\sharpP\SharpPUtil.class
