    ...
    throws JSONException
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localJSONObject.put("uin", com.tencent.component.network.module.base.a.f());
        ...
        if ((this.errMsg != null) && (this.errMsg.length() > 0))
        {
          ...
          if (com.tencent.component.network.downloader.common.a.c())
          {
            i = 1;
      ...
      {
        com.tencent.component.network.downloader.common.a.b("BusinessReport", "to json error!", localThrowable);
        return localJSONObject;
      }
    }
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\component\network\module\report\ReportObj.class
