  ...
  implements KeepAliveStrategy
{
  ...
  public final KeepAliveStrategy.KeepAlive keepAlive(String paramString, HttpRequest paramHttpRequest)
  {
    ...
    int j = com.tencent.component.network.module.base.a.h();
    int i = j;
    if (bool)
    {
      int k = com.tencent.component.network.module.base.a.i();
      i = j;
      if (k != -1) {
        i = k;
      }
  ...
  public void setConfig(String paramString)
  {
    ...
    if (com.tencent.component.network.downloader.common.a.b()) {
      com.tencent.component.network.downloader.common.a.b("ConfigKeepAliveStrategy", "keep alive domain:" + paramString);
    }
  ...
  public final boolean supportKeepAlive(String paramString)
  {
    ...
    for (;;)
    {
      ...
      bool = com.tencent.component.network.downloader.common.a.a((Pattern)this.d.get(str), paramString);
      if (bool) {
        bool = true;
      }
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\component\network\downloader\strategy\ConfigKeepAliveStrategy.class
