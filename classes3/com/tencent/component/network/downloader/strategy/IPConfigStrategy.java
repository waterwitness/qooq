  ...
  implements IPStrategy
{
  ...
  private String a(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      {
        a.a("IPConfigStrategy", "resolveIP", paramString);
        return null;
      }
      finally
      {
  ...
  private Map<Integer, IPConfig> a(String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      return (Map<Integer, IPConfig>)localObject4;
    }
    this.a.readLock().lock();
    int i;
    Object localObject3;
    for (;;)
    {
      ...
      {
        a.a("IPConfigStrategy", "findIPConfigs", localThrowable1);
        this.a.readLock().unlock();
      ...
      try
      {
        ...
        return (Map<Integer, IPConfig>)localObject1;
      }
      finally
      {
  ...
  private static void a(String paramString, Map<String, Map<Integer, IPConfig>> paramMap, Map<String, Pattern> paramMap1)
  {
    ...
    for (;;)
    {
      ...
      {
        a.b("IPConfigStrategy", "exception when add ip config: " + paramString, paramMap);
      }
    }
  }
  
  private List<IPInfo> b(String paramString, int paramInt1, int paramInt2)
  {
    if (TextUtils.isEmpty(paramString)) {
      return null;
    }
  ...
  public boolean isIPValid(String paramString1, String paramString2)
  {
    ...
    for (;;)
    {
      ...
      {
        a.a("IPConfigStrategy", "isIPValid", paramString1);
        this.a.readLock().unlock();
        boolean bool2 = false;
        continue;
      }
  ...
  public void onIPAccessResult(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    {
      a.a("IPConfigStrategy", "onIPAccessResult", paramString1);
      return;
    }
    finally
    {
  ...
  {
    return b(paramString, NetworkManager.getIspType(), this.h);
  }
  ...
  public final void setConfig(Map<String, String> paramMap)
  {
    ...
    for (;;)
    {
      ...
      localObject3 = (String)((Map.Entry)localObject3).getValue();
      if (a.b()) {
        a.b(getLogTag(), "IP Config -- " + str + ":" + (String)localObject3);
      }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\component\network\downloader\strategy\IPConfigStrategy.class
