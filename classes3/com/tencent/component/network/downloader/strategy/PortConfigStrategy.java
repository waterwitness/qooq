...
public class PortConfigStrategy
{
  ...
  private List<Integer> a(String paramString)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      return (List<Integer>)localObject4;
    }
    ...
    for (;;)
    {
      ...
      {
        a.a("PortConfigStrategy", "findPortConfig", localThrowable1);
  ...
  public final void setConfig(String paramString)
  {
    ...
    if (a.b()) {
      a.b("PortConfigStrategy", "Downloader port config:" + paramString);
    }
    ...
    for (;;)
    {
      ...
      if (a.b()) {
        a.b("PortConfigStrategy", "downloader port: domain:" + str + " port:" + localInteger);
      }
      j += 1;
    }
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\component\network\downloader\strategy\PortConfigStrategy.class
