  ...
  public void updatePreview(List<PointF> paramList, float paramFloat1, float paramFloat2, long paramLong)
  {
    ...
    if (i < 180)
    {
      ...
      for (;;)
      {
        i += 1;
        break;
        this.facePoints[i] = ((float)(paramList[i] / VideoMaterialUtil.SCALE_FACE_DETECT));
      }
    }
    if (paramList == null)
    {
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\ttpic\filter\CustomVertexFilter.class
