...
{
  private static final String FRAGMENT_SHADER = VideoFileUtil.loadAssetsString(VideoGlobalContext.getContext(), "camera/camera_video/shader/FaceOffFragmentShader.dat").replace("\n", "");
  private static final String TAG = FaceOffByImageFilter.class.getSimpleName();
  private static final String VERTEX_SHADER = VideoFileUtil.loadAssetsString(VideoGlobalContext.getContext(), "camera/camera_video/shader/FaceOffVertexShader.dat").replace("\n", "");
  ...
  public FaceOffByImageFilter(String paramString1, String paramString2, StickerItem paramStickerItem)
  {
  ...
  {
    Bitmap localBitmap1 = FaceOffUtil.getFaceBitmap(this.item.imageFile);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\ttpic\filter\FaceOffByImageFilter.class
