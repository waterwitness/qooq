...
public class Texture2dProgram
{
  ...
  public Texture2dProgram(ProgramType paramProgramType)
  {
    this.mProgramType = paramProgramType;
    switch (paramProgramType)
    {
    default: 
    ...
    Log.d("Grafika", "Created program " + this.mProgramHandle + " (" + paramProgramType + ")");
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\ttpic\gles\Texture2dProgram.class
