...
public final class EglCore
{
  ...
  public EglCore(EGLContext paramEGLContext, int paramInt)
  {
    ...
    Log.d("Grafika", "EGLContext created, client version " + paramEGLContext[0]);
  }
  ...
  private EGLConfig getConfig(int paramInt1, int paramInt2)
  {
    ...
    {
      Log.w("Grafika", "unable to find RGB8888 / " + paramInt2 + " EGLConfig");
      return null;
    }
  ...
  public static void logCurrent(String paramString)
  {
    ...
    Log.i("Grafika", "Current EGL (" + paramString + "): display=" + localEGLDisplay + ", context=" + localEGLContext + ", surface=" + localEGLSurface);
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\ttpic\gles\EglCore.class
