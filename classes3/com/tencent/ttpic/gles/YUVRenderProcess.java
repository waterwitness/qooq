...
public class YUVRenderProcess
{
  ...
  public Frame queueYUV(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    this.mEffectFrame.bindFrame(-1, this.sw, this.sh, 0.0D);
    drawFrame();
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\ttpic\gles\YUVRenderProcess.class
