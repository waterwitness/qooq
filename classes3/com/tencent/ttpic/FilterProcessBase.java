...
{
  private static final String TAG = FilterProcessBase.class.getSimpleName();
  ...
  {
    if ((!RetrieveDataUtil.isValid(paramInt)) || (paramRetrieveDataListener == null)) {
      return;
    }
  ...
  public void initial()
  {
    ...
    this.mFilter.setNextFilter(this.mBlendFilter, null);
  ...
  public byte[] showPreviewAndReturnRGBA(int paramInt1, int paramInt2)
  {
    ...
    return RetrieveDataUtil.retrieveData(RetrieveDataListener.DATA_TYPE.RGBA.value, this.mPreviewFrame.getLastRenderTextureId(), this.videoWidth, this.videoHeight);
  }
  ...
  {
    this.width = Math.min(paramInt1, paramInt2);
    this.height = Math.max(paramInt1, paramInt2);
    float f = Math.min(720.0F / this.width, 1.0F);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\ttpic\FilterProcessBase.class
