  ...
  extends BaseFilter
{
    ...
    extends BaseFilter
  {
    ...
    public void ClearGLSL()
    {
      if (this.paramTEXTRUEID != 63536)
      {
        RendererUtils.clearTexture(this.paramTEXTRUEID);
        this.paramTEXTRUEID = 63536;
      }
      super.ClearGLSL();
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\filter\art\BokehFilter.class
