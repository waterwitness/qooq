  ...
  extends BaseFilter
{
  ...
  public void ApplyGLSLFilter(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    ((BaseFilter)localObject2).addParam(new Param.FloatsParam("shadowsShift", new float[] { 0.0F, 0.0F, -0.023529412F }));
    ((BaseFilter)localObject2).addParam(new Param.FloatsParam("midtonesShift", new float[] { 0.0F, 0.0F, -0.023529412F }));
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\filter\ttpic\MilkCoffeeFilter.class
