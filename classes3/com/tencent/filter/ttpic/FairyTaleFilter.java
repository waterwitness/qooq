  ...
  extends BaseFilter
{
  ...
  public void ApplyGLSLFilter(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    ((BaseFilter)localObject2).addParam(new Param.FloatsParam("shadowsShift", new float[] { -0.02745098F, 0.0F, 0.011764706F }));
    ((BaseFilter)localObject2).addParam(new Param.FloatsParam("midtonesShift", new float[] { -0.039215688F, 0.05882353F, 0.09803922F }));
    ((BaseFilter)localObject2).addParam(new Param.FloatsParam("highlightsShift", new float[] { -0.11764706F, 0.039215688F, 0.0F }));
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\filter\ttpic\FairyTaleFilter.class
