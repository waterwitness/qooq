  ...
  extends BaseFilter
{
  ...
  public void ApplyGLSLFilter(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    localBaseFilter1.addParam(new Param.FloatsParam("shadowsShift", new float[] { -0.11764706F * 0.45F, 0.0F, 0.19607843F * 0.346F }));
    localBaseFilter1.addParam(new Param.FloatsParam("midtonesShift", new float[] { -0.11764706F * 0.45F, 0.0F, 0.19607843F * 0.346F }));
    localBaseFilter1.addParam(new Param.FloatsParam("highlightsShift", new float[] { -0.2784314F * 0.45F, 0.0F, 0.39215687F * 0.346F }));
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\filter\ttpic\GaoGuangLanZiFilter.class
