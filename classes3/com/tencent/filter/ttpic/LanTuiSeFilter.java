  ...
  extends BaseFilter
{
  ...
  public void ApplyGLSLFilter(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    localBaseFilter2.addParam(new Param.FloatsParam("shadowsShift", new float[] { 0.0F, 0.0F, 0.064941175F }));
    localBaseFilter2.addParam(new Param.FloatsParam("midtonesShift", new float[] { 0.0F, 0.0F, 0.0F }));
    localBaseFilter2.addParam(new Param.FloatsParam("highlightsShift", new float[] { -0.15152942F, 0.0F, 0.08293334F }));
    ...
    localBaseFilter1.addParam(new Param.FloatParam("scaleC", -0.14400002F));
    ...
    localBaseFilter2.addParam(new Param.FloatsParam("color2", new float[] { 0.54901963F, 0.654902F, 0.69803923F, 1.0F }));
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\filter\ttpic\LanTuiSeFilter.class
