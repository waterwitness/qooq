  ...
  extends BaseFilter
{
  ...
  public void ApplyGLSLFilter(boolean paramBoolean, float paramFloat1, float paramFloat2)
  {
    ...
    localBaseFilter.addParam(new Param.FloatsParam("shadowsShift", new float[] { 0.0F, 0.0F, 0.039215688F }));
    localBaseFilter.addParam(new Param.FloatsParam("midtonesShift", new float[] { -0.05882353F, 0.0F, 0.0F }));
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\filter\ttpic\LightFilter.class
