...
public final class JpegDecompressor
{
    ...
    throws Exception
  {
    ...
    try
    {
      ...
      i = (int)(l & 0xFFFFFFFFFFFFFFFF);
      j = (int)(l >> 32 & 0xFFFFFFFFFFFFFFFF);
    }
    catch (UnsatisfiedLinkError paramArrayOfByte)
    {
      for (;;)
  ...
  int decompressRegionBitmap(Bitmap paramBitmap, Rect paramRect)
  {
    try
    {
      ...
      return (int)(0xFFFFFFFFFFFFFFFF & l);
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\pic\JpegDecompressor.class
