...
public class Face2FaceAddFriendAnim
{
  ...
  List d;
  List e;
  List f = Arrays.asList(new Integer[] { Integer.valueOf(2131297720), Integer.valueOf(2131297721), Integer.valueOf(2131297722), Integer.valueOf(2131297723), Integer.valueOf(2131297724), Integer.valueOf(2131297725), Integer.valueOf(2131297726), Integer.valueOf(2131297727), Integer.valueOf(2131297728), Integer.valueOf(2131297729) });
  int k = 1;
  public int l = -1;
  public int m;
  public int n;
  ...
  public void a(int paramInt, boolean paramBoolean)
  {
    ...
    for (long l1 = a(800, 1500);; l1 = 750L)
    {
      ...
      localRotateAnimation.setInterpolator(new rms(this));
      this.jdField_a_of_type_AndroidWidgetImageView.startAnimation(localRotateAnimation);
      localRotateAnimation.setAnimationListener(new rmq(this, paramInt, paramBoolean));
      return;
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, View paramView, int paramInt, String paramString)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131297716));
    if ((paramInt == 1) && (!TextUtils.isEmpty(paramString)))
    {
      ((ImageView)paramView.findViewById(2131297714)).setVisibility(4);
      this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130838527);
    ...
    for (;;)
    {
      paramString = (ImageView)paramView.findViewById(2131297715);
  ...
  public void a(Face2FaceUserData paramFace2FaceUserData, boolean paramBoolean)
  {
    ...
    for (int i1 = ((Integer)this.jdField_a_of_type_JavaUtilMap.get(localObject)).intValue();; i1 = -1)
    {
      ...
      if (paramBoolean)
      {
        ...
        localAnimationSet.setInterpolator(new rmu(this));
        localAnimationSet.setAnimationListener(new rmp(this));
        if (localObject != null) {
  ...
  public void a(Face2FaceUserData paramFace2FaceUserData, boolean paramBoolean1, int paramInt, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    for (;;)
    {
      ...
      default: 
        ...
        ((TranslateAnimation)localObject2).setInterpolator(new rmu(this));
        ((TranslateAnimation)localObject2).setAnimationListener(new rmo(this, paramFace2FaceUserData, i1, d1, bool, paramBoolean3, paramFace2FaceUserData, paramBoolean1, paramBoolean2, (Face2FaceFriendBubbleView)localObject1, paramInt));
  ...
  public void b()
  {
    ...
    for (this.jdField_b_of_type_Float = (this.jdField_a_of_type_Float - i1);; this.jdField_b_of_type_Float = (i1 + f2))
    {
      ...
      this.jdField_a_of_type_AndroidViewAnimationRotateAnimation.setInterpolator(new rms(this));
      this.jdField_a_of_type_AndroidWidgetImageView.startAnimation(this.jdField_a_of_type_AndroidViewAnimationRotateAnimation);
      this.jdField_a_of_type_AndroidViewAnimationRotateAnimation.setAnimationListener(new rmr(this));
      return;
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\facetoface\Face2FaceAddFriendAnim.class
