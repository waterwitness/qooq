  ...
  extends FrameLayout
{
  ...
  private static final int[] jdField_a_of_type_ArrayOfInt = { 2131298234, 2131298238 };
  ...
  private Animation.AnimationListener jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new rmx(this);
  ...
  private Animation.AnimationListener jdField_b_of_type_AndroidViewAnimationAnimation$AnimationListener = new rmy(this);
  ...
  public Face2FaceFriendBubbleView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    ((LayoutInflater)paramContext.getSystemService("layout_inflater")).inflate(2130903354, this);
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)findViewById(2131298232));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131298235));
    this.jdField_b_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131298239));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131298234);
    this.c = ((ImageView)findViewById(2131298236));
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)findViewById(2131298237));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131298240));
    this.jdField_a_of_type_AndroidWidgetTextView.setContentDescription("");
    this.jdField_a_of_type_AndroidViewAnimationAnimation = AnimationUtils.loadAnimation(paramContext, 2130968619);
    this.jdField_b_of_type_AndroidViewAnimationAnimation = AnimationUtils.loadAnimation(paramContext, 2130968618);
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      while (k < m)
      {
        ...
        if (n == 0)
        {
          Animation localAnimation = AnimationUtils.loadAnimation(BaseApplicationImpl.getContext(), 2130968616);
          localAnimation.setAnimationListener(new rmz(this, 1, localView));
  ...
  public void a(QQAppInterface paramQQAppInterface, Face2FaceUserData paramFace2FaceUserData)
  {
    ...
    for (;;)
    {
      ...
      if (this.h < 1)
      {
        this.i = BaseApplicationImpl.getContext().getResources().getDimensionPixelSize(2131493489);
        this.h = BaseApplicationImpl.getContext().getResources().getDrawable(2130838563).getIntrinsicWidth();
      }
  ...
  public void b()
  {
    ...
    while (k < m)
    {
      ...
      {
        Animation localAnimation = AnimationUtils.loadAnimation(BaseApplicationImpl.getContext(), 2130968617);
        localAnimation.setAnimationListener(new rmz(this, 0, localView));
        localView.startAnimation(localAnimation);
      }
      k += 1;
    }
  ...
  public void setStatusWithoutAnimation(int paramInt)
  {
    ...
    case 3: 
      this.j = paramInt;
      this.jdField_a_of_type_AndroidWidgetProgressBar.setVisibility(8);
      this.c.setImageResource(2130838545);
      this.c.setVisibility(0);
      this.jdField_a_of_type_AndroidViewView.setVisibility(0);
      return;
    }
    ...
    this.c.setImageResource(2130838546);
    this.c.setVisibility(0);
    this.jdField_a_of_type_AndroidViewView.setVisibility(0);
  }
}
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\facetoface\Face2FaceFriendBubbleView.class
