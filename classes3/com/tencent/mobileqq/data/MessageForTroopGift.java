  ...
  extends MessageForDeliverGiftTips
{
  ...
  {
    // Byte code:
    //   0: new 133	java/io/ObjectInputStream
    //   3: dup
    //   4: new 135	java/io/ByteArrayInputStream
    //   7: dup
    //   8: aload_0
    //   9: getfield 139	com/tencent/mobileqq/data/MessageForTroopGift:msgData	[B
    //   12: invokespecial 142	java/io/ByteArrayInputStream:<init>	([B)V
    ...
    //   21: aload_0
    //   22: aload_2
    //   23: invokespecial 147	com/tencent/mobileqq/data/MessageForTroopGift:readExternal	(Ljava/io/ObjectInput;)V
    //   26: aload_2
    //   27: astore_1
    //   28: aload_0
    //   29: aload_0
    //   30: getfield 87	com/tencent/mobileqq/data/MessageForTroopGift:summary	Ljava/lang/String;
    //   33: putfield 150	com/tencent/mobileqq/data/MessageForTroopGift:msg	Ljava/lang/String;
    //   36: aload_2
    //   37: ifnull +7 -> 44
    //   40: aload_2
    //   41: invokevirtual 153	java/io/ObjectInputStream:close	()V
    //   44: return
    //   45: astore_1
    //   46: aload_1
    //   47: invokevirtual 156	java/lang/Exception:printStackTrace	()V
    //   50: return
    //   51: astore_3
    //   52: aconst_null
    //   53: astore_2
    //   54: aload_2
    //   55: astore_1
    //   56: invokestatic 98	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   59: ifeq +14 -> 73
    //   62: aload_2
    //   63: astore_1
    //   64: ldc 100
    ...
    //   67: ldc -98
    //   69: aload_3
    //   70: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   73: aload_2
    //   74: ifnull -30 -> 44
    //   77: aload_2
    //   78: invokevirtual 153	java/io/ObjectInputStream:close	()V
    //   81: return
    //   82: astore_1
    //   83: aload_1
    //   84: invokevirtual 156	java/lang/Exception:printStackTrace	()V
    //   87: return
    //   88: astore_2
    //   89: aconst_null
    //   90: astore_1
    ...
    //   92: ifnull +7 -> 99
    //   95: aload_1
    //   96: invokevirtual 153	java/io/ObjectInputStream:close	()V
    //   99: aload_2
    //   100: athrow
    //   101: astore_1
    //   102: aload_1
    //   103: invokevirtual 156	java/lang/Exception:printStackTrace	()V
    //   106: goto -7 -> 99
    //   109: astore_2
    //   110: goto -19 -> 91
    //   113: astore_3
    ...
    //   0	117	0	this	MessageForTroopGift
  ...
  public void prewrite()
  {
    ...
    //   21: aload_0
    //   22: aload_2
    //   23: invokespecial 193	com/tencent/mobileqq/data/MessageForTroopGift:writeExternal	(Ljava/io/ObjectOutput;)V
    //   26: aload_2
    //   27: astore_1
    //   28: aload_2
    ...
    //   40: putfield 139	com/tencent/mobileqq/data/MessageForTroopGift:msgData	[B
    //   43: aload_2
    //   44: ifnull +7 -> 51
    //   47: aload_2
    ...
    //   61: return
    //   62: astore_1
    //   63: invokestatic 98	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   66: ifeq -15 -> 51
    //   69: ldc 100
    //   71: iconst_2
    //   72: ldc -55
    //   74: aload_1
    //   75: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   78: goto -27 -> 51
    //   81: astore_1
    //   82: invokestatic 98	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   85: ifeq -24 -> 61
    //   88: ldc 100
    //   90: iconst_2
    //   91: ldc -55
    //   93: aload_1
    //   94: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   97: return
    //   98: astore_3
    //   99: aconst_null
    //   100: astore_2
    //   101: aload_2
    //   102: astore_1
    //   103: invokestatic 98	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   106: ifeq +14 -> 120
    //   109: aload_2
    //   110: astore_1
    //   111: ldc 100
    ...
    //   114: ldc -55
    //   116: aload_3
    //   117: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   120: aload_2
    //   121: ifnull +7 -> 128
    //   124: aload_2
    ...
    //   138: return
    //   139: astore_1
    //   140: invokestatic 98	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   143: ifeq -82 -> 61
    //   146: ldc 100
    //   148: iconst_2
    //   149: ldc -55
    //   151: aload_1
    //   152: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   155: return
    //   156: astore_1
    //   157: invokestatic 98	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   160: ifeq -32 -> 128
    //   163: ldc 100
    //   165: iconst_2
    //   166: ldc -55
    //   168: aload_1
    //   169: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   172: goto -44 -> 128
    //   175: astore_2
    //   176: aconst_null
    //   177: astore_1
    ...
    //   197: athrow
    //   198: astore_1
    //   199: invokestatic 98	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   202: ifeq -16 -> 186
    //   205: ldc 100
    //   207: iconst_2
    //   208: ldc -55
    //   210: aload_1
    //   211: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   214: goto -28 -> 186
    //   217: astore_1
    //   218: invokestatic 98	com/tencent/qphone/base/util/QLog:isColorLevel	()Z
    //   221: ifeq -25 -> 196
    //   224: ldc 100
    //   226: iconst_2
    //   227: ldc -55
    //   229: aload_1
    //   230: invokestatic 106	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;Ljava/lang/Throwable;)V
    //   233: goto -37 -> 196
    //   236: astore_2
    //   237: goto -59 -> 178
    //   240: astore_3
    ...
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	244	0	this	MessageForTroopGift
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\data\MessageForTroopGift.class
