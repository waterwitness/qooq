  ...
  implements Cloneable
{
  ...
  {
    return (paramDataLineMsgRecord.msgtype == 63536) || (paramDataLineMsgRecord.msgtype == 63531) || (paramDataLineMsgRecord.msgtype == 63527) || (paramDataLineMsgRecord.msgtype == 63201);
  }
  ...
  {
    return (paramDataLineMsgRecord.groupId == 0) || (paramDataLineMsgRecord.msgtype == 63531) || (paramDataLineMsgRecord.msgtype == 63527);
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      do
      {
        ...
        if (((DataLineMsgSet)paramObject).getTotalCount() != getTotalCount()) {
          return false;
        }
        if (!((DataLineMsgSet)paramObject).isSingle()) {
          break;
        }
      } while (paramObject.mSet[0].sessionid == this.mSet[0].sessionid);
      return false;
    } while (((DataLineMsgSet)paramObject).getGroupId() == getGroupId());
    return false;
  }
  ...
  {
    return (this.groupType == 63536) || (this.groupType == 63531) || (this.groupType == 63527) || (this.groupType == 63201);
  }
  ...
  {
    return (this.groupId == 0) || (this.groupType == 63531) || (this.groupType == 63527);
  }
  ...
  public DataLineMsgRecord put(Integer paramInteger, DataLineMsgRecord paramDataLineMsgRecord)
  {
    for (;;)
    {
      try
      {
        ...
        {
          if ((this.groupType != 63536) || ((paramDataLineMsgRecord.msgtype != 63531) && (paramDataLineMsgRecord.msgtype != 63527))) {
            continue;
          }
          this.groupType = 63531;
          continue;
        }
        if (this.mSet != null) {
          break label248;
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\data\DataLineMsgSet.class
