  ...
  extends Entity
{
  ...
  {
    this.locindex = (paramInt1 << 62 - paramInt2 * 2 | (3L << 62 - paramInt2 * 2 ^ 0xFFFFFFFFFFFFFFFF) & this.locindex);
  }
  
  private void setSerTwoBits(int paramInt1, int paramInt2)
  {
    this.serindex = (paramInt1 << 62 - paramInt2 * 2 | (3L << 62 - paramInt2 * 2 ^ 0xFFFFFFFFFFFFFFFF) & this.serindex);
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    do
    {
      do
      {
        ...
        if (this.uin == null)
        {
          if (((RoamDate)paramObject).uin != null) {
            return false;
          }
        }
        else if (!this.uin.equals(((RoamDate)paramObject).uin)) {
          return false;
        }
        if (this.date != null) {
          break;
        }
      } while (((RoamDate)paramObject).date == null);
      return false;
    } while (this.date.equals(((RoamDate)paramObject).date));
    return false;
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\data\RoamDate.class
