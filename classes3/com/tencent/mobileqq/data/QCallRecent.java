  ...
  public boolean equals(Object paramObject)
  {
    ...
    if (paramObject != null)
    {
      ...
      if ((paramObject instanceof QCallRecent))
      {
        ...
        if ((((QCallRecent)paramObject).uin != null) || (this.type != ((QCallRecent)paramObject).type)) {
          break label56;
        }
        bool1 = bool2;
      }
    ...
    do
    {
      do
      {
        do
        {
          ...
          if ((this.uin.equals(((QCallRecent)paramObject).uin)) && (this.type == ((QCallRecent)paramObject).type)) {
            break;
          }
          bool1 = bool3;
        } while (!this.uin.equals(((QCallRecent)paramObject).uin));
        bool1 = bool3;
      } while (!MsgProxyUtils.c(this.type));
      bool1 = bool3;
    } while (!MsgProxyUtils.c(((QCallRecent)paramObject).type));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\data\QCallRecent.class
