...
{
  public static final Parcelable.Creator CREATOR = new rbw();
  ...
  public void doParse()
  {
    localObject = new RichMsg.PicRec();
    try
    {
    ...
    catch (Exception localException2)
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if ((this.isShareAppActionMsg) || (this.msgtype == 62535) || (this.msgtype == 35534) || (this.msgtype == 35533) || (this.msgtype == 64504))
          {
            bool = true;
            this.isMixed = bool;
            ...
            this.bigThumbMsgUrl = ((TranDbRecord.PicDbRecord)localObject).jdField_i_of_type_JavaLangString;
        ...
        File localFile = AbsDownloader.a(URLDrawableHelper.a(this, 65537, null).toString());
        if ((localFile != null) && (GifDrawable.isGifFile(localFile))) {
          this.imageType = 2000;
        }
      }
    }
    if (i != 0)
    {
      ...
      this.bigThumbMsgUrl = ((RichMsg.PicRec)localObject).bigthumbMsgUrl.get();
      ...
      this.bEnableEnc = ((RichMsg.PicRec)localObject).enableEnc.get();
  ...
  public RichMsg.PicRec getSerialPB()
  {
    ...
    if (this.path != null)
    {
      ...
      ((PBStringField)localObject1).set(str);
      localObject1 = localPicRec.bigthumbMsgUrl;
      if (this.bigThumbMsgUrl == null) {
        break label637;
      }
      str = this.bigThumbMsgUrl;
      ((PBStringField)localObject1).set(str);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\data\MessageForPic.class
