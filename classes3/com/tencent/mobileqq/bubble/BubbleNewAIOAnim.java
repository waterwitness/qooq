  ...
  extends AIOAnimationConatiner.AIOAnimator
{
      ...
      for (;;)
      {
        ...
        for (paramString = f((BubbleNewAnimConf.PathAnimConf)paramString);; paramString = null)
        {
          if ((paramAnimator != null) && (paramString != null))
          {
            ...
            paramAnimator.addListener(new quc(this, paramString));
          }
          return i1;
          i1 += 1;
          break;
  ...
  private ObjectAnimator b(BubbleNewAnimConf.PendantAnimConf paramPendantAnimConf)
  {
    ...
    if (localObjectAnimator != null) {
      localObjectAnimator.addListener(new que(this, paramPendantAnimConf));
    }
  ...
  private void e()
  {
    ...
    for (;;)
    {
      if (i1 < localViewGroup.getChildCount())
      {
        ...
        if ((localView.getId() == 2131296330) && (localView.getVisibility() == 0))
        {
  ...
  private ObjectAnimator f(BubbleNewAnimConf.PathAnimConf paramPathAnimConf)
  {
    ...
    for (;;)
    {
      localObjectAnimator1.addListener(new qud(this, localObjectAnimator2));
  ...
  private void f()
  {
    this.jdField_d_of_type_Int = (this.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.m);
    this.jdField_e_of_type_Int = (this.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.m);
    this.jdField_f_of_type_Int = (this.jdField_a_of_type_AndroidViewView.getTop() + BaseChatItemLayout.k);
    this.jdField_g_of_type_Int = (this.jdField_a_of_type_AndroidViewView.getBottom() - BaseChatItemLayout.l);
    ...
    {
      this.jdField_d_of_type_Int = (this.jdField_a_of_type_AndroidViewView.getLeft() + BaseChatItemLayout.m - this.i / 3);
      this.jdField_e_of_type_Int = (this.jdField_a_of_type_AndroidViewView.getRight() - BaseChatItemLayout.m + this.i / 3);
      this.jdField_f_of_type_Int = (this.jdField_a_of_type_AndroidViewView.getTop() + BaseChatItemLayout.k - this.j / 3);
      this.jdField_g_of_type_Int = (this.jdField_a_of_type_AndroidViewView.getBottom() - BaseChatItemLayout.l + this.j / 3);
    }
  }
  ...
  private void g()
  {
    ...
    for (Object localObject1 = (BubbleNewAnimConf.PathAnimConf)localObject1;; localObject1 = null)
    {
      ...
      if (this.i > BaseChatItemLayout.m * 2)
      {
        i1 = BaseChatItemLayout.m * 2;
    ...
    for (Object localObject = (BubbleNewAnimConf.PathAnimConf)localObject;; localObject = null)
    {
      ...
      for (;;)
      {
        ...
        if ((localObject instanceof BubbleNewAnimConf.PendantAnimConf))
        {
          ...
          this.jdField_a_of_type_AndroidAnimationAnimatorSet.addListener(new qua(this));
          this.jdField_a_of_type_AndroidOsHandler.post(new qub(this));
          return;
        }
        else
        {
  ...
  private void i()
  {
    ThreadManager.a(new quf(this), 5, null, true);
  }
  ...
  public void a(boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqActivityAioBaseBubbleBuilder$ViewHolder != null)
      {
        ...
        {
          if ((localObject == null) || (!this.jdField_a_of_type_ComTencentMobileqqBubbleAnimationConfig.d)) {
            break label90;
          }
          ...
          ((VipBubbleDrawable)localObject).d(true);
          return;
        }
      }
    }
    label92:
    ((VipBubbleDrawable)localObject).d(false);
  }
  ...
  protected void c()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new qtz(this));
  }
  ...
  public void setBitmapData(BubbleNewAIOAnim.AnimPicData paramAnimPicData)
  {
    ...
    do
    {
      do
      {
        ...
        {
          localObject = new qtr(paramAnimPicData.jdField_a_of_type_AndroidGraphicsBitmap);
          ((qtr)localObject).jdField_a_of_type_Boolean = paramAnimPicData.jdField_a_of_type_JavaLangBoolean.booleanValue();
    ...
    Object localObject = new qtr((Bitmap)localObject);
    ((qtr)localObject).jdField_a_of_type_Boolean = paramAnimPicData.jdField_a_of_type_JavaLangBoolean.booleanValue();
    this.jdField_c_of_type_AndroidViewView.setBackgroundDrawable((Drawable)localObject);
    this.jdField_a_of_type_JavaLangString = paramAnimPicData.jdField_a_of_type_JavaLangString;
    this.jdField_c_of_type_AndroidViewView.invalidate();
  ...
  public void setPathLocation(PathPoint paramPathPoint)
  {
    ...
    {
      f2 = paramPathPoint.jdField_b_of_type_Float;
      f3 = this.jdField_b_of_type_AndroidViewView.getTop();
      f4 = this.jdField_a_of_type_ComTencentWidgetListView.getScrollY();
      if ((this.jdField_c_of_type_Int <= this.jdField_a_of_type_ComTencentWidgetListView.t()) && (this.jdField_c_of_type_Int >= this.jdField_a_of_type_ComTencentWidgetListView.s())) {
        break;
      }
      a("setPathLocation: now scroll over sreen, stop bubble animatorset!");
      a("now listview firstVisible postion: " + this.jdField_a_of_type_ComTencentWidgetListView.s() + ", last postion: " + this.jdField_a_of_type_ComTencentWidgetListView.t() + ", now msg pos: " + this.jdField_c_of_type_Int);
      c();
      return;
    }
    this.jdField_c_of_type_AndroidViewView.setTranslationX(f1);
    this.jdField_c_of_type_AndroidViewView.setTranslationY(f2 + f3 - f4);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\bubble\BubbleNewAIOAnim.class
