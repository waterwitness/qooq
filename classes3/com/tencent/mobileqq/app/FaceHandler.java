  ...
  extends BusinessHandler
{
  ...
  private static final String jdField_a_of_type_JavaLangString = "Q.qqhead.FaceHandler";
  ...
  private void a(int paramInt, ArrayList paramArrayList)
  {
    ...
    for (int i = 1;; i = 0)
    {
      ...
      ((MultiHeadUrl.MultiBusidUrlReq)localObject1).srcUin.set(Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.a()));
      ...
      if (j < paramArrayList.size())
      {
        ...
        for (;;)
        {
          try
          {
            ...
            ((FaceInfo)localObject2).a(FaceInfo.k);
          }
      ...
      if (QLog.isColorLevel())
      {
        ...
        ((StringBuilder)localObject3).append("QQHead_Stranger request.srcUidType=" + ((MultiHeadUrl.MultiBusidUrlReq)localObject1).srcUidType.get()).append(";srcUin=" + this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.a()).append("\n\n").append(";dstUsrType=" + ((MultiHeadUrl.MultiBusidUrlReq)localObject1).dstUsrType.get()).append(";dstUidType=" + ((MultiHeadUrl.MultiBusidUrlReq)localObject1).dstUidType.get()).append("\n\n").append(";uinset={");
        if (paramArrayList != null)
        {
          i = k;
          while (i < paramArrayList.size())
  ...
  public void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    catch (Exception localException)
    {
      ...
      paramFromServiceMsg.append("QQHead_Stranger response.srcUidType=" + ((MultiHeadUrl.MultiBusidUrlRsp)paramObject).srcUidType.get()).append(";srcUin=" + ((MultiHeadUrl.MultiBusidUrlRsp)paramObject).srcUin.get()).append("\n\n").append(";srcTid=" + ((MultiHeadUrl.MultiBusidUrlRsp)paramObject).srcTid.get()).append(";srcOpenid=" + ((MultiHeadUrl.MultiBusidUrlRsp)paramObject).srcOpenid.get()).append("\n\n").append(";dstUidType=" + ((MultiHeadUrl.MultiBusidUrlRsp)paramObject).dstUidType.get()).append(";result=" + ((MultiHeadUrl.MultiBusidUrlRsp)paramObject).result.get()).append("\n\n");
      localObject2 = ((MultiHeadUrl.MultiBusidUrlRsp)paramObject).dstUsrHeadInfos.get();
      ...
      localObject4 = ((MultiHeadUrl.MultiBusidUrlRsp)paramObject).dstUsrHeadInfos.get();
      localObject3 = new ArrayList();
      paramFromServiceMsg = paramToServiceMsg.extraData.getParcelableArrayList("list");
      localArrayList = new ArrayList();
      k = ((MultiHeadUrl.MultiBusidUrlRsp)paramObject).dstUidType.get();
    ...
    if ((paramFromServiceMsg == null) || (paramFromServiceMsg.getResultCode() != 1000) || (paramObject == null) || (((MultiHeadUrl.MultiBusidUrlRsp)paramObject).result.get() != 0))
    {
      ...
      if (paramObject != null)
      {
        i = ((MultiHeadUrl.MultiBusidUrlRsp)paramObject).result.get();
    ...
    for (;;)
    {
      ...
      if ((i == 32) && (((MultiHeadUrl.RspHeadInfo)localObject2).faceType.get() != 0))
      {
        ...
        for (paramToServiceMsg = paramToServiceMsg.headVerify.get();; paramToServiceMsg = "")
        {
          ...
          QLog.d("Q.qqhead.FaceHandler", 2, "there is no headinfo uin=" + (String)paramObject);
          break label921;
          break;
          if (paramFromServiceMsg != null)
          {
    ...
    for (;;)
    {
      ...
      if (!bool3)
      {
        ...
        if (!this.jdField_a_of_type_Boolean)
        {
          ...
          ContactConfig.a(this.jdField_a_of_type_ComTencentMobileqqNearbyNearbyAppInterface.a().getApplicationContext(), true);
          return bool1;
          label208:
          bool1 = false;
        }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\app\FaceHandler.class
