  ...
  implements LiteTransferListenerCallback, LiteTransferOperatorCallback
{
  ...
  private static final String jdField_a_of_type_JavaLangString = "dataline.Router";
  ...
  public RouterHandler(QQAppInterface paramQQAppInterface)
  {
    ...
    this.jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper = new ProtocolHelper(this.c, 1);
    ...
    paramQQAppInterface.addAction("mqq.intent.action.EXIT_" + this.c.a().getPackageName());
    ...
    this.c.a().registerReceiver(this.jdField_a_of_type_ComTencentMobileqqAppRouterHandler$NotifyReceiver, paramQQAppInterface);
  }
  
  public static long a()
  {
    return ((SmartDeviceProxyMgr)((QQAppInterface)BaseApplicationImpl.a().a()).a(51)).a();
  }
  
  private void a(int paramInt, FTNNotify paramFTNNotify, long paramLong)
  {
    paramFTNNotify = this.jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper.MsgBodyFromFTNNotify(paramFTNNotify, paramLong, AppConstants.aj, 1).toByteArray();
    ((SmartDeviceProxyMgr)this.c.a(51)).a(paramLong, paramInt, paramFTNNotify);
  }
  
  private void a(int paramInt, FileControl paramFileControl, long paramLong)
  {
    paramFileControl = this.jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper.MsgBodyFromFileControl(paramFileControl, paramLong, AppConstants.aj, 3).toByteArray();
    ((SmartDeviceProxyMgr)this.c.a(51)).a(paramLong, paramInt, paramFileControl);
  }
  ...
  private void a(int paramInt, MsgCSBody0x346 paramMsgCSBody0x346)
  {
    ...
    ((SmartDeviceProxyMgr)this.c.a(51)).a(paramMsgCSBody0x346.uMsgSubType, paramInt, localReqBody.toByteArray());
  }
  
  private void a(int paramInt, NFCNotify paramNFCNotify, long paramLong)
  {
    paramNFCNotify = this.jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper.MsgBodyFromNFCNotify(paramNFCNotify, paramLong, AppConstants.aj, 2).toByteArray();
    ((SmartDeviceProxyMgr)this.c.a(51)).a(paramLong, paramInt, paramNFCNotify);
  }
  ...
  private void a(RouterMsgRecord paramRouterMsgRecord, boolean paramBoolean)
  {
    ...
    boolean bool = false;
    QQMessageFacade localQQMessageFacade = this.c.a();
  ...
  private void b(SubMsgType0x7.MsgBody.MsgHeader paramMsgHeader, List paramList, boolean paramBoolean)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((localFTNNotify.uint64_sessionid.has()) && (localFTNNotify.uint32_originfiletype.has()) && (localFTNNotify.str_file_name.has()) && (localFTNNotify.uint64_file_len.has()) && (localFTNNotify.bytes_file_md5.has()) && (localFTNNotify.str_file_index.has()) && (this.jdField_a_of_type_ComTencentLitetransfersdkProtocolHelper.CheckActionInfo(localFTNNotify, this.b))) {
        localArrayList.add(localFTNNotify);
      }
    }
    if (localArrayList.size() > 0) {
      new Handler(Looper.getMainLooper()).post(new qfp(this, paramMsgHeader, localArrayList, paramBoolean));
    }
  }
  ...
  private void c(String paramString)
  {
    ...
    {
      return;
      EntityManager localEntityManager = this.c.a().createEntityManager();
      paramString = this.c.a().a().a(paramString, 6002);
  ...
  private void d(RouterMsgRecord paramRouterMsgRecord)
  {
    ...
    RecentUserProxy localRecentUserProxy = this.c.a().a();
  ...
  {
    if (paramInt2 == 5) {
      new Handler(Looper.getMainLooper()).post(new qfq(this, paramLong, paramMsgHeader));
    }
  }
  
  public void InvokeReport(ReportItem paramReportItem)
  {
    QualityReportUtil.a(this.c, paramReportItem, QualityReportUtil.d);
  }
  ...
  public void OnSessionComplete(long paramLong, int paramInt1, int paramInt2)
  {
    ...
    new Handler(Looper.getMainLooper()).post(new qfu(this, paramLong, paramInt1));
  }
  
  public void OnSessionNew(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo)
  {
    new Handler(Looper.getMainLooper()).post(new qfr(this, paramSession));
  }
  
  public void OnSessionProgress(long paramLong1, long paramLong2, long paramLong3)
  {
    new Handler(Looper.getMainLooper()).post(new qft(this, paramLong1, paramLong2, paramLong3));
  }
  
  public void OnSessionStart(long paramLong)
  {
    new Handler(Looper.getMainLooper()).post(new qfs(this, paramLong));
  }
  ...
  public int a(String paramString, int paramInt)
  {
    ...
    Object localObject1 = this.c.a().createEntityManager();
    ...
    if (paramString != null)
    {
      ...
      if (paramInt < paramString.size())
      {
        ...
        localObject2 = (RouterMsgRecord)this.d.get(Long.valueOf(((RouterMsgRecord)localObject1).uSessionID));
        if (localObject2 == null)
        {
          if (((RouterMsgRecord)localObject1).status < 3) {
            ((RouterMsgRecord)localObject1).status = 4;
          }
          this.d.put(Long.valueOf(((RouterMsgRecord)localObject1).uSessionID), localObject1);
  ...
  public Session a(MessageForDeviceFile paramMessageForDeviceFile)
  {
    ...
    for (;;)
    {
      ...
      localSession.emFileType = c(paramMessageForDeviceFile.msgtype);
      ...
      if ((QLog.isDevelopLevel()) && (paramMessageForDeviceFile.md5 != null)) {
        QLog.d("dataline.Router", 4, "getSessionFromMsgRecord, uSessionID[" + paramMessageForDeviceFile.uSessionID + "], strMR[" + HexUtil.a(paramMessageForDeviceFile.md5) + "], filesize[" + paramMessageForDeviceFile.fileSize);
      }
  ...
  {
    QQMessageFacade.Message localMessage = new QQMessageFacade.Message();
    ProxyManager localProxyManager = this.c.a();
    EntityManager localEntityManager = this.c.a().createEntityManager();
  ...
  {
    DeviceInfo localDeviceInfo = ((SmartDeviceProxyMgr)this.c.a(51)).a(paramLong);
    if (localDeviceInfo == null) {
      return BaseApplication.getContext().getString(2131362323);
    }
  ...
  public void a(int paramInt1, Session paramSession, double paramDouble, int paramInt2)
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        SmartDeviceProxyMgr localSmartDeviceProxyMgr = (SmartDeviceProxyMgr)this.c.a(51);
        if (paramSession.msgHeader.uint64_src_uin == localSmartDeviceProxyMgr.a())
        {
          ...
          ((RouterMsgRecord)localObject).msgtype = d(paramSession.emFileType);
  ...
  public void a(Session paramSession, NFCInfo paramNFCInfo, FTNInfo paramFTNInfo, boolean paramBoolean)
  {
    ...
    {
      l = paramSession.msgHeader.uint64_dst_uin;
      localMessageForDeviceFile = (MessageForDeviceFile)MessageRecordFactory.a(61036);
      localMessageForDeviceFile.uniseq = paramSession.uSessionID;
      localMessageForDeviceFile.msgtype = 61036;
      ...
      localMessageForDeviceFile.msg = this.c.a().getString(2131369800);
      if (!paramSession.bSend) {
        break label616;
      }
      i = 0;
      ...
      localMessageForDeviceFile.selfuin = this.c.a();
      ...
      localMessageForDeviceFile.msg = this.c.a().getString(2131369796);
    }
    for (;;)
    {
      ...
      ((DeviceMsgHandle)this.c.a(49)).a().a(paramSession.uSessionID, localMessageForDeviceFile.frienduin, localMessageForDeviceFile.istroop, localMessageForDeviceFile.uniseq);
      this.c.a().a(localMessageForDeviceFile, this.c.a());
      return;
      l = paramSession.msgHeader.uint64_src_uin;
      break;
      label616:
      ...
      break label151;
      label622:
      if (DeviceMsgHandle.l.equalsIgnoreCase(paramSession.actionInfo.strServiceName))
      {
  ...
  public void a(RouterMsgRecord paramRouterMsgRecord)
  {
    ...
    this.d.remove(Long.valueOf(paramRouterMsgRecord.uSessionID));
    this.c.a().a(String.valueOf(0), 0, paramRouterMsgRecord.getTableName(), "msgId=?", new String[] { String.valueOf(paramRouterMsgRecord.msgId) }, 2, null);
  ...
  public void a(ArrayList paramArrayList, boolean paramBoolean, String paramString, byte[] paramArrayOfByte, long paramLong)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (localSession != null)
      {
        ...
        localArrayList.add(localSession);
        if ((paramBoolean) && (this.e.get(Long.valueOf(localSession.uSessionID)) == null)) {
  ...
  public boolean a(long paramLong1, long paramLong2, long paramLong3, int paramInt1, int paramInt2)
  {
    ...
    return ((SmartDeviceProxyMgr)this.c.a(51)).a(localMsgBody.msg_header.uint64_dst_uin.get(), 1, arrayOfByte);
  }
  ...
  public boolean a(List paramList)
  {
    ...
    for (;;)
    {
      ...
      ((DeviceMsgHandle)this.c.a(49)).a().a(localMessageForDeviceFile.uSessionID, localMessageForDeviceFile.frienduin, localMessageForDeviceFile.istroop, localMessageForDeviceFile.uniseq);
      ((DeviceFileHandler)this.c.a(50)).a((Session)localObject5);
  ...
  void b()
  {
    ...
    if (Thread.currentThread() != localLooper.getThread()) {
      new Handler(localLooper).post(new qfv(this));
    }
  ...
  public void b(Session paramSession)
  {
    ...
    if ((paramSession.dwGroupID == 0) && (paramSession.bSend) && (paramSession.emFileType == 1) && (str != null) && (new File(str).exists())) {
      URLDrawable.getDrawable(AsyncImageView.a(str, this.f, this.g, true), null, null, false).downloadImediatly();
    }
  }
  ...
  public void c()
  {
    ...
    for (Object localObject1 = null; ((Iterator)localObject2).hasNext(); localObject1 = ((RouterMsgRecord)localObject1).getTableName())
    {
      ...
      this.d.remove(Long.valueOf(((RouterMsgRecord)localObject1).uSessionID));
    }
  ...
  public void g()
  {
    if ((this.c != null) && (this.c.a() != null) && (this.jdField_a_of_type_ComTencentMobileqqAppRouterHandler$NotifyReceiver != null))
    {
      this.c.a().unregisterReceiver(this.jdField_a_of_type_ComTencentMobileqqAppRouterHandler$NotifyReceiver);
  ...
  {
    return this.c.getPreferences().getBoolean("auto_receive_files", false);
  }
}


/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\app\RouterHandler.class
