...
{
  public static final String a = "QPayHandler";
  public static final String b = "QPayReminderSvc.query_over_due_info";
  private String c;
  ...
  private void a(int paramInt1, int paramInt2, String paramString1, String paramString2)
  {
    ...
    BaseActivity.sTopActivity.overridePendingTransition(2130968793, 2130968589);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      localObject = this.b.a() + ":" + SimpleDateFormat.getDateInstance().format(new Date());
      if ((this.c != null) && (this.c.equals(localObject))) {
        if (QLog.isColorLevel()) {
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\app\QPayHandler.class
