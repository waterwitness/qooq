  ...
  extends BusinessHandler
{
  ...
  private void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
      ...
      if (i == 1000)
      {
        ...
        catch (InvalidProtocolBufferMicroException paramObject)
        {
          for (;;)
          {
            ...
            StatisticCollector.a(BaseApplication.getContext()).a(this.b.a(), "actSBDBindProtol", false, 0L, 0L, paramToServiceMsg, "");
            ...
            try
            {
              paramObject = (oidb_0x7a0.RspBody)paramFromServiceMsg.mergeFrom((byte[])paramObject);
              paramFromServiceMsg = (FromServiceMsg)paramObject;
            ...
            catch (InvalidProtocolBufferMicroException paramObject)
            {
              ...
              StatisticCollector.a(BaseApplication.getContext()).a(this.b.a(), "actSBDBindProtol", true, 0L, 0L, paramFromServiceMsg, "");
              try
              {
        ...
        if (paramFromServiceMsg == null)
        {
          ...
          paramFromServiceMsg.put("fail_location", "bindhandle");
          StatisticCollector.a(BaseApplication.getContext()).a(this.b.a(), "actSBDBindProtol", false, 0L, 0L, paramFromServiceMsg, "");
          bool2 = bool1;
          if (QLog.isColorLevel())
          {
    ...
    for (;;)
    {
      ...
      label1009:
      label1086:
      StatisticCollector.a(BaseApplication.getContext()).a(this.b.a(), "actSBDBindProtol", bool1, 0L, 0L, paramToServiceMsg, "");
  ...
  private void c(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    if (paramToServiceMsg != null)
    {
      ...
      try
      {
        ...
        StatisticCollector.a(BaseApplication.getContext()).a(this.b.a(), "actSBUnbindProtol", false, 0L, 0L, paramToServiceMsg, "");
        localSubAccountBackProtocData.p = 1000;
      ...
      if (i == 1000)
      {
        ...
        if (paramToServiceMsg == null)
        {
          ...
          StatisticCollector.a(BaseApplication.getContext()).a(this.b.a(), "actSBUnbindProtol", false, 0L, 0L, paramFromServiceMsg, "");
          bool2 = bool1;
          if (QLog.isColorLevel())
          {
      ...
      for (;;)
      {
        ...
        if ((i == 1200) || (i == 1214) || (i == 1215) || (i == 1218) || (i == 1232) || (i == 1233) || (i == 1240) || (i == 1241) || (i == 1242))
        {
          ...
          if ((str1 != null) && (paramToServiceMsg.equalsIgnoreCase(str1)))
          {
            ...
            paramToServiceMsg.put("fail_location", "SubBind");
            StatisticCollector.a(BaseApplication.getContext()).a(this.b.a(), "actSBUnbindProtol", true, 0L, 0L, paramToServiceMsg, "");
            bool1 = true;
            try
            {
              localSubAccountBackProtocData.p = 0;
  ...
  private void d(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    try
    {
      ...
      paramToServiceMsg.put("fail_location", "SubBind");
      StatisticCollector.a(BaseApplication.getContext()).a(this.b.a(), "actSBGetbindProtol", false, 0L, 0L, paramToServiceMsg, "");
      localSubAccountBackProtocData.p = 1000;
    ...
    if (i == 1000)
    {
      ...
      if (paramToServiceMsg == null)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          paramFromServiceMsg.put("fail_step", "exception");
          paramFromServiceMsg.put("fail_location", "SubBind");
          StatisticCollector.a(BaseApplication.getContext()).a(this.b.a(), "actSBGetbindProtol", false, 0L, 0L, paramFromServiceMsg, "");
          paramToServiceMsg.printStackTrace();
          j = i;
          bool2 = bool1;
          if (QLog.isColorLevel())
      ...
      else
      {
        ...
        if ((i == 1200) || (i == 1214) || (i == 1215) || (i == 1218) || (i == 1232) || (i == 1233) || (i == 1240) || (i == 1241) || (i == 1242))
        {
          ...
          paramFromServiceMsg.put("fail_location", "SubBind");
          StatisticCollector.a(BaseApplication.getContext()).a(this.b.a(), "actSBGetbindProtol", true, 0L, 0L, paramFromServiceMsg, "");
          paramFromServiceMsg = (SubAccountManager)this.b.getManager(60);
    ...
    for (;;)
    {
      ...
      {
        localSubAccountBackProtocData.p = 0;
        localSubAccountBackProtocData.a(paramToServiceMsg, (ArrayList)paramObject);
        ...
        if ((paramObject != null) && (((ArrayList)paramObject).size() > 0))
        {
          ...
          {
            paramToServiceMsg.a((String)((Iterator)paramObject).next(), 1);
            continue;
          }
        }
        String str;
        if (localSubAccountBackProtocData.c())
        {
          ...
          if ((paramToServiceMsg != null) && (paramToServiceMsg.size() > 0))
          {
            ...
            if (((Iterator)paramObject).hasNext())
            {
              str = (String)((Iterator)paramObject).next();
              if (QLog.isColorLevel()) {
        ...
        try
        {
          ...
          this.b.getSubAccountKey(this.b.getAccount(), ((SubAccountBackProtocData)localObject).c, new qgo(this, (SubAccountBackProtocData)localObject, paramFromServiceMsg, bool2));
          i = 0;
        }
        catch (Exception paramToServiceMsg)
        {
        ...
        if (paramFromServiceMsg.a(str, 2))
        {
          ...
          if (j != 0)
          {
            ...
            this.b.a().a(new String[] { AppConstants.ah, str });
          }
          if (QLog.isColorLevel()) {
  ...
  public void a(String paramString)
  {
    ...
    Object localObject2 = Utils.b(this.b.a());
    ...
    ((oidb_0x7a1.ReqBody)localObject1).uint32_clt_appid.set(this.b.a());
  ...
  public void a(String paramString1, String paramString2, String paramString3)
  {
    ...
    try
    {
      ...
      ((oidb_0x7a0.ReqBody)localObject1).uint32_clt_appid.set(this.b.a());
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\app\SubAccountBindHandler.class
