  ...
  extends BusinessHandler
{
  ...
  private void a(Intent paramIntent, oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    for (;;)
    {
      ...
      this.g = 94;
      a(this.g, true, paramIntent.sigZanInfo.get(Integer.valueOf(255)));
      return;
  ...
  private boolean a(String[] paramArrayOfString, byte[] paramArrayOfByte)
  {
    ...
    paramArrayOfString = new NewIntent(this.b.a(), SignatureServlet.class);
  ...
  private void b(Intent paramIntent, oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    paramIntent = ((FriendsManager)this.b.getManager(50)).a(str);
    if ((paramIntent != null) && (paramOIDBSSOPkg.equals(paramIntent.getRichStatus().feedsId)) && (paramIntent.getRichStatus().sigZanInfo != null))
    {
      paramIntent = (RichStatus.SigZanInfo)paramIntent.getRichStatus().sigZanInfo.get(Integer.valueOf(255));
  ...
  private void d(Intent paramIntent, oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    if (paramOIDBSSOPkg.uint32_result.get() == 0)
    {
      ...
      this.b.getPreferences().edit().putLong("sigNewCommentLastFetchTime", System.currentTimeMillis() + i2 * 1000);
      if ((i1 != 0) && (0L != l1))
      {
  ...
  private void e(Intent paramIntent, oidb_sso.OIDBSSOPkg paramOIDBSSOPkg)
  {
    ...
    if (paramOIDBSSOPkg.uint32_result.get() == 0)
    {
      ...
      do
      {
        ...
        i1 = localRspBody.uint32_flag.get();
      ...
      } while (a((String[])localArrayList.toArray(new String[localArrayList.size()]), arrayOfByte));
      a(6, false, Integer.valueOf(64536));
      return;
  ...
  public void a()
  {
    long l1 = this.b.getPreferences().getLong("sigNewCommentLastFetchTime", 0L);
    ...
    localObject = new NewIntent(this.b.a(), SignatureServlet.class);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    ((SigActPb.Platform)localObject).platform.set(109L);
    ((SigActPb.Platform)localObject).mqqver.set("6.5.5");
    ...
    localSigactReq.uin_disable.set(Long.valueOf(this.b.getAccount()).longValue());
  ...
  public void a(String paramString1, String paramString2)
  {
    ...
    {
      return;
      l1 = this.b.getPreferences().getLong("sigCommentUpdateTimeStamp_" + paramString1, 0L);
  ...
  public void a(String paramString1, String paramString2, int paramInt1, int paramInt2)
  {
    ...
    localObject1 = new NewIntent(this.b.a(), SignatureServlet.class);
  ...
  public void a(String paramString1, String paramString2, int paramInt, boolean paramBoolean)
  {
    ...
    localObject2 = new NewIntent(this.b.a(), SignatureServlet.class);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\app\SignatureHandler.class
