  ...
  implements CheckUpdateItemInterface
{
  ...
  public ReqItem a()
  {
    ...
    Object localObject1 = BaseApplicationImpl.a().getSharedPreferences("web_process_preload_file", 4);
    int i = ((SharedPreferences)localObject1).getInt("key_check_update_interval" + this.a.a(), 259200);
    int j = ((SharedPreferences)localObject1).getInt("key_last_check_update_timestamp" + this.a.a(), 0);
    ...
    if ((k - j > i) || (k < j))
    {
      ...
      ((SharedPreferences)localObject1).edit().putInt("key_last_check_update_timestamp" + this.a.a(), (int)(System.currentTimeMillis() / 1000L)).commit();
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).client_ver.set("6.5.5");
      ...
      ((PreloadInfoCheckUpdate.ControlReqHead)localObject3).mem.set((int)DeviceInfoUtil.c() / 1048576);
      ...
      Object localObject4 = SharedPreferencesHandler.a((SharedPreferences)localObject1, "key_web_plugin_list" + this.a.a(), null);
      if ((localObject4 != null) && (!((Set)localObject4).isEmpty()))
      {
        ...
        if (((Iterator)localObject4).hasNext())
        {
          ...
          localAppBehavior.click_num.set(((SharedPreferences)localObject1).getInt("key_web_plugin_click_num" + str + this.a.a(), 0));
          localAppBehavior.click_red_num.set(((SharedPreferences)localObject1).getInt("key_web_plugin_click_red_num" + str + this.a.a(), 0));
          ...
          if (localObject1.length > 4)
          {
            ...
            if (localObject1 != null)
            {
              ...
              if (paramRespItem != null)
              {
                ...
                paramRespItem = BaseApplicationImpl.a().getSharedPreferences("web_process_preload_file", 4).edit();
                paramRespItem.putInt("key_preload_strategy" + this.a.a(), ((PreloadInfoCheckUpdate.PreloadInfoRsp)localObject1).preload_switch.get());
                if (QLog.isColorLevel()) {
                  QLog.d("PreloadInfoCheckUpdateItem", 2, "preload_switch=" + ((PreloadInfoCheckUpdate.PreloadInfoRsp)localObject1).preload_switch.get());
                }
                paramRespItem.putBoolean("key_preload_flag" + this.a.a(), ((PreloadInfoCheckUpdate.PreloadInfoRsp)localObject1).preload.get());
                if (QLog.isColorLevel()) {
                  QLog.d("PreloadInfoCheckUpdateItem", 2, "preload=" + ((PreloadInfoCheckUpdate.PreloadInfoRsp)localObject1).preload.get());
                }
                paramRespItem.putInt("key_check_update_interval" + this.a.a(), ((PreloadInfoCheckUpdate.PreloadInfoRsp)localObject1).interval.get());
                if (QLog.isColorLevel()) {
                ...
                while (((Iterator)localObject3).hasNext())
                {
                  ...
                  paramRespItem.putInt("key_web_plugin_click_num" + str + this.a.a(), 0);
                  paramRespItem.putInt("key_web_plugin_click_red_num" + str + this.a.a(), 0);
                }
              }
            }
          }
    ...
    while (!QLog.isColorLevel())
    {
      do
      {
        do
        {
          ...
          SharedPreferencesHandler.a(paramRespItem, "key_web_plugin_list" + this.a.a(), (Object[])localObject2);
          paramRespItem.putInt("key_red_ram" + this.a.a(), ((PreloadInfoCheckUpdate.PreloadInfoRsp)localObject1).red_ram.get());
          if (QLog.isColorLevel()) {
            QLog.d("PreloadInfoCheckUpdateItem", 2, "red_ram=" + ((PreloadInfoCheckUpdate.PreloadInfoRsp)localObject1).red_ram.get());
          }
          paramRespItem.putInt("key_click_ram" + this.a.a(), ((PreloadInfoCheckUpdate.PreloadInfoRsp)localObject1).click_ram.get());
          if (QLog.isColorLevel()) {
          ...
          {
            localObject1 = BaseApplicationImpl.a().getSharedPreferences("ppp_profile", 4).edit();
            ...
            while (((Iterator)localObject2).hasNext())
            {
              ...
              ((SharedPreferences.Editor)localObject1).putInt(i + "preload_switch" + this.a.a(), ((PreloadInfoCheckUpdate.PreloadResult)localObject3).preload_switch.get());
              ((SharedPreferences.Editor)localObject1).putBoolean(i + "preload" + this.a.a(), ((PreloadInfoCheckUpdate.PreloadResult)localObject3).preload.get());
              ((SharedPreferences.Editor)localObject1).putBoolean(i + "preload_data" + this.a.a(), ((PreloadInfoCheckUpdate.PreloadResult)localObject3).preload_data.get());
              ((SharedPreferences.Editor)localObject1).putInt(i + "mem_limit" + this.a.a(), ((PreloadInfoCheckUpdate.PreloadResult)localObject3).mem_limit.get());
              ((SharedPreferences.Editor)localObject1).putString(i + "ext1" + this.a.a(), ((PreloadInfoCheckUpdate.PreloadResult)localObject3).ext1.get());
            }
          }
          paramRespItem.putInt("key_last_check_update_timestamp" + this.a.a(), (int)(System.currentTimeMillis() / 1000L));
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\app\PreloadInfoCheckUpdateItem.class
