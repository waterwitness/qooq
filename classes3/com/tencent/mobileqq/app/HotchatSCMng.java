  ...
  implements Manager
{
  ...
  static final String b = "hotchat_scene_config";
  ...
  static
  {
    ...
    jdField_a_of_type_JavaLangString = HotchatSCMng.class.getSimpleName();
  }
  ...
  private void a(Set paramSet)
  {
    try
    {
      localObject = PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a()).edit();
      if (Build.VERSION.SDK_INT < 11) {
        break label76;
      }
      ((SharedPreferences.Editor)localObject).putStringSet("hotchat_scene_config", paramSet);
    ...
    if (QLog.isColorLevel())
    {
      ...
      {
        paramSet = "null";
        NearbyUtils.a((String)localObject, new Object[] { "saveConfigs", paramSet });
      }
    }
    else
    {
      return;
      ((SharedPreferences.Editor)localObject).putInt("hotchat_scene_config_count", paramSet.size());
      localIterator = paramSet.iterator();
      i = 0;
      while (localIterator.hasNext())
      {
        String str = (String)localIterator.next();
        ((SharedPreferences.Editor)localObject).putString("hotchat_scene_config_" + i, str);
        i += 1;
      }
    }
  }
  ...
  private String[] a()
  {
    ...
    do
    {
      try
      {
        localObject4 = PreferenceManager.getDefaultSharedPreferences(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a());
        if (Build.VERSION.SDK_INT < 11) {
          break label125;
        }
      ...
      if (QLog.isColorLevel())
      {
        ...
        NearbyUtils.a(str, new Object[] { "getConfigs", localObject2, localObject4 });
      }
  ...
  public HotchatSCMng.HotchatNote a(String paramString, int paramInt, long paramLong)
  {
    ...
    if (TextUtils.isEmpty(paramString))
    {
      ...
      {
        NearbyUtils.a(jdField_a_of_type_JavaLangString, "getHotchatNote", new Object[] { "id is null or empty" });
        localObject2 = localObject1;
      }
    }
      ...
      do
      {
        do
        {
          do
          {
            do
            {
              return (HotchatSCMng.HotchatNote)localObject2;
          ...
          if (localHotchatNotice.jdField_a_of_type_Int < 0)
          {
            if (this.jdField_a_of_type_JavaUtilComparator == null) {
              this.jdField_a_of_type_JavaUtilComparator = new pyz(this);
            }
            Collections.sort(localHotchatNotice.jdField_a_of_type_JavaUtilArrayList, this.jdField_a_of_type_JavaUtilComparator);
            if (QLog.isDevelopLevel()) {
              NearbyUtils.a(jdField_a_of_type_JavaLangString, "sort start", new Object[] { paramString });
            }
            i = 0;
              ...
              for (;;)
              {
                ...
                for (localHotchatNotice.jdField_a_of_type_Int = i;; localHotchatNotice.jdField_a_of_type_Int = i) {
                  do
                  {
                    ...
                    NearbyUtils.a(jdField_a_of_type_JavaLangString, String.valueOf(i), new Object[] { localObject2 });
                    break;
            ...
            if (QLog.isDevelopLevel()) {
              NearbyUtils.a(jdField_a_of_type_JavaLangString, "sort end", new Object[] { paramString });
            }
            if (QLog.isDevelopLevel()) {
              NearbyUtils.a(jdField_a_of_type_JavaLangString, "getHotchatNote", new Object[] { Integer.valueOf(localHotchatNotice.jdField_a_of_type_Int) });
            }
          }
          localObject2 = localObject1;
    ...
    NearbyUtils.a(jdField_a_of_type_JavaLangString, "getHotchatNote", new Object[] { paramString, Integer.valueOf(paramInt), Integer.valueOf(localHotchatNotice.jdField_a_of_type_Int), localObject1 });
    return (HotchatSCMng.HotchatNote)localObject1;
  ...
  public String a()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 56	com/tencent/mobileqq/app/HotchatSCMng:jdField_a_of_type_ComTencentMobileqqAppQQAppInterface	Lcom/tencent/mobileqq/app/QQAppInterface;
    //   8: astore_2
    //   9: aload_2
    //   10: ifnonnull +7 -> 17
    //   13: aload_0
    ...
    //   16: areturn
    //   17: aload_2
    //   18: invokevirtual 64	com/tencent/mobileqq/app/QQAppInterface:a	()Lcom/tencent/qphone/base/util/BaseApplication;
    //   21: astore_2
    //   22: aload_2
    //   23: ifnull -10 -> 13
    //   26: aload_0
    //   27: getfield 250	com/tencent/mobileqq/app/HotchatSCMng:c	Ljava/lang/String;
    //   30: ifnull +13 -> 43
    //   33: aload_0
    //   34: getfield 250	com/tencent/mobileqq/app/HotchatSCMng:c	Ljava/lang/String;
    //   37: invokevirtual 253	java/lang/String:length	()I
    //   40: ifgt +106 -> 146
    //   43: aload_0
    //   44: aload_2
    //   45: invokevirtual 259	android/content/Context:getFilesDir	()Ljava/io/File;
    //   48: invokevirtual 264	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   51: putfield 250	com/tencent/mobileqq/app/HotchatSCMng:c	Ljava/lang/String;
    //   54: aload_0
    //   55: getfield 250	com/tencent/mobileqq/app/HotchatSCMng:c	Ljava/lang/String;
    //   58: ldc_w 266
    //   61: invokevirtual 270	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   64: ifne +30 -> 94
    //   67: aload_0
    ...
    //   75: aload_0
    //   76: getfield 250	com/tencent/mobileqq/app/HotchatSCMng:c	Ljava/lang/String;
    ...
    //   91: putfield 250	com/tencent/mobileqq/app/HotchatSCMng:c	Ljava/lang/String;
    //   94: aload_0
    //   95: new 135	java/lang/StringBuilder
    //   98: dup
    //   99: invokespecial 136	java/lang/StringBuilder:<init>	()V
    //   102: aload_0
    //   103: getfield 250	com/tencent/mobileqq/app/HotchatSCMng:c	Ljava/lang/String;
    ...
    //   117: putfield 250	com/tencent/mobileqq/app/HotchatSCMng:c	Ljava/lang/String;
    //   120: getstatic 35	com/tencent/mobileqq/app/HotchatSCMng:jdField_a_of_type_Boolean	Z
    //   123: ifeq +23 -> 146
    //   126: getstatic 33	com/tencent/mobileqq/app/HotchatSCMng:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   129: ldc_w 272
    //   132: iconst_1
    ...
    //   137: iconst_0
    //   138: aload_0
    //   139: getfield 250	com/tencent/mobileqq/app/HotchatSCMng:c	Ljava/lang/String;
    //   142: aastore
    //   143: invokestatic 204	com/tencent/mobileqq/nearby/NearbyUtils:a	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   146: aload_0
    //   147: getfield 250	com/tencent/mobileqq/app/HotchatSCMng:c	Ljava/lang/String;
    //   150: astore_1
    //   151: goto -138 -> 13
    //   154: astore_1
    //   155: aload_0
    ...
    //   0	159	0	this	HotchatSCMng
    //   1	150	1	str	String
    //   154	4	1	localObject1	Object
  ...
  public void a()
  {
    ...
    {
      NearbyUtils.a(str, new Object[] { "initCache", localObject2 });
    ...
    for (;;)
    {
        ...
        if ((str != null) && (str.length() > 0))
        {
          ...
          if (localConfigData != null)
          {
            for (;;)
            {
              ...
              NearbyUtils.a(jdField_a_of_type_JavaLangString, new Object[] { "initCache", "parse config xml fail", localException.toString() });
              break label402;
              label281:
              boolean bool = true;
            }
            if (QLog.isColorLevel()) {
              NearbyUtils.a(jdField_a_of_type_JavaLangString, new Object[] { "initCache", "download config xml fail", localConfigData });
            }
          }
          else if (QLog.isColorLevel())
          {
            NearbyUtils.a(jdField_a_of_type_JavaLangString, new Object[] { "initCache", "parse ConfigData fail", localException });
          }
        }
      }
      else
      {
        ...
        this.b = true;
        if (QLog.isColorLevel()) {
          NearbyUtils.a(jdField_a_of_type_JavaLangString, new Object[] { "initCache", Integer.valueOf(this.jdField_a_of_type_JavaUtilHashMap.size()) });
        }
        return;
      }
      label402:
  ...
  {
    if (QLog.isDevelopLevel()) {
      NearbyUtils.a(jdField_a_of_type_JavaLangString, "parse", new Object[] { paramString });
    }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        catch (Exception paramString)
        {
          ...
          NearbyUtils.a(jdField_a_of_type_JavaLangString, new Object[] { "parseNotice exception", paramString.toString() });
        }
      }
      ...
      else
      {
        ...
        if (bool)
        {
          ...
          NearbyUtils.a(jdField_a_of_type_JavaLangString, new Object[] { "parseNotice exception", localException1.toString() });
          break label893;
        }
        ...
        else
        {
          ...
          NearbyUtils.a(jdField_a_of_type_JavaLangString, new Object[] { "parseNotice exception", localException2.toString() });
          break label902;
          if ("activity".equals(localXmlPullParser.getName()))
          {
            ...
            if (jdField_a_of_type_Boolean)
            {
              ...
              str1 = "null";
              NearbyUtils.a(str3, "parse", new Object[] { str1, paramString });
            }
            if (localObject6 == null)
            {
  ...
  public boolean a(HotchatSCMng.ConfigData paramConfigData, String paramString)
  {
    ...
    if (QLog.isColorLevel()) {
      NearbyUtils.a(jdField_a_of_type_JavaLangString, new Object[] { "download", paramConfigData });
    }
  ...
  public boolean a(HotchatSCMng.HotchatNote paramHotchatNote)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        NearbyUtils.a(jdField_a_of_type_JavaLangString, new Object[] { "checkHasGrabHbTask", paramHotchatNote, Boolean.valueOf(bool) });
      }
      return bool;
  ...
  public boolean a(ConfigurationService.Config paramConfig)
  {
    ...
    if (localConfigData != null)
    {
      ...
      if (this.b)
      {
        ...
        if (QLog.isDevelopLevel()) {
          NearbyUtils.a(jdField_a_of_type_JavaLangString, "updateHotChatSceneConfig", new Object[] { Boolean.valueOf(bool2), Boolean.valueOf(this.b) });
        }
        return bool2;
      }
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\app\HotchatSCMng.class
