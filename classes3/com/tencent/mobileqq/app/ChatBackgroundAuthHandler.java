  ...
  extends BusinessHandler
{
  ...
  public void a(List paramList)
  {
    ...
    localPlatform_Comm_Req.mqqver.set("6.5.5.2880");
  ...
  {
    HashMap localHashMap = ((ChatBackgroundManager)this.a.getManager(62)).a();
  ...
  protected void b(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        j = ((chatbgInfo.Bg_Auth_Rst)paramObject).bgId.get();
        paramObject = String.valueOf(((chatbgInfo.Bg_Auth_Rst)paramObject).result.get());
        if (((String)paramObject).endsWith("001")) {
          break label187;
        }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\app\ChatBackgroundAuthHandler.class
