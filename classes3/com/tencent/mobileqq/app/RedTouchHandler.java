  ...
  extends BusinessHandler
{
  ...
  public void a(String paramString, boolean paramBoolean, long paramLong)
  {
    if ((QLog.isColorLevel()) && (!TextUtils.isEmpty(paramString))) {
      QLog.i("RedTouchHandler", 2, "netSetPluginState : path = " + paramString + ";status = " + paramBoolean + ";time = " + paramLong);
    }
    BusinessInfoCheckUpdate.ReportReqBody localReportReqBody = new BusinessInfoCheckUpdate.ReportReqBody();
    localReportReqBody.uin.set(Long.parseLong(this.b.a()));
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\app\RedTouchHandler.class
