  ...
  extends BusinessHandler
{
  ...
  {
    ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(), "NearfieldGroupSvr.ReqExit");
  ...
  {
    ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(), "NearfieldGroupSvr.ReqJoinGroup");
    nearfield_group.BusiReqHead localBusiReqHead = new nearfield_group.BusiReqHead();
    localBusiReqHead.int32_seq.set(paramInt);
    localBusiReqHead.int32_version.set(1);
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        localObject1 = (nearfield_group.BusiRespHead)((nearfield_group.RespGetGroupList)paramObject).msg_head.get();
        paramObject = ((nearfield_group.RespGetGroupList)paramObject).rpt_msg_group_list.get();
        ...
        if (paramObject != null)
        {
          ...
          {
            Object localObject2 = (nearfield_group.GroupProfile)((List)paramObject).get(i);
  ...
  {
    boolean bool = true;
    ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", this.jdField_b_of_type_ComTencentMobileqqAppQQAppInterface.a(), "NearfieldGroupSvr.ReqGetGroupList");
  ...
  protected void b(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      catch (Exception paramObject)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.e(d, 2, "handleCloseFace2faceTroop:" + ((Exception)paramObject).toString());
          }
          paramObject = null;
          paramBoolean = false;
        }
      ...
      if ((paramBoolean) && (paramObject != null))
      {
        a(2, paramBoolean, new Object[] { (nearfield_group.BusiRespHead)((nearfield_group.RespExit)paramObject).msg_head.get() });
        return;
      }
    }
    a(2, false, null);
  ...
  protected void c(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      catch (Exception paramObject)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.e(d, 2, "handleJoinTroopResp:" + ((Exception)paramObject).toString());
          }
          paramObject = null;
          paramBoolean = false;
        }
      ...
      if ((paramBoolean) && (paramObject != null))
      {
        a(3, paramBoolean, new Object[] { (nearfield_group.BusiRespHead)((nearfield_group.RespJoinGroup)paramObject).msg_head.get(), String.valueOf(((nearfield_group.RespJoinGroup)paramObject).uint64_group_code.get()) });
        return;
      }
    }
    a(3, false, null);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\app\NearFieldTroopHandler.class
