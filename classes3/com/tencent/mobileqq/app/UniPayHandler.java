  ...
  extends BusinessHandler
{
  ...
  private void a()
  {
    ...
    while (localIterator.hasNext()) {
      ((UniPayHandler.UniPayUpdateListener)localIterator.next()).update();
    }
  }
  ...
  public void a(ToServiceMsg paramToServiceMsg, FromServiceMsg paramFromServiceMsg, Object paramObject)
  {
    ...
    SharedPreferences.Editor localEditor = this.b.a().getSharedPreferences("uniPaySp_" + paramToServiceMsg, 0).edit();
    localEditor.putString("sUin", paramToServiceMsg);
    localEditor.putInt("isShowOpen", i1);
    localEditor.putInt("iUinpPayType", i2);
    localEditor.putString("cur_st", paramFromServiceMsg);
    localEditor.putString("net_mobile_club", (String)paramObject);
  ...
  {
    paramString = new UniPayRequest(this.b.a(), "android" + paramString);
    ToServiceMsg localToServiceMsg = new ToServiceMsg("mobileqq.service", this.b.a(), "VipSTCheckServer.UinPay");
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\app\UniPayHandler.class
