...
public class TcpProtocolDataCodec
{
  ...
  private CSDataHighwayHead.DataHighwayHead buildHWHead(HwRequest paramHwRequest)
  {
    ...
    for (;;)
    {
      ...
      localDataHighwayHead.bytes_uin.set(ByteStringMicro.copyFrom((byte[])localObject1));
      localDataHighwayHead.bytes_command.set(ByteStringMicro.copyFrom((byte[])localObject2));
      if (paramHwRequest.isOpenUpEnable) {}
      try
      {
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\highway\codec\TcpProtocolDataCodec.class
