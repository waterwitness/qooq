  ...
  implements TransactionOps, RequestOps, INetInfoHandler
{
  ...
  private WeakNetCallback probeEngineCallBack = new WeakNetCallback()
  {
    public void onResultOverflow(HashMap<String, String> paramAnonymousHashMap)
    {
      ...
      try
      {
        ...
        paramAnonymousHashMap.setAppId(HwEngine.this.appId);
  ...
  public SparseArray<HwNetSegConf> getCurrentBuzConfigs()
  {
    ...
    {
      localSparseArray1 = ConfigManager.getInstance(getAppContext(), this.app, this.appId, this.currentUin).getAllBuzSegConfs(getAppContext());
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\highway\HwEngine.class
