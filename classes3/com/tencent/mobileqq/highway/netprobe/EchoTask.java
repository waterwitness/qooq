  ...
  public int doEcho()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (k < 5)
        {
          ...
          if (k + 1 == 5)
          {
            localObject1 = localObject8;
            localObject4 = localObject8;
            fillErrorMsg(64536, "redirect to many!");
            i = 1;
      ...
      catch (IOException localIOException)
      {
        ...
        try
        {
          localObject8 = ((HttpURLConnection)localObject1).getErrorStream();
          localObject4 = localObject1;
        ...
        localObject4 = localObject1;
        fillErrorMsg(64539, localIOException.toString());
        localObject4 = localObject1;
        ...
        localObject1 = localObject8;
        localObject4 = localObject8;
        fillErrorMsg(64536, " redirect and location header can't get ");
        int i = 1;
        ...
        localObject1 = localObject7;
        localObject4 = localObject7;
        fillErrorMsg(64537, this.responseCode + "");
        i = 3;
        return 3;
        localObject4 = localObject7;
        if (localObject7 == null) {
