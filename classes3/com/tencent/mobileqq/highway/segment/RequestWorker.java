  ...
  implements IHwManager
{
  ...
  private void handleConnClosed(int paramInt)
  {
    ...
    for (;;)
    {
      synchronized (this.sentRequests)
      {
        ...
        if (((HwRequest)localObject3).hwCmd.equalsIgnoreCase("PicUp.Echo"))
        {
          ...
          ((HwRequest)localObject3).reqListener.handleError(64533, "ConnClose");
        }
      }
      ...
      else if ((((HwRequest)localObject3).hwCmd.equalsIgnoreCase("PicUp.DataUp")) && (!((HwRequest)localObject3).isCancel.get()) && (((HwRequest)localObject3).status.get() == 3))
      {
        ...
        if (localObject4 != null) {
          ((SparseArray)localObject1).put(((Transaction)localObject4).getTransationId(), localObject4);
        }
    ...
    if (i < k)
    {
      localObject2 = (Transaction)((SparseArray)localObject1).valueAt(i);
  ...
  public void sendHeartBreak(final int paramInt1, boolean paramBoolean1, boolean paramBoolean2, final int paramInt2)
  {
    ...
    final Object localObject = new RequestHeartBreak(this.engine.currentUin, "PicUp.Echo", 0, 30000L, paramInt1, paramBoolean1);
    ...
    localObject = new Runnable()
    {
      public void run()
      {
        ...
        RequestWorker.this.addHwRequest(localObject);
        BdhLogUtil.LogEvent("N", "OnConnIdle: SendHeartBreak : " + localObject.dumpBaseInfo() + " size:" + RequestWorker.this.mCurrentRequests + " delay:" + paramInt2);
    ...
    implements IRequestListener
  {
    ...
    public RequestListener(HwRequest paramHwRequest)
    {
      ...
      this.netDetectTimer = new Runnable()
      {
        public void run()
        {
          ...
          RequestWorker.RequestListener.this.handleError(64536, "NoNetWork");
        }
      };
    ...
    public void handleError(int paramInt, String paramString)
    {
      ...
      if (localObject1 != null)
      {
        ...
        if (paramInt != 0) {
          ((HwResponse)localObject2).errCode = 64531;
        }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\highway\segment\RequestWorker.class
