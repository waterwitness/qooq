    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (localObject5 != null)
        {
          ...
          return (Transaction)localObject1;
        }
      }
      finally {}
      i += 1;
  ...
  public DataTransInfo pullNextSegment(SparseArray<HwNetSegConf> paramSparseArray)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          return (DataTransInfo)localObject2;
        }
        this.index += 1;
      }
      finally {}
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\highway\transaction\TransactionWorker.class
