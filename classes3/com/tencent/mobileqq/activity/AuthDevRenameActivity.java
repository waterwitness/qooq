  ...
  implements View.OnClickListener, TextView.OnEditorActionListener
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new kll(this);
  private SecSvcObserver jdField_a_of_type_ComTencentMobileqqAppSecSvcObserver = new klk(this);
  ...
  private void a()
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new klm(this));
  }
  
  private void b()
  {
    this.jdField_a_of_type_AndroidOsHandler.post(new kln(this));
  }
  
  protected boolean doOnCreate(Bundle paramBundle)
  {
    super.doOnCreate(paramBundle);
    super.setContentView(2130904147);
    super.addObserver(this.jdField_a_of_type_ComTencentMobileqqAppSecSvcObserver);
    super.setRightButton(2131370760, this);
    this.leftView.setText(2131367262);
    ...
    for (;;)
    {
      Object localObject = super.findViewById(2131297138);
      if (localObject != null)
      {
        ((View)localObject).setVisibility(0);
        TextView localTextView = (TextView)((View)localObject).findViewById(2131297829);
        if (localTextView != null) {
          localTextView.setText(2131370764);
        }
        localObject = (TextView)((View)localObject).findViewById(2131297830);
      ...
      for (;;)
      {
        this.jdField_a_of_type_ComTencentMobileqqWidgetClearableEditText = ((ClearableEditText)super.findViewById(2131301568));
        ...
        this.jdField_a_of_type_ComTencentMobileqqWidgetClearableEditText.setImeActionLabel(getString(2131367466), 6);
        this.jdField_a_of_type_ComTencentMobileqqWidgetClearableEditText.setFilters(new InputFilter[] { new klj(this) });
        return true;
        super.setTitle(2131370764);
      }
      paramBundle = null;
      str = null;
    }
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          {
            QQToast.a(this, getString(2131370765), 0).b(getTitleBarHeight());
            return;
          }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\AuthDevRenameActivity.class
