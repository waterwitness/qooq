  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (localMessage != null)
    {
      ...
      if (localObject1 != null)
      {
        ...
        {
          this.jdField_c_of_type_JavaLangCharSequence = BaseApplicationImpl.getContext().getString(2131367761);
    ...
    for (TroopInfo localTroopInfo = ((TroopManager)localObject1).a(str);; localTroopInfo = null)
    {
      ...
      {
        localObject3 = localTroopInfo.troopname;
        localObject1 = localTroopInfo.troopmemo;
      }
      for (;;)
      {
        this.K = (j & 0xF0FF | 0x100);
        ...
        {
          this.jdField_c_of_type_JavaLangCharSequence = paramQQAppInterface.a().getString(2131365310);
          this.J = paramQQAppInterface.a().getResources().getColor(2131428324);
        }
        ...
        if (localTroopInfo != null)
        {
          this.jdField_a_of_type_Long = localTroopInfo.troopCreditLevel;
          if (this.jdField_a_of_type_Long == 0L) {
            this.jdField_a_of_type_Long = 5L;
          }
          if (QLog.isColorLevel()) {
            QLog.i("troop.credit.act", 2, "RecentTroopAssistantItem->update," + str + "," + this.jdField_a_of_type_Long);
          }
        }
        if (!AppSetting.j) {
          break;
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\recent\data\RecentTroopAssistantItem.class
