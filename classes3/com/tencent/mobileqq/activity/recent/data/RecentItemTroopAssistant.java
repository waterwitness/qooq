  ...
  extends RecentUserBaseData
{
  ...
  public void a(Context paramContext)
  {
    if (this.H > 0)
    {
      this.jdField_c_of_type_JavaLangCharSequence = String.format(paramContext.getString(2131370835), new Object[] { Integer.valueOf(this.H) });
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {
      this.jdField_b_of_type_JavaLangString = paramContext.getString(2131369391);
    }
    ...
    for (;;)
    {
      ...
      if (localObject != null)
      {
        this.H = localTroopAssistantManager.a(localQQMessageFacade);
        this.jdField_b_of_type_Long = ((QQMessageFacade.Message)localObject).time;
      ...
      for (;;)
      {
        if ((TextUtils.isEmpty(localMsgSummary.jdField_b_of_type_JavaLangCharSequence)) && (TextUtils.isEmpty(localMsgSummary.jdField_c_of_type_JavaLangCharSequence)))
        {
          ...
          localMsgSummary.jdField_b_of_type_JavaLangCharSequence = paramContext.getString(2131369392);
        }
        a(paramQQAppInterface);
        a(paramQQAppInterface, localMsgSummary);
        a(paramQQAppInterface, paramContext, localMsgSummary);
        a(paramContext);
        if ((TextUtils.isEmpty(this.jdField_c_of_type_JavaLangCharSequence)) && (localObject != null) && (localMsgSummary != null) && (AnonymousChatHelper.a((MessageRecord)localObject))) {
        ...
        this.d = String.format("群助手,%d个群有新消息，%s。", new Object[] { Integer.valueOf(this.H), this.jdField_c_of_type_JavaLangString });
        return;
        this.H = 0;
        this.jdField_b_of_type_Long = 0L;
      }
      label317:
      this.d = String.format("群助手,%s，%s。", new Object[] { this.jdField_b_of_type_JavaLangCharSequence, this.jdField_c_of_type_JavaLangString });
      return;
      localObject = null;
      continue;
  ...
  public void a(QQAppInterface paramQQAppInterface, MsgSummary paramMsgSummary)
  {
    ...
    do
    {
      ...
      } while ((localTroopAssistantData == null) || (TextUtils.isEmpty(localTroopAssistantData.troopUin)) || (this.jdField_b_of_type_Long >= localTroopAssistantData.lastdrafttime));
    ...
    this.jdField_b_of_type_Long = ((DraftSummaryInfo)localObject).getTime();
  ...
  protected void a(QQMessageFacade.Message paramMessage, int paramInt, QQAppInterface paramQQAppInterface, Context paramContext, MsgSummary paramMsgSummary)
  {
    ...
    MsgUtils.a(paramContext, paramQQAppInterface, paramMessage, this.a.type, paramMsgSummary, str, false, false);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\recent\data\RecentItemTroopAssistant.class
