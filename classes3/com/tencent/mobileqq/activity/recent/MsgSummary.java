  ...
  public CharSequence a(Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        paramContext = ((Resources)localObject1).getDrawable(2130842851);
        i = j + "F ".length();
        if (paramContext != null)
        {
      ...
      if (this.f == 1)
      {
        paramContext = ((Resources)localObject1).getDrawable(2130842852);
        i = "S ".length();
        i = j + i;
        continue;
  ...
  public CharSequence a(Context paramContext, String paramString, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        if (this.f == 2)
        {
          localObject1 = localResources.getDrawable(2130842851);
          if (paramInt <= 0) {
            break label618;
          }
          paramInt = paramContext.getResources().getColor(2131428324);
        ...
        localObject1 = localResources.getDrawable(2130842852);
        continue;
        localObject2 = null;
      }
      catch (Exception localException)
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\recent\MsgSummary.class
