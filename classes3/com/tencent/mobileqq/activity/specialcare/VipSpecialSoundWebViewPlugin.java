  ...
  extends VasWebviewJsPlugin
{
  ...
  public static final String b = "specialRing";
  ...
  private MediaPlayerHelper jdField_a_of_type_ComTencentMobileqqUtilsMediaPlayerHelper;
  ...
  private void a(File paramFile, String paramString)
  {
    ...
    //   7: aconst_null
    //   8: astore_3
    //   9: new 101	java/io/FileOutputStream
    //   12: dup
    //   13: aload_1
    //   14: invokespecial 104	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   17: astore_1
    //   18: aload_1
    //   19: aload_2
    //   20: invokevirtual 110	java/lang/String:getBytes	()[B
    //   23: invokevirtual 114	java/io/FileOutputStream:write	([B)V
    //   26: aload_1
    //   27: invokevirtual 117	java/io/FileOutputStream:close	()V
    //   30: return
    //   31: astore_1
    //   32: aconst_null
    //   33: astore_1
    //   34: aload_1
    //   35: invokevirtual 117	java/io/FileOutputStream:close	()V
    //   38: return
    //   39: astore_1
    //   40: return
    //   41: astore_1
    ...
    //   43: astore_2
    //   44: aload_2
    //   45: invokevirtual 117	java/io/FileOutputStream:close	()V
    //   48: aload_1
    //   49: athrow
    //   50: astore_1
    //   51: return
  ...
  private void a(String paramString, List paramList)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        plq localplq = (plq)paramList.next();
        JSONObject localJSONObject3 = new JSONObject();
        localJSONObject3.put("id", localplq.jdField_a_of_type_Int);
        localJSONObject3.put("soundName", localplq.jdField_a_of_type_JavaLangString);
        localJSONObject3.put("type", localplq.jdField_b_of_type_Int);
        localJSONObject3.put("soundVersion", localplq.jdField_b_of_type_JavaLangString);
        localJSONObject3.put("soundUrl", localplq.jdField_c_of_type_JavaLangString);
        localJSONObject3.put("whiteList", localplq.jdField_d_of_type_JavaLangString);
        localJSONObject3.put("isShow", localplq.jdField_c_of_type_Int);
        localJSONObject3.put("backgroundUrl", localplq.jdField_e_of_type_JavaLangString);
        localJSONObject3.put("access", localplq.f);
        localJSONObject3.put("useNum", localplq.jdField_d_of_type_Int);
        localJSONObject3.put("classify", localplq.jdField_e_of_type_Int);
        localJSONObject3.put("classifyName", localplq.g);
        localJSONObject3.put("limitFreeStart", localplq.h);
        localJSONObject3.put("limitFreeEnd", localplq.i);
        if ((localplq.jdField_c_of_type_JavaLangString != null) && (!TextUtils.isEmpty(localplq.jdField_c_of_type_JavaLangString)) && (f(localplq.jdField_c_of_type_JavaLangString)))
        {
          localJSONObject3.put("isDownload", true);
          localJSONObject2.put(String.valueOf(localplq.jdField_a_of_type_Int), localJSONObject3);
        }
        else
        {
  ...
  private boolean a(String paramString)
  {
    ...
    if (!this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a()) {
      this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a(new pms(this, paramString));
    }
    for (;;)
    {
      return true;
  ...
  private boolean a(String paramString1, String paramString2, String paramString3)
  {
    ...
    for (;;)
    {
      ...
      return true;
      pmw localpmw = new pmw(this);
      localpmw.jdField_a_of_type_JavaLangString = paramString3;
      localpmw.jdField_b_of_type_JavaLangString = paramString1;
      paramString3 = new pmu(this, localpmw, paramString3);
      ThreadManager.a(localpmw, 5, null, true);
  ...
  {
    File localFile = new File(this.mRuntime.a().getApplicationContext().getFilesDir(), "http://i.gtimg.cn/club/moblie/special_sound/new_config.json");
  ...
  private void b(String paramString)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a(new pmt(this, paramString));
  }
  ...
  private boolean b(String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqUtilsMediaPlayerHelper.a(new pmv(this, paramString1, paramString2));
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\specialcare\VipSpecialSoundWebViewPlugin.class
