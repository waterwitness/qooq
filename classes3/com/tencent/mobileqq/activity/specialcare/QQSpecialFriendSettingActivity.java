  ...
  implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, FaceDecoder.DecodeTaskCompletionListener
{
  ...
  public QQSpecialFriendSettingActivity()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new pln(this);
    this.jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new plo(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQvipSpecialCareObserver = new plp(this);
  }
  ...
  private void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)findViewById(2131302531));
    this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setOnCheckedChangeListener(this);
    this.jdField_b_of_type_ComTencentMobileqqWidgetFormSwitchItem = ((FormSwitchItem)findViewById(2131302533));
    this.jdField_b_of_type_ComTencentMobileqqWidgetFormSwitchItem.setOnCheckedChangeListener(this);
    this.jdField_a_of_type_AndroidViewView = findViewById(2131302534);
    this.jdField_b_of_type_AndroidViewView = findViewById(2131302536);
    this.jdField_b_of_type_AndroidViewView.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131302535));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131296932));
    if (this.jdField_a_of_type_Boolean)
    {
      setLeftViewName(2131368676);
      setRightButton(2131368729, new pll(this));
    ...
    for (;;)
    {
      if (AppSetting.j)
      {
        this.jdField_a_of_type_ComTencentMobileqqWidgetFormSwitchItem.setContentDescription(getString(2131371040));
        this.jdField_b_of_type_ComTencentMobileqqWidgetFormSwitchItem.setContentDescription(getString(2131371041));
      }
      return;
      setLeftViewName(2131367350);
    }
  }
  ...
  private void b()
  {
    ...
    Object localObject = this.jdField_a_of_type_ComTencentMobileqqUtilFaceDecoder.a(1, this.jdField_b_of_type_JavaLangString, 0);
    if (localObject == null)
    {
  ...
  private void d()
  {
    ...
    startTitleProgress();
    this.jdField_a_of_type_ComTencentMobileqqActivitySpecialcareQvipSpecialSoundManager.a(new plm(this));
  }
  ...
  private void e()
  {
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      for (str1 = getString(2131368871);; str1 = str2)
      {
  ...
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean)
  {
    ...
    ((Message)localObject).arg2 = 2131367256;
  ...
  public void onClick(View paramView)
  {
    ...
    paramView.putExtra("url", "http://imgcache.qq.com/club/client/specialRing/rel/index.html?_wv=1027&suin=" + this.jdField_b_of_type_JavaLangString + "&uin=" + this.app.a() + "&_bid=279" + "&lazy=" + this.jdField_a_of_type_Boolean);
    ...
    if (NetworkUtil.h(this))
    {
      ...
      paramView.obj = getString(2131371051);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\specialcare\QQSpecialFriendSettingActivity.class
