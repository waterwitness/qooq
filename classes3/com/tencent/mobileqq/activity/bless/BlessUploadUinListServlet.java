  ...
  extends MSFServlet
{
  ...
  public static final String a = BlessUploadUinListServlet.class.getSimpleName();
  public static final int b = -2;
  public static final String b = "store.key";
  public static final int c = -3;
  public static final String c = "k_result_code";
  public static final int d = -4;
  public static final String d = "k_wait_time";
  public static final int e = -5;
  private static final String e = "k_uin_list";
  public static final int f = -6;
  private static final String f = "redbag_assistant.client_request";
  ...
  public static void a(QQAppInterface paramQQAppInterface, ArrayList paramArrayList)
  {
    if ((paramArrayList == null) || (paramArrayList.size() == 0))
    {
      if (QLog.isColorLevel()) {
        QLog.d(BlessManager.a, 2, "sendUinList error: empty uin list");
      }
      return;
    }
    NewIntent localNewIntent = new NewIntent(paramQQAppInterface.a(), BlessUploadUinListServlet.class);
    if (QLog.isColorLevel()) {
      QLog.d(BlessManager.a, 2, "sendUinList " + paramArrayList.size());
    }
    localNewIntent.putExtra("k_uin_list", paramArrayList);
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d(BlessManager.a, 2, "onReceive result=" + false + " waitTime=" + j);
          }
          paramFromServiceMsg = "";
          bool = false;
        }
      ...
      try
      {
        ...
        QLog.d(BlessManager.a, 2, "onReceive result=" + bool + " key=" + paramFromServiceMsg);
      }
  ...
  public void onSend(Intent paramIntent, Packet paramPacket)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(BlessManager.a, 2, "onSend req=" + paramIntent.toString());
    }
  }
}


/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\bless\BlessUploadUinListServlet.class
