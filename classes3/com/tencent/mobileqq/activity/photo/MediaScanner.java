...
public class MediaScanner
{
  ...
  private MediaScanner(Context paramContext)
  {
    ...
    if (paramContext != null) {
      this.jdField_b_of_type_JavaLangString = paramContext.getAbsolutePath();
    }
    if (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaDatabaseHelper != null) {
      this.c = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaDatabaseHelper.b();
    }
  }
  ...
  private void a(String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaDatabaseHelper.b(localArrayList);
      b(paramString);
      return;
    } while (!QLog.isColorLevel());
  ...
  private boolean a(String paramString)
  {
    boolean bool = true;
    if (QLog.isColorLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 2, "isNomediaFileExisit() folderpath=" + paramString + ", mExternalStorageDirectoryPath=" + this.jdField_b_of_type_JavaLangString);
    }
    if (new File(this.jdField_b_of_type_JavaLangString).equals(new File(paramString)))
    {
      if (QLog.isColorLevel()) {
  ...
  private void b()
  {
    ...
    {
      return;
      localHashSet = this.jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaDatabaseHelper.c();
    ...
    do
    {
      ...
      do
      {
        do
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d(jdField_a_of_type_JavaLangString, 2, "needScanFolder() lastModified=" + l + ", info.modifiedDate=" + ((MediaScannerFolderInfo)localObject).jdField_a_of_type_Long);
          }
  ...
  private boolean b(String paramString)
  {
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 2, "needScanFolder() lastModified=" + l + ", info.modifiedDate=" + paramString.jdField_a_of_type_Long);
      }
  ...
  private void c()
  {
    if ((this.jdField_b_of_type_JavaLangString == null) || (this.jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaDatabaseHelper == null)) {}
    for (;;)
    {
      return;
      String str = this.jdField_b_of_type_JavaLangString + "/tencent/MicroMsg";
  ...
  public int a()
  {
    ...
    //   3: monitorenter
    //   4: aload_0
    //   5: getfield 56	com/tencent/mobileqq/activity/photo/MediaScanner:jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaDatabaseHelper	Lcom/tencent/mobileqq/activity/photo/MediaDatabaseHelper;
    //   8: astore_1
    //   9: aload_1
    //   10: ifnonnull +7 -> 17
    //   13: aload_0
    ...
    //   26: ifeq -13 -> 13
    //   29: aload_0
    //   30: getfield 56	com/tencent/mobileqq/activity/photo/MediaScanner:jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaDatabaseHelper	Lcom/tencent/mobileqq/activity/photo/MediaDatabaseHelper;
    ...
    //   8	2	1	localMediaDatabaseHelper	MediaDatabaseHelper
  ...
  public ArrayList a(boolean paramBoolean, int paramInt)
  {
    ...
    //   6: monitorenter
    //   7: aload_0
    //   8: getfield 56	com/tencent/mobileqq/activity/photo/MediaScanner:jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaDatabaseHelper	Lcom/tencent/mobileqq/activity/photo/MediaDatabaseHelper;
    //   11: astore 5
    //   13: aload 5
    //   15: ifnonnull +7 -> 22
    //   18: aload_0
    ...
    //   48: ifne +15 -> 63
    //   51: aload_0
    //   52: getfield 56	com/tencent/mobileqq/activity/photo/MediaScanner:jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaDatabaseHelper	Lcom/tencent/mobileqq/activity/photo/MediaDatabaseHelper;
    //   55: aload_3
    //   56: invokevirtual 313	com/tencent/mobileqq/activity/photo/MediaDatabaseHelper:b	(Ljava/lang/String;)Ljava/util/ArrayList;
    //   59: astore_3
    //   60: goto -42 -> 18
    //   63: aload_0
    //   64: getfield 56	com/tencent/mobileqq/activity/photo/MediaScanner:jdField_a_of_type_ComTencentMobileqqActivityPhotoMediaDatabaseHelper	Lcom/tencent/mobileqq/activity/photo/MediaDatabaseHelper;
    //   67: aload_3
  ...
  public void a(MediaScanner.OnMediaScannerListener paramOnMediaScannerListener, LocalMediaInfo paramLocalMediaInfo, int paramInt)
  {
    ...
    ThreadManager.a(new orb(this, new WeakReference(paramLocalMediaInfo), paramOnMediaScannerListener, paramInt), 5, null, true);
  }
}


/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\photo\MediaScanner.class
