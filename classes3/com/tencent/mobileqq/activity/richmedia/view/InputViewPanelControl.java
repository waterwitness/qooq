...
{
  public static final String a = "InputViewPanelControl";
  ...
  public static int a(EditText paramEditText, ArrayList paramArrayList, List paramList, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      InputViewPanelControl.Friend localFriend = new InputViewPanelControl.Friend();
  ...
  public static SystemEmoticonPanel a(Context paramContext, EditText paramEditText)
  {
    try
    {
      paramContext = new SystemEmoticonPanel(paramContext, new pep(paramEditText));
      return paramContext;
    }
    catch (Throwable paramContext)
    {
      QLog.w("InputViewPanelControl", 2, paramContext.getMessage());
    }
    return null;
  }
  ...
  public static String a(EditText paramEditText, List paramList)
  {
    if (paramEditText != null)
    {
      ...
      if (!TextUtils.isEmpty(paramEditText)) {
        return EmoWindow.b(a(paramEditText, paramList).replaceAll("/钱", "/金钱").replaceAll("/美女", "/MM"));
      }
    }
    return "";
  }
  ...
  public static String a(List paramList)
  {
    ...
    {
      InputViewPanelControl.Friend localFriend = (InputViewPanelControl.Friend)localIterator.next();
  ...
  public static boolean a(String paramString1, boolean paramBoolean, List paramList, int paramInt1, int paramInt2, String paramString2)
  {
    if (((a(paramInt1, paramInt2, paramString2)) || (!paramBoolean)) && (paramList != null))
    {
      ...
      {
        paramString2 = (InputViewPanelControl.Friend)paramList.get(paramInt1);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\richmedia\view\InputViewPanelControl.class
