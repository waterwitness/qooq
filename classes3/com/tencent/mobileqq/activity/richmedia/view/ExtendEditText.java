  ...
  extends EditText
{
  ...
  public static final String a = "ExtendEditText";
  private static final ExtendEditText.LengthConvertor jdField_c_of_type_ComTencentMobileqqActivityRichmediaViewExtendEditText$LengthConvertor;
  protected int a;
  ...
  static
  {
    ...
    jdField_c_of_type_ComTencentMobileqqActivityRichmediaViewExtendEditText$LengthConvertor = new pem();
    jdField_a_of_type_ComTencentMobileqqActivityRichmediaViewExtendEditText$LengthConvertor = new pen();
  }
  ...
  private void d()
  {
    if (this.jdField_b_of_type_Int >= 0) {
      setFilters(new InputFilter[] { new peo(this, this.jdField_b_of_type_Int) });
    }
  }
  ...
  {
    if ((paramInt < 0) || (paramInt >= getLineCount())) {}
    Layout localLayout;
    do
    {
      return;
    ...
    paramInt = localLayout.getLineTop(paramInt);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\richmedia\view\ExtendEditText.class
