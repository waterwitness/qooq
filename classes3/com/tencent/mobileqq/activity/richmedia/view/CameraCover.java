  ...
  extends FrameLayout
{
  ...
  public void a(File paramFile, CameraCover.PictureCallback paramPictureCallback, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        ((PreviewContext)localObject).mCamera.a(paramFile, localRect, paramPictureCallback, paramInt);
        return;
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\richmedia\view\CameraCover.class
