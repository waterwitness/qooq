...
public class FlowCameraMqqAction
{
  ...
  public static void a(Activity paramActivity, RMVideoStateMgr paramRMVideoStateMgr, float paramFloat, boolean paramBoolean1, double paramDouble1, double paramDouble2, FlowComponentInterface paramFlowComponentInterface, boolean paramBoolean2, int paramInt1, int paramInt2)
  {
    ...
    try
    {
      ...
      paramActivity = new FlowSendTask(paramActivity, paramRMVideoStateMgr, str1, i, str2, paramFloat, paramBoolean1, paramDouble1, paramDouble2, paramFlowComponentInterface, paramInt1, paramInt2);
  ...
  public static void a(Activity paramActivity, RMVideoStateMgr paramRMVideoStateMgr, float paramFloat, boolean paramBoolean1, double paramDouble1, double paramDouble2, FlowComponentInterface paramFlowComponentInterface, boolean paramBoolean2, int paramInt1, int paramInt2, String paramString, int paramInt3, ArrayList paramArrayList, boolean paramBoolean3)
  {
    String str1 = "";
    int i = 0;
    String str2 = "";
    try
    {
      ...
      paramActivity = new FlowSendTask(paramActivity, paramRMVideoStateMgr, str1, i, str2, paramFloat, paramBoolean1, paramDouble1, paramDouble2, paramFlowComponentInterface, paramInt1, paramInt2, paramString, paramInt3, paramArrayList, paramBoolean3);
      paramActivity.a(paramBoolean2);
      paramActivity.execute(new Void[0]);
      if (paramBoolean1) {
        a("", "0X8005E94");
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\richmedia\FlowCameraMqqAction.class
