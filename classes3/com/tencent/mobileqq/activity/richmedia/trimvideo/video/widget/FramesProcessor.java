...
{
  private static final String jdField_a_of_type_JavaLangString = "FramesProcessor";
  ...
  public FramesProcessor(FrameParent paramFrameParent, int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, int paramInt3, float paramFloat3, int paramInt4)
  {
    boolean bool = NotVerifyClass.DO_VERIFY_CLASS;
    this.jdField_a_of_type_AndroidViewGestureDetector$OnGestureListener = new pec(this);
    ...
    this.i = paramInt3;
    this.f = (paramInt1 * 1.0F / paramInt4 * paramFloat1);
    ...
    this.jdField_b_of_type_AndroidGraphicsRect = new Rect((int)(Math.min(paramInt1 * 1.0F / paramInt4 * paramFloat1, paramInt2 * paramFloat1) + paramFloat3), 0, paramInt3, (int)this.jdField_c_of_type_Float);
    ...
    this.jdField_b_of_type_Int = ((int)Math.ceil(paramInt3 * 1.0F / this.jdField_b_of_type_Float));
  ...
  {
    this.jdField_b_of_type_AndroidGraphicsRect.right = ((int)paramFloat);
  }
  ...
  public boolean a()
  {
    return !b(this.jdField_d_of_type_Float, 0.0F);
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\richmedia\trimvideo\video\widget\FramesProcessor.class
