  ...
  extends ChatHistoryViewBase
{
  ...
  public ChatHistoryFileView()
  {
    ...
    this.jdField_a_of_type_JavaLangString = "ChatHistoryFileView<FileAssistant>";
  ...
  private void f()
  {
    ...
    this.jdField_b_of_type_AndroidViewView$OnClickListener = new kwr(this);
  }
  ...
  private void g()
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new kws(this);
  }
  ...
  public void a(Intent paramIntent, QQAppInterface paramQQAppInterface, Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2130903999, null);
    this.jdField_a_of_type_ComTencentWidgetXListView = ((XListView)this.jdField_a_of_type_AndroidViewView.findViewById(2131300958));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)this.jdField_a_of_type_AndroidViewView.findViewById(2131300963));
    this.jdField_a_of_type_ComTencentWidgetXListView.setVisibility(8);
    this.jdField_a_of_type_AndroidWidgetLinearLayout.setVisibility(8);
  ...
  public void d()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppFMObserver = new kwv(this);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().addObserver(this.jdField_a_of_type_ComTencentMobileqqFilemanagerAppFMObserver);
  }
}


/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\ChatHistoryFileView.class
