  ...
  protected void a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_AndroidWidgetTextView != null)
    {
      ...
      if ((localGeoPoint.getLatitudeE6() == this.jdField_a_of_type_ComTencentTencentmapMapsdkMapGeoPoint.getLatitudeE6()) && (localGeoPoint.getLongitudeE6() == this.jdField_a_of_type_ComTencentTencentmapMapsdkMapGeoPoint.getLongitudeE6()) && (paramString != null) && (paramString.length() > 0))
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqActivityQQMapActivity.j.findViewById(2131298389).setVisibility(0);
        this.jdField_a_of_type_ComTencentMobileqqActivityQQMapActivity.j.findViewById(2131298390).setVisibility(0);
      }
    }
    return;
    label147:
    this.jdField_a_of_type_ComTencentMobileqqActivityQQMapActivity.k = paramString;
  }
}


/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\QQMapActivity$GetLocNameTask.class
