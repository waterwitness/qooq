  ...
  implements View.OnClickListener
{
  ...
  private boolean a()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        {
          this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130841778);
        ...
        {
          this.jdField_a_of_type_AndroidWidgetImageView.setImageResource(2130841777);
          continue;
        }
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2130904579);
    setLeftButton(2131369134, this);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131303242));
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(this);
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)findViewById(2131303241));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131303240));
    if (!a()) {
      finish();
    }
    return true;
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\activity\QPayReminderActivity.class
