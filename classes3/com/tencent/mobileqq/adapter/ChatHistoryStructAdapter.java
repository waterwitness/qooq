  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if ((localObject2 instanceof MessageForStructing))
    {
      ...
      if ((paramView != null) && ((paramView.getTag() instanceof ChatHistoryStructAdapter.HistoryStructItemHolder)))
      {
        ...
        paramViewGroup.jdField_a_of_type_JavaLangString = ((ChatHistoryStructMsgView)this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryViewBase).b;
    ...
    do
    {
      ...
      paramView = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2130905012, null);
      paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131305040));
      paramViewGroup.jdField_a_of_type_AndroidWidgetCheckBox = ((CheckBox)paramView.findViewById(2131305041));
      paramViewGroup.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)paramView.findViewById(2131305043));
      paramViewGroup.jdField_a_of_type_AndroidWidgetTextView = ((TextView)paramView.findViewById(2131297541));
      paramViewGroup.b = ((TextView)paramView.findViewById(2131305044));
    ...
    for (;;)
    {
      ...
      return paramViewGroup;
      paramViewGroup = View.inflate(this.jdField_a_of_type_AndroidContentContext, 2130905013, null);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\adapter\ChatHistoryStructAdapter.class
