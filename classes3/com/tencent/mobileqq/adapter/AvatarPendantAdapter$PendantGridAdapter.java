  ...
  extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      localObject2 = LayoutInflater.from(this.jdField_a_of_type_ComTencentMobileqqAdapterAvatarPendantAdapter.jdField_a_of_type_AndroidContentContext).inflate(2130904530, paramViewGroup, false);
      ((AvatarPendantAdapter.PendantGridAdapter.GridItemHolder)localObject1).jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)((View)localObject2).findViewById(2131303062));
      ((AvatarPendantAdapter.PendantGridAdapter.GridItemHolder)localObject1).jdField_a_of_type_AndroidWidgetImageView = ((ImageView)((View)localObject2).findViewById(2131303063));
      ((AvatarPendantAdapter.PendantGridAdapter.GridItemHolder)localObject1).b = ((ImageView)((View)localObject2).findViewById(2131303064));
      ((AvatarPendantAdapter.PendantGridAdapter.GridItemHolder)localObject1).c = ((ImageView)((View)localObject2).findViewById(2131303065));
      ((AvatarPendantAdapter.PendantGridAdapter.GridItemHolder)localObject1).jdField_a_of_type_AndroidWidgetTextView = ((TextView)((View)localObject2).findViewById(2131303068));
      ((AvatarPendantAdapter.PendantGridAdapter.GridItemHolder)localObject1).d = ((ImageView)((View)localObject2).findViewById(2131303066));
      ((AvatarPendantAdapter.PendantGridAdapter.GridItemHolder)localObject1).e = ((ImageView)((View)localObject2).findViewById(2131303067));
    ...
    switch (localAvatarPendantShopItemInfo.g)
    {
    default: 
      paramViewGroup.d.setVisibility(8);
      label293:
      switch (localAvatarPendantShopItemInfo.h)
      {
      case 7: 
      case 8: 
      default: 
    ...
    for (;;)
    {
      ...
      {
        paramView.setBackgroundDrawable(this.jdField_a_of_type_ComTencentMobileqqAdapterAvatarPendantAdapter.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130841839));
        label460:
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\mobileqq\adapter\AvatarPendantAdapter$PendantGridAdapter.class
