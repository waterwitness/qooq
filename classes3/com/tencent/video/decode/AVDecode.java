  ...
  extends AbstractAVDecode
{
  ...
  public static AVDecode newInstanceUncatched(AVDecodeOption paramAVDecodeOption)
  {
    ...
    catch (UnsatisfiedLinkError localUnsatisfiedLinkError)
    {
      for (;;)
      {
        AVDecodeError.throwException(65336);
      }
    }
    if (localObject != null) {
      ((AVDecode)localObject).setWantedFps((int)paramAVDecodeOption.wantedFps, paramAVDecodeOption.fixDuration);
    }
    return (AVDecode)localObject;
  }
    ...
    throws AVideoException
  {
    if (this.audioFormat != 65280) {
      AVDecodeError.throwException(65335);
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tencent\video\decode\AVDecode.class
