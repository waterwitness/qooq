  ...
  extends Handler
{
  ...
  private Bitmap a(String paramString)
  {
    try
    {
      Object localObject1 = f.a().b().getPackageManager().getPackageArchiveInfo(paramString, 1);
      if (localObject1 != null)
      {
        ...
        paramString = ((ApplicationInfo)localObject1).loadIcon(f.a().b().getPackageManager());
        if (paramString != null) {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    com.tencent.tmdownloader.internal.a.d locald = com.tencent.tmdownloader.internal.a.a.b().f(((Bundle)localObject).getString("url"));
    if (locald != null)
    {
      this.a.url = locald.b;
      this.a.title = locald.I;
      this.a.nKey = String.valueOf(locald.t);
    }
    try
    {
      if (this.b == null) {
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        m.c("NotificationHandler", "init Notification " + localException);
      }
    ...
    for (;;)
    {
      ...
      a.a().a(i, this.b);
      return;
      this.b.tickerText = a(this.c.a("notification_tickerText_download_prefix"), new Object[] { locald.I });
      ...
      this.b.contentView.setTextViewText(this.c.d("notification_title"), h.a(a(this.c.a("notification_title_download_prefix"), new Object[] { locald.I }), 18, true));
      ...
      if (locald.k > 0L)
      {
        this.b.contentView.setProgressBar(this.c.d("notif_pro_bar"), 100, a(locald.j, locald.k), false);
        this.b.contentView.setTextViewText(this.c.d("notification_progress"), a(locald.j, locald.k) * 100 / 100 + "%");
      }
      this.b.contentView.setImageViewResource(this.c.d("notification_icon"), this.c.b("qfile_file_ufdownload"));
      this.b.contentView.setTextViewText(this.c.d("notification_title"), h.a(a(this.c.a("notification_title_download_prefix"), new Object[] { locald.I }), 18, true));
      ...
      m.c("NotificationHandler", ">>pause:" + this.a.url);
      ...
      this.b.contentView.setTextViewText(this.c.d("notification_title"), h.a(locald.I, 18, true));
      ...
      a.a().c(this.a.nKey);
      continue;
      m.c("NotificationHandler", ">>complete:" + this.a.url);
      this.b = a.a().a(this.a);
      if (this.b == null) {
        break;
      }
      ...
      a(this.b, e.a(this.a), true);
      paramMessage = a(a(b.b(locald.l)), 72, 72, true);
      ...
      for (;;)
      {
        ...
        a.a().c(this.a.nKey);
        break;
        m.c("NotificationHandler", ">>download icon fail,so we use default notification icon");
        this.b.contentView.setImageViewResource(this.c.d("notification_icon"), this.c.b("qfile_file_ufdownload"));
      }
      m.c("NotificationHandler", ">>error:" + this.a.url);
      this.b.contentView.setViewVisibility(this.c.d("notification_content"), 0);
      this.b.contentView.setViewVisibility(this.c.d("notif_pro_bar_layout"), 8);
      this.b.contentView.setViewVisibility(this.c.d("notification_progress"), 8);
