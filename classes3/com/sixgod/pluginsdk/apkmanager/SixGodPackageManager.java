  ...
  extends PackageManager
{
  ...
  public SixGodPackageManager(PackageManager paramPackageManager)
  {
  ...
  public PackageInfo getPackageInfo(String paramString, int paramInt)
  {
    ...
    com.sixgod.pluginsdk.c localc = SixGodHelper.getPluginLoader(paramString);
    if (localc != null) {
      localObject = (c)localc.c().e.get(paramString);
    }
    if (localObject != null) {
  ...
  {
    return getUserBadgedIcon(paramDrawable, paramUserHandle);
  }
  
  public CharSequence getUserBadgedLabel(CharSequence paramCharSequence, UserHandle paramUserHandle)
  {
    return getUserBadgedLabel(paramCharSequence, paramUserHandle);
  }
  ...
  public List queryIntentActivities(Intent paramIntent, int paramInt)
  {
    ...
    for (;;)
    {
      Object localObject2 = SixGodHelper.getPluginLoader(paramIntent.getPackage());
      Set localSet;
      label85:
      ...
      {
        localObject2 = ((com.sixgod.pluginsdk.c)localObject2).c();
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\sixgod\pluginsdk\apkmanager\SixGodPackageManager.class
