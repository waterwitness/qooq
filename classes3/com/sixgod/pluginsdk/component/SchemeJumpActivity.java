    ...
    catch (PackageManager.NameNotFoundException paramBundle)
    {
      ...
      while (paramBundle == null)
      {
        ...
        if (localObject2 != null)
        {
          ...
          paramBundle.getCategories();
          HashMap localHashMap = ((com.sixgod.pluginsdk.apkmanager.a)localObject2).f;
                ...
                while (((Iterator)localObject3).hasNext())
                {
                  ...
                  if ((((IntentFilter)localObject4).matchAction(paramBundle.getAction())) && (((IntentFilter)localObject4).matchCategories(paramBundle.getCategories()) == null))
                  {
                    ...
                    if ((str == null) || ((((IntentFilter)localObject4).hasDataScheme(str)) && (((IntentFilter)localObject4).matchDataAuthority(paramBundle.getData()) == 4194304)))
                    {
                      ...
                      ((ResolveInfo)localObject4).activityInfo = ((com.sixgod.pluginsdk.apkmanager.a)localObject2).a(localComponentName);
      ...
      paramBundle = j.a(this, (Intent)localObject1);
      if (paramBundle == null)
      {
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\sixgod\pluginsdk\component\SchemeJumpActivity.class
