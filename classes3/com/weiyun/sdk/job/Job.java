  ...
  public String getLastErrorString()
  {
    if ((Utils.isEmptyString(this.mLastErrorString)) && (this.mLastErrorNo != 0))
    {
      ...
      if (Utils.isEmptyString(this.mLastErrorString)) {
        this.mLastErrorString = "操作出错，请重试！";
      }
      this.mLastErrorString = ("(" + this.mLastErrorNo + ")" + this.mLastErrorString);
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\weiyun\sdk\job\Job.class
