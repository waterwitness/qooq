  ...
  extends BaseDownloadTransfer
{
  ...
  protected Transfer.Result doDownload()
  {
    ...
    if ((localResult.mRet != 0) && (!this.mDownloadOriginalImage))
    {
      ...
      if ((localResult.mRet == 36532) || (i == 500) || (i == 403) || (i == 404))
      {
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\weiyun\sdk\job\transfer\ThumbnailTryOrginalDownloadTransfer.class
