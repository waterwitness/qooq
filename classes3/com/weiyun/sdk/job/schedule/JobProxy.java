  ...
  implements Job.JobListener, IWyTaskManager.Task
{
  ...
  private IWyFileSystem.WyErrorStatus getErrorStatus(Job paramJob)
  {
    ...
    if (!NetworkUtils.hasInternet(null)) {
      localWyErrorStatus.errorCode = 55533;
    }
    ...
    for (;;)
    {
      if ((localWyErrorStatus.errorCode == 35524) || (localWyErrorStatus.errorCode == 35510)) {
        localWyErrorStatus.errorCode = 55533;
      }
      if (localWyErrorStatus.errorCode == 55533) {
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\weiyun\sdk\job\schedule\JobProxy.class
