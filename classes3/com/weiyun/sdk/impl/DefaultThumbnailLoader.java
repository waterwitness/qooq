...
public class DefaultThumbnailLoader
{
  ...
  private final ThreadPoolExecutor mThreadPool = new ThreadPoolExecutor(0, Integer.MAX_VALUE, 30L, TimeUnit.SECONDS, new ArrayBlockingQueue(2), new WyTaskManager.DefaultThreadFactory("wy-thumbnail-loader"));
    ...
    implements Runnable
  {
    ...
    private void buildCache(String paramString)
    {
      ...
      while ((i < paramString.length) && (!this.mCanceled))
      {
        ...
        if ((((File)localObject).isFile()) && (((File)localObject).length() < 512000L)) {
          DefaultThumbnailLoader.this.mDiskCache.put(((File)localObject).getName(), ((File)localObject).getPath());
        }
        i += 1;
      }
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\weiyun\sdk\impl\DefaultThumbnailLoader.class
