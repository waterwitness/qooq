  ...
  public final void onRespond(int paramInt, byte[] paramArrayOfByte)
  {
    if (paramInt != 0)
    {
      ...
      if (!NetworkUtils.hasInternet(SdkContext.getInstance().getContext())) {
        paramArrayOfByte.errorCode = 55533;
      }
    ...
    {
      paramArrayOfByte = new IWyFileSystem.WyErrorStatus();
      paramArrayOfByte.errorCode = 37534;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        case 1: 
          ...
          {
            paramArrayOfByte.errorCode = 37535;
      ...
      catch (InvalidProtocolBufferMicroException paramArrayOfByte)
      {
        ...
        paramArrayOfByte = new IWyFileSystem.WyErrorStatus();
        paramArrayOfByte.errorCode = 37533;
        paramArrayOfByte.errorMsg = "无效的协议!";
        handleResponse(paramArrayOfByte, null);
        return;
      }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\weiyun\sdk\protocol\BaseCallback.class
