...
public class CosmeticsHandle
{
  ...
  public static final int COS_NONE = 38;
  ...
  private void checkCosModel()
  {
    ...
    if ((i & 0x8) == 8) {
      setModelFromList(new String[] { "lipsHL.png" }, 8);
    }
    if ((i & 0x10) == 16) {
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\microrapid\opencv\CosmeticsHandle.class
