...
final class PendingPost
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((!((PendingPost)paramObject).dispatchable.equals(this.dispatchable)) || (!TextUtils.equals(this.group, ((PendingPost)paramObject).group)) || (!((PendingPost)paramObject).tag.equals(this.tag)));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tribe\async\dispatch\PendingPost.class
