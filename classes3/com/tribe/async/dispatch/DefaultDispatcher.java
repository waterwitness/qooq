  ...
  implements Dispatcher
{
  ...
  private void removeSubscriberData(Class<? extends Dispatcher.Dispatchable> paramClass, Object paramObject, Subscriber paramSubscriber)
  {
    ...
    if (paramObject != null)
    {
      ...
      Iterator localIterator = ((CopyOnWriteArraySet)paramObject).iterator();
      while (localIterator.hasNext())
      {
        Wrapper localWrapper = (Wrapper)localIterator.next();
        Subscriber localSubscriber = localWrapper.get();
      ...
      ((CopyOnWriteArraySet)paramObject).removeAll(localArrayList);
      if (((CopyOnWriteArraySet)paramObject).isEmpty()) {
    ...
    implements DefaultDispatcher.Wrapper
  {
    ...
    public boolean equals(Object paramObject)
    {
      ...
      return this.mSubscriber.equals(((DefaultWrpper)paramObject).get());
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\com\tribe\async\dispatch\DefaultDispatcher.class
