...
{
  public oxr(RecentItemBaseBuilder paramRecentItemBaseBuilder, int paramInt1, int paramInt2, int[] paramArrayOfInt1, int paramInt3, int[] paramArrayOfInt2, int[] paramArrayOfInt3, int[] paramArrayOfInt4)
  {
  ...
  public void a(int paramInt, Object paramObject, SwipRightMenuBuilder.SwipRightMenuItem[] paramArrayOfSwipRightMenuItem)
  {
    ...
    for (int j = ((RecentBaseData)paramObject).K;; j = 0)
    {
      int i;
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\oxr.class
