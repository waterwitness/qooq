  ...
  extends CharDividedFacePreloadBaseAdapter
{
  ...
  public lgt(DiscussionMemberActivity paramDiscussionMemberActivity)
  {
  ...
  private void a()
  {
    ...
    {
      lgs locallgs = (lgs)((Iterator)localObject2).next();
      if ((locallgs.c == null) || (locallgs.c.length() == 0))
      {
        localObject1 = "#";
      ...
      for (localObject1 = ((String)localObject1).toUpperCase();; localObject1 = "#")
      {
        ...
        ((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(localObject1)).add(locallgs);
        break;
        localObject1 = locallgs.c.substring(0, 1);
        break label62;
      }
    }
  ...
  public Object getItem(int paramInt)
  {
    ...
    i = -(i + 1) - 1;
    return (lgs)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
  }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_ComTencentMobileqqActivityDiscussionMemberActivity.getLayoutInflater().inflate(2130903328, paramViewGroup, false);
      ...
      paramView.d = ((ImageView)localView.findViewById(2131298136));
    ...
    {
      i = -(i + 1) - 1;
      paramViewGroup = (lgs)((List)this.jdField_a_of_type_JavaUtilLinkedHashMap.get(this.jdField_a_of_type_ArrayOfJavaLangString[i])).get(paramInt - this.jdField_a_of_type_ArrayOfInt[i] - 1);
      ...
      paramView.d.setImageBitmap(a(paramViewGroup.a));
      paramView.c.setText(paramViewGroup.b);
      paramView.b = paramViewGroup.a;
      return localView;
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\lgt.class
