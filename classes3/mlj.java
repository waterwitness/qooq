  ...
  extends View
{
  ...
  public mlj(SnapScreenActivity paramSnapScreenActivity, Context paramContext)
  {
    super(paramContext);
    ...
    this.i = 100004;
    this.j = 100005;
    setOnLongClickListener(new mlk(this, paramSnapScreenActivity));
  }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    do
    {
      ...
      if (this.jdField_a_of_type_AndroidGraphicsRect.isEmpty())
      {
        ...
        paramCanvas.drawText(this.jdField_a_of_type_ComTencentMobileqqActivitySnapScreenActivity.jdField_a_of_type_AndroidContentContext.getString(2131368160), getWidth() / 2, i2 + 26.0F * f1, this.jdField_b_of_type_AndroidGraphicsPaint);
      }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\mlj.class
