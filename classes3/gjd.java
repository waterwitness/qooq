...
{
  public gjd(GuildMultiActivity paramGuildMultiActivity)
  {
  ...
  protected void a(long paramLong, boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    if ((!GuildMultiActivity.a(this.a, String.valueOf(paramLong))) || (this.a.jdField_a_of_type_ComTencentAvVideoController.F != 3)) {
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(GuildMultiActivity.jdField_a_of_type_JavaLangString, 2, "onGetStrangeFaceBitmap");
    }
    this.a.runOnUiThread(new gje(this));
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\gjd.class
