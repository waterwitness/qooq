...
public class mqa
  extends BaseAdapter
{
  public mqa(TroopClassChoiceActivity paramTroopClassChoiceActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null) {
      paramViewGroup = this.a.getLayoutInflater().inflate(2130905054, null);
    }
    TextView localTextView1 = (TextView)paramViewGroup.findViewById(2131305136);
    TextView localTextView2 = (TextView)paramViewGroup.findViewById(2131305138);
    ImageView localImageView = (ImageView)paramViewGroup.findViewById(2131305137);
    ...
    for (paramInt = 1;; paramInt = 0)
    {
      if (paramInt != 0)
      {
        ...
        localTextView2.setCompoundDrawablesWithIntrinsicBounds(0, 0, 2130843465, 0);
      }
      for (;;)
      {
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\mqa.class
