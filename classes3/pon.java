...
{
  public pon(DiscussionListAdapter2 paramDiscussionListAdapter2)
  {
  ...
  {
    ((SlideDetectListView)DiscussionListAdapter2.a(this.a)).c();
    ...
    {
      paramView = (BaseActivity)DiscussionListAdapter2.a(this.a);
      QQToast.a(paramView, DiscussionListAdapter2.a(this.a).getString(2131364259, new Object[] { String.valueOf(80) }), 0).b(paramView.getTitleBarHeight());
      return;
    }
    ...
    for (paramView = "0X8006898";; paramView = "0X8006897")
    {
      ...
      localDiscussionHandler.f(Long.valueOf(((DiscussionInfo)localObject).uin).longValue());
      return;
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\pon.class
