...
{
  public gqs(CallbackWaitingActivityExt paramCallbackWaitingActivityExt)
  {
    ...
    for (Object localObject = localCallTypeRspParam;; localObject = null)
    {
      if (paramBoolean.booleanValue())
      {
        if (localObject != null)
        {
          ...
          {
            CallbackWaitingActivityExt.i = ((PstnHandler.CallTypeRspParam)localObject).jdField_c_of_type_JavaLangString;
            ...
            this.a.jdField_a_of_type_ComTencentAvUiBaseCallbackUI.a.postDelayed(new gqt(this), 30000L);
          }
      ...
      for (;;)
      {
        if (i == 2)
        {
          ...
          DialogUtil.a(this.a, 230, paramBoolean, (String)paramObject, this.a.getString(2131363161), (String)localObject, new gqv(this), new gqw(this)).show();
          return;
        ...
        {
          DialogUtil.a(this.a, 230, "", paramBoolean, 2131363160, 2131363160, null, new gqx(this)).show();
          return;
          i = 1;
        }
      }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if ((this.a.b != null) && (this.a.jdField_a_of_type_AndroidWidgetButton != null))
    {
      ...
      this.a.a(this.a.jdField_a_of_type_AndroidWidgetButton, false, 2130839056);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\gqs.class
