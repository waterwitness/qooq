...
public class pus
  implements Runnable
{
  public pus(CardHandler paramCardHandler, Bundle paramBundle)
  {
  ...
  public void run()
  {
    ...
    Object localObject2 = ((FriendsManager)this.jdField_a_of_type_ComTencentMobileqqAppCardHandler.b.getManager(50)).b(this.jdField_a_of_type_ComTencentMobileqqAppCardHandler.b.a());
    ...
    for (int j = 1;; j = 0)
    {
      ...
      if (this.jdField_a_of_type_AndroidOsBundle.containsKey("key_interest_switch"))
      {
        m += 1;
        j += 6;
        ((ByteBuffer)localObject1).putShort((short)40313);
      ...
      if (this.jdField_a_of_type_AndroidOsBundle.containsKey("key_joined_group_switch"))
      {
        k += 1;
        i += 6;
        ((ByteBuffer)localObject1).putShort((short)40317);
        ((ByteBuffer)localObject1).putShort((short)2);
      ...
      if (this.jdField_a_of_type_AndroidOsBundle.containsKey("key_ktv_switch"))
      {
        m += 1;
        j += 6;
        ((ByteBuffer)localObject1).putShort((short)40318);
        ((ByteBuffer)localObject1).putShort((short)2);
      ...
      if (this.jdField_a_of_type_AndroidOsBundle.containsKey("key_music_switch"))
      {
        k += 1;
        i += 6;
        ((ByteBuffer)localObject1).putShort((short)40314);
        ((ByteBuffer)localObject1).putShort((short)2);
      ...
      if (this.jdField_a_of_type_AndroidOsBundle.containsKey("key_recent_activity_switch"))
      {
        m += 1;
        j += 6;
        ((ByteBuffer)localObject1).putShort((short)40315);
        ((ByteBuffer)localObject1).putShort((short)2);
      ...
      if (this.jdField_a_of_type_AndroidOsBundle.containsKey("key_star_switch"))
      {
        k += 1;
        i += 6;
        ((ByteBuffer)localObject1).putShort((short)40316);
        ((ByteBuffer)localObject1).putShort((short)2);
      ...
      if (this.jdField_a_of_type_AndroidOsBundle.containsKey("key_eat_switch"))
      {
        m += 1;
        j += 6;
        ((ByteBuffer)localObject1).putShort((short)40320);
        ((ByteBuffer)localObject1).putShort((short)2);
      ...
      if (this.jdField_a_of_type_AndroidOsBundle.containsKey("key_reader_switch"))
      {
        k += 1;
        i += 6;
        ((ByteBuffer)localObject1).putShort((short)41981);
        ((ByteBuffer)localObject1).putShort((short)2);
      ...
      if (this.jdField_a_of_type_AndroidOsBundle.containsKey("key_radio_switch"))
      {
        m += 1;
        j += 6;
        ((ByteBuffer)localObject1).putShort((short)40335);
        ((ByteBuffer)localObject1).putShort((short)2);
      ...
      if (this.jdField_a_of_type_AndroidOsBundle.containsKey("key_comic_switch"))
      {
        k += 1;
        i += 6;
        ((ByteBuffer)localObject1).putShort((short)40526);
        ((ByteBuffer)localObject1).putShort((short)2);
      ...
      if (this.jdField_a_of_type_AndroidOsBundle.containsKey("key_now_switch"))
      {
        m += 1;
        j += 6;
        ((ByteBuffer)localObject1).putShort((short)40527);
        ((ByteBuffer)localObject1).putShort((short)2);
      ...
      ((ByteBuffer)localObject2).putInt((int)Long.parseLong(this.jdField_a_of_type_ComTencentMobileqqAppCardHandler.b.a()));
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\pus.class
