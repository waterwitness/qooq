...
{
  private kij(AddFriendLogicActivity paramAddFriendLogicActivity)
  {
  ...
  protected void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
      default: 
        QQToast.a(this.a.app.getApplication(), 2131368649, 0).b(this.a.getTitleBarHeight());
        this.a.finish();
        return;
      case 0: 
        this.a.a(i, paramBundle.booleanValue(), localArrayList, AutoRemarkActivity.class);
      ...
      case 4: 
        ...
        return;
      case 2: 
        QQToast.a(this.a.app.getApplication(), 2131368648, 0).b(this.a.getTitleBarHeight());
        this.a.finish();
        return;
      }
      QQToast.a(this.a.app.getApplication(), "对方已经是你的好友了", 0).b(this.a.getTitleBarHeight());
      if (AddFriendLogicActivity.b(this.a) == 1) {
        ((FriendListHandler)this.a.app.a(1)).a(str, 0, 10004, "", true, false, -1L);
      }
      for (;;)
      {
        this.a.setResult(-1);
        ...
        if (AddFriendLogicActivity.b(this.a) == 2) {
          ((PhoneContactManagerImp)this.a.app.getManager(10)).b();
        }
      }
    }
    QQToast.a(this.a.app.getApplication(), 2131368649, 0).b(this.a.getTitleBarHeight());
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\kij.class
