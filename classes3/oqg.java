...
public class oqg
  implements Runnable
{
  public oqg(AlbumListAdapter paramAlbumListAdapter)
  {
  ...
  public void run()
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      {
        String str2 = FileUtil.b(localQQAlbumInfo.mCoverInfo.a);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\oqg.class
