...
public class hck
{
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6)
  {
    ...
    } while ((this.h == 0) || (paramInt6 <= 0) || (this.d % paramInt6 == 0));
    if (paramInt2 > 0)
    {
      paramInt3 = this.d / paramInt6 * paramInt6;
      paramInt4 = (this.d / paramInt6 + 1) * paramInt6;
      if ((Math.abs(paramInt4 - this.d) < Math.abs(this.d - paramInt3)) || (paramInt3 < paramInt1)) {
        this.d = paramInt4;
      }
    }
    for (;;)
  ...
  public boolean b()
  {
    ...
    for (;;)
    {
      ...
      this.jdField_b_of_type_Float = ((float)((this.jdField_a_of_type_Float - this.jdField_a_of_type_Double) / (l1 - this.jdField_b_of_type_Long) * 1000.0D));
      continue;
      d1 = OverScroller.a((float)l2 / this.jdField_f_of_type_Int) * this.i;
      continue;
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\hck.class
