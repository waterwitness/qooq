...
{
  public pvm(ClubContentUpdateHandler paramClubContentUpdateHandler)
  {
  ...
  public void onDone(DownloadTask paramDownloadTask)
  {
    ...
    if ((paramDownloadTask.containsKey("version")) && (paramDownloadTask.containsKey("json_name")))
    {
      ...
      if (ClubContentJsonTask.i.e.equals(paramDownloadTask))
      {
        Object localObject = new File(this.a.a.getApplication().getApplicationContext().getFilesDir(), ClubContentJsonTask.i.b);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\pvm.class
