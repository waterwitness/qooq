  ...
  private ArrayList<g> d(ArrayList<f> paramArrayList)
  {
    ...
    while (paramArrayList.hasNext())
    {
      ...
      if (((f)localObject).b == 6)
      {
        ...
        {
          g localg = new g();
          localg.a = az.a(((AppInfo)localObject).getPkgName());
          localg.b = az.a(((AppInfo)localObject).getCertMd5());
          localg.c = ((int)((AppInfo)localObject).getFileSize());
          if (((AppInfo)localObject).getAppType() == 1) {}
          for (boolean bool = true;; bool = false)
          {
            localg.g = bool;
            localg.f = az.a(((AppInfo)localObject).getSoftName());
            localg.d = az.a(((AppInfo)localObject).getVersionName());
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\sm\w.class
