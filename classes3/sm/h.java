  ...
  implements Cloneable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.a, ((h)paramObject).a)) || (!JceUtil.equals(this.b, ((h)paramObject).b)) || (!JceUtil.equals(this.c, ((h)paramObject).c)) || (!JceUtil.equals(this.d, ((h)paramObject).d)) || (!JceUtil.equals(this.e, ((h)paramObject).e)) || (!JceUtil.equals(this.f, ((h)paramObject).f)) || (!JceUtil.equals(this.g, ((h)paramObject).g)) || (!JceUtil.equals(this.h, ((h)paramObject).h)) || (!JceUtil.equals(this.i, ((h)paramObject).i)) || (!JceUtil.equals(this.j, ((h)paramObject).j)));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\sm\h.class
