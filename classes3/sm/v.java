  ...
  implements Cloneable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.a, ((v)paramObject).a)) || (!JceUtil.equals(this.b, ((v)paramObject).b)) || (!JceUtil.equals(this.c, ((v)paramObject).c)) || (!JceUtil.equals(this.d, ((v)paramObject).d)) || (!JceUtil.equals(this.e, ((v)paramObject).e)) || (!JceUtil.equals(this.f, ((v)paramObject).f)) || (!JceUtil.equals(this.g, ((v)paramObject).g)) || (!JceUtil.equals(this.h, ((v)paramObject).h)) || (!JceUtil.equals(this.i, ((v)paramObject).i)) || (!JceUtil.equals(this.j, ((v)paramObject).j)) || (!JceUtil.equals(this.k, ((v)paramObject).k)) || (!JceUtil.equals(this.l, ((v)paramObject).l)) || (!JceUtil.equals(this.m, ((v)paramObject).m)) || (!JceUtil.equals(this.n, ((v)paramObject).n)) || (!JceUtil.equals(this.o, ((v)paramObject).o)) || (!JceUtil.equals(this.p, ((v)paramObject).p)) || (!JceUtil.equals(this.q, ((v)paramObject).q)) || (!JceUtil.equals(this.r, ((v)paramObject).r)));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\sm\v.class
