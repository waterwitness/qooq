...
public final class kse
  implements Runnable
{
  public kse(QQAppInterface paramQQAppInterface, Emoticon paramEmoticon)
  {
  ...
  public void run()
  {
    for (;;)
    {
      ...
      localObject1 = (EmoticonManager)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(13);
      if (localObject1 == null) {
        return;
      }
      ((EmoticonManager)localObject1).b(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon);
      localObject2 = ((EmoticonManager)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId);
      if ((localObject2 == null) || (((EmoticonPackage)localObject2).status != 0)) {
        return;
      }
      ((EmoticonManager)localObject1).a(this.jdField_a_of_type_ComTencentMobileqqDataEmoticon);
      return;
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\kse.class
