...
{
  public plo(QQSpecialFriendSettingActivity paramQQSpecialFriendSettingActivity)
  {
  ...
  protected void b(boolean paramBoolean, Object[] paramArrayOfObject)
  {
    ...
    label223:
    for (int i = 2131369497;; i = 2131371056)
    {
      paramArrayOfObject.arg2 = i;
      this.a.a.sendMessage(paramArrayOfObject);
      if ((!paramBoolean) || (j != 0)) {
      ...
      paramArrayOfObject.putExtra("selfSet_leftViewText", this.a.getString(2131371913));
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\plo.class
