...
public class oug
  implements Runnable
{
  public oug(CommonHbFragment paramCommonHbFragment)
  {
  ...
  public void run()
  {
    ...
    CommonHbFragment.c(this.a).dispatchTouchEvent(localMotionEvent1);
    MotionEvent localMotionEvent2 = MotionEvent.obtain(SystemClock.uptimeMillis(), SystemClock.uptimeMillis(), 1, 0.0F, 0.0F, 0);
    CommonHbFragment.c(this.a).dispatchTouchEvent(localMotionEvent2);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\oug.class
