  ...
  extends Thread
{
  ...
  public gir(GameHeroesProtocol paramGameHeroesProtocol, long paramLong1, long paramLong2, SessionInfo.HeroDetail paramHeroDetail)
  {
  ...
  String a()
  {
    try
    {
      ...
      localJSONObject1.put("qqver", this.jdField_a_of_type_ComTencentAvGuildGameHeroesProtocol.d);
      localJSONObject1.put("net", com.tencent.mobileqq.app.AppConstants.jdField_b_of_type_ArrayOfJavaLangString[com.tencent.mobileqq.utils.NetworkUtil.a(this.jdField_a_of_type_ComTencentAvGuildGameHeroesProtocol.jdField_a_of_type_ComTencentAvAppVideoAppInterface.a().getBaseContext())]);
  ...
  void b()
  {
    ...
    if (this.jdField_a_of_type_ComTencentAvGuildGameHeroesProtocol.jdField_a_of_type_Giq != null) {
      this.jdField_a_of_type_ComTencentAvGuildGameHeroesProtocol.jdField_a_of_type_Giq.a();
    }
    a();
  ...
  public void run()
  {
    ...
    {
      String str1 = a();
      String str2 = "http://league.gamecenter.qq.com/cgi-bin/gc_league_asyn_fcgi?g_tk=" + TroopBarShortVideoUploadUtil.a(this.jdField_a_of_type_ComTencentAvGuildGameHeroesProtocol.e) + "&param=" + URLEncoder.encode(str1, "UTF-8");
      String str3 = "uin=o0" + this.jdField_a_of_type_ComTencentAvGuildGameHeroesProtocol.jdField_c_of_type_JavaLangString + ";skey=" + this.jdField_a_of_type_ComTencentAvGuildGameHeroesProtocol.e;
      if (QLog.isColorLevel())
      {
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\gir.class
