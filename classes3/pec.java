...
{
  public pec(FramesProcessor paramFramesProcessor)
  {
  ...
  public boolean onScroll(MotionEvent arg1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
  {
    do
    {
      synchronized (this.a)
      {
        FramesProcessor.a(this.a, paramFloat1);
        if (FramesProcessor.a(this.a) < FramesProcessor.b(this.a)) {
          FramesProcessor.b(this.a, FramesProcessor.b(this.a));
        }
        if (FramesProcessor.a(this.a) > FramesProcessor.c(this.a)) {
          FramesProcessor.b(this.a, FramesProcessor.c(this.a));
        }
        paramFloat1 = FramesProcessor.a(this.a);
        paramFloat2 = FramesProcessor.d(this.a);
        FramesProcessor.c(this.a, FramesProcessor.a(this.a));
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\pec.class
