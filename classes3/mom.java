...
{
  public mom(SubLoginActivity paramSubLoginActivity)
  {
  ...
  protected void onGetKeyBack(String paramString1, String paramString2, String paramString3)
  {
    ...
    else
    {
      ...
      this.a.a();
      this.a.a(this.a.getString(2131370540));
      this.a.runOnUiThread(new moo(this));
    }
    for (;;)
    {
      return;
      ...
      while (QLog.isColorLevel())
      {
        ...
        if (paramString1 != null) {
          paramString1.a(paramString2, paramString3, this.a.jdField_a_of_type_JavaLangString);
        }
  ...
  protected void onLoginFailed(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    for (;;)
    {
      ...
      {
        this.a.a();
        this.a.runOnUiThread(new mon(this));
        if (TextUtils.isEmpty(paramString4))
        {
          this.a.a(this.a.getString(2131367481));
          return;
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\mom.class
