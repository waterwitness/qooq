...
{
  public gxq(PSTNC2CActivity paramPSTNC2CActivity)
  {
    ...
    for (;;)
    {
      if (paramBoolean.booleanValue())
      {
        if (localObject != null)
        {
          ...
          this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().jdField_b_of_type_Int = 1;
          this.a.jdField_a_of_type_MqqOsMqqHandler.postDelayed(new gxr(this), 500L);
        }
        return;
      }
      this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().jdField_b_of_type_Int = -1;
      ...
      for (;;)
      {
        if (i == 2)
        {
          ...
          DialogUtil.a(this.a, 230, paramBoolean, (String)paramObject, this.a.getString(2131363161), (String)localObject, new gxs(this), new gxt(this)).show();
          return;
        ...
        {
          DialogUtil.a(this.a, 230, "", paramBoolean, 2131363160, 2131363160, null, new gxu(this)).show();
          return;
          i = 1;
        }
      }
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    this.a.jdField_c_of_type_AndroidWidgetTextView.setText(this.a.getResources().getString(2131364009));
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\gxq.class
