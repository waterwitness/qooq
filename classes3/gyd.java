...
class gyd
  implements Runnable
{
  gyd(gyb paramgyb, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, int paramInt)
  {
  ...
  public void run()
  {
    int j = this.jdField_a_of_type_Gyb.a.jdField_a_of_type_ComTencentWidgetHorizontalListView.getFirstVisiblePosition();
    int k = this.jdField_a_of_type_Gyb.a.jdField_a_of_type_ComTencentWidgetHorizontalListView.getLastVisiblePosition();
    int i = j;
    Object localObject;
    if (i <= k)
    {
      ...
      localObject = this.jdField_a_of_type_Gyb.a.jdField_a_of_type_ComTencentWidgetHorizontalListView.getChildAt(i - j);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\gyd.class
