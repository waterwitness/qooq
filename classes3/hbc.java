...
{
  public hbc(NearbyPeopleProfileHelper paramNearbyPeopleProfileHelper)
  {
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (paramIntent.getAction().equals("tencent.video.q2v.getNearByProfile"))
    {
      ...
      paramIntent = SessionMgr.a().a(this.a.jdField_b_of_type_JavaLangString);
      if (paramIntent != null) {
        break label98;
      }
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\hbc.class
