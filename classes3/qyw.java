...
{
  public qyw(ConditionSearchFriendActivity paramConditionSearchFriendActivity)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        if (this.a.a[paramInt1] != null)
        {
          ...
          if (((BaseAddress)((List)this.a.a[paramInt1]).get(i)).b.equals("0")) {
            str1 = "不限";
          } else {
            str1 = ((BaseAddress)((List)this.a.a[paramInt1]).get(i)).a;
          }
        }
      }
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\qyw.class
