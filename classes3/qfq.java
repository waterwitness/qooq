...
public class qfq
  implements Runnable
{
  public qfq(RouterHandler paramRouterHandler, long paramLong, MsgHeader paramMsgHeader)
  {
  ...
  public void run()
  {
    ...
    {
      localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppRouterHandler.c.a().createEntityManager();
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\qfq.class
