...
public class rmn
  extends Handler
{
  public rmn(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity)
  {
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    for (;;)
    {
      ...
      for (bool1 = true;; bool1 = false)
      {
        ...
        {
          if (QLog.isColorLevel()) {
            QLog.d(Face2FaceAddFriendActivity.jdField_a_of_type_JavaLangString, 2, "show next isPush=" + localObject + "isNeedShake=" + bool1 + "currentFriendIndex=" + this.a.u + "count=" + j);
          }
          ...
          for (;;)
          {
            ...
            if (this.a.c.containsKey(paramMessage.e))
            {
              ...
              this.a.c.put(paramMessage.e, Integer.valueOf(i));
              break label448;
              if ((this.a.b != 1) || (((TroopManager)this.a.app.getManager(51)).a(this.a.e, paramMessage.e) == null)) {
                break label1245;
              }
              i = 2;
              continue;
            ...
            sendMessageDelayed(obtainMessage(5), Face2FaceAddFriendActivity.C);
            if (!QLog.isColorLevel()) {
              break;
            }
            ...
            paramMessage = this.a.getResources().getString(2131372063);
            ...
            long l = this.a.N;
            paramMessage = new Face2FaceUserProfile(2396794490L + l + "", "Member " + this.a.N, 1, 1, "");
            localObject = this.a;
            ((Face2FaceAddFriendActivity)localObject).N += 1;
            ...
            return;
            QQToast.a(this.a.app.getApplication(), 2131369008, 0).b(this.a.getTitleBarHeight());
            return;
            i = 1;
          }
        }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\rmn.class
