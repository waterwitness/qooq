...
{
  private lpw(JoinDiscussionActivity paramJoinDiscussionActivity)
  {
  ...
  protected void a(boolean paramBoolean, int paramInt, RespGetDiscussInfo paramRespGetDiscussInfo)
  {
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilArrayList.size() == this.a.jdField_c_of_type_Int)
      {
        ...
        this.a.runOnUiThread(new lpx(this, paramRespGetDiscussInfo));
      }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\lpw.class
