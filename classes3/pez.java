...
{
  public pez(CreateFaceToFaceDiscussionActivity paramCreateFaceToFaceDiscussionActivity)
  {
  ...
  protected void a(boolean paramBoolean, Object paramObject)
  {
    ...
    if (paramBoolean)
    {
      ...
      {
        if (!DiscussionInfo.isValidDisUin((String)paramObject)) {
          break label176;
        }
        this.a.finish();
        str = ContactUtils.a(this.a.app, this.a.getActivity().getApplicationContext(), (String)paramObject);
        localIntent = AIOUtils.a(new Intent(this.a.getActivity(), SplashActivity.class), null);
        localIntent.putExtra("uin", (String)paramObject);
    ...
    while (i != this.a.jdField_b_of_type_Int)
    {
      ...
      Intent localIntent;
      return;
      CreateFaceToFaceDiscussionActivity.a(this.a, 1, this.a.getString(2131371327));
      return;
    }
    CreateFaceToFaceDiscussionActivity.b(this.a, 1, this.a.getString(2131371327));
  }
  ...
  protected void a(boolean paramBoolean, List paramList, int paramInt1, int paramInt2, nearfield_discuss.BusiRespHead paramBusiRespHead)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (this.a.jdField_a_of_type_JavaUtilList == null)
      {
        ...
        if (this.a.jdField_a_of_type_Pfc != null)
        {
          this.a.jdField_a_of_type_Pfc.notifyDataSetChanged();
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\pez.class
