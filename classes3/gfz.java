...
{
  public gfz(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public void a(int paramInt1, String paramString, int paramInt2, long paramLong, int paramInt3, int paramInt4, int paramInt5)
  {
    if (QLog.isColorLevel()) {
      QLog.w(VideoAppInterface.a, 2, "testHWCodecIfNeed onFinish resultCode: " + paramInt1 + ", codecName: " + paramString + ", colorFormat: " + paramInt2 + "(0x" + Integer.toHexString(paramInt2).toUpperCase() + ")" + ", delay: " + paramLong + ", ssim: " + paramInt3 + ", rate0: " + paramInt4 + ", rate1: " + paramInt5);
    }
    ...
    StatisticCollector.a(BaseApplication.getContext()).a(this.a.a(), "AV_HWCODEC_AVC_ENC", true, 0L, 0L, localHashMap, "", true);
  }
}


/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\gfz.class
