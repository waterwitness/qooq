...
{
  public rln(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity)
  {
  ...
  public void a(Face2FaceGroupProfile paramFace2FaceGroupProfile)
  {
    ...
    for (;;)
    {
      ...
      paramFace2FaceGroupProfile.F += 1;
      return;
      bool = false;
      break;
      label163:
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, String paramString)
  {
    ...
    for (paramBusiRespHead = paramBusiRespHead.e + "_" + ((Face2FaceGroupProfile)paramBusiRespHead).jdField_b_of_type_JavaLangString;; paramBusiRespHead = paramString)
    {
      ...
      break;
      ReportController.b(null, "P_CliOper", "Grp_set", "", "Radar_grp_guest", "suc_join", 0, 0, paramString, "6.5.5", "", this.a.app.a());
  ...
  public void a(nearfield_group.BusiRespHead paramBusiRespHead, List paramList)
  {
    ...
    if (paramList == null)
    {
      ...
      if (this.a.jdField_b_of_type_Int == 1) {
        DialogUtil.a(this.a, 230, this.a.getString(2131368978), "分享失败，请稍后重试", 2131367262, 2131367774, new rlo(this), null).show();
      }
    }
    label177:
    label183:
    ...
    DialogUtil.a(this.a, 230, this.a.getString(2131368978), "分享失败，请稍后重试", 2131367262, 2131367774, new rlp(this), null).show();
  }
}


/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\rln.class
