...
public class pwb
  implements Runnable
{
  public pwb(ConfigHandler paramConfigHandler, String paramString, StatusManager paramStatusManager, GetResourceRespInfo paramGetResourceRespInfo)
  {
  ...
  public void run()
  {
    ...
    if (i == 0) {
      if (this.jdField_a_of_type_ComTencentMobileqqRichstatusStatusManager.a((File)localObject1, this.jdField_a_of_type_ProtocolKQQConfigGetResourceRespInfo.uiNewVer))
      {
        ...
        str = this.jdField_a_of_type_ComTencentMobileqqAppConfigHandler.b.a();
        if (i != 0) {
          break label328;
        }
      }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\pwb.class
