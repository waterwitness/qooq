...
public class rmh
  extends LBSObserver
{
  public rmh(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity)
  {
  ...
  protected void a(boolean paramBoolean, List paramList, int paramInt1, int paramInt2)
  {
    ...
    label259:
    if (paramInt2 > 0) {
      Face2FaceAddFriendActivity.C = paramInt2 * 1000;
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\rmh.class
