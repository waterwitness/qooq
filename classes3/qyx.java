...
{
  public qyx(ConditionSearchFriendActivity paramConditionSearchFriendActivity)
  {
  ...
  public void a()
  {
    if ((this.a.i == 0) && (this.a.f > this.a.g) && (this.a.g != 0)) {
      QQToast.a(this.a, this.a.getResources().getString(2131371455), 0).b(this.a.getTitleBarHeight());
    }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    do
    {
      ...
      while (this.a.i == 1)
      {
        this.a.jdField_b_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(this.a.jdField_a_of_type_ComTencentMobileqqAppConditionSearchManager.b(ConditionSearchFriendActivity.a(this.a)));
        return;
        if (this.a.jdField_a_of_type_ArrayOfJavaLangObject[0] != null)
        {
          if (paramInt2 >= 0)
          {
            paramInt1 = paramInt2;
          ...
          this.a.jdField_a_of_type_ArrayOfJavaLangString[0] = this.a.jdField_a_of_type_ArrayOfComTencentMobileqqConditionsearchDataBaseAddress[0].b;
          localObject = this.a.jdField_a_of_type_ArrayOfComTencentMobileqqConditionsearchDataBaseAddress[0].a();
          if (this.a.h > 1)
          {
            ...
            if (this.a.jdField_a_of_type_ArrayOfJavaLangObject[1] != null)
            {
              if (paramInt2 >= 0)
              {
                paramInt1 = paramInt2;
              ...
              this.a.jdField_a_of_type_ArrayOfJavaLangString[1] = this.a.jdField_a_of_type_ArrayOfComTencentMobileqqConditionsearchDataBaseAddress[1].b;
              ArrayList localArrayList = this.a.jdField_a_of_type_ArrayOfComTencentMobileqqConditionsearchDataBaseAddress[1].a();
              if (this.a.h > 2)
              {
                ...
                if ((this.a.jdField_a_of_type_ComTencentWidgetActionSheet != null) && (this.a.jdField_a_of_type_ComTencentWidgetActionSheet.isShowing()))
                {
                  this.a.jdField_a_of_type_ComTencentWidgetActionSheet.dismiss();
                  continue;
                  if (this.a.jdField_a_of_type_ArrayOfJavaLangObject[2] != null)
                  {
                    if (paramInt2 >= 0)
                    {
                      paramInt1 = paramInt2;
                    ...
                    this.a.jdField_a_of_type_ArrayOfJavaLangString[2] = this.a.jdField_a_of_type_ArrayOfComTencentMobileqqConditionsearchDataBaseAddress[2].b;
                  }
                }
              }
            }
    ...
    this.a.jdField_c_of_type_ComTencentMobileqqWidgetFormSimpleItem.setRightText(this.a.jdField_a_of_type_ComTencentMobileqqAppConditionSearchManager.b(ConditionSearchFriendActivity.a(this.a)));
  }
}


/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\qyx.class
