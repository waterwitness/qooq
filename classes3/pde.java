...
class pde
  implements Runnable
{
  pde(pdc parampdc, PtvTemplateManager.PtvTemplateInfo paramPtvTemplateInfo, int paramInt)
  {
  ...
  public void run()
  {
    int j = this.jdField_a_of_type_Pdc.a.jdField_a_of_type_ComTencentWidgetHorizontalListView.getFirstVisiblePosition();
    int k = this.jdField_a_of_type_Pdc.a.jdField_a_of_type_ComTencentWidgetHorizontalListView.getLastVisiblePosition();
    int i = j;
    Object localObject;
    if (i <= k)
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.i(PtvTemplateManager.a, 2, "onProgressUpdate index: " + i + " progress: " + this.jdField_a_of_type_Int);
      }
      ((PtvTemplateManager.PtvTemplateInfo)localObject).downloading = true;
      localObject = this.jdField_a_of_type_Pdc.a.jdField_a_of_type_ComTencentWidgetHorizontalListView.getChildAt(i - j);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\pde.class
