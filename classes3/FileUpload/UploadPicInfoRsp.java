...
public final class UploadPicInfoRsp
  extends JceStruct
{
  private static stWaterTemplate a = new stWaterTemplate();
  ...
  public final void readFrom(JceInputStream paramJceInputStream)
  {
    ...
    this.waterTemplate = ((stWaterTemplate)paramJceInputStream.read(a, 17, false));
    this.iBusiNessType = paramJceInputStream.read(this.iBusiNessType, 18, false);
    this.vBusiNessDataRsp = ((byte[])paramJceInputStream.read(b, 19, false));
  }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\FileUpload\UploadPicInfoRsp.class
