...
{
  public lka(FriendProfileCardActivity paramFriendProfileCardActivity, ActionSheet paramActionSheet)
  {
  ...
  public void OnClick(View paramView, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      int i = ProfileCardUtil.c(this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity);
      ...
      localUserInfo.a = this.jdField_a_of_type_ComTencentMobileqqActivityFriendProfileCardActivity.app.a();
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\lka.class
