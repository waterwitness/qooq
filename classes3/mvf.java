...
class mvf
  implements Runnable
{
  mvf(mvb parammvb, List paramList)
  {
  ...
  public void run()
  {
    ...
    for (int i = 0;; i = this.jdField_a_of_type_JavaUtilList.size())
    {
      ...
      localObject1 = (TroopHandler)this.jdField_a_of_type_Mvb.a.app.a(20);
      if (localObject1 == null) {
        break;
      }
      try
      {
        ((TroopHandler)localObject1).a(Long.parseLong(this.jdField_a_of_type_Mvb.a.k), 0L, 2, null, 0, 0);
        return;
      }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\mvf.class
