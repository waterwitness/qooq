...
{
  public ozf(FlowCameraActivity2 paramFlowCameraActivity2, File paramFile, Button paramButton)
  {
  ...
  {
    if (new File(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaFlowCameraActivity2.c).exists())
    {
      ...
      paramView.add(this.jdField_a_of_type_ComTencentMobileqqActivityRichmediaFlowCameraActivity2.c);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\ozf.class
