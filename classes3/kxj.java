...
{
  public kxj(ChatHistoryForC2C paramChatHistoryForC2C, View paramView1, int paramInt, View paramView2, TranslateAnimation paramTranslateAnimation)
  {
  ...
  public void onDismiss(DialogInterface paramDialogInterface)
  {
    ...
    while (bool)
    {
      this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryForC2C.leftView.setText(this.jdField_a_of_type_ComTencentMobileqqActivityChatHistoryForC2C.getString(2131367975));
      return;
      label220:
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\kxj.class
