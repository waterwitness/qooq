...
public final class bg
{
  ...
  public bg(byte[] paramArrayOfByte)
  {
    this.a = ByteBuffer.wrap(paramArrayOfByte);
  }
  
  public bg(byte[] paramArrayOfByte, byte paramByte)
  {
    this.a = ByteBuffer.wrap(paramArrayOfByte);
    this.a.position(4);
  }
  ...
  public final bi a(bi parambi, int paramInt, boolean paramBoolean)
  {
    a locala = null;
    if (a(paramInt))
    {
      try
      {
        parambi = (bi)parambi.getClass().newInstance();
        locala = new a();
        a(locala, this.a);
        if (locala.a != 10) {
          throw new RuntimeException("type mismatch.");
      ...
      {
        throw new RuntimeException(parambi.getMessage());
      }
      parambi.a(this);
      a();
    }
  ...
  public final Object a(Object paramObject, int paramInt, boolean paramBoolean)
  {
    ...
    if ((paramObject instanceof bi)) {
      return a((bi)paramObject, paramInt, paramBoolean);
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\ct\bg.class
