...
{
  public klc(AuthDevActivity paramAuthDevActivity)
  {
  ...
  protected void a(boolean paramBoolean, SvcRspGetDevLoginInfo paramSvcRspGetDevLoginInfo)
  {
    ...
    for (;;)
    {
      ...
      QQToast.a(this.a, 1, this.a.getString(2131370732), 0).b(this.a.getTitleBarHeight());
      return;
      label312:
  ...
  protected void b(boolean paramBoolean, String paramString, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      QQToast.a(this.a.getApplicationContext(), 2, this.a.getString(2131370734), 0).b(this.a.getTitleBarHeight());
      return;
    }
    if (TextUtils.isEmpty(paramString))
    {
      QQToast.a(this.a.getApplicationContext(), 1, this.a.getString(2131370733), 0).b(this.a.getTitleBarHeight());
      return;
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\klc.class
