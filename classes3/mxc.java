...
{
  public mxc(String paramString, Context paramContext, TroopNotificationUtils.TroopPrivilegeCallback paramTroopPrivilegeCallback, structmsg.StructMsg paramStructMsg)
  {
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    if (paramInt == 0)
    {
      ...
      if (paramBundle != null)
      {
        ...
        if (paramBundle.uint32_app_privilege_flag.has())
        {
          ...
          j = i;
          new Handler(this.jdField_a_of_type_AndroidContentContext.getMainLooper()).post(new mxd(this, k));
          label434:
          return;
        }
      }
    ...
    for (;;)
    {
      new Handler(this.jdField_a_of_type_AndroidContentContext.getMainLooper()).post(new mxe(this, i, paramInt, paramBundle));
      if (!QLog.isColorLevel()) {
        break label434;
      }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\mxc.class
