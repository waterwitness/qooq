  ...
  implements TextWatcher
{
  ...
  public lez(DetailProfileActivity paramDetailProfileActivity, int paramInt, EditText paramEditText)
  {
      ...
      do
      {
        for (;;)
        {
          ...
          if (QLog.isColorLevel())
          {
            ...
            DetailProfileActivity.b(this.jdField_a_of_type_ComTencentMobileqqActivityDetailProfileActivity, true);
          }
        }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\lez.class
