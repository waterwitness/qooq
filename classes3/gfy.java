...
{
  public gfy(VideoAppInterface paramVideoAppInterface)
  {
  ...
  public void a(int paramInt1, String paramString, int paramInt2, long paramLong)
  {
    if (QLog.isColorLevel()) {
      QLog.w(VideoAppInterface.a, 2, "onFinish resultCode: " + paramInt1 + ", codecName: " + paramString + ", colorFormat: " + paramInt2 + "(0x" + Integer.toHexString(paramInt2).toUpperCase() + ")" + ", delay: " + paramLong);
    }
    ...
    StatisticCollector.a(BaseApplication.getContext()).a(this.a.a(), "AV_HWCODEC_AVC_DEC", true, 0L, 0L, localHashMap, "", true);
  }
}


/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\gfy.class
