...
{
  public rmi(Face2FaceAddFriendActivity paramFace2FaceAddFriendActivity)
  {
  ...
  protected void a(String paramString)
  {
    ...
    try
    {
      ...
      if (localObject != null)
      {
        ...
        localObject = this.a.getResources().getString(2131372062);
  ...
  protected void a(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    for (;;)
    {
      ...
      {
        new ArrayList();
        localObject = this.a.app.a().b(AppConstants.av, 0);
        if (QLog.isColorLevel()) {
      ...
      if (localException.structMsg.msg_type.get() == 1)
      {
        ...
        else
        {
          ...
          for (boolean bool = true;; bool = false)
          {
            ...
            String str1 = this.a.getResources().getString(2131367431);
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\rmi.class
