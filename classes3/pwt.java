...
public class pwt
  implements Runnable
{
  public pwt(DataLineHandler paramDataLineHandler, FromServiceMsg paramFromServiceMsg, int paramInt, long paramLong)
  {
  ...
  public void run()
  {
    ...
    for (;;)
    {
      Object localObject = this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.b.a().a(this.jdField_a_of_type_Int).b(this.jdField_a_of_type_Long);
      if (localObject != null) {
        break;
      }
      return;
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\pwt.class
