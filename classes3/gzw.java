  ...
  extends BroadcastReceiver
{
  ...
  public gzw(VideoInviteLock paramVideoInviteLock)
  {
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (paramContext.equals("android.intent.action.CLOSE_SYSTEM_DIALOGS"))
    {
      ...
      {
        this.a.jdField_a_of_type_ComTencentAvVideoController.a(this.a.jdField_d_of_type_JavaLangString, 1, false);
        this.a.jdField_a_of_type_ComTencentAvVideoController.a(this.a.jdField_d_of_type_JavaLangString, 0);
        this.a.jdField_a_of_type_ComTencentAvVideoController.c(this.a.jdField_d_of_type_JavaLangString, 1);
        this.a.finish();
        if (!this.a.b) {
          break label155;
        }
        ReportController.b(null, "CliOper", "", "", "0X80041FF", "0X80041FF", 0, 0, Integer.toString(this.a.jdField_d_of_type_Int), Integer.toString(this.a.jdField_i_of_type_Int), Integer.toString(this.a.j), "");
      }
    }
    label155:
    do
    {
      ...
      {
        return;
        ReportController.b(null, "CliOper", "", "", "0X8004203", "0X8004203", 0, 0, Integer.toString(this.a.jdField_d_of_type_Int), Integer.toString(this.a.jdField_i_of_type_Int), Integer.toString(this.a.j), "");
        return;
        ...
        if (QLog.isColorLevel()) {
          QLog.d(VideoInviteLock.jdField_i_of_type_JavaLangString, 2, "recv cancel video request");
        }
      ...
      {
        this.a.jdField_a_of_type_ComTencentAvUiQavInOutAnimation.a(new gzx(this));
        return;
      }
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(VideoInviteLock.jdField_i_of_type_JavaLangString, 2, "ACTION_SCREEN_OFF");
        }
        ...
        if (this.a.b)
        {
          ReportController.b(null, "CliOper", "", "", "0X8004208", "0X8004208", 0, 0, Integer.toString(this.a.jdField_d_of_type_Int), Integer.toString(this.a.jdField_i_of_type_Int), Integer.toString(this.a.j), "");
          return;
        }
        ReportController.b(null, "CliOper", "", "", "0X8004209", "0X8004209", 0, 0, Integer.toString(this.a.jdField_d_of_type_Int), Integer.toString(this.a.jdField_i_of_type_Int), Integer.toString(this.a.j), "");
        return;
      }
    } while (!paramContext.equals("android.intent.action.SCREEN_ON"));
    if (QLog.isColorLevel()) {
      QLog.d(VideoInviteLock.jdField_i_of_type_JavaLangString, 2, "ACTION_SCREEN_ON");
    }
...
/* Location:              E:\apk\QQ_91\classes3-dex2jar.jar!\gzw.class
