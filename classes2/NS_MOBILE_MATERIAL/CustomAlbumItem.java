...
public final class CustomAlbumItem
  extends JceStruct
{
  static MaterialFile cache_stBgImage;
  static MaterialFile cache_stBgImageClick;
  static MaterialFile cache_stH5BgImage = new MaterialFile();
  static MaterialFile cache_stLeftImage;
  static MaterialFile cache_stRightImage;
  ...
  static
  {
    ...
    cache_stBgImage = new MaterialFile();
    cache_stBgImageClick = new MaterialFile();
    cache_stLeftImage = new MaterialFile();
    cache_stRightImage = new MaterialFile();
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\NS_MOBILE_MATERIAL\CustomAlbumItem.class
