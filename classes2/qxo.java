...
import com.tencent.mobileqq.camera.adapter.CameraAttrs;
  ...
  extends Handler
{
  ...
  public qxo(CameraManagerImpl paramCameraManagerImpl, Looper paramLooper)
  {
    super(paramLooper);
    boolean bool = NotVerifyClass.DO_VERIFY_CLASS;
    this.jdField_a_of_type_JavaLangString = "Q.camera.CameraManagerImpl.CameraHandler";
  }
  ...
  private void a(Object paramObject)
  {
    ...
    {
      QLog.e(this.jdField_a_of_type_JavaLangString, 2, "Could not set preview texture", (Throwable)paramObject);
    }
  }
  
  private void a(boolean paramBoolean)
  {
    CameraManagerImpl.a(this.jdField_a_of_type_ComTencentMobileqqCameraCameraManagerImpl).enableShutterSound(paramBoolean);
  }
  
  public void a(Camera.ShutterCallback paramShutterCallback, Camera.PictureCallback paramPictureCallback1, Camera.PictureCallback paramPictureCallback2, Camera.PictureCallback paramPictureCallback3)
  {
    if (CameraWrapper.a().a().g) {}
    for (int i = 300;; i = 0)
    {
      postDelayed(new qxp(this, paramShutterCallback, paramPictureCallback1, paramPictureCallback2, paramPictureCallback3), i);
      return;
    }
  }
  ...
  public boolean a()
  {
    ...
    //   3: ifeq +13 -> 16
    //   6: aload_0
    //   7: getfield 24	qxo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   10: iconst_2
    //   11: ldc 93
    //   13: invokestatic 97	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   16: new 99	java/lang/Object
    //   19: dup
    //   20: invokespecial 102	java/lang/Object:<init>	()V
    //   23: astore_1
    //   24: new 104	qxq
    //   27: dup
    //   28: aload_0
    //   29: aload_1
    //   30: invokespecial 107	qxq:<init>	(Lqxo;Ljava/lang/Object;)V
    //   33: astore_2
    //   34: aload_1
    //   35: monitorenter
    //   36: aload_0
    //   37: getfield 11	qxo:jdField_a_of_type_ComTencentMobileqqCameraCameraManagerImpl	Lcom/tencent/mobileqq/camera/CameraManagerImpl;
    //   40: invokestatic 110	com/tencent/mobileqq/camera/CameraManagerImpl:a	(Lcom/tencent/mobileqq/camera/CameraManagerImpl;)Lqxo;
    //   43: aload_2
    //   44: invokevirtual 114	qxo:post	(Ljava/lang/Runnable;)Z
    //   47: pop
    //   48: aload_1
    //   49: invokevirtual 117	java/lang/Object:wait	()V
    //   52: aload_1
    //   53: monitorexit
    //   54: iconst_1
    //   55: ireturn
    //   56: astore_2
    //   57: aload_0
    //   58: getfield 24	qxo:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   61: iconst_2
    //   62: ldc 119
    //   64: invokestatic 97	com/tencent/qphone/base/util/QLog:d	(Ljava/lang/String;ILjava/lang/String;)V
    //   67: aload_1
    //   68: monitorexit
    //   69: iconst_0
    //   70: ireturn
    ...
    //   0	76	0	this	qxo
    //   23	50	1	localObject1	Object
    //   33	11	2	localqxq	qxq
    //   56	1	2	localInterruptedException	InterruptedException
    //   71	4	2	localObject2	Object
    // Exception table:
    //   from	to	target	type
    //   48	52	56	java/lang/InterruptedException
    //   36	48	71	finally
    //   48	52	71	finally
    //   52	54	71	finally
    //   57	69	71	finally
      ...
      catch (RuntimeException localRuntimeException)
      {
        ...
        if ((paramMessage.what != 2) && (CameraManagerImpl.a(this.jdField_a_of_type_ComTencentMobileqqCameraCameraManagerImpl) != null))
        {
          ...
          try
          {
            ...
            if (paramMessage.obj != null)
            {
              ...
              if ((paramMessage.obj instanceof CameraManager.CameraOpenErrorCallback))
              {
                ...
                if (!CameraManagerImpl.a(this.jdField_a_of_type_ComTencentMobileqqCameraCameraManagerImpl)) {
                  continue;
                }
          ...
          catch (Exception localException)
          {
            ...
            continue;
            if (!(paramMessage.obj instanceof qxk)) {
              continue;
            }
            ((qxk)paramMessage.obj).onAutoFocus(false, CameraManagerImpl.a(this.jdField_a_of_type_ComTencentMobileqqCameraCameraManagerImpl));
            return;
          }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\qxo.class
