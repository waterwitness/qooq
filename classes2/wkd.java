...
{
  public wkd(WebSoService paramWebSoService, WebSoService.WebSoState paramWebSoState)
  {
  ...
  public void a(String paramString)
  {
    if (TextUtils.isEmpty(paramString)) {
      this.jdField_a_of_type_ComTencentMobileqqWebviewWebsoWebSoService$WebSoState.c = 10004;
    }
    this.jdField_a_of_type_ComTencentMobileqqWebviewWebsoWebSoService$WebSoState.b = paramString;
    this.jdField_a_of_type_ComTencentMobileqqWebviewWebsoWebSoService$WebSoState.a = false;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\wkd.class
