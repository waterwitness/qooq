...
{
  public vsa(TroopTopicMgr paramTroopTopicMgr, TroopTopicDetailInfo paramTroopTopicDetailInfo, MessageRecord paramMessageRecord)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (i == 0)
        {
          ...
          ThreadManager.a(new vsb(this, paramArrayOfByte), 8, null, false);
      ...
      catch (Exception paramArrayOfByte)
      {
        ...
        ThreadManager.a(new vsc(this, paramArrayOfByte), 8, null, false);
        continue;
      }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\vsa.class
