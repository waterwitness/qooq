  ...
  extends MessageMicro
{
  ...
  static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[] { 10, 18, 26, 32 }, new String[] { "msg_head", "msg_lbs_info", "str_number", "uint32_session_id" }, new Object[] { null, null, "", Integer.valueOf(0) }, ReqJoinDiscuss.class);
