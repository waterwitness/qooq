...
{
  public vbr(ShortVideoForwardProcessor paramShortVideoForwardProcessor, long paramLong, String paramString)
  {
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap paramHashMap)
  {
    ...
    ThreadManager.a(new vbt(this, l2, l3, l4, l5), 5, null, true);
    ...
    this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.b();
  }
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap paramHashMap)
  {
    ...
    try
    {
      ...
      if (paramArrayOfByte.str_fileid.has())
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.h = paramArrayOfByte;
          if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.c = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.jdField_a_of_type_Long;
      this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.d(false);
      ThreadManager.a(new vbs(this, l2, l3, l4, l5), 5, null, true);
  ...
  public void onSwitch2BackupChannel()
  {
    ...
    switch (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.bm)
    {
    default: 
      return;
    case 0: 
      this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.c("<BDH_LOG> onSwitch2BackupChannel() BUT current status is INIT");
      return;
    case 2: 
      this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.c("<BDH_LOG> onSwitch2BackupChannel() BUT current status is HTTP");
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.c("<BDH_LOG> onSwitch2BackupChannel() switch to HTTP channel");
    this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.bm = 2;
    ...
    StatisticCollector.a(BaseApplication.getContext()).a(null, "actSwitchChnl", true, l - this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.jdField_a_of_type_Long, null, "");
    this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.J_();
  }
  
  public void onTransStart()
  {
    this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.c("<BDH_LOG> onTransStart()");
  ...
  public void onUpdateProgress(int paramInt)
  {
    ...
    long l = paramInt;
    localFileMsg.f = l;
    localShortVideoForwardProcessor.c = l;
    if ((paramInt < this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.jdField_a_of_type_Long) && (!this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.o) && (!this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.k)) {
      this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoForwardProcessor.h();
    }
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\vbr.class
