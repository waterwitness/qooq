...
{
  public tfk(QQAppInterface paramQQAppInterface, String paramString, int paramInt, long paramLong1, long paramLong2)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          if ((localArrayList1 == null) || (localArrayList1.size() != 1) || ((((MessageRecord)localArrayList1.get(0)).msgtype != 64536) && (((MessageRecord)localArrayList1.get(0)).msgtype != 64485) && (((MessageRecord)localArrayList1.get(0)).msgtype != 64501))) {
            continue;
          }
          localObject1 = null;
          if (((MessageRecord)localArrayList1.get(0)).msgtype == 64501)
          {
            ...
            if (((((MessageRecord)localArrayList1.get(0)).istroop == 1) && (localMessageRecord.istroop == 1)) || ((((MessageRecord)localArrayList1.get(0)).istroop == 3000) && (localMessageRecord.istroop == 3000) && (localObject4 != null)))
            {
              ...
              if (((MessageInfo)localObject4).a.jdField_a_of_type_Long != -1L) {
                ((MessageInfo)localObject4).a.b = this.jdField_a_of_type_Long;
              }
            ...
            if ((((MessageRecord)localArrayList1.get(0)).msgtype != 64501) || (localObject1 == null)) {
              continue;
            }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\tfk.class
