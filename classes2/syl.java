...
{
  public syl(UiApiPlugin paramUiApiPlugin, JSONObject paramJSONObject, Activity paramActivity)
  {
  ...
  public void a(PopupMenuDialog.MenuItem paramMenuItem)
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        {
          QLog.e(UiApiPlugin.a, 2, "showPopupMenu Exception: " + localException1.getMessage());
          j = i;
          localObject1 = paramMenuItem;
        }
        switch (j)
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\syl.class
