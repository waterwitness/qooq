...
public class ETLayout
{
  ...
  ETLayout()
  {
    ...
    this.jdField_a_of_type_JavaUtilArrayList = new ArrayList(16);
  ...
  private void f()
  {
    ...
    td[] arrayOftd = new td[arrayOfCharacterStyle.length];
    if ((arrayOftd == null) || (arrayOftd.length == 0))
    {
      a(this.jdField_a_of_type_JavaLangCharSequence.toString(), 0, this.jdField_a_of_type_JavaLangCharSequence.length(), this.jdField_a_of_type_ComEtrumpMixlayoutETFont, false);
      return;
    }
    ...
    {
      arrayOftd[i] = new td();
      arrayOftd[i].jdField_a_of_type_Int = localSpanned.getSpanStart(arrayOfCharacterStyle[i]);
      arrayOftd[i].jdField_b_of_type_Int = localSpanned.getSpanEnd(arrayOfCharacterStyle[i]);
      arrayOftd[i].jdField_a_of_type_AndroidTextStyleCharacterStyle = arrayOfCharacterStyle[i];
      i += 1;
    }
    Arrays.sort(arrayOftd, new tc());
    i = 0;
    int j = 0;
    label163:
    int m;
    ...
    {
      m = arrayOftd[i].jdField_a_of_type_Int;
      k = arrayOftd[i].jdField_b_of_type_Int;
      if (m - j > 0) {
        a(a(this.jdField_a_of_type_JavaLangCharSequence, j, m).toString(), j, m, this.jdField_a_of_type_ComEtrumpMixlayoutETFont, false);
      }
      if (k - m > 0)
      {
        if (!(arrayOftd[i].jdField_a_of_type_AndroidTextStyleCharacterStyle instanceof ClickableSpan)) {
          break label383;
        }
    ...
    for (j = m + 1;; j = m)
    {
      ...
      for (;;)
      {
        ...
        break label163;
        break;
        if ((arrayOftd[i].jdField_a_of_type_AndroidTextStyleCharacterStyle instanceof QQText.EmotcationSpan)) {
          a((QQText.EmotcationSpan)arrayOftd[i].jdField_a_of_type_AndroidTextStyleCharacterStyle, m, k, false);
        }
      }
    }
  }
  ...
  public QQText.EmotcationSpan a(int paramInt1, int paramInt2)
  {
    int i = 0;
    Rect localRect = new Rect(0, 0, 0, 0);
    int j = this.jdField_a_of_type_ArrayOfComEtrumpMixlayoutETTextLine.length;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\etrump\mixlayout\ETLayout.class
