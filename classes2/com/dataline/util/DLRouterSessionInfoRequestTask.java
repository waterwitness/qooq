...
public class DLRouterSessionInfoRequestTask
{
  ...
  public void a(int paramInt, SubMsgType0x7.MsgBody paramMsgBody)
  {
    if (this.c != this.d)
    {
      ...
      localcu.jdField_a_of_type_Int = paramInt;
      localcu.b = paramMsgBody.uint32_sub_cmd.get();
      localcu.jdField_a_of_type_TencentImS2cMsgtype0x211Submsgtype0x7SubMsgType0x7$MsgBody = paramMsgBody;
      this.jdField_a_of_type_JavaUtilHashMap.put(Integer.valueOf(paramInt), localcu);
      paramMsgBody = paramMsgBody.toByteArray();
      ((SmartDeviceProxyMgr)((QQAppInterface)BaseApplicationImpl.a().a()).a(51)).a(this.c, paramInt, paramMsgBody);
    }
  }
  ...
  public void a(Bundle paramBundle)
  {
    ...
    {
      return;
      paramBundle = (cu)this.jdField_a_of_type_JavaUtilHashMap.get(Integer.valueOf(n));
  ...
  public void b()
  {
    ...
    cq localcq = new cq(this, this.g, this.jdField_a_of_type_Long);
    this.jdField_b_of_type_JavaUtilTimer.schedule(localcq, 15000L);
  }
  ...
  void d()
  {
    if ((!this.jdField_a_of_type_Boolean) && (this.jdField_a_of_type_JavaUtilTimer == null))
    {
      ...
      this.jdField_a_of_type_JavaUtilTimer.schedule(localcs, 3000L);
      if (QLog.isDevelopLevel()) {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\dataline\util\DLRouterSessionInfoRequestTask.class
