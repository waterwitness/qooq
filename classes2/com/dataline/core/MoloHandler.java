...
public class MoloHandler
{
  ...
  private PCPushProxy.OnDownloadListener jdField_a_of_type_ComTencentOpenPcpushPCPushProxy$OnDownloadListener;
  
  public MoloHandler(DataLineHandler paramDataLineHandler)
  {
    boolean bool = NotVerifyClass.DO_VERIFY_CLASS;
    this.jdField_a_of_type_ComTencentOpenPcpushPCPushProxy$OnDownloadListener = new co(this);
  ...
  {
    DataLineReportUtil.j(this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.b);
    ...
    for (;;)
    {
      try
      {
        ...
        if (localPkgEntry != null)
        {
          ...
          paramArrayOfByte.msg = this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.a().a().getString(2131362140);
          paramArrayOfByte.msgtype = 63201;
  ...
  public boolean a()
  {
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.a().a().a(0).a();
    Object localObject1 = this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.a().a().a(0).a(true);
  ...
  public boolean a(String paramString)
  {
    ...
    if (bool)
    {
      paramString = this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.b.a(0).a(paramString);
      if (paramString == null) {
        return bool;
      }
      ...
      while (paramString.hasNext())
      {
        ...
        this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.b.a().a(0).c(localDataLineMsgRecord.msgId);
  ...
  {
    DataLineReportUtil.h(this.jdField_a_of_type_ComTencentMobileqqAppDataLineHandler.b);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\dataline\core\MoloHandler.class
