...
{
  private static final long jdField_a_of_type_Long = Long.MAX_VALUE;
  ...
  private GoogleInfo jdField_a_of_type_ComRookeryTranslateGoogleGoogleInfo;
  private MicrosoftInfo jdField_a_of_type_ComRookeryTranslateMicrosoftMicrosoftInfo;
  ...
  private AITranslator()
  {
    ...
    this.jdField_a_of_type_ComRookeryTranslateGoogleGoogleInfo = new GoogleInfo();
    this.jdField_a_of_type_ComRookeryTranslateMicrosoftMicrosoftInfo = new MicrosoftInfo();
  }
  ...
  private long a(long paramLong, AITranslator.TranslatorType paramTranslatorType)
  {
    ...
    do
    {
      ...
      switch (gce.a[paramTranslatorType.ordinal()])
      {
      }
  ...
  private void a(long paramLong, Context paramContext, TextTranslationItemBuilder.Holder paramHolder, String paramString, List paramList1, List paramList2, Language paramLanguage, TranslateCallback paramTranslateCallback, int paramInt, AITranslator.TranslatorType paramTranslatorType, TranslateError paramTranslateError, Long paramLong1)
  {
    ...
    paramTranslateError = Long.valueOf(Long.MAX_VALUE);
    if (QLog.isColorLevel()) {
    ...
    if (paramTranslateError.longValue() == Long.MAX_VALUE) {
  ...
  private void a(long paramLong, Context paramContext, TextTranslationItemBuilder.Holder paramHolder, String paramString, List paramList1, List paramList2, Language paramLanguage, Long arg9, TranslateCallback paramTranslateCallback, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        switch (gce.a[localTranslatorType.ordinal()])
        {
        case 1: 
          return;
        }
      ...
      if (!this.jdField_a_of_type_JavaUtilList.contains(str))
      {
        ...
        GoogleTranslator.a().a(paramContext, paramList2, paramLanguage, this.jdField_a_of_type_ComRookeryTranslateGoogleGoogleInfo.a(), localLong, new gcb(this, str, paramLong, paramContext, paramHolder, paramString, paramLanguage, paramTranslateCallback, paramList1, paramList2, paramInt, localTranslatorType));
        continue;
        str = paramString + paramLanguage.toString() + "M";
        if (!this.jdField_a_of_type_JavaUtilList.contains(str))
        {
          this.jdField_a_of_type_JavaUtilList.add(str);
          MicrosoftTranslator.a().a(paramContext, paramList2, paramLanguage, localLong, this.jdField_a_of_type_ComRookeryTranslateMicrosoftMicrosoftInfo.a(), this.jdField_a_of_type_ComRookeryTranslateMicrosoftMicrosoftInfo.b(), new gcc(this, str, paramLong, paramContext, paramHolder, paramString, paramLanguage, paramTranslateCallback, paramList1, paramList2, paramInt, localTranslatorType));
        }
      }
    }
  }
  ...
  private void a(Context paramContext)
  {
    ...
    if ((localLong.longValue() == 0L) || (System.currentTimeMillis() - localLong.longValue() > 86400000L)) {
      if (Build.VERSION.SDK_INT >= 9)
      {
        ...
        gcf.a(paramContext, new gcd(this, paramContext));
      }
    }
    while (!QLog.isColorLevel()) {
      for (;;)
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\rookery\translate\AITranslator.class
