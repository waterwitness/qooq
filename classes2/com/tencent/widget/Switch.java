  ...
  extends CompoundButton
{
  ...
  {
    this(paramContext, paramAttributeSet, 2130772207);
  }
  ...
  public Switch(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.aq, paramInt, 2131558869);
    ...
    setOnClickListener(new xuy(this));
  }
  ...
  {
    paramContext = paramContext.obtainStyledAttributes(paramInt, R.styleable.at);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\widget\Switch.class
