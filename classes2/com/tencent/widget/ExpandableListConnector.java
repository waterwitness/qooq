  ...
  implements Filterable
{
  ...
  private final DataSetObserver jdField_a_of_type_AndroidDatabaseDataSetObserver;
  ...
  public ExpandableListConnector(ExpandableListAdapter paramExpandableListAdapter)
  {
    ...
    this.jdField_a_of_type_AndroidDatabaseDataSetObserver = new ExpandableListConnector.MyDataSetObserver(this);
  ...
  ExpandableListConnector.PositionMetadata a(xsz paramxsz)
  {
    int j = 0;
    ...
    if (i == 0)
    {
      localObject1 = ExpandableListConnector.PositionMetadata.a(paramxsz.c, paramxsz.f, paramxsz.c, paramxsz.d, null, 0);
      return (ExpandableListConnector.PositionMetadata)localObject1;
    }
    for (;;)
    {
      if (k <= i)
      {
        ...
        if (paramxsz.c > localGroupMetadata.d)
        {
          k = m + 1;
          j = m;
          continue;
        ...
        if (paramxsz.f == 2) {
          return ExpandableListConnector.PositionMetadata.a(localGroupMetadata.b, paramxsz.f, paramxsz.c, paramxsz.d, localGroupMetadata, m);
        }
        localObject1 = localObject2;
        if (paramxsz.f != 1) {
          break;
        }
        return ExpandableListConnector.PositionMetadata.a(localGroupMetadata.b + paramxsz.d + 1, paramxsz.f, paramxsz.c, paramxsz.d, localGroupMetadata, m);
      }
      localObject1 = localObject2;
      if (paramxsz.f != 2) {
        break;
      ...
      if (k > j)
      {
        ...
        return ExpandableListConnector.PositionMetadata.a(paramxsz.c - ((ExpandableListConnector.GroupMetadata)localObject1).d + i, paramxsz.f, paramxsz.c, paramxsz.d, null, k);
      }
      localObject1 = localObject2;
      if (i >= j) {
        break;
      ...
      return ExpandableListConnector.PositionMetadata.a(((ExpandableListConnector.GroupMetadata)localObject1).b - (((ExpandableListConnector.GroupMetadata)localObject1).d - paramxsz.c), paramxsz.f, paramxsz.c, paramxsz.d, null, i);
      i -= 1;
      int k = 0;
    }
  }
  ...
  {
    ExpandableListConnector.PositionMetadata localPositionMetadata = a(xsz.a(2, paramInt, -1, -1));
  ...
  {
    if (paramPositionMetadata.jdField_a_of_type_Xsz.c < 0) {
    ...
    ExpandableListConnector.GroupMetadata localGroupMetadata = ExpandableListConnector.GroupMetadata.a(-1, -1, paramPositionMetadata.jdField_a_of_type_Xsz.c, this.jdField_a_of_type_AndroidWidgetExpandableListAdapter.getGroupId(paramPositionMetadata.jdField_a_of_type_Xsz.c));
  ...
  public Object getItem(int paramInt)
  {
    ...
    for (Object localObject = this.jdField_a_of_type_AndroidWidgetExpandableListAdapter.getGroup(localPositionMetadata.jdField_a_of_type_Xsz.c);; localObject = this.jdField_a_of_type_AndroidWidgetExpandableListAdapter.getChild(localPositionMetadata.jdField_a_of_type_Xsz.c, localPositionMetadata.jdField_a_of_type_Xsz.d))
    {
      localPositionMetadata.a();
      return localObject;
      if (localPositionMetadata.jdField_a_of_type_Xsz.f != 1) {
        break;
      }
    }
  ...
  {
    ExpandableListConnector.PositionMetadata localPositionMetadata = a(paramInt);
    long l1 = this.jdField_a_of_type_AndroidWidgetExpandableListAdapter.getGroupId(localPositionMetadata.jdField_a_of_type_Xsz.c);
    if (localPositionMetadata.jdField_a_of_type_Xsz.f == 2) {}
    long l2;
    for (l1 = this.jdField_a_of_type_AndroidWidgetExpandableListAdapter.getCombinedGroupId(l1);; l1 = this.jdField_a_of_type_AndroidWidgetExpandableListAdapter.getCombinedChildId(l1, l2))
    {
      ...
      l2 = this.jdField_a_of_type_AndroidWidgetExpandableListAdapter.getChildId(localPositionMetadata.jdField_a_of_type_Xsz.c, localPositionMetadata.jdField_a_of_type_Xsz.d);
    }
    throw new RuntimeException("Flat list position is of unknown type");
  }
  ...
  {
    xsz localxsz = a(paramInt).jdField_a_of_type_Xsz;
    ...
    if ((VersionUtils.b()) && ((this.jdField_a_of_type_AndroidWidgetExpandableListAdapter instanceof HeterogeneousExpandableList)))
    {
      ...
      if (localxsz.f == 2) {
        paramInt = localHeterogeneousExpandableList.getGroupType(localxsz.c);
      }
    }
    for (;;)
    {
      localxsz.a();
      return paramInt;
      paramInt = localHeterogeneousExpandableList.getChildType(localxsz.c, localxsz.d);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (localPositionMetadata.jdField_a_of_type_Xsz.f == 2)
    {
      paramView = this.jdField_a_of_type_AndroidWidgetExpandableListAdapter.getGroupView(localPositionMetadata.jdField_a_of_type_Xsz.c, localPositionMetadata.a(), paramView, paramViewGroup);
      localPositionMetadata.a();
      return paramView;
    }
    if (localPositionMetadata.jdField_a_of_type_Xsz.f == 1)
    {
      ...
      for (;;)
      {
        paramView = this.jdField_a_of_type_AndroidWidgetExpandableListAdapter.getChildView(localPositionMetadata.jdField_a_of_type_Xsz.c, localPositionMetadata.jdField_a_of_type_Xsz.d, bool, paramView, paramViewGroup);
        break;
        bool = false;
      }
    }
  ...
  public boolean isEnabled(int paramInt)
  {
    ...
    xsz localxsz = a(paramInt).jdField_a_of_type_Xsz;
    if (localxsz.f == 1) {
      bool = this.jdField_a_of_type_AndroidWidgetExpandableListAdapter.isChildSelectable(localxsz.c, localxsz.d);
    }
    localxsz.a();
    return bool;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\widget\ExpandableListConnector.class
