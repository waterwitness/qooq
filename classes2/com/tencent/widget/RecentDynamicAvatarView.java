  ...
  protected static Bitmap a(long paramLong)
  {
    ...
    do
    {
      ...
      if (BaseApplicationImpl.a != null) {
        localBitmap2 = (Bitmap)BaseApplicationImpl.a.get(localObject);
      }
      localBitmap1 = localBitmap2;
      if (localBitmap2 == null)
      {
        localBitmap2 = BitmapManager.b(BaseApplicationImpl.a().getResources(), i);
        localBitmap1 = localBitmap2;
        if (localBitmap2 != null)
        {
          localBitmap1 = localBitmap2;
          if (BaseApplicationImpl.a != null)
          {
            BaseApplicationImpl.a.put(localObject, localBitmap2);
            localBitmap1 = localBitmap2;
          }
        }
      }
  ...
  protected void dispatchDraw(Canvas paramCanvas)
  {
    ...
    if (this.jdField_c_of_type_Boolean)
    {
      if ((this.jdField_a_of_type_Float == -1.0F) || (this.jdField_b_of_type_Float == -1.0F))
      {
        ...
        this.jdField_c_of_type_Float = (Math.max(i, j) / 2);
      }
      ...
      paramCanvas.drawCircle(this.jdField_a_of_type_Float, this.jdField_b_of_type_Float, this.jdField_c_of_type_Float, this.jdField_a_of_type_AndroidGraphicsPaint);
    }
    if (this.d)
    {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\widget\RecentDynamicAvatarView.class
