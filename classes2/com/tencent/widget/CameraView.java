    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        if (QLog.isColorLevel()) {
          QLog.e("CameraView", 2, "IOException caused by setPreviewDisplay()", localIOException);
        }
      }
    }
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\widget\CameraView.class
