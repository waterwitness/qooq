  ...
  implements Filterable, xsx
{
  ...
  public Cursor a(Cursor paramCursor)
  {
    ...
    if (localCursor != null)
    {
      if (this.jdField_a_of_type_Xvr != null) {
        localCursor.unregisterContentObserver(this.jdField_a_of_type_Xvr);
      }
    ...
    {
      if (this.jdField_a_of_type_Xvr != null) {
        paramCursor.registerContentObserver(this.jdField_a_of_type_Xvr);
      }
      if (this.jdField_a_of_type_AndroidDatabaseDataSetObserver != null) {
  ...
  void a(Context paramContext, Cursor paramCursor, int paramInt)
  {
    ...
    if ((paramInt & 0x1) == 1)
    {
      ...
      this.jdField_a_of_type_Xvr = new xvr(this);
    }
    for (this.jdField_a_of_type_AndroidDatabaseDataSetObserver = new xvs(this, null);; this.jdField_a_of_type_AndroidDatabaseDataSetObserver = null)
    {
      if (bool)
      {
        if (this.jdField_a_of_type_Xvr != null) {
      ...
      break label54;
      label152:
      this.jdField_a_of_type_Xvr = null;
    }
  }
  ...
  public Filter getFilter()
  {
    if (this.jdField_a_of_type_Xsw == null) {
      this.jdField_a_of_type_Xsw = new xsw(this);
    }
    return this.jdField_a_of_type_Xsw;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\widget\XCursorAdapter.class
