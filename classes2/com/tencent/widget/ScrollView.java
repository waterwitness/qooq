  ...
  extends FrameLayout
{
  ...
  private View a(boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      break label87;
      label115:
      if (((paramBoolean) && (i3 < ((View)localObject2).getTop())) || ((!paramBoolean) && (i5 > ((View)localObject2).getBottom()))) {}
      for (i3 = 1;; i3 = 0)
      {
        if (n == 0) {
          break label170;
  ...
  public OverScroller a()
  {
    return this.jdField_a_of_type_ComTencentWidgetOverScroller;
  }
  ...
  public boolean onInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    if ((n == 2) && (this.jdField_c_of_type_Boolean)) {
      return true;
    }
    switch (n & 0xFF)
    {
        ...
        if ((int)Math.abs(f1 - this.jdField_a_of_type_Float) > this.jdField_b_of_type_Int)
        {
          ...
          if (paramMotionEvent != null)
          {
            ...
            else
            {
              ...
              if ((this.jdField_c_of_type_Boolean) && (this.jdField_a_of_type_JavaLangObject == null))
              {
                this.jdField_a_of_type_JavaLangObject = a("ScrollView-scroll");
                continue;
                this.jdField_c_of_type_Boolean = false;
  ...
  public void setContentBackground(Drawable paramDrawable)
  {
    ...
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = getResources().getDrawable(2130838671);
  }
  ...
  public void setOverScrollMode(int paramInt)
  {
    ...
    try
    {
      ...
      this.jdField_f_of_type_Int = Integer.MAX_VALUE;
      for (;;)
      {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\widget\ScrollView.class
