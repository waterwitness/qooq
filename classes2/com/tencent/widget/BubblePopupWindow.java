...
public class BubblePopupWindow
{
  ...
  private ViewTreeObserver.OnScrollChangedListener jdField_a_of_type_AndroidViewViewTreeObserver$OnScrollChangedListener = new xsq(this);
  ...
  private xsr jdField_b_of_type_Xsr;
  private boolean jdField_b_of_type_Boolean;
  private int[] jdField_b_of_type_ArrayOfInt = new int[2];
  private xsr jdField_c_of_type_Xsr;
  ...
  private void a(WindowManager.LayoutParams paramLayoutParams)
  {
    ...
    xss localxss = new xss(this, this.jdField_a_of_type_AndroidContentContext);
    ...
    localxss.addView((View)localObject, -1, -1);
    ...
    localObject = this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838098);
    this.jdField_a_of_type_Xsr = new xsr(this, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838099));
    localObject = new LayerDrawable(new Drawable[] { localObject, this.jdField_a_of_type_Xsr });
    ...
    this.jdField_b_of_type_Xsr = new xsr(this, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838097));
    LayerDrawable localLayerDrawable = new LayerDrawable(new Drawable[] { this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838096), this.jdField_b_of_type_Xsr });
    this.jdField_b_of_type_AndroidWidgetImageView.setBackgroundDrawable(localLayerDrawable);
    localxss.addView(this.jdField_b_of_type_AndroidWidgetImageView, (ViewGroup.LayoutParams)localObject);
    this.jdField_a_of_type_AndroidWidgetImageView = new ImageView(this.jdField_a_of_type_AndroidContentContext);
    localObject = new FrameLayout.LayoutParams(-2, -2, 83);
    this.jdField_c_of_type_Xsr = new xsr(this, this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838095));
    localLayerDrawable = new LayerDrawable(new Drawable[] { this.jdField_a_of_type_AndroidContentContext.getResources().getDrawable(2130838094), this.jdField_c_of_type_Xsr });
    this.jdField_a_of_type_AndroidWidgetImageView.setBackgroundDrawable(localLayerDrawable);
    localxss.addView(this.jdField_a_of_type_AndroidWidgetImageView, (ViewGroup.LayoutParams)localObject);
    this.jdField_b_of_type_AndroidViewView = localxss;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\widget\BubblePopupWindow.class
