  ...
  implements PageIndicator
{
  ...
  public CirclePageIndicator(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    int i = ((Resources)localObject).getColor(2131427536);
    int j = ((Resources)localObject).getColor(2131427535);
    int k = ((Resources)localObject).getColor(2131427537);
    float f1 = ((Resources)localObject).getDimension(2131493225);
    float f2 = ((Resources)localObject).getDimension(2131493224);
    paramAttributeSet = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.h, paramInt, 0);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\widget\CirclePageIndicator.class
