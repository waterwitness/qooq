...
public class MovingView
  extends View
{
  private static final float jdField_a_of_type_Float = 54.7F;
  ...
  public MovingView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new xud(this, Looper.getMainLooper());
    f();
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\widget\MovingView.class
