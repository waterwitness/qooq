  ...
  extends View
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      return;
      int j = (int)FloatMath.ceil(Layout.getDesiredWidth(this.jdField_a_of_type_JavaLangCharSequence, this.jdField_a_of_type_AndroidTextTextPaint)) + (getPaddingLeft() + getPaddingRight());
      paramInt1 = j;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\widget\SimpleTextView.class
