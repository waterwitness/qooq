  ...
  extends View
{
  ...
  private Handler jdField_a_of_type_AndroidOsHandler = new xsv(this);
  ...
  public CountDownProgressBar(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_Int = paramContext.getResources().getColor(2131427669);
    this.jdField_b_of_type_Int = paramContext.getResources().getColor(2131427670);
    this.c = paramContext.getResources().getColor(2131427668);
    this.e = paramContext.getResources().getColor(2131427368);
    this.l = paramContext.getResources().getColor(2131427672);
    float f1 = paramContext.getResources().getDisplayMetrics().density;
    this.f = ((int)(21.0F * f1 + 0.5F));
    this.d = ((int)(2.0F * f1 + 0.5F));
    this.g = ((int)(20.0F * f1 + 0.5F));
    this.i = 0;
  ...
  public void b()
  {
    ...
    this.jdField_b_of_type_Float = 0.0F;
    this.jdField_b_of_type_Long = 1000L;
    if (this.jdField_a_of_type_ComTencentWidgetCountDownProgressBar$OnCountDownLinstener != null) {
      this.jdField_a_of_type_ComTencentWidgetCountDownProgressBar$OnCountDownLinstener.a();
    }
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\widget\CountDownProgressBar.class
