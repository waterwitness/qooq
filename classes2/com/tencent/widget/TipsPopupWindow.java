  ...
  implements TipsLinearLayout.TipsLayoutAnimListener
{
  ...
  {
    this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)((LayoutInflater)paramContext.getSystemService("layout_inflater")).inflate(2130903207, null));
    this.jdField_a_of_type_ComTencentWidgetTipsLinearLayout = ((TipsLinearLayout)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131297687));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131297689));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)this.jdField_a_of_type_AndroidWidgetFrameLayout.findViewById(2131297688));
    ...
    paramContext = paramContext.getResources().getDrawable(2130843446);
  ...
  private void d()
  {
    if (this.jdField_c_of_type_Boolean) {
      this.jdField_a_of_type_AndroidWidgetFrameLayout.postDelayed(this.jdField_a_of_type_Xvh, 1000L);
    }
  ...
  private void e()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.removeCallbacks(this.jdField_a_of_type_Xvh);
  }
  ...
  public void a(Activity paramActivity, boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean) {
      this.jdField_a_of_type_AndroidWidgetFrameLayout.postDelayed(new xvf(this), paramInt);
    }
  }
  ...
  public void b()
  {
    this.jdField_a_of_type_AndroidWidgetFrameLayout.post(new xvg(this));
  }
  ...
  public void dismiss()
  {
    ...
    this.jdField_a_of_type_AndroidWidgetFrameLayout.removeCallbacks(this.jdField_a_of_type_Xvh);
    this.jdField_a_of_type_AndroidWidgetFrameLayout.postDelayed(this.jdField_a_of_type_Xvh, 300L);
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\widget\TipsPopupWindow.class
