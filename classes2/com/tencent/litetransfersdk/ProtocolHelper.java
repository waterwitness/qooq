...
public class ProtocolHelper
{
  ...
  public void showFileIsEmptyDialog(String paramString)
  {
    ...
    {
      FMToastUtil.a("'" + paramString + "'" + BaseApplication.getContext().getResources().getString(2131362192));
      return;
    }
    new Handler(localLooper).post(new kfs(this, paramString));
  }
  ...
  public void showFileNotExistDialog(String paramString)
  {
    ...
    if (Thread.currentThread() == localLooper.getThread())
    {
      FMToastUtil.a("'" + paramString + "'" + BaseApplication.getContext().getResources().getString(2131362149));
      return;
    }
    new Handler(localLooper).post(new kfu(this, paramString));
  }
  ...
  public void showFileTooLargeDialog(String paramString)
  {
    ...
    if (Thread.currentThread() == localLooper.getThread())
    {
      FMToastUtil.a("'" + paramString + "'" + BaseApplication.getContext().getResources().getString(2131362194));
      return;
    }
    new Handler(localLooper).post(new kft(this, paramString));
  }
  ...
  public void showNoNetworkDialog()
  {
    ...
    new Handler(localLooper).post(new kfw(this));
  }
  ...
  public void showQQIsOfflineDialog()
  {
    ...
    if (Thread.currentThread() == localLooper.getThread())
    {
      FMToastUtil.a(2131362195);
      return;
    }
    new Handler(localLooper).post(new kfv(this));
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\litetransfersdk\ProtocolHelper.class
