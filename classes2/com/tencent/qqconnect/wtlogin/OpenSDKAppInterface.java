  ...
  extends AppInterface
{
  ...
  public Bitmap a(String paramString)
  {
    ...
    return BitmapManager.a(AppConstants.bj + "appicon/" + paramString);
  }
  ...
  public String a(String paramString)
  {
    ...
    return AppConstants.bG + paramString + ".png";
  }
  ...
  public void a(Context paramContext, String paramString)
  {
    if (((paramContext instanceof Activity)) && (!((Activity)paramContext).isFinishing()))
    {
      ...
      paramContext.setNegativeButton("确定", new xhj(this));
      paramContext.show();
    }
  }
  ...
  public void a(String paramString, Bitmap paramBitmap)
  {
    ...
    File localFile = new File(AppConstants.bj + "appicon/");
    if (!localFile.exists()) {
      localFile.mkdirs();
    }
  ...
  public String b(String paramString)
  {
    ...
    str = MD5.toMD5(str + paramString);
    paramString = MD5.toMD5(str + paramString);
    return AppConstants.cf + paramString + ".png";
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\qqconnect\wtlogin\OpenSDKAppInterface.class
