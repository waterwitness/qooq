...
public class AppClient
{
  ...
  public static final String n = "tmast";
  ...
  public static void a(Activity paramActivity, Bundle paramBundle)
  {
    ...
    for (paramActivity = (Activity)localObject5;; paramActivity = "2410")
    {
      ...
      ThreadManager.b().post(new wsl(paramBundle, (Bundle)localObject2, localMalformedURLException, (String)localObject1, paramActivity));
      return;
      localObject2 = null;
      localObject3 = null;
      localObject4 = "0";
  ...
  protected static void a(Activity paramActivity, String paramString1, String paramString2, Bundle paramBundle, String paramString3, String paramString4)
  {
    ...
    if (!paramString3.equals("online"))
    {
      ...
      if (((File)localObject).exists())
      {
        ...
        str3 = paramBundle.getString("splitvia");
        str4 = paramBundle.getString("subPageType");
        str2 = paramBundle.getString("appCustom");
    ...
    label1083:
    ThreadManager.b().post(new wsk(paramString1, localBundle, str1, paramActivity, localIntent, paramBundle));
    return;
    label1107:
    paramActivity.startActivityForResult(localIntent, 200);
  }
  ...
  public static void b(Activity paramActivity, Bundle paramBundle)
  {
    ...
    if (MyAppApi.a().b())
    {
      ...
      ThreadManager.b().post(new wsm(paramActivity, localBundle, bool));
      return;
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\appcommon\AppClient.class
