  ...
  implements IJsCallBack
{
  ...
  public DownloadInterface(Activity paramActivity, WebView paramWebView)
  {
    ...
    this.TAG = DownloadInterface.class.getSimpleName();
  ...
  private void innerQueryDownloadInfo(JSONArray paramJSONArray, String paramString)
  {
    try
    {
      ...
      DownloadApi.a(localArrayList, new wtg(this, paramString));
      return;
    }
  ...
  private void innerQueryDownloadInfoByVia(String paramString1, String paramString2)
  {
    try
    {
      DownloadApi.a(paramString1, new wth(this, paramString2));
      return;
    }
  ...
  public int doDownloadAction(String paramString)
  {
    ...
    try
    {
      ...
      localBundle.putInt(DownloadConstants.E, localJSONObject.optInt("showNotification"));
      localBundle.putString(DownloadConstants.F, localJSONObject.optString("extraData"));
  ...
  {
    this.mHandler.post(new wti(this, paramString));
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\appcommon\js\DownloadInterface.class
