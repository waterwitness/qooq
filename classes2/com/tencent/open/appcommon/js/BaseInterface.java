  ...
  extends JsBridge.JsHandler
{
  ...
  public void addResult(WebView paramWebView, long paramLong1, String paramString, long paramLong2, int paramInt)
  {
    ...
    if (this.firstIn)
    {
      ...
      wsx localwsx = new wsx(this, paramWebView, paramLong1);
      this.mTask = localwsx;
      localTimer.schedule(localwsx, paramLong2, paramLong2);
      this.firstIn = false;
    }
    try
    {
  ...
  public void batchCallback(WebView paramWebView, long paramLong)
  {
    ...
    {
      new Handler(Looper.getMainLooper()).post(new wsy(this, paramLong, localArrayList, paramWebView));
      return;
    }
  ...
  protected void batchCallbackError(WebView paramWebView, long paramLong, String paramString)
  {
    ...
    new Handler(Looper.getMainLooper()).post(new wsz(this, paramLong, paramString, paramWebView));
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\appcommon\js\BaseInterface.class
