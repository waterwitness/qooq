  ...
  public static String d()
  {
    if (TextUtils.isEmpty(d))
    {
      ...
      if (localObject != null)
      {
        ...
        if (TextUtils.isEmpty(d))
        {
          d = ((TelephonyManager)((Context)localObject).getSystemService("phone")).getSubscriberId();
          if (d != null)
          {
            localObject = ((Context)localObject).getSharedPreferences("appcenter_mobileinfo", 0).edit();
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\business\base\MobileInfoUtil.class
