...
public class AppUtil
{
  ...
  {
    // Byte code:
    //   0: new 225	java/lang/ProcessBuilder
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 228	java/lang/ProcessBuilder:<init>	([Ljava/lang/String;)V
    //   8: astore_0
    //   9: aload_0
    //   10: iconst_0
    //   11: invokevirtual 232	java/lang/ProcessBuilder:redirectErrorStream	(Z)Ljava/lang/ProcessBuilder;
    //   14: pop
    //   15: aload_0
    //   16: invokevirtual 235	java/lang/ProcessBuilder:start	()Ljava/lang/Process;
    //   19: astore_1
    //   20: new 270	java/io/DataOutputStream
    //   23: dup
    //   24: aload_1
    //   25: invokevirtual 276	java/lang/Process:getOutputStream	()Ljava/io/OutputStream;
    //   28: invokespecial 279	java/io/DataOutputStream:<init>	(Ljava/io/OutputStream;)V
    //   31: astore_2
    //   32: new 281	java/io/DataInputStream
    //   35: dup
    //   36: aload_1
    //   37: invokevirtual 285	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   40: invokespecial 288	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   43: astore_0
    //   44: aload_0
    //   45: ifnull +88 -> 133
    //   48: aload_2
    //   49: ifnull +84 -> 133
    //   52: aload_0
    //   53: invokevirtual 291	java/io/DataInputStream:readLine	()Ljava/lang/String;
    //   56: astore_0
    //   57: aload_2
    //   58: ldc_w 293
    //   61: invokevirtual 296	java/io/DataOutputStream:writeBytes	(Ljava/lang/String;)V
    //   64: aload_2
    //   65: invokevirtual 299	java/io/DataOutputStream:flush	()V
    //   68: aload_1
    //   69: invokevirtual 302	java/lang/Process:waitFor	()I
    //   72: pop
    //   73: aload_0
    //   74: astore_2
    //   75: aload_1
    //   76: ifnull +9 -> 85
    //   79: aload_1
    //   80: invokevirtual 305	java/lang/Process:destroy	()V
    //   83: aload_0
    //   84: astore_2
    //   85: aload_2
    //   86: areturn
    ...
    //   96: ifnull -11 -> 85
    //   99: aload_1
    //   100: invokevirtual 305	java/lang/Process:destroy	()V
    //   103: aload_0
    //   104: areturn
    //   105: astore_0
    //   106: aconst_null
    ...
    //   109: ifnull +7 -> 116
    //   112: aload_1
    //   113: invokevirtual 305	java/lang/Process:destroy	()V
    //   116: aload_0
    //   117: athrow
    //   118: astore_0
    //   119: goto -11 -> 108
  ...
  public static boolean a()
  {
    try
    {
      ...
      DataInputStream localDataInputStream = new DataInputStream(((Process)localObject).getInputStream());
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\business\base\AppUtil.class
