  ...
  implements HttpImageDownloadAsyncTask.TaskCompleteCallback
{
  ...
  protected static final String a = "AvatarUpdateService";
  public static final String b = "uin_avatarurl";
  ...
  protected AvatarUpdateService()
  {
    ...
    this.jdField_a_of_type_AndroidContentSharedPreferences = BaseApplicationImpl.a().getSharedPreferences("uin_avatarurl", 0);
  ...
  public void a(Context paramContext, String paramString1, String paramString2, String paramString3, HttpImageDownloadAsyncTask.TaskCompleteCallback paramTaskCompleteCallback)
  {
    ...
    str1 = "o" + str1;
    ThreadManager.a(new wud(this, str2, "uin=" + str1 + "; skey=" + paramString2, paramString1, paramString3, paramContext, paramTaskCompleteCallback), 5, null, true);
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\base\http\AvatarUpdateService.class
