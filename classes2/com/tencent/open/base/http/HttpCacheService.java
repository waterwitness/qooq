  ...
  public String b(String paramString)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilHashMap != null)
    {
      ...
      if (this.jdField_a_of_type_JavaUtilHashMap.size() != 0)
      {
        ...
        str1 = str2;
        if (this.jdField_a_of_type_JavaUtilHashMap.get(paramString) != null) {
          str1 = ((HttpCacheData)this.jdField_a_of_type_JavaUtilHashMap.get(paramString)).n;
        }
      }
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\base\http\HttpCacheService.class
