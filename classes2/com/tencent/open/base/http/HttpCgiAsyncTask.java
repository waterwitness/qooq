  ...
  extends HttpAsyncTask
{
  ...
  {
    if (!isCancelled()) {
      this.jdField_a_of_type_AndroidOsHandler.post(new wug(this, paramHashMap));
    }
  }
  ...
  public HashMap b(Bundle... paramVarArgs)
  {
    ...
    long l1 = 0L;
    String str2 = MsfSdkUtils.insertMtype("yingyongbao", this.k);
    ...
    catch (Exception localException)
    {
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          try
          {
            localStatistic = a(this.k, this.l, paramVarArgs[0]);
            l2 = l1;
            l4 = l1;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\base\http\HttpCgiAsyncTask.class
