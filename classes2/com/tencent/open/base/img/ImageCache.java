...
public class ImageCache
{
  ...
  static
  {
    ...
    try
    {
      File localFile = new File(Common.f() + c);
      if (localFile.exists()) {
        localFile.renameTo(new File(Common.f() + b));
      }
  ...
  {
    return Common.f() + b + paramString1 + File.separator + FileUtils.a(paramString2);
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\base\img\ImageCache.class
