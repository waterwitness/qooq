...
public class AppNotificationManager
{
  ...
  public Notification a(NoticeParam paramNoticeParam)
  {
    ...
    RemoteViews localRemoteViews = new RemoteViews(CommonDataAdapter.a().a().getPackageName(), 2130903505);
    Object localObject = IntentFactory.a(1, paramNoticeParam);
    a(localRemoteViews);
    localRemoteViews.setTextViewText(2131298851, StringAddition.a(paramNoticeParam.jdField_b_of_type_JavaLangString, 18, true, true));
    if (paramNoticeParam.jdField_b_of_type_Int == 1)
    {
      localNotification.icon = 2130840397;
      localRemoteViews.setImageViewResource(2131298849, 2130840393);
      localRemoteViews.setViewVisibility(2131298853, 8);
      localRemoteViews.setViewVisibility(2131298854, 0);
      if (Build.VERSION.SDK_INT > 10) {
        localRemoteViews.setOnClickPendingIntent(2131298848, (PendingIntent)localObject);
      }
    }
    for (;;)
    {
      ...
      if ((paramNoticeParam.jdField_b_of_type_Int == 0) || (paramNoticeParam.jdField_b_of_type_Int == 2) || (paramNoticeParam.jdField_b_of_type_Int == 3))
      {
        ...
        {
          localRemoteViews.setTextViewText(2131298853, CommonDataAdapter.a().a().getString(2131363055));
        ...
        {
          localRemoteViews.setTextViewText(2131298853, CommonDataAdapter.a().a().getString(2131363052));
          localObject = AppUtil.a(paramNoticeParam.d);
          if (localObject != null) {
            localRemoteViews.setImageViewBitmap(2131298849, (Bitmap)localObject);
          }
          localNotification.flags |= 0x10;
          localNotification.defaults |= 0x1;
          localNotification.defaults |= 0x4;
        ...
        if (paramNoticeParam.jdField_b_of_type_Int == 3)
        {
          ...
          localRemoteViews.setImageViewBitmap(2131298849, localBitmap);
        }
        for (;;)
        {
          if (paramNoticeParam.jdField_b_of_type_Int == 0)
      ...
      else if (paramNoticeParam.jdField_b_of_type_Int == 4)
      {
        localNotification.icon = 2130840397;
        localRemoteViews.setImageViewResource(2131298849, 2130840393);
        localRemoteViews.setTextViewText(2131298853, CommonDataAdapter.a().a().getString(2131363062));
        localRemoteViews.setViewVisibility(2131298853, 0);
        localRemoteViews.setViewVisibility(2131298854, 8);
      ...
      {
        localNotification.icon = 2130838950;
        localRemoteViews.setImageViewResource(2131298849, 2130838951);
        localRemoteViews.setTextViewText(2131298853, paramNoticeParam.c);
        localNotification.contentIntent = ((PendingIntent)localObject);
      }
    }
  }
  ...
  public void a(RemoteViews paramRemoteViews)
  {
    ...
    if (this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.b() != null) {
      paramRemoteViews.setTextColor(2131298851, this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.b().intValue());
    }
    ...
    if (this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a() != null) {
      paramRemoteViews.setTextColor(2131298853, this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a().intValue());
    }
    if (this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a() != null) {
      paramRemoteViews.setTextColor(2131298852, this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a().intValue());
    }
    ...
    if (this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a() > 0.0F) {
      paramRemoteViews.setFloat(2131298853, "setTextSize", this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a());
    }
    if (this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a() > 0.0F) {
      paramRemoteViews.setFloat(2131298852, "setTextSize", this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.a());
    }
    if (this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.b() > 0.0F) {
      paramRemoteViews.setFloat(2131298851, "setTextSize", this.jdField_a_of_type_ComTencentOpenDownloadnewCommonAppNotificationManager$NotificationStyleDiscover.b());
    }
    ...
    try
    {
      ...
      paramRemoteViews.setInt(2131298848, "setBackgroundColor", (i & 0xFF000000) + (-1 - i));
      return;
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\downloadnew\common\AppNotificationManager.class
