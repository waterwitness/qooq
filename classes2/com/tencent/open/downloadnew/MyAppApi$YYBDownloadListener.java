  ...
  implements DownloadListener
{
  ...
  public void a(DownloadInfo paramDownloadInfo)
  {
    if ((paramDownloadInfo != null) && (paramDownloadInfo.b.equals("1101070898")))
    {
      ...
      if ((this.a.jdField_a_of_type_ComTencentOpenDownloadnewMyAppDialog != null) && (this.a.jdField_a_of_type_ComTencentOpenDownloadnewMyAppDialog.isShowing()) && (this.a.c)) {
        this.a.jdField_a_of_type_ComTencentOpenDownloadnewMyAppDialog.a(paramDownloadInfo.l, paramDownloadInfo.a());
      }
    }
  }
  ...
  public void a(DownloadInfo paramDownloadInfo, int paramInt1, String paramString, int paramInt2)
  {
    if ((paramDownloadInfo != null) && (paramDownloadInfo.b.equals("1101070898")))
    {
      ...
      if ((paramDownloadInfo.l != 100) && (paramDownloadInfo.k != 4)) {
        break label46;
      }
      c(paramDownloadInfo);
    }
    ...
    if (paramList != null)
    {
      ...
      while (paramList.hasNext())
      {
        ...
        if (localDownloadInfo.b.equals("1101070898"))
        {
          ...
          if ((this.a.jdField_a_of_type_ComTencentOpenDownloadnewMyAppDialog != null) && (this.a.jdField_a_of_type_ComTencentOpenDownloadnewMyAppDialog.isShowing()) && (this.a.c)) {
            this.a.jdField_a_of_type_ComTencentOpenDownloadnewMyAppDialog.a(localDownloadInfo.l, localDownloadInfo.a());
          }
        }
      }
    }
  ...
  public void c(DownloadInfo paramDownloadInfo)
  {
    ...
    if ((paramDownloadInfo != null) && (paramDownloadInfo.b.equals("1101070898")))
    {
      ...
      if (this.a.jdField_a_of_type_ComTencentOpenDownloadnewMyAppApi$InstallParams != null)
      {
        ...
        ThreadManager.b().postDelayed(new wxh(this, paramDownloadInfo), 500L);
    ...
    for (;;)
    {
      ...
      ThreadManager.b().postDelayed(new wxj(this, paramDownloadInfo), 500L);
      this.a.jdField_a_of_type_Boolean = true;
      this.a.jdField_b_of_type_Boolean = false;
      break;
      this.a.e = true;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\downloadnew\MyAppApi$YYBDownloadListener.class
