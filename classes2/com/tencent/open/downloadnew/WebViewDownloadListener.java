  ...
  implements DownloadListener
{
  ...
  {
    if (paramDownloadInfo != null) {
      a(a(paramDownloadInfo.b, paramInt2, paramDownloadInfo.l, paramDownloadInfo.d, paramDownloadInfo.h, paramString, paramInt1, paramDownloadInfo.p));
    }
  }
        ...
        if (i < j)
        {
          ...
          if (localWebView != null) {
            if (TextUtils.isEmpty(((IJsCallBack)localObject).getJsCallbackMethod()))
            {
              ...
              this.jdField_a_of_type_AndroidOsHandler.post(new wxo(this, localWebView, (String)localObject));
            }
            else
            {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\downloadnew\WebViewDownloadListener.class
