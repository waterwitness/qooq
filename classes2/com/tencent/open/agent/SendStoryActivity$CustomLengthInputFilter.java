  ...
  extends LengthInputFilter
{
  ...
  public CharSequence filter(CharSequence paramCharSequence, int paramInt1, int paramInt2, Spanned paramSpanned, int paramInt3, int paramInt4)
  {
    ...
    Arrays.sort(arrayOfFriend, new wrs(this, paramSpanned));
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\agent\SendStoryActivity$CustomLengthInputFilter.class
