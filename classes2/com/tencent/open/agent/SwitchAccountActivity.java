  ...
  implements View.OnClickListener
{
  ...
  public SwitchAccountActivity()
  {
    ...
    this.jdField_a_of_type_MqqObserverSSOAccountObserver = new wrv(this);
    this.jdField_a_of_type_AndroidViewView$OnTouchListener = new wrw(this);
  }
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      {
        View localView = localLayoutInflater.inflate(2130903044, this.jdField_a_of_type_AndroidWidgetLinearLayout, false);
        TextView localTextView1 = (TextView)localView.findViewById(2131296818);
        TextView localTextView2 = (TextView)localView.findViewById(2131296819);
        ImageView localImageView = (ImageView)localView.findViewById(2131296814);
        ...
        ((Button)localView.findViewById(2131296817)).setOnClickListener(this);
      ...
      else
      {
        ...
        localObject1 = localLayoutInflater.inflate(2130903049, this.jdField_a_of_type_AndroidWidgetLinearLayout, false);
    ...
    for (;;)
    {
      if (i < this.jdField_a_of_type_AndroidWidgetLinearLayout.getChildCount())
      {
        ...
        if (i == 0)
        {
          ...
          paramString.setBackgroundResource(2130838349);
        }
      }
      return;
      label421:
      paramString.setBackgroundResource(2130838357);
      return;
      label428:
      i += 1;
    }
  ...
  public void a(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    if (QLog.isColorLevel())
    {
      localObject1 = new StringBuilder().append("-->loginSucess--mReqSrc = ").append(this.jdField_b_of_type_Int).append(", userAccount = *").append(AuthorityUtil.a(paramString1)).append(", bundle = null ? ");
      if (paramBundle == null)
      {
        bool = true;
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2130905030);
    ...
    super.setTitle(2131369821);
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog = new QQProgressDialog(this, getTitleBarHeight());
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)super.findViewById(2131305086));
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\agent\SwitchAccountActivity.class
