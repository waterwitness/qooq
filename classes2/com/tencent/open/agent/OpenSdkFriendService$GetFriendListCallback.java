    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ("action_invite".equals(this.jdField_a_of_type_ComTencentOpenAgentOpenSdkFriendService.i))
        {
          ...
          if (!OpensdkPreference.a(CommonDataAdapter.a().a(), "invite_friend_list_md5").getString(this.jdField_a_of_type_ComTencentOpenAgentOpenSdkFriendService.g, "").equals(localObject))
          {
            ...
            ThreadManager.b(new wrk(this, paramJSONObject, (String)localObject));
          ...
          new HttpCgiAsyncTask(this.jdField_a_of_type_ComTencentOpenAgentOpenSdkFriendService.h, "GET", new GetFriendListCallback(this.jdField_a_of_type_ComTencentOpenAgentOpenSdkFriendService, paramJSONObject)).a(this.jdField_a_of_type_ComTencentOpenAgentOpenSdkFriendService.a);
          return;
        }
      }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\agent\OpenSdkFriendService$GetFriendListCallback.class
