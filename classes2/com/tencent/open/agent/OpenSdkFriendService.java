...
public class OpenSdkFriendService
{
  ...
  {
    new Handler(Looper.getMainLooper()).post(new wri(this, paramHandler));
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\agent\OpenSdkFriendService.class
