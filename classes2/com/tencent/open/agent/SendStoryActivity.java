  ...
  implements TextWatcher, View.OnClickListener, HttpCgiAsyncTask.Callback, HttpImageDownloadAsyncTask.TaskCompleteCallback
{
  ...
  protected void a()
  {
    this.jdField_b_of_type_AndroidWidgetLinearLayout = ((LinearLayout)super.findViewById(2131298934));
    ...
    this.jdField_c_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131297139));
    this.jdField_d_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131297083));
    this.jdField_e_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131297391));
    this.jdField_f_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131297183));
    this.jdField_d_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_e_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_f_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_a_of_type_ComTencentOpenWidgetCursorEditText = ((CursorEditText)super.findViewById(2131298939));
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)super.findViewById(2131298937));
    this.jdField_a_of_type_AndroidWidgetLinearLayout = ((LinearLayout)super.findViewById(2131298940));
    this.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)super.findViewById(2131298935));
    this.jdField_a_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131298941));
    this.jdField_b_of_type_AndroidWidgetTextView = ((TextView)super.findViewById(2131298942));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)super.findViewById(2131298943));
  ...
  public void a(JSONObject paramJSONObject)
  {
    try
    {
      ...
      if (j == 0) {
        Toast.makeText(getApplicationContext(), 2131363146, 0).show();
      }
      Intent localIntent = new Intent();
  ...
  public void onClick(View paramView)
  {
    ...
    Arrays.sort((Object[])localObject3, new wrr(this, (Editable)localObject2));
    ...
    if (k < n)
    {
      ...
      if (((Friend)localObject4).jdField_b_of_type_JavaLangString == null) {}
      for (paramView = ((Friend)localObject4).jdField_c_of_type_JavaLangString;; paramView = ((Friend)localObject4).jdField_b_of_type_JavaLangString)
      {
        paramView = StringAddition.b(paramView);
        ((StringBuilder)localObject1).append(String.format("@{openid:%s,nick:%s}", new Object[] { ((Friend)localObject4).a, paramView }));
        localHashSet.add(((Friend)localObject4).a);
        k += 1;
        j = m;
        break;
      }
    ...
    {
      Toast.makeText(getApplicationContext(), super.getString(2131363147, new Object[] { Integer.valueOf(10) }), 0).show();
      return;
    }
    ...
    this.jdField_a_of_type_AndroidAppProgressDialog = ProgressDialog.show(this, "", super.getString(2131363143), true);
  ...
  protected void onStart()
  {
    ...
    this.jdField_e_of_type_AndroidWidgetTextView.setText(2131367262);
    this.jdField_f_of_type_AndroidWidgetTextView.setVisibility(0);
    this.jdField_f_of_type_AndroidWidgetTextView.setText(2131363140);
    this.jdField_c_of_type_AndroidWidgetTextView.setText(2131363138);
    this.jdField_e_of_type_AndroidWidgetTextView.setOnClickListener(this);
    this.jdField_f_of_type_AndroidWidgetTextView.setOnClickListener(this);
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\agent\SendStoryActivity.class
