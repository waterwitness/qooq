  ...
  extends AbstractDbCacheManager
{
  ...
  protected List a()
  {
    ...
    for (;;)
    {
      ...
      localObject2 = (DbCacheManager.OnChangeListener)((WeakReference)localObject1).get();
    }
    for (;;)
    {
  ...
  void a(wup paramwup)
  {
    this.jdField_a_of_type_Wup = paramwup;
  }
  ...
  protected void f()
  {
    wup localwup = this.jdField_a_of_type_Wup;
    if (localwup != null) {
      localwup.a(this);
    }
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\component\cache\database\DbCacheManager.class
