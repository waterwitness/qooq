  ...
  implements Handler.Callback
{
  ...
  protected void a(AppRuntime paramAppRuntime)
  {
    ...
    do
    {
      ...
      this.jdField_b_of_type_JavaLangString = ((TicketManager)paramAppRuntime.getManager(2)).getSkey(paramAppRuntime.getAccount());
  ...
  protected void b()
  {
    ...
    this.jdField_b_of_type_AndroidWidgetTextView = this.rightViewText;
    RelativeLayout localRelativeLayout = (RelativeLayout)findViewById(2131297082);
    View localView1 = getLayoutInflater().inflate(2130903506, null);
    View localView2 = getLayoutInflater().inflate(2130903507, null);
    ...
    this.c = ((TextView)localView1.findViewById(2131298858));
    this.jdField_a_of_type_AndroidWidgetProgressBar = ((ProgressBar)localView1.findViewById(2131298860));
    c();
  }
  ...
  protected void c()
  {
    ...
    localObject = findViewById(2131298845);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\open\adapter\AppBaseActivity.class
