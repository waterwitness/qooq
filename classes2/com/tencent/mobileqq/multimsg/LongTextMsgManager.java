...
public class LongTextMsgManager
  implements Manager
{
  public static final String a = "StructLongTextMsg";
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString1, int paramInt, long paramLong, String paramString2)
  {
    ...
    MultiMsgManager.a().a(paramQQAppInterface, paramString2, paramQQAppInterface.a(), paramString1, paramString1, paramInt, paramLong, 1035, new tfk(paramQQAppInterface, paramString1, paramInt, paramLong, l));
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    localHashMap.put("param_uin", paramQQAppInterface.a());
    ...
    default: 
      return;
    case 1: 
      StatisticCollector.a(BaseApplication.getContext()).a(paramQQAppInterface.a(), "ltextAutoPullResult", bool, 0L, 0L, localHashMap, "");
      return;
    }
    StatisticCollector.a(BaseApplication.getContext()).a(paramQQAppInterface.a(), "ltextManualPullResult", bool, 0L, 0L, localHashMap, "");
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      if ((!paramBoolean) || (TextUtils.isEmpty(paramMessageRecord.extStr)))
      {
        ...
        paramQQAppInterface.a().b(paramMessageRecord, paramQQAppInterface.a());
        if (QLog.isColorLevel()) {
      ...
      paramBoolean = a(paramQQAppInterface, (byte[])localObject, paramQQAppInterface.a(), paramMessageRecord.frienduin, paramMessageRecord.frienduin, paramMessageRecord.istroop, paramMessageRecord.uniseq, 1035, new tfj(this, paramQQAppInterface, paramMessageRecord, paramBoolean));
      if (!paramBoolean) {
        break;
      }
  ...
  public void a(String paramString, int paramInt1, long paramLong1, int paramInt2, long paramLong2)
  {
    try
    {
      ...
      if (localMessageRecord != null)
      {
        ...
        if (localMessageRecord.msgtype == 64485) {
          StatisticCollector.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), "ltextNewSendResult", true, 0L, 0L, localHashMap, "");
        }
        while (QLog.isColorLevel())
        {
          ...
          StatisticCollector.a(BaseApplication.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), "ltextOldSendResult", true, 0L, 0L, localHashMap, "");
        }
      }
      return;
    }
  ...
  public void b(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    if (paramMessageRecord.msgtype == 64485) {
      StatisticCollector.a(BaseApplication.getContext()).a(paramQQAppInterface.a(), "ltextNewReceiveResult", true, 0L, 0L, localHashMap, "");
    }
    ...
    StatisticCollector.a(BaseApplication.getContext()).a(paramQQAppInterface.a(), "ltextOldReceiveResult", true, 0L, 0L, localHashMap, "");
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\multimsg\LongTextMsgManager.class
