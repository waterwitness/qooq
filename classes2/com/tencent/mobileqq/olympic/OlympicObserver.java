...
public class OlympicObserver
  implements BusinessObserver
{
  public static final String a = OlympicObserver.class.getSimpleName();
  ...
  public void a(int paramInt, boolean paramBoolean, Object paramObject)
  {
    if (QLog.isColorLevel()) {
      QLog.d(a, 2, new Object[] { "onUpdata, type=", Integer.valueOf(paramInt), ", isSuccess=", Boolean.valueOf(paramBoolean) });
    }
    switch (paramInt)
    {
    default: 
        ...
        do
        {
          do
          {
            do
            {
              do
              {
                do
                {
                  do
                  {
                    ...
                    QLog.d(a, 2, "NOTIFY_GET_BUSINESS_TORCH, data is null or not Object[]");
                    return;
                  ...
                  QLog.d(a, 2, "NOTIFY_GET_BUSINESS_TORCH, objs.length < 4, is " + paramObject.length);
                  return;
                ...
                QLog.d(a, 2, "NOTIFY_DELIVER_TORCH, data is null or not Object[]");
                return;
                paramObject = (Object[])paramObject;
              ...
              QLog.d(a, 2, "NOTIFY_DELIVER_TORCH, objs.length < 6, is " + paramObject.length);
              return;
            ...
            QLog.d(a, 2, "NOTIFY_EXIT_DELIVER_TORCH, data is null or not Object[]");
            return;
            paramObject = (Object[])paramObject;
          ...
          QLog.d(a, 2, "NOTIFY_EXIT_DELIVER_TORCH, objs.length < 2, is " + paramObject.length);
          return;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\olympic\OlympicObserver.class
