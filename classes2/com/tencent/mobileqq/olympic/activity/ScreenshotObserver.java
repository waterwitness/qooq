...
{
  static final String jdField_a_of_type_JavaLangString = "date_added DESC";
  ...
  public void onChange(boolean paramBoolean, Uri paramUri)
  {
    ...
    do
    {
      ...
      {
        return;
      } while (!paramUri.toString().matches(b + "/\\d+"));
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\olympic\activity\ScreenshotObserver.class
