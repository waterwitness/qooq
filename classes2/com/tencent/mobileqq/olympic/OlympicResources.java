...
{
  public static final int a = -6103066;
  static INetEngine.IBreakDownFix jdField_a_of_type_ComTencentMobileqqTransfileINetEngine$IBreakDownFix = new trm();
  public static final String a = "OlympicRes/";
  public static final int b = 0;
  private static final String b = "OlympicResources";
  ...
  {
    if (SystemUtil.a()) {
      return AppConstants.bj + "OlympicRes/";
    }
    return BaseApplicationImpl.a().getFilesDir() + File.separator + "OlympicRes/";
  }
  ...
  private void a(String paramString1, String paramString2, Object paramObject, int paramInt1, boolean paramBoolean, int paramInt2, String paramString3)
  {
    ...
    localHttpNetReq.c = 0;
    localHttpNetReq.b = paramString3;
    localHttpNetReq.m = 1;
  ...
  public void a(NetResp paramNetResp)
  {
    ...
    if (paramNetResp.e == 0)
    {
      ...
      localObject2 = new File(localHttpNetReq.b);
    ...
    for (;;)
    {
      ...
      if ((j == 1) || (j == 2))
      {
        if (j == 1)
        {
          ...
          StatisticCollector.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), (String)localObject2, true, 0L, l, localHashMap, "", false);
      ...
      else
      {
        ...
        label491:
        if (QLog.isColorLevel()) {
          QLog.i("OlympicResources", 2, "onResp.url=" + localHttpNetReq.jdField_a_of_type_JavaLangString + ", result=" + paramNetResp.e + ", errCode=" + i + ",md5 = " + (String)localObject1);
        }
        j = 0;
        for (;;)
        {
          if (j < this.jdField_a_of_type_JavaUtilList.size())
          {
            ...
            if (QLog.isColorLevel()) {
              QLog.i("OlympicResources", 2, "onResp.retry.url=" + localHttpNetReq.jdField_a_of_type_JavaLangString + ",md5=" + (String)localObject4 + ", result=" + paramNetResp.e + ", errCode=" + i + ",retryCount=" + k);
            }
            a(localHttpNetReq.jdField_a_of_type_JavaLangString, (String)localObject4, localObject5, k + 1, bool2, j, localHttpNetReq.b);
          }
        }
      }
      label804:
      ...
      while (bool1)
      {
        ...
        try
        {
          ...
          StatisticCollector.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), (String)localObject2, false, 0L, 0L, localHashMap, "", false);
        }
        ...
        ((File)localObject2).delete();
        StatisticCollector.a(BaseApplicationImpl.getContext()).a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), "olympic_down_null", bool1, 0L, 0L, null, "", false);
        localObject3 = null;
        localObject2 = null;
        localObject1 = null;
        break label491;
      }
      QLog.i("OlympicResources", 1, "onResp.url=" + localHttpNetReq.jdField_a_of_type_JavaLangString + ", result=" + paramNetResp.e + ", errCode=" + i + ",md5 = " + (String)localObject1 + ", errDesc=" + str1);
      return;
      label1011:
      localObject1 = null;
      l = 0L;
  ...
  public boolean a(String paramString1, String paramString2, Object paramObject, boolean paramBoolean, int paramInt)
  {
    return a(paramString1, paramString2, paramObject, paramBoolean, paramInt, false);
  }
  ...
  public boolean a(String paramString1, String paramString2, Object paramObject, boolean paramBoolean1, int paramInt, boolean paramBoolean2)
  {
    ...
    for (String str1 = ".mp4";; str2 = "")
    {
      ...
      if (paramBoolean2)
      {
        ...
        if (localObject != null)
        {
          if (!((OlympicManager)localObject).d(paramString1))
          {
      ...
      ((HttpNetReq)localObject).b = (a() + paramString2 + localException);
      ((HttpNetReq)localObject).m = 1;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\olympic\OlympicResources.class
