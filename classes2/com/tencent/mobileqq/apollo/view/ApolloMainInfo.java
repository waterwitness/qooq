...
public class ApolloMainInfo
  extends ApolloInfo
{
  public static final String c = "ApolloMainInfo";
  private Drawable a;
  private Drawable b;
  ...
  public Drawable a(Context paramContext, float paramFloat)
  {
    ...
    do
    {
      do
      {
        ...
        ((ApolloImageDownloader.ApolloDrawableExtraInfo)localObject).jdField_a_of_type_JavaLangString = (ApolloConstant.l + this.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.actionId + File.separator + "txtImg.png");
  ...
  public void a(QQAppInterface paramQQAppInterface, Context paramContext, EditText paramEditText, SessionInfo paramSessionInfo)
  {
    ...
    do
    {
      ...
      if (TextUtils.isEmpty(this.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.inputText))
      {
        ...
        else
        {
          ...
          paramEditText = "" + this.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.actionId;
      ...
      {
        VipUtils.a(paramQQAppInterface, "cmshow", "Apollo", "action_sent", i, 0, new String[] { paramEditText, str, paramContext, paramSessionInfo.jdField_a_of_type_JavaLangString });
        return;
        paramContext = paramEditText;
        if (this.d != 1) {
          break;
    ...
    int j = ApolloUtil.a(paramSessionInfo.jdField_a_of_type_Int);
    paramEditText = "" + this.jdField_a_of_type_ComTencentMobileqqDataApolloActionData.actionId;
    paramSessionInfo = "655_" + this.jdField_a_of_type_Int;
    if (TextUtils.isEmpty(this.jdField_b_of_type_JavaLangString)) {}
    for (paramContext = "0";; paramContext = this.jdField_b_of_type_JavaLangString)
    {
      VipUtils.a(paramQQAppInterface, "cmshow", "Apollo", "g_action_single_sent", i, j, new String[] { paramEditText, paramSessionInfo, paramContext });
      return;
    }
  }
  ...
  public Drawable b(Context paramContext, float paramFloat)
  {
    ...
    do
    {
      ...
      try
      {
        paramContext = new URL("apollo_pic", null, b(this.jdField_a_of_type_ComTencentMobileqqDataApolloActionData));
        if (paramContext == null) {
          return this.jdField_a_of_type_AndroidGraphicsDrawableDrawable;
        }
      }
      catch (MalformedURLException localMalformedURLException)
      {
        ...
        localURLDrawable = URLDrawable.getDrawable(paramContext, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable, this.jdField_b_of_type_AndroidGraphicsDrawableDrawable, true);
        paramContext = localURLDrawable;
      }
    } while (localURLDrawable.getStatus() == 1);
    localURLDrawable.setTag(this.jdField_a_of_type_ComTencentMobileqqDataApolloActionData);
    localURLDrawable.addHeader("apollo_uin", this.jdField_a_of_type_JavaLangString);
    localURLDrawable.addHeader("apollo_tasks", str);
  ...
  public String b(ApolloActionData paramApolloActionData)
  {
    ...
    return paramApolloActionData.actionId + "_" + paramApolloActionData.actionName + "_gif";
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\apollo\view\ApolloMainInfo.class
