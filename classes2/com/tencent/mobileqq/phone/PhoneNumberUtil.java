...
public class PhoneNumberUtil
{
          ...
          if (paramString.startsWith("+"))
          {
            ...
            while (localIterator.hasNext())
            {
              ...
              if (paramString.startsWith(str))
              {
                ...
                paramString.insert(str.length(), " ");
                return paramString.toString();
              }
            }
          }
        } while (!paramString.startsWith("00"));
        localIterator = a.iterator();
      }
  ...
  public static String b(String paramString)
  {
    ...
    paramString = Pattern.compile("[^+0-9]").matcher(paramString).replaceAll("");
    String str;
    if (paramString.startsWith("+"))
    {
    ...
    for (;;)
    {
      ...
      localStringBuilder.append(" ");
      localStringBuilder.append(paramString.substring(str.length()));
  ...
  private static String c(String paramString)
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (paramString.startsWith(localInteger.toString())) {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\phone\PhoneNumberUtil.class
