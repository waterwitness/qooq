  ...
  extends MSFServlet
{
  ...
  private static final String b = QZoneAlbumListNumServlet.class.getSimpleName();
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    if ((paramFromServiceMsg != null) && (paramFromServiceMsg.getResultCode() == 1000))
    {
      ...
      if (QLog.isColorLevel()) {
        QLog.d(b, 2, "inform QZoneAlbumListNumServlet isSuccess false");
      }
      notifyObserver(null, 1002, false, new Bundle(), QZoneObserver.class);
      return;
    }
    if (QLog.isColorLevel()) {
      QLog.d(b, 2, "inform QZoneAlbumListNumServlet resultcode fail.");
    }
    notifyObserver(null, 1002, false, new Bundle(), QZoneObserver.class);
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\servlet\QZoneAlbumListNumServlet.class
