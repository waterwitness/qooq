  ...
  implements Manager
{
  ...
  public void a()
  {
    ...
    {
      return;
      if ((jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(localObject1) == null) || (!((Boolean)jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(localObject1)).booleanValue()))
      {
  ...
  public void c()
  {
    SharedPreferences localSharedPreferences = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getSharedPreferences("check_update_sp_key", 0);
    int m = localSharedPreferences.getInt("businessinfo_check_update_interval_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), 600);
    int n = localSharedPreferences.getInt("businessinfo_last_check_update_timestamp_" + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), 0);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\servlet\GameCenterManagerImp.class
