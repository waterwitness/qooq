  ...
  implements Manager
{
  ...
  public void a()
  {
    ...
    while (!NetworkUtil.h(BaseApplication.getContext())) {
      return;
    }
    ThreadManager.b().post(new uew(this));
  }
  ...
  public void b()
  {
    ...
    if (QLog.isColorLevel())
    {
      ...
      QLog.d("QzoneContactsFeedManager", 2, new Object[] { "allFriends.size:", Integer.valueOf(m), ",getAllFreindsCount:", Integer.valueOf(localFriendsManager.c()) });
    }
    a(this.jdField_a_of_type_JavaUtilArrayList, this.j);
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\qzonestatus\QzoneContactsFeedManager.class
