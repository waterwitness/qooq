  ...
  extends VasWebviewJsPlugin
{
  ...
  private boolean handleSetRoam(int paramInt, String paramString)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.d(TAG, 2, "handleSetRoam messageRoamType: " + paramInt);
    }
    String str = "success";
    Object localObject;
  ...
  {
    if (QLog.isColorLevel()) {
      QLog.d(TAG, 2, "setAuthMode mode: " + paramInt);
    }
    JSONObject localJSONObject = new JSONObject();
    localJSONObject.put("result", -1);
    if ((paramInt == 1) || (paramInt == 0))
    {
      ...
      {
        localSharedPreferences.edit().putInt("auth_mode_" + this.browserAppInterface.a(), paramInt).commit();
        localJSONObject.put("result", 0);
      }
    }
    for (;;)
  ...
  protected boolean handleSchemaRequest(String paramString1, String paramString2)
  {
    ...
    if ((paramString2.equals("open")) || (paramString2.equals("reset")) || (paramString2.equals("close")) || (paramString2.equals("history")))
    {
      ...
      this.context.getSharedPreferences("vip_message_roam_banner_file", 4).edit().putInt("message_roam_is_set_password" + this.browserAppInterface.a(), 1).commit();
      paramString1 = "success";
      i = 0;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\vaswebviewplugin\MessageRoamJsPlugin.class
