  ...
  extends VasWebviewUiPlugin
{
  ...
  public String decodeUrl(String paramString)
  {
    ...
    String str = paramString.replace("[client]", "androidQQ").replace("[version]", "6.5.5.2880").replace("[system]", Build.VERSION.RELEASE).replace("[device]", Build.DEVICE);
  ...
  public boolean onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 1)
    {
      if (paramInt2 == -1)
      {
        ...
        PhotoUtils.a((Intent)localObject, this.activity, AvatarPendantMarketActivity.class.getName(), paramInt1, paramInt1, 640, 640, paramIntent, ProfileCardUtil.a());
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\vaswebviewplugin\AvatarPendantUiPlugin.class
