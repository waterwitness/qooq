  ...
  extends EmojiUiPlugin
{
  ...
  {
    if (paramBoolean1) {}
    while (((paramInt != 8) && (paramInt != 4)) || (paramActivity == null) || (TextUtils.isEmpty(paramString1)) || (TextUtils.isEmpty(paramString2))) {
      return;
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\vaswebviewplugin\EmojiHomeUiPlugin.class
