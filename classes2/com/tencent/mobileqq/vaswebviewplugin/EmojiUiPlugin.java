  ...
  implements DialogInterface.OnDismissListener
{
  ...
  EmojiUiPlugin.HomePageUrlInfo configUrl;
  String errorUrl;
  String errordescription;
  int failcode;
  EmojiUiPlugin.HomePageLoadInfo homePageUrlInfo;
  ...
  public EmojiUiPlugin()
  {
    ...
    this.configUrl = new EmojiUiPlugin.HomePageUrlInfo(this);
    this.homePageUrlInfo = new EmojiUiPlugin.HomePageLoadInfo(this);
    this.mSid = "";
    ...
    this.errorUrl = "";
    this.mEmojiKeygetOnRemoteResp = new EmojiUiPlugin.1(this);
  }
  ...
  {
    QQCustomDialogThreeBtns localQQCustomDialogThreeBtns = DialogUtil.a(this.activity, 230).a(this.activity.getString(2131370455)).b(this.activity.getString(2131370454)).a(this.activity.getString(2131367263), new EmojiUiPlugin.3(this));
  ...
  {
    this.activity.a.b(getInfoIntent(), this.homePageUrlInfo.homePageUrl);
    if ((this.mActivityType == 1) && ((this.mSrcFromType == 1) || (this.mSrcFromType == 6))) {
      this.activity.setLeftButton(2131369134, new EmojiUiPlugin.2(this));
    }
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\vaswebviewplugin\EmojiUiPlugin.class
