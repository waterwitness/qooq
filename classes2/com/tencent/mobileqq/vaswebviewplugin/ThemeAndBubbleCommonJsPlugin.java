  ...
  extends VasWebviewJsPlugin
{
  ...
  public ThemeAndBubbleCommonJsPlugin()
  {
    ...
    this.handler = new ThemeAndBubbleCommonJsPlugin.6(this);
  ...
  public void saveImage(JSONObject paramJSONObject, String paramString)
  {
    try
    {
      ...
      paramString.append("&version=6.5.5.2880");
      ...
      ThreadManager.d(new ThemeAndBubbleCommonJsPlugin.5(this, paramJSONObject, new File(AppConstants.bo, paramString)));
      return;
    }
    catch (Exception paramJSONObject)
    {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\vaswebviewplugin\ThemeAndBubbleCommonJsPlugin.class
