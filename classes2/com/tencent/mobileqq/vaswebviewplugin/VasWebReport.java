...
import cooperation.qzone.report.QZoneMonitorH5ReportServlet;
  ...
  extends WebViewPlugin
{
  ...
  private void handleNewPerformanceData(String paramString, JSONObject paramJSONObject)
  {
    ...
    do
    {
        ...
        for (;;)
        {
          ...
          try
          {
            ...
            if ((i == 2) && (paramJSONObject.has("first_screen")))
            {
              ...
              ((WebUiUtils.WebviewReportSpeedInterface)paramJSONObject).a(paramString);
      ...
      } while (!(this.mRuntime.a() instanceof SwiftBrowserComponentsProvider.SwiftBrowserComponentProviderSupporter));
      paramJSONObject = (SwiftBrowserStatistics)super.getBrowserComponent(-2);
    } while (paramJSONObject == null);
    paramJSONObject.jdField_a_of_type_OrgJsonJSONObject = paramString;
    this.mIndexPerformanceObject = null;
    this.mFirstScreenPerformanceObject = null;
  }
  ...
  private void handlePerformanceData(JSONObject paramJSONObject)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ((WebUiUtils.WebviewReportSpeedInterface)localWebUiBaseInterface).a(localJSONObject);
      }
  ...
  protected boolean handleEvent(String paramString, long paramLong, Map paramMap)
  {
    ...
    for (paramMap = (Integer)paramMap;; paramMap = Integer.valueOf(0))
    {
      ...
      if (((this.mWebCoreDumpHandlePolicy & 0x2) != 0) && (localObject1 != null))
      {
        ...
        QzoneHandlerThreadFactory.a("BackGround_HandlerThread").a(new VasWebReport.1(this, (JSONObject)localObject1, paramString));
      }
      for (;;)
      {
        return true;
      ...
      if (paramLong == 8589934594L)
      {
        ...
        for (;;)
        {
          ...
          ReportController.a(null, "P_CliOper", "vasweb", "", "load", "finish", 0, 1, "errocode:" + this.errorMap.get(paramString), paramMap, Util.b(paramString, new String[0]), "6.5.5--android--" + Build.VERSION.SDK_INT);
          ...
          paramMap = (QQBrowserActivity)paramString;
          if ((paramMap.a == null) || (paramMap.a.a != null)) {
            break;
          }
        ...
        {
          ReportController.a(null, "P_CliOper", "vasweb", "", "load", "finish", 0, 0, "" + paramLong, paramMap, Util.b(paramString, new String[0]), "6.5.5--android--" + Build.VERSION.SDK_INT);
          break;
          if (QLog.isColorLevel()) {
  ...
  protected boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    if (("debug".equalsIgnoreCase(paramString2)) && ("log".equalsIgnoreCase(paramString3)))
    {
      ...
      if (((paramJsBridgeListener instanceof QQBrowserActivity)) && (paramString2 != null))
      {
        paramJsBridgeListener = (QQBrowserActivity)paramJsBridgeListener;
        if (QLog.isColorLevel()) {
          QLog.d("QQBrowser_report", 2, "try report web status, onNetworkCost,  step: 11, asyncMode: " + paramString2.jdField_a_of_type_Int + ", from loadUrl: " + (System.currentTimeMillis() - paramString2.n) + ", stepTime: " + (System.currentTimeMillis() - paramString2.b) + ", totalTime: " + (System.currentTimeMillis() - paramString2.b) + ", \n " + paramString1);
        }
        return true;
      }
    }
  ...
  public void monitorH5Report(JSONObject paramJSONObject, String paramString)
  {
    int k = 0;
    Object localObject1 = QzoneConfig.a().a("QZoneSetting", "MonitorH5ReportURL", "qzone.qq.com,qzone.com").split(",");
    if (TextUtils.isEmpty(paramString)) {
      QLog.i("VasWebReport", 1, "url is null");
    }
    Object localObject2;
    do
    {
    ...
    for (;;)
    {
      ...
      {
        if (((String)localObject2).endsWith(localObject1[i])) {
          j = 1;
        }
      }
      else
      {
        ...
        if ((this.mRuntime == null) || (paramJSONObject == null)) {
          break label232;
        }
        localObject2 = this.mRuntime.a();
        localObject1 = this.mRuntime.a();
        if ((localObject1 == null) || (localObject2 == null) || (!(localObject2 instanceof QQBrowserActivity)) || (!((QQBrowserActivity)localObject2).o)) {
          break;
        }
        paramJSONObject = parseJson(paramJSONObject);
        paramJSONObject.putString("uin", ((AppRuntime)localObject1).getAccount());
        paramJSONObject.putString("url", paramString);
        try
        {
          paramString = new NewIntent(BaseApplication.getContext(), QZoneMonitorH5ReportServlet.class);
          paramString.putExtra("bundle", paramJSONObject);
          ((AppRuntime)localObject1).startServlet(paramString);
          return;
        }
        catch (Exception paramJSONObject)
        {
          QLog.w("VasWebReport", 1, "monitorH5Report fail", paramJSONObject);
          return;
        }
      }
      i += 1;
    ...
    if (this.mRuntime == null)
    {
      QLog.i("VasWebReport", 1, "monitorH5Report AppRuntime is null");
      return;
    }
    QLog.i("VasWebReport", 1, "monitorH5Report performanceData is null");
  }
  ...
  public Bundle parseJson(JSONObject paramJSONObject)
  {
    Bundle localBundle = new Bundle();
    localBundle.putLong("first_word", paramJSONObject.optLong("first_word"));
    localBundle.putLong("first_screen", paramJSONObject.optLong("first_screen"));
    localBundle.putLong("page_finish", paramJSONObject.optLong("page_finish"));
    ...
    try
    {
      ...
      if (paramJSONObject != null)
      {
        ...
        long l3 = paramJSONObject.optLong("dns_end");
        l4 = paramJSONObject.optLong("connect_start");
        long l5 = paramJSONObject.optLong("connect_end");
        l6 = paramJSONObject.optLong("send_start");
        long l7 = paramJSONObject.optLong("send_end");
        long l8 = paramJSONObject.optLong("ssl_handshake_start");
        long l9 = paramJSONObject.optLong("ssl_handshake_end");
        l10 = paramJSONObject.optLong("recv_start");
        l11 = paramJSONObject.optLong("recv_end");
        if (l2 != 0L)
        {
          l1 = l11 - l2;
          localBundle.putLong("time", l1);
          localBundle.putLong("dns_start", l2);
          localBundle.putLong("dns_end", l3);
          localBundle.putLong("connect_start", l4);
          localBundle.putLong("connect_end", l5);
          localBundle.putLong("send_start", l6);
          localBundle.putLong("send_end", l7);
          localBundle.putLong("ssl_handshake_start", l8);
          localBundle.putLong("ssl_handshake_end", l9);
          localBundle.putLong("recv_start", l10);
          localBundle.putLong("recv_end", l11);
          localBundle.putBoolean("cached", paramJSONObject.optBoolean("cached"));
          localBundle.putLong("expired_time", paramJSONObject.optLong("expired_time"));
          localBundle.putInt("cipher_suit", paramJSONObject.optInt("cipher_suit"));
          localBundle.putInt("errorcode", paramJSONObject.optInt("errorcode"));
        }
      }
      else
      {
    ...
    catch (JSONException paramJSONObject)
    {
      for (;;)
      {
        ...
        long l11;
        long l1;
        QLog.w("VasWebReport", 1, "json parse error", paramJSONObject);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\vaswebviewplugin\VasWebReport.class
