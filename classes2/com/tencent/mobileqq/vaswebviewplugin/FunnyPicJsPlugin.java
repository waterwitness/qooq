  ...
  protected boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    try
    {
      ...
      for (;;)
      {
        return true;
        paramJsBridgeListener = paramString2;
        paramVarArgs = URLDecoder.decode(paramString1.substring(i + 1), "UTF-8");
        paramJsBridgeListener = paramString2;
        Object localObject = new JSONObject(paramVarArgs);
        paramJsBridgeListener = paramString2;
        paramString1 = ((JSONObject)localObject).getString("callback");
        ...
        if ("getCurrentPkgInfo".equals(paramString3))
        {
          ...
          paramJsBridgeListener = paramString1;
          this.mReqBundle.putString("jsonContent", paramVarArgs);
          paramJsBridgeListener = paramString1;
        ...
        else
        {
          ...
          if ("addQutu".equals(paramString3))
          {
            ...
            paramJsBridgeListener = paramString1;
            int j = ((JSONObject)localObject).getInt("action");
            paramJsBridgeListener = paramString1;
            paramString2 = ((JSONObject)localObject).getJSONArray("uids");
            paramJsBridgeListener = paramString1;
            ...
            {
              paramJsBridgeListener = paramString1;
              localObject = new NewIntent(this.mRuntime.a().a(), WebSSOAgentServlet.class);
              paramJsBridgeListener = paramString1;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\vaswebviewplugin\FunnyPicJsPlugin.class
