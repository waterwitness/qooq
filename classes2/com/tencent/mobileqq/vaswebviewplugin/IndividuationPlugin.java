  ...
  extends VasWebviewJsPlugin
{
  ...
  protected boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      } else if ("isSupportFont".equals(paramString3)) {
        getFontType(paramJsBridgeListener, paramString2);
      } else if ("setRightButton".equals(paramString3)) {
        setRightButton(paramJsBridgeListener);
  ...
  protected void onResponse(Bundle paramBundle)
  {
    ...
    if ("openEmojiMall".equals(str2))
    {
      ...
      EmojiHomeUiPlugin.openEmojiHomePage2(this.mActivity, this.mBrowserApp.a(), 3, paramBundle, i);
      return;
    }
    if ("openEmojiDetail".equals(str2))
    {
      ...
      EmojiHomeUiPlugin.openEmojiDetailPage2(this.mActivity, this.mBrowserApp.a(), 4, (String)localObject, Boolean.valueOf(bool).booleanValue(), i, paramBundle);
      return;
    }
    ...
    for (int i = 1;; i = -40) {
      try
      {
        ...
        if ("600".equals(localObject))
        {
          ...
          if (!BaseApplicationImpl.a)
          {
            Toast.makeText(this.mActivity.getApplicationContext(), this.mActivity.getString(2131368352), 0).show();
            return;
          }
          if (!Utils.b())
          {
            Toast.makeText(this.mActivity.getApplicationContext(), this.mActivity.getString(2131368967), 0).show();
            return;
          }
        }
      }
      catch (Exception paramJSONObject)
      {
        ...
        if (QLog.isColorLevel())
        {
          ...
          if ("500".equals(localObject))
          {
            ...
            paramJSONObject.putExtra("selfSet_leftViewText", this.mActivity.getString(2131367975));
  ...
  public void setRightButton(JSONObject paramJSONObject)
  {
    for (;;)
    {
      try
      {
        ...
        if ((i == 2) && ((this.mActivity instanceof QQBrowserActivity)))
        {
          ((QQBrowserActivity)this.mActivity).setRightButton(2131367875, new IndividuationPlugin.1(this));
          return;
        }
      }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\vaswebviewplugin\IndividuationPlugin.class
