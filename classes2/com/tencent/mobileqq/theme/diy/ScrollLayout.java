  ...
  extends ViewGroup
{
  ...
  static final float SCALE_STEP = 0.20000005F;
  ...
  boolean changeAlphaImmediately(View paramView, float paramFloat, int paramInt)
  {
    ...
    paramFloat = 1.0F + (paramFloat - 0.4F) / 0.6F * 0.20000005F;
    ...
    for (;;)
    {
      ...
      if (i < super.getChildCount() - 1)
      {
        ...
        for (;;)
        {
          ...
          this.mTouchState = 0;
          break;
          if ((i < 64936) && (this.mCurScreen < super.getChildCount() - 1))
          {
            this.onScreenChangeListener.onScreenChange(this.mCurScreen + 1);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\theme\diy\ScrollLayout.class
