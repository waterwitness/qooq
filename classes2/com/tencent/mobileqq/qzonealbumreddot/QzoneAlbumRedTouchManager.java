  ...
  implements Manager
{
  ...
  public void a(BusinessInfoCheckUpdate.AppInfo paramAppInfo)
  {
    ...
    QZoneClickReport.startReportImediately(this.a.a(), "443", "1");
    ThreadManager.b().post(new uam(this));
  }
  ...
  public boolean a()
  {
    ...
    {
      return false;
      long l1 = QzoneConfig.a().a("PhotoUpload", "PhotoUploadRedPointTimeInterval", 24) * 60 * 60 * 1000;
  ...
  public void b()
  {
    ...
    ThreadManager.b().post(new ual(this));
  }
  ...
  public void c()
  {
    ...
    {
      LocalMultiProcConfig.a("key_photo_guide_last_check", System.currentTimeMillis());
      if (b()) {
        break label65;
      }
      if (QLog.isColorLevel()) {
  ...
  public void d()
  {
    int i = QzoneConfig.a().a("PhotoUpload", "GuideSelectPhotoSendRedJumpToQzone", 0);
    SharedPreferences.Editor localEditor = a().edit().putLong("key_photo_guide_has_red_date", System.currentTimeMillis());
    if (Build.VERSION.SDK_INT < 9) {
      localEditor.commit();
    }
    while ((i == 1) && (this.a != null) && (this.a.a() != null) && (QzonePhotoGuideNotifyService.a(this.a.a(), 84)))
    {
      if (QLog.isColorLevel()) {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\qzonealbumreddot\QzoneAlbumRedTouchManager.class
