...
public class MQQProfileName
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((paramObject instanceof MQQProfileName))
    {
      ...
      bool1 = bool2;
      if (Utils.a(((MQQProfileName)paramObject).jdField_a_of_type_ComTencentMobileqqUnifiednameMQQName, this.jdField_a_of_type_ComTencentMobileqqUnifiednameMQQName)) {
        if (this.jdField_a_of_type_JavaUtilList == null)
        {
          i = 0;
          if (((MQQProfileName)paramObject).jdField_a_of_type_JavaUtilList != null) {
            break label134;
          }
          j = 0;
          label55:
          ...
          if (Utils.a((MQQName)this.jdField_a_of_type_JavaUtilList.get(j), (MQQName)((MQQProfileName)paramObject).jdField_a_of_type_JavaUtilList.get(j))) {
            break label150;
          }
          bool1 = false;
        }
    ...
    for (;;)
    {
      ...
      break;
      j = ((MQQProfileName)paramObject).jdField_a_of_type_JavaUtilList.size();
      break label55;
      return bool1;
    }
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\unifiedname\MQQProfileName.class
