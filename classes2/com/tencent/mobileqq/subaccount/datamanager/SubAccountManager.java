  ...
  implements Manager
{
  ...
  public SubAccountManager(QQAppInterface paramQQAppInterface)
  {
    ...
    List localList = this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.a(SubAccountInfo.class);
    StringBuilder localStringBuilder;
    if (QLog.isColorLevel())
    {
      localStringBuilder = new StringBuilder().append("initSubAccountInfos() uin=").append(paramQQAppInterface.a()).append(" result=");
      if (localList != null) {
        break label128;
      }
    }
  ...
  private void a(SubAccountInfo paramSubAccountInfo, ArrayList paramArrayList, int paramInt)
  {
  ...
  private void d()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        ArrayList localArrayList = (ArrayList)this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.a(SubAccountMessage.class, SubAccountMessage.class.getSimpleName(), false, "subUin=?", new String[] { str }, null, null, "time desc", null);
  ...
  public int a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localObject != null)
        {
          int j = ((SubAccountInfo)localObject).status;
          i = j;
          if (QLog.isColorLevel())
          {
            ...
            if ((paramString1.equals(localSubAccountMessage.subUin)) && (paramString2.equals(localSubAccountMessage.senderuin)))
            {
              ...
              if (localIterator.hasNext())
              {
                ...
                if (localSubAccountMessage != null) {
                  this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.b(localSubAccountMessage);
                }
                if (QLog.isColorLevel()) {
  ...
  public Pair a(String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          localObject2 = new Pair(Integer.valueOf(((SubAccountInfo)localObject1).serverErrorType), ((SubAccountInfo)localObject1).serverErrorMsg);
          paramString = (String)localObject2;
          if (QLog.isColorLevel())
          {
            QLog.d("SUB_ACCOUNT", 2, "getServerError() findInfo errType=" + ((SubAccountInfo)localObject1).serverErrorType + " errMsg=" + ((SubAccountInfo)localObject1).serverErrorMsg);
            paramString = (String)localObject2;
          }
          return paramString;
        }
  ...
  public void a()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.a(SubAccountMessage.class.getSimpleName());
  }
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          SubAccountControll.a(paramQQAppInterface, paramString1, 6);
          paramQQAppInterface.a().c(paramString1, 7000, -i);
          paramQQAppInterface.a().a(new String[] { AppConstants.ah, paramString1 });
          paramQQAppInterface.D();
          paramString2 = new SubAccountBackProtocData();
  ...
  public void a(SubAccountInfo paramSubAccountInfo)
  {
    ...
    if (QLog.isColorLevel())
    {
      localObject2 = new StringBuilder().append("saveSubAccountInfo() ");
      if (paramSubAccountInfo == null)
      {
    ...
    else
    {
      ...
      if (QLog.isColorLevel())
      {
        localObject1 = new StringBuilder().append("saveSubAccountInfo() ");
        if (paramSubAccountInfo != null) {
          break label123;
        }
      }
    ...
    label123:
    for (paramSubAccountInfo = "saveInfo is null.";; paramSubAccountInfo = "saveInfo.subuin is null")
    {
      QLog.d("SUB_ACCOUNT", 2, paramSubAccountInfo);
      return;
      localObject1 = "saveInfo.subuin=" + paramSubAccountInfo.subuin;
      break;
    }
    label130:
    if (this.jdField_a_of_type_JavaUtilArrayList == null) {
  ...
  public void a(SubAccountBackProtocData paramSubAccountBackProtocData)
  {
    Object localObject2;
    if (QLog.isColorLevel())
    {
    ...
    {
      if ((paramSubAccountBackProtocData != null) && (paramSubAccountBackProtocData.b != null) && (paramSubAccountBackProtocData.c())) {
        break label183;
      }
      if (QLog.isColorLevel())
      {
    ...
    label143:
    for (paramSubAccountBackProtocData = "data == null";; paramSubAccountBackProtocData = "data.mMainAccount=" + paramSubAccountBackProtocData.b + " data.mSubUin=" + paramSubAccountBackProtocData.jdField_c_of_type_JavaLangString)
    {
      QLog.d("SUB_ACCOUNT", 2, paramSubAccountBackProtocData);
      return;
      localObject1 = "data.mMainAccount=" + paramSubAccountBackProtocData.b + " data.mSubUin=" + paramSubAccountBackProtocData.jdField_c_of_type_JavaLangString;
      break;
    }
    label183:
    ArrayList localArrayList2 = paramSubAccountBackProtocData.a();
    Object localObject1 = paramSubAccountBackProtocData.c();
    ArrayList localArrayList3 = paramSubAccountBackProtocData.b();
    if (QLog.isColorLevel())
    {
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          localObject1 = (SubAccountInfo)((Iterator)localObject2).next();
          if ((!paramSubAccountBackProtocData.b.equals(((SubAccountInfo)localObject1).trunkuin)) || (!str.equals(((SubAccountInfo)localObject1).subuin))) {
            continue;
          }
          ...
          ((SubAccountInfo)localObject2).trunkuin = paramSubAccountBackProtocData.b;
          ((SubAccountInfo)localObject2).serverErrorType = paramSubAccountBackProtocData.q;
          ((SubAccountInfo)localObject2).serverErrorMsg = paramSubAccountBackProtocData.a;
      ...
      {
        paramSubAccountBackProtocData = localArrayList3.iterator();
        while (paramSubAccountBackProtocData.hasNext()) {
          a((String)paramSubAccountBackProtocData.next());
        }
      }
      label575:
      this.jdField_a_of_type_JavaUtilConcurrentLocksLock.unlock();
      ...
      while (paramSubAccountBackProtocData.hasNext()) {
        a((SubAccountInfo)paramSubAccountBackProtocData.next());
      }
      break;
      label629:
      localObject1 = null;
  ...
  public void a(String paramString, long paramLong)
  {
    ...
    ThreadManager.a().post(new uxp(this, paramString, paramLong));
  }
  ...
  public void a(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    if (QLog.isColorLevel())
    {
      StringBuilder localStringBuilder = new StringBuilder().append("updateA2() subUin=").append(paramString1).append(" A2=");
      if (paramString2 == null)
      {
        localObject = "null";
        QLog.d("SUB_ACCOUNT", 2, localObject + " change=" + paramBoolean);
      }
    }
    else
    {
    ...
    {
      return;
      localObject = Integer.valueOf(paramString2.length());
      break;
      if (this.jdField_a_of_type_JavaUtilArrayList != null) {
        break label120;
      }
    ...
    return;
    label120:
    ThreadManager.a().post(new uxo(this, paramString1, paramString2, paramBoolean));
  }
  ...
  public int b(String paramString)
  {
    int i = 0;
    if (QLog.isColorLevel()) {
      QLog.d("SUB_ACCOUNT", 2, "getUnreadSenderNum() subUin=" + paramString);
    }
    if (paramString == null) {}
    do
    {
  ...
  public void b()
  {
    ...
    try
    {
      this.jdField_a_of_type_JavaUtilArrayList.clear();
      this.jdField_a_of_type_JavaUtilConcurrentLocksLock.unlock();
      this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.a(SubAccountInfo.class.getSimpleName());
      return;
    }
    finally
    {
  ...
  public void b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      boolean bool = this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.a((String)localObject1, (ContentValues)localObject2, "subUin=?", new String[] { paramString });
      if (!QLog.isColorLevel()) {
        break;
      }
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          bool = localSubAccountInfo.isTop;
          this.jdField_a_of_type_JavaUtilConcurrentLocksLock.unlock();
          if (QLog.isColorLevel()) {
            QLog.d("SUB_ACCOUNT", 2, "isRecentListTop() subUin.top=" + bool);
          }
          return bool;
        }
      }
    ...
    for (;;)
    {
      try
      {
        ...
        if (localIterator.hasNext())
        {
          ...
          bool = localSubAccountInfo.hintIsNew;
          return bool;
        }
      }
      finally
  ...
  public void g(String paramString)
  {
    ...
    boolean bool = this.jdField_a_of_type_ComTencentMobileqqPersistenceEntityManager.a(str, localContentValues, null, null);
    if (QLog.isColorLevel()) {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\subaccount\datamanager\SubAccountManager.class
