...
{
  public static final String a = "OpenSDKUtils";
  ...
  public static void a(QQAppInterface paramQQAppInterface, Context paramContext, String paramString, int paramInt1, PstnSessionInfo paramPstnSessionInfo, int paramInt2)
  {
    ...
    default: 
      arrayOfInt[0] = 1;
      localActionSheet.c(2131372178);
    }
    for (;;)
    {
      localActionSheet.d(2131367262);
      localActionSheet.a(new tyt());
      localActionSheet.a(new tyu(localActionSheet, arrayOfInt, paramInt1, paramQQAppInterface, paramContext, paramPstnSessionInfo, paramInt2, paramString));
      localActionSheet.show();
      return;
      localActionSheet.a(paramContext.getResources().getString(2131372444), paramContext.getResources().getDrawable(2130839269), 0);
      continue;
      localActionSheet.a(paramContext.getResources().getString(2131372444), paramContext.getResources().getDrawable(2130839268), 0);
      continue;
      localActionSheet.a(paramContext.getResources().getString(2131372444), paramContext.getResources().getDrawable(2130839267), 0);
      localActionSheet.c(2131372178);
    }
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\qcall\OpenSDKUtils.class
