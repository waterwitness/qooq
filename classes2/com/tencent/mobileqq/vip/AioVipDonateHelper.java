...
public class AioVipDonateHelper
{
  ...
  public long a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (this.jdField_d_of_type_Int == -1) {
      this.jdField_d_of_type_Int = paramQQAppInterface.getApplication().getSharedPreferences(jdField_a_of_type_JavaLangString + paramQQAppInterface.a(), 0).getInt(jdField_d_of_type_JavaLangString, -1);
    }
  ...
  public String a(QQAppInterface paramQQAppInterface)
  {
    ...
    if (TextUtils.isEmpty(this.m)) {
      this.m = paramQQAppInterface.getApplication().getSharedPreferences(jdField_a_of_type_JavaLangString + paramQQAppInterface.a(), 0).getString(h, null);
    }
    return this.m;
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, int paramInt)
  {
    ...
    paramQQAppInterface = paramQQAppInterface.getApplication().getSharedPreferences(jdField_a_of_type_JavaLangString + paramQQAppInterface.a(), 0).edit();
  ...
  public boolean a(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (this.jdField_c_of_type_Int == -1) {
        this.jdField_c_of_type_Int = paramQQAppInterface.getApplication().getSharedPreferences(jdField_a_of_type_JavaLangString + paramQQAppInterface.a(), 0).getInt(jdField_c_of_type_JavaLangString, -1);
      }
  ...
  public boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    do
    {
      ...
      if ((this.jdField_a_of_type_JavaUtilList == null) || (this.jdField_a_of_type_JavaUtilList.size() < 1))
      {
        ...
        paramQQAppInterface = paramQQAppInterface.getApplication().getSharedPreferences(jdField_a_of_type_JavaLangString + paramQQAppInterface.a(), 0).getString(f, null);
  ...
  public String b(QQAppInterface paramQQAppInterface)
  {
    ...
    if (TextUtils.isEmpty(this.n)) {
      this.n = paramQQAppInterface.getApplication().getSharedPreferences(jdField_a_of_type_JavaLangString + paramQQAppInterface.a(), 0).getString(i, null);
    }
    return this.n;
  }
  ...
  public boolean b(QQAppInterface paramQQAppInterface)
  {
    ...
    for (;;)
    {
      ...
      if (TextUtils.isEmpty(this.l)) {
        this.l = paramQQAppInterface.getApplication().getSharedPreferences(jdField_a_of_type_JavaLangString + paramQQAppInterface.a(), 0).getString(jdField_e_of_type_JavaLangString, null);
      }
      if (!TextUtils.isEmpty(this.l))
      {
  ...
  public String c(QQAppInterface paramQQAppInterface)
  {
    ...
    if (TextUtils.isEmpty(this.o)) {
      this.o = paramQQAppInterface.getApplication().getSharedPreferences(jdField_a_of_type_JavaLangString + paramQQAppInterface.a(), 0).getString(j, k);
    }
    return this.o;
  }
  ...
  public boolean c(QQAppInterface paramQQAppInterface)
  {
    ...
    do
    {
      ...
      if (this.jdField_e_of_type_Int == -1) {
        this.jdField_e_of_type_Int = paramQQAppInterface.getApplication().getSharedPreferences(jdField_a_of_type_JavaLangString + paramQQAppInterface.a(), 0).getInt(g, 0);
      }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\vip\AioVipDonateHelper.class
