...
public class PhoneNumLoginImpl
{
  ...
  public boolean a(QQAppInterface paramQQAppInterface, Activity paramActivity)
  {
    ...
    localQQCustomDialog.setTitle(2131368579);
    localQQCustomDialog.setMessage(2131368580);
    paramQQAppInterface = new tsi(this, str, paramActivity, paramQQAppInterface);
    paramActivity = new tsj(this);
    localQQCustomDialog.setPositiveButton(2131368581, paramQQAppInterface);
    localQQCustomDialog.setNegativeButton(2131367262, paramActivity);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\phonelogin\PhoneNumLoginImpl.class
