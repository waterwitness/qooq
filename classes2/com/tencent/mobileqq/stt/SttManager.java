  ...
  implements Handler.Callback, Manager, BusinessObserver
{
  ...
  private static final String jdField_a_of_type_JavaLangString = "rich_status";
  public static boolean a = false;
  private static final int jdField_b_of_type_Int = 1;
  private static final String jdField_b_of_type_JavaLangString = "k_ability_";
  private static final int jdField_c_of_type_Int = 2;
  private static final String jdField_c_of_type_JavaLangString = "Q.stt";
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      {
        this.jdField_a_of_type_AndroidOsHandler.obtainMessage(3, (int)(localLong.longValue() >> 32) & 0xFFFFFFFF, (int)(localLong.longValue() & 0xFFFFFFFFFFFFFFFF), paramArrayOfByte).sendToTarget();
        return;
        if (this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap == null) {
          this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap = new ConcurrentHashMap();
        }
        localObject = (uxh)this.jdField_a_of_type_JavaUtilConcurrentConcurrentHashMap.get(localLong);
        paramArrayOfByte = (byte[])localObject;
        if (localObject == null)
        {
          paramArrayOfByte = new uxh(null);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\stt\SttManager.class
