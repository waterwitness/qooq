  ...
  extends MSFServlet
{
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageForPtt paramMessageForPtt, Long paramLong)
  {
    ...
    int i2 = paramMessageForPtt.voiceLength;
    if (QLog.isColorLevel()) {
      QLog.d("SttServlet", 2, "voiceLength translate " + paramMessageForPtt.voiceLength);
    }
    int i1 = i2;
    if (i2 == 0) {
      i1 = QQRecorder.a(paramMessageForPtt);
    }
    i2 = paramMessageForPtt.voiceType;
    ...
    localNewIntent.putExtra("k_voice_type", i2);
    localNewIntent.putExtra("k_file_path", paramMessageForPtt.groupFileKeyStr);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\stt\SttServlet.class
