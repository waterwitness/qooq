...
public class PkgTools
{
  ...
  public static String a(android.content.Context paramContext)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 204	android/content/Context:getContentResolver	()Landroid/content/ContentResolver;
    //   4: getstatic 41	com/tencent/mobileqq/utils/httputils/PkgTools:jdField_a_of_type_AndroidNetUri	Landroid/net/Uri;
    //   7: aconst_null
    //   8: aconst_null
    //   9: aconst_null
    //   10: aconst_null
    //   11: invokevirtual 210	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   14: astore_1
    //   15: aload_1
    //   16: ifnonnull +16 -> 32
    //   19: aload_1
    ...
    //   40: aload_1
    //   41: ldc -33
    //   43: invokeinterface 226 2 0
    //   48: invokeinterface 229 2 0
    //   53: invokevirtual 232	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   56: astore_0
    //   57: aload_0
    //   58: getstatic 45	com/tencent/mobileqq/utils/httputils/PkgTools:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   61: invokevirtual 236	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   64: ifeq +23 -> 87
    //   67: getstatic 45	com/tencent/mobileqq/utils/httputils/PkgTools:jdField_a_of_type_JavaLangString	Ljava/lang/String;
    //   70: astore_0
    //   71: aload_0
    //   72: astore_2
    //   73: aload_1
    ...
    //   86: areturn
    //   87: aload_0
    //   88: getstatic 49	com/tencent/mobileqq/utils/httputils/PkgTools:b	Ljava/lang/String;
    //   91: invokevirtual 236	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   94: ifeq +10 -> 104
    //   97: getstatic 49	com/tencent/mobileqq/utils/httputils/PkgTools:b	Ljava/lang/String;
    //   100: astore_0
    //   101: goto -30 -> 71
    //   104: aload_0
    //   105: getstatic 53	com/tencent/mobileqq/utils/httputils/PkgTools:c	Ljava/lang/String;
    //   108: invokevirtual 236	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   111: ifeq +10 -> 121
    //   114: getstatic 53	com/tencent/mobileqq/utils/httputils/PkgTools:c	Ljava/lang/String;
    //   117: astore_0
    //   118: goto -47 -> 71
    //   121: aload_0
    //   122: getstatic 57	com/tencent/mobileqq/utils/httputils/PkgTools:d	Ljava/lang/String;
    //   125: invokevirtual 236	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   128: ifeq +10 -> 138
    //   131: getstatic 57	com/tencent/mobileqq/utils/httputils/PkgTools:d	Ljava/lang/String;
    //   134: astore_0
    //   135: goto -64 -> 71
    //   138: aload_0
    //   139: getstatic 61	com/tencent/mobileqq/utils/httputils/PkgTools:e	Ljava/lang/String;
    //   142: invokevirtual 236	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   145: ifeq +10 -> 155
    //   148: getstatic 61	com/tencent/mobileqq/utils/httputils/PkgTools:e	Ljava/lang/String;
    //   151: astore_0
    //   152: goto -81 -> 71
    //   155: aload_0
    //   156: getstatic 65	com/tencent/mobileqq/utils/httputils/PkgTools:f	Ljava/lang/String;
    //   159: invokevirtual 236	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   162: ifeq +60 -> 222
    //   165: getstatic 65	com/tencent/mobileqq/utils/httputils/PkgTools:f	Ljava/lang/String;
    //   168: astore_0
    //   169: goto -98 -> 71
    //   172: astore_0
    //   173: aconst_null
  ...
  public static String c(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    //   38: iconst_2
    //   39: iload_2
    //   40: invokestatic 374	java/lang/System:arraycopy	(Ljava/lang/Object;ILjava/lang/Object;II)V
    //   43: new 434	java/io/ByteArrayInputStream
    //   46: dup
    //   47: aload 7
    //   49: invokespecial 436	java/io/ByteArrayInputStream:<init>	([B)V
    //   52: astore_0
    //   53: new 239	java/io/DataInputStream
    //   56: dup
    //   57: aload_0
    //   58: invokespecial 242	java/io/DataInputStream:<init>	(Ljava/io/InputStream;)V
    //   61: astore_3
    //   62: aload_3
    //   63: invokevirtual 516	java/io/DataInputStream:readUTF	()Ljava/lang/String;
    //   66: astore 5
    //   68: aload 5
    //   70: astore 4
    //   72: aload_3
    //   73: ifnull +7 -> 80
    //   76: aload_3
    //   77: invokevirtual 517	java/io/DataInputStream:close	()V
    //   80: aload 4
    //   82: astore_3
    //   83: aload_0
    //   84: ifnull +10 -> 94
    //   87: aload_0
    //   88: invokevirtual 518	java/io/ByteArrayInputStream:close	()V
    //   91: aload 4
    //   93: astore_3
    //   94: aload_3
    //   95: areturn
    ...
    //   106: ifnull +7 -> 113
    //   109: aload_3
    //   110: invokevirtual 517	java/io/DataInputStream:close	()V
    //   113: aload 4
    //   115: astore_3
    //   116: aload_0
    //   117: ifnull -23 -> 94
    //   120: aload_0
    //   121: invokevirtual 518	java/io/ByteArrayInputStream:close	()V
    //   124: ldc 107
    //   126: areturn
    //   127: astore_0
    //   128: ldc 107
    ...
    //   138: ifnull +7 -> 145
    //   141: aload_3
    //   142: invokevirtual 517	java/io/DataInputStream:close	()V
    //   145: aload 4
    //   147: astore_3
    //   148: aload_0
    //   149: ifnull -55 -> 94
    //   152: aload_0
    //   153: invokevirtual 518	java/io/ByteArrayInputStream:close	()V
    //   156: ldc 107
    //   158: areturn
    //   159: astore_0
    //   160: ldc 107
    ...
    //   172: ifnull +8 -> 180
    //   175: aload 4
    //   177: invokevirtual 517	java/io/DataInputStream:close	()V
    //   180: aload_0
    //   181: ifnull +7 -> 188
    //   184: aload_0
    //   185: invokevirtual 518	java/io/ByteArrayInputStream:close	()V
    //   188: aload_3
    //   189: athrow
    //   190: astore_3
    //   191: goto -111 -> 80
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\utils\httputils\PkgTools.class
