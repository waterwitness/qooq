...
public class SecUtil
{
  ...
  public static boolean check0DayRepack(Context paramContext)
  {
    ...
    //   4: iconst_0
    //   5: ireturn
    //   6: new 44	java/util/jar/JarFile
    //   9: dup
    //   10: new 46	java/io/File
    //   13: dup
    //   14: aload_0
    //   15: invokevirtual 52	android/content/Context:getApplicationContext	()Landroid/content/Context;
    //   18: invokevirtual 56	android/content/Context:getApplicationInfo	()Landroid/content/pm/ApplicationInfo;
    //   21: getfield 62	android/content/pm/ApplicationInfo:sourceDir	Ljava/lang/String;
    //   24: invokespecial 65	java/io/File:<init>	(Ljava/lang/String;)V
    //   27: invokespecial 68	java/util/jar/JarFile:<init>	(Ljava/io/File;)V
    //   30: invokevirtual 72	java/util/jar/JarFile:entries	()Ljava/util/Enumeration;
    //   33: astore_0
    //   34: new 74	java/util/HashSet
    //   37: dup
    //   38: invokespecial 75	java/util/HashSet:<init>	()V
    //   41: astore_1
    //   42: aload_0
    ...
    //   57: checkcast 87	java/util/jar/JarEntry
    //   60: invokevirtual 91	java/util/jar/JarEntry:getName	()Ljava/lang/String;
    //   63: astore_2
    //   64: aload_1
    //   65: aload_2
    ...
    //   77: aload_1
    //   78: aload_2
    //   79: invokeinterface 100 2 0
    //   84: pop
    //   85: goto -43 -> 42
    //   88: astore_0
    //   89: aload_0
    //   90: invokevirtual 103	java/lang/Exception:printStackTrace	()V
    //   93: iconst_0
    //   94: ireturn
    //   95: astore_0
    //   96: aload_0
    //   97: invokevirtual 104	java/lang/OutOfMemoryError:printStackTrace	()V
    //   100: goto -7 -> 93
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\utils\SecUtil.class
