...
public class ContactConfig
{
  ...
  {
    int i = 0;
    paramContext = paramContext.getSharedPreferences(String.valueOf(AppConstants.aq), 0).edit();
  ...
  {
    paramContext.getSharedPreferences(String.valueOf(AppConstants.aq), 0).edit().putInt(paramString, paramInt).commit();
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\utils\ContactConfig.class
