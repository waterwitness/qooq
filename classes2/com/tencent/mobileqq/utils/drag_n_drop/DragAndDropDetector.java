...
public class DragAndDropDetector
{
  ...
  public DragAndDropDetector(DragAndDropDetector.DragSource paramDragSource, DragAndDropDetector.DropTarget paramDropTarget)
  {
    this(paramDragSource, paramDropTarget, false);
  ...
  public void a(float[] paramArrayOfFloat)
  {
    ...
    {
      paramArrayOfFloat[0] = this.jdField_a_of_type_Float;
      paramArrayOfFloat[1] = this.jdField_b_of_type_Float;
    }
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    do
    {
      do
      {
        do
        {
          ...
          break;
          this.jdField_a_of_type_ComTencentMobileqqUtilsDrag_n_dropDragAndDropDetector$Draggable = this.jdField_a_of_type_ComTencentMobileqqUtilsDrag_n_dropDragAndDropDetector$DragSource.a(f2, f1);
        } while (this.jdField_a_of_type_ComTencentMobileqqUtilsDrag_n_dropDragAndDropDetector$Draggable == null);
        if ((this.jdField_a_of_type_ComTencentMobileqqUtilsDrag_n_dropDragAndDropDetector$DragSource.a(this.jdField_a_of_type_ComTencentMobileqqUtilsDrag_n_dropDragAndDropDetector$Draggable, f2, f1)) && (this.jdField_a_of_type_ComTencentMobileqqUtilsDrag_n_dropDragAndDropDetector$Draggable.a(this.jdField_a_of_type_ComTencentMobileqqUtilsDrag_n_dropDragAndDropDetector$DragSource, f2, f1))) {
          this.jdField_b_of_type_Boolean = true;
        }
        return true;
      } while (!this.jdField_b_of_type_Boolean);
      this.jdField_a_of_type_ComTencentMobileqqUtilsDrag_n_dropDragAndDropDetector$DragSource.a(this.jdField_a_of_type_ComTencentMobileqqUtilsDrag_n_dropDragAndDropDetector$Draggable, f2, f1);
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqUtilsDrag_n_dropDragAndDropDetector$DragSource.a(this.jdField_a_of_type_ComTencentMobileqqUtilsDrag_n_dropDragAndDropDetector$DropTarget, this.jdField_a_of_type_ComTencentMobileqqUtilsDrag_n_dropDragAndDropDetector$Draggable, f2, f1);
    ...
    for (;;)
    {
      ...
      this.d = true;
      return true;
      this.jdField_a_of_type_ComTencentMobileqqUtilsDrag_n_dropDragAndDropDetector$DragSource.a(null, this.jdField_a_of_type_ComTencentMobileqqUtilsDrag_n_dropDragAndDropDetector$Draggable, f2, f1);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\utils\drag_n_drop\DragAndDropDetector.class
