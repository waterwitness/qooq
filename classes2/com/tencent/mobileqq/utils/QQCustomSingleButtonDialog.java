  ...
  extends Dialog
{
  ...
  public QQCustomSingleButtonDialog(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetBaseAdapter = new wcg(this);
  }
  ...
  public QQCustomSingleButtonDialog a(int paramInt1, int paramInt2, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetButton.setOnClickListener(new wci(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public QQCustomSingleButtonDialog a(Drawable paramDrawable, boolean paramBoolean, int paramInt)
  {
    ...
    if (paramBoolean)
    {
      ...
      if (paramInt == 2)
      {
        this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130838565);
        return this;
      }
      this.jdField_a_of_type_AndroidViewView.setBackgroundResource(2130838566);
      return this;
    }
  ...
  public QQCustomSingleButtonDialog a(String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.d.setOnClickListener(new wch(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public QQCustomSingleButtonDialog b(int paramInt, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    this.d.setVisibility(0);
    this.d.setOnClickListener(new wcj(this, paramOnClickListener));
    a();
    return this;
  }
  ...
  public QQCustomSingleButtonDialog b(String paramString)
  {
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      this.b.setContentDescription(paramString);
      this.b.setLinkTextColor(getContext().getResources().getColor(2131427482));
      this.b.setVisibility(0);
      return this;
    }
    this.b.setVisibility(8);
  ...
  public void setContentView(int paramInt)
  {
    ...
    this.c = ((TextView)findViewById(2131297851));
    this.f = ((TextView)findViewById(2131297847));
    this.e = ((TextView)findViewById(2131297848));
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)findViewById(2131297850));
    this.jdField_a_of_type_AndroidViewView = findViewById(2131297849);
    this.jdField_a_of_type_AndroidWidgetButton = ((Button)findViewById(2131297843));
    ...
    this.jdField_a_of_type_AndroidWidgetListView = ((ListView)findViewById(2131297845));
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\utils\QQCustomSingleButtonDialog.class
