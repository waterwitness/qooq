...
public class PhoneCodeUtils
{
  ...
  static
  {
    ...
    c.put("VG", "1284");
    c.put("VI", "1340");
    a = new PhoneCodeUtils.1(130);
    jdField_b_of_type_JavaUtilHashMap = new PhoneCodeUtils.2(20);
  }
  ...
  public static String a()
  {
    ...
    if (jdField_b_of_type_JavaUtilHashMap.containsKey(str))
    {
      ...
      return (String)jdField_b_of_type_JavaUtilHashMap.get(str);
    }
    return "86";
  }
  ...
  public static String a(Context paramContext)
  {
    if (TextUtils.isEmpty(jdField_b_of_type_JavaLangString))
    {
      ...
      if (!TextUtils.isEmpty(paramContext)) {
        jdField_b_of_type_JavaLangString = (String)c.get(paramContext.toUpperCase());
      }
      if (TextUtils.isEmpty(jdField_b_of_type_JavaLangString)) {
        jdField_b_of_type_JavaLangString = "86";
      }
      jdField_b_of_type_JavaLangString = "+" + jdField_b_of_type_JavaLangString;
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\utils\PhoneCodeUtils.class
