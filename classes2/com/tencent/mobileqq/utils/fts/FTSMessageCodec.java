...
{
  private static final String a = "Q.fts.utils";
  ...
  public static byte[] a(Object paramObject, int paramInt)
  {
      ...
      for (;;)
      {
        ...
        try
        {
          if ((paramObject instanceof FTSMessageCodec.TextMsgExts))
          {
            ...
            System.arraycopy(a(((FTSMessageCodec.TextMsgExts)paramObject).time), 0, arrayOfByte, 0, 8);
            System.arraycopy(a(((FTSMessageCodec.TextMsgExts)paramObject).shmsgseq), 0, arrayOfByte, 8, 8);
    ...
    QLog.e("Q.fts.utils", 2, "unserialize: failure", (Throwable)paramObject);
    return null;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\utils\fts\FTSMessageCodec.class
