  ...
  implements Manager
{
  ...
  public void a(String paramString, Integer paramInteger)
  {
    ...
    try
    {
      ...
      this.jdField_a_of_type_JavaUtilConcurrentLocksLock.unlock();
      if (QLog.isColorLevel()) {
        QLog.d("RoamSetting", 2, "state_newValue=" + this.jdField_c_of_type_Boolean + " setRoamSettingNewValue, path=" + paramString + " value=" + paramInteger + " uploadingCount=" + this.jdField_b_of_type_Int);
      }
      a();
      return;
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\utils\RoamSettingController.class
