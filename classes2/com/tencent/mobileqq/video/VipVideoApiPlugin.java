  ...
  extends WebViewPlugin
{
  ...
  public VipVideoApiPlugin()
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqEmosmClient$onRemoteRespObserver = new wfq(this);
  ...
  protected boolean handleJsRequest(JsBridgeListener paramJsBridgeListener, String paramString1, String paramString2, String paramString3, String... paramVarArgs)
  {
    ...
    callJs(this.d, new String[] { String.valueOf(4) });
    return true;
  }
  ...
  public void onActivityResult(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    if ((paramByte == 100) && (!TextUtils.isEmpty(this.d))) {
      callJs(this.d, new String[] { String.valueOf(paramInt) });
    }
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\video\VipVideoApiPlugin.class
