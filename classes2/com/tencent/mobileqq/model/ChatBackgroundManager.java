  ...
  implements Manager
{
  ...
  public static final String b = "chatbg_intent_frinedUin";
  ...
  public static final String f = "userChatbgInfo";
  ...
  DownloadListener jdField_a_of_type_ComTencentMobileqqVipDownloadListener = new tem(this, "param_WIFIFontDownloadFlow", "param_XGFontDownloadFlow");
  ...
  static
  {
    ...
    h = AppConstants.cs + "ChatBgJson.txt";
    jdField_a_of_type_Int = 1;
    jdField_a_of_type_AndroidOsHandler = new teo(BaseApplication.getContext().getMainLooper());
  }
  ...
  public ChatBackgroundManager(QQAppInterface paramQQAppInterface)
  {
    ...
    this.c = paramQQAppInterface.getAccount();
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString, StatisticCollector paramStatisticCollector)
  {
    ...
    localHashMap.put(l, Integer.valueOf(1));
    if (QLog.isColorLevel()) {
      QLog.d("ThemeDownloadTrace", 2, "initCurrChatBgNameForReport is:" + l);
    }
  ...
  public Bundle a(Context paramContext, String paramString1, String paramString2)
  {
    ...
    try
    {
      File localFile = new File(AppConstants.cs + paramString1 + ".jpg");
    ...
    if (paramContext != null)
    {
      ...
      if (paramString != null)
      {
        ...
        if (!"none".equals(paramString)) {
          paramContext = paramString + "&isOldVersion=" + b;
        }
      }
    }
    do
  ...
  public String a(String paramString)
  {
    try
    {
      Object localObject = FileUtils.a(new File(h));
  ...
  public void a(int paramInt, String paramString, long paramLong)
  {
    ...
    ReportController.b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "chatbackground", "BjIDXiazai", 0, paramInt, "0", "0", m + "", String.valueOf(paramLong));
  }
  ...
  public void a(Intent paramIntent)
  {
    ...
    if (paramIntent != null)
    {
      ...
      if (m != 999) {
        ReportController.b(null, "CliOper", "", "", "background", "bkground_replace", m, 0, "0", "0", "", "");
      }
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    jdField_a_of_type_AndroidOsHandler.removeMessages(1);
    l = null;
    paramQQAppInterface.a(new ten(this, paramString, paramQQAppInterface));
  }
  ...
  public void a(ChatBackgroundInfo paramChatBackgroundInfo, String paramString)
  {
    ...
    do
    {
      ...
      paramString = new File(AppConstants.cs + str1 + ".jpg");
  ...
  {
    SharedPreferences localSharedPreferences = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getSharedPreferences("chat_background_path_" + this.c, 0);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\model\ChatBackgroundManager.class
