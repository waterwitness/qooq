...
public class HttpRequestPackage
{
  ...
  {
    if ((paramJSONObject != null) && (paramString1 != null) && (paramString1.length() > 0)) {}
    try
    {
      paramJSONObject = paramJSONObject.getString(paramString1);
      put(paramString1, paramJSONObject, paramString2);
      return;
    }
    catch (JSONException paramJSONObject)
    {
      paramJSONObject = paramJSONObject;
      put(paramString1, null, paramString2);
      return;
    }
    finally
    {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\webview\webso\HttpRequestPackage.class
