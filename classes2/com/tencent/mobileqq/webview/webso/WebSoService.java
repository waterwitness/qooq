  ...
  implements BusinessObserver
{
  ...
  public static final String a = "key_rsp_succeed";
  private static final String b = "WebSoService";
  LruCache jdField_a_of_type_AndroidSupportV4UtilLruCache = new wjz(this, 10);
  ...
  private String a(String paramString1, String paramString2, String paramString3, Uri paramUri, WebSoService.WebSoState paramWebSoState, boolean paramBoolean)
  {
    String str6 = "";
    if (paramUri == null) {
      return "";
    ...
    for (;;)
    {
      ...
      str2 = String.valueOf(BaseApplicationImpl.a().a().getLongAccountUin());
  ...
  {
    ThreadManager.a().post(new wkb(this, paramFile, paramString, paramCallBack, paramUri));
  }
  ...
  private void a(Handler paramHandler, WebSoService.WebSoState paramWebSoState)
  {
    ...
    localBundle.putBoolean("need_local_refresh", paramWebSoState.f);
    ...
    localBundle.putBoolean("is_local_data", paramWebSoState.jdField_e_of_type_Boolean);
    localBundle.putString("wns_proxy_http_data", paramWebSoState.jdField_b_of_type_JavaLangString);
    localBundle.putInt("result_code", paramWebSoState.jdField_c_of_type_Int);
  ...
  private void a(HttpResponsePackage paramHttpResponsePackage, String paramString, Uri paramUri)
  {
    ThreadManager.a().post(new wkg(this, paramHttpResponsePackage, paramUri, paramString));
  }
  
  private void a(WebSoService.WebSoState paramWebSoState)
  {
  ...
  {
    ThreadManager.a().post(new wkf(this, paramString1, paramString2, paramString3, paramUri, paramWebSoState, paramBoolean, paramCallBack));
  }
  ...
  private void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    localWebSoState.jdField_c_of_type_Int = 0;
  ...
  private void a(boolean paramBoolean, Bundle paramBundle, WebSoService.WebSoState paramWebSoState)
  {
    ...
    {
      paramWebSoState.jdField_c_of_type_Int = 10001;
      if (!TextUtils.isEmpty(paramWebSoState.jdField_b_of_type_JavaLangString)) {
    ...
    for (HttpResponsePackage localHttpResponsePackage = new HttpResponsePackage((HttpRsp)localObject1);; localHttpResponsePackage = null)
    {
      if (localObject1 == null)
      {
        paramWebSoState.jdField_c_of_type_Int = 10002;
      ...
      String str1 = localHttpResponsePackage.E;
      ...
      if (i < j)
      {
        ...
        Object localObject3;
        Object localObject4;
        if (str2.contains("cache-offline"))
        {
          localObject3 = str2.split(":")[1].trim();
        ...
        for (;;)
        {
          ...
          break;
          if (str2.contains("etag"))
          {
            localObject4 = str2.split(":")[1].trim();
          ...
          else
          {
            localObject3 = localObject2;
            localObject4 = paramBundle;
            if (str2.contains("template-tag"))
            {
              localObject1 = str2.split(":")[1].trim();
              localObject3 = localObject2;
              localObject4 = paramBundle;
            }
          }
      ...
      if ("http".equals(localObject2))
      {
        QLog.i("WebSoService", 1, "now 503, so start reLoadUrl");
        paramWebSoState.jdField_c_of_type_Int = 10503;
        paramWebSoState.jdField_c_of_type_Boolean = false;
      ...
      if ("true".equals(localObject2))
      {
        ...
        {
          a(localHttpResponsePackage, paramBundle, localUri);
          paramWebSoState.jdField_b_of_type_JavaLangString = str1;
          paramWebSoState.jdField_a_of_type_Boolean = true;
          paramWebSoState.jdField_e_of_type_Boolean = false;
          a(paramWebSoState);
          return;
        }
        a(str1, paramBundle, (String)localObject1, localUri, paramWebSoState, true, new wkc(this, paramWebSoState));
        return;
      }
      if ("store".equals(localObject2))
      {
        if (TextUtils.isEmpty((CharSequence)localObject1))
        {
          a(localHttpResponsePackage, paramBundle, localUri);
        ...
        a(str1, paramBundle, (String)localObject1, localUri, paramWebSoState, true, new wkd(this, paramWebSoState));
        return;
      }
      if ((localObject2 == null) || ("false".equals(localObject2)))
      {
        if (TextUtils.isEmpty((CharSequence)localObject1))
        {
          paramWebSoState.jdField_b_of_type_JavaLangString = str1;
        ...
        for (;;)
        {
          ...
          return;
          a(str1, paramBundle, (String)localObject1, localUri, paramWebSoState, false, new wke(this, paramWebSoState));
        }
      }
      WebSoUtils.a(localUri);
      paramWebSoState.jdField_b_of_type_JavaLangString = str1;
  ...
  public String a(String paramString, Handler paramHandler)
  {
    ...
    for (;;)
    {
      ...
      if (localWebSoState.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicInteger.get() == 1)
      {
        ...
        {
          localWebSoState.jdField_e_of_type_Boolean = true;
          a(paramHandler, localWebSoState);
        }
        else
        {
          localWebSoState.jdField_b_of_type_JavaLangString = WebSoUtils.c(paramString);
          if (TextUtils.isEmpty(localWebSoState.jdField_b_of_type_JavaLangString)) {
            return null;
          }
          localWebSoState.jdField_e_of_type_Boolean = true;
          localWebSoState.jdField_b_of_type_Boolean = true;
          a(paramHandler, localWebSoState);
        }
      }
      else
  ...
  public boolean a(String paramString, Handler paramHandler)
  {
    ...
    localWebSoState.jdField_e_of_type_Boolean = false;
    ...
    while (WebSoUtils.d(paramString))
    {
      return false;
    ...
    if (localObject3 != null)
    {
      ...
      a((Uri)localObject3, str3, (File)localObject4, localWebSoState, new wka(this, System.currentTimeMillis(), localWebSoState, paramString));
    }
    for (;;)
    {
      ...
      try
      {
        ...
        localObject1 = "";
        localObject2 = SwiftBrowserCookieMonster.a(paramString);
        if (localObject2 != null) {
          localObject1 = ((SwiftBrowserCookieMonster)localObject2).a();
        }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\webview\webso\WebSoService.class
