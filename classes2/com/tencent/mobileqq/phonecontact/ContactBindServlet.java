  ...
  extends MSFServlet
{
  ...
  private static final String jdField_a_of_type_JavaLangString = "PhoneContact.Servlet";
    ...
    if (localCompressedPackage != null)
    {
      ...
      for (paramUniPacket = a(localCompressedPackage.buffer);; paramUniPacket = localCompressedPackage.buffer)
      {
        ...
        if (QLog.isColorLevel()) {
          QLog.d("PhoneContact.Manager", 2, "getRspQueryContacts | compress != null | read from JceInputStream");
        }
  ...
  private void p(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    if (paramFromServiceMsg.isSuccess())
    {
      ...
      if ((localObject != null) && (((RespondHeader)localObject).result == 0))
      {
        ...
        if ((paramFromServiceMsg != null) && (paramFromServiceMsg.size() > 0) && ((getAppRuntime() instanceof QQAppInterface)))
        {
          ...
          if (QLog.isColorLevel()) {
            QLog.d("NewerGuide", 2, "handleGetNewer origin: " + paramFromServiceMsg.size() + ", handled: " + paramIntent.size());
          }
        }
      }
    }
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d("NewerGuide", 2, "handleGetNewerGuideRecommended " + bool);
      }
  ...
  public void onReceive(Intent paramIntent, FromServiceMsg paramFromServiceMsg)
  {
    ...
    } while (!str.equals("account.RequestQueryNewUserRecommendedList"));
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\phonecontact\ContactBindServlet.class
