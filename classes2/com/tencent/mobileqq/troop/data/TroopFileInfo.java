...
{
  public static final long f = 3000L;
  ...
  public TroopFileInfo(group_file_common.FileInfo paramFileInfo)
  {
    this.jdField_a_of_type_JavaLangString = "TroopFileInfo";
    this.jdField_e_of_type_Int = 7;
    this.jdField_a_of_type_JavaUtilMap = new ConcurrentHashMap();
  ...
  public static String a(Context paramContext, long paramLong)
  {
    ...
    if (str != null)
    {
      i1 = TimeFormatterUtils.b(paramLong);
      i2 = str.indexOf(" ");
      paramContext = str;
      if (i2 != -1)
      {
  ...
  private String a(QQAppInterface paramQQAppInterface, long paramLong, boolean paramBoolean)
  {
    ...
    for (int i1 = 1;; i1 = 1)
    {
      if (i1 != 0)
      {
        this.n = ContactUtils.a(paramQQAppInterface, c(), paramLong + "", 1, 0);
        if (this.n.length() > 10) {
          break label264;
        }
        i1 = i4;
    ...
    for (;;)
    {
      if ((i1 != 0) && (SystemClock.uptimeMillis() - this.jdField_e_of_type_Long > 3000L))
      {
        i1 = 1;
        break;
        i1 = 0;
  ...
  public void a(int paramInt)
  {
    ...
    this.l = a(BaseApplicationImpl.a(), this.jdField_b_of_type_Int * 1000L);
  }
  ...
  public void a(TroopFileStatusInfo paramTroopFileStatusInfo, QQAppInterface paramQQAppInterface)
  {
    ...
    try
    {
      this.jdField_b_of_type_Long = Long.parseLong(paramQQAppInterface.a());
      return;
    }
  ...
  public void a(cmd0x383.ApplyGetFileListRspBody.FileInfo paramFileInfo)
  {
    ...
    this.m = a(BaseApplicationImpl.a(), this.jdField_i_of_type_Int * 1000L);
    this.l = a(BaseApplicationImpl.a(), this.jdField_b_of_type_Int * 1000L);
    this.jdField_d_of_type_Boolean = false;
  }
  
  public void a(group_file_common.FileInfo paramFileInfo)
  {
    if (paramFileInfo == null) {
      return;
    }
    this.jdField_b_of_type_Boolean = false;
    this.jdField_b_of_type_JavaLangString = paramFileInfo.str_file_id.get();
    this.jdField_c_of_type_JavaLangString = paramFileInfo.str_file_name.get();
    this.jdField_a_of_type_Long = paramFileInfo.uint64_file_size.get();
    this.jdField_a_of_type_Int = paramFileInfo.uint32_bus_id.get();
    this.jdField_b_of_type_Long = paramFileInfo.uint64_uploader_uin.get();
    this.jdField_c_of_type_Long = paramFileInfo.uint64_uploaded_size.get();
    this.jdField_b_of_type_Int = paramFileInfo.uint32_upload_time.get();
    this.jdField_c_of_type_Int = paramFileInfo.uint32_dead_time.get();
    this.jdField_i_of_type_Int = paramFileInfo.uint32_modify_time.get();
    ...
    this.jdField_e_of_type_JavaLangString = paramFileInfo.str_uploader_name.get();
    this.jdField_d_of_type_JavaLangString = new String(paramFileInfo.bytes_sha.get().toByteArray());
    this.jdField_f_of_type_JavaLangString = paramFileInfo.str_parent_folder_id.get();
    this.l = a(BaseApplicationImpl.a(), this.jdField_b_of_type_Int * 1000L);
    this.m = a(BaseApplicationImpl.a(), this.jdField_i_of_type_Int * 1000L);
    this.jdField_d_of_type_Boolean = false;
  }
  ...
  {
    boolean bool1 = paramQQAppInterface.a().equals(c());
  ...
  public String b()
  {
    return TroopFileUtils.a(this.jdField_d_of_type_Long) + "/" + TroopFileUtils.a(this.jdField_a_of_type_Long);
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    return this.jdField_a_of_type_JavaUtilUUID.equals(((TroopFileInfo)paramObject).jdField_a_of_type_JavaUtilUUID);
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\data\TroopFileInfo.class
