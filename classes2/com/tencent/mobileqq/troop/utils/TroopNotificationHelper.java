...
public class TroopNotificationHelper
{
  ...
  public static TroopNotificationCache a(TroopNotificationHelper.FeedItem paramFeedItem, String paramString, int paramInt1, int paramInt2, long paramLong)
  {
    ...
    {
      if (paramFeedItem.jdField_c_of_type_Int == 1)
      {
        ...
        {
          str2 = new SimpleDateFormat("yyyy年M月d日").format(new Date(paramFeedItem.jdField_e_of_type_Int * 1000L));
          str2 = str2 + " 群公告";
        }
        ...
        localTroopNotificationCache.time = paramFeedItem.jdField_e_of_type_Int;
      ...
      if (paramFeedItem.jdField_c_of_type_Int == 2)
      {
        ...
        paramString.time = paramFeedItem.jdField_e_of_type_Int;
        ...
        paramString.src = paramFeedItem.f;
  ...
  public static TroopNotificationHelper.FeedItem a(DataInputStream paramDataInputStream, boolean paramBoolean)
  {
    ...
    if (paramDataInputStream != null)
    {
      ...
      paramDataInputStream.jdField_e_of_type_Int = n;
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((k == 5) || (k == 19))
        {
          ...
          ((TroopNotificationHelper.FeedItem)localObject5).jdField_c_of_type_Int = 1;
          if (localGroupFeedsMessage.opt_uint32_ctl_flag.has()) {
            i = localGroupFeedsMessage.opt_uint32_ctl_flag.get();
          }
          ((TroopNotificationHelper.FeedItem)localObject5).g = i;
          return (TroopNotificationHelper.FeedItem)localObject5;
        }
        if (k == 22)
        {
      ...
      ((TroopNotificationHelper.FeedItem)localObject3).jdField_c_of_type_Int = 2;
      ((TroopNotificationHelper.FeedItem)localObject3).jdField_b_of_type_Long = l1;
      ((TroopNotificationHelper.FeedItem)localObject3).f = i;
      i = j;
      if (localGroupFeedsMessage.opt_uint32_ctl_flag.has()) {
        i = localGroupFeedsMessage.opt_uint32_ctl_flag.get();
      }
      ((TroopNotificationHelper.FeedItem)localObject3).g = i;
      return (TroopNotificationHelper.FeedItem)localObject3;
      return null;
      label718:
      label724:
      label734:
  ...
  public static void a(QQAppInterface paramQQAppInterface, int paramInt1, long paramLong1, long paramLong2, long paramLong3, String paramString, int paramInt2, byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ...
      {
        paramArrayOfByte = null;
        if ((((TroopNotificationHelper.FeedItem)localObject).jdField_c_of_type_Int == 1) || (((TroopNotificationHelper.FeedItem)localObject).jdField_c_of_type_Int == 2)) {
        ...
        localQQMessageFacade.a().a(paramQQAppInterface, String.valueOf(paramLong1), String.valueOf(paramLong2), localArrayList, 23, paramInt1, ((TroopNotificationHelper.FeedItem)localObject).g);
      }
    }
    catch (Exception paramQQAppInterface)
    {
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    BaseApplicationImpl.getContext().getSharedPreferences("new_notify_" + paramQQAppInterface.a(), 0).edit().remove(paramString).commit();
  }
  ...
  public static boolean a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    return BaseApplicationImpl.getContext().getSharedPreferences("new_notify_" + paramQQAppInterface.a(), 0).getBoolean(paramString, false);
  }
  ...
  public static void b(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    BaseApplicationImpl.getContext().getSharedPreferences("new_notify_" + paramQQAppInterface.a(), 0).edit().putBoolean(paramString, true).commit();
  ...
  public static void c(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    ((TroopManager)localObject1).c(paramString);
    if (!TroopAssistantManager.a().a(paramQQAppInterface, paramString))
    {
  ...
  public static void d(QQAppInterface paramQQAppInterface, String paramString)
  {
    if ((jdField_a_of_type_JavaUtilHashMap != null) && (jdField_a_of_type_JavaUtilHashMap.containsKey(paramString)))
    {
      ...
      ((TroopHandler)paramQQAppInterface.a(20)).a(paramQQAppInterface, paramString, arrayOfByte);
      return;
    }
    try
    {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\utils\TroopNotificationHelper.class
