  ...
  implements Manager
{
  ...
  public static final String a = ".troop.troop_topic.TroopTopicMgr";
  public static final int b = 5;
  public static final String b = "CgiPublishableTime";
  public static final int c = 100;
  public static String c;
  public static final int d = 1;
  public static final String d = "MQUpdateSvc_com_qq_buluo.web.sbar_post_extinfo";
  public static final int e = 2;
  public static final String e = "MQUpdateSvc_com_qq_buluo.web.sbar_comment";
  public static final int f = 3;
  public static final String f = "MQUpdateSvc_com_qq_buluo.web.sbar_like";
  protected Handler a;
  ...
  static
  {
    ...
    jdField_c_of_type_JavaLangString = "http://buluo.qq.com/cgi-bin/sbar/post/publishable";
  }
  ...
  public TroopTopicMgr(QQAppInterface paramQQAppInterface)
  {
    ...
    b(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getSharedPreferences(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a() + "_TroopTopic", 0).getString("ShareCommentWhiteList", "{}"));
  }
  ...
  {
    MessageRecord localMessageRecord = MessageRecordFactory.a(64487);
    ...
    localMessageRecord.msgtype = 64487;
    ...
    for (;;)
    {
      ...
      if (i < ((AbsShareMsg)localObject).getItemCount())
      {
        ...
        if ((localAbsStructMsgElement instanceof StructMsgItemLayout2))
        {
          ...
          {
            localJSONObject.put("cover", ((StructMsgItemCover)localAbsStructMsgElement).o);
            break label299;
          }
  ...
  {
    return this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a() + "_" + paramString + "_" + paramLong;
  }
  ...
  public static void a(AppInterface paramAppInterface, MessageForTroopTopic paramMessageForTroopTopic)
  {
    ...
    try
    {
      ...
      paramMessageForTroopTopic.setObserver(new vrz());
  ...
  public static void a(QQAppInterface paramQQAppInterface, long paramLong, String paramString1, String paramString2, MessageRecord paramMessageRecord, String paramString3, ArrayList paramArrayList)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        localJSONObject.put("version", "6.5.5.2880");
        if (QLog.isColorLevel()) {
        ...
        paramString1.setObserver(new vrx(paramQQAppInterface, paramMessageRecord));
  ...
  public static void a(QQAppInterface paramQQAppInterface, MessageRecord paramMessageRecord)
  {
    ...
    localQQMessageFacade.a(paramMessageRecord, paramQQAppInterface.a());
  ...
  public static void a(MessageForPic paramMessageForPic, long paramLong, int paramInt1, int paramInt2, WeakReference paramWeakReference, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        localPicReq.a(new vrs(paramWeakReference, paramLong, paramInt1, paramInt2, paramMessageForPic.size, str));
        PicBusiManager.a(localPicReq, (QQAppInterface)BaseApplicationImpl.a.getAppRuntime(paramString));
        return;
      }
  ...
  private void a(MessageForTroopTopic paramMessageForTroopTopic, TroopTopicDetailInfo paramTroopTopicDetailInfo)
  {
    ...
    try
    {
      ...
      ((NewIntent)localObject).setObserver(new vrq(this, paramTroopTopicDetailInfo, paramMessageForTroopTopic));
    ...
    for (;;)
    {
      try
      {
        if ((paramMessageRecord instanceof MessageForTroopTopic))
        {
          ...
          localWebSsoRequestBody.data.set(localJSONObject.toString());
          ProtoUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new vsa(this, paramTroopTopicDetailInfo, paramMessageRecord), localWebSsoRequestBody.toByteArray(), "MQUpdateSvc_com_qq_buluo.web.sbar_post_extinfo");
          return;
        }
      }
      catch (JSONException paramMessageRecord)
  ...
  public static final boolean a(QQAppInterface paramQQAppInterface, SessionInfo paramSessionInfo, Editable paramEditable, MessageRecord paramMessageRecord, ChatActivityFacade.SendMsgParams paramSendMsgParams)
  {
    ...
    if (paramMessageRecord != null)
    {
      if ((paramMessageRecord instanceof MessageForTroopTopic))
      {
        ...
        paramSessionInfo = a(paramQQAppInterface, paramSessionInfo.a, paramSendMsgParams, paramEditable, 1);
    ...
    for (;;)
    {
      paramSessionInfo = a(paramQQAppInterface, paramSessionInfo.a, paramSendMsgParams, str, 3);
      a(paramQQAppInterface, paramSessionInfo);
      ((TroopTopicMgr)paramQQAppInterface.getManager(97)).a(paramSessionInfo, paramMessageRecord.shmsgseq, str, (String)localObject2, localArrayList, Long.parseLong(paramMessageRecord.frienduin) + 10000000000L, paramEditable, (String)localObject1, 1, new vry());
      if (QLog.isColorLevel()) {
      ...
      if ((paramMessageRecord instanceof MessageForReplyText))
      {
        ...
        if ((paramMessageRecord instanceof MessageForReplyText))
        {
          ...
          if (((MessageForReplyText)localObject1).mGroupPostElemInfo != null)
          {
            localObject2 = new ArrayList();
            paramEditable = AtTroopMemberSpan.a(paramEditable, (ArrayList)localObject2);
            paramSessionInfo = a(paramQQAppInterface, paramSessionInfo.a, paramSendMsgParams, paramEditable, 2);
            a(paramQQAppInterface, paramSessionInfo);
  ...
  public TroopTopicDetailInfo a(MessageForTroopTopic paramMessageForTroopTopic)
  {
    ...
    if ((localObject != null) && (((TroopTopicDetailInfo)localObject).detailInfoData != null))
    {
      ...
      if (((TroopTopicDetailInfo)localObject).detailStructMsg != null) {
        return (TroopTopicDetailInfo)localObject;
      }
      if (QLog.isColorLevel()) {
        QLog.i(".troop.troop_topic.TroopTopicMgr", 2, "getTroopTopicDetailInfo parse xml error");
      }
    }
    ThreadManager.a(new vrp(this, (TroopTopicDetailInfo)localObject, paramMessageForTroopTopic), 8, null, false);
    return null;
  }
  ...
  public void a(BaseChatPie paramBaseChatPie, String paramString1, ChatMessage paramChatMessage, String paramString2, int paramInt)
  {
    ...
    for (paramBaseChatPie = paramBaseChatPie.getSkey(str);; paramBaseChatPie = null)
    {
      ...
      localBundle.putString("version", DeviceInfoUtil.c());
      ...
      new HttpWebCgiAsyncTask2(jdField_c_of_type_JavaLangString, "POST", new vro(this, localTroopChatPie, paramString1, paramChatMessage, paramString2, paramInt), 1000, null).a(localHashMap);
      return;
    }
  }
  ...
  public void a(TroopChatPie paramTroopChatPie, String paramString)
  {
    ...
    paramTroopChatPie.a.overridePendingTransition(2130968592, 2130968589);
  }
  ...
  public void a(ChatMessage paramChatMessage, int paramInt, TroopTopicMgr.DoLikeCallback paramDoLikeCallback)
  {
    ...
    try
    {
      ...
      localWebSsoRequestBody.data.set(localJSONObject.toString());
      ProtoUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new vrv(this, paramDoLikeCallback), localWebSsoRequestBody.toByteArray(), "MQUpdateSvc_com_qq_buluo.web.sbar_like");
      return;
    }
    catch (JSONException paramChatMessage)
    {
  ...
  public void a(MessageForTroopTopic paramMessageForTroopTopic)
  {
    ...
    for (;;)
    {
      return;
      Vector localVector;
      if (this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(paramMessageForTroopTopic.frienduin)) {
        localVector = (Vector)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramMessageForTroopTopic.frienduin);
      }
      while (!localVector.contains(paramMessageForTroopTopic))
      {
        ...
        this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.put(paramMessageForTroopTopic.frienduin, localVector);
      }
    }
  }
  ...
  public void a(MessageRecord paramMessageRecord, long paramLong1, String paramString1, String paramString2, ArrayList paramArrayList, long paramLong2, String paramString3, String paramString4, int paramInt, TroopTopicMgr.WriteCommentCallback paramWriteCommentCallback)
  {
    ...
    try
    {
      ...
      localJSONObject.put("version", "6.5.5.2880");
      localWebSsoRequestBody.data.set(localJSONObject.toString());
      ProtoUtils.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, new vru(this, paramWriteCommentCallback, paramMessageRecord), localWebSsoRequestBody.toByteArray(), "MQUpdateSvc_com_qq_buluo.web.sbar_comment");
      return;
    }
    catch (JSONException paramMessageRecord)
    {
  ...
  public void a(MessageRecord paramMessageRecord, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      ThreadManager.a(new vrw(this, paramMessageRecord), 8, null, true);
      return;
      bool = false;
      continue;
      bool = false;
  ...
  {
    if (TextUtils.isEmpty(paramString)) {}
    while (!this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.containsKey(paramString)) {
      return;
    }
    Iterator localIterator = ((Vector)this.jdField_c_of_type_JavaUtilConcurrentConcurrentHashMap.get(paramString)).iterator();
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    if (!TextUtils.isEmpty(paramString))
    {
      ...
      localObject = AppConstants.by + "troopsharecommentwhitelist.tmp";
      paramString = new DownloadTask(paramString, new File((String)localObject));
      paramString.A = 3;
      Bundle localBundle = new Bundle();
      localBundle.putString("filePath", (String)localObject);
      ((DownloaderFactory)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getManager(46)).a(1).a(paramString, new vrt(this, paramInt), localBundle);
    }
  }
  
  public void a(String paramString, long paramLong1, long paramLong2)
  {
    ThreadManager.a(new vsd(this, paramString, paramLong1, paramLong2), 8, null, false);
  }
  ...
  public void b(String paramString)
  {
    ...
    try
    {
      ...
      this.g = paramString.optInt("version");
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\utils\TroopTopicMgr.class
