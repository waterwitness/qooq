...
public class TroopBusinessUtil$TroopBusinessMessage
{
  ...
  public static TroopBusinessMessage a(im_msg_body.GroupBusinessMsg paramGroupBusinessMsg)
  {
    ...
    {
      QLog.e(TroopBusinessUtil.j, 2, "the color string cannot parse to color. " + paramGroupBusinessMsg.getMessage());
    }
    return localTroopBusinessMessage;
  }
}
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\utils\TroopBusinessUtil$TroopBusinessMessage.class
