  ...
  protected JSONObject a(HashMap... paramVarArgs)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        paramVarArgs = new JSONObject(HttpUtil.a(paramVarArgs, this.k, this.l, (Bundle)localObject, localBundle));
      }
      catch (IOException paramVarArgs)
      {
        QLog.w(a, 1, paramVarArgs.getMessage(), paramVarArgs);
        paramVarArgs = null;
        continue;
      }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\utils\HttpWebCgiAsyncTask2.class
