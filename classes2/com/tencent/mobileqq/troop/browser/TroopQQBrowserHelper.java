...
{
  public static final String a = "http://admin.qun.qq.com/mcreatev3/index.html?_bid=206&ver=%s&clientversion=%s&fromlocation=%s&_wv=2097152";
  public static final String b = "&initgrouptype=%s";
  public static final String c = "1";
  
  public TroopQQBrowserHelper()
  {
  ...
  {
    String str = String.format("http://admin.qun.qq.com/mcreatev3/index.html?_bid=206&ver=%s&clientversion=%s&fromlocation=%s&_wv=2097152", new Object[] { "1", "6.5.5", Integer.valueOf(0) });
  ...
  public static void a(Context paramContext, int paramInt)
  {
    ...
    for (String str = String.format("http://admin.qun.qq.com/mcreatev3/index.html?_bid=206&ver=%s&clientversion=%s&fromlocation=%s&_wv=2097152", new Object[] { "1", "6.5.5", Integer.valueOf(1) });; str = String.format("http://admin.qun.qq.com/mcreatev3/index.html?_bid=206&ver=%s&clientversion=%s&fromlocation=%s&_wv=2097152", new Object[] { "1", "6.5.5", Integer.valueOf(0) }))
    {
      Intent localIntent = new Intent(paramContext, QQBrowserActivity.class);
      localIntent.putExtra("url", str);
      localIntent.putExtra("isShowAd", false);
  ...
  {
    Object localObject = String.format("http://admin.qun.qq.com/mcreatev3/index.html?_bid=206&ver=%s&clientversion=%s&fromlocation=%s&_wv=2097152", new Object[] { "1", "6.5.5", Integer.valueOf(0) });
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\browser\TroopQQBrowserHelper.class
