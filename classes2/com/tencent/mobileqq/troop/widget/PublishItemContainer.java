...
{
  private static final int jdField_b_of_type_Int = 9;
  ...
  public PublishItemContainer(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(getContext()).inflate(2130903701, null);
  ...
  public MediaInfo a()
  {
    return this.jdField_a_of_type_ComTencentMobileqqTroopDataMediaInfo;
  }
  ...
  public String a()
  {
    ...
    return ((AudioInfo)this.jdField_a_of_type_ComTencentMobileqqTroopDataMediaInfo).path;
  }
  ...
  {
    Object localObject = paramView.findViewById(2131299768);
    URLImageView localURLImageView = (URLImageView)paramView.findViewById(2131299766);
    localURLImageView.setImageResource(2130842471);
  ...
  protected void a(View paramView, String paramString)
  {
    ...
    for (Object localObject1 = null;; localObject1 = localObject2)
    {
      try
      {
        ...
        localObject2 = URLDrawable.getDrawable(((File)localObject2).toURL(), localLayoutParams.width, localLayoutParams.height, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable, this.jdField_a_of_type_AndroidGraphicsDrawableDrawable);
  ...
  public boolean a(String paramString)
  {
    ...
    if (this.jdField_a_of_type_JavaUtilArrayList != null)
    {
      ...
      if (!TextUtils.isEmpty(paramString))
      {
        ...
        View localView = LayoutInflater.from(getContext()).inflate(2130903701, null);
        this.jdField_a_of_type_AndroidWidgetLinearLayout.addView(localView);
    ...
    if (paramArrayList != null)
    {
      ...
      for (;;)
      {
        ...
        if (j < k)
        {
          ...
          while (i < k - j)
          {
            localObject = paramArrayList.inflate(2130903701, null);
  ...
  public void b()
  {
    ...
    do
    {
      ...
      localAudioInfo.mAudioIcon.setImageResource(2130843047);
    ...
    Object localObject = (AnimationDrawable)BaseApplicationImpl.a().getResources().getDrawable(2130968719);
  ...
  public void onClick(View paramView)
  {
    ...
    do
    {
      ...
      if (paramView.getTag() != null)
      {
        ...
        paramView.putExtra("back_btn_text", this.jdField_a_of_type_AndroidAppActivity.getString(2131364963));
  ...
  public void setItemEnable(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_Int == 2)
    {
      ...
      View localView1 = localView2.findViewById(2131299756);
      localView2 = localView2.findViewById(2131299758);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\widget\PublishItemContainer.class
