  ...
  extends AnimationTextView
{
  ...
  private Field b;
  private Field jdField_c_of_type_JavaLangReflectField;
  ...
  private void a()
  {
    try
    {
      ...
      this.jdField_c_of_type_JavaLangReflectField = TextView.class.getDeclaredField("LINES");
      this.jdField_a_of_type_JavaLangReflectField.setAccessible(true);
      this.b.setAccessible(true);
      this.jdField_c_of_type_JavaLangReflectField.setAccessible(true);
      return;
    }
  ...
  public int getMaxLines()
  {
    ...
    {
      return i;
      if ((this.jdField_c_of_type_Boolean) && ((this.jdField_a_of_type_JavaLangReflectField == null) || (this.b == null) || (this.jdField_c_of_type_JavaLangReflectField == null))) {
        a();
      }
    ...
    try
    {
      ...
      int k = this.jdField_c_of_type_JavaLangReflectField.getInt(this);
      if (j == k) {}
      for (;;)
      {
        return i;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\widget\LimitTextView.class
