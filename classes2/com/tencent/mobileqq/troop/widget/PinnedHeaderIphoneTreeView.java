  ...
  extends PinnedHeaderExpandableListView
{
  ...
  public PinnedHeaderIphoneTreeView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidViewView$OnTouchListener = new vtf(this);
    c();
  }
      ...
      default: 
        ...
        else
        {
          ...
          if ((this.jdField_b_of_type_AndroidViewView == null) || (this.jdField_d_of_type_Boolean) || (this.jdField_b_of_type_Int != i))
          {
            ...
            this.jdField_b_of_type_AndroidViewView.setSelected(((View)localObject5).isSelected());
          ...
          if (b(l) == 0) {
            this.jdField_c_of_type_AndroidViewView = ((View)localObject5);
          }
          a(this.jdField_b_of_type_AndroidViewView, i, 0, ((View)localObject5).getWidth());
      ...
      try
      {
        for (;;)
        {
          ...
          if (this.jdField_b_of_type_AndroidViewView != null)
          {
            ...
            {
              localObject3 = a();
              ((Drawable)localObject3).setBounds(new Rect(((Drawable)localObject3).getBounds().left, this.jdField_b_of_type_AndroidViewView.getTop(), ((Drawable)localObject3).getBounds().right, this.jdField_b_of_type_AndroidViewView.getBottom()));
              a().draw(paramCanvas);
            }
            ...
            if (this.jdField_b_of_type_AndroidGraphicsDrawableDrawable != null)
            {
              ...
              k = 0;
              ((Drawable)localObject5).setBounds(j, m, k, this.jdField_b_of_type_AndroidViewView.getBottom());
              this.jdField_b_of_type_AndroidGraphicsDrawableDrawable.draw(paramCanvas);
            }
            if (localObject1 != null)
            {
              ((Drawable)localObject1).setBounds(this.jdField_b_of_type_AndroidViewView.getLeft(), this.jdField_b_of_type_AndroidViewView.getBottom() - x(), this.jdField_b_of_type_AndroidViewView.getRight(), this.jdField_b_of_type_AndroidViewView.getBottom());
              paramCanvas.clipRect(this.jdField_b_of_type_AndroidViewView.getLeft(), this.jdField_b_of_type_AndroidViewView.getBottom() - x() + i, this.jdField_b_of_type_AndroidViewView.getRight(), this.jdField_b_of_type_AndroidViewView.getBottom() + i);
            }
            paramCanvas.translate(0.0F, -i);
          }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\widget\PinnedHeaderIphoneTreeView.class
