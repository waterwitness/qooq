  ...
  implements AdapterView.OnItemLongClickListener
{
  ...
  public AvatarWallView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.jdField_a_of_type_AndroidViewAnimationAnimation$AnimationListener = new vsp(this);
  ...
  protected void a(int paramInt1, int paramInt2)
  {
    ...
    if (i1 < i4)
    {
      ...
      View localView;
      if (i3 > 0) {
        if (this.o / this.f == (this.o + 1) / this.f)
        {
          paramInt1 = 0;
          paramInt2 = -1;
          this.o += 1;
  ...
  protected void a(Bitmap paramBitmap)
  {
    ...
    for (this.jdField_a_of_type_AndroidViewWindowManager$LayoutParams.width = i1;; this.jdField_a_of_type_AndroidViewWindowManager$LayoutParams.width = i2)
    {
      ...
      localImageView.setBackgroundResource(2130839373);
  ...
  protected void c()
  {
    if (this.j != this.n)
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTroopWidgetAvatarWallAdapter.f();
    }
    for (;;)
    {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\widget\AvatarWallView.class
