  ...
  implements View.OnClickListener
{
  ...
  public TroopBarImagePreviewAdapter(Context paramContext, ExtendGridView paramExtendGridView)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130842111);
    this.jdField_a_of_type_JavaLangCharSequence = BaseApplication.getContext().getText(2131364794);
    this.b = BaseApplication.getContext().getResources().getText(2131366954);
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      localView = this.jdField_a_of_type_AndroidViewLayoutInflater.inflate(2130903701, null);
      paramViewGroup = new vhk();
      paramViewGroup.jdField_a_of_type_ComTencentImageURLImageView = ((URLImageView)localView.findViewById(2131299766));
      paramViewGroup.b = ((ImageView)localView.findViewById(2131299768));
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)localView.findViewById(2131299767));
      ...
      paramViewGroup.jdField_a_of_type_ComTencentImageURLImageView.setImageResource(2130839418);
    ...
    do
    {
      ...
      return localView;
      paramViewGroup = (vhk)paramView.getTag();
      localView = paramView;
      break;
      paramView.width = i;
      paramView.height = i;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\activity\TroopBarImagePreviewAdapter.class
