  ...
  extends BaseAdapter
{
  ...
  public RecommendTroopItem a()
  {
    int i = getCount();
    if (i > 0) {
      return (RecommendTroopItem)this.jdField_a_of_type_JavaUtilList.get(i - 1);
    }
    return null;
  }
  ...
  protected void a(View paramView, RecommendTroopItem paramRecommendTroopItem)
  {
    ...
    if (TextUtils.isEmpty(paramRecommendTroopItem.recommendReason))
    {
      ...
      ((NearbyTroops.CustomViewHolder)localObject).d.setImageDrawable(FaceDrawable.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 4, paramRecommendTroopItem.uin));
    }
    for (;;)
    {
      paramView.setOnClickListener(new vft(this, localGroupInfo));
      ...
      ((NearbyTroops.CustomViewHolder)localObject).i.setOnClickListener(new vfu(this, paramRecommendTroopItem));
      return;
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqTroopUtilsNonMainAppListViewFaceLoader != null)
      {
        ...
        ((NearbyTroops.CustomViewHolder)localObject).d.setImageBitmap(localBitmap);
      }
    }
  }
  ...
  public void b(String paramString)
  {
    ...
    RecommendTroopManagerImp.a(this.jdField_a_of_type_ComTencentCommonAppAppInterface, 2, paramString, new vfv(this));
    a(paramString);
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface != null)
    {
      ...
      localRecommendTroopManagerImp.b(paramString);
    }
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    localView.setOnClickListener(new vfs(this));
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\activity\RecommendTroopAdapter.class
