  ...
  extends PublicCommentWindow
{
  ...
  protected void a(String paramString)
  {
    ...
    try
    {
      ...
      localJSONObject.put("bid", Long.parseLong(this.e));
      ...
      paramString.setObserver(new vhj(this));
      this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getAppRuntime().startServlet(paramString);
      return;
    }
    catch (Exception paramString)
    {
      QQToast.a(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity, 1, 2131364761, 0).b(this.jdField_a_of_type_ComTencentMobileqqAppBaseActivity.getTitleBarHeight());
      this.c = false;
    }
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\activity\TroopBarCommentWindow.class
