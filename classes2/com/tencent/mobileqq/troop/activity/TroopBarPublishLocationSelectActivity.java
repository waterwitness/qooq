  ...
  implements View.OnClickListener, HttpWebCgiAsyncTask.Callback, AdapterView.OnItemClickListener
{
  ...
  public static final String a = "Transparent_Bg";
  public static final int b = 1;
  public static final String b = "current_location_list";
  public static final String c = "key_current_poi";
  public static final String d = "key_selected_poi";
  public static final String e = "refresh_all_poi";
  public static final String f = "isend";
  public long a;
  ...
  public TroopBarPublishLocationSelectActivity()
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new vhz(this);
  }
  ...
  protected void a()
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setOverScrollListener(new vhw(this));
  }
  ...
  {
    TextView localTextView = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131298776);
    if (paramBoolean)
    {
  ...
  protected void b()
  {
    this.jdField_a_of_type_ComTencentMobileqqAppSosoSosoInterface$OnLocationListener = new via(this, 0, true, true, 0L, false, false, "QLifeCommentActivity");
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetXListView.setDivider(getResources().getDrawable(2130838649));
    ...
    setTitle(2131364790);
    this.rightViewImg.setImageResource(2130839419);
    ...
    for (;;)
    {
      this.jdField_a_of_type_AndroidViewView = LayoutInflater.from(this).inflate(2130903499, null);
      a();
      paramBundle = (ImageView)this.jdField_a_of_type_AndroidViewView.findViewById(2131297449);
      TextView localTextView1 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131298776);
      TextView localTextView2 = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131298777);
      ...
      this.jdField_a_of_type_ComTencentWidgetXListView.setOnScrollListener(new vhv(this));
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\activity\TroopBarPublishLocationSelectActivity.class
