...
public class TroopBarReplyActivity$AudioUploadTask
  implements Runnable
{
  protected int a;
  protected Handler a;
  ...
  public TroopBarReplyActivity$AudioUploadTask(TroopBarReplyActivity paramTroopBarReplyActivity, BaseActivity paramBaseActivity, Handler paramHandler, String paramString, AudioInfo paramAudioInfo)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (((JSONObject)localObject1).optInt("retcode", -1) == 0)
        {
          ...
          {
            if (this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopBarReplyActivity.jdField_a_of_type_ComTencentMobileqqTroopDataAudioInfo != null) {
              this.jdField_a_of_type_ComTencentMobileqqTroopActivityTroopBarReplyActivity.jdField_a_of_type_ComTencentMobileqqTroopDataAudioInfo.url = ((JSONObject)localObject1).optString("url");
            }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troop\activity\TroopBarReplyActivity$AudioUploadTask.class
