  ...
  extends PttComponentProcessor
{
  ...
  public void a()
  {
    if ((this.jdField_a_of_type_Long > 0L) && (this.e > 0) && (this.d > 0)) {
      PttInfoCollector.a(this.jdField_a_of_type_Long, this.e, this.jdField_b_of_type_Long, this.d + 2);
    }
    Release(this.jdField_c_of_type_Int);
  ...
  public void a(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    this.jdField_c_of_type_Int = Create(this.jdField_a_of_type_JavaLangString);
    ...
    for (;;)
    {
      Init(this.jdField_c_of_type_Int, paramInt1, 1, paramInt2, paramInt3);
      this.jdField_a_of_type_ArrayOfByte = new byte[this.jdField_b_of_type_Int];
      this.jdField_b_of_type_ArrayOfByte = new byte[this.jdField_b_of_type_Int * 10];
      ...
      {
        QLog.e("QQVoiceChanger", 1, "Init Error type=" + this.d);
        paramInt3 = 0;
        paramInt2 = 0;
      }
    }
  ...
  public int read(byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    paramInt2 = doChange(this.jdField_c_of_type_Int, this.jdField_a_of_type_ArrayOfByte, this.jdField_b_of_type_ArrayOfByte);
    if (QLog.isColorLevel()) {
      QLog.d("QQVoiceChanger", 2, "change voice type=" + this.d + " changedSize=" + paramInt2);
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\voicechange\VoiceChange.class
