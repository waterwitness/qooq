  ...
  implements BaseConstants.NetType
{
  ...
  private static PreDownloadParams.Params[] jdField_a_of_type_ArrayOfComTencentMobileqqPttPreopPreDownloadParams$Params;
  ...
  private static String a(QQAppInterface paramQQAppInterface)
  {
    ...
    String str = BaseApplicationImpl.a.getSharedPreferences("RecordParams_" + paramQQAppInterface, 0).getString("PreDownloadCfg", null);
  ...
  public static String a(QQAppInterface paramQQAppInterface, int paramInt, PreDownloadParams.Params paramParams)
  {
    ...
    paramQQAppInterface = paramQQAppInterface.a();
    String str = BaseApplicationImpl.a.getSharedPreferences("RecordParams_" + paramQQAppInterface, 0).getString("PTTPreDownloadParams_" + paramInt, null);
  ...
  public static void a(QQAppInterface paramQQAppInterface, PreDownloadParams.Params paramParams, int paramInt)
  {
    ...
    paramQQAppInterface = paramQQAppInterface.a();
    paramParams = BaseApplicationImpl.a.getSharedPreferences("RecordParams_" + paramQQAppInterface, 0);
  ...
  public static void a(QQAppInterface paramQQAppInterface, String paramString)
  {
    ...
    SharedPreferences.Editor localEditor = BaseApplicationImpl.a.getSharedPreferences("RecordParams_" + str, 0).edit().putString("PreDownloadCfg", paramString);
    if (QLog.isColorLevel()) {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\ptt\preop\PreDownloadParams.class
