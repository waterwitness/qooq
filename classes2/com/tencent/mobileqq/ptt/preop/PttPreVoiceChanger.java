  ...
  implements IPttProcessorListener
{
  ...
  public void a()
  {
    ...
    catch (Exception localException)
    {
      ...
      QLog.e(PttPreSendManager.jdField_a_of_type_JavaLangString, 2, "PttPreVoiceChanger.close error");
    }
  }
  ...
  public boolean a(byte[] paramArrayOfByte, int paramInt)
  {
    ...
    catch (Exception paramArrayOfByte)
    {
      ...
      if (QLog.isDevelopLevel()) {
        QLog.e(PttPreSendManager.jdField_a_of_type_JavaLangString, 4, "handleSliceDataIfNeed exception !!!");
      }
    }
    return false;
  }
  ...
  public void b()
  {
    if (QLog.isColorLevel()) {
      QLog.d(PttPreSendManager.jdField_a_of_type_JavaLangString, 2, "delete tempfile, path : " + this.jdField_a_of_type_JavaLangString);
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\ptt\preop\PttPreVoiceChanger.class
