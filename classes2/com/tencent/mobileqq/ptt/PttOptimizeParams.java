...
public class PttOptimizeParams
{
  ...
  private static final String jdField_a_of_type_JavaLangString = "PttOptimizeParams";
  ...
  {
    paramQQAppInterface = BaseApplicationImpl.a.getSharedPreferences("RecordParams_" + paramQQAppInterface.a(), 0).getString("ptt_optimize_cfg_v2", null);
  ...
  {
    BaseApplicationImpl.a.getSharedPreferences("RecordParams_" + paramQQAppInterface.a(), 0).edit().putString("ptt_optimize_cfg_v2", paramString).commit();
    if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      try
      {
        ...
        try
        {
          ...
          {
            if (!paramQQAppInterface.a().endsWith("5")) {
              break label535;
            }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\ptt\PttOptimizeParams.class
