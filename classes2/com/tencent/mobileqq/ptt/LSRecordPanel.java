...
{
  private static final int jdField_a_of_type_Int = -15550475;
  public static final String a = "LsRecord";
  private static final int jdField_b_of_type_Int = -43434;
  ...
  private QQRecorder.RecorderParam a()
  {
    ...
    return new QQRecorder.RecorderParam(RecordParams.f, 8000, 0);
  }
  ...
  private void a(QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    PttBuffer.b(this.jdField_c_of_type_JavaLangString);
    MessageRecord localMessageRecord = ChatActivityFacade.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_c_of_type_JavaLangString, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo, -2, paramRecorderParam.c);
    if (localMessageRecord == null) {
      return;
    }
    ((MessageForPtt)localMessageRecord).c2cViaOffline = true;
    long l = localMessageRecord.uniseq;
    ChatActivityFacade.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_JavaLangString, this.jdField_c_of_type_JavaLangString, l, false, this.j, paramRecorderParam.c, true, 0, 3, true);
    this.jdField_c_of_type_JavaLangString = null;
    BaseChatPie.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.jdField_a_of_type_Int, 8, this.j);
  }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if (!paramBoolean)
    {
      if (this.jdField_b_of_type_Boolean)
      {
        ...
        int m = (int)(getResources().getDisplayMetrics().density * 4.0F);
        localLayoutParams.height -= m;
        localLayoutParams.width -= m;
        int n = localLayoutParams.rightMargin;
        localLayoutParams.rightMargin = (m / 2 + n);
  ...
  {
    if (QLog.isDevelopLevel()) {
      QLog.d("LsRecord", 4, "LS close: " + this.k + " done:" + paramBoolean1);
    }
    this.jdField_a_of_type_AndroidOsHandler.removeMessages(101);
    if ((this.k == 0) || ((!paramBoolean2) && (this.k == 5))) {}
    do
    {
      return;
    ...
    int n = ((RelativeLayout.LayoutParams)localObject).rightMargin;
    ((RelativeLayout.LayoutParams)localObject).rightMargin = (m / 2 + n);
    this.jdField_b_of_type_Boolean = false;
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqPttLSRecordAnimations$TrackInfo != null)
    {
      ...
      m = this.jdField_a_of_type_ComTencentMobileqqPttLSRecordAnimations$TrackInfo.jdField_a_of_type_Int;
      ((GradientDrawable)localObject).setColor(m);
      float f1 = this.jdField_a_of_type_ComTencentMobileqqPttLSRecordAnimations$TrackInfo.jdField_a_of_type_Float;
      this.jdField_a_of_type_AndroidViewAnimationAnimation = null;
      g();
      LSRecordAnimations.ChangeBgAndScaleAnimation localChangeBgAndScaleAnimation = new LSRecordAnimations.ChangeBgAndScaleAnimation(f1, 1.0F, f1, 1.0F, 1, 0.5F, 1, 0.5F, this.jdField_a_of_type_ComTencentMobileqqPttLSRecordAnimations$TrackInfo);
      localChangeBgAndScaleAnimation.a((GradientDrawable)localObject, m, -15550475);
      ...
      localChangeBgAndScaleAnimation.setAnimationListener(new tyd(this));
  ...
  private void b(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      m = this.jdField_b_of_type_ComTencentMobileqqPttLSRecordAnimations$TrackInfo.jdField_a_of_type_Int;
    }
    for (;;)
    {
      LSRecordAnimations.ChangeBgColorAnimation localChangeBgColorAnimation = new LSRecordAnimations.ChangeBgColorAnimation(this.jdField_b_of_type_AndroidViewView, m, n, this.jdField_b_of_type_ComTencentMobileqqPttLSRecordAnimations$TrackInfo);
      ...
      localChangeBgColorAnimation.setAnimationListener(new tyc(this));
      ...
      this.jdField_b_of_type_ComTencentMobileqqPttLSRecordAnimations$TrackInfo.jdField_a_of_type_Int = m;
    }
  }
  ...
  private void c(int paramInt)
  {
    ...
    QLog.d("LsRecord", 4, "LS setMode: " + this.k);
  }
  ...
  private void d(boolean paramBoolean)
  {
    ...
    c(0);
    if (this.jdField_a_of_type_ComTencentMobileqqPttLSRecordPanel$IRecordPanelHandler != null) {
      this.jdField_a_of_type_ComTencentMobileqqPttLSRecordPanel$IRecordPanelHandler.a(this.jdField_c_of_type_Boolean, -1, this.jdField_d_of_type_JavaLangString, false, paramBoolean);
    }
  ...
  {
    this.k = 0;
    this.jdField_a_of_type_AndroidViewView = super.findViewById(2131301263);
    this.jdField_a_of_type_AndroidViewView.setVisibility(4);
    this.jdField_b_of_type_AndroidViewView = super.findViewById(2131301264);
    this.jdField_b_of_type_AndroidViewView.setVisibility(4);
    this.jdField_c_of_type_AndroidViewView = super.findViewById(2131301265);
    if (AppSetting.j)
    {
    ...
    this.jdField_a_of_type_ComTencentMobileqqPttLSRecordTextView = ((LSRecordTextView)super.findViewById(2131299553));
    this.jdField_a_of_type_ComTencentMobileqqActivityAioAudiopanelVolumeIndicateSquareView = ((VolumeIndicateSquareView)super.findViewById(2131301268));
    ...
    this.jdField_a_of_type_ComTencentMobileqqPttLSRecordTextView.setText("-:--");
    this.jdField_d_of_type_AndroidViewView = super.findViewById(2131301266);
  }
  ...
  private void m()
  {
    ...
    for (;;)
    {
      ...
      ((Animation)localObject).setAnimationListener(new tyb(this));
  ...
  private void n()
  {
    ...
    if ((this.jdField_a_of_type_ComTencentMobileqqUtilsQQRecorder != null) && (!this.jdField_a_of_type_ComTencentMobileqqUtilsQQRecorder.b()) && (!this.jdField_a_of_type_AndroidOsHandler.hasMessages(16711686)))
    {
      ...
      d(2131165201);
      AudioUtil.a(BaseApplicationImpl.a, false);
    }
    for (;;)
    {
      if (!bool) {
  ...
  private void o()
  {
    ...
    {
      PttBuffer.a(this.jdField_c_of_type_JavaLangString);
      this.jdField_c_of_type_JavaLangString = null;
      BaseChatPie.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, 8);
    }
  }
  ...
  public int a()
  {
    ...
    this.j = 0;
    this.jdField_a_of_type_AndroidOsHandler.post(new tyf(this));
  ...
  public int a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    {
      m -= 200;
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(16711687, m);
      return m + 200;
      if ((n & 0x2) != 0) {
  ...
  public void a(String paramString, int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqActivityAioSessionInfo.b = paramString;
  }
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler.post(new tye(this));
    if (this.jdField_c_of_type_JavaLangString != null) {
      d(2131165193);
    }
  }
  ...
  public void a(String paramString, QQRecorder.RecorderParam paramRecorderParam, double paramDouble)
  {
    ...
    if (this.jdField_c_of_type_Boolean) {
      ...
      {
        this.jdField_c_of_type_Boolean = false;
        this.jdField_d_of_type_JavaLangString = "录音时间太短啦";
        o();
      }
    }
    for (;;)
    {
      this.jdField_a_of_type_AndroidOsHandler.post(new tyg(this));
      return;
  ...
  public void a(String paramString1, QQRecorder.RecorderParam paramRecorderParam, String paramString2)
  {
    ...
    o();
    this.jdField_a_of_type_AndroidOsHandler.post(new tyh(this));
  }
  ...
  public void a(String paramString, byte[] paramArrayOfByte, int paramInt1, int paramInt2, double paramDouble, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    if ((c()) && (this.k != 5)) {
      this.jdField_a_of_type_AndroidOsHandler.post(new txy(this, paramInt2, paramDouble));
    }
    this.j = ((int)paramDouble);
  }
  ...
  public boolean a(MotionEvent paramMotionEvent)
  {
    ...
    int m = this.jdField_a_of_type_AndroidGraphicsRect.right;
    ...
    this.jdField_a_of_type_AndroidGraphicsRect.right = (m - n + this.jdField_a_of_type_AndroidGraphicsRect.left);
    m = this.jdField_a_of_type_AndroidGraphicsRect.bottom;
    ...
    this.jdField_a_of_type_AndroidGraphicsRect.bottom = (m - n + this.jdField_a_of_type_AndroidGraphicsRect.top);
    ...
    if (this.k == 0)
    {
      if ((paramMotionEvent.getAction() != 0) || (!this.jdField_a_of_type_AndroidGraphicsRect.contains(n, i1))) {
        break label736;
      }
      this.j = 0;
      l();
      ...
      if (this.k != 5)
      {
        ...
        for (bool1 = true;; bool1 = false)
        {
          if (m == 0)
          {
            ...
            {
              if (QLog.isDevelopLevel()) {
                QLog.d("LsRecord", 4, "LS ACTION_UP: " + this.k);
              }
              if ((this.k == 3) || (this.k == 2))
              {
                ...
                this.jdField_d_of_type_JavaLangString = "录制时间短";
                c(false);
                bool1 = bool2;
                break;
              }
            ...
            m = this.jdField_c_of_type_AndroidGraphicsRect.right;
            int i2 = this.jdField_c_of_type_AndroidGraphicsRect.left;
            ...
            this.jdField_c_of_type_AndroidGraphicsRect.right = (m - i2 + this.jdField_c_of_type_AndroidGraphicsRect.left);
            m = this.jdField_c_of_type_AndroidGraphicsRect.bottom;
            i2 = this.jdField_c_of_type_AndroidGraphicsRect.top;
            paramMotionEvent = this.jdField_c_of_type_AndroidGraphicsRect;
            paramMotionEvent.top -= this.jdField_a_of_type_AndroidGraphicsPoint.y;
            this.jdField_c_of_type_AndroidGraphicsRect.bottom = (m - i2 + this.jdField_c_of_type_AndroidGraphicsRect.top);
            if (this.jdField_c_of_type_AndroidGraphicsRect.contains(n, i1))
            {
              if (this.k == 4) {
                b(true);
              }
  ...
  public void b(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    o();
    this.jdField_a_of_type_AndroidOsHandler.post(new txx(this));
  }
  ...
  public void c(String paramString, QQRecorder.RecorderParam paramRecorderParam)
  {
    ...
    o();
    this.jdField_a_of_type_AndroidOsHandler.post(new txw(this));
  }
  ...
  public void f()
  {
    ...
    this.jdField_c_of_type_AndroidViewAnimationAnimation.setAnimationListener(new txv(this));
  ...
  public void g()
  {
    ...
    this.jdField_d_of_type_AndroidViewAnimationAnimation.setAnimationListener(new txz(this));
  ...
  public void h()
  {
    ...
    if (this.k == 4)
    {
      ...
      this.jdField_d_of_type_JavaLangString = getResources().getString(2131367684);
    }
    for (;;)
    {
      ...
      label147:
      if (!QQRecorder.d()) {
        this.jdField_d_of_type_JavaLangString = getResources().getString(2131367685);
      } else if (!QQRecorder.a(((QQRecorder.RecorderParam)localObject2).c)) {
        this.jdField_d_of_type_JavaLangString = getResources().getString(2131367688);
      } else if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.d()) {
        this.jdField_d_of_type_JavaLangString = getResources().getString(2131368056);
      } else if (AudioHelper.b(1)) {
        this.jdField_d_of_type_JavaLangString = getResources().getString(2131367659);
      } else {
        this.jdField_d_of_type_JavaLangString = null;
      }
    }
    ...
    if (this.jdField_a_of_type_ComTencentMobileqqUtilsQQRecorder == null) {
      this.jdField_a_of_type_ComTencentMobileqqUtilsQQRecorder = new QQRecorder(BaseApplicationImpl.a);
    }
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQRecorder.a((QQRecorder.RecorderParam)localObject2);
    Object localObject1 = BuddyTransfileProcessor.a(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), null, 2, null, false);
    ...
    for (;;)
    {
      ...
      AudioUtil.a(BaseApplicationImpl.a, true);
      if (QLog.isColorLevel()) {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\ptt\LSRecordPanel.class
