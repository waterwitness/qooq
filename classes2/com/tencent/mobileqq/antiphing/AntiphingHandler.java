  ...
  implements BusinessObserver
{
  ...
  public static final String b = "InputClickEvent";
  static final String jdField_c_of_type_JavaLangString = "onClickInputCtrl";
  private int jdField_a_of_type_Int;
  private FrameLayout jdField_a_of_type_AndroidWidgetFrameLayout;
  private AntiphishingUrlConfig jdField_a_of_type_ComTencentMobileqqAntiphingAntiphishingUrlConfig;
  BrowserAppInterface jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface;
  QQAppInterface jdField_a_of_type_ComTencentMobileqqAppQQAppInterface;
  private AntiphingToast jdField_a_of_type_ComTencentMobileqqWidgetAntiphingToast;
  ...
  public AntiphingHandler()
  {
    ...
    this.jdField_d_of_type_JavaLangString = "Antiphishing";
    this.jdField_b_of_type_Int = 1;
    this.c = 0;
    this.jdField_d_of_type_Int = 1;
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface = null;
    this.jdField_a_of_type_ComTencentMobileqqAppBrowserAppInterface = null;
    this.jdField_a_of_type_ComTencentMobileqqAntiphingAntiphishingUrlConfig = new AntiphishingUrlConfig();
    this.jdField_a_of_type_ComTencentMobileqqWidgetAntiphingToast = new AntiphingToast();
  ...
  private boolean a(Context paramContext, String paramString, int paramInt)
  {
    ...
    if ((this.jdField_a_of_type_AndroidWidgetFrameLayout == null) && (this.mRuntime != null) && (this.mRuntime.a() != null)) {
      this.jdField_a_of_type_AndroidWidgetFrameLayout = ((FrameLayout)this.mRuntime.a().findViewById(2131299832));
    }
    ...
    {
      this.jdField_a_of_type_ComTencentMobileqqWidgetAntiphingToast.a(2131370681, 3000, this.jdField_a_of_type_AndroidWidgetFrameLayout);
  ...
  private boolean a(String paramString, ppp paramppp)
  {
    if (paramString == null) {
      return false;
    }
    ...
    for (int i = 1;; i = 0)
    {
      ...
      do
      {
        ...
        {
          paramppp.jdField_a_of_type_JavaLangString = ((String)localObject);
          paramppp.jdField_a_of_type_Int = 1;
          return true;
        }
      } while ((i != 1) || (!str.contains((CharSequence)localObject)));
      paramppp.jdField_a_of_type_JavaLangString = ((String)localObject);
      paramppp.jdField_a_of_type_Int = 2;
      return true;
    }
  }
  ...
  public void a(String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    label121:
    for (Object localObject2 = null;; localObject2 = new ppo(this))
    {
  ...
  public boolean a(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6)
  {
    ...
    do
    {
      ...
      localppp = new ppp(this);
      if (a(paramString1, localppp)) {
        break;
      }
    ...
    try
    {
      long l = Long.parseLong(localppp.jdField_a_of_type_JavaLangString);
      ...
      a(i, j, k, m, paramString2, Long.valueOf(l), localppp.jdField_a_of_type_Int);
      return true;
    }
  ...
  public void onReceive(int paramInt, boolean paramBoolean, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      str = localContext.getString(2131370697);
      localObject1 = localContext.getString(2131370693);
      localObject3 = localContext.getString(2131370694);
      localObject2 = localContext.getString(2131370696);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\antiphing\AntiphingHandler.class
