...
public class AntiphishingUrlConfig
{
  ...
  public AntiphishingUrlConfig()
  {
    ...
    this.jdField_a_of_type_JavaLangString = "antiphishingConfig";
    this.c = 1;
    this.d = 2;
    this.jdField_a_of_type_AndroidOsHandler = new ppq(this, Looper.getMainLooper());
  }
  ...
  public void a(int paramInt, String paramString1, String paramString2, Context paramContext)
  {
    ...
    ThreadManager.a(new ppr(this, paramContext, paramString1, paramString2), 5, null, true);
  }
  ...
  public boolean a()
  {
    ...
    pps localpps = new pps();
    try
    {
      SAXParserFactory.newInstance().newSAXParser().parse(new InputSource(new InputStreamReader(new FileInputStream((File)localObject), "UTF-8")), localpps);
      this.jdField_a_of_type_Int = localpps.a();
      this.jdField_a_of_type_JavaUtilArrayList = localpps.a();
      return true;
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\antiphing\AntiphishingUrlConfig.class
