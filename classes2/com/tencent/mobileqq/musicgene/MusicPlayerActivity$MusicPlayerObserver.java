    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        try
        {
          ...
          localObject9 = ((String)paramObject).replace("&apos;", "'").replace("&quot;", "\"").replace("&nbsp;", " ").replace("&lt;", "<").replace("&gt;", ">").replace("&amp;", "&");
          MusicPlayerActivity.a().put(str1, Long.valueOf(l2));
          MusicPlayerActivity.d().put(str1, localObject9);
          if (localObject1 == null) {
            continue;
          }
          paramObject = new tgv(l2, (String)localObject4, (String)localObject3, (String)localObject8, (String)localObject6, (String)localObject5, paramBoolean);
          ...
          paramObject = new tgu((String)localObject4, (String)localObject3, (String)localObject5, (String)localObject6, (String)localObject8, "http://qzonestyle.gtimg.cn/ac/qzone/applogo/16/308/100497308_16.gif");
      ...
      if (localObject1 != null)
      {
        ...
        try
        {
          ...
          Message.obtain(MusicPlayerActivity.a(localMusicPlayerActivity), 54).sendToTarget();
          return;
        }
        catch (Exception paramObject)
        {
          QLog.d("MusicPlayerActivity", 1, "add favourite parse json ", (Throwable)paramObject);
          return;
        }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\musicgene\MusicPlayerActivity$MusicPlayerObserver.class
