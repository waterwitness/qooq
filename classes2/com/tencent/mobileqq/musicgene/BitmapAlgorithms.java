...
{
  private static final String a = "BitmapAlgorithms";
  
  public BitmapAlgorithms()
  {
  ...
  public static Bitmap b(Bitmap paramBitmap, int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    //   14: areturn
    //   15: aload_0
    //   16: invokevirtual 32	android/graphics/Bitmap:getWidth	()I
    //   19: istore 11
    //   21: aload_0
    //   22: invokevirtual 36	android/graphics/Bitmap:getHeight	()I
    //   25: istore 12
    //   27: iload 11
    //   29: iload 12
    //   31: imul
    ...
    //   45: iload 11
    //   47: iload 12
    //   49: getstatic 68	android/graphics/Bitmap$Config:ARGB_8888	Landroid/graphics/Bitmap$Config;
    //   52: invokestatic 71	android/graphics/Bitmap:createBitmap	(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    //   55: astore 4
    //   57: aload_0
    //   58: aload 8
    //   60: iconst_0
    ...
    //   65: iload 11
    //   67: iload 12
    //   69: invokevirtual 75	android/graphics/Bitmap:getPixels	([IIIIIII)V
    //   72: iconst_0
    //   73: istore 10
    //   75: iload 10
    //   77: iload_1
    ...
    //   89: iload_2
    //   90: i2f
    //   91: invokestatic 77	com/tencent/mobileqq/musicgene/BitmapAlgorithms:b	([I[IIIF)V
    //   94: aload 9
    //   96: aload 8
    //   98: iload 12
    //   100: iload 11
    //   102: iload_3
    //   103: i2f
    //   104: invokestatic 77	com/tencent/mobileqq/musicgene/BitmapAlgorithms:b	([I[IIIF)V
    //   107: iload 10
    //   109: iconst_1
    //   110: iadd
    //   111: istore 10
    ...
    //   124: iload_2
    //   125: i2f
    //   126: invokestatic 79	com/tencent/mobileqq/musicgene/BitmapAlgorithms:a	([I[IIIF)V
    //   129: aload 9
    //   131: aload 8
    //   133: iload 12
    //   135: iload 11
    //   137: iload_3
    //   138: i2f
    //   139: invokestatic 79	com/tencent/mobileqq/musicgene/BitmapAlgorithms:a	([I[IIIF)V
    //   142: aload 4
    //   144: aload 8
    //   146: iconst_0
    //   147: iload 11
    ...
    //   151: iload 11
    //   153: iload 12
    //   155: invokevirtual 82	android/graphics/Bitmap:setPixels	([IIIIIII)V
    //   158: aload 4
    //   160: areturn
    //   161: astore_0
    //   162: aload 5
    ...
    //   168: iconst_1
    //   169: aload_0
    //   170: invokevirtual 51	java/lang/Exception:toString	()Ljava/lang/String;
    //   173: invokestatic 57	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   176: aload 4
    //   178: areturn
    //   179: astore_0
    //   180: aload 6
    ...
    //   186: iconst_1
    //   187: aload_0
    //   188: invokevirtual 83	java/lang/OutOfMemoryError:toString	()Ljava/lang/String;
    //   191: invokestatic 57	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   194: aload 4
    //   196: areturn
    //   197: astore_0
    //   198: aload 7
    ...
    //   204: iconst_1
    //   205: aload_0
    //   206: invokevirtual 84	java/lang/Error:toString	()Ljava/lang/String;
    //   209: invokestatic 57	com/tencent/qphone/base/util/QLog:e	(Ljava/lang/String;ILjava/lang/String;)V
    //   212: aload 4
    //   214: areturn
    //   215: astore_0
    //   216: goto -14 -> 202
    ...
    //   55	158	4	localObject1	Object
    //   7	156	5	localObject2	Object
    //   1	180	6	localObject3	Object
    //   4	195	7	localObject4	Object
    //   34	111	8	arrayOfInt1	int[]
    //   43	87	9	arrayOfInt2	int[]
    //   73	39	10	i	int
    //   19	133	11	j	int
    //   25	129	12	k	int
    // Exception table:
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\musicgene\BitmapAlgorithms.class
