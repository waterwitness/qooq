  ...
  extends BaseAdapter
{
  ...
  private LinearLayout a(ViewGroup paramViewGroup)
  {
    ...
    paramViewGroup.setTag(new wmg(null));
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    for (;;)
    {
      wmg localwmg = (wmg)paramView.getTag();
      ...
      paramViewGroup = localwmg.a[paramInt];
      int k = this.a.jdField_a_of_type_ComTencentMobileqqWidgetGridListView$GridListAdapter.b(j + paramInt);
      if ((paramViewGroup != null) && (((Integer)paramViewGroup.getTag(2131296830)).intValue() != k)) {
        paramViewGroup = null;
      }
      for (;;)
      {
        ...
        localView.setTag(2131296830, Integer.valueOf(k));
        localwmg.a[paramInt] = localView;
        ...
        {
          localView.setTag(2131302453, Integer.valueOf(j + paramInt));
        ...
        {
          localObject = paramView;
          if (((Integer)paramView.getTag(2131296830)).intValue() != i) {
            localObject = null;
          }
        }
        ...
        paramView.setTag(2131296830, Integer.valueOf(i));
        ...
        {
          paramView.setTag(2131302453, Integer.valueOf(paramInt));
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\GridListView$WraperAdapter.class
