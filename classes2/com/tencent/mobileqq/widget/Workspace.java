  ...
  extends FrameLayout
{
  ...
  public Workspace(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    setBackgroundDrawable(getResources().getDrawable(2130837958));
  }
  ...
  public void d()
  {
    if ((this.jdField_e_of_type_Int == -1) && (this.jdField_c_of_type_Int > 0) && (this.jdField_a_of_type_AndroidWidgetScroller.isFinished())) {
      a(this.jdField_c_of_type_Int - 1);
    }
  }
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (;;)
    {
      ...
      return true;
      label374:
      if ((i1 < 65186) && (this.jdField_c_of_type_Int < getChildCount() - 1)) {
        a(this.jdField_c_of_type_Int + 1);
      } else {
        h();
      }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\Workspace.class
