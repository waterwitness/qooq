  ...
  implements FormItemConstants
{
  ...
  public FormSwitchItem(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.k = getResources().getDimensionPixelSize(2131493323);
    int n = getResources().getDimensionPixelSize(2131493684);
  ...
  public static Drawable a(Resources paramResources, int paramInt)
  {
    ...
    {
    default: 
      return paramResources.getDrawable(2130843273);
    case 0: 
      return paramResources.getDrawable(2130843273);
    case 1: 
      return paramResources.getDrawable(2130843292);
    case 2: 
      return paramResources.getDrawable(2130843286);
    }
    return paramResources.getDrawable(2130843277);
  }
  
  private void a()
  {
    this.jdField_a_of_type_AndroidWidgetTextView = new TextView(getContext());
    this.jdField_a_of_type_AndroidWidgetTextView.setId(2131296462);
    if (!TextUtils.isEmpty(this.jdField_a_of_type_JavaLangCharSequence)) {
      this.jdField_a_of_type_AndroidWidgetTextView.setText(this.jdField_a_of_type_JavaLangCharSequence);
    }
    this.jdField_a_of_type_AndroidWidgetTextView.setSingleLine(true);
    int n = getContext().getResources().getDimensionPixelSize(2131493682);
    this.jdField_a_of_type_AndroidWidgetTextView.setTextSize(0, n);
    ...
    localLayoutParams.addRule(0, 2131296463);
    ...
    this.jdField_a_of_type_ComTencentWidgetSwitch.setId(2131296463);
  ...
  public void a(boolean paramBoolean)
  {
    ...
    while ((this.jdField_a_of_type_ComTencentWidgetSwitch == null) || (this.jdField_a_of_type_ComTencentWidgetSwitch.getVisibility() == 0))
    {
      ...
      this.jdField_a_of_type_ComTencentWidgetSwitch.setVisibility(8);
      this.jdField_a_of_type_AndroidWidgetProgressBar.setIndeterminateDrawable(getResources().getDrawable(2130838318));
  ...
  {
    if ((AppSetting.j) && (this.jdField_a_of_type_ComTencentWidgetSwitch != null) && (this.jdField_a_of_type_ComTencentWidgetSwitch.getVisibility() == 0))
    {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\FormSwitchItem.class
