  ...
  extends RelativeLayout
{
  ...
  public OvalProgress(Context paramContext)
  {
    ...
    this.jdField_f_of_type_Int = -3355444;
    this.jdField_g_of_type_Int = -16745985;
  }
  ...
  private double a(Canvas paramCanvas, double paramDouble)
  {
    ...
    int j = 90;
    if (this.jdField_a_of_type_Wmv.jdField_a_of_type_Double > 0.0D) {}
    for (int i = (int)(1.0D * paramDouble * 90 / this.jdField_a_of_type_Wmv.jdField_a_of_type_Double);; i = 0)
    {
      if (i > 90) {
        i = j;
      }
      for (;;)
      {
        ...
        return paramDouble - this.jdField_a_of_type_Wmv.jdField_a_of_type_Double;
      }
    }
  }
  ...
  private boolean a()
  {
    ...
    } while (this.jdField_a_of_type_Wmv != null);
    double d1 = (j - 2) * 3.141592653589793D;
    double d2 = f1 * 2.0F + d1;
    this.jdField_a_of_type_Wmv = new wmv(this);
    this.jdField_a_of_type_Wmv.jdField_a_of_type_Double = (0.25D * d1 / d2);
    this.jdField_a_of_type_Wmv.b = (f1 * 1.0D / d2);
    this.jdField_a_of_type_Wmv.c = (d1 * 0.5D / d2);
    this.jdField_a_of_type_Wmv.d = (f1 * 1.0D / d2);
    this.jdField_a_of_type_Wmv.e = (d1 * 0.25D / d2);
    return true;
  }
  ...
  private double b(Canvas paramCanvas, double paramDouble)
  {
    ...
    if (this.jdField_a_of_type_Wmv.b > 0.0D) {
      d1 = paramDouble / this.jdField_a_of_type_Wmv.b;
    }
    if (d1 > 1.0D) {
      d1 = d2;
    }
    for (;;)
    {
      ...
      return paramDouble - this.jdField_a_of_type_Wmv.b;
    }
  }
  ...
  private double c(Canvas paramCanvas, double paramDouble)
  {
    ...
    int j = 180;
    if (this.jdField_a_of_type_Wmv.c > 0.0D) {}
    for (int i = (int)(1.0D * paramDouble * '´' / this.jdField_a_of_type_Wmv.c);; i = 0)
    {
      if (i > 180) {
        i = j;
      }
      for (;;)
      {
        ...
        return paramDouble - this.jdField_a_of_type_Wmv.c;
      }
    }
  }
  ...
  private double d(Canvas paramCanvas, double paramDouble)
  {
    ...
    if (this.jdField_a_of_type_Wmv.d > 0.0D) {
      d1 = paramDouble / this.jdField_a_of_type_Wmv.d;
    }
    double d2 = d1;
    if (d1 > 1.0D) {
      d2 = 1.0D;
    ...
    return paramDouble - this.jdField_a_of_type_Wmv.d;
  }
  ...
  private double e(Canvas paramCanvas, double paramDouble)
  {
    ...
    int j = 90;
    int i;
    if (this.jdField_a_of_type_Wmv.e > 0.0D) {
      if (paramDouble > this.jdField_a_of_type_Wmv.e * 0.99D) {
        i = 90;
      }
    }
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        return paramDouble - this.jdField_a_of_type_Wmv.e;
        i = (int)(1.0D * paramDouble * 90 / this.jdField_a_of_type_Wmv.e);
        break;
      }
      i = 0;
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\OvalProgress.class
