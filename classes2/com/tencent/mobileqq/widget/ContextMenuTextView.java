  ...
  extends TextView
{
  ...
  public ContextMenuTextView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_Wln = new wln(this, null);
    this.jdField_a_of_type_AndroidViewView$OnClickListener = new wll(this);
    this.jdField_a_of_type_AndroidContentContext = paramContext;
    setOnLongClickListener(this.jdField_a_of_type_Wln);
  ...
  public ContextMenuTextView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    setOnLongClickListener(this.jdField_a_of_type_Wln);
    setSelectAllOnFocus(true);
    setOnTouchListener(this.jdField_a_of_type_Wln);
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\ContextMenuTextView.class
