...
public class WebViewProgressBar
  extends View
{
  private static final String jdField_a_of_type_JavaLangString = "WebViewProgressBar";
  ...
  public void onDraw(Canvas paramCanvas)
  {
    ...
    for (;;)
    {
      ...
      label164:
      if (this.b == null) {
        this.b = getContext().getResources().getDrawable(2130843137);
      }
      this.b.setBounds(0, 0, getWidth(), getHeight());
      this.b.draw(paramCanvas);
      if (this.jdField_a_of_type_AndroidGraphicsDrawableDrawable == null) {
        this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = getContext().getResources().getDrawable(2130843138);
      }
      j = (int)this.jdField_a_of_type_ComTencentMobileqqWidgetWebViewProgressBarController.a();
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\WebViewProgressBar.class
