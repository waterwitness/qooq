  ...
  extends LinearLayout
{
  ...
  public CustomedTabWidget(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)inflate(paramContext, 2130904992, null));
    this.jdField_a_of_type_AndroidGraphicsDrawableDrawable = this.jdField_a_of_type_AndroidWidgetImageView.getBackground();
    this.jdField_b_of_type_AndroidGraphicsDrawableDrawable = paramContext.getResources().getDrawable(2130843298);
    this.c = paramContext.getResources().getDrawable(2130843297);
  ...
  private void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_Wlw.sendEmptyMessage(0);
  }
  
  private void a(View paramView)
  {
    paramView.setOnClickListener(new wlu(this));
    paramView.setOnTouchListener(new wlv(this));
    if (getChildCount() == 1) {
  ...
  {
    this.jdField_a_of_type_Wlw.removeMessages(0);
    this.jdField_a_of_type_ComTencentMobileqqWidgetCustomedTabWidget$OnSwitchTabListener = paramOnSwitchTabListener;
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\CustomedTabWidget.class
