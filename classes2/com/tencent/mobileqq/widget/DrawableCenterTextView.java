  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    if (localObject2 != null)
    {
      ...
      if ((localObject1 != null) || (localObject2 != null))
      {
        ...
        f1 = f2 + ((Drawable)localObject1).getIntrinsicWidth();
      }
    }
    for (;;)
    {
      ...
      else
      {
        ...
        if (localObject1 != null)
        {
          ...
          if (localObject2 != null)
          {
            ...
            f1 = f2 + (((Drawable)localObject1).getIntrinsicWidth() + j + i);
            setPadding(0, 0, (int)(getWidth() - f1), 0);
          }
        }
      }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\DrawableCenterTextView.class
