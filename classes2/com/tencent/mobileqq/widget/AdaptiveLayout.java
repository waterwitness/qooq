  ...
  extends ViewGroup
{
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        if (i4 > 0)
        {
          ...
          if (localView.getMeasuredWidth() + m > i6)
          {
            ...
            i1 = Math.max(j, m);
            n = i + (this.e + k);
            this.a.put(Integer.valueOf(i4), new wkm(this, m, k));
            i = this.mPaddingLeft;
  ...
  private void a(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      localObject = (wkm)this.a.get(localObject);
      int k = this.d;
      int m = this.e;
      int i3;
      switch (this.f & 0x7)
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (i4 = i; i2 < i1; i4 = i5)
          {
            ...
            if (localView.getVisibility() != 8)
            {
              i5 = (((wkm)localObject).b - localView.getMeasuredHeight()) / 2 + (k + j);
              localView.layout(i4, i5, localView.getMeasuredWidth() + i4, localView.getMeasuredHeight() + i5);
              i5 = i4 + (localView.getMeasuredWidth() + i3);
            }
            i2 += 1;
          }
          i = this.mPaddingLeft + paramInt3 - paramInt1 - ((wkm)localObject).a;
          i3 = k;
          break label162;
          i = this.mPaddingLeft + (paramInt3 - paramInt1 - ((wkm)localObject).a) / 2;
          i3 = k;
          break label162;
          i = i1 - i2;
          k = (paramInt3 - paramInt1 - (((wkm)localObject).a - this.d * (i - 1))) / i;
          break;
      ...
      if (i != i4) {}
      for (int i = ((wkm)localObject).b + m + j;; i = j)
      {
        n += 1;
        j = i;
        break;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\AdaptiveLayout.class
