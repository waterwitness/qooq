  ...
  extends View
{
  ...
  private wof jdField_a_of_type_Wof;
  ...
  public RoundWaveView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, R.styleable.ah, paramInt, 0);
  ...
  public void a()
  {
    ...
    b();
    this.jdField_a_of_type_Wof = new wof(this, 0.4F, 0.0F, this.jdField_b_of_type_Float, this.e, 1000L);
    ViewCompat.postOnAnimation(this, this.jdField_a_of_type_Wof);
  }
  
  public void b()
  {
    if (this.jdField_a_of_type_Wof != null)
    {
      this.jdField_a_of_type_Wof.a();
      this.jdField_a_of_type_Wof = null;
    }
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\RoundWaveView.class
