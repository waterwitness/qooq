  ...
  implements View.OnClickListener
{
  ...
  {
    paramContext = getContext().getTheme().obtainStyledAttributes(paramAttributeSet, R.styleable.t, 0, 0);
    try
    {
  ...
  private void d()
  {
    ...
    localImageView.setId(2131296454);
    localImageView.setImageResource(2130840961);
    ...
    do
    {
      ...
      if (m < n)
      {
        ...
        for (paramBoolean = true;; paramBoolean = false)
        {
          ...
          ((Animation)localObject).setAnimationListener(new wmc(this, localView));
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    for (paramInt2 = View.MeasureSpec.makeMeasureSpec(this.f * 2, Integer.MIN_VALUE);; paramInt2 = View.MeasureSpec.makeMeasureSpec(this.f, 1073741824))
    {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\ExpandableEntranceLayout.class
