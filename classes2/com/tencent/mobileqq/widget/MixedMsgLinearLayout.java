  ...
  extends LinearLayout
{
  ...
  {
    super(paramContext);
    this.jdField_a_of_type_Wmo = new wmo(this);
    this.jdField_a_of_type_Wmn = new wmn(this);
  }
  ...
  private ChatThumbView a(MessageForPic paramMessageForPic)
  {
    ...
    localLayoutParams.leftMargin = BaseChatItemLayout.r;
    localLayoutParams.rightMargin = BaseChatItemLayout.s;
  ...
  private AnimationTextView a()
  {
    ...
    localAnimationTextView.setTextColor(getContext().getResources().getColorStateList(2131428272));
    localAnimationTextView.setLinkTextColor(getContext().getResources().getColorStateList(2131428271));
    localAnimationTextView.setSpannableFactory(QQText.a);
    localAnimationTextView.setMaxWidth(BaseChatItemLayout.i);
    localAnimationTextView.setMovementMethod(LinkMovementMethod.getInstance());
    localAnimationTextView.setPadding(BaseChatItemLayout.r, 0, BaseChatItemLayout.s, 0);
  ...
  public void a(List paramList)
  {
    ...
    while (i < ((ArrayList)localObject3).size())
    {
      ...
      this.jdField_a_of_type_Wmo.a((AnimationTextView)localObject1);
      i += 1;
    }
    j = paramList.size();
    i = 0;
    if (i < j)
    {
      ...
      if ((localObject2 instanceof MessageForReplyText))
      {
        ...
        ((ETTextView)localObject2).setTextColor(getContext().getResources().getColorStateList(2131428272));
        ((ETTextView)localObject2).setLinkTextColor(getContext().getResources().getColorStateList(2131428271));
        ((ETTextView)localObject2).setEditableFactory(QQTextBuilder.a);
        ((ETTextView)localObject2).setSpannableFactory(QQText.a);
        ((ETTextView)localObject2).setMaxWidth(BaseChatItemLayout.h);
      ...
      do
      {
        for (;;)
        {
          ...
          localObject2 = this.jdField_a_of_type_Wmo.a();
      ...
      localObject1 = this.jdField_a_of_type_Wmn.a();
    ...
    for (;;)
    {
      ...
      while (i < ((ArrayList)localObject3).size())
      {
        ...
        if ((paramList instanceof ChatThumbView))
        {
          ...
          this.jdField_a_of_type_Wmn.a((ChatThumbView)paramList);
        }
        i += 1;
      }
      return;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\MixedMsgLinearLayout.class
