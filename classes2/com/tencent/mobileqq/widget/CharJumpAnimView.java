  ...
  extends TextView
{
  ...
  public CharJumpAnimView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_JavaLangRunnable = new wkz(this);
    b();
  }
  ...
  private void b()
  {
    ...
    if (TextUtils.isEmpty(this.jdField_a_of_type_JavaLangString)) {
      this.jdField_a_of_type_JavaLangString = getResources().getString(2131370683);
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\CharJumpAnimView.class
