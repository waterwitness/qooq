  ...
  implements Handler.Callback, ScrollListener
{
  ...
  static final String jdField_a_of_type_JavaLangString = ScrollStateDetector.class.getSimpleName();
  ...
  public void a(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if ((!this.jdField_c_of_type_Boolean) && (paramInt3 <= this.jdField_c_of_type_Int)) {
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(0, 50L);
    }
    a(1);
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\ScrollStateDetector.class
