  ...
  extends FrameLayout
{
  ...
  public int a;
  private Handler jdField_a_of_type_AndroidOsHandler = new wou(this);
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    for (int j = paramMotionEvent.getRight() - j; j > 0; j = 0)
    {
      ...
      for (;;)
      {
        ...
        this.h = 0;
        break;
        if ((j < 65036) && (this.jdField_a_of_type_Int < getChildCount())) {
          a(this.jdField_a_of_type_Int + 1);
        } else {
          c();
        }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\widget\WorkSpaceView.class
