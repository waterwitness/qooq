  ...
  extends AbsStructMsg
{
  ...
  StructMsgForHypertext()
  {
    ...
    this.mUrlAdapter = new uvo(this);
    this.mSourceOnClickListener = new uvp(this);
  }
  ...
  public View getPreDialogView(Context paramContext, View paramView)
  {
    ...
    if (paramView == null) {
      paramView = new LinearLayout.LayoutParams(BaseChatItemLayout.i, -2);
    }
    for (;;)
    {
      ...
      paramView.setPadding((int)localResources.getDimension(2131493081), (int)localResources.getDimension(2131493083), (int)localResources.getDimension(2131493082), (int)localResources.getDimension(2131493084));
      ...
      paramView.setTextColor(paramContext.getResources().getColor(2131427386));
      paramView.setLinkTextColor(paramContext.getResources().getColor(2131427450));
      paramView.setLinksClickable(false);
      paramView.setMovementMethod(LinkMovementMethod.getInstance());
      localLinearLayout.addView(paramView);
      localLinearLayout.setLongClickable(true);
      localLinearLayout.setTag(2131296312, this);
      return localLinearLayout;
      paramView.width = BaseChatItemLayout.i;
      paramView.height = -2;
    }
  }
  ...
  public View getSourceView(Context paramContext, View paramView)
  {
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(this.mSourceIcon))
      {
        ...
        Object localObject = localResources.getDrawable(2130843355);
  ...
  public View getView(Context paramContext, View paramView, OnLongClickAndTouchListener paramOnLongClickAndTouchListener, Bundle paramBundle)
  {
    ...
    Resources localResources = paramContext.getResources();
    paramBundle.setPadding((int)localResources.getDimension(2131493081), (int)localResources.getDimension(2131493083), (int)localResources.getDimension(2131493082), (int)localResources.getDimension(2131493084));
    paramBundle.setText(getSpannableString(true));
    paramBundle.setTextSize(0, ChatTextSizeSettingActivity.a(paramContext));
    paramBundle.setTextColor(paramContext.getResources().getColor(2131427386));
    paramBundle.setLinkTextColor(paramContext.getResources().getColor(2131427450));
    ...
    if (paramContext == null) {
      new LinearLayout.LayoutParams(BaseChatItemLayout.i, -2);
    }
    for (;;)
    {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\structmsg\StructMsgForHypertext.class
