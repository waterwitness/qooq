  ...
  extends AbsStructMsgItem
{
  ...
  public StructMsgItemLayout9(int paramInt)
  {
    super(paramInt);
  }
  
  public StructMsgItemLayout9(Collection paramCollection)
  {
  ...
  public View a(Context paramContext, View paramView, boolean paramBoolean, Bundle paramBundle)
  {
        ...
        if (paramView.getChildCount() == j)
        {
          ...
          if ("summary".equals(localObject2))
          {
            ...
            if (paramBoolean)
            {
              ...
              ((StructMsgItemSummary)localObject1).d("22");
          ...
          for (;;)
          {
            ...
            {
              ((StructMsgItemSummary)localObject1).d("44");
              ((StructMsgItemSummary)localObject1).a(true);
              ((StructMsgItemSummary)localObject1).a(paramContext, paramView.findViewById(3), paramBundle);
            }
            else
            {
              ((StructMsgItemSummary)localObject1).d("30");
              ((StructMsgItemSummary)localObject1).d(20);
    ...
    for (;;)
    {
      ...
      if (i < j)
      {
        ...
        if ("summary".equals(localObject3))
        {
          ...
          if (paramBoolean)
          {
            ...
            ((StructMsgItemSummary)localObject2).d("22");
      ...
      for (;;)
      {
        ...
        {
          ((StructMsgItemSummary)localObject2).d("44");
          ((StructMsgItemSummary)localObject2).a(true);
          localObject2 = ((StructMsgItemSummary)localObject2).a(paramContext, null, paramBundle);
        ...
        {
          ((StructMsgItemSummary)localObject2).d("30");
          ((StructMsgItemSummary)localObject2).d(20);
          localObject2 = ((StructMsgItemSummary)localObject2).a(paramContext, null, paramBundle);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\structmsg\view\StructMsgItemLayout9.class
