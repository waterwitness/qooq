...
{
  public static final String a = "StructMsgItemLayout6Adapter";
  ...
  public StructMsgItemLayout6Adapter(AbsStructMsgItem paramAbsStructMsgItem, Context paramContext, int paramInt)
  {
    ...
    this.b = this.jdField_a_of_type_AndroidContentContext.getResources().getDimensionPixelSize(2131493121);
  }
  ...
  public static boolean a(AbsStructMsgItem paramAbsStructMsgItem, int paramInt)
  {
    ...
    if ((localObject == null) || (TextUtils.isEmpty(paramAbsStructMsgItem.n)) || ((!PublicAccountUtil.b((QQAppInterface)localObject, paramAbsStructMsgItem.n)) && (!"2909288299".equals(paramAbsStructMsgItem.n)) && (!"3338705755".equals(paramAbsStructMsgItem.n)))) {}
    int j;
    label80:
    do
    {
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    if (paramView != null)
    {
      ...
      if ((paramView instanceof LinearLayout))
      {
        ...
        localFrameLayout = (FrameLayout)((LinearLayout)localObject1).findViewById(2131296533);
      ...
      else
      {
        if ("summary".equals(str))
        {
          ...
          if ((j != 0) && (!TextUtils.isEmpty(((StructMsgItemSummary)localObject2).b())))
          {
            ...
            ((ArrayList)localObject3).add(a((StructMsgItemSummary)localObject2, ((LinearLayout)localObject1).findViewById(i + 2131296529)));
            localObject2 = paramContext;
            paramContext = paramView;
            m = i + 1;
            i = j;
            ...
            {
              paramBundle = (TextView)paramContext.findViewById(2131296532);
              if (!TextUtils.isEmpty(paramView)) {
                if (paramBundle == null)
                {
                  paramView = a(paramView, null, true);
                  paramView.setId(2131296532);
                  ...
                  else
                  {
                    if ("summary".equals(localObject3))
                    {
                      ...
                      if ((i != 0) && (!TextUtils.isEmpty(((StructMsgItemSummary)localObject2).b())))
                      {
                        ...
                        ((TextView)localObject2).setId(2131296529 + j);
                        ((LinearLayout)localObject1).addView((View)localObject2);
                      }
                    }
                    localObject2 = paramContext;
  ...
  public View a(AbsStructMsgElement paramAbsStructMsgElement, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramView != null) && ((paramView instanceof FrameLayout)))
    {
      ...
      paramAbsStructMsgElement.a(this.jdField_a_of_type_AndroidContentContext, paramView.findViewById(2131296359), paramBundle);
      return paramView;
    }
    ...
    paramView.setId(2131296533);
    if (paramBundle != null) {
      paramBundle.putBoolean("pa_should_change", true);
    }
    paramAbsStructMsgElement = (ImageView)paramAbsStructMsgElement.a(this.jdField_a_of_type_AndroidContentContext, null, paramBundle).findViewById(2131296359);
    ...
    if ((paramAbsStructMsgElement != null) && ((paramAbsStructMsgElement instanceof PAImageView))) {
      ((PAImageView)paramAbsStructMsgElement).setUseRadiusRound(true, localResources.getDimensionPixelSize(2131493122));
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\structmsg\view\StructMsgItemLayout6Adapter.class
