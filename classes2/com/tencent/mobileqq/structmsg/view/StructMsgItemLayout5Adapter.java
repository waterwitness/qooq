...
{
  private static final String jdField_a_of_type_JavaLangString = "StructMsgItemLayout5Adapter";
  ...
  public View a(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    do
    {
      ...
      localObject1 = (FrameLayout)localLinearLayout.findViewById(2131296533);
      ...
      paramBundle = (TextView)this.jdField_a_of_type_AndroidViewView.findViewById(2131296532);
    ...
    for (;;)
    {
      if (localLinearLayout == null)
      {
        ...
        localLinearLayout.setId(2131296534);
      }
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          if ((!TextUtils.isEmpty(paramView)) && (paramView.trim().length() > 0))
          {
            ...
            this.jdField_a_of_type_AndroidWidgetTextView.setId(2131296531);
  ...
  public View a(AbsStructMsgElement paramAbsStructMsgElement, View paramView, Bundle paramBundle)
  {
    ...
    if ((paramAbsStructMsgElement != null) && ((paramAbsStructMsgElement instanceof PAImageView)))
    {
      ...
      localPAImageView.setUseRadiusRound(true, localResources.getDimensionPixelSize(2131493122));
      localPAImageView.setTag(2131296575, Integer.valueOf(1));
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\structmsg\view\StructMsgItemLayout5Adapter.class
