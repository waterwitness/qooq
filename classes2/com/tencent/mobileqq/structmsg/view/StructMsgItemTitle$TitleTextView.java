  ...
  extends TextView
{
  ...
  private void a(CharSequence paramCharSequence, int paramInt)
  {
    ...
    {
      return;
      i = (int)FloatMath.ceil(Layout.getDesiredWidth(paramCharSequence, getPaint()));
    } while (i <= paramInt);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\structmsg\view\StructMsgItemTitle$TitleTextView.class
