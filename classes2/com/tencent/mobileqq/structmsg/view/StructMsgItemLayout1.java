  ...
  public View b(Context paramContext, View paramView, Bundle paramBundle)
  {
    ...
    for (int j = a(paramContext) + i;; j = i)
    {
      ...
      if ("picture".equals(localObject2))
      {
        ...
        localLayoutParams.height = (BaseChatItemLayout.i - i1 - i1);
      }
      for (;;)
      {
        j += 1;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\structmsg\view\StructMsgItemLayout1.class
