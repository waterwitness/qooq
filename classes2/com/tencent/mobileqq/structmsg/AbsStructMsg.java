  ...
  implements StructMsgConstants, Externalizable
{
  ...
  {
    return getExceptionView(paramContext, paramView, paramOnLongClickAndTouchListener, paramBundle, 2131367673);
  }
  ...
  public View getView(Context paramContext, View paramView, OnLongClickAndTouchListener paramOnLongClickAndTouchListener, Bundle paramBundle)
  {
    ...
    if (paramView == null)
    {
      ...
      paramOnLongClickAndTouchListener.setBackgroundResource(2130843353);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\structmsg\AbsStructMsg.class
