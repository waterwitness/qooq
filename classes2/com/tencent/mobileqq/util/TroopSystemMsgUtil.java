...
public class TroopSystemMsgUtil
{
  ...
  {
    long l = 0L;
    paramContext = paramContext.getSharedPreferences(String.valueOf(AppConstants.aq), 0);
  ...
  public static String a(Context paramContext, String paramString)
  {
    ...
    SharedPreferences localSharedPreferences = paramContext.getSharedPreferences(String.valueOf(AppConstants.aq), 0);
  ...
  public static String a(String paramString)
  {
    ...
    for (paramString = (String)localObject; localMatcher.find(); paramString = localMatcher.group()) {}
    return paramString;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\util\TroopSystemMsgUtil.class
