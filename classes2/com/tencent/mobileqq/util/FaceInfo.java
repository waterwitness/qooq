...
{
  public static final Parcelable.Creator CREATOR = new vyd();
  ...
  public FaceInfo()
  {
    if (this.jdField_a_of_type_ArrayOfLong == null) {
      this.jdField_a_of_type_ArrayOfLong = new long[r];
    }
    int i1 = 0;
    while (i1 < r)
    {
  ...
  {
    a(paramInt1, paramString, paramBoolean1, paramByte, paramInt2, paramBoolean2, paramInt3, 0, false);
  }
  ...
  {
    a(paramInt1, paramString, paramBoolean1, paramByte, paramInt2, paramBoolean2, paramInt3, paramInt4, false);
  }
  
  public FaceInfo(int paramInt1, String paramString, boolean paramBoolean1, byte paramByte, int paramInt2, boolean paramBoolean2, int paramInt3, int paramInt4, boolean paramBoolean3)
  {
    a(paramInt1, paramString, paramBoolean1, paramByte, paramInt2, paramBoolean2, paramInt3, paramInt4, paramBoolean3);
  }
  
  public FaceInfo(int paramInt1, String paramString, boolean paramBoolean1, byte paramByte, int paramInt2, boolean paramBoolean2, int paramInt3, boolean paramBoolean3)
  {
    a(paramInt1, paramString, paramBoolean1, paramByte, paramInt2, paramBoolean2, paramInt3, 0, paramBoolean3);
  }
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    } while ((paramInt1 != q) || (!QLog.isColorLevel()));
    ...
    l1 = l2;
    if (this.jdField_a_of_type_ArrayOfLong[q] > 0L)
    {
      l1 = l2;
      if (this.jdField_a_of_type_ArrayOfLong[i] > 0L) {
        l1 = Math.abs(this.jdField_a_of_type_ArrayOfLong[q] - this.jdField_a_of_type_ArrayOfLong[i]);
      }
    }
  ...
  public void a(int paramInt1, String paramString, boolean paramBoolean1, byte paramByte, int paramInt2, boolean paramBoolean2, int paramInt3, int paramInt4, boolean paramBoolean3)
  {
  ...
  public String c()
  {
    if (TextUtils.isEmpty(this.e)) {
      this.e = a(this.jdField_a_of_type_AvatarInfoQQHeadInfo, this.jdField_b_of_type_Int);
    }
    return this.e;
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    return (this.jdField_a_of_type_Int == ((FaceInfo)paramObject).jdField_a_of_type_Int) && (TextUtils.equals(this.jdField_a_of_type_JavaLangString, ((FaceInfo)paramObject).jdField_a_of_type_JavaLangString)) && (this.jdField_b_of_type_Int == ((FaceInfo)paramObject).jdField_b_of_type_Int) && (this.jdField_c_of_type_Int == ((FaceInfo)paramObject).jdField_c_of_type_Int);
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\util\FaceInfo.class
