...
public class ImageWorker
{
  ...
  public ImageWorker(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidGraphicsDrawableBitmapDrawable = new BitmapDrawable();
  ...
  private vyq a(View paramView)
  {
    if (paramView != null)
    {
      vys localvys = (vys)this.jdField_a_of_type_JavaUtilMap.get(paramView);
      if (localvys != null) {
        paramView = localvys.jdField_a_of_type_Vyp;
      }
      while ((paramView instanceof vyp))
      {
        return ((vyp)paramView).a();
  ...
  private void a(boolean paramBoolean, View paramView, Drawable paramDrawable, vys paramvys)
  {
    ...
    paramDrawable = null;
    if (paramvys != null) {
      paramDrawable = paramvys.jdField_a_of_type_ComTencentMobileqqUtilImageLoader;
    }
    if (paramDrawable != null)
    {
  ...
  public void a(Bitmap paramBitmap, String paramString, View paramView, ImageLoader paramImageLoader, ImageCreator paramImageCreator, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      localObject = new vyq(this, paramView);
      vyp localvyp = new vyp(this.jdField_a_of_type_AndroidContentContext.getResources(), paramBitmap, (vyq)localObject);
      paramBitmap = paramImageCreator;
      if (paramImageCreator == null) {
        paramBitmap = new vyr(this, paramString);
      }
      if (paramImageLoader != null)
      {
        paramImageLoader.a(paramView, localvyp);
        this.jdField_a_of_type_JavaUtilMap.put(paramView, new vys(paramBitmap, paramImageLoader, localvyp));
      }
      while (paramBoolean)
      {
        ...
        this.jdField_a_of_type_JavaUtilConcurrentExecutorService.execute(new vyn(this, (vyq)localObject, paramString, paramBitmap));
        return;
        if ((paramView instanceof ImageView)) {
          ((ImageView)paramView).setImageDrawable(localvyp);
        } else {
          paramView.setBackgroundDrawable(localvyp);
        }
      }
      paramBitmap = ((vyq)localObject).a(new Object[] { paramString, paramBitmap, Boolean.valueOf(false) });
    } while (paramBitmap == null);
    ((vyq)localObject).a(paramBitmap);
  }
  ...
  public boolean a(Object paramObject, View paramView)
  {
    ...
    if (paramView != null)
    {
      Object localObject = vyq.a(paramView);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\util\ImageWorker.class
