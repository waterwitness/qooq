...
{
  private static final String jdField_a_of_type_JavaLangString = "Q.qqhead.NearByFaceDecodeTask";
  ...
  protected void a()
  {
    ...
    do
    {
      ...
      if (((BitmapManager.BitmapDecodeResult)localObject2).e == 1)
      {
      ...
      i += 1;
    } while ((i < 2) && (((BitmapManager.BitmapDecodeResult)localObject2).e == 1));
    if ((QLog.isColorLevel()) || (((BitmapManager.BitmapDecodeResult)localObject2).e != 0)) {
      QLog.i("Q.qqhead.NearByFaceDecodeTask", 1, "doDecodeBitmap decode bitmap.faceInfo=" + this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo + ",result=" + ((BitmapManager.BitmapDecodeResult)localObject2).e + ", bmp=" + ((BitmapManager.BitmapDecodeResult)localObject2).jdField_a_of_type_AndroidGraphicsBitmap);
    }
    ...
    case 3: 
      for (((BitmapManager.BitmapDecodeResult)localObject2).jdField_a_of_type_AndroidGraphicsBitmap = ImageUtil.b(((BitmapManager.BitmapDecodeResult)localObject2).jdField_a_of_type_AndroidGraphicsBitmap, 50, 50);; ((BitmapManager.BitmapDecodeResult)localObject2).jdField_a_of_type_AndroidGraphicsBitmap = ImageUtil.a(((BitmapManager.BitmapDecodeResult)localObject2).jdField_a_of_type_AndroidGraphicsBitmap, 50, 50))
      {
        ...
        localException3.a(this.jdField_a_of_type_ComTencentMobileqqUtilFaceInfo.a(), ((BitmapManager.BitmapDecodeResult)localObject2).jdField_a_of_type_AndroidGraphicsBitmap);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\util\NearByFaceDecodeTask.class
