  ...
  extends View
{
  ...
  public TimeDownTextView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.jdField_a_of_type_AndroidTextTextPaint.setColor(Color.parseColor("#FEF900"));
    this.jdField_a_of_type_AndroidTextTextPaint.setTextSize(AIOUtils.a(16.0F, getResources()));
    ...
    this.jdField_b_of_type_AndroidTextTextPaint.setTextSize(AIOUtils.a(14.0F, getResources()));
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\portal\TimeDownTextView.class
