  ...
  implements WordMatchManager.WordMatcher
{
  ...
  protected int executeMatchTask(WordMatchManager.MatchTask paramMatchTask)
  {
    ...
    ThreadManager.b(new quy(this, arrayOfByte4, j, (int[])localObject6, arrayOfByte3, arrayOfByte2, arrayOfByte1, (byte[])localObject5));
  ...
  protected void onMatchResult(WordMatchManager.HotWordItem[] paramArrayOfHotWordItem)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqBusinessSougouWordMatchManager.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.runOnUiThread(new qux(this, paramArrayOfHotWordItem));
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\business\sougou\WordMatchManager$HotWordMatcher.class
