...
public class LoadingUI
{
  ...
  private static final String jdField_a_of_type_JavaLangString = "XProxy|LoadingUI";
  ...
  public void a(RelativeLayout paramRelativeLayout)
  {
    ...
    localObject1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130839484);
  ...
  public void a(RelativeLayout paramRelativeLayout, String paramString)
  {
    ...
    localObject = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130839482);
    this.jdField_c_of_type_AndroidWidgetImageView.setImageDrawable((Drawable)localObject);
    this.jdField_c_of_type_AndroidWidgetImageView.setOnClickListener(new swh(this));
  ...
  public void b()
  {
    this.jdField_a_of_type_ComTencentMobileqqIntervideoOdLoadingUI$Event = null;
  }
  ...
  public void b(RelativeLayout paramRelativeLayout)
  {
    ...
    this.g = (i + 1);
    ((ImageView)localObject1).setId(i);
    localObject1 = this.jdField_a_of_type_AndroidAppActivity.getResources().getDrawable(2130839483);
    ...
    ((Button)localObject1).setOnClickListener(new swi(this));
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\intervideo\od\LoadingUI.class
