...
public class SosoSrvAddrProvider
{
  ...
  vck jdField_a_of_type_Vck = new vck(this);
  ...
  public String a(SosoSrvAddrProvider.SosoSrvAddrType paramSosoSrvAddrType)
  {
    ...
    try
    {
      FileStorageServerListInfo localFileStorageServerListInfo = this.jdField_a_of_type_Vck.a(paramSosoSrvAddrType);
      paramSosoSrvAddrType = (SosoSrvAddrProvider.SosoSrvAddrType)localObject;
  ...
  public void a(FileStoragePushFSSvcList paramFileStoragePushFSSvcList)
  {
    try
    {
      ...
      this.jdField_a_of_type_Vck.a(paramFileStoragePushFSSvcList);
      return;
    }
    finally
    {
  ...
  public void a(SosoSrvAddrProvider.SosoSrvAddrType paramSosoSrvAddrType, String paramString)
  {
    try
    {
      this.jdField_a_of_type_Vck.a(paramSosoSrvAddrType, paramString);
      return;
    }
    finally
    {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\transfile\SosoSrvAddrProvider.class
