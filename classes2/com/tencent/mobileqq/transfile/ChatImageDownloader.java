  ...
  implements ProtocolDownloaderConstants
{
  ...
  private String a(ChatImageDownloader.DownloadData paramDownloadData, String paramString)
  {
    ...
    paramString = new CompressInfo(paramDownloadData.jdField_a_of_type_ComTencentMobileqqPicPicUploadInfo.g, 0);
    ...
    for (int i = 0;; i = 1) {
      try
      {
        ...
        if (((TranDbRecord.PicDbRecord)localObject).jdField_b_of_type_Int == 1)
        {
          ...
          if ((ActionMsgUtil.a(paramMessageRecord.msgtype)) || (paramMessageRecord.msgtype == 62535) || (paramMessageRecord.msgtype == 35534) || (paramMessageRecord.msgtype == 35533)) {
            continue;
          }
          if (i == 0)
          {
  ...
  public static void a(Object paramObject, String paramString1, String paramString2)
  {
    if ((paramObject instanceof ChatImageDownloader.DownloadData)) {
      if (QLog.isColorLevel())
      {
        ...
        if (((ChatImageDownloader.DownloadData)paramObject).jdField_a_of_type_ComTencentMobileqqPicPicUploadInfo == null) {
          break label58;
        }
        i = RichMediaUtil.a(((ChatImageDownloader.DownloadData)paramObject).jdField_a_of_type_Int);
        RichMediaUtil.c(((ChatImageDownloader.DownloadData)paramObject).jdField_a_of_type_ComTencentMobileqqPicPicUploadInfo.jdField_b_of_type_Int, false, i, String.valueOf(((ChatImageDownloader.DownloadData)paramObject).jdField_a_of_type_ComTencentMobileqqPicPicUploadInfo.jdField_a_of_type_Long), paramString1, paramString2);
      }
    }
    label58:
    while (!QLog.isColorLevel())
    {
      do
      {
        int i;
        return;
        if (((ChatImageDownloader.DownloadData)paramObject).jdField_a_of_type_ComTencentMobileqqPicPicDownloadInfo != null)
        {
          i = RichMediaUtil.a(((ChatImageDownloader.DownloadData)paramObject).jdField_a_of_type_Int);
          RichMediaUtil.c(((ChatImageDownloader.DownloadData)paramObject).jdField_a_of_type_ComTencentMobileqqPicPicDownloadInfo.jdField_b_of_type_Int, false, i, String.valueOf(((ChatImageDownloader.DownloadData)paramObject).jdField_a_of_type_ComTencentMobileqqPicPicDownloadInfo.jdField_a_of_type_Long), paramString1, paramString2);
          return;
        }
      } while (!QLog.isColorLevel());
  ...
  TransferResult a(ChatImageDownloader.DownloadData paramDownloadData)
  {
    ...
    try
    {
      ...
      if (paramDownloadData.jdField_a_of_type_ComTencentMobileqqDataMessageForPic != null)
      {
        paramDownloadData.jdField_a_of_type_ComTencentMobileqqPicPicDownloadInfo.d = paramDownloadData.jdField_a_of_type_ComTencentMobileqqDataMessageForPic.bEnableEnc;
        paramDownloadData.jdField_a_of_type_ComTencentMobileqqPicPicDownloadInfo.c = paramDownloadData.jdField_a_of_type_ComTencentMobileqqDataMessageForPic.time;
      }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\transfile\ChatImageDownloader.class
