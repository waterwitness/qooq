  ...
  extends BaseHandler
{
  ...
  void a(int paramInt, RichProto.RichProtoReq.ReqCommon paramReqCommon, cmd0x388.ReqBody paramReqBody)
  {
    ...
    localGetImgUrlReq.uint32_pic_up_timestamp.set(paramReqCommon.b);
  ...
  public void a(ProtoReqManager.ProtoResp paramProtoResp, ProtoReqManager.ProtoReq paramProtoReq)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          a(-1, 56009, BaseTransProcessor.a("P", -9529L), paramProtoResp.getMessage() + " hex:" + HexUtil.bytes2HexStr(arrayOfByte), localStatictisInfo, (RichProto.RichProtoResp.RespCommon)localObject);
        }
        if (paramProtoResp.jdField_a_of_type_Int == 65537) {
          if (GeneralConfigUtils.a()) {
            paramProtoResp = localGetImgUrlRsp.bytes_big_thumb_down_para.get().toStringUtf8();
          }
        }
        for (;;)
        {
        ...
        a(-1, 56009, BaseTransProcessor.a(i), "", localStatictisInfo, (RichProto.RichProtoResp.RespCommon)localObject);
      }
    }
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\transfile\protohandler\GroupPicDownHandler.class
