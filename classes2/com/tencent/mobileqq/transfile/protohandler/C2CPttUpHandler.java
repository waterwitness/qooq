  ...
  extends BaseHandler
{
  ...
  public void a(ProtoReqManager.ProtoResp paramProtoResp, ProtoReqManager.ProtoReq paramProtoReq)
  {
    ...
    for (;;)
    {
      ...
      {
        a(-1, 56009, BaseTransProcessor.a("P", -9529L), paramProtoResp.getMessage() + " hex:" + HexUtil.bytes2HexStr((byte[])localObject1), localStatictisInfo, localRichProtoResp.jdField_a_of_type_JavaUtilList);
      }
    }
    ...
    for (;;)
    {
      ...
      do
      {
        ...
        paramProtoReq.b = localApplyUploadRsp.uint32_upload_port.get();
        localC2CPttUpResp.jdField_a_of_type_JavaUtilArrayList.add(paramProtoReq);
        a(0, 0, "", "", localStatictisInfo, localC2CPttUpResp);
        break;
        a(-1, 56009, BaseTransProcessor.a(i), "", localStatictisInfo, localC2CPttUpResp);
        break;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\transfile\protohandler\C2CPttUpHandler.class
