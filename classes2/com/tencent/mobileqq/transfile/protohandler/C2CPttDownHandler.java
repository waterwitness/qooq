  ...
  public void a(ProtoReqManager.ProtoResp paramProtoResp, ProtoReqManager.ProtoReq paramProtoReq)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if ((paramProtoResp != null) && (localFromServiceMsg != null)) {
          paramProtoResp.e = ((Boolean)localFromServiceMsg.getAttribute("_attr_send_by_quickHttp", Boolean.valueOf(false))).booleanValue();
        }
      ...
      {
        a(-1, 56009, BaseTransProcessor.a("P", -9529L), paramProtoResp.getMessage() + " hex:" + HexUtil.bytes2HexStr((byte[])localObject), localStatictisInfo, localRichProtoResp.jdField_a_of_type_JavaUtilList);
      }
      continue;
      label387:
  ...
  byte[] a(List paramList)
  {
    ...
    if (paramList.size() == 1)
    {
      ...
      if ("ftn".equals(paramList.jdField_b_of_type_JavaLangString))
      {
        ...
        localReqBody.uint32_business_id.set(this.aH);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\transfile\protohandler\C2CPttDownHandler.class
