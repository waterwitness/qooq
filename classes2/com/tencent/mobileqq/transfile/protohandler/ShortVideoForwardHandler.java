...
public class ShortVideoForwardHandler
  extends BaseHandler
{
  public static final String e = "Q.richmedia.ShortVideoForwardHandler";
  ...
  public void a(ProtoReqManager.ProtoResp paramProtoResp, ProtoReqManager.ProtoReq paramProtoReq)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        a(-1, 56009, BaseTransProcessor.a("P", -9529L), paramProtoResp.getMessage() + " hex:" + HexUtil.bytes2HexStr(arrayOfByte), localStatictisInfo, paramProtoReq);
        break;
      ...
      else
      {
        ...
        a(-1, 56009, BaseTransProcessor.a(i), "", localStatictisInfo, paramProtoResp);
      }
    }
  }
  ...
  byte[] a(List paramList)
  {
    ...
    if (paramList.size() == 1)
    {
      ...
      localPttShortVideoRetweetReq.uint32_client_type.set(localShortVideoForwardReq.jdField_f_of_type_Int);
      ...
      if (localShortVideoForwardReq.jdField_f_of_type_JavaLangString == null)
      {
        paramList = "";
      ...
      for (;;)
      {
        try
        {
          ...
          paramList = localShortVideoForwardReq.jdField_f_of_type_JavaLangString;
        }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\transfile\protohandler\ShortVideoForwardHandler.class
