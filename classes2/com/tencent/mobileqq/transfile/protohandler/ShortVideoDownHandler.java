  ...
  extends BaseHandler
{
    ...
    for (;;)
    {
          ...
          if (((RichProto.RichProtoResp.ShortVideoDownResp)localObject).jdField_a_of_type_Int == 0)
          {
            ...
            while (i < localList.size())
            {
              ...
              if (paramProtoResp.length == 2) {
                localServerAddr.jdField_b_of_type_Int = Integer.valueOf(paramProtoResp[1]).intValue();
              }
      ...
      if ((((RichProto.RichProtoResp.ShortVideoDownResp)localObject).jdField_a_of_type_JavaUtilArrayList.size() == 0) && (((RichProto.RichProtoResp.ShortVideoDownResp)localObject).jdField_b_of_type_JavaLangString == null))
      {
        ...
        while (i < paramProtoResp.size())
        {
          ...
          paramProtoReq.jdField_b_of_type_Int = j;
  ...
  public void a(RichProto.RichProtoReq paramRichProtoReq)
  {
    ...
    for (;;)
    {
      ...
      return;
      label96:
      if ((1 == localReqCommon.e) || (3000 == localReqCommon.e)) {
  ...
  byte[] a(List paramList)
  {
    ...
    if (paramList.size() == 1)
    {
      ...
      for (;;)
      {
        ...
        localPttShortVideoDownloadReq.uint32_business_type.set(paramList.f);
        ...
        localPttShortVideoDownloadReq.uint64_fromuin.set(Long.parseLong(paramList.e));
        break;
        label359:
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\transfile\protohandler\ShortVideoDownHandler.class
