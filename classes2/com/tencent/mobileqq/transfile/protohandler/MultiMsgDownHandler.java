  ...
  extends BaseHandler
{
  ...
  private void a(int paramInt, RichProto.RichProtoReq.ReqCommon paramReqCommon, MultiMsg.ReqBody paramReqBody)
  {
    ...
    localMultiMsgApplyDownReq.uint32_msg_type.set(MultiMsgUpHandler.b(paramReqCommon.e));
  ...
  public void a(ProtoReqManager.ProtoResp paramProtoResp, ProtoReqManager.ProtoReq paramProtoReq)
  {
    ...
    for (;;)
    {
      ...
      {
        a(-1, 56009, BaseTransProcessor.a("P", -9529L), paramProtoResp.getMessage() + " hex:" + HexUtil.bytes2HexStr(arrayOfByte1), localStatictisInfo, localRichProtoResp.jdField_a_of_type_JavaUtilList);
      }
    }
    int i = 0;
    label229:
    ...
    a(-1, 56009, BaseTransProcessor.a("P", -9529L), paramProtoResp.getMessage() + " hex:" + HexUtil.bytes2HexStr(arrayOfByte1), localStatictisInfo, (RichProto.RichProtoResp.RespCommon)localObject1);
    for (;;)
    {
      i += 1;
      break label229;
      ...
      a(-1, 56009, BaseTransProcessor.a(j), "", localStatictisInfo, (RichProto.RichProtoResp.RespCommon)localObject1);
    }
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\transfile\protohandler\MultiMsgDownHandler.class
