  ...
  private void a(DownloadParams paramDownloadParams, OutputStream paramOutputStream, URLDrawableHandler paramURLDrawableHandler, boolean paramBoolean)
  {
    ...
    if ((paramDownloadParams.tag != null) && ((paramDownloadParams.tag instanceof MessageForPic)))
    {
      ...
      if (((MessageForPic)localObject6).isSendFromLocal()) {
        if (i == 65537) {
          if ((((MessageForPic)localObject6).isShareAppActionMsg) || (((MessageForPic)localObject6).msgtype == 62535))
          {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          if (!localDownloaderHttpMsg.jdField_a_of_type_Boolean)
          {
            ...
            ((FileMsg.StepTransInfo)localObject4).jdField_a_of_type_JavaLangString = localDownloaderHttpMsg.aj;
            throw new FileDownloadFailedException(localDownloaderHttpMsg.h, localDownloaderHttpMsg.c, localDownloaderHttpMsg.aj, false);
          }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\transfile\LBSImageDownloader.class
