...
public class DynamicAvatarConfig
{
  ...
  private static final String b = "DynamicAvatarConfig";
  public String a;
  public boolean a;
  public int b;
  public boolean b;
  ...
  public void a()
  {
    ...
    for (;;)
    {
      ...
      catch (Exception localException)
      {
        ...
        QLog.d("DynamicAvatarConfig", 2, "adjust samllSizeFPS:" + this.jdField_d_of_type_Int);
        ...
        QLog.d("DynamicAvatarConfig", 2, "adjust bigSizeFPS:" + this.jdField_e_of_type_Int);
        this.jdField_e_of_type_Int = 18;
      }
      ...
      this.j = true;
      this.jdField_b_of_type_Int = Integer.valueOf(localObject[7]).intValue();
      this.jdField_c_of_type_Int = Integer.valueOf(localObject[8]).intValue();
      this.jdField_d_of_type_Int = Integer.valueOf(localObject[9]).intValue();
      this.jdField_e_of_type_Int = Integer.valueOf(localObject[10]).intValue();
  ...
  public String toString()
  {
    ...
    localStringBuilder.append("dpcString:").append(this.jdField_a_of_type_JavaLangString).append(",isPlayInAll:").append(this.jdField_b_of_type_Boolean).append(",isPlayInMsgTab:").append(this.jdField_c_of_type_Boolean).append(",isPlayInContacts:").append(this.jdField_d_of_type_Boolean).append(",isPlayInNearList:").append(this.jdField_e_of_type_Boolean).append(",isPlayInFriendProfile:").append(this.f).append(",isPlayInNearProfile:").append(this.g).append(",isPlayInTroopProfile:").append(this.h).append(",maxPlayingCount:").append(this.jdField_b_of_type_Int).append(",maxPlayCountOneDay:").append(this.jdField_c_of_type_Int).append(",bigSizeFPS:").append(this.jdField_e_of_type_Int).append(",smallSizeFPS:").append(this.jdField_d_of_type_Int).append(",isConvsPlayAfterKill:").append(this.i).append(",isContactPlayAfterKill:").append(this.j).append(",isUseDefault:").append(this.jdField_a_of_type_Boolean);
    return localStringBuilder.toString();
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\avatar\dynamicavatar\DynamicAvatarConfig.class
