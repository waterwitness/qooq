...
public class OrientationAdapterImageView
  extends View
{
  protected static final String a = "OrientationAdapterImageView";
  public int a;
  public Bitmap a;
  protected Paint a;
  protected RectF a;
  ...
  public OrientationAdapterImageView(Context paramContext)
  {
    ...
    this.jdField_a_of_type_AndroidOsHandler = new vvs(this);
    a(paramContext);
  }
  ...
  {
    if (((paramInt >= 0) && (paramInt <= 45)) || (paramInt > 315)) {}
    do
    {
      return 0;
  ...
  public void a(int paramInt)
  {
    ...
    if (this.jdField_a_of_type_Int != paramInt)
    {
      ...
      this.jdField_a_of_type_AndroidOsHandler.sendEmptyMessageDelayed(0, 600L);
    }
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\troopreward\OrientationAdapterImageView.class
