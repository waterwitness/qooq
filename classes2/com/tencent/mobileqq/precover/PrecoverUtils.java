...
public class PrecoverUtils
{
  ...
  public static final String a = "PrecoverUtils";
  public static final String b = "res_precover";
  public static final String c = "PRECOVER_SP_NAME";
  public static final String d = "key_config_version_pre_";
  
  public PrecoverUtils()
  {
  ...
  {
    return a(paramQQAppInterface.f()).getInt("acount_first_login_app" + paramInt, 0);
  }
  
  public static int a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    return paramQQAppInterface.a().getSharedPreferences("PRECOVER_SP_NAME", 0).getInt(paramString, paramInt);
  }
  
  public static SharedPreferences a(String paramString)
  {
    return BaseApplicationImpl.getContext().getSharedPreferences("PRECOVER_SP_NAME" + paramString, 0);
  }
            ...
            if ("PrecoverRes".equalsIgnoreCase((String)localObject1))
            {
              ...
              else
              {
                ...
                if ("url".equalsIgnoreCase((String)localObject6))
                {
                  ...
                  {
                    localObject3 = paramString;
                    ((PrecoverResource)localObject2).url = localXmlPullParser.nextText();
                    localObject7 = localObject2;
                    localObject4 = paramString;
                    localObject5 = localObject1;
                  }
                ...
                else
                {
                  ...
                  if ("md5".equalsIgnoreCase((String)localObject6)) {
                    ...
                    {
                      localObject3 = paramString;
                      ((PrecoverResource)localObject2).md5 = localXmlPullParser.nextText();
                      localObject3 = paramString;
  ...
  {
    if (SystemUtil.a()) {
      return AppConstants.bj + "res_precover";
    }
    return BaseApplicationImpl.a().getFilesDir() + File.separator + "res_precover";
  }
  ...
  {
    paramQQAppInterface = a(paramQQAppInterface.f()).edit();
    paramQQAppInterface.putInt("key_config_version_pre_" + paramInt1, paramInt2);
    paramQQAppInterface.commit();
  }
  
  public static void a(QQAppInterface paramQQAppInterface, String paramString, int paramInt)
  {
    paramQQAppInterface.a().getSharedPreferences("PRECOVER_SP_NAME", 0).edit().putInt(paramString, paramInt).commit();
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\precover\PrecoverUtils.class
