  ...
  extends View
{
  ...
  public LockPatternView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    {
      setClickable(true);
      this.s = getResources().getColor(2131427465);
      this.t = getResources().getColor(2131427466);
      this.u = getResources().getDimensionPixelSize(2131493075);
      ...
      this.jdField_g_of_type_Int = getResources().getColor(2131427470);
      this.h = getResources().getColor(2131427471);
      this.i = getResources().getColor(2131427472);
      this.j = getResources().getColor(2131427473);
      this.k = getResources().getColor(2131427474);
      this.l = getResources().getColor(2131427475);
      this.m = getResources().getColor(2131427476);
      this.n = getResources().getColor(2131427477);
      this.o = getResources().getColor(2131427478);
      this.jdField_g_of_type_Float = getResources().getDimensionPixelSize(2131493076);
      this.p = (getWidth() / 4);
      this.q = (getHeight() / 4);
      ...
      if ("lock_width".equals(paramAttributeSet)) {
        this.r = 1;
      } else if ("lock_height".equals(paramAttributeSet)) {
        this.r = 2;
      } else {
        this.r = 0;
      }
  ...
  private LockPatternView.Cell a(float paramFloat1, float paramFloat2)
  {
    ...
    for (i2 = i3 + i2;; i2 = i3)
    {
      ...
      return (LockPatternView.Cell)localObject1;
      i1 = -1;
      break;
    }
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\gesturelock\LockPatternView.class
