...
public class PngFrameUtil
{
      ...
      try
      {
        ...
        if (paramString1.has("process_frame"))
        {
          ...
          if ((localObject != null) && (((JSONArray)localObject).length() > 0))
          {
            ...
            {
              localPngPlayParam.jdField_a_of_type_ArrayOfJavaLangString[i] = (EmoticonUtils.t.replace("[epId]", paramString2) + ((JSONArray)localObject).getString(i));
              i += 1;
            }
          }
        }
        ...
        for (;;)
        {
          ...
          localPngPlayParam.jdField_b_of_type_ArrayOfJavaLangString[i] = (EmoticonUtils.t.replace("[epId]", paramString2) + ((JSONArray)localObject).getString(i));
          i += 1;
        }
  ...
  private String a(String paramString)
  {
    ...
    localStringBuffer.append(EmoticonUtils.t.replace("[epId]", paramString));
  ...
  public static boolean a(String paramString)
  {
    ...
    if (!paramString.exists())
    {
      if (QLog.isColorLevel()) {
        QLog.d(a, 2, "func checkRandomPngExist, file NOT exist.[" + paramString.getAbsolutePath() + "].");
      }
      return false;
    }
    ...
    {
      if (QLog.isColorLevel()) {
        QLog.d(a, 2, "func checkRandomPngExist, file NOT exist.[" + ((File)localObject1).getAbsolutePath() + "].");
      }
      return false;
    }
    for (;;)
    {
      ...
      try
      {
        ...
        if (((JSONObject)localObject2).has("seq_array"))
        {
          ...
          if (((JSONArray)localObject2).length() > 0)
          {
            ...
            if (i < ((JSONArray)localObject2).length())
            {
              ...
              QLog.d(a, 2, "func checkRandomPngExist, file NOT exist.[" + localFile.getAbsolutePath() + "].");
              break label391;
            }
          }
        }
        ...
        if (((JSONArray)localObject1).length() > 0)
        {
          ...
          if (i < ((JSONArray)localObject1).length())
          {
            ...
            {
              if (QLog.isColorLevel()) {
                QLog.d(a, 2, "func checkRandomPngExist, file NOT exist.[" + ((File)localObject2).getAbsolutePath() + "].");
              }
              return false;
            }
            i += 1;
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.w(a, 2, "func checkRandomPngExist, exception:" + paramString.getMessage());
        }
        return false;
      }
      label391:
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\magicface\drawable\PngFrameUtil.class
