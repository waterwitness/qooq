  ...
  implements ActionGlobalData.ActionCountdownOver, MagicfaceContainerView.MagicfaceGestureListener
{
  ...
  public long a;
  private ShakeListener jdField_a_of_type_ComTencentMobileqqAppShakeListener = new tbb(this);
  public Emoticon a;
  public Action a;
  public ActionGlobalData a;
  public MagicfaceActionDecoder a;
  public MagicfaceResLoader a;
  private RecordVolume jdField_a_of_type_ComTencentMobileqqMagicfaceModelRecordVolume = new RecordVolume(new tbc(this));
  ...
  private MagicfaceActionManager.MagicfaceSensorOperation jdField_a_of_type_ComTencentMobileqqMagicfaceServiceMagicfaceActionManager$MagicfaceSensorOperation = new taz(this);
  ...
  {
    MagicfaceResLoader localMagicfaceResLoader = new MagicfaceResLoader(EmoticonUtils.j.replace("[epId]", paramEmoticon.epId));
    paramEmoticon = null;
    if (paramInt == 0) {
  ...
  public static ActionGlobalData a(Emoticon paramEmoticon, int paramInt1, int paramInt2)
  {
    if (paramInt2 == 1)
    {
      paramEmoticon = new MagicfaceResLoader(EmoticonUtils.j.replace("[epId]", paramEmoticon.epId));
      if (paramInt1 != 0) {
        break label100;
      }
    ...
    for (;;)
    {
      if (paramEmoticon == null)
      {
        do
        {
          ...
          if (paramInt2 == 2)
          {
            paramEmoticon = new MagicfaceResLoader(EmoticonUtils.i.replace("[epId]", paramEmoticon.epId), 2);
            break;
          }
        } while (paramInt2 != 3);
        paramEmoticon = new MagicfaceResLoader(EmoticonUtils.j.replace("[epId]", paramEmoticon.epId), 3);
        break;
        label100:
        if (paramInt1 != 1) {
          break label127;
  ...
  private void a(int paramInt)
  {
    ...
    if (paramInt == 1) {
      this.jdField_a_of_type_ComTencentMobileqqMagicfaceModelMagicfaceResLoader = new MagicfaceResLoader(EmoticonUtils.j.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId));
    }
    for (;;)
    {
      ...
      return;
      if (paramInt == 2) {
        this.jdField_a_of_type_ComTencentMobileqqMagicfaceModelMagicfaceResLoader = new MagicfaceResLoader(EmoticonUtils.i.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId), 2);
      } else if (paramInt == 3) {
        this.jdField_a_of_type_ComTencentMobileqqMagicfaceModelMagicfaceResLoader = new MagicfaceResLoader(EmoticonUtils.j.replace("[epId]", this.jdField_a_of_type_ComTencentMobileqqDataEmoticon.epId), 3);
      }
    }
  }
  ...
  private void c(ActionGlobalData paramActionGlobalData)
  {
    if ("mic".equalsIgnoreCase(paramActionGlobalData.j)) {
      ThreadManager.d(this.jdField_a_of_type_ComTencentMobileqqMagicfaceModelRecordVolume);
    }
    do
    {
      return;
  ...
  public void a(Emoticon paramEmoticon, int paramInt1, String paramString, int paramInt2)
  {
    ...
    this.g = paramString;
    ThreadManager.a(new tba(this, paramInt2, paramInt1), 8, null, true);
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\magicface\service\MagicfaceActionManager.class
