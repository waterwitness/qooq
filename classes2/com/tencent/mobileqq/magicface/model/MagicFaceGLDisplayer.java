...
public class MagicFaceGLDisplayer
{
  ...
  public void a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat, boolean paramBoolean)
  {
    ...
    do
    {
      for (;;)
      {
        ...
        try
        {
          ...
          if ((this.j != 63521) && (this.k != 63521) && (this.l != 63521) && (this.p != 63521) && (this.q != 63521) && (this.r != 63521))
          {
    ...
    QLog.w(jdField_a_of_type_JavaLangString, 2, "ooooom happens.");
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\com\tencent\mobileqq\magicface\model\MagicFaceGLDisplayer.class
