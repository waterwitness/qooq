  ...
  implements Runnable
{
  ...
  public xtf(Gallery paramGallery)
  {
  ...
  private void b(boolean paramBoolean)
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetGallery.jdField_a_of_type_ComTencentWidgetGallery$OnScollListener != null) {
      this.jdField_a_of_type_ComTencentWidgetGallery.jdField_a_of_type_ComTencentWidgetGallery$OnScollListener.a(this.jdField_a_of_type_ComTencentWidgetGallery.aF);
    }
    if (Gallery.c(this.jdField_a_of_type_ComTencentWidgetGallery) == 2)
    {
      this.jdField_a_of_type_ComTencentWidgetGallery.a(this.jdField_a_of_type_ComTencentWidgetGallery.aF, this.jdField_a_of_type_ComTencentWidgetGallery.getChildAt(0), this.jdField_a_of_type_ComTencentWidgetGallery);
  ...
  {
    this.jdField_a_of_type_ComTencentWidgetOverScroller.a(paramInt1, 0, paramInt2, 0, Integer.MIN_VALUE, Integer.MAX_VALUE, 0, 0);
  ...
  public void a(int paramInt1, int paramInt2)
  {
    ...
    this.jdField_a_of_type_ComTencentWidgetGallery.jdField_a_of_type_ComTencentWidgetGallery$OnScollListener.b(this.jdField_a_of_type_ComTencentWidgetGallery.aF);
  }
  ...
  public void run()
  {
    ...
    if (this.jdField_a_of_type_ComTencentWidgetGallery.aG == 0)
    {
      b(true);
      return;
    }
    ...
    if (this.jdField_a_of_type_Boolean)
    {
      ...
      if (Gallery.b(this.jdField_a_of_type_ComTencentWidgetGallery))
      {
        ...
        f2 = Gallery.a(this.jdField_a_of_type_ComTencentWidgetGallery, this.jdField_a_of_type_ComTencentWidgetGallery.jdField_a_of_type_AndroidViewView);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\xtf.class
