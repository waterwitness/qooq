  ...
  implements Handler.Callback, PluginManagerHelper.OnPluginManagerLoadedListener
{
  ...
  private void a(String paramString, PluginBaseInfo paramPluginBaseInfo)
  {
    ...
    if ((-2 != paramPluginBaseInfo.mState) && (4 != paramPluginBaseInfo.mState) && (!NetworkUtil.h(BaseApplicationImpl.getContext())) && (System.currentTimeMillis() - this.jdField_a_of_type_Long > 5000L))
    {
      a(-4);
      return;
    }
  ...
  public void a(Activity paramActivity, AppRuntime paramAppRuntime, String paramString1, Intent paramIntent, String paramString2, int paramInt, DialogInterface.OnDismissListener paramOnDismissListener, Class paramClass)
  {
    ...
    paramAppRuntime = new QQProgressDialog(paramActivity, paramActivity.getResources().getDimensionPixelSize(2131492908));
    if ((!bool) || (paramOnDismissListener != null))
    {
      paramAppRuntime.a("正在加载...");
      paramAppRuntime.setOnDismissListener(new yst(this, paramOnDismissListener));
      if (bool) {
        paramAppRuntime.setOnShowListener(new ysu(this, paramAppRuntime));
      }
    }
    for (;;)
    {
      paramOnDismissListener = (QQAppInterface)BaseApplicationImpl.a().a();
      ((SmartDeviceProxyMgr)paramOnDismissListener.a(51)).b();
  ...
  public void onPluginManagerLoaded(PluginManagerClient paramPluginManagerClient)
  {
    ...
    if (QLog.isColorLevel()) {
      QLog.i(c, 2, "[SmartDevicePluginLoader] onPluginManagerLoaded SUPPORT_NETWORKING:true");
    }
    ...
    if (paramPluginManagerClient != null) {
      ...
      {
        if (QLog.isColorLevel()) {
          QLog.d(c, 2, "[SmartDevicePluginLoader] plugin is installed");
        }
        this.jdField_a_of_type_Boolean = true;
        b(0);
        b();
    ...
    for (;;)
    {
      ...
      return;
      if (QLog.isColorLevel()) {
        QLog.i(c, 2, "[SmartDevicePluginLoader] onPluginManagerLoaded start down or install...");
      }
      this.jdField_a_of_type_ComTencentMobileqqPluginsdkPluginManagerClient.installPlugin("qqsmartdevice.apk");
      i = 0;
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\smartdevice\SmartDevicePluginLoader.class
