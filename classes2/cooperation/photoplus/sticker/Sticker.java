  ...
  extends Entity
{
  ...
  public JSONObject toJsonObject()
  {
    try
    {
      ...
      localJSONObject.put("thumbPath", PhotoPlusManager.b + getUnzippedDir() + getThumbImageFileName());
      localJSONObject.put("path", PhotoPlusManager.b + getUnzippedDir() + getImageFileName());
      localJSONObject.put("version", this.version);
      localJSONObject.put("priority", this.priority);
      localJSONObject.put("type", this.type);
      localJSONObject.put("jsonPath", PhotoPlusManager.b + getUnzippedDir() + getJsonFileName());
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\photoplus\sticker\Sticker.class
