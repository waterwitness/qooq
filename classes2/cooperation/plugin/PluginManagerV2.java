  ...
  implements Handler.Callback, PluginDownloader.OnPluginDownLoadListener, PluginInstaller.OnPluginSetupListener, PluginUpdater.OnPluginInfoUpdateListener
{
  ...
  private static ProgressDialog a(Context paramContext, String paramString, DialogInterface.OnClickListener paramOnClickListener)
  {
    ...
    paramContext.setButton(-2, "取消", new ydz(paramOnClickListener));
    return paramContext;
  }
  ...
  private void a(int paramInt, boolean paramBoolean, Context paramContext, IPluginManager.PluginParams paramPluginParams, IPluginManager.OnPluginReadyListener paramOnPluginReadyListener)
  {
    ...
    do
    {
      ...
      if (paramInt == 1)
      {
        ...
        for (localObject1 = "";; localObject1 = ((PluginInfo)localObject1).mName)
        {
          ...
          localLaunchState.jdField_a_of_type_AndroidAppProgressDialog = a(paramContext, (String)localObject1, new yea(this, paramPluginParams.b, null));
          a((String)localObject2, paramBoolean, new yec(this, localLaunchState));
          return;
        }
      }
    } while (paramInt != 3);
    ...
    a((String)localObject1, paramBoolean, new yec(this, (PluginManagerV2.LaunchState)localObject2));
  }
  ...
  private PluginInfo b(String paramString)
  {
    ...
    for (;;)
    {
      ...
      return (PluginInfo)localObject2;
  ...
  private void c(Context paramContext, IPluginManager.PluginParams paramPluginParams, IPluginManager.OnPluginReadyListener paramOnPluginReadyListener)
  {
    ...
    do
    {
      do
      {
        return;
        if (QLog.isColorLevel()) {
          QLog.d("plugin_tag", 2, "checkUpdate:" + paramPluginParams.b);
        }
        if ((this.d) || (BuiltinPluginManager.b(paramPluginParams.b))) {
          break;
        }
      ...
      if ((!PluginInfoUtil.a(localPluginInfo, this.jdField_a_of_type_AndroidAppApplication)) || (localObject == null)) {
        break;
      }
      if (QLog.isColorLevel()) {
    ...
    for (;;)
    {
      ...
      {
        paramPluginParams = new yeb(this, paramOnPluginReadyListener, bool2, paramContext, paramPluginParams, bool3, null);
    ...
    for (;;)
    {
      try
      {
        ...
        if (!this.jdField_b_of_type_Boolean)
        {
          ...
          if (!NetworkUtil.h(this.jdField_a_of_type_AndroidAppApplication)) {
            a(false);
          } else {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\plugin\PluginManagerV2.class
