...
public class ThirdPayGate
{
  ...
  private void _newInstallPlugin(Activity paramActivity, PluginInterface paramPluginInterface, Bundle paramBundle, String paramString)
  {
    ...
    Object localObject2 = new yte(this, paramBundle, paramActivity);
    localObject2 = DialogUtil.a(paramActivity, 0, "下载失败", "当前网络不给力，下载失败", "取消", "继续下载", new ytf(this, paramString, paramPluginInterface, paramActivity, paramBundle), (DialogInterface.OnClickListener)localObject2);
    ((QQCustomDialog)localObject2).setCancelable(false);
    Object localObject1 = new yth(this, paramPluginInterface, paramString, System.currentTimeMillis(), new ytg(this, paramString, l, (Channel)localObject1, paramBundle, paramActivity, (QQCustomDialog)localObject2));
  ...
  private void _showStartAllTip(Activity paramActivity, PluginInterface paramPluginInterface, Bundle paramBundle, String paramString)
  {
    ...
    {
      float f = new BigDecimal((float)localChannel.pluginSize * 1.0E-6F).setScale(3, 4).floatValue();
      new StringBuilder().append("").append(f).toString();
    }
    this.startDialog.show();
    if (NetworkUtil.h(paramActivity))
    {
    ...
    paramActivity = DialogUtil.a(paramActivity, 0, "", "当前网络不可用，请检查网络设置！", "确定", "", null, new ytd(this, paramBundle, paramActivity));
  ...
  private void startPlugin(Bundle paramBundle, Activity paramActivity, String paramString)
  {
    for (;;)
    {
      ...
      catch (Exception localException1)
      {
        ...
        paramBundle = new ytc(this, paramBundle, paramActivity);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\thirdpay\ThirdPayGate.class
