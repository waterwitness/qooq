  ...
  extends PluginProxyActivity
{
  ...
  public NFCPayPluginProxyActivity()
  {
  ...
  private void a()
  {
    ...
    if (this.jdField_a_of_type_AndroidNfcNfcAdapter != null) {
      if (!this.jdField_a_of_type_AndroidNfcNfcAdapter.isEnabled()) {
        DialogUtil.a(this, 0, "", "请到设置界面打开NFC功能", new yta(this), new ytb(this)).show();
      }
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\thirdpay\NFCPayPluginProxyActivity.class
