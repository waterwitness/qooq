  ...
  implements Manager
{
  ...
  private static final String jdField_a_of_type_JavaLangString = "DingdongPluginManager";
  private static final String jdField_b_of_type_JavaLangString = "dingdong.lastmsg.feedid";
  private static final String c = "dingdong.lastmsg.modifiedtime";
  private static final String d = "_schedule_del_data";
  private FriendListObserver jdField_a_of_type_ComTencentMobileqqAppFriendListObserver = new ybb(this);
  ...
  private boolean a(boolean paramBoolean)
  {
    ...
    try
    {
      ...
      if (paramBoolean)
      {
        localJSONObject.put("actionUin", AppConstants.aT);
  ...
  {
    int i = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(AppConstants.aT, 9999);
    if (paramInt1 == i) {
    ...
    {
      return;
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().c(AppConstants.aT, 9999, paramInt1 - i);
      a(true);
      this.n = paramInt1;
      this.o = paramInt2;
    } while (!QLog.isColorLevel());
    QLog.i("DingdongPluginManager", 2, "setUnreadNum:mCacheUnreadVersion[" + this.o + "], mCacheUnreadNum[" + this.n + "]");
  }
  ...
  public void a(long paramLong)
  {
    ...
    for (;;)
    {
      ...
      {
        ybd localybd = (ybd)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramLong));
        if (localybd == null)
        {
          if (QLog.isColorLevel()) {
          ...
          ((DingdongPluginDataFactory.ScheduleSummaryData)localObject2).id = localybd.jdField_a_of_type_JavaLangString;
          ...
          localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a() + "_schedule_del_data", 0);
          ((SharedPreferences)localObject2).edit().putLong(localybd.jdField_a_of_type_JavaLangString, localybd.b);
      ...
      {
        i = ((ybd)localObject1).jdField_a_of_type_Int;
        break;
      }
    }
  }
  ...
  public void a(QQAppInterface paramQQAppInterface)
  {
    ...
    paramQQAppInterface = new Intent(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getApplicationContext(), ScheduleTipsDialog.class);
    paramQQAppInterface.setFlags(335544320);
    this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().getApplicationContext().startActivity(paramQQAppInterface);
  }
  ...
  public void a(DingdongPluginBizObserver.FeedConfirmNotifyData paramFeedConfirmNotifyData)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      switch (paramFeedConfirmNotifyData.jdField_d_of_type_Int)
      {
      default: 
        ...
        ((Intent)localObject1).putExtra("_changed_type_", paramFeedConfirmNotifyData.jdField_d_of_type_Int);
      ...
      if (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().equals(paramFeedConfirmNotifyData.jdField_d_of_type_JavaLangString))
      {
        localObject1 = DingdongPluginHelper.a(paramFeedConfirmNotifyData.jdField_b_of_type_Int, paramFeedConfirmNotifyData.jdField_b_of_type_JavaLangString, paramFeedConfirmNotifyData.jdField_c_of_type_JavaLangString) + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131362489);
        if (2 != paramFeedConfirmNotifyData.jdField_d_of_type_Int) {
          break label534;
        }
        localObject1 = (String)localObject1 + this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131362488);
        bool = false;
      }
    }
    for (;;)
    {
      String str = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131362491);
      ...
      localObject2 = (MessageForGrayTips)MessageRecordFactory.a(63502);
      ((MessageForGrayTips)localObject2).init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), paramFeedConfirmNotifyData.jdField_b_of_type_JavaLangString, paramFeedConfirmNotifyData.jdField_c_of_type_JavaLangString, (String)localObject1, NetConnInfoCenter.getServerTime(), 63502, DingdongPluginHelper.c(paramFeedConfirmNotifyData.jdField_b_of_type_Int), 0L);
      ...
      ((MessageForGrayTips)localObject2).isread = bool;
      ...
      break;
      localObject1 = String.format(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131362490), new Object[] { DingdongPluginHelper.a(paramFeedConfirmNotifyData.jdField_b_of_type_Int, paramFeedConfirmNotifyData.jdField_b_of_type_JavaLangString, paramFeedConfirmNotifyData.jdField_d_of_type_JavaLangString) });
      bool = true;
      continue;
  ...
  public void a(DingdongPluginBizObserver.FeedStateUpdateData paramFeedStateUpdateData)
  {
    ...
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      switch (paramFeedStateUpdateData.jdField_d_of_type_Int)
      {
      case 2: 
      case 3: 
      default: 
        ...
        ((Intent)localObject).putExtra("_changed_type_", paramFeedStateUpdateData.jdField_d_of_type_Int);
      ...
      bool2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().equals(paramFeedStateUpdateData.jdField_c_of_type_JavaLangString);
      if ((!bool2) || (1 != paramFeedStateUpdateData.jdField_d_of_type_Int) || (this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a().b(AppConstants.aT, 9999) != null)) {
        break label379;
      }
    }
    label379:
    ...
    {
      ((DingdongPluginBizHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(75)).a(bool1);
      if ((!bool2) || (6 != paramFeedStateUpdateData.jdField_d_of_type_Int)) {
        break;
      }
      localObject = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131362492);
      MessageForGrayTips localMessageForGrayTips = (MessageForGrayTips)MessageRecordFactory.a(63502);
      localMessageForGrayTips.init(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), paramFeedStateUpdateData.jdField_b_of_type_JavaLangString, paramFeedStateUpdateData.jdField_c_of_type_JavaLangString, (String)localObject, NetConnInfoCenter.getServerTime(), 63502, DingdongPluginHelper.c(paramFeedStateUpdateData.jdField_b_of_type_Int), 0L);
  ...
  public void a(DingdongPluginBizObserver.NodeUpdateData paramNodeUpdateData)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      if (paramNodeUpdateData.jdField_a_of_type_Int == 0)
      {
        if ((paramNodeUpdateData.jdField_a_of_type_ComTencentMobileqqAppUtilsDingdongPluginBizObserver$LastMsgUpdateData != null) && (paramNodeUpdateData.jdField_a_of_type_ComTencentMobileqqAppUtilsDingdongPluginBizObserver$LastMsgUpdateData.jdField_a_of_type_Int == 0)) {
          a(paramNodeUpdateData.jdField_a_of_type_ComTencentMobileqqAppUtilsDingdongPluginBizObserver$LastMsgUpdateData.jdField_a_of_type_JavaLangString, paramNodeUpdateData.jdField_a_of_type_ComTencentMobileqqAppUtilsDingdongPluginBizObserver$LastMsgUpdateData.jdField_b_of_type_Int, paramNodeUpdateData.jdField_a_of_type_ComTencentMobileqqAppUtilsDingdongPluginBizObserver$LastMsgUpdateData.jdField_b_of_type_JavaLangString, paramNodeUpdateData.jdField_a_of_type_ComTencentMobileqqAppUtilsDingdongPluginBizObserver$LastMsgUpdateData.jdField_c_of_type_JavaLangString, paramNodeUpdateData.jdField_a_of_type_ComTencentMobileqqAppUtilsDingdongPluginBizObserver$LastMsgUpdateData.jdField_c_of_type_Int, paramNodeUpdateData.jdField_a_of_type_ComTencentMobileqqAppUtilsDingdongPluginBizObserver$LastMsgUpdateData.jdField_d_of_type_JavaLangString);
        }
        if ((paramNodeUpdateData.jdField_a_of_type_ComTencentMobileqqAppUtilsDingdongPluginBizObserver$UnreadNumUpdateData != null) && (paramNodeUpdateData.jdField_a_of_type_ComTencentMobileqqAppUtilsDingdongPluginBizObserver$UnreadNumUpdateData.jdField_a_of_type_Int == 0)) {
  ...
  public void a(DingdongPluginBizObserver.ScheduleMoreSummaryData paramScheduleMoreSummaryData)
  {
    ...
    {
      localybd = (ybd)this.jdField_a_of_type_JavaUtilHashMap.get(Long.valueOf(paramScheduleMoreSummaryData.jdField_a_of_type_Long));
      if (localybd != null) {
        break label83;
      }
    }
    label83:
    for (int i = 0;; i = localybd.jdField_a_of_type_Int)
    {
      if (QLog.isColorLevel()) {
        QLog.i("DingdongPluginManager", 2, "onGetScheduleDetailNotify type = " + i);
      }
      new ybc(this, i, localybd).execute(new DingdongPluginBizObserver.ScheduleMoreSummaryData[] { paramScheduleMoreSummaryData });
      return;
    }
  }
  ...
  public void a(MessageForDingdongSchedule paramMessageForDingdongSchedule, long paramLong)
  {
    ...
    ybd localybd = new ybd(this, null);
    long l = this.b;
    this.b = (1L + l);
    localybd.jdField_a_of_type_Long = l;
    localybd.jdField_a_of_type_Int = i;
    localybd.b = paramLong;
    localybd.jdField_a_of_type_JavaLangString = paramMessageForDingdongSchedule.id;
    this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(localybd.jdField_a_of_type_Long), localybd);
    ((DingdongPluginBizHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(75)).a(localybd.jdField_a_of_type_Long, paramMessageForDingdongSchedule.id);
  }
  ...
  void a(String paramString1, int paramInt1, String paramString2, String paramString3, int paramInt2, String paramString4)
  {
    Object localObject1 = null;
    Object localObject2 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getSharedPreferences(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(), 0);
    String str = ((SharedPreferences)localObject2).getString("dingdong.lastmsg.feedid", null);
    int i = ((SharedPreferences)localObject2).getInt("dingdong.lastmsg.modifiedtime", 0);
    ...
    while ((i == paramInt2) && (paramString1 != null) && (paramString1.equals(str))) {
      return;
    }
    ((SharedPreferences)localObject2).edit().putString("dingdong.lastmsg.feedid", paramString1);
    ((SharedPreferences)localObject2).edit().putInt("dingdong.lastmsg.modifiedtime", paramInt2);
    ((SharedPreferences)localObject2).edit().commit();
    if (paramString1 != null)
    {
      localObject2 = new DingdongPluginRecentUserMsg();
      ((DingdongPluginRecentUserMsg)localObject2).jdField_a_of_type_Int = paramInt1;
      ((DingdongPluginRecentUserMsg)localObject2).jdField_b_of_type_JavaLangString = paramString2;
      ((DingdongPluginRecentUserMsg)localObject2).jdField_c_of_type_JavaLangString = paramString3;
      ((DingdongPluginRecentUserMsg)localObject2).jdField_d_of_type_JavaLangString = paramString4;
      ((DingdongPluginRecentUserMsg)localObject2).e = paramString1;
    }
    for (paramString1 = (String)localObject2;; paramString1 = null)
    {
      paramString3 = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a();
      paramString4 = paramString3.a(AppConstants.aT, 9999);
      paramString4.lastmsgtime = paramInt2;
      paramString2 = (String)localObject1;
      if (paramString1 != null) {
        paramString2 = paramString1.a();
      }
      paramString4.msgData = paramString2;
      paramString4.msg = paramString1;
      paramString4.msgType = 17;
      paramString4.displayName = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131362474);
  ...
  public void a(boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    {
      if (!paramBoolean3) {
        ((DingdongPluginBizHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(75)).a(this.n, this.o);
      }
      this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().a(AppConstants.aT, 9999, paramBoolean1, paramBoolean2);
      this.n = 0;
    }
  }
  ...
  public void b()
  {
    ((DingdongPluginBizHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(75)).a(false);
  }
  ...
  public void b(String paramString, int paramInt, long paramLong)
  {
    ...
    this.b = (1L + l);
    localybd.jdField_a_of_type_Long = l;
    localybd.jdField_a_of_type_Int = paramInt;
    localybd.b = paramLong;
    localybd.jdField_a_of_type_JavaLangString = paramString;
    this.jdField_a_of_type_JavaUtilHashMap.put(Long.valueOf(localybd.jdField_a_of_type_Long), localybd);
    ((DingdongPluginBizHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(75)).a(localybd.jdField_a_of_type_Long, paramString);
  }
  
  public void c()
  {
    ((DingdongPluginBizHandler)this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a(75)).a();
  }
  ...
  {
    String str = ContactUtils.c(this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, paramString, true);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\dingdong\DingdongPluginManager.class
