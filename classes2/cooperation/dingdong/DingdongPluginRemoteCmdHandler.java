...
{
  public static final String a = "DingdongPluginRemoteCmdHandler";
  private int jdField_a_of_type_Int;
  private DiscussionObserver jdField_a_of_type_ComTencentMobileqqAppDiscussionObserver;
  private RemoteCommand jdField_a_of_type_ComTencentMobileqqPluginsdkIpcRemoteCommand;
  private ArrayList jdField_a_of_type_JavaUtilArrayList;
  private ybj jdField_a_of_type_Ybj;
  private boolean jdField_a_of_type_Boolean;
  private int jdField_b_of_type_Int;
  private String jdField_b_of_type_JavaLangString;
  
  public DingdongPluginRemoteCmdHandler()
  {
    boolean bool = NotVerifyClass.DO_VERIFY_CLASS;
    this.jdField_a_of_type_Int = 0;
    this.jdField_b_of_type_JavaLangString = "";
    this.jdField_a_of_type_ComTencentMobileqqPluginsdkIpcRemoteCommand = new ybe(this, "dingDongRemoteCmd");
    this.jdField_a_of_type_ComTencentMobileqqAppDiscussionObserver = new ybi(this);
    this.jdField_a_of_type_Ybj = new ybj(this);
  }
  
  private int a(Bundle paramBundle1, Bundle paramBundle2)
  {
    int i = paramBundle1.getInt("_attachment_count");
    int j = paramBundle1.getInt("_source_type_");
    paramBundle2 = paramBundle1.getString("_source_id_");
    String str1 = paramBundle1.getString("_feed_id_");
    String str2 = paramBundle1.getString("_from_uin_");
    String str3 = paramBundle1.getString("_concern_uin_list_str_");
    ...
    Object localObject2 = "mqqapi://asyncmsg/showdetail?src_type=internal&version=1&feedsid=" + str1 + "&fsc=" + paramBundle2 + "&fst=" + j;
    localObject1 = ((AbsShareMsg.Builder)localObject1).c(61).a(BaseApplicationImpl.a().getString(2131362573) + paramBundle1).a(11).a("plugin", "", (String)localObject2, "", "").d(BaseApplicationImpl.a().getString(2131362572)).a();
    localObject2 = StructMsgElementFactory.a(2);
    ((AbsStructMsgItem)localObject2).a(BaseApplicationImpl.a().getString(2131362575), BaseApplicationImpl.a().getString(2131362571), paramBundle1, 0);
    paramBundle1 = new StructMsgItemLayout6();
    paramBundle1.a(new StructMsgItemHr());
    StructMsgItemLayout6 localStructMsgItemLayout6 = new StructMsgItemLayout6();
    localStructMsgItemLayout6.a(new StructMsgItemAsyncMsg(str2, paramBundle2, String.valueOf(j), str3, String.valueOf(i), str1));
    localStructMsgItemLayout6.d(0);
    ((AbsShareMsg)localObject1).addItem((AbsStructMsgElement)localObject2);
    ((AbsShareMsg)localObject1).addItem(paramBundle1);
    ((AbsShareMsg)localObject1).addItem(localStructMsgItemLayout6);
    ShareMsgHelper.a((QQAppInterface)BaseApplicationImpl.a().a(), paramBundle2, paramBundle2, DingdongPluginHelper.c(j), (AbsStructMsg)localObject1, null);
    return 0;
  }
  ...
  private void a(int paramInt)
  {
    ...
    {
      new Handler(localLooper).post(new ybh(this, paramInt));
      return;
    }
    b(paramInt);
  }
  ...
  private int b(Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    if (1 == i)
    {
      paramBundle1 = (QQAppInterface)BaseApplicationImpl.a().a();
      localTroopGagMgr = (TroopGagMgr)paramBundle1.getManager(47);
      if (localTroopGagMgr.a((String)localObject, str)) {
        paramBundle1 = paramBundle1.getApplication().getString(2131362506);
      }
    }
    for (;;)
    {
      ...
      if ((localObject != null) && (((TroopGagMgr.TroopGagInfo)localObject).jdField_a_of_type_Long > 0L)) {
        paramBundle1 = paramBundle1.getApplication().getString(2131362507);
      } else {
        paramBundle1 = null;
      }
    }
  ...
  private void b(int paramInt)
  {
    ...
    do
    {
      ...
      if (paramInt == 0)
      {
        long l = this.jdField_a_of_type_Ybj.jdField_a_of_type_Long;
        ...
        for (boolean bool = true;; bool = false)
        {
          ...
          ((Intent)localObject5).putExtra("roomId", this.jdField_a_of_type_Ybj.jdField_a_of_type_Long);
          ((Intent)localObject5).putExtra("createdFlag", 0);
          ((Intent)localObject5).putExtra("discuss_create_reason", this.jdField_b_of_type_Int);
          if (l > 0L)
          {
    ...
    {
      localQQAppInterface.a(this.jdField_a_of_type_ComTencentMobileqqAppDiscussionObserver);
      this.jdField_a_of_type_Boolean = true;
    }
    Object localObject5 = new ArrayList();
    Object localObject1 = ContactUtils.i(localQQAppInterface, localQQAppInterface.a());
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
          localObject1 = localResultRecord.jdField_b_of_type_JavaLangString;
          break label408;
        }
        localObject1 = localNumberFormatException;
        if (localResultRecord.jdField_a_of_type_Int != 4) {
  ...
  private int c(Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    if (i == 1) {
      OfficeCenterConfigLoader.a().a((QQAppInterface)BaseApplicationImpl.a().a());
    }
    do
    {
      do
      {
        ...
        if (i == 2)
        {
          ...
          ((DingdongPluginBizHandler)((QQAppInterface)BaseApplicationImpl.a().a()).a(75)).a(5, false, null);
          return 0;
        }
      } while (i != 3);
  ...
  {
    if (!this.jdField_a_of_type_Ybj.jdField_a_of_type_Boolean)
    {
      this.jdField_a_of_type_JavaUtilArrayList = null;
      this.jdField_a_of_type_JavaUtilArrayList = paramBundle1.getParcelableArrayList("resultRecords");
      this.jdField_b_of_type_JavaLangString = paramBundle1.getString("discussName");
      this.jdField_b_of_type_Int = paramBundle1.getInt("discuss_create_reason");
      this.jdField_a_of_type_Int = paramBundle1.getInt("discuss_create_form", 0);
      if ((this.jdField_a_of_type_JavaUtilArrayList == null) || (this.jdField_a_of_type_JavaUtilArrayList.size() == 0)) {
        return 1;
      }
      this.jdField_a_of_type_Ybj.a(this.jdField_a_of_type_JavaUtilArrayList);
      return 0;
    }
    if (QLog.isColorLevel()) {
  ...
  private int e(Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    for (long l = 0L;; l = Long.valueOf(str).longValue())
    {
      ...
      if (localDiscussionManager.a(str, localQQAppInterface.a()) != null) {
        break;
      }
    ...
    new ybg(this, localDiscussionManager, str, l, localQQAppInterface).execute(new Void[] { null, null, null });
    return 0;
  }
  ...
  private int f(Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    if (paramBundle1 != null) {
      ((DingdongPluginManager)((QQAppInterface)BaseApplicationImpl.a().a()).getManager(114)).d(paramBundle1);
    }
    return 0;
  }
  ...
  private int g(Bundle paramBundle1, Bundle paramBundle2)
  {
    ...
    ((DingdongPluginManager)((QQAppInterface)BaseApplicationImpl.a().a()).getManager(114)).b(paramBundle2, i, l);
    return 0;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\dingdong\DingdongPluginRemoteCmdHandler.class
