...
public class DingdongPluginHelper
{
  ...
  public static String a(int paramInt, String paramString1, String paramString2)
  {
    ...
    if ((localObject instanceof QQAppInterface))
    {
      ...
      {
      default: 
        paramString1 = ContactUtils.j((QQAppInterface)localObject, paramString2);
      }
    }
    for (;;)
    {
      ...
      {
        return paramString2;
        paramString1 = ContactUtils.f((QQAppInterface)localObject, paramString1, paramString2);
        continue;
  ...
  {
    new yba(paramIntent, paramInt).execute(new Void[] { null, null, null });
  }
  ...
  public static void a(Activity paramActivity, String paramString, Intent paramIntent, int paramInt)
  {
    ...
    for (;;)
    {
      if (a(paramActivity))
      {
        DingdongPluginProxyActivity.a(BaseApplicationImpl.a().a().getAccount(), paramActivity, paramString, paramIntent, paramInt, null);
        return;
      }
    ...
    if (paramContext != null)
    {
      ...
      if (paramContext != null)
      {
        ...
        while (paramContext.hasNext()) {
          if ("com.tencent.mobileqq:dingdong".compareTo(((ActivityManager.RunningAppProcessInfo)paramContext.next()).processName) == 0) {
            return true;
          }
        }
      }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\dingdong\DingdongPluginHelper.class
