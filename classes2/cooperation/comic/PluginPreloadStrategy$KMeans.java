...
public class PluginPreloadStrategy$KMeans
{
  ...
  {
    if ((paramArrayOfInt == null) || (paramArrayOfInt.length < this.b) || (this.b <= 0) || (paramInt < 1) || (paramInt > paramArrayOfInt.length)) {
      return -1;
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\comic\PluginPreloadStrategy$KMeans.class
