  ...
  extends IphoneTitleBarActivity
{
  ...
  public TextView a;
  private final OnPluginInstallListener jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener;
  ...
  public GVideoPluginInstallerActivity()
  {
    ...
    this.c = 3;
    this.d = 4;
    this.jdField_b_of_type_JavaLangString = "TroopVideoPluginInstaller";
    this.jdField_b_of_type_AndroidOsHandler = new ybt(this, Looper.getMainLooper());
    this.jdField_a_of_type_ComTencentMobileqqPluginsdkOnPluginInstallListener = new ybu(this);
    this.jdField_a_of_type_JavaLangRunnable = new ybv(this);
  }
  ...
  private void b()
  {
    this.jdField_a_of_type_AndroidWidgetTextView.setText(getString(2131365267));
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    super.setContentView(2130903942);
    super.setTitle(getString(2131365268));
    ...
    this.jdField_a_of_type_AndroidWidgetTextView.setText(getString(2131365266));
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\groupvideo\GVideoPluginInstallerActivity.class
