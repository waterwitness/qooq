...
{
  public FavoritesRemoteCommandHandler()
  {
  ...
  public boolean a(int paramInt, Bundle paramBundle)
  {
    ...
    String str = paramBundle.getString("configKey");
    paramBundle.putString("configInfo", FMConfig.a(((QQAppInterface)localObject1).a().getBaseContext(), str));
    return true;
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\qqfav\ipc\FavoritesRemoteCommandHandler.class
