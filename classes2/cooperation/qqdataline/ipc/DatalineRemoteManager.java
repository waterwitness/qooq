  ...
  implements Observer
{
  ...
  public DatalineRemoteManager(QQAppInterface paramQQAppInterface)
  {
    ...
    this.b = false;
    this.jdField_a_of_type_AndroidContentServiceConnection = new yfx(this);
  ...
  private void a(Bundle paramBundle, boolean paramBoolean)
  {
    ...
    do
    {
      ...
      {
        new Handler((Looper)localObject).post(new yfz(this, paramBundle));
        return;
      }
      a(paramBundle);
  ...
  private Bundle b(Bundle paramBundle)
  {
    ...
    do
    {
      ...
      if (((String)localObject2).equals("DatalineHandler_saveFileManagerEntity"))
      {
        ...
        if (l1 == 0L) {}
        for (localFileManagerEntity.peerNick = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131370350);; localFileManagerEntity.peerNick = this.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getString(2131370353))
        {
  ...
  private void c()
  {
    ...
    {
      new Handler(localLooper).post(new yfq(this));
      return;
    }
    e();
  }
  ...
  private void d()
  {
    ...
    if (Thread.currentThread() != localLooper.getThread())
    {
      new Handler(localLooper).post(new yft(this));
      return;
    }
    f();
  }
  ...
  private void e()
  {
    ...
    a(0);
    this.b = false;
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog = DialogUtil.a(BaseActivity.sTopActivity, 230, "授权申请", "是否允许电脑导出手机相册？", 2131367259, 2131367258, new yfu(this), new yfv(this));
    this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.setOnDismissListener(new yfw(this));
    TextView localTextView = (TextView)this.jdField_a_of_type_ComTencentMobileqqUtilsQQCustomDialog.findViewById(2131296852);
  ...
  private void g()
  {
    ...
    for (;;)
    {
      ...
      {
        new Handler((Looper)localObject1).post(new yga(this));
        return;
      }
  ...
  private void h()
  {
    ...
    localPluginCommunicationHandler.register(new yfr(this, "dataline.remotecall"));
  }
  ...
  private void j()
  {
    ...
    if (Thread.currentThread() != ((Looper)localObject).getThread()) {
      new Handler((Looper)localObject).post(new yfs(this));
    }
  ...
  public void a(MpfileTaskInfo paramMpfileTaskInfo, long paramLong)
  {
    ...
    for (;;)
    {
      ...
      new Handler(paramMpfileTaskInfo).post(new yfy(this, localFileManagerEntity, localForwardFileInfo));
      return;
  ...
  {
    Bundle localBundle = new Bundle();
    localBundle.putString("notify_cmd", "forceExitMp");
    localBundle = a(localBundle);
    if (localBundle == null) {
      return false;
    }
  ...
  {
    Bundle localBundle = new Bundle();
    localBundle.putString("notify_cmd", "setMpFileDownloadPwdRadom");
    localBundle.putString("pwdradom", paramString);
    paramString = a(localBundle);
    if (paramString == null) {
      return -1L;
    }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\qqdataline\ipc\DatalineRemoteManager.class
