  ...
  implements Handler.Callback
{
  ...
  private boolean a()
  {
    ...
    if (QlinkPluginProxyActivity.a(this))
    {
      ...
      localBundle.putString("_SELF_NICK_", ContactUtils.j(this.app, this.app.getAccount()));
  ...
  protected boolean doOnCreate(Bundle paramBundle)
  {
    ...
    if (BaseApplication.getContext().getSharedPreferences("QlinkResistTerrorist", 0).getInt("QlinkResistTerrorist_res", 0) == 1)
    {
      ...
      paramBundle = new yes(this);
      DialogUtil.a(this, 233, getString(2131366275), getString(2131366341), 2131366290, 2131366290, paramBundle, null).show();
      bool = false;
    }
    while (a()) {
      return bool;
    ...
    this.jdField_a_of_type_ComTencentMobileqqWidgetQQProgressDialog.setOnDismissListener(new yet(this));
    this.jdField_a_of_type_ComTencentUtilMqqWeakReferenceHandler.postDelayed(new yeu(this), 300L);
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\qlink\QlinkBridgeActivity.class
