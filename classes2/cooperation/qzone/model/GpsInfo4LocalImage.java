  ...
  implements Parcelable
{
  ...
  public static double a(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4)
  {
    ...
    return Math.asin(Math.sqrt(Math.cos(paramDouble1) * Math.cos(paramDouble3) * Math.pow(Math.sin((paramDouble2 - paramDouble4) / 2.0D), 2.0D) + d)) * 2.0D * 6378.137D * 1000.0D;
  }
  ...
  public boolean equals(Object paramObject)
  {
    ...
    if ((this.jdField_a_of_type_Int == ((GpsInfo4LocalImage)paramObject).jdField_a_of_type_Int) && (a(this.jdField_a_of_type_Float * 1000000.0F, this.b * 1000000.0F, ((GpsInfo4LocalImage)paramObject).jdField_a_of_type_Float * 1000000.0F, ((GpsInfo4LocalImage)paramObject).b * 1000000.0F) <= QzoneLbsConfig.a().a())) {}
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\qzone\model\GpsInfo4LocalImage.class
