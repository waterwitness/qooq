  ...
  extends Activity
{
  ...
  private void a(Intent paramIntent)
  {
    ...
    {
      localQQProgressDialog = new QQProgressDialog(this, getResources().getDimensionPixelSize(2131492908));
      localQQProgressDialog.a("正在加载...");
      localQQProgressDialog.setOnDismissListener(new ylr(this));
    }
    for (;;)
    {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\qzone\TranslucentActivity.class
