  ...
  extends QzoneInternalWebViewPlugin
{
  ...
  public static final String c = "cooperation.qzone.webviewplugin.QzoneQunFeedJsPlugin.handleQunDetailDelete";
  private static String d = "";
  Dialog jdField_a_of_type_AndroidAppDialog;
  private BroadcastReceiver jdField_a_of_type_AndroidContentBroadcastReceiver = new yrq(this);
  
  static
  {
    boolean bool = NotVerifyClass.DO_VERIFY_CLASS;
    jdField_a_of_type_JavaLangString = QzoneQunFeedJsPlugin.class.getSimpleName();
  }
  ...
  private void a(int paramInt)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().c("window.QZQunRedPointInterface.onReceive({data:" + paramInt + "});");
  }
  ...
  private void a(int paramInt1, int paramInt2, String paramString, boolean paramBoolean)
  {
    ...
    if (paramInt2 > 0)
    {
      ...
      if (paramInt1 > 0)
      {
        str = String.format(localActivity.getString(2131366857), new Object[] { Integer.valueOf(paramInt1) }) + "，";
        str = str + paramString + "目录下，";
      }
      paramString = str + String.format(localActivity.getString(2131366858), new Object[] { Integer.valueOf(paramInt2) });
      DialogUtil.a(localActivity, 232).setMessage(paramString).setNegativeButton(2131366855, new yrv(this)).show();
      return;
    }
    ToastUtil.a().a(localActivity.getString(2131366856) + paramString + "目录下。");
  }
  ...
  private void a(String paramString)
  {
    if (this.jdField_a_of_type_AndroidAppDialog == null)
    {
      ...
      this.jdField_a_of_type_AndroidAppDialog.setTitle(2131366854);
      this.jdField_a_of_type_AndroidAppDialog.setCancelable(true);
    }
    this.jdField_a_of_type_AndroidAppDialog.setOnCancelListener(new yru(this, paramString));
  ...
  private void a(String... paramVarArgs)
  {
    if (QLog.isDevelopLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 4, "handleQunDetailDelete ");
    }
    try
    {
    ...
    catch (Exception paramVarArgs)
    {
      ...
      QLog.w(jdField_a_of_type_JavaLangString, 2, "handleQunDetailDelete exception:" + paramVarArgs);
    }
  }
  ...
  private void b()
  {
    ...
    {
      QLog.w(jdField_a_of_type_JavaLangString, 1, "registerUnreadMsgReceiver----", localException);
    }
  }
  ...
  private void b(String... paramVarArgs)
  {
    ...
    do
    {
      return;
      if (QLog.isDevelopLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 4, "handleQunJumpDetail " + paramVarArgs[0]);
      }
      try
      {
        ...
        localIntent.putExtra("source_name", this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().getString(2131367184));
    ...
    QLog.w(jdField_a_of_type_JavaLangString, 2, "handleQunJumpDetail,decode param error");
  }
  ...
  private void c(String... paramVarArgs)
  {
    ...
    do
    {
      return;
      if (QLog.isDevelopLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 4, "handleStartQunRedPointNotify " + paramVarArgs[0]);
      }
      try
      {
        ...
        if (QLog.isDevelopLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 4, "handleStartQunRedPointNotify data=" + i);
        }
        a(i);
        return;
      }
    ...
    QLog.w(jdField_a_of_type_JavaLangString, 2, "handleStartQunRedPointNotify,decode param error");
  }
  
  private void d(String... paramVarArgs)
  {
    if (QLog.isDevelopLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 4, "handleEndQunRedPointNotify");
    }
  }
  ...
  {
    if (QLog.isDevelopLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 4, "handleHideTopicComment");
    }
  }
  ...
  private void f(String... paramVarArgs)
  {
    int i = 1;
    if (QLog.isDevelopLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 4, "handleGroupUploadPhoto " + paramVarArgs[0]);
    }
    try
    {
    ...
    {
      while (!QLog.isColorLevel()) {}
      QLog.w(jdField_a_of_type_JavaLangString, 2, "handleGroupUploadPhoto,decode param error");
    }
  }
  ...
  private void g(String... paramVarArgs)
  {
    ...
    if (QLog.isDevelopLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 4, "handleQunDownloadPhoto " + paramVarArgs[0]);
    }
    new Intent().putExtra("photos", paramVarArgs[0]);
    RemoteHandleManager.a().a(new yrr(this));
    if (!a())
    {
    ...
    {
      Activity localActivity = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a();
      DialogUtil.a(localActivity, 230).setTitle(localActivity.getString(2131366853)).setMessage(localActivity.getString(2131366859)).setPositiveButton(localActivity.getString(2131366860), new yrt(this, paramVarArgs)).setNegativeButton(localActivity.getString(2131366861), new yrs(this)).show();
      return;
    }
    a(paramVarArgs[0]);
  }
  ...
  private void h(String... paramVarArgs)
  {
    ...
    if (QLog.isDevelopLevel()) {
      QLog.d(jdField_a_of_type_JavaLangString, 4, "handleGroupQuote " + paramVarArgs[0]);
    }
    for (;;)
    {
      try
  ...
  private void i(String... paramVarArgs)
  {
    ...
    do
    {
      for (;;)
      {
        return;
        if (QLog.isDevelopLevel()) {
          QLog.d(jdField_a_of_type_JavaLangString, 4, "handleQunDidPickAlbum " + paramVarArgs[0]);
        }
        try
        {
          Object localObject = new JSONObject(paramVarArgs[0]);
    ...
    QLog.w(jdField_a_of_type_JavaLangString, 2, "handleQunDidPickAlbum,decode param error");
  }
  ...
  private void j(String... paramVarArgs)
  {
    ...
    do
    {
      return;
      if (QLog.isDevelopLevel()) {
        QLog.d(jdField_a_of_type_JavaLangString, 4, "handleQunPickQzoneAlbum " + paramVarArgs[0]);
      }
      try
      {
        d = new JSONObject(paramVarArgs[0]).getString("callback");
        ...
        localUserInfo.jdField_a_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.mRuntime.a().a();
    ...
    QLog.w(jdField_a_of_type_JavaLangString, 2, "handleQunPickQzoneAlbum,decode param error");
  }
  ...
  public void a()
  {
    ...
    {
      QLog.w(jdField_a_of_type_JavaLangString, 1, "", localException);
    }
  }
  ...
  public void a(Intent paramIntent, byte paramByte, int paramInt)
  {
    ...
    {
      return;
    } while ((TextUtils.isEmpty(d)) || (paramIntent == null));
    ...
    this.jdField_a_of_type_ComTencentMobileqqWebviewSwiftWebViewPlugin.callJs(d, new String[] { paramIntent.toString() });
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\cooperation\qzone\webviewplugin\QzoneQunFeedJsPlugin.class
