  ...
  implements Cloneable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.ver, ((MultiVideoMsg)paramObject).ver)) || (!JceUtil.equals(this.type, ((MultiVideoMsg)paramObject).type)) || (!JceUtil.equals(this.csCmd, ((MultiVideoMsg)paramObject).csCmd)) || (!JceUtil.equals(this.from_uin, ((MultiVideoMsg)paramObject).from_uin)) || (!JceUtil.equals(this.to_uin, ((MultiVideoMsg)paramObject).to_uin)) || (!JceUtil.equals(this.video_buff, ((MultiVideoMsg)paramObject).video_buff)) || (!JceUtil.equals(this.subCmd, ((MultiVideoMsg)paramObject).subCmd)) || (!JceUtil.equals(this.msg_uid, ((MultiVideoMsg)paramObject).msg_uid)) || (!JceUtil.equals(this.msg_seq, ((MultiVideoMsg)paramObject).msg_seq)) || (!JceUtil.equals(this.msg_type, ((MultiVideoMsg)paramObject).msg_type)) || (!JceUtil.equals(this.msg_time, ((MultiVideoMsg)paramObject).msg_time)) || (!JceUtil.equals(this.msg_dataflag, ((MultiVideoMsg)paramObject).msg_dataflag)));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\SharpSvrPack\MultiVideoMsg.class
