  ...
  implements Cloneable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.ver, ((SharpVideoMsg)paramObject).ver)) || (!JceUtil.equals(this.type, ((SharpVideoMsg)paramObject).type)) || (!JceUtil.equals(this.from_uin, ((SharpVideoMsg)paramObject).from_uin)) || (!JceUtil.equals(this.to_uin, ((SharpVideoMsg)paramObject).to_uin)) || (!JceUtil.equals(this.video_buff, ((SharpVideoMsg)paramObject).video_buff)) || (!JceUtil.equals(this.msg_uid, ((SharpVideoMsg)paramObject).msg_uid)) || (!JceUtil.equals(this.msg_seq, ((SharpVideoMsg)paramObject).msg_seq)) || (!JceUtil.equals(this.msg_type, ((SharpVideoMsg)paramObject).msg_type)) || (!JceUtil.equals(this.msg_time, ((SharpVideoMsg)paramObject).msg_time)) || (!JceUtil.equals(this.call_type, ((SharpVideoMsg)paramObject).call_type)) || (!JceUtil.equals(this.client_state, ((SharpVideoMsg)paramObject).client_state)));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\SharpSvrPack\SharpVideoMsg.class
