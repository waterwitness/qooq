  ...
  extends AsyncTask
{
  ...
  public vyq(ImageWorker paramImageWorker, View paramView)
  {
  ...
  {
    View localView = a();
    vys localvys = (vys)ImageWorker.a(this.jdField_a_of_type_ComTencentMobileqqUtilImageWorker).remove(localView);
    ...
    if (localView != null)
    {
      ...
      if ((localvys != null) && (localvys.a != null)) {
        localvys.a.a(localView, null);
      }
    }
    return;
    label72:
    ImageWorker.a(this.jdField_a_of_type_ComTencentMobileqqUtilImageWorker, this.jdField_a_of_type_Boolean, localView, paramDrawable, localvys);
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\vyq.class
