  ...
  implements FaceDrawable.OnLoadingStateChangeListener
{
  ...
  {
    Object localObject = FaceDrawable.a(TroopGiftAnimationController.a(this.a.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftAnimationController), String.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqDataMessageForDeliverGiftTips.receiverUin), (byte)3);
    ...
    if ((paramInt1 == 0) && (paramInt2 == 1) && (this.a.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftAnimationController.a != null)) {
      this.a.jdField_a_of_type_ComTencentMobileqqTroopgiftTroopGiftAnimationController.a.a(new vvj(this, (Bitmap)localObject));
    }
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\vvi.class
