  ...
  implements View.OnClickListener
{
  ...
  {
    Object localObject2 = paramView.findViewById(2131296312);
    if (localObject2 == null) {}
    for (;;)
    {
      return;
      Object localObject1 = ((View)localObject2).getTag(2131296312);
      ...
      try
      {
        QQAppInterface localQQAppInterface = (QQAppInterface)((BaseApplicationImpl)((Context)localObject2).getApplicationContext()).getAppRuntime(((StructMsgForAudioShare)localObject1).currentAccountUin);
        if (((StructMsgForAudioShare)localObject1).msgId > 0L)
        {
          ...
          ThreadManager.b().postDelayed(new uvc(this, (StructMsgForAudioShare)localObject1, localQQAppInterface), 0L);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\uvb.class
