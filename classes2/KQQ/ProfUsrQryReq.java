  ...
  extends JceStruct
{
  ...
  public ProfUsrQryReq(int paramInt1, String paramString, ArrayList paramArrayList, int paramInt2, int paramInt3, byte paramByte1, int paramInt4, int paramInt5, byte paramByte2, byte paramByte3, byte paramByte4)
  {
    this.strSessionKey = "";
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\KQQ\ProfUsrQryReq.class
