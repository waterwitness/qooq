...
{
  public vbx(ShortVideoUploadProcessor paramShortVideoUploadProcessor)
  {
  ...
  public void onFailed(int paramInt)
  {
    synchronized (this.a)
    {
      ...
      LogTag.a(String.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_a_of_type_Long), "svrcomp_r", "sendAckToBDHServer fail!  erroCode:" + paramInt);
      this.a.f(paramInt);
      return;
    }
  }
  ...
  public void onResponse(HwResponse paramHwResponse)
  {
    ...
    try
    {
      Object localObject2 = new Bdh_extinfo.ShortVideoRspExtInfo();
      ...
      byte[] arrayOfByte = ((Bdh_extinfo.VideoInfo)localObject2).bytes_bin_md5.get().toByteArray();
      ...
      LogTag.a(String.valueOf(this.a.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_a_of_type_Long), "svrcomp_r", "sendAckToBDHServer success!  MD5:" + HexUtil.bytes2HexStr(arrayOfByte) + " mSendClicked : " + this.a.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get());
      this.a.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.f = HexUtil.bytes2HexStr(arrayOfByte);
      this.a.jdField_e_of_type_JavaLangString = this.a.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.f;
      if (this.a.jdField_a_of_type_JavaUtilHashMap != null)
      {
        this.a.jdField_a_of_type_JavaUtilHashMap.put("param_fileMD5", this.a.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.f);
      ...
      this.a.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.i = ShortVideoUtils.a((MessageForShortVideo)this.a.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, "mp4");
      this.a.h = ((Bdh_extinfo.ShortVideoSureRspInfo)localObject1).bytes_fileid.get().toStringUtf8();
      this.a.jdField_a_of_type_Long = i;
      this.a.by = j;
      this.a.jdField_e_of_type_ComTencentMobileqqTransfileBaseTransProcessor$StepInfo.b();
      this.a.jdField_e_of_type_ComTencentMobileqqTransfileBaseTransProcessor$StepInfo.a = 1;
      if (this.a.jdField_b_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get())
      {
        ...
        localObject2 = this.a.c.iterator();
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\vbx.class
