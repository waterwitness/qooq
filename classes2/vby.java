...
{
  public vby(ShortVideoUploadProcessor paramShortVideoUploadProcessor, long paramLong, String paramString)
  {
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap paramHashMap)
  {
    ...
    ThreadManager.a(new vca(this, l2, l3, l4, l5), 5, null, true);
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap paramHashMap)
  {
    ...
    try
    {
      ...
      if (paramArrayOfByte.str_fileid.has())
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.h = paramArrayOfByte;
          if (QLog.isColorLevel()) {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.c = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Long;
      ...
      ThreadManager.a(new vbz(this, l2, l3, l4, l5), 5, null, true);
  ...
  public void onSwitch2BackupChannel()
  {
    ...
    switch (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.bm)
    {
    default: 
      return;
    case 0: 
      this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.c("<BDH_LOG> onSwitch2BackupChannel() BUT current status is INIT");
      return;
    case 2: 
      this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.c("<BDH_LOG> onSwitch2BackupChannel() BUT current status is HTTP");
      return;
    }
    this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.c("<BDH_LOG> onSwitch2BackupChannel() switch to HTTP channel");
    this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.bm = 2;
    ...
    StatisticCollector.a(BaseApplication.getContext()).a(null, "actSwitchChnl", true, l - this.jdField_a_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Long, null, "");
    this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.J_();
  }
  
  public void onTransStart()
  {
    this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.c("<BDH_LOG> onTransStart()");
  ...
  public void onUpdateProgress(int paramInt)
  {
    ...
    long l = paramInt;
    localFileMsg.f = l;
    localShortVideoUploadProcessor.c = l;
    if ((paramInt < this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Long) && (!this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.o) && (!this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.k)) {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\vby.class
