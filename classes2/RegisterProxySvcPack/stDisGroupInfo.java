  ...
  implements Cloneable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.lDisCode, ((stDisGroupInfo)paramObject).lDisCode)) || (!JceUtil.equals(this.uDisMsgSeq, ((stDisGroupInfo)paramObject).uDisMsgSeq)) || (!JceUtil.equals(this.uMemberMsgSeq, ((stDisGroupInfo)paramObject).uMemberMsgSeq)) || (!JceUtil.equals(this.uInfoSeq, ((stDisGroupInfo)paramObject).uInfoSeq)) || (!JceUtil.equals(this.eInfoFlag, ((stDisGroupInfo)paramObject).eInfoFlag)));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\RegisterProxySvcPack\stDisGroupInfo.class
