...
{
  public vaf(C2CPicUploadProcessor paramC2CPicUploadProcessor, long paramLong)
  {
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap paramHashMap)
  {
    ...
    ThreadManager.a(new vah(this, l2, l3, l4, l5), 5, null, false);
    ...
    this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.b();
  }
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap paramHashMap)
  {
    ...
    this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.c = this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.jdField_a_of_type_Long;
    ...
    ThreadManager.b(new vag(this, l2, l3, l4, l5));
  ...
  public void onSwitch2BackupChannel()
  {
    ...
    switch (this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.bm)
    {
    default: 
      return;
    case 0: 
    ...
    this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.bm = 2;
  ...
  public void onUpdateProgress(int paramInt)
  {
    ...
    long l = paramInt;
    localFileMsg.f = l;
    localC2CPicUploadProcessor.c = l;
    if ((paramInt < this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.jdField_a_of_type_Long) && (!this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.o) && (!this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.k))
    {
      ...
      this.jdField_a_of_type_ComTencentMobileqqTransfileC2CPicUploadProcessor.h();
    }
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\vaf.class
