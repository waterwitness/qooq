  ...
  extends MessageMicro
{
  ...
  static
  {
    ...
    __fieldMap__ = MessageMicro.initFieldMap(new int[] { 8, 18, 24, 32, 42, 48, 58, 64, 74, 80, 88, 96, 104, 112, 120, 128, 138, 144, 154, 160, 168 }, new String[] { "uint64_tinyid", "bytes_nickname", "uint32_age", "uint32_gender", "str_constellation", "uint32_profession", "str_distance", "uint32_marriage", "str_vipinfo", "uint32_recommend", "uint32_godflag", "uint32_chatflag", "uint32_chatup_count", "uint32_charm", "uint32_charm_level", "uint32_pub_number", "msg_common_label", "uint32_recent_vistor_time", "bytes_stranger_declare", "uint64_friend_uin", "uint32_history_flag" }, new Object[] { Long.valueOf(0L), localByteStringMicro1, Integer.valueOf(0), Integer.valueOf(0), "", Integer.valueOf(0), "", Integer.valueOf(0), "", Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), Integer.valueOf(0), null, Integer.valueOf(0), localByteStringMicro2, Long.valueOf(0L), Integer.valueOf(0) }, PublisherInfo.class);
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\appoint\define\appoint_define$PublisherInfo.class
