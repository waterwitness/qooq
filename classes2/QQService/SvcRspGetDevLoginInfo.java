  ...
  implements Cloneable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.iResult, ((SvcRspGetDevLoginInfo)paramObject).iResult)) || (!JceUtil.equals(this.strResult, ((SvcRspGetDevLoginInfo)paramObject).strResult)) || (!JceUtil.equals(this.iNextItemIndex, ((SvcRspGetDevLoginInfo)paramObject).iNextItemIndex)) || (!JceUtil.equals(this.iTotalItemCount, ((SvcRspGetDevLoginInfo)paramObject).iTotalItemCount)) || (!JceUtil.equals(this.vecCurrentLoginDevInfo, ((SvcRspGetDevLoginInfo)paramObject).vecCurrentLoginDevInfo)) || (!JceUtil.equals(this.vecHistoryLoginDevInfo, ((SvcRspGetDevLoginInfo)paramObject).vecHistoryLoginDevInfo)) || (!JceUtil.equals(this.vecAuthLoginDevInfo, ((SvcRspGetDevLoginInfo)paramObject).vecAuthLoginDevInfo)));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\QQService\SvcRspGetDevLoginInfo.class
