  ...
  implements Cloneable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.vecGuid, ((SvcReqDelLoginInfo)paramObject).vecGuid)) || (!JceUtil.equals(this.strAppName, ((SvcReqDelLoginInfo)paramObject).strAppName)) || (!JceUtil.equals(this.vecDeviceItemDes, ((SvcReqDelLoginInfo)paramObject).vecDeviceItemDes)) || (!JceUtil.equals(this.iDelType, ((SvcReqDelLoginInfo)paramObject).iDelType)) || (!JceUtil.equals(this.iDelMe, ((SvcReqDelLoginInfo)paramObject).iDelMe)) || (!JceUtil.equals(this.iAppId, ((SvcReqDelLoginInfo)paramObject).iAppId)));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\QQService\SvcReqDelLoginInfo.class
