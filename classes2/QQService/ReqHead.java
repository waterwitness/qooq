  ...
  implements Cloneable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.lUIN, ((ReqHead)paramObject).lUIN)) || (!JceUtil.equals(this.shVersion, ((ReqHead)paramObject).shVersion)) || (!JceUtil.equals(this.iSeq, ((ReqHead)paramObject).iSeq)) || (!JceUtil.equals(this.bReqType, ((ReqHead)paramObject).bReqType)) || (!JceUtil.equals(this.bTriggered, ((ReqHead)paramObject).bTriggered)) || (!JceUtil.equals(this.vCookies, ((ReqHead)paramObject).vCookies)));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\QQService\ReqHead.class
