...
{
  wni(wnh paramwnh, ProfilePhotoWall paramProfilePhotoWall, int paramInt)
  {
  ...
  public void onClick(View paramView)
  {
    if ((this.jdField_a_of_type_ComTencentMobileqqDataProfilePhotoWall instanceof NowShowVideoInfo))
    {
      ...
      ReportController.b(this.jdField_a_of_type_Wnh.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "dc00899", "NOW", "", "qq_zlk", "replay_click", 0, 0, this.jdField_a_of_type_Wnh.a.jdField_a_of_type_JavaLangString, "", "", "");
      return;
    }
    paramView = new Intent(this.jdField_a_of_type_Wnh.a.jdField_a_of_type_AndroidAppActivity, TroopAvatarWallPreviewActivity.class);
    ...
    int i = 0;
    while (i < this.jdField_a_of_type_Wnh.a.jdField_a_of_type_JavaUtilLinkedList.size())
    {
      Object localObject3 = (ProfilePhotoWall)this.jdField_a_of_type_Wnh.a.jdField_a_of_type_JavaUtilLinkedList.get(i);
    ...
    if (this.jdField_a_of_type_Wnh.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().equals(this.jdField_a_of_type_Wnh.a.jdField_a_of_type_JavaLangString))
    {
    ...
    this.jdField_a_of_type_Wnh.a.jdField_a_of_type_AndroidAppActivity.startActivity(paramView);
    if (this.jdField_a_of_type_Wnh.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.a().equals(this.jdField_a_of_type_Wnh.a.jdField_a_of_type_JavaLangString))
    {
      ReportController.b(this.jdField_a_of_type_Wnh.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006A80", "0X8006A80", 0, 0, "", "", "", "");
      return;
    }
    ReportController.b(this.jdField_a_of_type_Wnh.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, "CliOper", "", "", "0X8006A94", "0X8006A94", 0, 0, "", "", "", "");
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\wni.class
