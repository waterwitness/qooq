...
{
  public wxw(VipDownloadInterface paramVipDownloadInterface)
  {
  ...
  {
    LogUtility.e(this.a.b, "getQueryDownloadAction onException code = " + paramInt + " msg= ");
  ...
  {
    LogUtility.a(this.a.b, "getQueryDownloadAction onResult = " + paramList.size());
    ...
    LogUtility.a(this.a.b, "getQueryDownloadAction callback url = " + paramList);
    this.a.a(paramList);
  }
}


/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\wxw.class
