...
public class wql
  extends Handler
{
  public wql(BindGroupConfirmActivity paramBindGroupConfirmActivity)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (k >= 100)
        {
          ...
          ThreadManager.d(new wqm(this, paramMessage));
          return;
        }
      }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\wql.class
