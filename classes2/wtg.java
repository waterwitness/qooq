...
{
  public wtg(DownloadInterface paramDownloadInterface, String paramString)
  {
    ...
    for (;;)
    {
      if (i < j)
      {
        ...
        try
        {
          ...
          localJSONObject.put("writecodestate", localDownloadInfo.p);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\wtg.class
