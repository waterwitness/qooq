  ...
  implements Iterator, Map.Entry
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    if ((ContainerHelpers.equal(((Map.Entry)paramObject).getKey(), this.this$0.colGetEntry(this.mIndex, 0))) && (ContainerHelpers.equal(((Map.Entry)paramObject).getValue(), this.this$0.colGetEntry(this.mIndex, 1)))) {}
    for (;;)
    {
      return bool;
      bool = false;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\android\support\v4\util\MapCollections$MapIterator.class
