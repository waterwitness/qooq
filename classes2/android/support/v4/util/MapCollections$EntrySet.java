  ...
  implements Set
{
  ...
  public boolean contains(Object paramObject)
  {
    ...
    do
    {
      ...
      i = this.this$0.colIndexOfKey(((Map.Entry)paramObject).getKey());
    } while (i < 0);
    return ContainerHelpers.equal(this.this$0.colGetEntry(i, 1), ((Map.Entry)paramObject).getValue());
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\android\support\v4\util\MapCollections$EntrySet.class
