...
public final class wuj
  implements Runnable
{
  public wuj(Context paramContext, String paramString1, WebView paramWebView, String paramString2, boolean paramBoolean)
  {
        ...
        if ((localObject2 != null) && (((List)localObject2).size() > 0))
        {
          ...
          else
          {
            ...
            if ((!APNUtil.b(this.jdField_a_of_type_AndroidContentContext)) || (((Bundle)localObject1).getString("sid").equals("")))
            {
              ...
              AppReport.jdField_a_of_type_Boolean = false;
              if ((!this.jdField_a_of_type_Boolean) || (this.jdField_a_of_type_ComTencentSmttSdkWebView == null)) {
                continue;
              }
              CommonDataAdapter.a().a("{\"guid\":1,\"method\":\"POST\"}", this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_ComTencentSmttSdkWebView);
              return;
            }
            LogUtility.b("AppReport", "<AppReport> do full report to server !!!");
            new HttpCgiAsyncTask("http://fusionbase.qq.com/cgi-bin/appstage/sdk_update", "POST", new AppReport.FullReportCallback(this.jdField_a_of_type_AndroidContentContext, this.jdField_a_of_type_JavaLangString, this.jdField_a_of_type_ComTencentSmttSdkWebView)).execute(new Bundle[] { localObject1 });
            continue;
          }
        }
        else
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\wuj.class
