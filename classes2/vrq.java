...
{
  public vrq(TroopTopicMgr paramTroopTopicMgr, TroopTopicDetailInfo paramTroopTopicDetailInfo, MessageForTroopTopic paramMessageForTroopTopic)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        if (i == 0)
        {
          ...
          ThreadManager.a(new vrr(this, paramBundle), 8, null, false);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\vrq.class
