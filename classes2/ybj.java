  ...
  implements Runnable
{
  ...
  public ybj(DingdongPluginRemoteCmdHandler paramDingdongPluginRemoteCmdHandler)
  {
  ...
  private boolean a(ArrayList paramArrayList1, ArrayList paramArrayList2)
  {
    ...
    if (localObject != null) {}
    for (localObject = ((QQAppInterface)localObject).a();; localObject = null)
    {
  ...
  public boolean a(ArrayList paramArrayList)
  {
    if (!this.jdField_a_of_type_Boolean)
    {
      ...
      ThreadManager.a(this, 8, null, true);
      return true;
    }
    return false;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\ybj.class
