...
{
  public vpx(TroopFileTransferManager paramTroopFileTransferManager)
  {
  ...
  private final void a(TroopFileTransferManager.Item paramItem, cmd0x383.RspBody paramRspBody, long paramLong)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          paramRspBody = this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface.getApplication().getResources().getString(2131364222);
  ...
  public final void a(TroopFileTransferManager.Item paramItem, cmd0x383.RspBody paramRspBody)
  {
    ...
    try
    {
      paramRspBody = new TroopFileError.SimpleErrorInfo(paramItem.FileName, this.a.g, 5, 207);
    ...
    for (;;)
    {
      ...
      ((QQAppInterface)this.b.get()).a().b("" + this.a.g, 1, l);
      break;
      i = 202;
      continue;
      i = 600;
      ...
      {
        paramItem.BusId = 104;
        TroopFileProtocol.a(this.a.jdField_a_of_type_ComTencentMobileqqAppQQAppInterface, false, this.a.g, paramItem, this.a.g, 0L, TroopFileTransferManager.a(this.a));
        break;
        ...
        paramItem.BusId = 102;
        new TroopFileTransferManager.TaskScan(this.a, paramItem);
        break;
        new Handler(Looper.getMainLooper()).post(new vpy(this));
        paramRspBody = ((cmd0x383.ApplyCopyToRspBody)paramRspBody.msg_copy_to_rsp_body.get()).str_save_file_path.get();
        paramItem.FilePath = paramRspBody;
        Object localObject = paramItem.getInfo(this.a.g);
        if (localObject != null) {
  ...
  public final void b(TroopFileTransferManager.Item paramItem, cmd0x383.RspBody paramRspBody)
  {
    ...
    try
    {
      paramRspBody = new TroopFileError.SimpleErrorInfo(paramItem.FileName, this.a.g, 5, 601);
      this.a.a(paramItem, 5, paramRspBody);
      return;
    }
    finally {}
    ...
    for (;;)
    {
      paramRspBody = new TroopFileError.SimpleErrorInfo(paramItem.FileName, this.a.g, 5, i, paramRspBody);
      this.a.a(paramItem, 5, paramRspBody);
      break;
      int i = 202;
      continue;
      ...
      if (paramItem.BusId == 102)
      {
        ...
        if (!TextUtils.isEmpty(paramRspBody))
        {
          ...
          do
          {
            paramRspBody = new TroopFileError.SimpleErrorInfo(paramItem.FileName, this.a.g, 5, 602);
            this.a.a(paramItem, 5, paramRspBody);
            break;
          } while (k == 0);
          i = j;
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\vpx.class
