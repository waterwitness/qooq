...
{
  public vbj(PtvGuideUploader paramPtvGuideUploader, String paramString)
  {
    ...
    try
    {
      ...
      if (paramArrayOfByte.str_fileid.has())
      {
        ...
        if (paramArrayOfByte.length() > 0)
        {
          ...
          PtvGuideUploader.a(this.jdField_a_of_type_ComTencentMobileqqTransfilePtvGuideUploader).b(paramArrayOfByte);
          if (QLog.isColorLevel()) {
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\vbj.class
