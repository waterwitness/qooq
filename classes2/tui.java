...
{
  private tui(PortalManager paramPortalManager)
  {
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    case 1011: 
      ...
      localObject = ContactUtils.k(PortalManager.a(this.a), (String)localObject);
    ...
    for (;;)
    {
      ...
      if (!TextUtils.isEmpty(paramContext))
      {
        ...
        paramIntent = ContactUtils.k(PortalManager.a(this.a), String.valueOf(paramIntent));
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\tui.class
