  ...
  implements Cloneable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.wType, ((stConfMsgRecord)paramObject).wType)) || (!JceUtil.equals(this.wSeqNum, ((stConfMsgRecord)paramObject).wSeqNum)) || (!JceUtil.equals(this.lFromUin, ((stConfMsgRecord)paramObject).lFromUin)) || (!JceUtil.equals(this.lToUin, ((stConfMsgRecord)paramObject).lToUin)) || (!JceUtil.equals(this.lGroupUin, ((stConfMsgRecord)paramObject).lGroupUin)) || (!JceUtil.equals(this.cConfType, ((stConfMsgRecord)paramObject).cConfType)) || (!JceUtil.equals(this.lConfUin, ((stConfMsgRecord)paramObject).lConfUin)) || (!JceUtil.equals(this.lSendUin, ((stConfMsgRecord)paramObject).lSendUin)) || (!JceUtil.equals(this.uMsgSeq, ((stConfMsgRecord)paramObject).uMsgSeq)) || (!JceUtil.equals(this.uMsgTime, ((stConfMsgRecord)paramObject).uMsgTime)) || (!JceUtil.equals(this.uInfoSeq, ((stConfMsgRecord)paramObject).uInfoSeq)) || (!JceUtil.equals(this.uMsgLen, ((stConfMsgRecord)paramObject).uMsgLen)) || (!JceUtil.equals(this.vMsg, ((stConfMsgRecord)paramObject).vMsg)) || (!JceUtil.equals(this.uAppShareID, ((stConfMsgRecord)paramObject).uAppShareID)) || (!JceUtil.equals(this.vAppShareCookie, ((stConfMsgRecord)paramObject).vAppShareCookie)) || (!JceUtil.equals(this.vRemarkOfSender, ((stConfMsgRecord)paramObject).vRemarkOfSender)));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\MessageSvcPack\stConfMsgRecord.class
