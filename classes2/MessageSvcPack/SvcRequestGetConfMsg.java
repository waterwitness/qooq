  ...
  implements Cloneable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.lConfUin, ((SvcRequestGetConfMsg)paramObject).lConfUin)) || (!JceUtil.equals(this.lBeginSeq, ((SvcRequestGetConfMsg)paramObject).lBeginSeq)) || (!JceUtil.equals(this.lEndSeq, ((SvcRequestGetConfMsg)paramObject).lEndSeq)) || (!JceUtil.equals(this.cVerifyType, ((SvcRequestGetConfMsg)paramObject).cVerifyType)) || (!JceUtil.equals(this.cGetPttUrl, ((SvcRequestGetConfMsg)paramObject).cGetPttUrl)) || (!JceUtil.equals(this.cGetSmartRemark, ((SvcRequestGetConfMsg)paramObject).cGetSmartRemark)) || (!JceUtil.equals(this.dwLastGetTime, ((SvcRequestGetConfMsg)paramObject).dwLastGetTime)) || (!JceUtil.equals(this.dwLastInfoSeq, ((SvcRequestGetConfMsg)paramObject).dwLastInfoSeq)));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\MessageSvcPack\SvcRequestGetConfMsg.class
