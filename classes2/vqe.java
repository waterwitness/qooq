...
{
  public vqe(TroopFileTransferManager paramTroopFileTransferManager)
  {
  ...
  public void a(boolean paramBoolean, int paramInt, oidb_0x6d6.ResendRspBody paramResendRspBody, Bundle paramBundle)
  {
    ...
    if (!paramBoolean)
    {
      paramResendRspBody = new TroopFileError.SimpleErrorInfo(((TroopFileTransferManager.Item)localObject).FileName, this.a.g, 3, 207);
    ...
    else
    {
      ...
      if (!this.a.a((TroopFileTransferManager.Item)localObject)) {
        new TroopFileTransferManager.TaskHttpUpload(this.a, (TroopFileTransferManager.Item)localObject);
      }
    }
  }
}
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\vqe.class
