...
public class tun
  implements Runnable
{
  public tun(PrecoverManager paramPrecoverManager, String paramString)
  {
  ...
  public void run()
  {
    ...
    if ((this.jdField_a_of_type_JavaLangString == null) && (PrecoverUtils.a(PrecoverManager.a(this.jdField_a_of_type_ComTencentMobileqqPrecoverPrecoverManager).a(), "res_cover"))) {}
    for (;;)
    {
      if (bool1)
      {
        PrecoverUtils.a(PrecoverManager.a(this.jdField_a_of_type_ComTencentMobileqqPrecoverPrecoverManager).a(), "res_cover");
      ...
      while (((Iterator)localObject3).hasNext())
      {
        ...
        if ((localObject4 != null) && (((PrecoverResource)localObject4).isValid()))
        {
          ...
          boolean bool2 = PrecoverManager.a(this.jdField_a_of_type_ComTencentMobileqqPrecoverPrecoverManager).a((PrecoverResource)localObject4, null, true);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\tun.class
