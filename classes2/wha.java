  ...
  implements Runnable
{
  ...
  public void run()
  {
    try
    {
      ...
      {
        Object localObject = new File(BaseApplicationImpl.getContext().getFilesDir(), ClubContentJsonTask.i.b);
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\wha.class
