...
{
  public wrv(SwitchAccountActivity paramSwitchAccountActivity)
  {
  ...
  public void onFailed(String paramString, int paramInt1, int paramInt2, Bundle paramBundle)
  {
    ...
    try
    {
      ...
      if (paramInt2 == 64536) {
        this.a.a.a(this.a, this.a.getResources().getString(2131369830));
      }
      for (;;)
      {
        paramInt1 = paramBundle.getInt("code");
        ...
        return;
        if ((paramInt2 == 1) || (paramInt2 == 64532))
        {
          this.a.b();
        }
        else
        {
          ...
          {
            localObject3 = this.a.getString(2131368963);
          }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\wrv.class
