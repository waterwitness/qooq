  ...
  implements ITransactionCallback
{
  ...
  public vci(ShortVideoUploadProcessor paramShortVideoUploadProcessor)
  {
  ...
  public void onFailed(int paramInt, byte[] paramArrayOfByte, HashMap paramHashMap)
  {
    ...
    synchronized (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor)
    {
      ...
      paramHashMap = (BaseTransProcessor.StepInfo)this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_b_of_type_JavaUtilHashMap.get(Integer.valueOf(this.jdField_a_of_type_Int));
    ...
    try
    {
      ...
      if ((paramHashMap.uint32_retry_flag.has()) && (paramHashMap.uint32_retry_flag.get() != 0))
      {
        ...
        if (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_e_of_type_ComTencentMobileqqTransfileBaseTransProcessor$StepInfo != null)
        {
          this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_e_of_type_ComTencentMobileqqTransfileBaseTransProcessor$StepInfo.b();
          this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_e_of_type_ComTencentMobileqqTransfileBaseTransProcessor$StepInfo.jdField_a_of_type_Int = 0;
        }
        this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.b();
      }
    }
    ...
    if (ShortVideoUploadProcessor.c(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor) == 2)
    {
      ...
      LogTag.a(String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_a_of_type_Long), "onFailed", "TransactionListener.onFailed mVideoPreUpStatus = " + ShortVideoUploadProcessor.b(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor) + " mVideoRecordStatus = " + ShortVideoUploadProcessor.c(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor));
  ...
  public void onSuccess(byte[] paramArrayOfByte, HashMap paramHashMap)
  {
    ...
    for (;;)
    {
      synchronized (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor)
      {
        ...
        localObject1 = (BaseTransProcessor.StepInfo)this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_b_of_type_JavaUtilHashMap.get(Integer.valueOf(this.jdField_a_of_type_Int));
        if (localObject1 != null) {
          ((BaseTransProcessor.StepInfo)localObject1).b();
        }
    ...
    {
      label470:
      if ((ShortVideoUploadProcessor.f) && (paramArrayOfByte != null) && (paramArrayOfByte.length > 0))
      {
        if (QLog.isColorLevel()) {
        ...
        try
        {
          ...
          else
          {
            ...
            LogTag.a(String.valueOf(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_a_of_type_Long), "svrcomp_r", "TransactionListener.onSuccess -> get MD5 from Server success!  MD5:" + HexUtil.bytes2HexStr((byte[])localObject2));
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.f = HexUtil.bytes2HexStr((byte[])localObject2);
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_e_of_type_JavaLangString = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.f;
            if (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_JavaUtilHashMap != null)
            {
              this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_JavaUtilHashMap.put("param_fileMD5", this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.f);
            ...
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.i = ShortVideoUtils.a((MessageForShortVideo)this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_ComTencentMobileqqTransfileTransferRequest.jdField_a_of_type_ComTencentMobileqqDataMessageRecord, "mp4");
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.h = paramArrayOfByte.bytes_fileid.get().toStringUtf8();
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Long = i;
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.by = j;
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_e_of_type_ComTencentMobileqqTransfileBaseTransProcessor$StepInfo.b();
            this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_e_of_type_ComTencentMobileqqTransfileBaseTransProcessor$StepInfo.jdField_a_of_type_Int = 1;
    ...
    if (ShortVideoUploadProcessor.c(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor) == 0) {
      this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.v();
    }
    if ((!ShortVideoUploadProcessor.f) && (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_JavaUtilConcurrentAtomicAtomicBoolean.get()) && (ShortVideoUploadProcessor.b(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor) == 0))
    {
      this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.a(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_o_of_type_Long, this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_ComTencentMobileqqHighwayProtocolBdh_extinfo$PicInfo, this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_b_of_type_JavaUtilList);
  ...
  {
    ??? = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor;
    ???.jdField_c_of_type_Long += paramInt;
    this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_ComTencentMobileqqTransfileFileMsg.f = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_c_of_type_Long;
    for (;;)
    {
      ...
      synchronized (this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor)
      {
        ...
        ShortVideoUploadProcessor.e(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor, this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.cacheIp);
        Iterator localIterator = this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_c_of_type_JavaUtilList.iterator();
    ...
    {
      label329:
      if ((this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_c_of_type_Long < this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_a_of_type_Long) && (!this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.jdField_o_of_type_Boolean) && (!this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.k)) {
        this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor.h();
      }
      return;
      label377:
      if (this.jdField_a_of_type_ComTencentMobileqqHighwayTransactionTransaction.cacheIp != ShortVideoUploadProcessor.d(this.jdField_a_of_type_ComTencentMobileqqTransfileShortVideoUploadProcessor))
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\vci.class
