...
{
  public vmf(TroopEntranceBar paramTroopEntranceBar, long paramLong)
  {
  ...
  public void a(int paramInt, byte[] paramArrayOfByte, Bundle paramBundle)
  {
    ...
    for (;;)
    {
      try
      {
        ...
        {
          this.jdField_a_of_type_ComTencentMobileqqTroopDataTroopEntranceBar.g = ((oidb_0x487.RspBody)localObject).uint32_groups_flag.get();
        ...
        if ((paramInt == 0) && (((oidb_0x487.RspBody)localObject).uint32_follow_state.has()))
        {
          ...
          if (i == 1)
          {
            ...
            String str = ((QQAppInterface)localObject).f();
            ...
            localHashMap.put("CONTEXT", ((QQAppInterface)localObject).a().getApplicationContext());
            new HttpWebCgiAsyncTask2("http://buluo.qq.com/cgi-bin/bar/extra/clean_temp_follow_state", "", new vmg(this, paramBundle, i), 1000, null).a(localHashMap);
          }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\vmf.class
