  ...
  implements Cloneable
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    } while ((!JceUtil.equals(this.Ret, ((RspResOrder)paramObject).Ret)) || (!JceUtil.equals(this.SeqID, ((RspResOrder)paramObject).SeqID)) || (!JceUtil.equals(this.Title, ((RspResOrder)paramObject).Title)) || (!JceUtil.equals(this.ErrMsg, ((RspResOrder)paramObject).ErrMsg)) || (!JceUtil.equals(this.ButtonDesc, ((RspResOrder)paramObject).ButtonDesc)) || (!JceUtil.equals(this.ButtonUrl, ((RspResOrder)paramObject).ButtonUrl)));
    return true;
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\ResPackage\RspResOrder.class
