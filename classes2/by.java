  ...
  implements View.OnClickListener
{
  ...
  private by(LiteMutiPicViewerActivity paramLiteMutiPicViewerActivity)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    do
    {
      ...
      if (!LiteMutiPicViewerActivity.a(this.jdField_a_of_type_ComDatalineActivitiesLiteMutiPicViewerActivity).isTimeOut())
      {
        ...
        paramView = String.format(this.jdField_a_of_type_ComDatalineActivitiesLiteMutiPicViewerActivity.app.a().getString(2131362226), new Object[] { Integer.valueOf(i), Integer.valueOf(i - paramInt) });
      ...
      paramView = String.format(this.jdField_a_of_type_ComDatalineActivitiesLiteMutiPicViewerActivity.app.a().getString(2131362227), new Object[] { Integer.valueOf(i), Integer.valueOf(i - paramInt) });
      LiteMutiPicViewerActivity.a(this.jdField_a_of_type_ComDatalineActivitiesLiteMutiPicViewerActivity).setWaitText(paramView);
      break;
      if (paramInt <= LiteMutiPicViewerActivity.a(this.jdField_a_of_type_ComDatalineActivitiesLiteMutiPicViewerActivity).getTotalCount() - 1) {
        break label403;
    ...
    if (paramView == null)
    {
      ...
      paramViewGroup.jdField_a_of_type_AndroidWidgetRelativeLayout = ((RelativeLayout)paramView.findViewById(2131298105));
      paramViewGroup.jdField_a_of_type_AndroidViewView = paramView.findViewById(2131297902);
      paramViewGroup.jdField_a_of_type_AndroidWidgetImageView = ((ImageView)paramView.findViewById(2131300902));
      paramViewGroup.jdField_a_of_type_ComDatalineUtilWidgetAsyncImageView = ((AsyncImageView)paramView.findViewById(2131296303));
  ...
  public void onClick(View paramView)
  {
    ...
    while (((Iterator)localObject).hasNext())
    {
      ...
      if ((localDataLineMsgRecord.msgtype == 63536) || ((localDataLineMsgRecord.msgtype == 63531) && (FileManagerUtil.a(localDataLineMsgRecord.filename) == 0)) || ((localDataLineMsgRecord.msgtype == 63201) && (localDataLineMsgRecord.bIsMoloImage))) {
