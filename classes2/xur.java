...
{
  public xur(RangeButtonView paramRangeButtonView, View paramView)
  {
    super(paramView);
  ...
  {
    return RangeButtonView.a(this.a, (int)paramFloat1, (int)paramFloat2, RangeButtonView.a(this.a).c() / 2, RangeButtonView.a(this.a).a() / 2, false);
  }
...
/* Location:              E:\apk\QQ_91\classes2-dex2jar.jar!\xur.class
