  ...
  extends URLDrawableParams
{
  ...
  public iqx(ImageLoader paramImageLoader, Context paramContext)
  {
    super(paramContext);
  ...
  protected ProtocolDownloader doGetDownloader(String paramString)
  {
    ...
    if (("file".equals(paramString)) || (BaseApplicationImpl.a.getProcessName().endsWith(":peak"))) {
...
/* Location:              E:\apk\QQ_91\classes6-dex2jar.jar!\iqx.class
