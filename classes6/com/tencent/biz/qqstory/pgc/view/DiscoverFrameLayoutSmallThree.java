...
public class DiscoverFrameLayoutSmallThree
  extends BaseDiscoverFrameLayout
{
  public DiscoverFrameLayoutSmallThree(Context paramContext, int paramInt1, int paramInt2, AdapterView.OnItemClickListener paramOnItemClickListener, AdapterView.OnItemLongClickListener paramOnItemLongClickListener, DiscoverItem.OnItemTouchListener paramOnItemTouchListener)
  {
    super(paramContext, paramInt1, paramInt2, paramOnItemClickListener, paramOnItemLongClickListener);
    boolean bool = NotVerifyClass.DO_VERIFY_CLASS;
    paramInt1 = (paramInt1 - DisplayUtil.a(getContext(), 4.0F)) / 3;
    paramInt2 /= 3;
    ...
    paramContext = new DiscoverItem(getContext(), 22, this.jdField_a_of_type_AndroidWidgetAdapterView$OnItemClickListener, this.jdField_a_of_type_AndroidWidgetAdapterView$OnItemLongClickListener, paramOnItemTouchListener);
    paramOnItemClickListener = new FrameLayout.LayoutParams(paramInt1, paramInt2);
    paramOnItemClickListener.leftMargin = (paramInt1 * 2 + DisplayUtil.a(getContext(), 2.0F) * 2);
    super.addView(paramContext, paramOnItemClickListener);
  }
}


/* Location:              E:\apk\QQ_91\classes6-dex2jar.jar!\com\tencent\biz\qqstory\pgc\view\DiscoverFrameLayoutSmallThree.class
