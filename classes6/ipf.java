...
public class ipf
  implements Runnable
{
  public ipf(StoryPlayVideoActivity.VideoViewPagerAdapter paramVideoViewPagerAdapter, StoryVideoItem paramStoryVideoItem, StoryPlayVideoActivity.VideoViewPagerAdapter.VideoViewHolder paramVideoViewHolder)
  {
  ...
  public void run()
  {
    ...
    this.jdField_a_of_type_ComTencentBizQqstoryPlayvideoStoryPlayVideoActivity$VideoViewPagerAdapter.a.runOnUiThread(new ipg(this, (FaceDrawable)localObject));
  }
}


/* Location:              E:\apk\QQ_91\classes6-dex2jar.jar!\ipf.class
