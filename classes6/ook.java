...
{
  public ook(BindVerifyActivity paramBindVerifyActivity)
  {
  ...
  protected void a(boolean paramBoolean, Bundle paramBundle)
  {
    ...
    if ((this.a.c == 10) || (this.a.c == 11))
    {
      ...
      paramBundle.putExtra("kSrouce", this.a.c);
      paramBundle.putExtra("keyReqBindMode", this.a.d);
...
/* Location:              E:\apk\QQ_91\classes6-dex2jar.jar!\ook.class
